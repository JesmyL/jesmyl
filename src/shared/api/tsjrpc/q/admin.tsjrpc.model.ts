...
export type QuestionerAdminTsjrpcModel = {
  ...
  setTemplateConditionOperator: (
    args: QuestionerTemplateSelector<{ operator: QuestionerTemplateConditionType; nexti?: number }>,
  ) => void;
  setTemplateConditionNextTemplateId: (
    args: QuestionerTemplateSelector<{ conditionTemplateId: QuestionerTemplateId; nexti: number; nextNexti: number }>,
  ) => void;
  setTemplateConditionNextValue: (
    args: QuestionerTemplateSelector<{
      match: Partial<{
        [T in QuestionerType]: Partial<{
          [O in Exclude<QuestionerTemplateTypeConditionDict[T]['op'], nil>]: Exclude<
            QuestionerTemplateTypeConditionDict[T]['val'],
            nil
          >;
        }>;
      }>;
  ...
  setTemplateConditionNextOperator: (
    args: QuestionerTemplateSelector<{
