        ...
        <>
                        ...
                        <QuestionerTemplateCard
                              ...
                              {!templateIdi || (
                                <Button
                                  ...
                                  onClick={event => {
                                    ...
                                    return questionerAdminTsjrpcClient.changeTemplatePosition({ blankw, templateId });
                                  }}
                                />
                              )}
                            </div>
                          ...
                          requiredSign={
                            <IconCheckbox
                              ...
                              className="text-xKO"
                              onChange={value =>
                                questionerAdminTsjrpcClient.changeTemplateRequiredSign({ blankw, value, templateId })
                              }
                            />
                          }
                          innerTitle={
                            <InputWithLoadingIcon
                              ...
                              onChanged={value =>
                                questionerAdminTsjrpcClient.changeTemplateTitle({ blankw, value, templateId })
                              }
                            />
                          }
                          description={
                            <InputWithLoadingIcon
                              ...
                              multiline
                              onChanged={value =>
                                questionerAdminTsjrpcClient.changeTemplateDescription({ blankw, value, templateId })
                              }
                            />
                          }
                        />
          ...
          <FullContent openAtom={openVisibilityTemplateIdModalAtom}>
            <WithAtomTruthfulValue atom={openVisibilityTemplateIdModalAtom}>
              {templateId => (
                <QuestionerTemplateVisibilityRedactor
                  blankw={blankw}
                  templateId={templateId}
                />
              )}
