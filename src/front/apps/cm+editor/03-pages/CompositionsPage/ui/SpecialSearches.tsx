...
interface Props {
  ...
  setMapper: React.Dispatch<React.SetStateAction<ICmEditorCompositionsCatSpecialSearches['map'] | null>>;
}

export const CmEditorCompositionsCatSpecialSearches = ({ setTerm, setMapper, term }: Props) => {
