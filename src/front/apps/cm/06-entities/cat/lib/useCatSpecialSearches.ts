...
import { CmCatTracker } from '../model/Cat.model';
import { CmCat } from './Cat';

export const cmCatTrackers: CmCatTracker[] = [
...
export type ICmCatSpecialSearches = {
  title: string;
...
export const useCmCatSpecialSearches = (): Record<`@${string}`, ICmCatSpecialSearches> => {
