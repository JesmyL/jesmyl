...
export const CmTranslationFullscreen = () => {
  ...
  const { text, nextText, prevText } = useCmTranslationScreenComTextNavigations();
  const { nextCom, prevCom } = useCmTranslationScreenComNavigations();
  const closeTranslation = useCmTranslationClose();
