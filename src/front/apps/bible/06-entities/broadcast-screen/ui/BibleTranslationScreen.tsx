...
import { useBibleBroadcastScreenTranslationWrapperStyle } from '../../broadcast/style/wrapper-style';
...
export const BibleBroadcastScreenScreen = (props: Props) => {
  ...
  const wrapperStyle = useBibleBroadcastScreenTranslationWrapperStyle(props.bibleConfig);
