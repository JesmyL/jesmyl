...
import { AlertLineConfig, ScreenTranslationConfig } from '../model/Configs.model';
import { FixedResizerLines } from '../model/Position.model';
import { defaultScreenTranslationBackgroundConfig } from './defaults';
