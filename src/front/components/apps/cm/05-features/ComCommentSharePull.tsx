...
import { cmComCommentAltKeyAtom, cmComCommentRegisteredAltKeysAtom } from '$cm/basis/lib/store/atoms';
...
export const CmComCommentSharePull = memo(function CmComCommentSharePull({
  ...
  const com = useCom(shareProps.comw);
      ...
      <ModalFooter>
        <Button
          ...
          onClick={async () => {
            ...
            if (!fromBlock) return;
            cmShareComCommentPropsAtom.reset();
