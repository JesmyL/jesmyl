...
export const IconWindPower02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WindPower02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWindPower02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WindPower02 DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconWindPower02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WindPower02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWindPower02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WindPower02 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconWindPower02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WindPower02 BulkRounded"
    >
      <path 
        d={d.d14}
        i-c="f"
...
export const IconWindPower02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WindPower02 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s ss sw"
...
export const IconWindPower02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WindPower02 SolidSharp"
    >
      <path 
        d={d.d16}
        i-c="c f fr"
...
export const iconPackOfWindPower02: TheIconSelfPack = [
  'WindPower02',
  IconWindPower02StrokeRounded,
  IconWindPower02DuotoneRounded,
  IconWindPower02TwotoneRounded,
  IconWindPower02SolidRounded,
  IconWindPower02BulkRounded,
  IconWindPower02StrokeSharp,
  IconWindPower02SolidSharp,
];