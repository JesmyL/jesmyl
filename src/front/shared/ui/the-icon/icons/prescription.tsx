...
export const IconPrescriptionStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Prescription StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconPrescriptionDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Prescription DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconPrescriptionTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Prescription TwotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="s sr sw"
...
export const IconPrescriptionSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Prescription SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconPrescriptionBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Prescription BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr o7"
...
export const IconPrescriptionStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Prescription StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPrescriptionSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Prescription SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfPrescription: TheIconSelfPack = [
  'Prescription',
  IconPrescriptionStrokeRounded,
  IconPrescriptionDuotoneRounded,
  IconPrescriptionTwotoneRounded,
  IconPrescriptionSolidRounded,
  IconPrescriptionBulkRounded,
  IconPrescriptionStrokeSharp,
  IconPrescriptionSolidSharp,
];