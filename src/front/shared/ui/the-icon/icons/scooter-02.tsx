...
export const IconScooter02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Scooter02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconScooter02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Scooter02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconScooter02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Scooter02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconScooter02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Scooter02 SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconScooter02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Scooter02 BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconScooter02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Scooter02 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfScooter02: TheIconSelfPack = [
  'Scooter02',
  IconScooter02StrokeRounded,
  IconScooter02DuotoneRounded,
  IconScooter02TwotoneRounded,
  IconScooter02SolidRounded,
  IconScooter02BulkRounded,
  IconScooter02StrokeSharp,
  IconScooter02SolidSharp,
];