...
export const IconCovariateStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Covariate StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconCovariateDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Covariate DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconCovariateTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Covariate TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconCovariateSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Covariate SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconCovariateBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Covariate BulkRounded"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const IconCovariateStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Covariate StrokeSharp"
    >
      <path 
        d={d.d18}
        i-c="s sj sw"
...
export const iconPackOfCovariate: TheIconSelfPack = [
  'Covariate',
  IconCovariateStrokeRounded,
  IconCovariateDuotoneRounded,
  IconCovariateTwotoneRounded,
  IconCovariateSolidRounded,
  IconCovariateBulkRounded,
  IconCovariateStrokeSharp,
  IconCovariateSolidSharp,
];