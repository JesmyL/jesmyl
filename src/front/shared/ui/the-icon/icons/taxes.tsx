...
export const iconPackOfTaxes: TheIconSelfPack = [
  'Taxes',
  IconTaxesStrokeRounded,
  IconTaxesDuotoneRounded,
  IconTaxesTwotoneRounded,
  IconTaxesSolidRounded,
  IconTaxesBulkRounded,
  IconTaxesStrokeSharp,
  IconTaxesSolidSharp,
];