...
export const IconMoneyAdd01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneyAdd01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMoneyAdd01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneyAdd01 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconMoneyAdd01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneyAdd01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMoneyAdd01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneyAdd01 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconMoneyAdd01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneyAdd01 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconMoneyAdd01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneyAdd01 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconMoneyAdd01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneyAdd01 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfMoneyAdd01: TheIconSelfPack = [
  'MoneyAdd01',
  IconMoneyAdd01StrokeRounded,
  IconMoneyAdd01DuotoneRounded,
  IconMoneyAdd01TwotoneRounded,
  IconMoneyAdd01SolidRounded,
  IconMoneyAdd01BulkRounded,
  IconMoneyAdd01StrokeSharp,
  IconMoneyAdd01SolidSharp,
];