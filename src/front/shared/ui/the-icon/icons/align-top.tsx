...
export const IconAlignTopStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignTop StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAlignTopDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignTop DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconAlignTopTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignTop TwotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="s sj sr sw"
...
export const IconAlignTopSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignTop SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfAlignTop: TheIconSelfPack = [
  'AlignTop',
  IconAlignTopStrokeRounded,
  IconAlignTopDuotoneRounded,
  IconAlignTopTwotoneRounded,
  IconAlignTopSolidRounded,
  IconAlignTopBulkRounded,
  IconAlignTopStrokeSharp,
  IconAlignTopSolidSharp,
];