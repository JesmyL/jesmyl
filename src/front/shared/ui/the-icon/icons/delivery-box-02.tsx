...
export const IconDeliveryBox02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveryBox02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDeliveryBox02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveryBox02 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconDeliveryBox02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveryBox02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDeliveryBox02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveryBox02 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconDeliveryBox02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveryBox02 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconDeliveryBox02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveryBox02 StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const IconDeliveryBox02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveryBox02 SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const iconPackOfDeliveryBox02: TheIconSelfPack = [
  'DeliveryBox02',
  IconDeliveryBox02StrokeRounded,
  IconDeliveryBox02DuotoneRounded,
  IconDeliveryBox02TwotoneRounded,
  IconDeliveryBox02SolidRounded,
  IconDeliveryBox02BulkRounded,
  IconDeliveryBox02StrokeSharp,
  IconDeliveryBox02SolidSharp,
];