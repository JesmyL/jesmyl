...
export const IconArchiveStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Archive StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconArchiveDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Archive DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconArchiveTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Archive TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfArchive: TheIconSelfPack = [
  'Archive',
  IconArchiveStrokeRounded,
  IconArchiveDuotoneRounded,
  IconArchiveTwotoneRounded,
  IconArchiveSolidRounded,
  IconArchiveBulkRounded,
  IconArchiveStrokeSharp,
  IconArchiveSolidSharp,
];