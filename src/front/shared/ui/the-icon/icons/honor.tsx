...
export const iconPackOfHonor: TheIconSelfPack = [
  'Honor',
  IconHonorStrokeRounded,
  IconHonorDuotoneRounded,
  IconHonorTwotoneRounded,
  IconHonorSolidRounded,
  IconHonorBulkRounded,
  IconHonorStrokeSharp,
  IconHonorSolidSharp,
];