...
export const IconNoteAddStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NoteAdd StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconNoteAddDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NoteAdd DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconNoteAddTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NoteAdd TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfNoteAdd: TheIconSelfPack = [
  'NoteAdd',
  IconNoteAddStrokeRounded,
  IconNoteAddDuotoneRounded,
  IconNoteAddTwotoneRounded,
  IconNoteAddSolidRounded,
  IconNoteAddBulkRounded,
  IconNoteAddStrokeSharp,
  IconNoteAddSolidSharp,
];