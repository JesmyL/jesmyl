...
export const IconPathfinderTrimStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PathfinderTrim StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPathfinderTrimDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PathfinderTrim DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconPathfinderTrimTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PathfinderTrim TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconPathfinderTrimSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PathfinderTrim SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconPathfinderTrimBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PathfinderTrim BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconPathfinderTrimStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PathfinderTrim StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sj sw"
...
export const IconPathfinderTrimSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PathfinderTrim SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const iconPackOfPathfinderTrim: TheIconSelfPack = [
  'PathfinderTrim',
  IconPathfinderTrimStrokeRounded,
  IconPathfinderTrimDuotoneRounded,
  IconPathfinderTrimTwotoneRounded,
  IconPathfinderTrimSolidRounded,
  IconPathfinderTrimBulkRounded,
  IconPathfinderTrimStrokeSharp,
  IconPathfinderTrimSolidSharp,
];