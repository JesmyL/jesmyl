...
export const IconProtectionMaskStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ProtectionMask StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconProtectionMaskDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ProtectionMask DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconProtectionMaskTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ProtectionMask TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconProtectionMaskSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ProtectionMask SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconProtectionMaskBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ProtectionMask BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconProtectionMaskStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ProtectionMask StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconProtectionMaskSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ProtectionMask SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfProtectionMask: TheIconSelfPack = [
  'ProtectionMask',
  IconProtectionMaskStrokeRounded,
  IconProtectionMaskDuotoneRounded,
  IconProtectionMaskTwotoneRounded,
  IconProtectionMaskSolidRounded,
  IconProtectionMaskBulkRounded,
  IconProtectionMaskStrokeSharp,
  IconProtectionMaskSolidSharp,
];