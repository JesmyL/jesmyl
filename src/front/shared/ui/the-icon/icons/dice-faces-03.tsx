...
export const IconDiceFaces03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDiceFaces03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces03 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconDiceFaces03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDiceFaces03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces03 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconDiceFaces03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces03 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconDiceFaces03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces03 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sw"
...
export const IconDiceFaces03SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces03 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfDiceFaces03: TheIconSelfPack = [
  'DiceFaces03',
  IconDiceFaces03StrokeRounded,
  IconDiceFaces03DuotoneRounded,
  IconDiceFaces03TwotoneRounded,
  IconDiceFaces03SolidRounded,
  IconDiceFaces03BulkRounded,
  IconDiceFaces03StrokeSharp,
  IconDiceFaces03SolidSharp,
];