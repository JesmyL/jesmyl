...
export const IconAlbum02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Album02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconAlbum02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Album02 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconAlbum02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Album02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const iconPackOfAlbum02: TheIconSelfPack = [
  'Album02',
  IconAlbum02StrokeRounded,
  IconAlbum02DuotoneRounded,
  IconAlbum02TwotoneRounded,
  IconAlbum02SolidRounded,
  IconAlbum02BulkRounded,
  IconAlbum02StrokeSharp,
  IconAlbum02SolidSharp,
];