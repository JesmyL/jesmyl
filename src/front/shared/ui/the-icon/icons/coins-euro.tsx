...
export const IconCoinsEuroStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsEuro StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconCoinsEuroDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsEuro DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconCoinsEuroTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsEuro TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconCoinsEuroSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsEuro SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconCoinsEuroBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsEuro BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconCoinsEuroStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsEuro StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfCoinsEuro: TheIconSelfPack = [
  'CoinsEuro',
  IconCoinsEuroStrokeRounded,
  IconCoinsEuroDuotoneRounded,
  IconCoinsEuroTwotoneRounded,
  IconCoinsEuroSolidRounded,
  IconCoinsEuroBulkRounded,
  IconCoinsEuroStrokeSharp,
  IconCoinsEuroSolidSharp,
];