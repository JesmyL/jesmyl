...
export const IconBriefcase04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconBriefcase04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase04 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconBriefcase04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconBriefcase04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase04 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconBriefcase04BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase04 BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconBriefcase04StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase04 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sr sw"
...
export const IconBriefcase04SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase04 SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfBriefcase04: TheIconSelfPack = [
  'Briefcase04',
  IconBriefcase04StrokeRounded,
  IconBriefcase04DuotoneRounded,
  IconBriefcase04TwotoneRounded,
  IconBriefcase04SolidRounded,
  IconBriefcase04BulkRounded,
  IconBriefcase04StrokeSharp,
  IconBriefcase04SolidSharp,
];