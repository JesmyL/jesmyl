...
export const IconTongueWinkLeftStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TongueWinkLeft StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconTongueWinkLeftDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TongueWinkLeft DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconTongueWinkLeftTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TongueWinkLeft TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconTongueWinkLeftSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TongueWinkLeft SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconTongueWinkLeftBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TongueWinkLeft BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconTongueWinkLeftStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TongueWinkLeft StrokeSharp"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconTongueWinkLeftSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TongueWinkLeft SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfTongueWinkLeft: TheIconSelfPack = [
  'TongueWinkLeft',
  IconTongueWinkLeftStrokeRounded,
  IconTongueWinkLeftDuotoneRounded,
  IconTongueWinkLeftTwotoneRounded,
  IconTongueWinkLeftSolidRounded,
  IconTongueWinkLeftBulkRounded,
  IconTongueWinkLeftStrokeSharp,
  IconTongueWinkLeftSolidSharp,
];