...
export const IconStrategyStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Strategy StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconStrategyDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Strategy DuotoneRounded"
    >
      <circle 
        cx="5.5"
        cy="5.5"
...
export const IconStrategyTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Strategy TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconStrategySolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Strategy SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const iconPackOfStrategy: TheIconSelfPack = [
  'Strategy',
  IconStrategyStrokeRounded,
  IconStrategyDuotoneRounded,
  IconStrategyTwotoneRounded,
  IconStrategySolidRounded,
  IconStrategyBulkRounded,
  IconStrategyStrokeSharp,
  IconStrategySolidSharp,
];