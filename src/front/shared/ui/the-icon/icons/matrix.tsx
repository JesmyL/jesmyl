...
export const IconMatrixDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Matrix DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconMatrixTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Matrix TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfMatrix: TheIconSelfPack = [
  'Matrix',
  IconMatrixStrokeRounded,
  IconMatrixDuotoneRounded,
  IconMatrixTwotoneRounded,
  IconMatrixSolidRounded,
  IconMatrixBulkRounded,
  IconMatrixStrokeSharp,
  IconMatrixSolidSharp,
];