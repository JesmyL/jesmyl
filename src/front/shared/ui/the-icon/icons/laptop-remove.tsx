...
export const IconLaptopRemoveStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopRemove StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconLaptopRemoveDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopRemove DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconLaptopRemoveTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopRemove TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconLaptopRemoveSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopRemove SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconLaptopRemoveBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopRemove BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconLaptopRemoveStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopRemove StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLaptopRemoveSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopRemove SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfLaptopRemove: TheIconSelfPack = [
  'LaptopRemove',
  IconLaptopRemoveStrokeRounded,
  IconLaptopRemoveDuotoneRounded,
  IconLaptopRemoveTwotoneRounded,
  IconLaptopRemoveSolidRounded,
  IconLaptopRemoveBulkRounded,
  IconLaptopRemoveStrokeSharp,
  IconLaptopRemoveSolidSharp,
];