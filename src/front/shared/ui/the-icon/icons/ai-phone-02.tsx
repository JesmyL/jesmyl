...
export const IconAiPhone02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiPhone02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAiPhone02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiPhone02 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconAiPhone02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiPhone02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconAiPhone02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiPhone02 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconAiPhone02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiPhone02 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconAiPhone02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiPhone02 StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sw"
...
export const iconPackOfAiPhone02: TheIconSelfPack = [
  'AiPhone02',
  IconAiPhone02StrokeRounded,
  IconAiPhone02DuotoneRounded,
  IconAiPhone02TwotoneRounded,
  IconAiPhone02SolidRounded,
  IconAiPhone02BulkRounded,
  IconAiPhone02StrokeSharp,
  IconAiPhone02SolidSharp,
];