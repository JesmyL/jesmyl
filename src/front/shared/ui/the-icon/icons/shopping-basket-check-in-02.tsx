...
export const IconShoppingBasketCheckIn02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketCheckIn02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShoppingBasketCheckIn02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketCheckIn02 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconShoppingBasketCheckIn02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketCheckIn02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShoppingBasketCheckIn02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketCheckIn02 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconShoppingBasketCheckIn02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketCheckIn02 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconShoppingBasketCheckIn02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketCheckIn02 StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sw"
...
export const IconShoppingBasketCheckIn02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketCheckIn02 SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfShoppingBasketCheckIn02: TheIconSelfPack = [
  ...
  IconShoppingBasketCheckIn02StrokeRounded,
  IconShoppingBasketCheckIn02DuotoneRounded,
  IconShoppingBasketCheckIn02TwotoneRounded,
  IconShoppingBasketCheckIn02SolidRounded,
  IconShoppingBasketCheckIn02BulkRounded,
  IconShoppingBasketCheckIn02StrokeSharp,
  IconShoppingBasketCheckIn02SolidSharp,
];