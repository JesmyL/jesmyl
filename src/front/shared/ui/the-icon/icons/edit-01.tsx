...
export const IconEdit01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Edit01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconEdit01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Edit01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfEdit01: TheIconSelfPack = [
  'Edit01',
  IconEdit01StrokeRounded,
  IconEdit01DuotoneRounded,
  IconEdit01TwotoneRounded,
  IconEdit01SolidRounded,
  IconEdit01BulkRounded,
  IconEdit01StrokeSharp,
  IconEdit01SolidSharp,
];