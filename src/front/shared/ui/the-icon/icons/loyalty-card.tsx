...
export const IconLoyaltyCardStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LoyaltyCard StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLoyaltyCardDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LoyaltyCard DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconLoyaltyCardTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LoyaltyCard TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLoyaltyCardSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LoyaltyCard SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconLoyaltyCardBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LoyaltyCard BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconLoyaltyCardStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LoyaltyCard StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const IconLoyaltyCardSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LoyaltyCard SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfLoyaltyCard: TheIconSelfPack = [
  'LoyaltyCard',
  IconLoyaltyCardStrokeRounded,
  IconLoyaltyCardDuotoneRounded,
  IconLoyaltyCardTwotoneRounded,
  IconLoyaltyCardSolidRounded,
  IconLoyaltyCardBulkRounded,
  IconLoyaltyCardStrokeSharp,
  IconLoyaltyCardSolidSharp,
];