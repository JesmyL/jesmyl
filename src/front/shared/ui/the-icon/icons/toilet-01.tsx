...
export const IconToilet01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Toilet01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconToilet01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Toilet01 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconToilet01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Toilet01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconToilet01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Toilet01 SolidRounded"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfToilet01: TheIconSelfPack = [
  'Toilet01',
  IconToilet01StrokeRounded,
  IconToilet01DuotoneRounded,
  IconToilet01TwotoneRounded,
  IconToilet01SolidRounded,
  IconToilet01BulkRounded,
  IconToilet01StrokeSharp,
  IconToilet01SolidSharp,
];