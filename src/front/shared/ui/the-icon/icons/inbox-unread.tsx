...
export const IconInboxUnreadStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InboxUnread StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconInboxUnreadDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InboxUnread DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconInboxUnreadTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InboxUnread TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconInboxUnreadSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InboxUnread SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconInboxUnreadBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InboxUnread BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconInboxUnreadStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InboxUnread StrokeSharp"
    >
      <path 
        d={d.d2}
        i-c="s sw"
...
export const IconInboxUnreadSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InboxUnread SolidSharp"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const iconPackOfInboxUnread: TheIconSelfPack = [
  'InboxUnread',
  IconInboxUnreadStrokeRounded,
  IconInboxUnreadDuotoneRounded,
  IconInboxUnreadTwotoneRounded,
  IconInboxUnreadSolidRounded,
  IconInboxUnreadBulkRounded,
  IconInboxUnreadStrokeSharp,
  IconInboxUnreadSolidSharp,
];