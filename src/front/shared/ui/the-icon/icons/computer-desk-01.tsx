...
export const IconComputerDesk01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerDesk01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconComputerDesk01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerDesk01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconComputerDesk01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerDesk01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconComputerDesk01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerDesk01 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconComputerDesk01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerDesk01 BulkRounded"
    >
      <path 
        d={d.d11}
        i-c="c f fr o7"
...
export const IconComputerDesk01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerDesk01 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconComputerDesk01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerDesk01 SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="f"
...
export const iconPackOfComputerDesk01: TheIconSelfPack = [
  'ComputerDesk01',
  IconComputerDesk01StrokeRounded,
  IconComputerDesk01DuotoneRounded,
  IconComputerDesk01TwotoneRounded,
  IconComputerDesk01SolidRounded,
  IconComputerDesk01BulkRounded,
  IconComputerDesk01StrokeSharp,
  IconComputerDesk01SolidSharp,
];