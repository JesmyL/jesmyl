...
export const IconUserBlock01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserBlock01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserBlock01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserBlock01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconUserBlock01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserBlock01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserBlock01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserBlock01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconUserBlock01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserBlock01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconUserBlock01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserBlock01 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sw"
...
export const IconUserBlock01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserBlock01 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfUserBlock01: TheIconSelfPack = [
  'UserBlock01',
  IconUserBlock01StrokeRounded,
  IconUserBlock01DuotoneRounded,
  IconUserBlock01TwotoneRounded,
  IconUserBlock01SolidRounded,
  IconUserBlock01BulkRounded,
  IconUserBlock01StrokeSharp,
  IconUserBlock01SolidSharp,
];