...
export const IconEdgeStyleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EdgeStyle StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconEdgeStyleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EdgeStyle DuotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconEdgeStyleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EdgeStyle TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconEdgeStyleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EdgeStyle SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconEdgeStyleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EdgeStyle BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconEdgeStyleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EdgeStyle StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfEdgeStyle: TheIconSelfPack = [
  'EdgeStyle',
  IconEdgeStyleStrokeRounded,
  IconEdgeStyleDuotoneRounded,
  IconEdgeStyleTwotoneRounded,
  IconEdgeStyleSolidRounded,
  IconEdgeStyleBulkRounded,
  IconEdgeStyleStrokeSharp,
  IconEdgeStyleSolidSharp,
];