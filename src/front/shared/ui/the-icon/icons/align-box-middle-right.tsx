...
export const IconAlignBoxMiddleRightStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignBoxMiddleRight StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAlignBoxMiddleRightDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignBoxMiddleRight DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconAlignBoxMiddleRightTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignBoxMiddleRight TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAlignBoxMiddleRightSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignBoxMiddleRight SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconAlignBoxMiddleRightBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignBoxMiddleRight BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconAlignBoxMiddleRightStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignBoxMiddleRight StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sr sw"
...
export const IconAlignBoxMiddleRightSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignBoxMiddleRight SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfAlignBoxMiddleRight: TheIconSelfPack = [
  'AlignBoxMiddleRight',
  IconAlignBoxMiddleRightStrokeRounded,
  IconAlignBoxMiddleRightDuotoneRounded,
  IconAlignBoxMiddleRightTwotoneRounded,
  IconAlignBoxMiddleRightSolidRounded,
  IconAlignBoxMiddleRightBulkRounded,
  IconAlignBoxMiddleRightStrokeSharp,
  IconAlignBoxMiddleRightSolidSharp,
];