...
export const IconMouse11StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mouse11 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMouse11DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mouse11 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconMouse11TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mouse11 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfMouse11: TheIconSelfPack = [
  'Mouse11',
  IconMouse11StrokeRounded,
  IconMouse11DuotoneRounded,
  IconMouse11TwotoneRounded,
  IconMouse11SolidRounded,
  IconMouse11BulkRounded,
  IconMouse11StrokeSharp,
  IconMouse11SolidSharp,
];