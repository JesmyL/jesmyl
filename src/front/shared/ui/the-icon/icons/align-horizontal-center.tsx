...
export const IconAlignHorizontalCenterStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignHorizontalCenter StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAlignHorizontalCenterDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignHorizontalCenter DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconAlignHorizontalCenterTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignHorizontalCenter TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconAlignHorizontalCenterSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignHorizontalCenter SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconAlignHorizontalCenterBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignHorizontalCenter BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconAlignHorizontalCenterStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignHorizontalCenter StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const IconAlignHorizontalCenterSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignHorizontalCenter SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfAlignHorizontalCenter: TheIconSelfPack = [
  ...
  IconAlignHorizontalCenterStrokeRounded,
  IconAlignHorizontalCenterDuotoneRounded,
  IconAlignHorizontalCenterTwotoneRounded,
  IconAlignHorizontalCenterSolidRounded,
  IconAlignHorizontalCenterBulkRounded,
  IconAlignHorizontalCenterStrokeSharp,
  IconAlignHorizontalCenterSolidSharp,
];