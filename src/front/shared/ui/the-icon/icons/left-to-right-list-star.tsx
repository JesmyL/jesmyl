...
export const IconLeftToRightListStarStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftToRightListStar StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconLeftToRightListStarDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftToRightListStar DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconLeftToRightListStarTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftToRightListStar TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconLeftToRightListStarSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftToRightListStar SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconLeftToRightListStarBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftToRightListStar BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconLeftToRightListStarStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftToRightListStar StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sw"
...
export const IconLeftToRightListStarSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftToRightListStar SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfLeftToRightListStar: TheIconSelfPack = [
  'LeftToRightListStar',
  IconLeftToRightListStarStrokeRounded,
  IconLeftToRightListStarDuotoneRounded,
  IconLeftToRightListStarTwotoneRounded,
  IconLeftToRightListStarSolidRounded,
  IconLeftToRightListStarBulkRounded,
  IconLeftToRightListStarStrokeSharp,
  IconLeftToRightListStarSolidSharp,
];