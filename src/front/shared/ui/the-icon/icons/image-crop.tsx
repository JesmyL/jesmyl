...
export const IconImageCropStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageCrop StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconImageCropDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageCrop DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconImageCropTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageCrop TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconImageCropSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageCrop SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconImageCropBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageCrop BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconImageCropStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageCrop StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const iconPackOfImageCrop: TheIconSelfPack = [
  'ImageCrop',
  IconImageCropStrokeRounded,
  IconImageCropDuotoneRounded,
  IconImageCropTwotoneRounded,
  IconImageCropSolidRounded,
  IconImageCropBulkRounded,
  IconImageCropStrokeSharp,
  IconImageCropSolidSharp,
];