...
export const IconSquareSingleFireStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareSingleFire StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconSquareSingleFireDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareSingleFire DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr o7"
...
export const IconSquareSingleFireTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareSingleFire TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconSquareSingleFireSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareSingleFire SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconSquareSingleFireBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareSingleFire BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconSquareSingleFireStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareSingleFire StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconSquareSingleFireSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareSingleFire SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfSquareSingleFire: TheIconSelfPack = [
  'SquareSingleFire',
  IconSquareSingleFireStrokeRounded,
  IconSquareSingleFireDuotoneRounded,
  IconSquareSingleFireTwotoneRounded,
  IconSquareSingleFireSolidRounded,
  IconSquareSingleFireBulkRounded,
  IconSquareSingleFireStrokeSharp,
  IconSquareSingleFireSolidSharp,
];