...
export const IconAuctionStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Auction StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconAuctionDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Auction DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconAuctionTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Auction TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sw"
...
export const iconPackOfAuction: TheIconSelfPack = [
  'Auction',
  IconAuctionStrokeRounded,
  IconAuctionDuotoneRounded,
  IconAuctionTwotoneRounded,
  IconAuctionSolidRounded,
  IconAuctionBulkRounded,
  IconAuctionStrokeSharp,
  IconAuctionSolidSharp,
];