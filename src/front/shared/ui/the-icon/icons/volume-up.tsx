...
export const IconVolumeUpStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VolumeUp StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconVolumeUpDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VolumeUp DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconVolumeUpTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VolumeUp TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconVolumeUpSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VolumeUp SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const iconPackOfVolumeUp: TheIconSelfPack = [
  'VolumeUp',
  IconVolumeUpStrokeRounded,
  IconVolumeUpDuotoneRounded,
  IconVolumeUpTwotoneRounded,
  IconVolumeUpSolidRounded,
  IconVolumeUpBulkRounded,
  IconVolumeUpStrokeSharp,
  IconVolumeUpSolidSharp,
];