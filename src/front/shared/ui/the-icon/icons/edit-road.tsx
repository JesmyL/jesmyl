...
export const IconEditRoadStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EditRoad StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconEditRoadDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EditRoad DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconEditRoadTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EditRoad TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconEditRoadSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EditRoad SolidRounded"
    >
      <path 
        d={d.d14}
        i-c="f"
...
export const iconPackOfEditRoad: TheIconSelfPack = [
  'EditRoad',
  IconEditRoadStrokeRounded,
  IconEditRoadDuotoneRounded,
  IconEditRoadTwotoneRounded,
  IconEditRoadSolidRounded,
  IconEditRoadBulkRounded,
  IconEditRoadStrokeSharp,
  IconEditRoadSolidSharp,
];