...
export const IconHealtcareStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Healtcare StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconHealtcareDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Healtcare DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconHealtcareTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Healtcare TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconHealtcareSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Healtcare SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconHealtcareBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Healtcare BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconHealtcareStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Healtcare StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sr sw"
...
export const iconPackOfHealtcare: TheIconSelfPack = [
  'Healtcare',
  IconHealtcareStrokeRounded,
  IconHealtcareDuotoneRounded,
  IconHealtcareTwotoneRounded,
  IconHealtcareSolidRounded,
  IconHealtcareBulkRounded,
  IconHealtcareStrokeSharp,
  IconHealtcareSolidSharp,
];