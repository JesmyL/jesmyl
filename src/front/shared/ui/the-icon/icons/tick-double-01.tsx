...
export const IconTickDouble01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TickDouble01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTickDouble01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TickDouble01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTickDouble01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TickDouble01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconTickDouble01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TickDouble01 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconTickDouble01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TickDouble01 BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d3}
...
export const IconTickDouble01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TickDouble01 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const IconTickDouble01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TickDouble01 SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfTickDouble01: TheIconSelfPack = [
  'TickDouble01',
  IconTickDouble01StrokeRounded,
  IconTickDouble01DuotoneRounded,
  IconTickDouble01TwotoneRounded,
  IconTickDouble01SolidRounded,
  IconTickDouble01BulkRounded,
  IconTickDouble01StrokeSharp,
  IconTickDouble01SolidSharp,
];