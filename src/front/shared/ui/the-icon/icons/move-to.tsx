...
export const IconMoveToDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoveTo DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="o7 s sr sw"
...
export const IconMoveToTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoveTo TwotoneRounded"
    >
      <path 
        d={d.d13}
        i-c="s sr sw"
...
export const iconPackOfMoveTo: TheIconSelfPack = [
  'MoveTo',
  IconMoveToStrokeRounded,
  IconMoveToDuotoneRounded,
  IconMoveToTwotoneRounded,
  IconMoveToSolidRounded,
  IconMoveToBulkRounded,
  IconMoveToStrokeSharp,
  IconMoveToSolidSharp,
];