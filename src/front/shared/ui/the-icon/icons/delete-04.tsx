...
export const IconDelete04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Delete04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDelete04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Delete04 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconDelete04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Delete04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDelete04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Delete04 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfDelete04: TheIconSelfPack = [
  'Delete04',
  IconDelete04StrokeRounded,
  IconDelete04DuotoneRounded,
  IconDelete04TwotoneRounded,
  IconDelete04SolidRounded,
  IconDelete04BulkRounded,
  IconDelete04StrokeSharp,
  IconDelete04SolidSharp,
];