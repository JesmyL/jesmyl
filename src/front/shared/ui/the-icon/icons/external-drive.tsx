...
export const IconExternalDriveStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ExternalDrive StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconExternalDriveDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ExternalDrive DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconExternalDriveTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ExternalDrive TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconExternalDriveSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ExternalDrive SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconExternalDriveBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ExternalDrive BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconExternalDriveStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ExternalDrive StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sw"
...
export const IconExternalDriveSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ExternalDrive SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfExternalDrive: TheIconSelfPack = [
  'ExternalDrive',
  IconExternalDriveStrokeRounded,
  IconExternalDriveDuotoneRounded,
  IconExternalDriveTwotoneRounded,
  IconExternalDriveSolidRounded,
  IconExternalDriveBulkRounded,
  IconExternalDriveStrokeSharp,
  IconExternalDriveSolidSharp,
];