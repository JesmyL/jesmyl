...
export const IconHotspotStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Hotspot StrokeRounded"
    >
      <circle 
        cx="12"
        cy="14"
...
export const IconHotspotDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Hotspot DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="14"
...
export const IconHotspotTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Hotspot TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="14"
...
export const iconPackOfHotspot: TheIconSelfPack = [
  'Hotspot',
  IconHotspotStrokeRounded,
  IconHotspotDuotoneRounded,
  IconHotspotTwotoneRounded,
  IconHotspotSolidRounded,
  IconHotspotBulkRounded,
  IconHotspotStrokeSharp,
  IconHotspotSolidSharp,
];