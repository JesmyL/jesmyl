...
export const IconFile02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="File02 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconFile02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="File02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfFile02: TheIconSelfPack = [
  'File02',
  IconFile02StrokeRounded,
  IconFile02DuotoneRounded,
  IconFile02TwotoneRounded,
  IconFile02SolidRounded,
  IconFile02BulkRounded,
  IconFile02StrokeSharp,
  IconFile02SolidSharp,
];