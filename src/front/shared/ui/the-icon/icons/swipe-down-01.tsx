...
export const IconSwipeDown01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeDown01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSwipeDown01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeDown01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconSwipeDown01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeDown01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconSwipeDown01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeDown01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconSwipeDown01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeDown01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconSwipeDown01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeDown01 StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const IconSwipeDown01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeDown01 SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfSwipeDown01: TheIconSelfPack = [
  'SwipeDown01',
  IconSwipeDown01StrokeRounded,
  IconSwipeDown01DuotoneRounded,
  IconSwipeDown01TwotoneRounded,
  IconSwipeDown01SolidRounded,
  IconSwipeDown01BulkRounded,
  IconSwipeDown01StrokeSharp,
  IconSwipeDown01SolidSharp,
];