...
export const IconCancelSquareStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CancelSquare StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCancelSquareDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CancelSquare DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconCancelSquareTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CancelSquare TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconCancelSquareSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CancelSquare SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconCancelSquareBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CancelSquare BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconCancelSquareStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CancelSquare StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const IconCancelSquareSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CancelSquare SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfCancelSquare: TheIconSelfPack = [
  'CancelSquare',
  IconCancelSquareStrokeRounded,
  IconCancelSquareDuotoneRounded,
  IconCancelSquareTwotoneRounded,
  IconCancelSquareSolidRounded,
  IconCancelSquareBulkRounded,
  IconCancelSquareStrokeSharp,
  IconCancelSquareSolidSharp,
];