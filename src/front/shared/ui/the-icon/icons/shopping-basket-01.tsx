...
export const IconShoppingBasket01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasket01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconShoppingBasket01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasket01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconShoppingBasket01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasket01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconShoppingBasket01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasket01 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconShoppingBasket01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasket01 BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconShoppingBasket01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasket01 StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sw"
...
export const IconShoppingBasket01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasket01 SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfShoppingBasket01: TheIconSelfPack = [
  'ShoppingBasket01',
  IconShoppingBasket01StrokeRounded,
  IconShoppingBasket01DuotoneRounded,
  IconShoppingBasket01TwotoneRounded,
  IconShoppingBasket01SolidRounded,
  IconShoppingBasket01BulkRounded,
  IconShoppingBasket01StrokeSharp,
  IconShoppingBasket01SolidSharp,
];