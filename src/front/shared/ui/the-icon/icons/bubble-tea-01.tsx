...
export const IconBubbleTea01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BubbleTea01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconBubbleTea01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BubbleTea01 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconBubbleTea01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BubbleTea01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconBubbleTea01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BubbleTea01 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconBubbleTea01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BubbleTea01 BulkRounded"
    >
      <path 
        d={d.d10}
        i-c="f o7"
...
export const IconBubbleTea01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BubbleTea01 StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const IconBubbleTea01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BubbleTea01 SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfBubbleTea01: TheIconSelfPack = [
  'BubbleTea01',
  IconBubbleTea01StrokeRounded,
  IconBubbleTea01DuotoneRounded,
  IconBubbleTea01TwotoneRounded,
  IconBubbleTea01SolidRounded,
  IconBubbleTea01BulkRounded,
  IconBubbleTea01StrokeSharp,
  IconBubbleTea01SolidSharp,
];