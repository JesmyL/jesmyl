...
export const IconSortingDownStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingDown StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSortingDownDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingDown DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="s sj sr sw"
...
export const IconSortingDownTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingDown TwotoneRounded"
    >
      <path 
        d={d.d11}
        i-c="s sj sr sw"
...
export const IconSortingDownSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingDown SolidRounded"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const IconSortingDownBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingDown BulkRounded"
    >
      <path 
        d={d.d15}
        i-c="c f fr o7"
...
export const IconSortingDownStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingDown StrokeSharp"
    >
      <path 
        d={d.d20}
        i-c="s sj sw"
...
export const IconSortingDownSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingDown SolidSharp"
    >
      <path 
        d={d.d25}
        i-c="c f fr"
...
export const iconPackOfSortingDown: TheIconSelfPack = [
  'SortingDown',
  IconSortingDownStrokeRounded,
  IconSortingDownDuotoneRounded,
  IconSortingDownTwotoneRounded,
  IconSortingDownSolidRounded,
  IconSortingDownBulkRounded,
  IconSortingDownStrokeSharp,
  IconSortingDownSolidSharp,
];