...
export const IconAutoConversationsStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AutoConversations StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAutoConversationsDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AutoConversations DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="o7 s sj sr sw"
...
export const IconAutoConversationsTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AutoConversations TwotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="s sj sr sw"
...
export const IconAutoConversationsSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AutoConversations SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconAutoConversationsBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AutoConversations BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconAutoConversationsStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AutoConversations StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconAutoConversationsSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AutoConversations SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfAutoConversations: TheIconSelfPack = [
  'AutoConversations',
  IconAutoConversationsStrokeRounded,
  IconAutoConversationsDuotoneRounded,
  IconAutoConversationsTwotoneRounded,
  IconAutoConversationsSolidRounded,
  IconAutoConversationsBulkRounded,
  IconAutoConversationsStrokeSharp,
  IconAutoConversationsSolidSharp,
];