...
export const IconRouteBlockStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RouteBlock StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRouteBlockDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RouteBlock DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRouteBlockTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RouteBlock TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconRouteBlockSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RouteBlock SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconRouteBlockBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RouteBlock BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconRouteBlockStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RouteBlock StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconRouteBlockSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RouteBlock SolidSharp"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const iconPackOfRouteBlock: TheIconSelfPack = [
  'RouteBlock',
  IconRouteBlockStrokeRounded,
  IconRouteBlockDuotoneRounded,
  IconRouteBlockTwotoneRounded,
  IconRouteBlockSolidRounded,
  IconRouteBlockBulkRounded,
  IconRouteBlockStrokeSharp,
  IconRouteBlockSolidSharp,
];