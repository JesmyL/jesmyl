...
export const IconChemistry01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Chemistry01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconChemistry01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Chemistry01 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconChemistry01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Chemistry01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconChemistry01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Chemistry01 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconChemistry01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Chemistry01 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconChemistry01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Chemistry01 StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sw"
...
export const IconChemistry01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Chemistry01 SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfChemistry01: TheIconSelfPack = [
  'Chemistry01',
  IconChemistry01StrokeRounded,
  IconChemistry01DuotoneRounded,
  IconChemistry01TwotoneRounded,
  IconChemistry01SolidRounded,
  IconChemistry01BulkRounded,
  IconChemistry01StrokeSharp,
  IconChemistry01SolidSharp,
];