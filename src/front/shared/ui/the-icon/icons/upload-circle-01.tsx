...
export const IconUploadCircle01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UploadCircle01 StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconUploadCircle01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UploadCircle01 DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconUploadCircle01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UploadCircle01 TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconUploadCircle01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UploadCircle01 SolidRounded"
    >
      <path 
        d={d.d2}
        i-c="c f fr"
...
export const IconUploadCircle01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UploadCircle01 BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconUploadCircle01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UploadCircle01 StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sw"
...
export const IconUploadCircle01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UploadCircle01 SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfUploadCircle01: TheIconSelfPack = [
  'UploadCircle01',
  IconUploadCircle01StrokeRounded,
  IconUploadCircle01DuotoneRounded,
  IconUploadCircle01TwotoneRounded,
  IconUploadCircle01SolidRounded,
  IconUploadCircle01BulkRounded,
  IconUploadCircle01StrokeSharp,
  IconUploadCircle01SolidSharp,
];