...
export const IconUserCheck01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserCheck01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserCheck01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserCheck01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconUserCheck01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserCheck01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconUserCheck01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserCheck01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconUserCheck01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserCheck01 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconUserCheck01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserCheck01 StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sw"
...
export const IconUserCheck01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserCheck01 SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfUserCheck01: TheIconSelfPack = [
  'UserCheck01',
  IconUserCheck01StrokeRounded,
  IconUserCheck01DuotoneRounded,
  IconUserCheck01TwotoneRounded,
  IconUserCheck01SolidRounded,
  IconUserCheck01BulkRounded,
  IconUserCheck01StrokeSharp,
  IconUserCheck01SolidSharp,
];