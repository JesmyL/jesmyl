...
export const IconWashingtonMonumentStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WashingtonMonument StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconWashingtonMonumentDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WashingtonMonument DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconWashingtonMonumentTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WashingtonMonument TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconWashingtonMonumentSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WashingtonMonument SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconWashingtonMonumentBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WashingtonMonument BulkRounded"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const IconWashingtonMonumentStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WashingtonMonument StrokeSharp"
    >
      <path 
        d={d.d14}
        i-c="s sw"
...
export const IconWashingtonMonumentSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WashingtonMonument SolidSharp"
    >
      <path 
        d={d.d19}
        i-c="f"
...
export const iconPackOfWashingtonMonument: TheIconSelfPack = [
  'WashingtonMonument',
  IconWashingtonMonumentStrokeRounded,
  IconWashingtonMonumentDuotoneRounded,
  IconWashingtonMonumentTwotoneRounded,
  IconWashingtonMonumentSolidRounded,
  IconWashingtonMonumentBulkRounded,
  IconWashingtonMonumentStrokeSharp,
  IconWashingtonMonumentSolidSharp,
];