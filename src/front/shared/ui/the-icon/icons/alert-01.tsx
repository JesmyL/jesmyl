...
export const IconAlert01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Alert01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconAlert01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Alert01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconAlert01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Alert01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfAlert01: TheIconSelfPack = [
  ...
  IconAlert01DuotoneRounded,
  IconAlert01TwotoneRounded,
  IconAlert01SolidRounded,
  IconAlert01BulkRounded,
  IconAlert01StrokeSharp,
  IconAlert01SolidSharp,
];