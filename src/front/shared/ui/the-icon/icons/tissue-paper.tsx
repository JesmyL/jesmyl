...
export const IconTissuePaperStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TissuePaper StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconTissuePaperDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TissuePaper DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconTissuePaperTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TissuePaper TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconTissuePaperSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TissuePaper SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconTissuePaperBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TissuePaper BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconTissuePaperStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TissuePaper StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconTissuePaperSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TissuePaper SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfTissuePaper: TheIconSelfPack = [
  'TissuePaper',
  IconTissuePaperStrokeRounded,
  IconTissuePaperDuotoneRounded,
  IconTissuePaperTwotoneRounded,
  IconTissuePaperSolidRounded,
  IconTissuePaperBulkRounded,
  IconTissuePaperStrokeSharp,
  IconTissuePaperSolidSharp,
];