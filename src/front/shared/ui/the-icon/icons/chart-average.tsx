...
export const IconChartAverageStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartAverage StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconChartAverageDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartAverage DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconChartAverageTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartAverage TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconChartAverageSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartAverage SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconChartAverageBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartAverage BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconChartAverageStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartAverage StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconChartAverageSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartAverage SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfChartAverage: TheIconSelfPack = [
  'ChartAverage',
  IconChartAverageStrokeRounded,
  IconChartAverageDuotoneRounded,
  IconChartAverageTwotoneRounded,
  IconChartAverageSolidRounded,
  IconChartAverageBulkRounded,
  IconChartAverageStrokeSharp,
  IconChartAverageSolidSharp,
];