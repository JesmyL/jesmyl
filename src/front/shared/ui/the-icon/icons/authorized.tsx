...
export const IconAuthorizedStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Authorized StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAuthorizedDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Authorized DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconAuthorizedTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Authorized TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAuthorizedSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Authorized SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconAuthorizedBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Authorized BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconAuthorizedStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Authorized StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sr sw"
...
export const IconAuthorizedSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Authorized SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfAuthorized: TheIconSelfPack = [
  'Authorized',
  IconAuthorizedStrokeRounded,
  IconAuthorizedDuotoneRounded,
  IconAuthorizedTwotoneRounded,
  IconAuthorizedSolidRounded,
  IconAuthorizedBulkRounded,
  IconAuthorizedStrokeSharp,
  IconAuthorizedSolidSharp,
];