...
export const IconHierarchyFilesStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HierarchyFiles StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHierarchyFilesDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HierarchyFiles DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconHierarchyFilesTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HierarchyFiles TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHierarchyFilesSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HierarchyFiles SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconHierarchyFilesBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HierarchyFiles BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconHierarchyFilesStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HierarchyFiles StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconHierarchyFilesSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HierarchyFiles SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfHierarchyFiles: TheIconSelfPack = [
  'HierarchyFiles',
  IconHierarchyFilesStrokeRounded,
  IconHierarchyFilesDuotoneRounded,
  IconHierarchyFilesTwotoneRounded,
  IconHierarchyFilesSolidRounded,
  IconHierarchyFilesBulkRounded,
  IconHierarchyFilesStrokeSharp,
  IconHierarchyFilesSolidSharp,
];