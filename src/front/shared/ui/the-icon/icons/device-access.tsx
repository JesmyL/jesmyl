...
export const IconDeviceAccessStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeviceAccess StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDeviceAccessDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeviceAccess DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconDeviceAccessTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeviceAccess TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDeviceAccessSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeviceAccess SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconDeviceAccessBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeviceAccess BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconDeviceAccessStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeviceAccess StrokeSharp"
    >
      <path 
        d={d.d3}
        i-c="s ss sw"
...
export const IconDeviceAccessSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeviceAccess SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfDeviceAccess: TheIconSelfPack = [
  'DeviceAccess',
  IconDeviceAccessStrokeRounded,
  IconDeviceAccessDuotoneRounded,
  IconDeviceAccessTwotoneRounded,
  IconDeviceAccessSolidRounded,
  IconDeviceAccessBulkRounded,
  IconDeviceAccessStrokeSharp,
  IconDeviceAccessSolidSharp,
];