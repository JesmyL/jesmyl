...
export const IconUmbrellaStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Umbrella StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUmbrellaDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Umbrella DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconUmbrellaTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Umbrella TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconUmbrellaSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Umbrella SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const iconPackOfUmbrella: TheIconSelfPack = [
  'Umbrella',
  IconUmbrellaStrokeRounded,
  IconUmbrellaDuotoneRounded,
  IconUmbrellaTwotoneRounded,
  IconUmbrellaSolidRounded,
  IconUmbrellaBulkRounded,
  IconUmbrellaStrokeSharp,
  IconUmbrellaSolidSharp,
];