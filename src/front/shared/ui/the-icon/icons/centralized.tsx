...
export const IconCentralizedStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Centralized StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCentralizedDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Centralized DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconCentralizedTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Centralized TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconCentralizedSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Centralized SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconCentralizedBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Centralized BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconCentralizedStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Centralized StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconCentralizedSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Centralized SolidSharp"
    >
      <path 
        d={d.d16}
        i-c="f"
...
export const iconPackOfCentralized: TheIconSelfPack = [
  'Centralized',
  IconCentralizedStrokeRounded,
  IconCentralizedDuotoneRounded,
  IconCentralizedTwotoneRounded,
  IconCentralizedSolidRounded,
  IconCentralizedBulkRounded,
  IconCentralizedStrokeSharp,
  IconCentralizedSolidSharp,
];