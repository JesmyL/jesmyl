...
export const IconWaterPumpStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WaterPump StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconWaterPumpDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WaterPump DuotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconWaterPumpTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WaterPump TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconWaterPumpSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WaterPump SolidRounded"
    >
      <path 
        d={d.d12}
        i-c="f"
...
export const IconWaterPumpBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WaterPump BulkRounded"
    >
      <path 
        d={d.d12}
        i-c="f"
...
export const IconWaterPumpStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WaterPump StrokeSharp"
    >
      <path 
        d={d.d18}
        i-c="s sw"
...
export const iconPackOfWaterPump: TheIconSelfPack = [
  'WaterPump',
  IconWaterPumpStrokeRounded,
  IconWaterPumpDuotoneRounded,
  IconWaterPumpTwotoneRounded,
  IconWaterPumpSolidRounded,
  IconWaterPumpBulkRounded,
  IconWaterPumpStrokeSharp,
  IconWaterPumpSolidSharp,
];