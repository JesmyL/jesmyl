...
export const IconBitcoin02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bitcoin02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBitcoin02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bitcoin02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconBitcoin02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bitcoin02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconBitcoin02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bitcoin02 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconBitcoin02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bitcoin02 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconBitcoin02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bitcoin02 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfBitcoin02: TheIconSelfPack = [
  'Bitcoin02',
  IconBitcoin02StrokeRounded,
  IconBitcoin02DuotoneRounded,
  IconBitcoin02TwotoneRounded,
  IconBitcoin02SolidRounded,
  IconBitcoin02BulkRounded,
  IconBitcoin02StrokeSharp,
  IconBitcoin02SolidSharp,
];