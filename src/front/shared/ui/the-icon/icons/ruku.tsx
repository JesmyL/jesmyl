...
export const iconPackOfRuku: TheIconSelfPack = [
  'Ruku',
  IconRukuStrokeRounded,
  IconRukuDuotoneRounded,
  IconRukuTwotoneRounded,
  IconRukuSolidRounded,
  IconRukuBulkRounded,
  IconRukuStrokeSharp,
  IconRukuSolidSharp,
];