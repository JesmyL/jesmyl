...
export const IconUserStoryStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserStory StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserStoryDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserStory DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconUserStoryTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserStory TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserStorySolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserStory SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconUserStoryBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserStory BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconUserStoryStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserStory StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfUserStory: TheIconSelfPack = [
  'UserStory',
  IconUserStoryStrokeRounded,
  IconUserStoryDuotoneRounded,
  IconUserStoryTwotoneRounded,
  IconUserStorySolidRounded,
  IconUserStoryBulkRounded,
  IconUserStoryStrokeSharp,
  IconUserStorySolidSharp,
];