...
export const IconFilterDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Filter DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconFilterTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Filter TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfFilter: TheIconSelfPack = [
  'Filter',
  IconFilterStrokeRounded,
  IconFilterDuotoneRounded,
  IconFilterTwotoneRounded,
  IconFilterSolidRounded,
  IconFilterBulkRounded,
  IconFilterStrokeSharp,
  IconFilterSolidSharp,
];