...
export const IconLibrariesStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Libraries StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLibrariesDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Libraries DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconLibrariesTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Libraries TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconLibrariesSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Libraries SolidRounded"
    >
      <path 
        d={d.d1}
        i-c="f"
...
export const IconLibrariesBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Libraries BulkRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconLibrariesStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Libraries StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sr sw"
...
export const iconPackOfLibraries: TheIconSelfPack = [
  'Libraries',
  IconLibrariesStrokeRounded,
  IconLibrariesDuotoneRounded,
  IconLibrariesTwotoneRounded,
  IconLibrariesSolidRounded,
  IconLibrariesBulkRounded,
  IconLibrariesStrokeSharp,
  IconLibrariesSolidSharp,
];