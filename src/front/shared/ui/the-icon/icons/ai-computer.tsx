...
export const IconAiComputerStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiComputer StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconAiComputerDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiComputer DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconAiComputerTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiComputer TwotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="s sr sw"
...
export const IconAiComputerSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiComputer SolidRounded"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const IconAiComputerBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiComputer BulkRounded"
    >
      <path 
        d={d.d13}
        i-c="c f fr o7"
...
export const IconAiComputerStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiComputer StrokeSharp"
    >
      <path 
        d={d.d16}
        i-c="s sw"
...
export const IconAiComputerSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiComputer SolidSharp"
    >
      <path 
        d={d.d20}
        i-c="c f fr"
...
export const iconPackOfAiComputer: TheIconSelfPack = [
  'AiComputer',
  IconAiComputerStrokeRounded,
  IconAiComputerDuotoneRounded,
  IconAiComputerTwotoneRounded,
  IconAiComputerSolidRounded,
  IconAiComputerBulkRounded,
  IconAiComputerStrokeSharp,
  IconAiComputerSolidSharp,
];