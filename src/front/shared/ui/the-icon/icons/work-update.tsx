...
export const IconWorkUpdateStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkUpdate StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconWorkUpdateDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkUpdate DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconWorkUpdateTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkUpdate TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconWorkUpdateSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkUpdate SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconWorkUpdateBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkUpdate BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconWorkUpdateStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkUpdate StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconWorkUpdateSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkUpdate SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfWorkUpdate: TheIconSelfPack = [
  'WorkUpdate',
  IconWorkUpdateStrokeRounded,
  IconWorkUpdateDuotoneRounded,
  IconWorkUpdateTwotoneRounded,
  IconWorkUpdateSolidRounded,
  IconWorkUpdateBulkRounded,
  IconWorkUpdateStrokeSharp,
  IconWorkUpdateSolidSharp,
];