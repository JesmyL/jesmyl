...
export const IconSearch02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Search02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconSearch02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Search02 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconSearch02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Search02 TwotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="o7 s sr sw"
...
export const IconSearch02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Search02 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const iconPackOfSearch02: TheIconSelfPack = [
  'Search02',
  IconSearch02StrokeRounded,
  IconSearch02DuotoneRounded,
  IconSearch02TwotoneRounded,
  IconSearch02SolidRounded,
  IconSearch02BulkRounded,
  IconSearch02StrokeSharp,
  IconSearch02SolidSharp,
];