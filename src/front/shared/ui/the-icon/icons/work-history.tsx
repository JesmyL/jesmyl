...
export const IconWorkHistoryStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkHistory StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconWorkHistoryDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkHistory DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconWorkHistoryTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkHistory TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconWorkHistorySolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkHistory SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconWorkHistoryBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkHistory BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconWorkHistoryStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkHistory StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const IconWorkHistorySolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkHistory SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfWorkHistory: TheIconSelfPack = [
  'WorkHistory',
  IconWorkHistoryStrokeRounded,
  IconWorkHistoryDuotoneRounded,
  IconWorkHistoryTwotoneRounded,
  IconWorkHistorySolidRounded,
  IconWorkHistoryBulkRounded,
  IconWorkHistoryStrokeSharp,
  IconWorkHistorySolidSharp,
];