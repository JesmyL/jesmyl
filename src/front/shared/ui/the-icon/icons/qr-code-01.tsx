...
export const IconQrCode01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="QrCode01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconQrCode01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="QrCode01 DuotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr o7"
...
export const IconQrCode01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="QrCode01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconQrCode01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="QrCode01 SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfQrCode01: TheIconSelfPack = [
  'QrCode01',
  IconQrCode01StrokeRounded,
  IconQrCode01DuotoneRounded,
  IconQrCode01TwotoneRounded,
  IconQrCode01SolidRounded,
  IconQrCode01BulkRounded,
  IconQrCode01StrokeSharp,
  IconQrCode01SolidSharp,
];