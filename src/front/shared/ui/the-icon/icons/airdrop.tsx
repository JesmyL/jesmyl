...
export const IconAirdropStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Airdrop StrokeRounded"
    >
      <circle 
        cx="12"
        cy="11"
...
export const IconAirdropDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Airdrop DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconAirdropTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Airdrop TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="11"
...
export const iconPackOfAirdrop: TheIconSelfPack = [
  'Airdrop',
  IconAirdropStrokeRounded,
  IconAirdropDuotoneRounded,
  IconAirdropTwotoneRounded,
  IconAirdropSolidRounded,
  IconAirdropBulkRounded,
  IconAirdropStrokeSharp,
  IconAirdropSolidSharp,
];