...
export const IconGroupItemsStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GroupItems StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconGroupItemsDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GroupItems DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconGroupItemsTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GroupItems TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconGroupItemsSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GroupItems SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconGroupItemsBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GroupItems BulkRounded"
    >
      <path 
        d={d.d15}
        i-c="f o7"
...
export const IconGroupItemsStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GroupItems StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconGroupItemsSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GroupItems SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const iconPackOfGroupItems: TheIconSelfPack = [
  'GroupItems',
  IconGroupItemsStrokeRounded,
  IconGroupItemsDuotoneRounded,
  IconGroupItemsTwotoneRounded,
  IconGroupItemsSolidRounded,
  IconGroupItemsBulkRounded,
  IconGroupItemsStrokeSharp,
  IconGroupItemsSolidSharp,
];