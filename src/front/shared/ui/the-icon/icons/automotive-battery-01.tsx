...
export const IconAutomotiveBattery01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AutomotiveBattery01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconAutomotiveBattery01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AutomotiveBattery01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconAutomotiveBattery01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AutomotiveBattery01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconAutomotiveBattery01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AutomotiveBattery01 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconAutomotiveBattery01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AutomotiveBattery01 BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconAutomotiveBattery01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AutomotiveBattery01 StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const IconAutomotiveBattery01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AutomotiveBattery01 SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfAutomotiveBattery01: TheIconSelfPack = [
  'AutomotiveBattery01',
  IconAutomotiveBattery01StrokeRounded,
  IconAutomotiveBattery01DuotoneRounded,
  IconAutomotiveBattery01TwotoneRounded,
  IconAutomotiveBattery01SolidRounded,
  IconAutomotiveBattery01BulkRounded,
  IconAutomotiveBattery01StrokeSharp,
  IconAutomotiveBattery01SolidSharp,
];