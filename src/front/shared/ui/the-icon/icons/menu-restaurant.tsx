...
export const IconMenuRestaurantStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MenuRestaurant StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMenuRestaurantDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MenuRestaurant DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconMenuRestaurantTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MenuRestaurant TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMenuRestaurantSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MenuRestaurant SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconMenuRestaurantBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MenuRestaurant BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconMenuRestaurantStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MenuRestaurant StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sw"
...
export const IconMenuRestaurantSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MenuRestaurant SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfMenuRestaurant: TheIconSelfPack = [
  'MenuRestaurant',
  IconMenuRestaurantStrokeRounded,
  IconMenuRestaurantDuotoneRounded,
  IconMenuRestaurantTwotoneRounded,
  IconMenuRestaurantSolidRounded,
  IconMenuRestaurantBulkRounded,
  IconMenuRestaurantStrokeSharp,
  IconMenuRestaurantSolidSharp,
];