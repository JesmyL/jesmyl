...
export const IconSortingAZ02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingAZ02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSortingAZ02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingAZ02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSortingAZ02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingAZ02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconSortingAZ02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingAZ02 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconSortingAZ02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingAZ02 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconSortingAZ02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingAZ02 StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const IconSortingAZ02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingAZ02 SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfSortingAZ02: TheIconSelfPack = [
  'SortingAZ02',
  IconSortingAZ02StrokeRounded,
  IconSortingAZ02DuotoneRounded,
  IconSortingAZ02TwotoneRounded,
  IconSortingAZ02SolidRounded,
  IconSortingAZ02BulkRounded,
  IconSortingAZ02StrokeSharp,
  IconSortingAZ02SolidSharp,
];