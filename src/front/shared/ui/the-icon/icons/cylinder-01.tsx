...
export const IconCylinder01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cylinder01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconCylinder01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cylinder01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconCylinder01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cylinder01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconCylinder01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cylinder01 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconCylinder01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cylinder01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconCylinder01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cylinder01 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconCylinder01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cylinder01 SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfCylinder01: TheIconSelfPack = [
  'Cylinder01',
  IconCylinder01StrokeRounded,
  IconCylinder01DuotoneRounded,
  IconCylinder01TwotoneRounded,
  IconCylinder01SolidRounded,
  IconCylinder01BulkRounded,
  IconCylinder01StrokeSharp,
  IconCylinder01SolidSharp,
];