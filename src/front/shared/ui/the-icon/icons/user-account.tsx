...
export const IconUserAccountStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserAccount StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconUserAccountDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserAccount DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconUserAccountTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserAccount TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconUserAccountSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserAccount SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconUserAccountBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserAccount BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconUserAccountStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserAccount StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const IconUserAccountSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserAccount SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfUserAccount: TheIconSelfPack = [
  'UserAccount',
  IconUserAccountStrokeRounded,
  IconUserAccountDuotoneRounded,
  IconUserAccountTwotoneRounded,
  IconUserAccountSolidRounded,
  IconUserAccountBulkRounded,
  IconUserAccountStrokeSharp,
  IconUserAccountSolidSharp,
];