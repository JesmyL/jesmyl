...
export const IconTime02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Time02 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr o7"
...
export const IconTime02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Time02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfTime02: TheIconSelfPack = [
  'Time02',
  IconTime02StrokeRounded,
  IconTime02DuotoneRounded,
  IconTime02TwotoneRounded,
  IconTime02SolidRounded,
  IconTime02BulkRounded,
  IconTime02StrokeSharp,
  IconTime02SolidSharp,
];