...
export const IconUserStar02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserStar02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserStar02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserStar02 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconUserStar02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserStar02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserStar02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserStar02 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconUserStar02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserStar02 BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d4}
...
export const IconUserStar02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserStar02 StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const IconUserStar02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserStar02 SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfUserStar02: TheIconSelfPack = [
  'UserStar02',
  IconUserStar02StrokeRounded,
  IconUserStar02DuotoneRounded,
  IconUserStar02TwotoneRounded,
  IconUserStar02SolidRounded,
  IconUserStar02BulkRounded,
  IconUserStar02StrokeSharp,
  IconUserStar02SolidSharp,
];