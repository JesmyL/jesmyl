...
export const IconQuillWrite01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="QuillWrite01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconQuillWrite01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="QuillWrite01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconQuillWrite01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="QuillWrite01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconQuillWrite01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="QuillWrite01 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconQuillWrite01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="QuillWrite01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconQuillWrite01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="QuillWrite01 StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconQuillWrite01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="QuillWrite01 SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfQuillWrite01: TheIconSelfPack = [
  'QuillWrite01',
  IconQuillWrite01StrokeRounded,
  IconQuillWrite01DuotoneRounded,
  IconQuillWrite01TwotoneRounded,
  IconQuillWrite01SolidRounded,
  IconQuillWrite01BulkRounded,
  IconQuillWrite01StrokeSharp,
  IconQuillWrite01SolidSharp,
];