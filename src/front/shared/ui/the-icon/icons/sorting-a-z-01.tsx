...
export const IconSortingAZ01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingAZ01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSortingAZ01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingAZ01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconSortingAZ01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingAZ01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSortingAZ01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingAZ01 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconSortingAZ01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingAZ01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconSortingAZ01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingAZ01 StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sw"
...
export const IconSortingAZ01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingAZ01 SolidSharp"
    >
      <path 
        d={d.d16}
        i-c="c f fr"
...
export const iconPackOfSortingAZ01: TheIconSelfPack = [
  'SortingAZ01',
  IconSortingAZ01StrokeRounded,
  IconSortingAZ01DuotoneRounded,
  IconSortingAZ01TwotoneRounded,
  IconSortingAZ01SolidRounded,
  IconSortingAZ01BulkRounded,
  IconSortingAZ01StrokeSharp,
  IconSortingAZ01SolidSharp,
];