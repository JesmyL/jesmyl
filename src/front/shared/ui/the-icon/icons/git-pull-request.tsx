...
export const IconGitPullRequestStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitPullRequest StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGitPullRequestDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitPullRequest DuotoneRounded"
    >
      <circle 
        cx="6"
        cy="18"
...
export const IconGitPullRequestTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitPullRequest TwotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="o7 s sj sr sw"
...
export const IconGitPullRequestSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitPullRequest SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconGitPullRequestBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitPullRequest BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr o7"
...
export const IconGitPullRequestStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitPullRequest StrokeSharp"
    >
      <path 
        d={d.d14}
        i-c="s sj sw"
...
export const IconGitPullRequestSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitPullRequest SolidSharp"
    >
      <path 
        d={d.d16}
        i-c="c f fr"
...
export const iconPackOfGitPullRequest: TheIconSelfPack = [
  'GitPullRequest',
  IconGitPullRequestStrokeRounded,
  IconGitPullRequestDuotoneRounded,
  IconGitPullRequestTwotoneRounded,
  IconGitPullRequestSolidRounded,
  IconGitPullRequestBulkRounded,
  IconGitPullRequestStrokeSharp,
  IconGitPullRequestSolidSharp,
];