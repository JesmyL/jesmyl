...
export const IconRouterDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Router DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconRouterTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Router TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfRouter: TheIconSelfPack = [
  'Router',
  IconRouterStrokeRounded,
  IconRouterDuotoneRounded,
  IconRouterTwotoneRounded,
  IconRouterSolidRounded,
  IconRouterBulkRounded,
  IconRouterStrokeSharp,
  IconRouterSolidSharp,
];