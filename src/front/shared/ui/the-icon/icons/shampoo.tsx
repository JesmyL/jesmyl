...
export const IconShampooStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Shampoo StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconShampooDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Shampoo DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconShampooTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Shampoo TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfShampoo: TheIconSelfPack = [
  'Shampoo',
  IconShampooStrokeRounded,
  IconShampooDuotoneRounded,
  IconShampooTwotoneRounded,
  IconShampooSolidRounded,
  IconShampooBulkRounded,
  IconShampooStrokeSharp,
  IconShampooSolidSharp,
];