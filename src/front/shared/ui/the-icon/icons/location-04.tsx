...
export const IconLocation04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconLocation04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location04 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconLocation04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconLocation04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location04 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconLocation04BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location04 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconLocation04StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location04 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLocation04SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location04 SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfLocation04: TheIconSelfPack = [
  'Location04',
  IconLocation04StrokeRounded,
  IconLocation04DuotoneRounded,
  IconLocation04TwotoneRounded,
  IconLocation04SolidRounded,
  IconLocation04BulkRounded,
  IconLocation04StrokeSharp,
  IconLocation04SolidSharp,
];