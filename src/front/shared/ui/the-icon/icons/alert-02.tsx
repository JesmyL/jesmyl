...
export const IconAlert02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Alert02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconAlert02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Alert02 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconAlert02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Alert02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfAlert02: TheIconSelfPack = [
  ...
  IconAlert02DuotoneRounded,
  IconAlert02TwotoneRounded,
  IconAlert02SolidRounded,
  IconAlert02BulkRounded,
  IconAlert02StrokeSharp,
  IconAlert02SolidSharp,
];