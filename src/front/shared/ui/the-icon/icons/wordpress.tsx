...
export const IconWordpressStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wordpress StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconWordpressDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wordpress DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconWordpressTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wordpress TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconWordpressSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wordpress SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconWordpressBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wordpress BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconWordpressStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wordpress StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const iconPackOfWordpress: TheIconSelfPack = [
  'Wordpress',
  IconWordpressStrokeRounded,
  IconWordpressDuotoneRounded,
  IconWordpressTwotoneRounded,
  IconWordpressSolidRounded,
  IconWordpressBulkRounded,
  IconWordpressStrokeSharp,
  IconWordpressSolidSharp,
];