...
export const IconStartUp01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StartUp01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconStartUp01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StartUp01 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconStartUp01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StartUp01 TwotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="s sj sr sw"
...
export const IconStartUp01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StartUp01 SolidRounded"
    >
      <path 
        d={d.d12}
        i-c="f"
...
export const IconStartUp01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StartUp01 BulkRounded"
    >
      <path 
        d={d.d12}
        i-c="f"
...
export const IconStartUp01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StartUp01 StrokeSharp"
    >
      <path 
        d={d.d18}
        i-c="s sw"
...
export const iconPackOfStartUp01: TheIconSelfPack = [
  'StartUp01',
  IconStartUp01StrokeRounded,
  IconStartUp01DuotoneRounded,
  IconStartUp01TwotoneRounded,
  IconStartUp01SolidRounded,
  IconStartUp01BulkRounded,
  IconStartUp01StrokeSharp,
  IconStartUp01SolidSharp,
];