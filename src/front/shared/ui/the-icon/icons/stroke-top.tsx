...
export const IconStrokeTopStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeTop StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconStrokeTopDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeTop DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconStrokeTopTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeTop TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconStrokeTopSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeTop SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconStrokeTopBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeTop BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconStrokeTopStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeTop StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s ss sw"
...
export const iconPackOfStrokeTop: TheIconSelfPack = [
  'StrokeTop',
  IconStrokeTopStrokeRounded,
  IconStrokeTopDuotoneRounded,
  IconStrokeTopTwotoneRounded,
  IconStrokeTopSolidRounded,
  IconStrokeTopBulkRounded,
  IconStrokeTopStrokeSharp,
  IconStrokeTopSolidSharp,
];