...
export const IconPlayListMinusStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListMinus StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconPlayListMinusDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListMinus DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconPlayListMinusTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListMinus TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconPlayListMinusSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListMinus SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const IconPlayListMinusBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListMinus BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d9}
...
export const IconPlayListMinusStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListMinus StrokeSharp"
    >
      <path 
        d={d.d14}
        i-c="s sj sw"
...
export const IconPlayListMinusSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListMinus SolidSharp"
    >
      <path 
        d={d.d19}
        i-c="c f fr"
...
export const iconPackOfPlayListMinus: TheIconSelfPack = [
  'PlayListMinus',
  IconPlayListMinusStrokeRounded,
  IconPlayListMinusDuotoneRounded,
  IconPlayListMinusTwotoneRounded,
  IconPlayListMinusSolidRounded,
  IconPlayListMinusBulkRounded,
  IconPlayListMinusStrokeSharp,
  IconPlayListMinusSolidSharp,
];