...
export const IconRiceBowl02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RiceBowl02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRiceBowl02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RiceBowl02 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconRiceBowl02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RiceBowl02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconRiceBowl02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RiceBowl02 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconRiceBowl02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RiceBowl02 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconRiceBowl02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RiceBowl02 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconRiceBowl02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RiceBowl02 SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="f"
...
export const iconPackOfRiceBowl02: TheIconSelfPack = [
  'RiceBowl02',
  IconRiceBowl02StrokeRounded,
  IconRiceBowl02DuotoneRounded,
  IconRiceBowl02TwotoneRounded,
  IconRiceBowl02SolidRounded,
  IconRiceBowl02BulkRounded,
  IconRiceBowl02StrokeSharp,
  IconRiceBowl02SolidSharp,
];