...
export const IconToggleOnStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ToggleOn StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconToggleOnDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ToggleOn DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr o7"
...
export const IconToggleOnTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ToggleOn TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconToggleOnSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ToggleOn SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const iconPackOfToggleOn: TheIconSelfPack = [
  'ToggleOn',
  IconToggleOnStrokeRounded,
  IconToggleOnDuotoneRounded,
  IconToggleOnTwotoneRounded,
  IconToggleOnSolidRounded,
  IconToggleOnBulkRounded,
  IconToggleOnStrokeSharp,
  IconToggleOnSolidSharp,
];