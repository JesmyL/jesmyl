...
export const IconEthereumEllipseStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EthereumEllipse StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconEthereumEllipseDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EthereumEllipse DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="c f fr o7"
...
export const IconEthereumEllipseTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EthereumEllipse TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconEthereumEllipseSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EthereumEllipse SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconEthereumEllipseBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EthereumEllipse BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconEthereumEllipseStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EthereumEllipse StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconEthereumEllipseSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EthereumEllipse SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfEthereumEllipse: TheIconSelfPack = [
  'EthereumEllipse',
  IconEthereumEllipseStrokeRounded,
  IconEthereumEllipseDuotoneRounded,
  IconEthereumEllipseTwotoneRounded,
  IconEthereumEllipseSolidRounded,
  IconEthereumEllipseBulkRounded,
  IconEthereumEllipseStrokeSharp,
  IconEthereumEllipseSolidSharp,
];