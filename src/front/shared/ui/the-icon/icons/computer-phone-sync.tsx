...
export const IconComputerPhoneSyncStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerPhoneSync StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconComputerPhoneSyncDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerPhoneSync DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconComputerPhoneSyncTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerPhoneSync TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconComputerPhoneSyncSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerPhoneSync SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconComputerPhoneSyncBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerPhoneSync BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr o7"
...
export const IconComputerPhoneSyncStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerPhoneSync StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const IconComputerPhoneSyncSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerPhoneSync SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfComputerPhoneSync: TheIconSelfPack = [
  'ComputerPhoneSync',
  IconComputerPhoneSyncStrokeRounded,
  IconComputerPhoneSyncDuotoneRounded,
  IconComputerPhoneSyncTwotoneRounded,
  IconComputerPhoneSyncSolidRounded,
  IconComputerPhoneSyncBulkRounded,
  IconComputerPhoneSyncStrokeSharp,
  IconComputerPhoneSyncSolidSharp,
];