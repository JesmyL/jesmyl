...
export const IconSpeechToTextStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpeechToText StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSpeechToTextDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpeechToText DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconSpeechToTextTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpeechToText TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSpeechToTextSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpeechToText SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconSpeechToTextBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpeechToText BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconSpeechToTextStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpeechToText StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconSpeechToTextSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpeechToText SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfSpeechToText: TheIconSelfPack = [
  'SpeechToText',
  IconSpeechToTextStrokeRounded,
  IconSpeechToTextDuotoneRounded,
  IconSpeechToTextTwotoneRounded,
  IconSpeechToTextSolidRounded,
  IconSpeechToTextBulkRounded,
  IconSpeechToTextStrokeSharp,
  IconSpeechToTextSolidSharp,
];