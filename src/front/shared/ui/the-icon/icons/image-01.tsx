...
export const IconImage01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Image01 StrokeRounded"
    >
      <circle 
        cx="7.5"
        cy="7.5"
...
export const IconImage01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Image01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr o7"
...
export const IconImage01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Image01 TwotoneRounded"
    >
      <circle 
        cx="7.5"
        cy="7.5"
...
export const iconPackOfImage01: TheIconSelfPack = [
  'Image01',
  IconImage01StrokeRounded,
  IconImage01DuotoneRounded,
  IconImage01TwotoneRounded,
  IconImage01SolidRounded,
  IconImage01BulkRounded,
  IconImage01StrokeSharp,
  IconImage01SolidSharp,
];