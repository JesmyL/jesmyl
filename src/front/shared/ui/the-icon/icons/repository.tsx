...
export const IconRepositoryStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Repository StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconRepositoryDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Repository DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconRepositoryTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Repository TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconRepositorySolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Repository SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconRepositoryBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Repository BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconRepositoryStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Repository StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconRepositorySolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Repository SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfRepository: TheIconSelfPack = [
  'Repository',
  IconRepositoryStrokeRounded,
  IconRepositoryDuotoneRounded,
  IconRepositoryTwotoneRounded,
  IconRepositorySolidRounded,
  IconRepositoryBulkRounded,
  IconRepositoryStrokeSharp,
  IconRepositorySolidSharp,
];