...
export const IconShoppingBasketDone01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketDone01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShoppingBasketDone01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketDone01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconShoppingBasketDone01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketDone01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShoppingBasketDone01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketDone01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconShoppingBasketDone01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketDone01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconShoppingBasketDone01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketDone01 StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sw"
...
export const IconShoppingBasketDone01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketDone01 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfShoppingBasketDone01: TheIconSelfPack = [
  ...
  IconShoppingBasketDone01StrokeRounded,
  IconShoppingBasketDone01DuotoneRounded,
  IconShoppingBasketDone01TwotoneRounded,
  IconShoppingBasketDone01SolidRounded,
  IconShoppingBasketDone01BulkRounded,
  IconShoppingBasketDone01StrokeSharp,
  IconShoppingBasketDone01SolidSharp,
];