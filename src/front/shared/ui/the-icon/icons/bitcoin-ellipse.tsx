...
export const IconBitcoinEllipseStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinEllipse StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconBitcoinEllipseDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinEllipse DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconBitcoinEllipseTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinEllipse TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconBitcoinEllipseSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinEllipse SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconBitcoinEllipseBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinEllipse BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconBitcoinEllipseStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinEllipse StrokeSharp"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconBitcoinEllipseSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinEllipse SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfBitcoinEllipse: TheIconSelfPack = [
  'BitcoinEllipse',
  IconBitcoinEllipseStrokeRounded,
  IconBitcoinEllipseDuotoneRounded,
  IconBitcoinEllipseTwotoneRounded,
  IconBitcoinEllipseSolidRounded,
  IconBitcoinEllipseBulkRounded,
  IconBitcoinEllipseStrokeSharp,
  IconBitcoinEllipseSolidSharp,
];