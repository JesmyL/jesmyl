...
export const IconMoonCloudStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoonCloud StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMoonCloudDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoonCloud DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconMoonCloudTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoonCloud TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMoonCloudSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoonCloud SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconMoonCloudBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoonCloud BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconMoonCloudStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoonCloud StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfMoonCloud: TheIconSelfPack = [
  'MoonCloud',
  IconMoonCloudStrokeRounded,
  IconMoonCloudDuotoneRounded,
  IconMoonCloudTwotoneRounded,
  IconMoonCloudSolidRounded,
  IconMoonCloudBulkRounded,
  IconMoonCloudStrokeSharp,
  IconMoonCloudSolidSharp,
];