...
export const IconPenTool01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PenTool01 StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconPenTool01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PenTool01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconPenTool01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PenTool01 TwotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="s sj sr sw"
...
export const IconPenTool01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PenTool01 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconPenTool01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PenTool01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconPenTool01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PenTool01 StrokeSharp"
    >
      <circle 
        cx="12"
        cy="12"
...
export const iconPackOfPenTool01: TheIconSelfPack = [
  'PenTool01',
  IconPenTool01StrokeRounded,
  IconPenTool01DuotoneRounded,
  IconPenTool01TwotoneRounded,
  IconPenTool01SolidRounded,
  IconPenTool01BulkRounded,
  IconPenTool01StrokeSharp,
  IconPenTool01SolidSharp,
];