...
export const IconAlignVerticalCenterStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignVerticalCenter StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAlignVerticalCenterDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignVerticalCenter DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconAlignVerticalCenterTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignVerticalCenter TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAlignVerticalCenterSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignVerticalCenter SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconAlignVerticalCenterBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignVerticalCenter BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const IconAlignVerticalCenterStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignVerticalCenter StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const IconAlignVerticalCenterSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignVerticalCenter SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfAlignVerticalCenter: TheIconSelfPack = [
  'AlignVerticalCenter',
  IconAlignVerticalCenterStrokeRounded,
  IconAlignVerticalCenterDuotoneRounded,
  IconAlignVerticalCenterTwotoneRounded,
  IconAlignVerticalCenterSolidRounded,
  IconAlignVerticalCenterBulkRounded,
  IconAlignVerticalCenterStrokeSharp,
  IconAlignVerticalCenterSolidSharp,
];