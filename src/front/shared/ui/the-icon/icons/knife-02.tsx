...
export const IconKnife02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Knife02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconKnife02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Knife02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconKnife02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Knife02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfKnife02: TheIconSelfPack = [
  'Knife02',
  IconKnife02StrokeRounded,
  IconKnife02DuotoneRounded,
  IconKnife02TwotoneRounded,
  IconKnife02SolidRounded,
  IconKnife02BulkRounded,
  IconKnife02StrokeSharp,
  IconKnife02SolidSharp,
];