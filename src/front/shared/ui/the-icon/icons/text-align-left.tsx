...
export const IconTextAlignLeftStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextAlignLeft StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTextAlignLeftDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextAlignLeft DuotoneRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d1}
...
export const IconTextAlignLeftTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextAlignLeft TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconTextAlignLeftSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextAlignLeft SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconTextAlignLeftBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextAlignLeft BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconTextAlignLeftStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextAlignLeft StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconTextAlignLeftSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextAlignLeft SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfTextAlignLeft: TheIconSelfPack = [
  'TextAlignLeft',
  IconTextAlignLeftStrokeRounded,
  IconTextAlignLeftDuotoneRounded,
  IconTextAlignLeftTwotoneRounded,
  IconTextAlignLeftSolidRounded,
  IconTextAlignLeftBulkRounded,
  IconTextAlignLeftStrokeSharp,
  IconTextAlignLeftSolidSharp,
];