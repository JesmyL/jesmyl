...
export const IconBitcoinPresentationStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinPresentation StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBitcoinPresentationDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinPresentation DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconBitcoinPresentationTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinPresentation TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBitcoinPresentationSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinPresentation SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconBitcoinPresentationBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinPresentation BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconBitcoinPresentationStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinPresentation StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj ss sw"
...
export const IconBitcoinPresentationSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinPresentation SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const iconPackOfBitcoinPresentation: TheIconSelfPack = [
  'BitcoinPresentation',
  IconBitcoinPresentationStrokeRounded,
  IconBitcoinPresentationDuotoneRounded,
  IconBitcoinPresentationTwotoneRounded,
  IconBitcoinPresentationSolidRounded,
  IconBitcoinPresentationBulkRounded,
  IconBitcoinPresentationStrokeSharp,
  IconBitcoinPresentationSolidSharp,
];