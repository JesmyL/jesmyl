...
export const IconTimeQuarterStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TimeQuarter StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTimeQuarterDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TimeQuarter DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconTimeQuarterTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TimeQuarter TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconTimeQuarterSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TimeQuarter SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconTimeQuarterBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TimeQuarter BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconTimeQuarterStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TimeQuarter StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj ss sw"
...
export const IconTimeQuarterSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TimeQuarter SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfTimeQuarter: TheIconSelfPack = [
  'TimeQuarter',
  IconTimeQuarterStrokeRounded,
  IconTimeQuarterDuotoneRounded,
  IconTimeQuarterTwotoneRounded,
  IconTimeQuarterSolidRounded,
  IconTimeQuarterBulkRounded,
  IconTimeQuarterStrokeSharp,
  IconTimeQuarterSolidSharp,
];