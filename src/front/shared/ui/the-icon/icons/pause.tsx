...
export const iconPackOfPause: TheIconSelfPack = [
  ...
  IconPauseDuotoneRounded,
  IconPauseTwotoneRounded,
  IconPauseSolidRounded,
  IconPauseBulkRounded,
  IconPauseStrokeSharp,
  IconPauseSolidSharp,
];