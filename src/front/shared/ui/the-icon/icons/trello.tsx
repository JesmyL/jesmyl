...
export const IconTrelloDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Trello DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconTrelloTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Trello TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfTrello: TheIconSelfPack = [
  'Trello',
  IconTrelloStrokeRounded,
  IconTrelloDuotoneRounded,
  IconTrelloTwotoneRounded,
  IconTrelloSolidRounded,
  IconTrelloBulkRounded,
  IconTrelloStrokeSharp,
  IconTrelloSolidSharp,
];