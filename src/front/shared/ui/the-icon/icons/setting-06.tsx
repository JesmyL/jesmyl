...
export const IconSetting06StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Setting06 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSetting06DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Setting06 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconSetting06TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Setting06 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSetting06SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Setting06 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconSetting06BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Setting06 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconSetting06StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Setting06 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const iconPackOfSetting06: TheIconSelfPack = [
  'Setting06',
  IconSetting06StrokeRounded,
  IconSetting06DuotoneRounded,
  IconSetting06TwotoneRounded,
  IconSetting06SolidRounded,
  IconSetting06BulkRounded,
  IconSetting06StrokeSharp,
  IconSetting06SolidSharp,
];