...
export const IconSpadesDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Spades DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconSpadesTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Spades TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfSpades: TheIconSelfPack = [
  'Spades',
  IconSpadesStrokeRounded,
  IconSpadesDuotoneRounded,
  IconSpadesTwotoneRounded,
  IconSpadesSolidRounded,
  IconSpadesBulkRounded,
  IconSpadesStrokeSharp,
  IconSpadesSolidSharp,
];