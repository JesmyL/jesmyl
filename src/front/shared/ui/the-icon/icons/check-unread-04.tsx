...
export const IconCheckUnread04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheckUnread04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCheckUnread04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheckUnread04 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCheckUnread04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheckUnread04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCheckUnread04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheckUnread04 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconCheckUnread04BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheckUnread04 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconCheckUnread04StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheckUnread04 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s ss sw"
...
export const IconCheckUnread04SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheckUnread04 SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfCheckUnread04: TheIconSelfPack = [
  'CheckUnread04',
  IconCheckUnread04StrokeRounded,
  IconCheckUnread04DuotoneRounded,
  IconCheckUnread04TwotoneRounded,
  IconCheckUnread04SolidRounded,
  IconCheckUnread04BulkRounded,
  IconCheckUnread04StrokeSharp,
  IconCheckUnread04SolidSharp,
];