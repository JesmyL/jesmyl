...
export const IconKeyframeTopStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframeTop StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconKeyframeTopDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframeTop DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconKeyframeTopTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframeTop TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconKeyframeTopSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframeTop SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconKeyframeTopBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframeTop BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconKeyframeTopStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframeTop StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sw"
...
export const IconKeyframeTopSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframeTop SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const iconPackOfKeyframeTop: TheIconSelfPack = [
  'KeyframeTop',
  IconKeyframeTopStrokeRounded,
  IconKeyframeTopDuotoneRounded,
  IconKeyframeTopTwotoneRounded,
  IconKeyframeTopSolidRounded,
  IconKeyframeTopBulkRounded,
  IconKeyframeTopStrokeSharp,
  IconKeyframeTopSolidSharp,
];