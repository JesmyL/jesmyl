...
export const IconPrism01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Prism01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPrism01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Prism01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconPrism01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Prism01 TwotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="s sj sr sw"
...
export const iconPackOfPrism01: TheIconSelfPack = [
  'Prism01',
  IconPrism01StrokeRounded,
  IconPrism01DuotoneRounded,
  IconPrism01TwotoneRounded,
  IconPrism01SolidRounded,
  IconPrism01BulkRounded,
  IconPrism01StrokeSharp,
  IconPrism01SolidSharp,
];