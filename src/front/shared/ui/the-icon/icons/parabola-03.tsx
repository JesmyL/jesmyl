...
export const IconParabola03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Parabola03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconParabola03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Parabola03 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconParabola03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Parabola03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconParabola03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Parabola03 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconParabola03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Parabola03 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconParabola03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Parabola03 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconParabola03SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Parabola03 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfParabola03: TheIconSelfPack = [
  'Parabola03',
  IconParabola03StrokeRounded,
  IconParabola03DuotoneRounded,
  IconParabola03TwotoneRounded,
  IconParabola03SolidRounded,
  IconParabola03BulkRounded,
  IconParabola03StrokeSharp,
  IconParabola03SolidSharp,
];