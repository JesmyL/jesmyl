...
export const IconWebValidationStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WebValidation StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconWebValidationDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WebValidation DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconWebValidationTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WebValidation TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconWebValidationSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WebValidation SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconWebValidationBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WebValidation BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconWebValidationStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WebValidation StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sj sw"
...
export const IconWebValidationSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WebValidation SolidSharp"
    >
      <path 
        d={d.d18}
        i-c="c f fr"
...
export const iconPackOfWebValidation: TheIconSelfPack = [
  'WebValidation',
  IconWebValidationStrokeRounded,
  IconWebValidationDuotoneRounded,
  IconWebValidationTwotoneRounded,
  IconWebValidationSolidRounded,
  IconWebValidationBulkRounded,
  IconWebValidationStrokeSharp,
  IconWebValidationSolidSharp,
];