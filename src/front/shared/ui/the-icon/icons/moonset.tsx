...
export const IconMoonsetStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Moonset StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMoonsetDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Moonset DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMoonsetTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Moonset TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfMoonset: TheIconSelfPack = [
  'Moonset',
  IconMoonsetStrokeRounded,
  IconMoonsetDuotoneRounded,
  IconMoonsetTwotoneRounded,
  IconMoonsetSolidRounded,
  IconMoonsetBulkRounded,
  IconMoonsetStrokeSharp,
  IconMoonsetSolidSharp,
];