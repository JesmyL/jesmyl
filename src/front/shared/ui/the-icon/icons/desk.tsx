...
export const iconPackOfDesk: TheIconSelfPack = [
  'Desk',
  IconDeskStrokeRounded,
  IconDeskDuotoneRounded,
  IconDeskTwotoneRounded,
  IconDeskSolidRounded,
  IconDeskBulkRounded,
  IconDeskStrokeSharp,
  IconDeskSolidSharp,
];