...
export const IconPokeballStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pokeball StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPokeballDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pokeball DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconPokeballTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pokeball TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPokeballSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pokeball SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const iconPackOfPokeball: TheIconSelfPack = [
  'Pokeball',
  IconPokeballStrokeRounded,
  IconPokeballDuotoneRounded,
  IconPokeballTwotoneRounded,
  IconPokeballSolidRounded,
  IconPokeballBulkRounded,
  IconPokeballStrokeSharp,
  IconPokeballSolidSharp,
];