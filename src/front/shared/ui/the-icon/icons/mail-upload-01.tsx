...
export const IconMailUpload01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailUpload01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMailUpload01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailUpload01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconMailUpload01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailUpload01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMailUpload01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailUpload01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconMailUpload01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailUpload01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconMailUpload01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailUpload01 StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconMailUpload01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailUpload01 SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfMailUpload01: TheIconSelfPack = [
  'MailUpload01',
  IconMailUpload01StrokeRounded,
  IconMailUpload01DuotoneRounded,
  IconMailUpload01TwotoneRounded,
  IconMailUpload01SolidRounded,
  IconMailUpload01BulkRounded,
  IconMailUpload01StrokeSharp,
  IconMailUpload01SolidSharp,
];