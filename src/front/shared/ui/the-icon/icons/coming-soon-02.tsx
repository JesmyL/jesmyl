...
export const IconComingSoon02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComingSoon02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconComingSoon02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComingSoon02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconComingSoon02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComingSoon02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconComingSoon02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComingSoon02 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconComingSoon02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComingSoon02 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconComingSoon02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComingSoon02 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconComingSoon02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComingSoon02 SolidSharp"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const iconPackOfComingSoon02: TheIconSelfPack = [
  'ComingSoon02',
  IconComingSoon02StrokeRounded,
  IconComingSoon02DuotoneRounded,
  IconComingSoon02TwotoneRounded,
  IconComingSoon02SolidRounded,
  IconComingSoon02BulkRounded,
  IconComingSoon02StrokeSharp,
  IconComingSoon02SolidSharp,
];