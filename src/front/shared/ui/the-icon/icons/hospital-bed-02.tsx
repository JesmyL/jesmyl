...
export const IconHospitalBed02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HospitalBed02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconHospitalBed02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HospitalBed02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconHospitalBed02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HospitalBed02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconHospitalBed02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HospitalBed02 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconHospitalBed02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HospitalBed02 BulkRounded"
    >
      <path 
        d={d.d11}
        i-c="c f fr o7"
...
export const IconHospitalBed02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HospitalBed02 StrokeSharp"
    >
      <path 
        d={d.d16}
        i-c="s sj sw"
...
export const IconHospitalBed02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HospitalBed02 SolidSharp"
    >
      <path 
        d={d.d22}
        i-c="f"
...
export const iconPackOfHospitalBed02: TheIconSelfPack = [
  'HospitalBed02',
  IconHospitalBed02StrokeRounded,
  IconHospitalBed02DuotoneRounded,
  IconHospitalBed02TwotoneRounded,
  IconHospitalBed02SolidRounded,
  IconHospitalBed02BulkRounded,
  IconHospitalBed02StrokeSharp,
  IconHospitalBed02SolidSharp,
];