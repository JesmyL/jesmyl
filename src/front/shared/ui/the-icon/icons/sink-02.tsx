...
export const IconSink02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sink02 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconSink02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sink02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfSink02: TheIconSelfPack = [
  'Sink02',
  IconSink02StrokeRounded,
  IconSink02DuotoneRounded,
  IconSink02TwotoneRounded,
  IconSink02SolidRounded,
  IconSink02BulkRounded,
  IconSink02StrokeSharp,
  IconSink02SolidSharp,
];