...
export const IconFolderAddStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderAdd StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFolderAddDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderAdd DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconFolderAddTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderAdd TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconFolderAddSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderAdd SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconFolderAddBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderAdd BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconFolderAddStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderAdd StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const iconPackOfFolderAdd: TheIconSelfPack = [
  'FolderAdd',
  IconFolderAddStrokeRounded,
  IconFolderAddDuotoneRounded,
  IconFolderAddTwotoneRounded,
  IconFolderAddSolidRounded,
  IconFolderAddBulkRounded,
  IconFolderAddStrokeSharp,
  IconFolderAddSolidSharp,
];