...
export const IconFileUploadStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileUpload StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFileUploadDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileUpload DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconFileUploadTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileUpload TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFileUploadSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileUpload SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconFileUploadBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileUpload BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconFileUploadStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileUpload StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const IconFileUploadSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileUpload SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfFileUpload: TheIconSelfPack = [
  'FileUpload',
  IconFileUploadStrokeRounded,
  IconFileUploadDuotoneRounded,
  IconFileUploadTwotoneRounded,
  IconFileUploadSolidRounded,
  IconFileUploadBulkRounded,
  IconFileUploadStrokeSharp,
  IconFileUploadSolidSharp,
];