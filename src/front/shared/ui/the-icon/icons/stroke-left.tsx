...
export const IconStrokeLeftStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeLeft StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconStrokeLeftDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeLeft DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconStrokeLeftTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeLeft TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconStrokeLeftSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeLeft SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconStrokeLeftBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeLeft BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconStrokeLeftStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeLeft StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s ss sw"
...
export const IconStrokeLeftSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeLeft SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfStrokeLeft: TheIconSelfPack = [
  'StrokeLeft',
  IconStrokeLeftStrokeRounded,
  IconStrokeLeftDuotoneRounded,
  IconStrokeLeftTwotoneRounded,
  IconStrokeLeftSolidRounded,
  IconStrokeLeftBulkRounded,
  IconStrokeLeftStrokeSharp,
  IconStrokeLeftSolidSharp,
];