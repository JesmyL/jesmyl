...
export const IconHealthDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Health DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconHealthTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Health TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfHealth: TheIconSelfPack = [
  'Health',
  IconHealthStrokeRounded,
  IconHealthDuotoneRounded,
  IconHealthTwotoneRounded,
  IconHealthSolidRounded,
  IconHealthBulkRounded,
  IconHealthStrokeSharp,
  IconHealthSolidSharp,
];