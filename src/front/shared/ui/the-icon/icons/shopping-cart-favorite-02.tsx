...
export const IconShoppingCartFavorite02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingCartFavorite02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShoppingCartFavorite02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingCartFavorite02 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconShoppingCartFavorite02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingCartFavorite02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShoppingCartFavorite02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingCartFavorite02 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconShoppingCartFavorite02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingCartFavorite02 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr o7"
...
export const IconShoppingCartFavorite02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingCartFavorite02 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconShoppingCartFavorite02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingCartFavorite02 SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="f"
...
export const iconPackOfShoppingCartFavorite02: TheIconSelfPack = [
  ...
  IconShoppingCartFavorite02StrokeRounded,
  IconShoppingCartFavorite02DuotoneRounded,
  IconShoppingCartFavorite02TwotoneRounded,
  IconShoppingCartFavorite02SolidRounded,
  IconShoppingCartFavorite02BulkRounded,
  IconShoppingCartFavorite02StrokeSharp,
  IconShoppingCartFavorite02SolidSharp,
];