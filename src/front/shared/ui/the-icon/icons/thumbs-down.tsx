...
export const IconThumbsDownStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ThumbsDown StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconThumbsDownDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ThumbsDown DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconThumbsDownTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ThumbsDown TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconThumbsDownSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ThumbsDown SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconThumbsDownBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ThumbsDown BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconThumbsDownStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ThumbsDown StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sj sr sw"
...
export const IconThumbsDownSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ThumbsDown SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfThumbsDown: TheIconSelfPack = [
  'ThumbsDown',
  IconThumbsDownStrokeRounded,
  IconThumbsDownDuotoneRounded,
  IconThumbsDownTwotoneRounded,
  IconThumbsDownSolidRounded,
  IconThumbsDownBulkRounded,
  IconThumbsDownStrokeSharp,
  IconThumbsDownSolidSharp,
];