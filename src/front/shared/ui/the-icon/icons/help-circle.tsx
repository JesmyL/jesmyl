...
export const IconHelpCircleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HelpCircle StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconHelpCircleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HelpCircle DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconHelpCircleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HelpCircle TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconHelpCircleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HelpCircle SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconHelpCircleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HelpCircle BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconHelpCircleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HelpCircle StrokeSharp"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconHelpCircleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HelpCircle SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfHelpCircle: TheIconSelfPack = [
  ...
  IconHelpCircleDuotoneRounded,
  IconHelpCircleTwotoneRounded,
  IconHelpCircleSolidRounded,
  IconHelpCircleBulkRounded,
  IconHelpCircleStrokeSharp,
  IconHelpCircleSolidSharp,
];