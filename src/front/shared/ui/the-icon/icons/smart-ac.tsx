...
export const IconSmartAcStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmartAc StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSmartAcDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmartAc DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconSmartAcTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmartAc TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfSmartAc: TheIconSelfPack = [
  'SmartAc',
  IconSmartAcStrokeRounded,
  IconSmartAcDuotoneRounded,
  IconSmartAcTwotoneRounded,
  IconSmartAcSolidRounded,
  IconSmartAcBulkRounded,
  IconSmartAcStrokeSharp,
  IconSmartAcSolidSharp,
];