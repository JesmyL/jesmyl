...
export const IconDeliveredSentStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveredSent StrokeRounded"
    >
      <circle 
        cx="17"
        cy="19"
...
export const IconDeliveredSentDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveredSent DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconDeliveredSentTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveredSent TwotoneRounded"
    >
      <circle 
        cx="17"
        cy="19"
...
export const IconDeliveredSentSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveredSent SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconDeliveredSentBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveredSent BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconDeliveredSentStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveredSent StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const IconDeliveredSentSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveredSent SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="f"
...
export const iconPackOfDeliveredSent: TheIconSelfPack = [
  'DeliveredSent',
  IconDeliveredSentStrokeRounded,
  IconDeliveredSentDuotoneRounded,
  IconDeliveredSentTwotoneRounded,
  IconDeliveredSentSolidRounded,
  IconDeliveredSentBulkRounded,
  IconDeliveredSentStrokeSharp,
  IconDeliveredSentSolidSharp,
];