...
export const IconSpoonAndKnifeStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpoonAndKnife StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSpoonAndKnifeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpoonAndKnife DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconSpoonAndKnifeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpoonAndKnife TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSpoonAndKnifeSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpoonAndKnife SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconSpoonAndKnifeBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpoonAndKnife BulkRounded"
    >
      <path 
        d={d.d11}
        i-c="f o7"
...
export const IconSpoonAndKnifeStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpoonAndKnife StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s ss sw"
...
export const IconSpoonAndKnifeSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpoonAndKnife SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const iconPackOfSpoonAndKnife: TheIconSelfPack = [
  'SpoonAndKnife',
  IconSpoonAndKnifeStrokeRounded,
  IconSpoonAndKnifeDuotoneRounded,
  IconSpoonAndKnifeTwotoneRounded,
  IconSpoonAndKnifeSolidRounded,
  IconSpoonAndKnifeBulkRounded,
  IconSpoonAndKnifeStrokeSharp,
  IconSpoonAndKnifeSolidSharp,
];