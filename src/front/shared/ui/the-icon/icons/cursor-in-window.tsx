...
export const IconCursorInWindowStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorInWindow StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCursorInWindowDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorInWindow DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCursorInWindowTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorInWindow TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCursorInWindowSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorInWindow SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconCursorInWindowBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorInWindow BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconCursorInWindowStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorInWindow StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconCursorInWindowSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorInWindow SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfCursorInWindow: TheIconSelfPack = [
  'CursorInWindow',
  IconCursorInWindowStrokeRounded,
  IconCursorInWindowDuotoneRounded,
  IconCursorInWindowTwotoneRounded,
  IconCursorInWindowSolidRounded,
  IconCursorInWindowBulkRounded,
  IconCursorInWindowStrokeSharp,
  IconCursorInWindowSolidSharp,
];