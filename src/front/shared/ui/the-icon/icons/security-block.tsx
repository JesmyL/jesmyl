...
export const IconSecurityBlockStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SecurityBlock StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSecurityBlockDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SecurityBlock DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconSecurityBlockTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SecurityBlock TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSecurityBlockSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SecurityBlock SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconSecurityBlockBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SecurityBlock BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconSecurityBlockStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SecurityBlock StrokeSharp"
    >
      <path 
        d={d.d3}
        i-c="s sj sw"
...
export const IconSecurityBlockSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SecurityBlock SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const iconPackOfSecurityBlock: TheIconSelfPack = [
  'SecurityBlock',
  IconSecurityBlockStrokeRounded,
  IconSecurityBlockDuotoneRounded,
  IconSecurityBlockTwotoneRounded,
  IconSecurityBlockSolidRounded,
  IconSecurityBlockBulkRounded,
  IconSecurityBlockStrokeSharp,
  IconSecurityBlockSolidSharp,
];