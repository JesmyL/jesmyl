...
export const IconMosque04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mosque04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMosque04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mosque04 DuotoneRounded"
    >
      <path 
        d={d.d10}
        i-c="f o7"
...
export const IconMosque04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mosque04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMosque04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mosque04 SolidRounded"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfMosque04: TheIconSelfPack = [
  'Mosque04',
  IconMosque04StrokeRounded,
  IconMosque04DuotoneRounded,
  IconMosque04TwotoneRounded,
  IconMosque04SolidRounded,
  IconMosque04BulkRounded,
  IconMosque04StrokeSharp,
  IconMosque04SolidSharp,
];