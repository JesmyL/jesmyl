...
export const IconRouter01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Router01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRouter01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Router01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconRouter01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Router01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRouter01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Router01 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const iconPackOfRouter01: TheIconSelfPack = [
  'Router01',
  IconRouter01StrokeRounded,
  IconRouter01DuotoneRounded,
  IconRouter01TwotoneRounded,
  IconRouter01SolidRounded,
  IconRouter01BulkRounded,
  IconRouter01StrokeSharp,
  IconRouter01SolidSharp,
];