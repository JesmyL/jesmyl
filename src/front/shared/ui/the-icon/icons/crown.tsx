...
export const iconPackOfCrown: TheIconSelfPack = [
  'Crown',
  IconCrownStrokeRounded,
  IconCrownDuotoneRounded,
  IconCrownTwotoneRounded,
  IconCrownSolidRounded,
  IconCrownBulkRounded,
  IconCrownStrokeSharp,
  IconCrownSolidSharp,
];