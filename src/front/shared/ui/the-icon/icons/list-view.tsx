...
export const IconListViewStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ListView StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconListViewDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ListView DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconListViewTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ListView TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconListViewSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ListView SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const iconPackOfListView: TheIconSelfPack = [
  ...
  IconListViewDuotoneRounded,
  IconListViewTwotoneRounded,
  IconListViewSolidRounded,
  IconListViewBulkRounded,
  IconListViewStrokeSharp,
  IconListViewSolidSharp,
];