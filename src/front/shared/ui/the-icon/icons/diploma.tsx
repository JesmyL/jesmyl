...
export const IconDiplomaStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Diploma StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDiplomaDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Diploma DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconDiplomaTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Diploma TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfDiploma: TheIconSelfPack = [
  'Diploma',
  IconDiplomaStrokeRounded,
  IconDiplomaDuotoneRounded,
  IconDiplomaTwotoneRounded,
  IconDiplomaSolidRounded,
  IconDiplomaBulkRounded,
  IconDiplomaStrokeSharp,
  IconDiplomaSolidSharp,
];