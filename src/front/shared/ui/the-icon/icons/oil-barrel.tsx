...
export const IconOilBarrelStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OilBarrel StrokeRounded"
    >
      <ellipse 
        cx="12"
        cy="4"
...
export const IconOilBarrelDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OilBarrel DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconOilBarrelTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OilBarrel TwotoneRounded"
    >
      <ellipse 
        cx="12"
        cy="4"
...
export const IconOilBarrelSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OilBarrel SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconOilBarrelBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OilBarrel BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconOilBarrelStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OilBarrel StrokeSharp"
    >
      <ellipse 
        cx="12"
        cy="4"
...
export const iconPackOfOilBarrel: TheIconSelfPack = [
  'OilBarrel',
  IconOilBarrelStrokeRounded,
  IconOilBarrelDuotoneRounded,
  IconOilBarrelTwotoneRounded,
  IconOilBarrelSolidRounded,
  IconOilBarrelBulkRounded,
  IconOilBarrelStrokeSharp,
  IconOilBarrelSolidSharp,
];