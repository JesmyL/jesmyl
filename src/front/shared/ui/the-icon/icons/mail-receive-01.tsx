...
export const IconMailReceive01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailReceive01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMailReceive01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailReceive01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconMailReceive01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailReceive01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMailReceive01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailReceive01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconMailReceive01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailReceive01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconMailReceive01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailReceive01 StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconMailReceive01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailReceive01 SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfMailReceive01: TheIconSelfPack = [
  'MailReceive01',
  IconMailReceive01StrokeRounded,
  IconMailReceive01DuotoneRounded,
  IconMailReceive01TwotoneRounded,
  IconMailReceive01SolidRounded,
  IconMailReceive01BulkRounded,
  IconMailReceive01StrokeSharp,
  IconMailReceive01SolidSharp,
];