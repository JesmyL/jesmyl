...
export const IconTeacherStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Teacher StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTeacherDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Teacher DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTeacherTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Teacher TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfTeacher: TheIconSelfPack = [
  'Teacher',
  IconTeacherStrokeRounded,
  IconTeacherDuotoneRounded,
  IconTeacherTwotoneRounded,
  IconTeacherSolidRounded,
  IconTeacherBulkRounded,
  IconTeacherStrokeSharp,
  IconTeacherSolidSharp,
];