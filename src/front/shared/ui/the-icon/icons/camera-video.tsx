...
export const IconCameraVideoStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraVideo StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCameraVideoDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraVideo DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconCameraVideoTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraVideo TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconCameraVideoSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraVideo SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconCameraVideoBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraVideo BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr o7"
...
export const IconCameraVideoStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraVideo StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconCameraVideoSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraVideo SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfCameraVideo: TheIconSelfPack = [
  'CameraVideo',
  IconCameraVideoStrokeRounded,
  IconCameraVideoDuotoneRounded,
  IconCameraVideoTwotoneRounded,
  IconCameraVideoSolidRounded,
  IconCameraVideoBulkRounded,
  IconCameraVideoStrokeSharp,
  IconCameraVideoSolidSharp,
];