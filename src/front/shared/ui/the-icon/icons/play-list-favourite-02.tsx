...
export const IconPlayListFavourite02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListFavourite02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconPlayListFavourite02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListFavourite02 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconPlayListFavourite02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListFavourite02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconPlayListFavourite02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListFavourite02 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconPlayListFavourite02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListFavourite02 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconPlayListFavourite02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListFavourite02 StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconPlayListFavourite02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListFavourite02 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfPlayListFavourite02: TheIconSelfPack = [
  'PlayListFavourite02',
  IconPlayListFavourite02StrokeRounded,
  IconPlayListFavourite02DuotoneRounded,
  IconPlayListFavourite02TwotoneRounded,
  IconPlayListFavourite02SolidRounded,
  IconPlayListFavourite02BulkRounded,
  IconPlayListFavourite02StrokeSharp,
  IconPlayListFavourite02SolidSharp,
];