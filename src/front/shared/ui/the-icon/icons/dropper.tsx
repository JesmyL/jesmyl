...
export const IconDropperStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Dropper StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDropperDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Dropper DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDropperTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Dropper TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfDropper: TheIconSelfPack = [
  'Dropper',
  IconDropperStrokeRounded,
  IconDropperDuotoneRounded,
  IconDropperTwotoneRounded,
  IconDropperSolidRounded,
  IconDropperBulkRounded,
  IconDropperStrokeSharp,
  IconDropperSolidSharp,
];