...
export const iconPackOfDead: TheIconSelfPack = [
  'Dead',
  IconDeadStrokeRounded,
  IconDeadDuotoneRounded,
  IconDeadTwotoneRounded,
  IconDeadSolidRounded,
  IconDeadBulkRounded,
  IconDeadStrokeSharp,
  IconDeadSolidSharp,
];