...
export const IconArrowHorizontalStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowHorizontal StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconArrowHorizontalDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowHorizontal DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="o7 s sj sr sw"
...
export const IconArrowHorizontalTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowHorizontal TwotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconArrowHorizontalSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowHorizontal SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconArrowHorizontalBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowHorizontal BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr o7"
...
export const IconArrowHorizontalStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowHorizontal StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sw"
...
export const IconArrowHorizontalSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowHorizontal SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="f"
...
export const iconPackOfArrowHorizontal: TheIconSelfPack = [
  'ArrowHorizontal',
  IconArrowHorizontalStrokeRounded,
  IconArrowHorizontalDuotoneRounded,
  IconArrowHorizontalTwotoneRounded,
  IconArrowHorizontalSolidRounded,
  IconArrowHorizontalBulkRounded,
  IconArrowHorizontalStrokeSharp,
  IconArrowHorizontalSolidSharp,
];