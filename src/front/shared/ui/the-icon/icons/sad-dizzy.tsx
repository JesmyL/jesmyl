...
export const IconSadDizzyStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SadDizzy StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconSadDizzyDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SadDizzy DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconSadDizzyTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SadDizzy TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconSadDizzySolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SadDizzy SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const iconPackOfSadDizzy: TheIconSelfPack = [
  'SadDizzy',
  IconSadDizzyStrokeRounded,
  IconSadDizzyDuotoneRounded,
  IconSadDizzyTwotoneRounded,
  IconSadDizzySolidRounded,
  IconSadDizzyBulkRounded,
  IconSadDizzyStrokeSharp,
  IconSadDizzySolidSharp,
];