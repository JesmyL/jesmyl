...
export const IconCalendar01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Calendar01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCalendar01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Calendar01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconCalendar01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Calendar01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCalendar01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Calendar01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconCalendar01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Calendar01 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconCalendar01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Calendar01 StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const IconCalendar01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Calendar01 SolidSharp"
    >
      <path 
        d={d.d16}
        i-c="c f fr"
...
export const iconPackOfCalendar01: TheIconSelfPack = [
  'Calendar01',
  IconCalendar01StrokeRounded,
  IconCalendar01DuotoneRounded,
  IconCalendar01TwotoneRounded,
  IconCalendar01SolidRounded,
  IconCalendar01BulkRounded,
  IconCalendar01StrokeSharp,
  IconCalendar01SolidSharp,
];