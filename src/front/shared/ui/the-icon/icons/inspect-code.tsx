...
export const IconInspectCodeStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InspectCode StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconInspectCodeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InspectCode DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconInspectCodeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InspectCode TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconInspectCodeSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InspectCode SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconInspectCodeBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InspectCode BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr o7"
...
export const IconInspectCodeStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InspectCode StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sw"
...
export const IconInspectCodeSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InspectCode SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfInspectCode: TheIconSelfPack = [
  'InspectCode',
  IconInspectCodeStrokeRounded,
  IconInspectCodeDuotoneRounded,
  IconInspectCodeTwotoneRounded,
  IconInspectCodeSolidRounded,
  IconInspectCodeBulkRounded,
  IconInspectCodeStrokeSharp,
  IconInspectCodeSolidSharp,
];