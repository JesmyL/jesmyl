...
export const IconRacingFlagStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RacingFlag StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRacingFlagDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RacingFlag DuotoneRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d4}
...
export const IconRacingFlagTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RacingFlag TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRacingFlagSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RacingFlag SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconRacingFlagBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RacingFlag BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconRacingFlagStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RacingFlag StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconRacingFlagSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RacingFlag SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const iconPackOfRacingFlag: TheIconSelfPack = [
  'RacingFlag',
  IconRacingFlagStrokeRounded,
  IconRacingFlagDuotoneRounded,
  IconRacingFlagTwotoneRounded,
  IconRacingFlagSolidRounded,
  IconRacingFlagBulkRounded,
  IconRacingFlagStrokeSharp,
  IconRacingFlagSolidSharp,
];