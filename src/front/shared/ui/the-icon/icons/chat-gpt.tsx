...
export const IconChatGptStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChatGpt StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconChatGptDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChatGpt DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconChatGptTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChatGpt TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfChatGpt: TheIconSelfPack = [
  'ChatGpt',
  IconChatGptStrokeRounded,
  IconChatGptDuotoneRounded,
  IconChatGptTwotoneRounded,
  IconChatGptSolidRounded,
  IconChatGptBulkRounded,
  IconChatGptStrokeSharp,
  IconChatGptSolidSharp,
];