...
export const IconMonsterStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Monster StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMonsterDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Monster DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr o7"
...
export const IconMonsterTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Monster TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfMonster: TheIconSelfPack = [
  'Monster',
  IconMonsterStrokeRounded,
  IconMonsterDuotoneRounded,
  IconMonsterTwotoneRounded,
  IconMonsterSolidRounded,
  IconMonsterBulkRounded,
  IconMonsterStrokeSharp,
  IconMonsterSolidSharp,
];