...
export const IconHonourStarStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HonourStar StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHonourStarDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HonourStar DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="s sj sr sw"
...
export const IconHonourStarTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HonourStar TwotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="s sj sr sw"
...
export const IconHonourStarSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HonourStar SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconHonourStarBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HonourStar BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconHonourStarStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HonourStar StrokeSharp"
    >
      <path 
        d={d.d4}
        i-c="s sj sw"
...
export const IconHonourStarSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HonourStar SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfHonourStar: TheIconSelfPack = [
  'HonourStar',
  IconHonourStarStrokeRounded,
  IconHonourStarDuotoneRounded,
  IconHonourStarTwotoneRounded,
  IconHonourStarSolidRounded,
  IconHonourStarBulkRounded,
  IconHonourStarStrokeSharp,
  IconHonourStarSolidSharp,
];