...
export const IconTired01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Tired01 StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconTired01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Tired01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr o7"
...
export const IconTired01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Tired01 TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const iconPackOfTired01: TheIconSelfPack = [
  'Tired01',
  IconTired01StrokeRounded,
  IconTired01DuotoneRounded,
  IconTired01TwotoneRounded,
  IconTired01SolidRounded,
  IconTired01BulkRounded,
  IconTired01StrokeSharp,
  IconTired01SolidSharp,
];