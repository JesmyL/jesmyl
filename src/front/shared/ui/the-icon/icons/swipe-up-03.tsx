...
export const IconSwipeUp03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeUp03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSwipeUp03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeUp03 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconSwipeUp03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeUp03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSwipeUp03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeUp03 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconSwipeUp03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeUp03 BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconSwipeUp03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeUp03 StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sw"
...
export const iconPackOfSwipeUp03: TheIconSelfPack = [
  'SwipeUp03',
  IconSwipeUp03StrokeRounded,
  IconSwipeUp03DuotoneRounded,
  IconSwipeUp03TwotoneRounded,
  IconSwipeUp03SolidRounded,
  IconSwipeUp03BulkRounded,
  IconSwipeUp03StrokeSharp,
  IconSwipeUp03SolidSharp,
];