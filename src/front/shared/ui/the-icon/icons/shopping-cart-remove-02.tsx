...
export const IconShoppingCartRemove02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingCartRemove02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShoppingCartRemove02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingCartRemove02 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconShoppingCartRemove02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingCartRemove02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShoppingCartRemove02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingCartRemove02 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconShoppingCartRemove02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingCartRemove02 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr o7"
...
export const IconShoppingCartRemove02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingCartRemove02 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconShoppingCartRemove02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingCartRemove02 SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfShoppingCartRemove02: TheIconSelfPack = [
  ...
  IconShoppingCartRemove02StrokeRounded,
  IconShoppingCartRemove02DuotoneRounded,
  IconShoppingCartRemove02TwotoneRounded,
  IconShoppingCartRemove02SolidRounded,
  IconShoppingCartRemove02BulkRounded,
  IconShoppingCartRemove02StrokeSharp,
  IconShoppingCartRemove02SolidSharp,
];