...
export const IconBadmintonStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Badminton StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBadmintonDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Badminton DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBadmintonTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Badminton TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBadmintonSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Badminton SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconBadmintonBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Badminton BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconBadmintonStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Badminton StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfBadminton: TheIconSelfPack = [
  'Badminton',
  IconBadmintonStrokeRounded,
  IconBadmintonDuotoneRounded,
  IconBadmintonTwotoneRounded,
  IconBadmintonSolidRounded,
  IconBadmintonBulkRounded,
  IconBadmintonStrokeSharp,
  IconBadmintonSolidSharp,
];