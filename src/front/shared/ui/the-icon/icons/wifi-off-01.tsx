...
export const IconWifiOff01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WifiOff01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconWifiOff01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WifiOff01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconWifiOff01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WifiOff01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconWifiOff01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WifiOff01 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconWifiOff01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WifiOff01 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconWifiOff01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WifiOff01 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfWifiOff01: TheIconSelfPack = [
  'WifiOff01',
  IconWifiOff01StrokeRounded,
  IconWifiOff01DuotoneRounded,
  IconWifiOff01TwotoneRounded,
  IconWifiOff01SolidRounded,
  IconWifiOff01BulkRounded,
  IconWifiOff01StrokeSharp,
  IconWifiOff01SolidSharp,
];