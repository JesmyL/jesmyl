...
export const IconShoppingBagFavoriteStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBagFavorite StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShoppingBagFavoriteDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBagFavorite DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconShoppingBagFavoriteTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBagFavorite TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShoppingBagFavoriteSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBagFavorite SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconShoppingBagFavoriteBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBagFavorite BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconShoppingBagFavoriteStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBagFavorite StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sw"
...
export const IconShoppingBagFavoriteSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBagFavorite SolidSharp"
    >
      <path 
        d={d.d16}
        i-c="c f fr"
...
export const iconPackOfShoppingBagFavorite: TheIconSelfPack = [
  'ShoppingBagFavorite',
  IconShoppingBagFavoriteStrokeRounded,
  IconShoppingBagFavoriteDuotoneRounded,
  IconShoppingBagFavoriteTwotoneRounded,
  IconShoppingBagFavoriteSolidRounded,
  IconShoppingBagFavoriteBulkRounded,
  IconShoppingBagFavoriteStrokeSharp,
  IconShoppingBagFavoriteSolidSharp,
];