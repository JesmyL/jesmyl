...
export const IconFrameworksStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Frameworks StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="f"
...
export const IconFrameworksDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Frameworks DuotoneRounded"
    >
      <path 
        d={d.d10}
        i-c="f o7"
...
export const IconFrameworksTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Frameworks TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f"
...
export const IconFrameworksSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Frameworks SolidRounded"
    >
      <path 
        d={d.d14}
        i-c="f"
...
export const IconFrameworksBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Frameworks BulkRounded"
    >
      <path 
        d={d.d20}
        i-c="c f fr"
...
export const IconFrameworksStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Frameworks StrokeSharp"
    >
      <path 
        d={d.d27}
        i-c="f"
...
export const IconFrameworksSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Frameworks SolidSharp"
    >
      <path 
        d={d.d35}
        i-c="f"
...
export const iconPackOfFrameworks: TheIconSelfPack = [
  'Frameworks',
  IconFrameworksStrokeRounded,
  IconFrameworksDuotoneRounded,
  IconFrameworksTwotoneRounded,
  IconFrameworksSolidRounded,
  IconFrameworksBulkRounded,
  IconFrameworksStrokeSharp,
  IconFrameworksSolidSharp,
];