...
export const IconWeightScale01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WeightScale01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconWeightScale01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WeightScale01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconWeightScale01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WeightScale01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconWeightScale01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WeightScale01 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconWeightScale01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WeightScale01 BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconWeightScale01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WeightScale01 StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sj sw"
...
export const IconWeightScale01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WeightScale01 SolidSharp"
    >
      <path 
        d={d.d16}
        i-c="f"
...
export const iconPackOfWeightScale01: TheIconSelfPack = [
  'WeightScale01',
  IconWeightScale01StrokeRounded,
  IconWeightScale01DuotoneRounded,
  IconWeightScale01TwotoneRounded,
  IconWeightScale01SolidRounded,
  IconWeightScale01BulkRounded,
  IconWeightScale01StrokeSharp,
  IconWeightScale01SolidSharp,
];