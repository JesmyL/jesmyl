...
export const IconSunsetDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sunset DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSunsetTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sunset TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfSunset: TheIconSelfPack = [
  'Sunset',
  IconSunsetStrokeRounded,
  IconSunsetDuotoneRounded,
  IconSunsetTwotoneRounded,
  IconSunsetSolidRounded,
  IconSunsetBulkRounded,
  IconSunsetStrokeSharp,
  IconSunsetSolidSharp,
];