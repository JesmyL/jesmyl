...
export const IconHome01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Home01 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconHome01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Home01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const iconPackOfHome01: TheIconSelfPack = [
  'Home01',
  IconHome01StrokeRounded,
  IconHome01DuotoneRounded,
  IconHome01TwotoneRounded,
  IconHome01SolidRounded,
  IconHome01BulkRounded,
  IconHome01StrokeSharp,
  IconHome01SolidSharp,
];