...
export const IconAndroidStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Android StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconAndroidDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Android DuotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconAndroidTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Android TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfAndroid: TheIconSelfPack = [
  'Android',
  IconAndroidStrokeRounded,
  IconAndroidDuotoneRounded,
  IconAndroidTwotoneRounded,
  IconAndroidSolidRounded,
  IconAndroidBulkRounded,
  IconAndroidStrokeSharp,
  IconAndroidSolidSharp,
];