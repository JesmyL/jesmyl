...
export const iconPackOfPlane: TheIconSelfPack = [
  'Plane',
  IconPlaneStrokeRounded,
  IconPlaneDuotoneRounded,
  IconPlaneTwotoneRounded,
  IconPlaneSolidRounded,
  IconPlaneBulkRounded,
  IconPlaneStrokeSharp,
  IconPlaneSolidSharp,
];