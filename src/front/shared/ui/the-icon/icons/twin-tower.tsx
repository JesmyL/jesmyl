...
export const IconTwinTowerStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TwinTower StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTwinTowerDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TwinTower DuotoneRounded"
    >
      <path 
        d={d.d13}
        i-c="f o7"
...
export const IconTwinTowerTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TwinTower TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconTwinTowerSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TwinTower SolidRounded"
    >
      <path 
        d={d.d18}
        i-c="c f fr"
...
export const IconTwinTowerBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TwinTower BulkRounded"
    >
      <path 
        d={d.d28}
        i-c="f o7"
...
export const IconTwinTowerStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TwinTower StrokeSharp"
    >
      <path 
        d={d.d34}
        i-c="s sj sw"
...
export const iconPackOfTwinTower: TheIconSelfPack = [
  'TwinTower',
  IconTwinTowerStrokeRounded,
  IconTwinTowerDuotoneRounded,
  IconTwinTowerTwotoneRounded,
  IconTwinTowerSolidRounded,
  IconTwinTowerBulkRounded,
  IconTwinTowerStrokeSharp,
  IconTwinTowerSolidSharp,
];