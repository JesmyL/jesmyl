...
export const IconPlusMinusSquare02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlusMinusSquare02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconPlusMinusSquare02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlusMinusSquare02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconPlusMinusSquare02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlusMinusSquare02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconPlusMinusSquare02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlusMinusSquare02 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconPlusMinusSquare02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlusMinusSquare02 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconPlusMinusSquare02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlusMinusSquare02 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const IconPlusMinusSquare02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlusMinusSquare02 SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfPlusMinusSquare02: TheIconSelfPack = [
  'PlusMinusSquare02',
  IconPlusMinusSquare02StrokeRounded,
  IconPlusMinusSquare02DuotoneRounded,
  IconPlusMinusSquare02TwotoneRounded,
  IconPlusMinusSquare02SolidRounded,
  IconPlusMinusSquare02BulkRounded,
  IconPlusMinusSquare02StrokeSharp,
  IconPlusMinusSquare02SolidSharp,
];