...
export const IconBulbChargingStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BulbCharging StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconBulbChargingDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BulbCharging DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconBulbChargingTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BulbCharging TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconBulbChargingSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BulbCharging SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconBulbChargingBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BulbCharging BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconBulbChargingStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BulbCharging StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sw"
...
export const IconBulbChargingSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BulbCharging SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfBulbCharging: TheIconSelfPack = [
  'BulbCharging',
  IconBulbChargingStrokeRounded,
  IconBulbChargingDuotoneRounded,
  IconBulbChargingTwotoneRounded,
  IconBulbChargingSolidRounded,
  IconBulbChargingBulkRounded,
  IconBulbChargingStrokeSharp,
  IconBulbChargingSolidSharp,
];