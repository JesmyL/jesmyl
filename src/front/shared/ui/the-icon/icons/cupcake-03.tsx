...
export const IconCupcake03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cupcake03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCupcake03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cupcake03 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconCupcake03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cupcake03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCupcake03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cupcake03 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconCupcake03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cupcake03 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconCupcake03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cupcake03 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfCupcake03: TheIconSelfPack = [
  'Cupcake03',
  IconCupcake03StrokeRounded,
  IconCupcake03DuotoneRounded,
  IconCupcake03TwotoneRounded,
  IconCupcake03SolidRounded,
  IconCupcake03BulkRounded,
  IconCupcake03StrokeSharp,
  IconCupcake03SolidSharp,
];