...
export const IconWindPower01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WindPower01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconWindPower01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WindPower01 DuotoneRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d9}
...
export const IconWindPower01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WindPower01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconWindPower01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WindPower01 SolidRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const IconWindPower01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WindPower01 BulkRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const IconWindPower01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WindPower01 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconWindPower01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WindPower01 SolidSharp"
    >
      <path 
        d={d.d20}
        i-c="f"
...
export const iconPackOfWindPower01: TheIconSelfPack = [
  'WindPower01',
  IconWindPower01StrokeRounded,
  IconWindPower01DuotoneRounded,
  IconWindPower01TwotoneRounded,
  IconWindPower01SolidRounded,
  IconWindPower01BulkRounded,
  IconWindPower01StrokeSharp,
  IconWindPower01SolidSharp,
];