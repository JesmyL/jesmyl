...
export const IconVerticalScrollPointStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VerticalScrollPoint StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconVerticalScrollPointDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VerticalScrollPoint DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconVerticalScrollPointTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VerticalScrollPoint TwotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="s sj sr sw"
...
export const IconVerticalScrollPointSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VerticalScrollPoint SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconVerticalScrollPointBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VerticalScrollPoint BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconVerticalScrollPointStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VerticalScrollPoint StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const IconVerticalScrollPointSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VerticalScrollPoint SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="f"
...
export const iconPackOfVerticalScrollPoint: TheIconSelfPack = [
  'VerticalScrollPoint',
  IconVerticalScrollPointStrokeRounded,
  IconVerticalScrollPointDuotoneRounded,
  IconVerticalScrollPointTwotoneRounded,
  IconVerticalScrollPointSolidRounded,
  IconVerticalScrollPointBulkRounded,
  IconVerticalScrollPointStrokeSharp,
  IconVerticalScrollPointSolidSharp,
];