...
export const IconLaptopIssueStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopIssue StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLaptopIssueDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopIssue DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconLaptopIssueTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopIssue TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLaptopIssueSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopIssue SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconLaptopIssueBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopIssue BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconLaptopIssueStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopIssue StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sw"
...
export const IconLaptopIssueSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopIssue SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfLaptopIssue: TheIconSelfPack = [
  'LaptopIssue',
  IconLaptopIssueStrokeRounded,
  IconLaptopIssueDuotoneRounded,
  IconLaptopIssueTwotoneRounded,
  IconLaptopIssueSolidRounded,
  IconLaptopIssueBulkRounded,
  IconLaptopIssueStrokeSharp,
  IconLaptopIssueSolidSharp,
];