...
export const iconPackOfLabs: TheIconSelfPack = [
  'Labs',
  IconLabsStrokeRounded,
  IconLabsDuotoneRounded,
  IconLabsTwotoneRounded,
  IconLabsSolidRounded,
  IconLabsBulkRounded,
  IconLabsStrokeSharp,
  IconLabsSolidSharp,
];