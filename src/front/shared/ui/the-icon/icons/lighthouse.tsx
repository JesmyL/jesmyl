...
export const IconLighthouseStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Lighthouse StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLighthouseDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Lighthouse DuotoneRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconLighthouseTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Lighthouse TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLighthouseSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Lighthouse SolidRounded"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const IconLighthouseBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Lighthouse BulkRounded"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const IconLighthouseStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Lighthouse StrokeSharp"
    >
      <path 
        d={d.d19}
        i-c="s sw"
...
export const IconLighthouseSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Lighthouse SolidSharp"
    >
      <path 
        d={d.d23}
        i-c="c f fr"
...
export const iconPackOfLighthouse: TheIconSelfPack = [
  'Lighthouse',
  IconLighthouseStrokeRounded,
  IconLighthouseDuotoneRounded,
  IconLighthouseTwotoneRounded,
  IconLighthouseSolidRounded,
  IconLighthouseBulkRounded,
  IconLighthouseStrokeSharp,
  IconLighthouseSolidSharp,
];