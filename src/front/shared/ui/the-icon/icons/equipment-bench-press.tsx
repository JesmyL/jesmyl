...
export const IconEquipmentBenchPressStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EquipmentBenchPress StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconEquipmentBenchPressDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EquipmentBenchPress DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconEquipmentBenchPressTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EquipmentBenchPress TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconEquipmentBenchPressSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EquipmentBenchPress SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconEquipmentBenchPressBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EquipmentBenchPress BulkRounded"
    >
      <path 
        d={d.d16}
        i-c="c f fr o7"
...
export const IconEquipmentBenchPressStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EquipmentBenchPress StrokeSharp"
    >
      <path 
        d={d.d21}
        i-c="s sj sw"
...
export const IconEquipmentBenchPressSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EquipmentBenchPress SolidSharp"
    >
      <path 
        d={d.d25}
        i-c="f"
...
export const iconPackOfEquipmentBenchPress: TheIconSelfPack = [
  'EquipmentBenchPress',
  IconEquipmentBenchPressStrokeRounded,
  IconEquipmentBenchPressDuotoneRounded,
  IconEquipmentBenchPressTwotoneRounded,
  IconEquipmentBenchPressSolidRounded,
  IconEquipmentBenchPressBulkRounded,
  IconEquipmentBenchPressStrokeSharp,
  IconEquipmentBenchPressSolidSharp,
];