...
export const IconArrowTurnDownStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowTurnDown StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconArrowTurnDownDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowTurnDown DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="o4 s sj sr sw"
...
export const IconArrowTurnDownTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowTurnDown TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconArrowTurnDownSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowTurnDown SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconArrowTurnDownBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowTurnDown BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconArrowTurnDownStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowTurnDown StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const IconArrowTurnDownSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowTurnDown SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfArrowTurnDown: TheIconSelfPack = [
  'ArrowTurnDown',
  IconArrowTurnDownStrokeRounded,
  IconArrowTurnDownDuotoneRounded,
  IconArrowTurnDownTwotoneRounded,
  IconArrowTurnDownSolidRounded,
  IconArrowTurnDownBulkRounded,
  IconArrowTurnDownStrokeSharp,
  IconArrowTurnDownSolidSharp,
];