...
export const IconHouse04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="House04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHouse04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="House04 DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconHouse04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="House04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfHouse04: TheIconSelfPack = [
  'House04',
  IconHouse04StrokeRounded,
  IconHouse04DuotoneRounded,
  IconHouse04TwotoneRounded,
  IconHouse04SolidRounded,
  IconHouse04BulkRounded,
  IconHouse04StrokeSharp,
  IconHouse04SolidSharp,
];