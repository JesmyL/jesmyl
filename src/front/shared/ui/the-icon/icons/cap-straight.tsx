...
export const IconCapStraightStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CapStraight StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCapStraightDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CapStraight DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconCapStraightTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CapStraight TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCapStraightSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CapStraight SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconCapStraightBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CapStraight BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconCapStraightStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CapStraight StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconCapStraightSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CapStraight SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfCapStraight: TheIconSelfPack = [
  'CapStraight',
  IconCapStraightStrokeRounded,
  IconCapStraightDuotoneRounded,
  IconCapStraightTwotoneRounded,
  IconCapStraightSolidRounded,
  IconCapStraightBulkRounded,
  IconCapStraightStrokeSharp,
  IconCapStraightSolidSharp,
];