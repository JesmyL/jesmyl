...
export const IconWinkingStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Winking StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconWinkingDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Winking DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconWinkingTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Winking TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const iconPackOfWinking: TheIconSelfPack = [
  'Winking',
  IconWinkingStrokeRounded,
  IconWinkingDuotoneRounded,
  IconWinkingTwotoneRounded,
  IconWinkingSolidRounded,
  IconWinkingBulkRounded,
  IconWinkingStrokeSharp,
  IconWinkingSolidSharp,
];