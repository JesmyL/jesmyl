...
export const IconCorporateStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Corporate StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconCorporateDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Corporate DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconCorporateTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Corporate TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconCorporateSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Corporate SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconCorporateBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Corporate BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconCorporateStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Corporate StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const iconPackOfCorporate: TheIconSelfPack = [
  'Corporate',
  IconCorporateStrokeRounded,
  IconCorporateDuotoneRounded,
  IconCorporateTwotoneRounded,
  IconCorporateSolidRounded,
  IconCorporateBulkRounded,
  IconCorporateStrokeSharp,
  IconCorporateSolidSharp,
];