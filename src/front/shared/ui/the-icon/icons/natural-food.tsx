...
export const IconNaturalFoodStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NaturalFood StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconNaturalFoodDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NaturalFood DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconNaturalFoodTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NaturalFood TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconNaturalFoodSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NaturalFood SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconNaturalFoodBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NaturalFood BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d10}
...
export const IconNaturalFoodStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NaturalFood StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconNaturalFoodSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NaturalFood SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const iconPackOfNaturalFood: TheIconSelfPack = [
  'NaturalFood',
  IconNaturalFoodStrokeRounded,
  IconNaturalFoodDuotoneRounded,
  IconNaturalFoodTwotoneRounded,
  IconNaturalFoodSolidRounded,
  IconNaturalFoodBulkRounded,
  IconNaturalFoodStrokeSharp,
  IconNaturalFoodSolidSharp,
];