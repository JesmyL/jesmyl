...
export const IconUploadSquare01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UploadSquare01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUploadSquare01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UploadSquare01 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconUploadSquare01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UploadSquare01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconUploadSquare01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UploadSquare01 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconUploadSquare01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UploadSquare01 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconUploadSquare01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UploadSquare01 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const IconUploadSquare01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UploadSquare01 SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfUploadSquare01: TheIconSelfPack = [
  'UploadSquare01',
  IconUploadSquare01StrokeRounded,
  IconUploadSquare01DuotoneRounded,
  IconUploadSquare01TwotoneRounded,
  IconUploadSquare01SolidRounded,
  IconUploadSquare01BulkRounded,
  IconUploadSquare01StrokeSharp,
  IconUploadSquare01SolidSharp,
];