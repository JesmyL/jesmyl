...
export const IconBriefcase05StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase05 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBriefcase05DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase05 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconBriefcase05TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase05 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconBriefcase05SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase05 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconBriefcase05BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase05 BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconBriefcase05StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase05 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconBriefcase05SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase05 SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfBriefcase05: TheIconSelfPack = [
  'Briefcase05',
  IconBriefcase05StrokeRounded,
  IconBriefcase05DuotoneRounded,
  IconBriefcase05TwotoneRounded,
  IconBriefcase05SolidRounded,
  IconBriefcase05BulkRounded,
  IconBriefcase05StrokeSharp,
  IconBriefcase05SolidSharp,
];