...
export const iconPackOfDua: TheIconSelfPack = [
  'Dua',
  IconDuaStrokeRounded,
  IconDuaDuotoneRounded,
  IconDuaTwotoneRounded,
  IconDuaSolidRounded,
  IconDuaBulkRounded,
  IconDuaStrokeSharp,
  IconDuaSolidSharp,
