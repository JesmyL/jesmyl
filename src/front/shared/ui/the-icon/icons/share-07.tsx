...
export const IconShare07StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Share07 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconShare07DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Share07 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconShare07TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Share07 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfShare07: TheIconSelfPack = [
  'Share07',
  IconShare07StrokeRounded,
  IconShare07DuotoneRounded,
  IconShare07TwotoneRounded,
  IconShare07SolidRounded,
  IconShare07BulkRounded,
  IconShare07StrokeSharp,
  IconShare07SolidSharp,
];