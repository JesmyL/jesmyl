...
export const IconMoon01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Moon01 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconMoon01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Moon01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfMoon01: TheIconSelfPack = [
  'Moon01',
  IconMoon01StrokeRounded,
  IconMoon01DuotoneRounded,
  IconMoon01TwotoneRounded,
  IconMoon01SolidRounded,
  IconMoon01BulkRounded,
  IconMoon01StrokeSharp,
  IconMoon01SolidSharp,
];