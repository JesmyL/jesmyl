...
export const IconResize02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Resize02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconResize02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Resize02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconResize02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Resize02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconResize02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Resize02 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const iconPackOfResize02: TheIconSelfPack = [
  'Resize02',
  IconResize02StrokeRounded,
  IconResize02DuotoneRounded,
  IconResize02TwotoneRounded,
  IconResize02SolidRounded,
  IconResize02BulkRounded,
  IconResize02StrokeSharp,
  IconResize02SolidSharp,
];