...
export const IconMushroomStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mushroom StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconMushroomDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mushroom DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconMushroomTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mushroom TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconMushroomSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mushroom SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const iconPackOfMushroom: TheIconSelfPack = [
  'Mushroom',
  IconMushroomStrokeRounded,
  IconMushroomDuotoneRounded,
  IconMushroomTwotoneRounded,
  IconMushroomSolidRounded,
  IconMushroomBulkRounded,
  IconMushroomStrokeSharp,
  IconMushroomSolidSharp,
];