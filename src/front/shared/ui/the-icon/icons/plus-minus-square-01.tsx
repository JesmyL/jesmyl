...
export const IconPlusMinusSquare01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlusMinusSquare01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPlusMinusSquare01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlusMinusSquare01 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconPlusMinusSquare01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlusMinusSquare01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconPlusMinusSquare01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlusMinusSquare01 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconPlusMinusSquare01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlusMinusSquare01 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconPlusMinusSquare01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlusMinusSquare01 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconPlusMinusSquare01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlusMinusSquare01 SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfPlusMinusSquare01: TheIconSelfPack = [
  'PlusMinusSquare01',
  IconPlusMinusSquare01StrokeRounded,
  IconPlusMinusSquare01DuotoneRounded,
  IconPlusMinusSquare01TwotoneRounded,
  IconPlusMinusSquare01SolidRounded,
  IconPlusMinusSquare01BulkRounded,
  IconPlusMinusSquare01StrokeSharp,
  IconPlusMinusSquare01SolidSharp,
];