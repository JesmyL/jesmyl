...
export const IconTextAlignRightStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextAlignRight StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTextAlignRightDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextAlignRight DuotoneRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d1}
...
export const IconTextAlignRightTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextAlignRight TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconTextAlignRightSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextAlignRight SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconTextAlignRightBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextAlignRight BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconTextAlignRightStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextAlignRight StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconTextAlignRightSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextAlignRight SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfTextAlignRight: TheIconSelfPack = [
  'TextAlignRight',
  IconTextAlignRightStrokeRounded,
  IconTextAlignRightDuotoneRounded,
  IconTextAlignRightTwotoneRounded,
  IconTextAlignRightSolidRounded,
  IconTextAlignRightBulkRounded,
  IconTextAlignRightStrokeSharp,
  IconTextAlignRightSolidSharp,
];