...
export const IconNavigation02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Navigation02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconNavigation02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Navigation02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconNavigation02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Navigation02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconNavigation02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Navigation02 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconNavigation02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Navigation02 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconNavigation02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Navigation02 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconNavigation02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Navigation02 SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="f"
...
export const iconPackOfNavigation02: TheIconSelfPack = [
  'Navigation02',
  IconNavigation02StrokeRounded,
  IconNavigation02DuotoneRounded,
  IconNavigation02TwotoneRounded,
  IconNavigation02SolidRounded,
  IconNavigation02BulkRounded,
  IconNavigation02StrokeSharp,
  IconNavigation02SolidSharp,
];