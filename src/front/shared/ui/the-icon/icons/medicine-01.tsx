...
export const IconMedicine01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Medicine01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMedicine01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Medicine01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconMedicine01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Medicine01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMedicine01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Medicine01 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconMedicine01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Medicine01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconMedicine01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Medicine01 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconMedicine01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Medicine01 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const iconPackOfMedicine01: TheIconSelfPack = [
  'Medicine01',
  IconMedicine01StrokeRounded,
  IconMedicine01DuotoneRounded,
  IconMedicine01TwotoneRounded,
  IconMedicine01SolidRounded,
  IconMedicine01BulkRounded,
  IconMedicine01StrokeSharp,
  IconMedicine01SolidSharp,
];