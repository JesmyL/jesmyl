...
export const iconPackOfChart: TheIconSelfPack = [
  'Chart',
  IconChartStrokeRounded,
  IconChartDuotoneRounded,
  IconChartTwotoneRounded,
  IconChartSolidRounded,
  IconChartBulkRounded,
  IconChartStrokeSharp,
  IconChartSolidSharp,
];