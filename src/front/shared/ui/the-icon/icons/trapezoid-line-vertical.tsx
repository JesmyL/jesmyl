...
export const IconTrapezoidLineVerticalStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TrapezoidLineVertical StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconTrapezoidLineVerticalDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TrapezoidLineVertical DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconTrapezoidLineVerticalTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TrapezoidLineVertical TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconTrapezoidLineVerticalSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TrapezoidLineVertical SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconTrapezoidLineVerticalBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TrapezoidLineVertical BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconTrapezoidLineVerticalStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TrapezoidLineVertical StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const IconTrapezoidLineVerticalSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TrapezoidLineVertical SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfTrapezoidLineVertical: TheIconSelfPack = [
  ...
  IconTrapezoidLineVerticalStrokeRounded,
  IconTrapezoidLineVerticalDuotoneRounded,
  IconTrapezoidLineVerticalTwotoneRounded,
  IconTrapezoidLineVerticalSolidRounded,
  IconTrapezoidLineVerticalBulkRounded,
  IconTrapezoidLineVerticalStrokeSharp,
  IconTrapezoidLineVerticalSolidSharp,
];