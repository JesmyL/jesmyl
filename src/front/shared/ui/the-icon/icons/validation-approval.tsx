...
export const IconValidationApprovalStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ValidationApproval StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconValidationApprovalDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ValidationApproval DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconValidationApprovalTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ValidationApproval TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconValidationApprovalSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ValidationApproval SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconValidationApprovalBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ValidationApproval BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconValidationApprovalStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ValidationApproval StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sj sw"
...
export const IconValidationApprovalSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ValidationApproval SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const iconPackOfValidationApproval: TheIconSelfPack = [
  'ValidationApproval',
  IconValidationApprovalStrokeRounded,
  IconValidationApprovalDuotoneRounded,
  IconValidationApprovalTwotoneRounded,
  IconValidationApprovalSolidRounded,
  IconValidationApprovalBulkRounded,
  IconValidationApprovalStrokeSharp,
  IconValidationApprovalSolidSharp,
];