...
export const IconDarkModeStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DarkMode StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDarkModeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DarkMode DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconDarkModeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DarkMode TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDarkModeSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DarkMode SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const iconPackOfDarkMode: TheIconSelfPack = [
  'DarkMode',
  IconDarkModeStrokeRounded,
  IconDarkModeDuotoneRounded,
  IconDarkModeTwotoneRounded,
  IconDarkModeSolidRounded,
  IconDarkModeBulkRounded,
  IconDarkModeStrokeSharp,
  IconDarkModeSolidSharp,
];