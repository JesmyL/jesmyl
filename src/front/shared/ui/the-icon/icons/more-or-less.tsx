...
export const IconMoreOrLessStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreOrLess StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconMoreOrLessDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreOrLess DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconMoreOrLessTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreOrLess TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconMoreOrLessSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreOrLess SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconMoreOrLessBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreOrLess BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconMoreOrLessStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreOrLess StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconMoreOrLessSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreOrLess SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfMoreOrLess: TheIconSelfPack = [
  'MoreOrLess',
  IconMoreOrLessStrokeRounded,
  IconMoreOrLessDuotoneRounded,
  IconMoreOrLessTwotoneRounded,
  IconMoreOrLessSolidRounded,
  IconMoreOrLessBulkRounded,
  IconMoreOrLessStrokeSharp,
  IconMoreOrLessSolidSharp,
];