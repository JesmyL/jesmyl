...
export const IconDownloadSquare01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DownloadSquare01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconDownloadSquare01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DownloadSquare01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconDownloadSquare01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DownloadSquare01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconDownloadSquare01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DownloadSquare01 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconDownloadSquare01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DownloadSquare01 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconDownloadSquare01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DownloadSquare01 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const IconDownloadSquare01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DownloadSquare01 SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfDownloadSquare01: TheIconSelfPack = [
  'DownloadSquare01',
  IconDownloadSquare01StrokeRounded,
  IconDownloadSquare01DuotoneRounded,
  IconDownloadSquare01TwotoneRounded,
  IconDownloadSquare01SolidRounded,
  IconDownloadSquare01BulkRounded,
  IconDownloadSquare01StrokeSharp,
  IconDownloadSquare01SolidSharp,
];