...
export const IconArtboardToolStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArtboardTool StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconArtboardToolDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArtboardTool DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconArtboardToolTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArtboardTool TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconArtboardToolSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArtboardTool SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconArtboardToolBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArtboardTool BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconArtboardToolStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArtboardTool StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sw"
...
export const IconArtboardToolSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArtboardTool SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfArtboardTool: TheIconSelfPack = [
  'ArtboardTool',
  IconArtboardToolStrokeRounded,
  IconArtboardToolDuotoneRounded,
  IconArtboardToolTwotoneRounded,
  IconArtboardToolSolidRounded,
  IconArtboardToolBulkRounded,
  IconArtboardToolStrokeSharp,
  IconArtboardToolSolidSharp,
];