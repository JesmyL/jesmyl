...
export const IconNotification01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Notification01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconNotification01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Notification01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconNotification01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Notification01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconNotification01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Notification01 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconNotification01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Notification01 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconNotification01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Notification01 StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const IconNotification01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Notification01 SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="f"
...
export const iconPackOfNotification01: TheIconSelfPack = [
  ...
  IconNotification01DuotoneRounded,
  IconNotification01TwotoneRounded,
  IconNotification01SolidRounded,
  IconNotification01BulkRounded,
  IconNotification01StrokeSharp,
  IconNotification01SolidSharp,
];