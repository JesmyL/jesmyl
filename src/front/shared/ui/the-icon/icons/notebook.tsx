...
export const IconNotebookStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Notebook StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconNotebookDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Notebook DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconNotebookTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Notebook TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconNotebookSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Notebook SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const iconPackOfNotebook: TheIconSelfPack = [
  'Notebook',
  IconNotebookStrokeRounded,
  IconNotebookDuotoneRounded,
  IconNotebookTwotoneRounded,
  IconNotebookSolidRounded,
  IconNotebookBulkRounded,
  IconNotebookStrokeSharp,
  IconNotebookSolidSharp,
];