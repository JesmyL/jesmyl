...
export const IconCabinet02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cabinet02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCabinet02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cabinet02 DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconCabinet02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cabinet02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCabinet02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cabinet02 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconCabinet02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cabinet02 BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d11}
...
export const IconCabinet02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cabinet02 StrokeSharp"
    >
      <path 
        d={d.d16}
        i-c="s sj sw"
...
export const iconPackOfCabinet02: TheIconSelfPack = [
  'Cabinet02',
  IconCabinet02StrokeRounded,
  IconCabinet02DuotoneRounded,
  IconCabinet02TwotoneRounded,
  IconCabinet02SolidRounded,
  IconCabinet02BulkRounded,
  IconCabinet02StrokeSharp,
  IconCabinet02SolidSharp,
];