...
export const IconDeliveryBox01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveryBox01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDeliveryBox01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveryBox01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconDeliveryBox01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveryBox01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDeliveryBox01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveryBox01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconDeliveryBox01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveryBox01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconDeliveryBox01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveryBox01 StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sr sw"
...
export const IconDeliveryBox01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveryBox01 SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfDeliveryBox01: TheIconSelfPack = [
  'DeliveryBox01',
  IconDeliveryBox01StrokeRounded,
  IconDeliveryBox01DuotoneRounded,
  IconDeliveryBox01TwotoneRounded,
  IconDeliveryBox01SolidRounded,
  IconDeliveryBox01BulkRounded,
  IconDeliveryBox01StrokeSharp,
  IconDeliveryBox01SolidSharp,
];