...
export const IconUserQuestion02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserQuestion02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserQuestion02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserQuestion02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconUserQuestion02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserQuestion02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserQuestion02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserQuestion02 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconUserQuestion02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserQuestion02 BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d5}
...
export const IconUserQuestion02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserQuestion02 StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const IconUserQuestion02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserQuestion02 SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="f"
...
export const iconPackOfUserQuestion02: TheIconSelfPack = [
  'UserQuestion02',
  IconUserQuestion02StrokeRounded,
  IconUserQuestion02DuotoneRounded,
  IconUserQuestion02TwotoneRounded,
  IconUserQuestion02SolidRounded,
  IconUserQuestion02BulkRounded,
  IconUserQuestion02StrokeSharp,
  IconUserQuestion02SolidSharp,
];