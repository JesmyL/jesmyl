...
export const IconSidebarBottomStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarBottom StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSidebarBottomDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarBottom DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconSidebarBottomTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarBottom TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSidebarBottomSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarBottom SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconSidebarBottomBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarBottom BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconSidebarBottomStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarBottom StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconSidebarBottomSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarBottom SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfSidebarBottom: TheIconSelfPack = [
  'SidebarBottom',
  IconSidebarBottomStrokeRounded,
  IconSidebarBottomDuotoneRounded,
  IconSidebarBottomTwotoneRounded,
  IconSidebarBottomSolidRounded,
  IconSidebarBottomBulkRounded,
  IconSidebarBottomStrokeSharp,
  IconSidebarBottomSolidSharp,
];