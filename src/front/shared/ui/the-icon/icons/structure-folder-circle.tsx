...
export const IconStructureFolderCircleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StructureFolderCircle StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconStructureFolderCircleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StructureFolderCircle DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconStructureFolderCircleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StructureFolderCircle TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconStructureFolderCircleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StructureFolderCircle SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconStructureFolderCircleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StructureFolderCircle BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconStructureFolderCircleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StructureFolderCircle StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconStructureFolderCircleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StructureFolderCircle SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="f"
...
export const iconPackOfStructureFolderCircle: TheIconSelfPack = [
  ...
  IconStructureFolderCircleStrokeRounded,
  IconStructureFolderCircleDuotoneRounded,
  IconStructureFolderCircleTwotoneRounded,
  IconStructureFolderCircleSolidRounded,
  IconStructureFolderCircleBulkRounded,
  IconStructureFolderCircleStrokeSharp,
  IconStructureFolderCircleSolidSharp,
];