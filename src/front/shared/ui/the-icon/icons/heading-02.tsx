...
export const IconHeading02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Heading02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHeading02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Heading02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHeading02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Heading02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHeading02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Heading02 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconHeading02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Heading02 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconHeading02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Heading02 StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const iconPackOfHeading02: TheIconSelfPack = [
  'Heading02',
  IconHeading02StrokeRounded,
  IconHeading02DuotoneRounded,
  IconHeading02TwotoneRounded,
  IconHeading02SolidRounded,
  IconHeading02BulkRounded,
  IconHeading02StrokeSharp,
  IconHeading02SolidSharp,
];