...
export const IconMenu03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Menu03 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconMenu03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Menu03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfMenu03: TheIconSelfPack = [
  'Menu03',
  IconMenu03StrokeRounded,
  IconMenu03DuotoneRounded,
  IconMenu03TwotoneRounded,
  IconMenu03SolidRounded,
  IconMenu03BulkRounded,
  IconMenu03StrokeSharp,
  IconMenu03SolidSharp,
];