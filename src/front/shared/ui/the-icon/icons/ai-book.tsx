...
export const IconAiBookDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiBook DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconAiBookTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiBook TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfAiBook: TheIconSelfPack = [
  'AiBook',
  IconAiBookStrokeRounded,
  IconAiBookDuotoneRounded,
  IconAiBookTwotoneRounded,
  IconAiBookSolidRounded,
  IconAiBookBulkRounded,
  IconAiBookStrokeSharp,
  IconAiBookSolidSharp,
];