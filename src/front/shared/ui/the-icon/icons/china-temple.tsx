...
export const IconChinaTempleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChinaTemple StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconChinaTempleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChinaTemple DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconChinaTempleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChinaTemple TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconChinaTempleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChinaTemple SolidRounded"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const IconChinaTempleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChinaTemple BulkRounded"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const IconChinaTempleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChinaTemple StrokeSharp"
    >
      <path 
        d={d.d21}
        i-c="s sw"
...
export const IconChinaTempleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChinaTemple SolidSharp"
    >
      <path 
        d={d.d23}
        i-c="f"
...
export const iconPackOfChinaTemple: TheIconSelfPack = [
  'ChinaTemple',
  IconChinaTempleStrokeRounded,
  IconChinaTempleDuotoneRounded,
  IconChinaTempleTwotoneRounded,
  IconChinaTempleSolidRounded,
  IconChinaTempleBulkRounded,
  IconChinaTempleStrokeSharp,
  IconChinaTempleSolidSharp,
];