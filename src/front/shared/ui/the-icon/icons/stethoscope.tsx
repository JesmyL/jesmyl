...
export const IconStethoscopeStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Stethoscope StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconStethoscopeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Stethoscope DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconStethoscopeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Stethoscope TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconStethoscopeSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Stethoscope SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconStethoscopeBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Stethoscope BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconStethoscopeStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Stethoscope StrokeSharp"
    >
      <path 
        d={d.d14}
        i-c="s sj sw"
...
export const IconStethoscopeSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Stethoscope SolidSharp"
    >
      <path 
        d={d.d16}
        i-c="c f fr"
...
export const iconPackOfStethoscope: TheIconSelfPack = [
  'Stethoscope',
  IconStethoscopeStrokeRounded,
  IconStethoscopeDuotoneRounded,
  IconStethoscopeTwotoneRounded,
  IconStethoscopeSolidRounded,
  IconStethoscopeBulkRounded,
  IconStethoscopeStrokeSharp,
  IconStethoscopeSolidSharp,
];