...
export const IconDepartementStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Departement StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDepartementDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Departement DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconDepartementTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Departement TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDepartementSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Departement SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconDepartementBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Departement BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconDepartementStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Departement StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sr sw"
...
export const IconDepartementSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Departement SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfDepartement: TheIconSelfPack = [
  'Departement',
  IconDepartementStrokeRounded,
  IconDepartementDuotoneRounded,
  IconDepartementTwotoneRounded,
  IconDepartementSolidRounded,
  IconDepartementBulkRounded,
  IconDepartementStrokeSharp,
  IconDepartementSolidSharp,
];