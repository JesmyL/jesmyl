...
export const IconCommandLineStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CommandLine StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconCommandLineDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CommandLine DuotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconCommandLineTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CommandLine TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconCommandLineSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CommandLine SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconCommandLineBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CommandLine BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconCommandLineStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CommandLine StrokeSharp"
    >
      <path 
        d={d.d15}
        i-c="s sw"
...
export const IconCommandLineSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CommandLine SolidSharp"
    >
      <path 
        d={d.d18}
        i-c="c f fr"
...
export const iconPackOfCommandLine: TheIconSelfPack = [
  'CommandLine',
  IconCommandLineStrokeRounded,
  IconCommandLineDuotoneRounded,
  IconCommandLineTwotoneRounded,
  IconCommandLineSolidRounded,
  IconCommandLineBulkRounded,
  IconCommandLineStrokeSharp,
  IconCommandLineSolidSharp,
];