...
export const IconPerspectiveStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Perspective StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPerspectiveDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Perspective DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconPerspectiveTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Perspective TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconPerspectiveSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Perspective SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconPerspectiveBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Perspective BulkRounded"
    >
      <path 
        d={d.d11}
        i-c="f o7"
...
export const IconPerspectiveStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Perspective StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sj sw"
...
export const IconPerspectiveSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Perspective SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="f"
...
export const iconPackOfPerspective: TheIconSelfPack = [
  'Perspective',
  IconPerspectiveStrokeRounded,
  IconPerspectiveDuotoneRounded,
  IconPerspectiveTwotoneRounded,
  IconPerspectiveSolidRounded,
  IconPerspectiveBulkRounded,
  IconPerspectiveStrokeSharp,
  IconPerspectiveSolidSharp,
];