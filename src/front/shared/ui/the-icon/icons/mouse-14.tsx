...
export const IconMouse14StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mouse14 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMouse14DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mouse14 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconMouse14TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mouse14 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfMouse14: TheIconSelfPack = [
  'Mouse14',
  IconMouse14StrokeRounded,
  IconMouse14DuotoneRounded,
  IconMouse14TwotoneRounded,
  IconMouse14SolidRounded,
  IconMouse14BulkRounded,
  IconMouse14StrokeSharp,
  IconMouse14SolidSharp,
];