...
export const IconImageUploadStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageUpload StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconImageUploadDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageUpload DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconImageUploadTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageUpload TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconImageUploadSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageUpload SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconImageUploadBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageUpload BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr o7"
...
export const IconImageUploadStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageUpload StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const IconImageUploadSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageUpload SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const iconPackOfImageUpload: TheIconSelfPack = [
  'ImageUpload',
  IconImageUploadStrokeRounded,
  IconImageUploadDuotoneRounded,
  IconImageUploadTwotoneRounded,
  IconImageUploadSolidRounded,
  IconImageUploadBulkRounded,
  IconImageUploadStrokeSharp,
  IconImageUploadSolidSharp,
];