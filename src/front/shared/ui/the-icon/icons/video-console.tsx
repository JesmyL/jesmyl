...
export const IconVideoConsoleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VideoConsole StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconVideoConsoleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VideoConsole DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconVideoConsoleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VideoConsole TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconVideoConsoleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VideoConsole SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconVideoConsoleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VideoConsole BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconVideoConsoleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VideoConsole StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const IconVideoConsoleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VideoConsole SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfVideoConsole: TheIconSelfPack = [
  'VideoConsole',
  IconVideoConsoleStrokeRounded,
  IconVideoConsoleDuotoneRounded,
  IconVideoConsoleTwotoneRounded,
  IconVideoConsoleSolidRounded,
  IconVideoConsoleBulkRounded,
  IconVideoConsoleStrokeSharp,
  IconVideoConsoleSolidSharp,
];