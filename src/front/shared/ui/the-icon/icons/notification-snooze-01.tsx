...
export const IconNotificationSnooze01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationSnooze01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconNotificationSnooze01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationSnooze01 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconNotificationSnooze01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationSnooze01 TwotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="s sj sr sw"
...
export const IconNotificationSnooze01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationSnooze01 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconNotificationSnooze01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationSnooze01 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconNotificationSnooze01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationSnooze01 StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sw"
...
export const IconNotificationSnooze01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationSnooze01 SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const iconPackOfNotificationSnooze01: TheIconSelfPack = [
  ...
  IconNotificationSnooze01StrokeRounded,
  IconNotificationSnooze01DuotoneRounded,
  IconNotificationSnooze01TwotoneRounded,
  IconNotificationSnooze01SolidRounded,
  IconNotificationSnooze01BulkRounded,
  IconNotificationSnooze01StrokeSharp,
  IconNotificationSnooze01SolidSharp,
];