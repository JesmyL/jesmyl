...
export const IconWrench02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wrench02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWrench02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wrench02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconWrench02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wrench02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWrench02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wrench02 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const iconPackOfWrench02: TheIconSelfPack = [
  'Wrench02',
  IconWrench02StrokeRounded,
  IconWrench02DuotoneRounded,
  IconWrench02TwotoneRounded,
  IconWrench02SolidRounded,
  IconWrench02BulkRounded,
  IconWrench02StrokeSharp,
  IconWrench02SolidSharp,
];