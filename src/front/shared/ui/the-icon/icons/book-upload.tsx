...
export const IconBookUploadStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookUpload StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconBookUploadDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookUpload DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconBookUploadTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookUpload TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconBookUploadSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookUpload SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconBookUploadBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookUpload BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr o7"
...
export const IconBookUploadStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookUpload StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const IconBookUploadSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookUpload SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfBookUpload: TheIconSelfPack = [
  'BookUpload',
  IconBookUploadStrokeRounded,
  IconBookUploadDuotoneRounded,
  IconBookUploadTwotoneRounded,
  IconBookUploadSolidRounded,
  IconBookUploadBulkRounded,
  IconBookUploadStrokeSharp,
  IconBookUploadSolidSharp,
];