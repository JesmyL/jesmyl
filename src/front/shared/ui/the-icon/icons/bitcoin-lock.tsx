...
export const IconBitcoinLockStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinLock StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconBitcoinLockDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinLock DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconBitcoinLockTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinLock TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconBitcoinLockSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinLock SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconBitcoinLockBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinLock BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconBitcoinLockStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinLock StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const IconBitcoinLockSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinLock SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfBitcoinLock: TheIconSelfPack = [
  'BitcoinLock',
  IconBitcoinLockStrokeRounded,
  IconBitcoinLockDuotoneRounded,
  IconBitcoinLockTwotoneRounded,
  IconBitcoinLockSolidRounded,
  IconBitcoinLockBulkRounded,
  IconBitcoinLockStrokeSharp,
  IconBitcoinLockSolidSharp,
];