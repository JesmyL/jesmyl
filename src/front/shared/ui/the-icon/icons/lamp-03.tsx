...
export const IconLamp03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Lamp03 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconLamp03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Lamp03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfLamp03: TheIconSelfPack = [
  'Lamp03',
  IconLamp03StrokeRounded,
  IconLamp03DuotoneRounded,
  IconLamp03TwotoneRounded,
  IconLamp03SolidRounded,
  IconLamp03BulkRounded,
  IconLamp03StrokeSharp,
  IconLamp03SolidSharp,
];