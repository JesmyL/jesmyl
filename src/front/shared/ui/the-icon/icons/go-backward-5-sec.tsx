...
export const IconGoBackward5SecStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoBackward5Sec StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGoBackward5SecDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoBackward5Sec DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconGoBackward5SecTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoBackward5Sec TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGoBackward5SecSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoBackward5Sec SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconGoBackward5SecBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoBackward5Sec BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconGoBackward5SecStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoBackward5Sec StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const IconGoBackward5SecSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoBackward5Sec SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfGoBackward5Sec: TheIconSelfPack = [
  'GoBackward5Sec',
  IconGoBackward5SecStrokeRounded,
  IconGoBackward5SecDuotoneRounded,
  IconGoBackward5SecTwotoneRounded,
  IconGoBackward5SecSolidRounded,
  IconGoBackward5SecBulkRounded,
  IconGoBackward5SecStrokeSharp,
  IconGoBackward5SecSolidSharp,
];