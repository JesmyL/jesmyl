...
export const IconPaintBucketStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PaintBucket StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPaintBucketDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PaintBucket DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconPaintBucketTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PaintBucket TwotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="s sj sr sw"
...
export const IconPaintBucketSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PaintBucket SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconPaintBucketBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PaintBucket BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconPaintBucketStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PaintBucket StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sw"
...
export const IconPaintBucketSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PaintBucket SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfPaintBucket: TheIconSelfPack = [
  'PaintBucket',
  IconPaintBucketStrokeRounded,
  IconPaintBucketDuotoneRounded,
  IconPaintBucketTwotoneRounded,
  IconPaintBucketSolidRounded,
  IconPaintBucketBulkRounded,
  IconPaintBucketStrokeSharp,
  IconPaintBucketSolidSharp,
];