...
export const iconPackOfSmile: TheIconSelfPack = [
  ...
  IconSmileDuotoneRounded,
  IconSmileTwotoneRounded,
  IconSmileSolidRounded,
  IconSmileBulkRounded,
  IconSmileStrokeSharp,
  IconSmileSolidSharp,
];