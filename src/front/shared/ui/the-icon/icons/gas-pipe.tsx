...
export const IconGasPipeStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GasPipe StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGasPipeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GasPipe DuotoneRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d7}
...
export const IconGasPipeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GasPipe TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfGasPipe: TheIconSelfPack = [
  'GasPipe',
  IconGasPipeStrokeRounded,
  IconGasPipeDuotoneRounded,
  IconGasPipeTwotoneRounded,
  IconGasPipeSolidRounded,
  IconGasPipeBulkRounded,
  IconGasPipeStrokeSharp,
  IconGasPipeSolidSharp,
];