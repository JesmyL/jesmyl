...
export const IconMilkBottleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MilkBottle StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMilkBottleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MilkBottle DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconMilkBottleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MilkBottle TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMilkBottleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MilkBottle SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconMilkBottleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MilkBottle BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconMilkBottleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MilkBottle StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const IconMilkBottleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MilkBottle SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfMilkBottle: TheIconSelfPack = [
  'MilkBottle',
  IconMilkBottleStrokeRounded,
  IconMilkBottleDuotoneRounded,
  IconMilkBottleTwotoneRounded,
  IconMilkBottleSolidRounded,
  IconMilkBottleBulkRounded,
  IconMilkBottleStrokeSharp,
  IconMilkBottleSolidSharp,
];