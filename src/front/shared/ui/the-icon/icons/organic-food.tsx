...
export const IconOrganicFoodStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OrganicFood StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconOrganicFoodDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OrganicFood DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconOrganicFoodTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OrganicFood TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconOrganicFoodSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OrganicFood SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconOrganicFoodBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OrganicFood BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconOrganicFoodStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OrganicFood StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconOrganicFoodSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OrganicFood SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfOrganicFood: TheIconSelfPack = [
  'OrganicFood',
  IconOrganicFoodStrokeRounded,
  IconOrganicFoodDuotoneRounded,
  IconOrganicFoodTwotoneRounded,
  IconOrganicFoodSolidRounded,
  IconOrganicFoodBulkRounded,
  IconOrganicFoodStrokeSharp,
  IconOrganicFoodSolidSharp,
];