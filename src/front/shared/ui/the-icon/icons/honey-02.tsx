...
export const IconHoney02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Honey02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconHoney02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Honey02 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconHoney02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Honey02 TwotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="o7 s sr sw"
...
export const iconPackOfHoney02: TheIconSelfPack = [
  'Honey02',
  IconHoney02StrokeRounded,
  IconHoney02DuotoneRounded,
  IconHoney02TwotoneRounded,
  IconHoney02SolidRounded,
  IconHoney02BulkRounded,
  IconHoney02StrokeSharp,
  IconHoney02SolidSharp,
];