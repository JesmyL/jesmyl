...
export const IconFolderLibraryStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderLibrary StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFolderLibraryDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderLibrary DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconFolderLibraryTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderLibrary TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconFolderLibrarySolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderLibrary SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconFolderLibraryBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderLibrary BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconFolderLibraryStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderLibrary StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconFolderLibrarySolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderLibrary SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfFolderLibrary: TheIconSelfPack = [
  'FolderLibrary',
  IconFolderLibraryStrokeRounded,
  IconFolderLibraryDuotoneRounded,
  IconFolderLibraryTwotoneRounded,
  IconFolderLibrarySolidRounded,
  IconFolderLibraryBulkRounded,
  IconFolderLibraryStrokeSharp,
  IconFolderLibrarySolidSharp,
];