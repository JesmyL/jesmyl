...
export const IconSolarPanel05StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SolarPanel05 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSolarPanel05DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SolarPanel05 DuotoneRounded"
    >
      <path 
        d={d.d11}
        i-c="f o7"
...
export const IconSolarPanel05TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SolarPanel05 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconSolarPanel05SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SolarPanel05 SolidRounded"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const IconSolarPanel05BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SolarPanel05 BulkRounded"
    >
      <path 
        d={d.d13}
        i-c="f o7"
...
export const IconSolarPanel05StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SolarPanel05 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s ss sw"
...
export const IconSolarPanel05SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SolarPanel05 SolidSharp"
    >
      <path 
        d={d.d28}
        i-c="c f fr"
...
export const iconPackOfSolarPanel05: TheIconSelfPack = [
  'SolarPanel05',
  IconSolarPanel05StrokeRounded,
  IconSolarPanel05DuotoneRounded,
  IconSolarPanel05TwotoneRounded,
  IconSolarPanel05SolidRounded,
  IconSolarPanel05BulkRounded,
  IconSolarPanel05StrokeSharp,
  IconSolarPanel05SolidSharp,
];