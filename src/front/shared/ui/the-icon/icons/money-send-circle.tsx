...
export const IconMoneySendCircleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneySendCircle StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconMoneySendCircleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneySendCircle DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconMoneySendCircleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneySendCircle TwotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="s sr sw"
...
export const IconMoneySendCircleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneySendCircle SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconMoneySendCircleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneySendCircle BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr o7"
...
export const IconMoneySendCircleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneySendCircle StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconMoneySendCircleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneySendCircle SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfMoneySendCircle: TheIconSelfPack = [
  'MoneySendCircle',
  IconMoneySendCircleStrokeRounded,
  IconMoneySendCircleDuotoneRounded,
  IconMoneySendCircleTwotoneRounded,
  IconMoneySendCircleSolidRounded,
  IconMoneySendCircleBulkRounded,
  IconMoneySendCircleStrokeSharp,
  IconMoneySendCircleSolidSharp,
];