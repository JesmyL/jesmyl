...
export const IconElectricWireStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ElectricWire StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconElectricWireDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ElectricWire DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconElectricWireTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ElectricWire TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconElectricWireSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ElectricWire SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconElectricWireBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ElectricWire BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconElectricWireStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ElectricWire StrokeSharp"
    >
      <path 
        d={d.d17}
        i-c="s ss sw"
...
export const IconElectricWireSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ElectricWire SolidSharp"
    >
      <path 
        d={d.d19}
        i-c="c f fr"
...
export const iconPackOfElectricWire: TheIconSelfPack = [
  'ElectricWire',
  IconElectricWireStrokeRounded,
  IconElectricWireDuotoneRounded,
  IconElectricWireTwotoneRounded,
  IconElectricWireSolidRounded,
  IconElectricWireBulkRounded,
  IconElectricWireStrokeSharp,
  IconElectricWireSolidSharp,
];