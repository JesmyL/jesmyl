...
export const IconWindPower03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WindPower03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWindPower03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WindPower03 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconWindPower03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WindPower03 TwotoneRounded"
    >
      <path 
        d={d.d14}
        i-c="s sj sr sw"
...
export const IconWindPower03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WindPower03 SolidRounded"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const IconWindPower03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WindPower03 BulkRounded"
    >
      <path 
        d={d.d21}
        i-c="f"
...
export const IconWindPower03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WindPower03 StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sw"
...
export const IconWindPower03SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WindPower03 SolidSharp"
    >
      <path 
        d={d.d24}
        i-c="c f fr"
...
export const iconPackOfWindPower03: TheIconSelfPack = [
  'WindPower03',
  IconWindPower03StrokeRounded,
  IconWindPower03DuotoneRounded,
  IconWindPower03TwotoneRounded,
  IconWindPower03SolidRounded,
  IconWindPower03BulkRounded,
  IconWindPower03StrokeSharp,
  IconWindPower03SolidSharp,
];