...
export const IconEraserDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Eraser DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconEraserTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Eraser TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfEraser: TheIconSelfPack = [
  'Eraser',
  IconEraserStrokeRounded,
  IconEraserDuotoneRounded,
  IconEraserTwotoneRounded,
  IconEraserSolidRounded,
  IconEraserBulkRounded,
  IconEraserStrokeSharp,
  IconEraserSolidSharp,
];