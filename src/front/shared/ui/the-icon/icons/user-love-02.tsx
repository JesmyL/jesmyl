...
export const IconUserLove02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserLove02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserLove02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserLove02 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconUserLove02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserLove02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserLove02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserLove02 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconUserLove02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserLove02 BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d4}
...
export const IconUserLove02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserLove02 StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const IconUserLove02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserLove02 SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfUserLove02: TheIconSelfPack = [
  'UserLove02',
  IconUserLove02StrokeRounded,
  IconUserLove02DuotoneRounded,
  IconUserLove02TwotoneRounded,
  IconUserLove02SolidRounded,
  IconUserLove02BulkRounded,
  IconUserLove02StrokeSharp,
  IconUserLove02SolidSharp,
];