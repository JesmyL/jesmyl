...
export const IconPlug01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Plug01 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconPlug01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Plug01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfPlug01: TheIconSelfPack = [
  'Plug01',
  IconPlug01StrokeRounded,
  IconPlug01DuotoneRounded,
  IconPlug01TwotoneRounded,
  IconPlug01SolidRounded,
  IconPlug01BulkRounded,
  IconPlug01StrokeSharp,
  IconPlug01SolidSharp,
];