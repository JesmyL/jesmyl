...
export const IconDatabase01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Database01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconDatabase01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Database01 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconDatabase01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Database01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconDatabase01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Database01 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconDatabase01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Database01 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconDatabase01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Database01 StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sj sw"
...
export const IconDatabase01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Database01 SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const iconPackOfDatabase01: TheIconSelfPack = [
  'Database01',
  IconDatabase01StrokeRounded,
  IconDatabase01DuotoneRounded,
  IconDatabase01TwotoneRounded,
  IconDatabase01SolidRounded,
  IconDatabase01BulkRounded,
  IconDatabase01StrokeSharp,
  IconDatabase01SolidSharp,
];