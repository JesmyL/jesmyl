...
export const IconSpoonAndForkStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpoonAndFork StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSpoonAndForkDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpoonAndFork DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSpoonAndForkTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpoonAndFork TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSpoonAndForkSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpoonAndFork SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconSpoonAndForkBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpoonAndFork BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconSpoonAndForkStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpoonAndFork StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s ss sw"
...
export const IconSpoonAndForkSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpoonAndFork SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfSpoonAndFork: TheIconSelfPack = [
  'SpoonAndFork',
  IconSpoonAndForkStrokeRounded,
  IconSpoonAndForkDuotoneRounded,
  IconSpoonAndForkTwotoneRounded,
  IconSpoonAndForkSolidRounded,
  IconSpoonAndForkBulkRounded,
  IconSpoonAndForkStrokeSharp,
  IconSpoonAndForkSolidSharp,
];