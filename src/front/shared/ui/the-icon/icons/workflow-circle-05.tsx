...
export const IconWorkflowCircle05StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowCircle05 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWorkflowCircle05DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowCircle05 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconWorkflowCircle05TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowCircle05 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWorkflowCircle05SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowCircle05 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconWorkflowCircle05BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowCircle05 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconWorkflowCircle05StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowCircle05 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconWorkflowCircle05SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowCircle05 SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const iconPackOfWorkflowCircle05: TheIconSelfPack = [
  'WorkflowCircle05',
  IconWorkflowCircle05StrokeRounded,
  IconWorkflowCircle05DuotoneRounded,
  IconWorkflowCircle05TwotoneRounded,
  IconWorkflowCircle05SolidRounded,
  IconWorkflowCircle05BulkRounded,
  IconWorkflowCircle05StrokeSharp,
  IconWorkflowCircle05SolidSharp,
];