...
export const IconSoundcloudStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Soundcloud StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSoundcloudDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Soundcloud DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconSoundcloudTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Soundcloud TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconSoundcloudSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Soundcloud SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconSoundcloudBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Soundcloud BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconSoundcloudStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Soundcloud StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconSoundcloudSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Soundcloud SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfSoundcloud: TheIconSelfPack = [
  'Soundcloud',
  IconSoundcloudStrokeRounded,
  IconSoundcloudDuotoneRounded,
  IconSoundcloudTwotoneRounded,
  IconSoundcloudSolidRounded,
  IconSoundcloudBulkRounded,
  IconSoundcloudStrokeSharp,
  IconSoundcloudSolidSharp,
];