...
export const IconScooter04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Scooter04 StrokeRounded"
    >
      <circle 
        cx="4"
        cy="18"
...
export const IconScooter04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Scooter04 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconScooter04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Scooter04 TwotoneRounded"
    >
      <circle 
        cx="4"
        cy="18"
...
export const IconScooter04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Scooter04 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconScooter04BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Scooter04 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconScooter04StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Scooter04 StrokeSharp"
    >
      <circle 
        cx="4"
        cy="18"
...
export const iconPackOfScooter04: TheIconSelfPack = [
  'Scooter04',
  IconScooter04StrokeRounded,
  IconScooter04DuotoneRounded,
  IconScooter04TwotoneRounded,
  IconScooter04SolidRounded,
  IconScooter04BulkRounded,
  IconScooter04StrokeSharp,
  IconScooter04SolidSharp,
];