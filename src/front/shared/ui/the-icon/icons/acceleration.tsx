...
export const IconAccelerationStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Acceleration StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAccelerationDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Acceleration DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconAccelerationTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Acceleration TwotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="s sj sr sw"
...
export const IconAccelerationSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Acceleration SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconAccelerationBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Acceleration BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconAccelerationStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Acceleration StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sr sw"
...
export const IconAccelerationSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Acceleration SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const iconPackOfAcceleration: TheIconSelfPack = [
  'Acceleration',
  IconAccelerationStrokeRounded,
  IconAccelerationDuotoneRounded,
  IconAccelerationTwotoneRounded,
  IconAccelerationSolidRounded,
  IconAccelerationBulkRounded,
  IconAccelerationStrokeSharp,
  IconAccelerationSolidSharp,
];