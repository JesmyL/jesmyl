...
export const IconMirrorDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mirror DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconMirrorTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mirror TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfMirror: TheIconSelfPack = [
  'Mirror',
  IconMirrorStrokeRounded,
  IconMirrorDuotoneRounded,
  IconMirrorTwotoneRounded,
  IconMirrorSolidRounded,
  IconMirrorBulkRounded,
  IconMirrorStrokeSharp,
  IconMirrorSolidSharp,
];