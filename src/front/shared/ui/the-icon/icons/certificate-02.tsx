...
export const IconCertificate02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Certificate02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconCertificate02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Certificate02 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconCertificate02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Certificate02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sw"
...
export const IconCertificate02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Certificate02 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconCertificate02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Certificate02 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconCertificate02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Certificate02 StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sw"
...
export const IconCertificate02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Certificate02 SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="f"
...
export const iconPackOfCertificate02: TheIconSelfPack = [
  'Certificate02',
  IconCertificate02StrokeRounded,
  IconCertificate02DuotoneRounded,
  IconCertificate02TwotoneRounded,
  IconCertificate02SolidRounded,
  IconCertificate02BulkRounded,
  IconCertificate02StrokeSharp,
  IconCertificate02SolidSharp,
];