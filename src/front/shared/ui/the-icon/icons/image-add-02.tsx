...
export const IconImageAdd02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageAdd02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="f"
...
export const IconImageAdd02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageAdd02 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconImageAdd02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageAdd02 TwotoneRounded"
    >
      <path 
        d={d.d10}
        i-c="s sr sw"
...
export const IconImageAdd02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageAdd02 SolidRounded"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const IconImageAdd02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageAdd02 BulkRounded"
    >
      <path 
        d={d.d16}
        i-c="c f fr o7"
...
export const IconImageAdd02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageAdd02 StrokeSharp"
    >
      <path 
        d={d.d17}
        i-c="s sj sw"
...
export const IconImageAdd02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageAdd02 SolidSharp"
    >
      <path 
        d={d.d21}
        i-c="f"
...
export const iconPackOfImageAdd02: TheIconSelfPack = [
  'ImageAdd02',
  IconImageAdd02StrokeRounded,
  IconImageAdd02DuotoneRounded,
  IconImageAdd02TwotoneRounded,
  IconImageAdd02SolidRounded,
  IconImageAdd02BulkRounded,
  IconImageAdd02StrokeSharp,
  IconImageAdd02SolidSharp,
];