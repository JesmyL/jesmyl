...
export const IconPenConnectWifiStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PenConnectWifi StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPenConnectWifiDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PenConnectWifi DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconPenConnectWifiTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PenConnectWifi TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPenConnectWifiSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PenConnectWifi SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconPenConnectWifiBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PenConnectWifi BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d4}
...
export const IconPenConnectWifiStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PenConnectWifi StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sr sw"
...
export const IconPenConnectWifiSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PenConnectWifi SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfPenConnectWifi: TheIconSelfPack = [
  'PenConnectWifi',
  IconPenConnectWifiStrokeRounded,
  IconPenConnectWifiDuotoneRounded,
  IconPenConnectWifiTwotoneRounded,
  IconPenConnectWifiSolidRounded,
  IconPenConnectWifiBulkRounded,
  IconPenConnectWifiStrokeSharp,
  IconPenConnectWifiSolidSharp,
];