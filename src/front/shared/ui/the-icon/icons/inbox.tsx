...
export const iconPackOfInbox: TheIconSelfPack = [
  'Inbox',
  IconInboxStrokeRounded,
  IconInboxDuotoneRounded,
  IconInboxTwotoneRounded,
  IconInboxSolidRounded,
  IconInboxBulkRounded,
  IconInboxStrokeSharp,
  IconInboxSolidSharp,
];