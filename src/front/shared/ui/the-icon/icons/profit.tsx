...
export const IconProfitDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Profit DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconProfitTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Profit TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfProfit: TheIconSelfPack = [
  'Profit',
  IconProfitStrokeRounded,
  IconProfitDuotoneRounded,
  IconProfitTwotoneRounded,
  IconProfitSolidRounded,
  IconProfitBulkRounded,
  IconProfitStrokeSharp,
  IconProfitSolidSharp,
];