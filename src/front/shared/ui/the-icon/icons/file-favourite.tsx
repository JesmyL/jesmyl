...
export const IconFileFavouriteStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileFavourite StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFileFavouriteDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileFavourite DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconFileFavouriteTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileFavourite TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFileFavouriteSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileFavourite SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconFileFavouriteBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileFavourite BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconFileFavouriteStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileFavourite StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sr sw"
...
export const IconFileFavouriteSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileFavourite SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfFileFavourite: TheIconSelfPack = [
  'FileFavourite',
  IconFileFavouriteStrokeRounded,
  IconFileFavouriteDuotoneRounded,
  IconFileFavouriteTwotoneRounded,
  IconFileFavouriteSolidRounded,
  IconFileFavouriteBulkRounded,
  IconFileFavouriteStrokeSharp,
  IconFileFavouriteSolidSharp,
];