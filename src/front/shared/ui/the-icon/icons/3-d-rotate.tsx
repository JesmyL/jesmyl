...
export const Icon3DRotateStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="3DRotate StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const Icon3DRotateDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="3DRotate DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const Icon3DRotateTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="3DRotate TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const Icon3DRotateSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="3DRotate SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const iconPackOf3DRotate: TheIconSelfPack = [
  '3DRotate',
  Icon3DRotateStrokeRounded,
  Icon3DRotateDuotoneRounded,
  Icon3DRotateTwotoneRounded,
  Icon3DRotateSolidRounded,
  Icon3DRotateBulkRounded,
  Icon3DRotateStrokeSharp,
  Icon3DRotateSolidSharp,
];