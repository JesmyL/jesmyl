...
export const IconNotificationCircleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationCircle StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconNotificationCircleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationCircle DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconNotificationCircleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationCircle TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconNotificationCircleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationCircle SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconNotificationCircleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationCircle BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconNotificationCircleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationCircle StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconNotificationCircleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationCircle SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const iconPackOfNotificationCircle: TheIconSelfPack = [
  'NotificationCircle',
  IconNotificationCircleStrokeRounded,
  IconNotificationCircleDuotoneRounded,
  IconNotificationCircleTwotoneRounded,
  IconNotificationCircleSolidRounded,
  IconNotificationCircleBulkRounded,
  IconNotificationCircleStrokeSharp,
  IconNotificationCircleSolidSharp,
];