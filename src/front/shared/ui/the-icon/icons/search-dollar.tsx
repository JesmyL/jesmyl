...
export const IconSearchDollarStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SearchDollar StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSearchDollarDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SearchDollar DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconSearchDollarTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SearchDollar TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconSearchDollarSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SearchDollar SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconSearchDollarBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SearchDollar BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconSearchDollarStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SearchDollar StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconSearchDollarSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SearchDollar SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfSearchDollar: TheIconSelfPack = [
  'SearchDollar',
  IconSearchDollarStrokeRounded,
  IconSearchDollarDuotoneRounded,
  IconSearchDollarTwotoneRounded,
  IconSearchDollarSolidRounded,
  IconSearchDollarBulkRounded,
  IconSearchDollarStrokeSharp,
  IconSearchDollarSolidSharp,
];