...
export const IconBiometricAccessStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BiometricAccess StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconBiometricAccessDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BiometricAccess DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconBiometricAccessTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BiometricAccess TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconBiometricAccessSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BiometricAccess SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconBiometricAccessBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BiometricAccess BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconBiometricAccessStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BiometricAccess StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s ss sw"
...
export const IconBiometricAccessSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BiometricAccess SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfBiometricAccess: TheIconSelfPack = [
  'BiometricAccess',
  IconBiometricAccessStrokeRounded,
  IconBiometricAccessDuotoneRounded,
  IconBiometricAccessTwotoneRounded,
  IconBiometricAccessSolidRounded,
  IconBiometricAccessBulkRounded,
  IconBiometricAccessStrokeSharp,
  IconBiometricAccessSolidSharp,
];