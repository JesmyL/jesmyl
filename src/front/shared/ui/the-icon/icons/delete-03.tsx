...
export const IconDelete03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Delete03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDelete03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Delete03 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconDelete03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Delete03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDelete03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Delete03 SolidRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfDelete03: TheIconSelfPack = [
  'Delete03',
  IconDelete03StrokeRounded,
  IconDelete03DuotoneRounded,
  IconDelete03TwotoneRounded,
  IconDelete03SolidRounded,
  IconDelete03BulkRounded,
  IconDelete03StrokeSharp,
  IconDelete03SolidSharp,
];