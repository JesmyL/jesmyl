...
export const IconUserMinus01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserMinus01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserMinus01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserMinus01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconUserMinus01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserMinus01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserMinus01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserMinus01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconUserMinus01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserMinus01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconUserMinus01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserMinus01 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sw"
...
export const IconUserMinus01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserMinus01 SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfUserMinus01: TheIconSelfPack = [
  'UserMinus01',
  IconUserMinus01StrokeRounded,
  IconUserMinus01DuotoneRounded,
  IconUserMinus01TwotoneRounded,
  IconUserMinus01SolidRounded,
  IconUserMinus01BulkRounded,
  IconUserMinus01StrokeSharp,
  IconUserMinus01SolidSharp,
];