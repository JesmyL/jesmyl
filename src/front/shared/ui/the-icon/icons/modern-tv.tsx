...
export const IconModernTvStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ModernTv StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconModernTvDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ModernTv DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconModernTvTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ModernTv TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconModernTvSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ModernTv SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const iconPackOfModernTv: TheIconSelfPack = [
  'ModernTv',
  IconModernTvStrokeRounded,
  IconModernTvDuotoneRounded,
  IconModernTvTwotoneRounded,
  IconModernTvSolidRounded,
  IconModernTvBulkRounded,
  IconModernTvStrokeSharp,
  IconModernTvSolidSharp,
];