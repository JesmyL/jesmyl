...
export const IconPictureInPictureOnStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PictureInPictureOn StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPictureInPictureOnDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PictureInPictureOn DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconPictureInPictureOnTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PictureInPictureOn TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPictureInPictureOnSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PictureInPictureOn SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const IconPictureInPictureOnBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PictureInPictureOn BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const IconPictureInPictureOnStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PictureInPictureOn StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const IconPictureInPictureOnSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PictureInPictureOn SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfPictureInPictureOn: TheIconSelfPack = [
  'PictureInPictureOn',
  IconPictureInPictureOnStrokeRounded,
  IconPictureInPictureOnDuotoneRounded,
  IconPictureInPictureOnTwotoneRounded,
  IconPictureInPictureOnSolidRounded,
  IconPictureInPictureOnBulkRounded,
  IconPictureInPictureOnStrokeSharp,
  IconPictureInPictureOnSolidSharp,
];