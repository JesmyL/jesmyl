...
export const IconChairBarberStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChairBarber StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconChairBarberDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChairBarber DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconChairBarberTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChairBarber TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconChairBarberSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChairBarber SolidRounded"
    >
      <path 
        d={d.d15}
        i-c="f"
...
export const IconChairBarberBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChairBarber BulkRounded"
    >
      <path 
        d={d.d16}
        i-c="f o7"
...
export const IconChairBarberStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChairBarber StrokeSharp"
    >
      <path 
        d={d.d21}
        i-c="s sj sr sw"
...
export const IconChairBarberSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChairBarber SolidSharp"
    >
      <path 
        d={d.d26}
        i-c="c f fr"
...
export const iconPackOfChairBarber: TheIconSelfPack = [
  'ChairBarber',
  IconChairBarberStrokeRounded,
  IconChairBarberDuotoneRounded,
  IconChairBarberTwotoneRounded,
  IconChairBarberSolidRounded,
  IconChairBarberBulkRounded,
  IconChairBarberStrokeSharp,
  IconChairBarberSolidSharp,
];