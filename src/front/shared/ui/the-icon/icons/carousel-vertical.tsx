...
export const IconCarouselVerticalStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CarouselVertical StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCarouselVerticalDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CarouselVertical DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconCarouselVerticalTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CarouselVertical TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCarouselVerticalSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CarouselVertical SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconCarouselVerticalBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CarouselVertical BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconCarouselVerticalStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CarouselVertical StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sr sw"
...
export const IconCarouselVerticalSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CarouselVertical SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfCarouselVertical: TheIconSelfPack = [
  'CarouselVertical',
  IconCarouselVerticalStrokeRounded,
  IconCarouselVerticalDuotoneRounded,
  IconCarouselVerticalTwotoneRounded,
  IconCarouselVerticalSolidRounded,
  IconCarouselVerticalBulkRounded,
  IconCarouselVerticalStrokeSharp,
  IconCarouselVerticalSolidSharp,
];