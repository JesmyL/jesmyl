...
export const IconDistributionStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Distribution StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDistributionDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Distribution DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconDistributionTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Distribution TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDistributionSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Distribution SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconDistributionBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Distribution BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconDistributionStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Distribution StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sr sw"
...
export const IconDistributionSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Distribution SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfDistribution: TheIconSelfPack = [
  'Distribution',
  IconDistributionStrokeRounded,
  IconDistributionDuotoneRounded,
  IconDistributionTwotoneRounded,
  IconDistributionSolidRounded,
  IconDistributionBulkRounded,
  IconDistributionStrokeSharp,
  IconDistributionSolidSharp,
];