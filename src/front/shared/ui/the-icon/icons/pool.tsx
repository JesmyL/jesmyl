...
export const iconPackOfPool: TheIconSelfPack = [
  'Pool',
  IconPoolStrokeRounded,
  IconPoolDuotoneRounded,
  IconPoolTwotoneRounded,
  IconPoolSolidRounded,
  IconPoolBulkRounded,
  IconPoolStrokeSharp,
  IconPoolSolidSharp,
];