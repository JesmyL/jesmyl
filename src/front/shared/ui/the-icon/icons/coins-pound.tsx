...
export const IconCoinsPoundStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsPound StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconCoinsPoundDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsPound DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconCoinsPoundTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsPound TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconCoinsPoundSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsPound SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconCoinsPoundBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsPound BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconCoinsPoundStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsPound StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCoinsPoundSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsPound SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfCoinsPound: TheIconSelfPack = [
  'CoinsPound',
  IconCoinsPoundStrokeRounded,
  IconCoinsPoundDuotoneRounded,
  IconCoinsPoundTwotoneRounded,
  IconCoinsPoundSolidRounded,
  IconCoinsPoundBulkRounded,
  IconCoinsPoundStrokeSharp,
  IconCoinsPoundSolidSharp,
];