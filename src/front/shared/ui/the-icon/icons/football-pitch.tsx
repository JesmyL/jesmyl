...
export const IconFootballPitchStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FootballPitch StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconFootballPitchDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FootballPitch DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconFootballPitchTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FootballPitch TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconFootballPitchSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FootballPitch SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconFootballPitchBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FootballPitch BulkRounded"
    >
      <path 
        d={d.d13}
        i-c="f o7"
...
export const IconFootballPitchStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FootballPitch StrokeSharp"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconFootballPitchSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FootballPitch SolidSharp"
    >
      <path 
        d={d.d19}
        i-c="f"
...
export const iconPackOfFootballPitch: TheIconSelfPack = [
  'FootballPitch',
  IconFootballPitchStrokeRounded,
  IconFootballPitchDuotoneRounded,
  IconFootballPitchTwotoneRounded,
  IconFootballPitchSolidRounded,
  IconFootballPitchBulkRounded,
  IconFootballPitchStrokeSharp,
  IconFootballPitchSolidSharp,
];