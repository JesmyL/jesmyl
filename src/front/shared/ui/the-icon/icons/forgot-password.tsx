...
export const IconForgotPasswordStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ForgotPassword StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconForgotPasswordDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ForgotPassword DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconForgotPasswordTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ForgotPassword TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconForgotPasswordSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ForgotPassword SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconForgotPasswordBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ForgotPassword BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconForgotPasswordStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ForgotPassword StrokeSharp"
    >
      <path 
        d={d.d2}
        i-c="s ss sw"
...
export const IconForgotPasswordSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ForgotPassword SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfForgotPassword: TheIconSelfPack = [
  'ForgotPassword',
  IconForgotPasswordStrokeRounded,
  IconForgotPasswordDuotoneRounded,
  IconForgotPasswordTwotoneRounded,
  IconForgotPasswordSolidRounded,
  IconForgotPasswordBulkRounded,
  IconForgotPasswordStrokeSharp,
  IconForgotPasswordSolidSharp,
];