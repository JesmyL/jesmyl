...
export const IconSpaghettiStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Spaghetti StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSpaghettiDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Spaghetti DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconSpaghettiTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Spaghetti TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSpaghettiSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Spaghetti SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconSpaghettiBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Spaghetti BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconSpaghettiStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Spaghetti StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sj sw"
...
export const iconPackOfSpaghetti: TheIconSelfPack = [
  'Spaghetti',
  IconSpaghettiStrokeRounded,
  IconSpaghettiDuotoneRounded,
  IconSpaghettiTwotoneRounded,
  IconSpaghettiSolidRounded,
  IconSpaghettiBulkRounded,
  IconSpaghettiStrokeSharp,
  IconSpaghettiSolidSharp,
];