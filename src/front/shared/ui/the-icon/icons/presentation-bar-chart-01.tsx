...
export const IconPresentationBarChart01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PresentationBarChart01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPresentationBarChart01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PresentationBarChart01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconPresentationBarChart01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PresentationBarChart01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPresentationBarChart01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PresentationBarChart01 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconPresentationBarChart01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PresentationBarChart01 BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr o7"
...
export const IconPresentationBarChart01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PresentationBarChart01 StrokeSharp"
    >
      <path 
        d={d.d14}
        i-c="s sj sw"
...
export const IconPresentationBarChart01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PresentationBarChart01 SolidSharp"
    >
      <path 
        d={d.d18}
        i-c="f"
...
export const iconPackOfPresentationBarChart01: TheIconSelfPack = [
  ...
  IconPresentationBarChart01StrokeRounded,
  IconPresentationBarChart01DuotoneRounded,
  IconPresentationBarChart01TwotoneRounded,
  IconPresentationBarChart01SolidRounded,
  IconPresentationBarChart01BulkRounded,
  IconPresentationBarChart01StrokeSharp,
  IconPresentationBarChart01SolidSharp,
];