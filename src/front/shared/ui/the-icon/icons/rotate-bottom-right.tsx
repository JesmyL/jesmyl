...
export const IconRotateBottomRightStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RotateBottomRight StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRotateBottomRightDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RotateBottomRight DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconRotateBottomRightTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RotateBottomRight TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRotateBottomRightSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RotateBottomRight SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconRotateBottomRightBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RotateBottomRight BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconRotateBottomRightStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RotateBottomRight StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sr sw"
...
export const IconRotateBottomRightSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RotateBottomRight SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const iconPackOfRotateBottomRight: TheIconSelfPack = [
  'RotateBottomRight',
  IconRotateBottomRightStrokeRounded,
  IconRotateBottomRightDuotoneRounded,
  IconRotateBottomRightTwotoneRounded,
  IconRotateBottomRightSolidRounded,
  IconRotateBottomRightBulkRounded,
  IconRotateBottomRightStrokeSharp,
  IconRotateBottomRightSolidSharp,
];