...
export const IconTrolley02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Trolley02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconTrolley02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Trolley02 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconTrolley02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Trolley02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconTrolley02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Trolley02 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconTrolley02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Trolley02 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconTrolley02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Trolley02 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const iconPackOfTrolley02: TheIconSelfPack = [
  'Trolley02',
  IconTrolley02StrokeRounded,
  IconTrolley02DuotoneRounded,
  IconTrolley02TwotoneRounded,
  IconTrolley02SolidRounded,
  IconTrolley02BulkRounded,
  IconTrolley02StrokeSharp,
  IconTrolley02SolidSharp,
];