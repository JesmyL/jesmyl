...
export const IconAiViewDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiView DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAiViewTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiView TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfAiView: TheIconSelfPack = [
  'AiView',
  IconAiViewStrokeRounded,
  IconAiViewDuotoneRounded,
  IconAiViewTwotoneRounded,
  IconAiViewSolidRounded,
  IconAiViewBulkRounded,
  IconAiViewStrokeSharp,
  IconAiViewSolidSharp,
];