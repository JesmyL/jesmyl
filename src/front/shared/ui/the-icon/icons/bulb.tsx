...
export const iconPackOfBulb: TheIconSelfPack = [
  'Bulb',
  IconBulbStrokeRounded,
  IconBulbDuotoneRounded,
  IconBulbTwotoneRounded,
  IconBulbSolidRounded,
  IconBulbBulkRounded,
  IconBulbStrokeSharp,
  IconBulbSolidSharp,
];