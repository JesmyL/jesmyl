...
export const IconInfinity02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Infinity02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconInfinity02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Infinity02 DuotoneRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d3}
...
export const IconInfinity02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Infinity02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconInfinity02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Infinity02 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconInfinity02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Infinity02 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconInfinity02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Infinity02 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconInfinity02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Infinity02 SolidSharp"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const iconPackOfInfinity02: TheIconSelfPack = [
  'Infinity02',
  IconInfinity02StrokeRounded,
  IconInfinity02DuotoneRounded,
  IconInfinity02TwotoneRounded,
  IconInfinity02SolidRounded,
  IconInfinity02BulkRounded,
  IconInfinity02StrokeSharp,
  IconInfinity02SolidSharp,
];