...
export const iconPackOfRadio: TheIconSelfPack = [
  'Radio',
  IconRadioStrokeRounded,
  IconRadioDuotoneRounded,
  IconRadioTwotoneRounded,
  IconRadioSolidRounded,
  IconRadioBulkRounded,
  IconRadioStrokeSharp,
  IconRadioSolidSharp,
];