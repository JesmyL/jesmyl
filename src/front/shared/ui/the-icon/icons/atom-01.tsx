...
export const IconAtom01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Atom01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr o7"
...
export const IconAtom01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Atom01 TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const iconPackOfAtom01: TheIconSelfPack = [
  'Atom01',
  IconAtom01StrokeRounded,
  IconAtom01DuotoneRounded,
  IconAtom01TwotoneRounded,
  IconAtom01SolidRounded,
  IconAtom01BulkRounded,
  IconAtom01StrokeSharp,
  IconAtom01SolidSharp,
];