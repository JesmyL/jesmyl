...
export const IconJoystick01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconJoystick01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconJoystick01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconJoystick01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick01 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconJoystick01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick01 BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr o7"
...
export const IconJoystick01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick01 StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sw"
...
export const IconJoystick01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick01 SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="f"
...
export const iconPackOfJoystick01: TheIconSelfPack = [
  'Joystick01',
  IconJoystick01StrokeRounded,
  IconJoystick01DuotoneRounded,
  IconJoystick01TwotoneRounded,
  IconJoystick01SolidRounded,
  IconJoystick01BulkRounded,
  IconJoystick01StrokeSharp,
  IconJoystick01SolidSharp,
];