...
export const IconClock02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Clock02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconClock02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Clock02 DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconClock02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Clock02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfClock02: TheIconSelfPack = [
  'Clock02',
  IconClock02StrokeRounded,
  IconClock02DuotoneRounded,
  IconClock02TwotoneRounded,
  IconClock02SolidRounded,
  IconClock02BulkRounded,
  IconClock02StrokeSharp,
  IconClock02SolidSharp,
];