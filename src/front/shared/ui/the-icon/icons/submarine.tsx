...
export const IconSubmarineStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Submarine StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSubmarineDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Submarine DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconSubmarineTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Submarine TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSubmarineSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Submarine SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconSubmarineBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Submarine BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconSubmarineStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Submarine StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const iconPackOfSubmarine: TheIconSelfPack = [
  'Submarine',
  IconSubmarineStrokeRounded,
  IconSubmarineDuotoneRounded,
  IconSubmarineTwotoneRounded,
  IconSubmarineSolidRounded,
  IconSubmarineBulkRounded,
  IconSubmarineStrokeSharp,
  IconSubmarineSolidSharp,
];