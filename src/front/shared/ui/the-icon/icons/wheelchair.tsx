...
export const IconWheelchairStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wheelchair StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWheelchairDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wheelchair DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconWheelchairTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wheelchair TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWheelchairSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wheelchair SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconWheelchairBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wheelchair BulkRounded"
    >
      <path 
        d={d.d12}
        i-c="f o7"
...
export const IconWheelchairStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wheelchair StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWheelchairSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wheelchair SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfWheelchair: TheIconSelfPack = [
  'Wheelchair',
  IconWheelchairStrokeRounded,
  IconWheelchairDuotoneRounded,
  IconWheelchairTwotoneRounded,
  IconWheelchairSolidRounded,
  IconWheelchairBulkRounded,
  IconWheelchairStrokeSharp,
  IconWheelchairSolidSharp,
];