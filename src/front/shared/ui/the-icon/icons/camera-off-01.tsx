...
export const IconCameraOff01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraOff01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconCameraOff01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraOff01 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconCameraOff01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraOff01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconCameraOff01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraOff01 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconCameraOff01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraOff01 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconCameraOff01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraOff01 StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj ss sw"
...
export const IconCameraOff01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraOff01 SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="f"
...
export const iconPackOfCameraOff01: TheIconSelfPack = [
  'CameraOff01',
  IconCameraOff01StrokeRounded,
  IconCameraOff01DuotoneRounded,
  IconCameraOff01TwotoneRounded,
  IconCameraOff01SolidRounded,
  IconCameraOff01BulkRounded,
  IconCameraOff01StrokeSharp,
  IconCameraOff01SolidSharp,
];