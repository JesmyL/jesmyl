...
export const IconLink01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Link01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconLink01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Link01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfLink01: TheIconSelfPack = [
  'Link01',
  IconLink01StrokeRounded,
  IconLink01DuotoneRounded,
  IconLink01TwotoneRounded,
  IconLink01SolidRounded,
  IconLink01BulkRounded,
  IconLink01StrokeSharp,
  IconLink01SolidSharp,
];