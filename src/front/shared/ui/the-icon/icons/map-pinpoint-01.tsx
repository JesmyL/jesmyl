...
export const IconMapPinpoint01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapPinpoint01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconMapPinpoint01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapPinpoint01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconMapPinpoint01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapPinpoint01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconMapPinpoint01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapPinpoint01 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconMapPinpoint01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapPinpoint01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconMapPinpoint01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapPinpoint01 StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sw"
...
export const IconMapPinpoint01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapPinpoint01 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfMapPinpoint01: TheIconSelfPack = [
  'MapPinpoint01',
  IconMapPinpoint01StrokeRounded,
  IconMapPinpoint01DuotoneRounded,
  IconMapPinpoint01TwotoneRounded,
  IconMapPinpoint01SolidRounded,
  IconMapPinpoint01BulkRounded,
  IconMapPinpoint01StrokeSharp,
  IconMapPinpoint01SolidSharp,
];