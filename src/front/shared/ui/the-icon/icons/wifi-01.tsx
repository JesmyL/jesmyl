...
export const IconWifi01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wifi01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconWifi01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wifi01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfWifi01: TheIconSelfPack = [
  'Wifi01',
  IconWifi01StrokeRounded,
  IconWifi01DuotoneRounded,
  IconWifi01TwotoneRounded,
  IconWifi01SolidRounded,
  IconWifi01BulkRounded,
  IconWifi01StrokeSharp,
  IconWifi01SolidSharp,
];