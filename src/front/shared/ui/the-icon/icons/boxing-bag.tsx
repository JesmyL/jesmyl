...
export const IconBoxingBagStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BoxingBag StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBoxingBagDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BoxingBag DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="s sj sr sw"
...
export const IconBoxingBagTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BoxingBag TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconBoxingBagSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BoxingBag SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconBoxingBagBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BoxingBag BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconBoxingBagStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BoxingBag StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfBoxingBag: TheIconSelfPack = [
  'BoxingBag',
  IconBoxingBagStrokeRounded,
  IconBoxingBagDuotoneRounded,
  IconBoxingBagTwotoneRounded,
  IconBoxingBagSolidRounded,
  IconBoxingBagBulkRounded,
  IconBoxingBagStrokeSharp,
  IconBoxingBagSolidSharp,
];