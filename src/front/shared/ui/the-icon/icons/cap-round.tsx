...
export const IconCapRoundStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CapRound StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCapRoundDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CapRound DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconCapRoundTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CapRound TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCapRoundSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CapRound SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const iconPackOfCapRound: TheIconSelfPack = [
  'CapRound',
  IconCapRoundStrokeRounded,
  IconCapRoundDuotoneRounded,
  IconCapRoundTwotoneRounded,
  IconCapRoundSolidRounded,
  IconCapRoundBulkRounded,
  IconCapRoundStrokeSharp,
  IconCapRoundSolidSharp,
];