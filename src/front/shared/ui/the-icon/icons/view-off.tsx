...
export const IconViewOffStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ViewOff StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconViewOffDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ViewOff DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconViewOffTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ViewOff TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfViewOff: TheIconSelfPack = [
  'ViewOff',
  IconViewOffStrokeRounded,
  IconViewOffDuotoneRounded,
  IconViewOffTwotoneRounded,
  IconViewOffSolidRounded,
  IconViewOffBulkRounded,
  IconViewOffStrokeSharp,
  IconViewOffSolidSharp,
];