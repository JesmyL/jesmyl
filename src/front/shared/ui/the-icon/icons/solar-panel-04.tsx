...
export const IconSolarPanel04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SolarPanel04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSolarPanel04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SolarPanel04 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconSolarPanel04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SolarPanel04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSolarPanel04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SolarPanel04 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconSolarPanel04BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SolarPanel04 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconSolarPanel04StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SolarPanel04 StrokeSharp"
    >
      <path 
        d={d.d15}
        i-c="s sj ss sw"
...
export const IconSolarPanel04SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SolarPanel04 SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const iconPackOfSolarPanel04: TheIconSelfPack = [
  'SolarPanel04',
  IconSolarPanel04StrokeRounded,
  IconSolarPanel04DuotoneRounded,
  IconSolarPanel04TwotoneRounded,
  IconSolarPanel04SolidRounded,
  IconSolarPanel04BulkRounded,
  IconSolarPanel04StrokeSharp,
  IconSolarPanel04SolidSharp,
];