...
export const IconMusicNoteSquare01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNoteSquare01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMusicNoteSquare01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNoteSquare01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr o7"
...
export const IconMusicNoteSquare01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNoteSquare01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMusicNoteSquare01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNoteSquare01 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconMusicNoteSquare01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNoteSquare01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconMusicNoteSquare01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNoteSquare01 StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconMusicNoteSquare01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNoteSquare01 SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfMusicNoteSquare01: TheIconSelfPack = [
  'MusicNoteSquare01',
  IconMusicNoteSquare01StrokeRounded,
  IconMusicNoteSquare01DuotoneRounded,
  IconMusicNoteSquare01TwotoneRounded,
  IconMusicNoteSquare01SolidRounded,
  IconMusicNoteSquare01BulkRounded,
  IconMusicNoteSquare01StrokeSharp,
  IconMusicNoteSquare01SolidSharp,
];