...
export const IconCabinet03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cabinet03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCabinet03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cabinet03 DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconCabinet03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cabinet03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCabinet03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cabinet03 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconCabinet03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cabinet03 BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d11}
...
export const IconCabinet03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cabinet03 StrokeSharp"
    >
      <path 
        d={d.d16}
        i-c="s sj sw"
...
export const iconPackOfCabinet03: TheIconSelfPack = [
  'Cabinet03',
  IconCabinet03StrokeRounded,
  IconCabinet03DuotoneRounded,
  IconCabinet03TwotoneRounded,
  IconCabinet03SolidRounded,
  IconCabinet03BulkRounded,
  IconCabinet03StrokeSharp,
  IconCabinet03SolidSharp,
];