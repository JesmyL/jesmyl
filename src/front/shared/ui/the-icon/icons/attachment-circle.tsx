...
export const IconAttachmentCircleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AttachmentCircle StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAttachmentCircleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AttachmentCircle DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconAttachmentCircleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AttachmentCircle TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconAttachmentCircleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AttachmentCircle SolidRounded"
    >
      <path 
        d={d.d2}
        i-c="c f fr"
...
export const IconAttachmentCircleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AttachmentCircle BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconAttachmentCircleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AttachmentCircle StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconAttachmentCircleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AttachmentCircle SolidSharp"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const iconPackOfAttachmentCircle: TheIconSelfPack = [
  'AttachmentCircle',
  IconAttachmentCircleStrokeRounded,
  IconAttachmentCircleDuotoneRounded,
  IconAttachmentCircleTwotoneRounded,
  IconAttachmentCircleSolidRounded,
  IconAttachmentCircleBulkRounded,
  IconAttachmentCircleStrokeSharp,
  IconAttachmentCircleSolidSharp,
];