...
export const IconCircleArrowLeftRightStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CircleArrowLeftRight StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconCircleArrowLeftRightDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CircleArrowLeftRight DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconCircleArrowLeftRightTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CircleArrowLeftRight TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconCircleArrowLeftRightSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CircleArrowLeftRight SolidRounded"
    >
      <path 
        d={d.d2}
        i-c="c f fr"
...
export const IconCircleArrowLeftRightBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CircleArrowLeftRight BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconCircleArrowLeftRightStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CircleArrowLeftRight StrokeSharp"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconCircleArrowLeftRightSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CircleArrowLeftRight SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfCircleArrowLeftRight: TheIconSelfPack = [
  ...
  IconCircleArrowLeftRightStrokeRounded,
  IconCircleArrowLeftRightDuotoneRounded,
  IconCircleArrowLeftRightTwotoneRounded,
  IconCircleArrowLeftRightSolidRounded,
  IconCircleArrowLeftRightBulkRounded,
  IconCircleArrowLeftRightStrokeSharp,
  IconCircleArrowLeftRightSolidSharp,
];