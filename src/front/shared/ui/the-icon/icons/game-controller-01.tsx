...
export const IconGameController01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GameController01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGameController01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GameController01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconGameController01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GameController01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconGameController01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GameController01 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconGameController01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GameController01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconGameController01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GameController01 StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const IconGameController01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GameController01 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfGameController01: TheIconSelfPack = [
  'GameController01',
  IconGameController01StrokeRounded,
  IconGameController01DuotoneRounded,
  IconGameController01TwotoneRounded,
  IconGameController01SolidRounded,
  IconGameController01BulkRounded,
  IconGameController01StrokeSharp,
  IconGameController01SolidSharp,
];