...
export const IconLayerAddStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayerAdd StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLayerAddDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayerAdd DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o1"
...
export const IconLayerAddTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayerAdd TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLayerAddSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayerAdd SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconLayerAddStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayerAdd StrokeSharp"
    >
      <rect 
        x="9"
        y="9"
        i-c="h3 s sj sr sw w4"
      />
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const iconPackOfLayerAdd: TheIconSelfPack = [
  'LayerAdd',
  IconLayerAddStrokeRounded,
  IconLayerAddDuotoneRounded,
  IconLayerAddTwotoneRounded,
  IconLayerAddSolidRounded,
  IconLayerAddBulkRounded,
  IconLayerAddStrokeSharp,
  IconLayerAddSolidSharp,
];