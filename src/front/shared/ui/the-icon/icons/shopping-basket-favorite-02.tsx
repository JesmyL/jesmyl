...
export const IconShoppingBasketFavorite02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketFavorite02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShoppingBasketFavorite02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketFavorite02 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconShoppingBasketFavorite02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketFavorite02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShoppingBasketFavorite02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketFavorite02 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconShoppingBasketFavorite02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketFavorite02 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconShoppingBasketFavorite02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketFavorite02 StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sw"
...
export const IconShoppingBasketFavorite02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketFavorite02 SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="f"
...
export const iconPackOfShoppingBasketFavorite02: TheIconSelfPack = [
  ...
  IconShoppingBasketFavorite02StrokeRounded,
  IconShoppingBasketFavorite02DuotoneRounded,
  IconShoppingBasketFavorite02TwotoneRounded,
  IconShoppingBasketFavorite02SolidRounded,
  IconShoppingBasketFavorite02BulkRounded,
  IconShoppingBasketFavorite02StrokeSharp,
  IconShoppingBasketFavorite02SolidSharp,
];