...
export const IconMoneyReceiveFlow01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneyReceiveFlow01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconMoneyReceiveFlow01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneyReceiveFlow01 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconMoneyReceiveFlow01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneyReceiveFlow01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconMoneyReceiveFlow01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneyReceiveFlow01 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconMoneyReceiveFlow01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneyReceiveFlow01 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconMoneyReceiveFlow01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneyReceiveFlow01 StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sj sw"
...
export const IconMoneyReceiveFlow01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneyReceiveFlow01 SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfMoneyReceiveFlow01: TheIconSelfPack = [
  'MoneyReceiveFlow01',
  IconMoneyReceiveFlow01StrokeRounded,
  IconMoneyReceiveFlow01DuotoneRounded,
  IconMoneyReceiveFlow01TwotoneRounded,
  IconMoneyReceiveFlow01SolidRounded,
  IconMoneyReceiveFlow01BulkRounded,
  IconMoneyReceiveFlow01StrokeSharp,
  IconMoneyReceiveFlow01SolidSharp,
];