...
export const IconGoogleHomeStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoogleHome StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGoogleHomeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoogleHome DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconGoogleHomeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoogleHome TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGoogleHomeSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoogleHome SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconGoogleHomeBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoogleHome BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconGoogleHomeStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoogleHome StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconGoogleHomeSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoogleHome SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfGoogleHome: TheIconSelfPack = [
  'GoogleHome',
  IconGoogleHomeStrokeRounded,
  IconGoogleHomeDuotoneRounded,
  IconGoogleHomeTwotoneRounded,
  IconGoogleHomeSolidRounded,
  IconGoogleHomeBulkRounded,
  IconGoogleHomeStrokeSharp,
  IconGoogleHomeSolidSharp,
];