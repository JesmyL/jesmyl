...
export const iconPackOfIdea: TheIconSelfPack = [
  'Idea',
  IconIdeaStrokeRounded,
  IconIdeaDuotoneRounded,
  IconIdeaTwotoneRounded,
  IconIdeaSolidRounded,
  IconIdeaBulkRounded,
  IconIdeaStrokeSharp,
  IconIdeaSolidSharp,
];