...
export const IconSwipeRight03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeRight03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSwipeRight03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeRight03 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconSwipeRight03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeRight03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSwipeRight03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeRight03 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconSwipeRight03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeRight03 BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconSwipeRight03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeRight03 StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sw"
...
export const IconSwipeRight03SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeRight03 SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const iconPackOfSwipeRight03: TheIconSelfPack = [
  'SwipeRight03',
  IconSwipeRight03StrokeRounded,
  IconSwipeRight03DuotoneRounded,
  IconSwipeRight03TwotoneRounded,
  IconSwipeRight03SolidRounded,
  IconSwipeRight03BulkRounded,
  IconSwipeRight03StrokeSharp,
  IconSwipeRight03SolidSharp,
];