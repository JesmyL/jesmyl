...
export const IconDiscoverSquareStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiscoverSquare StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDiscoverSquareDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiscoverSquare DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconDiscoverSquareTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiscoverSquare TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconDiscoverSquareSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiscoverSquare SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconDiscoverSquareBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiscoverSquare BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconDiscoverSquareStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiscoverSquare StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sr sw"
...
export const IconDiscoverSquareSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiscoverSquare SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfDiscoverSquare: TheIconSelfPack = [
  'DiscoverSquare',
  IconDiscoverSquareStrokeRounded,
  IconDiscoverSquareDuotoneRounded,
  IconDiscoverSquareTwotoneRounded,
  IconDiscoverSquareSolidRounded,
  IconDiscoverSquareBulkRounded,
  IconDiscoverSquareStrokeSharp,
  IconDiscoverSquareSolidSharp,
];