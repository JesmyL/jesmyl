...
export const IconReturnRequestStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ReturnRequest StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconReturnRequestDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ReturnRequest DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconReturnRequestTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ReturnRequest TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconReturnRequestSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ReturnRequest SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconReturnRequestBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ReturnRequest BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconReturnRequestStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ReturnRequest StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sr sw"
...
export const IconReturnRequestSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ReturnRequest SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfReturnRequest: TheIconSelfPack = [
  'ReturnRequest',
  IconReturnRequestStrokeRounded,
  IconReturnRequestDuotoneRounded,
  IconReturnRequestTwotoneRounded,
  IconReturnRequestSolidRounded,
  IconReturnRequestBulkRounded,
  IconReturnRequestStrokeSharp,
  IconReturnRequestSolidSharp,
];