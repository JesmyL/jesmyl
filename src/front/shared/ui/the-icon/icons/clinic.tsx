...
export const IconClinicDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Clinic DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconClinicTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Clinic TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfClinic: TheIconSelfPack = [
  'Clinic',
  IconClinicStrokeRounded,
  IconClinicDuotoneRounded,
  IconClinicTwotoneRounded,
  IconClinicSolidRounded,
  IconClinicBulkRounded,
  IconClinicStrokeSharp,
  IconClinicSolidSharp,
];