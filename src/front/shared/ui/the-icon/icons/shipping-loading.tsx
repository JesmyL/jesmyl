...
export const IconShippingLoadingStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShippingLoading StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconShippingLoadingDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShippingLoading DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconShippingLoadingTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShippingLoading TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconShippingLoadingSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShippingLoading SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconShippingLoadingBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShippingLoading BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconShippingLoadingStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShippingLoading StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sj sr sw"
...
export const IconShippingLoadingSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShippingLoading SolidSharp"
    >
      <path 
        d={d.d18}
        i-c="c f fr"
...
export const iconPackOfShippingLoading: TheIconSelfPack = [
  'ShippingLoading',
  IconShippingLoadingStrokeRounded,
  IconShippingLoadingDuotoneRounded,
  IconShippingLoadingTwotoneRounded,
  IconShippingLoadingSolidRounded,
  IconShippingLoadingBulkRounded,
  IconShippingLoadingStrokeSharp,
  IconShippingLoadingSolidSharp,
];