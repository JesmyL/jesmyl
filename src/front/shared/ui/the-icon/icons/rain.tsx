...
export const iconPackOfRain: TheIconSelfPack = [
  'Rain',
  IconRainStrokeRounded,
  IconRainDuotoneRounded,
  IconRainTwotoneRounded,
  IconRainSolidRounded,
  IconRainBulkRounded,
  IconRainStrokeSharp,
  IconRainSolidSharp,
];