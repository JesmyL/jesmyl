...
export const IconBitcoinDatabaseStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinDatabase StrokeRounded"
    >
      <ellipse 
        cx="12"
        cy="5"
...
export const IconBitcoinDatabaseDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinDatabase DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconBitcoinDatabaseTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinDatabase TwotoneRounded"
    >
      <ellipse 
        cx="12"
        cy="5"
...
export const IconBitcoinDatabaseSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinDatabase SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconBitcoinDatabaseBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinDatabase BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconBitcoinDatabaseStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinDatabase StrokeSharp"
    >
      <ellipse 
        cx="12"
        cy="5"
...
export const IconBitcoinDatabaseSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinDatabase SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfBitcoinDatabase: TheIconSelfPack = [
  'BitcoinDatabase',
  IconBitcoinDatabaseStrokeRounded,
  IconBitcoinDatabaseDuotoneRounded,
  IconBitcoinDatabaseTwotoneRounded,
  IconBitcoinDatabaseSolidRounded,
  IconBitcoinDatabaseBulkRounded,
  IconBitcoinDatabaseStrokeSharp,
  IconBitcoinDatabaseSolidSharp,
];