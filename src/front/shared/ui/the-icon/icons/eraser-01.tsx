...
export const IconEraser01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Eraser01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconEraser01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Eraser01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconEraser01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Eraser01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconEraser01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Eraser01 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const iconPackOfEraser01: TheIconSelfPack = [
  ...
  IconEraser01DuotoneRounded,
  IconEraser01TwotoneRounded,
  IconEraser01SolidRounded,
  IconEraser01BulkRounded,
  IconEraser01StrokeSharp,
  IconEraser01SolidSharp,
];