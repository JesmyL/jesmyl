...
export const IconTree06DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Tree06 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconTree06TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Tree06 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfTree06: TheIconSelfPack = [
  'Tree06',
  IconTree06StrokeRounded,
  IconTree06DuotoneRounded,
  IconTree06TwotoneRounded,
  IconTree06SolidRounded,
  IconTree06BulkRounded,
  IconTree06StrokeSharp,
  IconTree06SolidSharp,
];