...
export const iconPackOfLamp: TheIconSelfPack = [
  'Lamp',
  IconLampStrokeRounded,
  IconLampDuotoneRounded,
  IconLampTwotoneRounded,
  IconLampSolidRounded,
  IconLampBulkRounded,
  IconLampStrokeSharp,
  IconLampSolidSharp,
];