...
export const IconPresentation05StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation05 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPresentation05DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation05 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconPresentation05TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation05 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPresentation05SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation05 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconPresentation05BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation05 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconPresentation05StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation05 StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const IconPresentation05SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation05 SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="f"
...
export const iconPackOfPresentation05: TheIconSelfPack = [
  'Presentation05',
  IconPresentation05StrokeRounded,
  IconPresentation05DuotoneRounded,
  IconPresentation05TwotoneRounded,
  IconPresentation05SolidRounded,
  IconPresentation05BulkRounded,
  IconPresentation05StrokeSharp,
  IconPresentation05SolidSharp,
];