...
export const IconGoogleDriveStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoogleDrive StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGoogleDriveDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoogleDrive DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconGoogleDriveTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoogleDrive TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGoogleDriveSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoogleDrive SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconGoogleDriveBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoogleDrive BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconGoogleDriveStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoogleDrive StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sr sw"
...
export const IconGoogleDriveSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoogleDrive SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="f"
...
export const iconPackOfGoogleDrive: TheIconSelfPack = [
  'GoogleDrive',
  IconGoogleDriveStrokeRounded,
  IconGoogleDriveDuotoneRounded,
  IconGoogleDriveTwotoneRounded,
  IconGoogleDriveSolidRounded,
  IconGoogleDriveBulkRounded,
  IconGoogleDriveStrokeSharp,
  IconGoogleDriveSolidSharp,
];