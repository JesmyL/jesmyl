...
export const IconMachineRobotStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MachineRobot StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconMachineRobotDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MachineRobot DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconMachineRobotTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MachineRobot TwotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconMachineRobotSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MachineRobot SolidRounded"
    >
      <path 
        d={d.d12}
        i-c="f"
...
export const IconMachineRobotBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MachineRobot BulkRounded"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const IconMachineRobotStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MachineRobot StrokeSharp"
    >
      <path 
        d={d.d20}
        i-c="s sj sw"
...
export const IconMachineRobotSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MachineRobot SolidSharp"
    >
      <path 
        d={d.d22}
        i-c="c f fr"
...
export const iconPackOfMachineRobot: TheIconSelfPack = [
  'MachineRobot',
  IconMachineRobotStrokeRounded,
  IconMachineRobotDuotoneRounded,
  IconMachineRobotTwotoneRounded,
  IconMachineRobotSolidRounded,
  IconMachineRobotBulkRounded,
  IconMachineRobotStrokeSharp,
  IconMachineRobotSolidSharp,
];