...
export const IconFactory01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Factory01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFactory01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Factory01 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconFactory01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Factory01 TwotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="s sj sr sw"
...
export const IconFactory01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Factory01 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconFactory01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Factory01 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconFactory01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Factory01 StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const iconPackOfFactory01: TheIconSelfPack = [
  'Factory01',
  IconFactory01StrokeRounded,
  IconFactory01DuotoneRounded,
  IconFactory01TwotoneRounded,
  IconFactory01SolidRounded,
  IconFactory01BulkRounded,
  IconFactory01StrokeSharp,
  IconFactory01SolidSharp,
];