...
export const IconFlipPhoneStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlipPhone StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconFlipPhoneDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlipPhone DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconFlipPhoneTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlipPhone TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconFlipPhoneSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlipPhone SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconFlipPhoneBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlipPhone BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconFlipPhoneStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlipPhone StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const iconPackOfFlipPhone: TheIconSelfPack = [
  'FlipPhone',
  IconFlipPhoneStrokeRounded,
  IconFlipPhoneDuotoneRounded,
  IconFlipPhoneTwotoneRounded,
  IconFlipPhoneSolidRounded,
  IconFlipPhoneBulkRounded,
  IconFlipPhoneStrokeSharp,
  IconFlipPhoneSolidSharp,
];