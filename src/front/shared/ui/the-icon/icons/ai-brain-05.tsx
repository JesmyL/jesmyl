...
export const IconAiBrain05StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiBrain05 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAiBrain05DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiBrain05 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconAiBrain05TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiBrain05 TwotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="s sj sr sw"
...
export const IconAiBrain05SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiBrain05 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconAiBrain05BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiBrain05 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconAiBrain05StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiBrain05 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfAiBrain05: TheIconSelfPack = [
  'AiBrain05',
  IconAiBrain05StrokeRounded,
  IconAiBrain05DuotoneRounded,
  IconAiBrain05TwotoneRounded,
  IconAiBrain05SolidRounded,
  IconAiBrain05BulkRounded,
  IconAiBrain05StrokeSharp,
  IconAiBrain05SolidSharp,
];