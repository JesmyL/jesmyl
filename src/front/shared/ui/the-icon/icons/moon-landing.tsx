...
export const IconMoonLandingStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoonLanding StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconMoonLandingDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoonLanding DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconMoonLandingTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoonLanding TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconMoonLandingSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoonLanding SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconMoonLandingBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoonLanding BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconMoonLandingStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoonLanding StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sw"
...
export const IconMoonLandingSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoonLanding SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfMoonLanding: TheIconSelfPack = [
  'MoonLanding',
  IconMoonLandingStrokeRounded,
  IconMoonLandingDuotoneRounded,
  IconMoonLandingTwotoneRounded,
  IconMoonLandingSolidRounded,
  IconMoonLandingBulkRounded,
  IconMoonLandingStrokeSharp,
  IconMoonLandingSolidSharp,
];