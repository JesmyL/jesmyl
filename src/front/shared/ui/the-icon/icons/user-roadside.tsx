...
export const IconUserRoadsideStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserRoadside StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconUserRoadsideDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserRoadside DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconUserRoadsideTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserRoadside TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconUserRoadsideSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserRoadside SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconUserRoadsideBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserRoadside BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconUserRoadsideStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserRoadside StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconUserRoadsideSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserRoadside SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="f"
...
export const iconPackOfUserRoadside: TheIconSelfPack = [
  'UserRoadside',
  IconUserRoadsideStrokeRounded,
  IconUserRoadsideDuotoneRounded,
  IconUserRoadsideTwotoneRounded,
  IconUserRoadsideSolidRounded,
  IconUserRoadsideBulkRounded,
  IconUserRoadsideStrokeSharp,
  IconUserRoadsideSolidSharp,
];