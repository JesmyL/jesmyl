...
export const IconGitCompareStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitCompare StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGitCompareDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitCompare DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGitCompareTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitCompare TwotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="o7 s sj sr sw"
...
export const IconGitCompareSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitCompare SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconGitCompareBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitCompare BulkRounded"
    >
      <path 
        d={d.d10}
        i-c="f o7"
...
export const IconGitCompareStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitCompare StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sj sw"
...
export const IconGitCompareSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitCompare SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const iconPackOfGitCompare: TheIconSelfPack = [
  'GitCompare',
  IconGitCompareStrokeRounded,
  IconGitCompareDuotoneRounded,
  IconGitCompareTwotoneRounded,
  IconGitCompareSolidRounded,
  IconGitCompareBulkRounded,
  IconGitCompareStrokeSharp,
  IconGitCompareSolidSharp,
];