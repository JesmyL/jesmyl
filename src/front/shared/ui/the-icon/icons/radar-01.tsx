...
export const IconRadar01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Radar01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconRadar01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Radar01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconRadar01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Radar01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const iconPackOfRadar01: TheIconSelfPack = [
  'Radar01',
  IconRadar01StrokeRounded,
  IconRadar01DuotoneRounded,
  IconRadar01TwotoneRounded,
  IconRadar01SolidRounded,
  IconRadar01BulkRounded,
  IconRadar01StrokeSharp,
  IconRadar01SolidSharp,
];