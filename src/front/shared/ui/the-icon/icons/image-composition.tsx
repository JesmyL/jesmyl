...
export const IconImageCompositionStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageComposition StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconImageCompositionDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageComposition DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconImageCompositionTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageComposition TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconImageCompositionSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageComposition SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconImageCompositionBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageComposition BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconImageCompositionStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageComposition StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconImageCompositionSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageComposition SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfImageComposition: TheIconSelfPack = [
  'ImageComposition',
  IconImageCompositionStrokeRounded,
  IconImageCompositionDuotoneRounded,
  IconImageCompositionTwotoneRounded,
  IconImageCompositionSolidRounded,
  IconImageCompositionBulkRounded,
  IconImageCompositionStrokeSharp,
  IconImageCompositionSolidSharp,
];