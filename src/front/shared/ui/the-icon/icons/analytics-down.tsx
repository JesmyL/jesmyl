...
export const IconAnalyticsDownStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AnalyticsDown StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconAnalyticsDownDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AnalyticsDown DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconAnalyticsDownTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AnalyticsDown TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconAnalyticsDownSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AnalyticsDown SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconAnalyticsDownBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AnalyticsDown BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconAnalyticsDownStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AnalyticsDown StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const IconAnalyticsDownSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AnalyticsDown SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const iconPackOfAnalyticsDown: TheIconSelfPack = [
  'AnalyticsDown',
  IconAnalyticsDownStrokeRounded,
  IconAnalyticsDownDuotoneRounded,
  IconAnalyticsDownTwotoneRounded,
  IconAnalyticsDownSolidRounded,
  IconAnalyticsDownBulkRounded,
  IconAnalyticsDownStrokeSharp,
  IconAnalyticsDownSolidSharp,
];