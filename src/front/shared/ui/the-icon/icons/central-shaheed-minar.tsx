...
export const IconCentralShaheedMinarStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CentralShaheedMinar StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCentralShaheedMinarDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CentralShaheedMinar DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconCentralShaheedMinarTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CentralShaheedMinar TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconCentralShaheedMinarSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CentralShaheedMinar SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconCentralShaheedMinarBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CentralShaheedMinar BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr o7"
...
export const IconCentralShaheedMinarStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CentralShaheedMinar StrokeSharp"
    >
      <path 
        d={d.d14}
        i-c="s sw"
...
export const IconCentralShaheedMinarSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CentralShaheedMinar SolidSharp"
    >
      <path 
        d={d.d18}
        i-c="c f fr"
...
export const iconPackOfCentralShaheedMinar: TheIconSelfPack = [
  'CentralShaheedMinar',
  IconCentralShaheedMinarStrokeRounded,
  IconCentralShaheedMinarDuotoneRounded,
  IconCentralShaheedMinarTwotoneRounded,
  IconCentralShaheedMinarSolidRounded,
  IconCentralShaheedMinarBulkRounded,
  IconCentralShaheedMinarStrokeSharp,
  IconCentralShaheedMinarSolidSharp,
];