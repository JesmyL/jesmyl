...
export const IconCallPausedStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CallPaused StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconCallPausedDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CallPaused DuotoneRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d3}
...
export const IconCallPausedTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CallPaused TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconCallPausedSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CallPaused SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconCallPausedBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CallPaused BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconCallPausedStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CallPaused StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sw"
...
export const IconCallPausedSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CallPaused SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfCallPaused: TheIconSelfPack = [
  'CallPaused',
  IconCallPausedStrokeRounded,
  IconCallPausedDuotoneRounded,
  IconCallPausedTwotoneRounded,
  IconCallPausedSolidRounded,
  IconCallPausedBulkRounded,
  IconCallPausedStrokeSharp,
  IconCallPausedSolidSharp,
];