...
export const IconFile01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="File01 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconFile01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="File01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfFile01: TheIconSelfPack = [
  'File01',
  IconFile01StrokeRounded,
  IconFile01DuotoneRounded,
  IconFile01TwotoneRounded,
  IconFile01SolidRounded,
  IconFile01BulkRounded,
  IconFile01StrokeSharp,
  IconFile01SolidSharp,
];