...
export const IconMouseLeftClick03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MouseLeftClick03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMouseLeftClick03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MouseLeftClick03 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconMouseLeftClick03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MouseLeftClick03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMouseLeftClick03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MouseLeftClick03 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconMouseLeftClick03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MouseLeftClick03 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr o7"
...
export const IconMouseLeftClick03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MouseLeftClick03 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconMouseLeftClick03SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MouseLeftClick03 SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfMouseLeftClick03: TheIconSelfPack = [
  'MouseLeftClick03',
  IconMouseLeftClick03StrokeRounded,
  IconMouseLeftClick03DuotoneRounded,
  IconMouseLeftClick03TwotoneRounded,
  IconMouseLeftClick03SolidRounded,
  IconMouseLeftClick03BulkRounded,
  IconMouseLeftClick03StrokeSharp,
  IconMouseLeftClick03SolidSharp,
];