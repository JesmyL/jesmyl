...
export const IconWardrobe03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wardrobe03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconWardrobe03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wardrobe03 DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconWardrobe03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wardrobe03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconWardrobe03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wardrobe03 SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconWardrobe03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wardrobe03 BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconWardrobe03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wardrobe03 StrokeSharp"
    >
      <path 
        d={d.d16}
        i-c="s sj sw"
...
export const IconWardrobe03SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wardrobe03 SolidSharp"
    >
      <path 
        d={d.d22}
        i-c="c f fr"
...
export const iconPackOfWardrobe03: TheIconSelfPack = [
  'Wardrobe03',
  IconWardrobe03StrokeRounded,
  IconWardrobe03DuotoneRounded,
  IconWardrobe03TwotoneRounded,
  IconWardrobe03SolidRounded,
  IconWardrobe03BulkRounded,
  IconWardrobe03StrokeSharp,
  IconWardrobe03SolidSharp,
];