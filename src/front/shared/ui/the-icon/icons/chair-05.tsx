...
export const IconChair05StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Chair05 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconChair05DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Chair05 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconChair05TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Chair05 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfChair05: TheIconSelfPack = [
  'Chair05',
  IconChair05StrokeRounded,
  IconChair05DuotoneRounded,
  IconChair05TwotoneRounded,
  IconChair05SolidRounded,
  IconChair05BulkRounded,
  IconChair05StrokeSharp,
  IconChair05SolidSharp,
];