...
export const IconSlidersHorizontalStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SlidersHorizontal StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSlidersHorizontalDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SlidersHorizontal DuotoneRounded"
    >
      <path 
        d={d.d10}
        i-c="s sr sw"
...
export const IconSlidersHorizontalTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SlidersHorizontal TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSlidersHorizontalSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SlidersHorizontal SolidRounded"
    >
      <path 
        d={d.d16}
        i-c="c f fr"
...
export const IconSlidersHorizontalBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SlidersHorizontal BulkRounded"
    >
      <path 
        d={d.d16}
        i-c="c f fr"
...
export const IconSlidersHorizontalStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SlidersHorizontal StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSlidersHorizontalSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SlidersHorizontal SolidSharp"
    >
      <path 
        d={d.d25}
        i-c="c f fr"
...
export const iconPackOfSlidersHorizontal: TheIconSelfPack = [
  'SlidersHorizontal',
  IconSlidersHorizontalStrokeRounded,
  IconSlidersHorizontalDuotoneRounded,
  IconSlidersHorizontalTwotoneRounded,
  IconSlidersHorizontalSolidRounded,
  IconSlidersHorizontalBulkRounded,
  IconSlidersHorizontalStrokeSharp,
  IconSlidersHorizontalSolidSharp,
];