...
export const IconApricotStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Apricot StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconApricotDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Apricot DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconApricotTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Apricot TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfApricot: TheIconSelfPack = [
  'Apricot',
  IconApricotStrokeRounded,
  IconApricotDuotoneRounded,
  IconApricotTwotoneRounded,
  IconApricotSolidRounded,
  IconApricotBulkRounded,
  IconApricotStrokeSharp,
  IconApricotSolidSharp,
];