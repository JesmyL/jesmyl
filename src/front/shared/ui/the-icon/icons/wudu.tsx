...
export const iconPackOfWudu: TheIconSelfPack = [
  'Wudu',
  IconWuduStrokeRounded,
  IconWuduDuotoneRounded,
  IconWuduTwotoneRounded,
  IconWuduSolidRounded,
  IconWuduBulkRounded,
  IconWuduStrokeSharp,
  IconWuduSolidSharp,
];