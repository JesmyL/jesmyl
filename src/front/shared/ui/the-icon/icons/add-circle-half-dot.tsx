...
export const IconAddCircleHalfDotStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AddCircleHalfDot StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconAddCircleHalfDotDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AddCircleHalfDot DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconAddCircleHalfDotTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AddCircleHalfDot TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconAddCircleHalfDotSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AddCircleHalfDot SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconAddCircleHalfDotBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AddCircleHalfDot BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconAddCircleHalfDotStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AddCircleHalfDot StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconAddCircleHalfDotSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AddCircleHalfDot SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfAddCircleHalfDot: TheIconSelfPack = [
  'AddCircleHalfDot',
  IconAddCircleHalfDotStrokeRounded,
  IconAddCircleHalfDotDuotoneRounded,
  IconAddCircleHalfDotTwotoneRounded,
  IconAddCircleHalfDotSolidRounded,
  IconAddCircleHalfDotBulkRounded,
  IconAddCircleHalfDotStrokeSharp,
  IconAddCircleHalfDotSolidSharp,
];