...
export const IconMailbox01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mailbox01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMailbox01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mailbox01 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconMailbox01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mailbox01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconMailbox01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mailbox01 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconMailbox01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mailbox01 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconMailbox01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mailbox01 StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const iconPackOfMailbox01: TheIconSelfPack = [
  'Mailbox01',
  IconMailbox01StrokeRounded,
  IconMailbox01DuotoneRounded,
  IconMailbox01TwotoneRounded,
  IconMailbox01SolidRounded,
  IconMailbox01BulkRounded,
  IconMailbox01StrokeSharp,
  IconMailbox01SolidSharp,
];