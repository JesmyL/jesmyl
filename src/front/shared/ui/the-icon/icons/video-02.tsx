...
export const IconVideo02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Video02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconVideo02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Video02 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconVideo02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Video02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const iconPackOfVideo02: TheIconSelfPack = [
  'Video02',
  IconVideo02StrokeRounded,
  IconVideo02DuotoneRounded,
  IconVideo02TwotoneRounded,
  IconVideo02SolidRounded,
  IconVideo02BulkRounded,
  IconVideo02StrokeSharp,
  IconVideo02SolidSharp,
];