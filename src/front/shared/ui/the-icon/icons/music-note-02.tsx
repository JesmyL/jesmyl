...
export const IconMusicNote02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNote02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMusicNote02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNote02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMusicNote02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNote02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconMusicNote02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNote02 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconMusicNote02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNote02 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconMusicNote02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNote02 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sr sw"
...
export const IconMusicNote02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNote02 SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const iconPackOfMusicNote02: TheIconSelfPack = [
  'MusicNote02',
  IconMusicNote02StrokeRounded,
  IconMusicNote02DuotoneRounded,
  IconMusicNote02TwotoneRounded,
  IconMusicNote02SolidRounded,
  IconMusicNote02BulkRounded,
  IconMusicNote02StrokeSharp,
  IconMusicNote02SolidSharp,
];