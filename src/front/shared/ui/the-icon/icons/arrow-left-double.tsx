...
export const IconArrowLeftDoubleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowLeftDouble StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconArrowLeftDoubleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowLeftDouble DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconArrowLeftDoubleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowLeftDouble TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconArrowLeftDoubleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowLeftDouble SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconArrowLeftDoubleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowLeftDouble BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconArrowLeftDoubleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowLeftDouble StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sw"
...
export const IconArrowLeftDoubleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowLeftDouble SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfArrowLeftDouble: TheIconSelfPack = [
  ...
  IconArrowLeftDoubleDuotoneRounded,
  IconArrowLeftDoubleTwotoneRounded,
  IconArrowLeftDoubleSolidRounded,
  IconArrowLeftDoubleBulkRounded,
  IconArrowLeftDoubleStrokeSharp,
  IconArrowLeftDoubleSolidSharp,
];