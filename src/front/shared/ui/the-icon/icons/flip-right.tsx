...
export const IconFlipRightStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlipRight StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFlipRightDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlipRight DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconFlipRightTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlipRight TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconFlipRightSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlipRight SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconFlipRightBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlipRight BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconFlipRightStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlipRight StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const iconPackOfFlipRight: TheIconSelfPack = [
  'FlipRight',
  IconFlipRightStrokeRounded,
  IconFlipRightDuotoneRounded,
  IconFlipRightTwotoneRounded,
  IconFlipRightSolidRounded,
  IconFlipRightBulkRounded,
  IconFlipRightStrokeSharp,
  IconFlipRightSolidSharp,
];