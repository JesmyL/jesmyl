...
export const iconPackOfDoor: TheIconSelfPack = [
  'Door',
  IconDoorStrokeRounded,
  IconDoorDuotoneRounded,
  IconDoorTwotoneRounded,
  IconDoorSolidRounded,
  IconDoorBulkRounded,
  IconDoorStrokeSharp,
  IconDoorSolidSharp,
];