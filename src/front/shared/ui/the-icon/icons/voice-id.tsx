...
export const IconVoiceIdStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VoiceId StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconVoiceIdDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VoiceId DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconVoiceIdTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VoiceId TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfVoiceId: TheIconSelfPack = [
  'VoiceId',
  IconVoiceIdStrokeRounded,
  IconVoiceIdDuotoneRounded,
  IconVoiceIdTwotoneRounded,
  IconVoiceIdSolidRounded,
  IconVoiceIdBulkRounded,
  IconVoiceIdStrokeSharp,
  IconVoiceIdSolidSharp,
];