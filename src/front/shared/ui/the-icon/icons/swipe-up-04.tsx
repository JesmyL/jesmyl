...
export const IconSwipeUp04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeUp04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSwipeUp04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeUp04 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconSwipeUp04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeUp04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSwipeUp04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeUp04 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconSwipeUp04BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeUp04 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconSwipeUp04StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeUp04 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const iconPackOfSwipeUp04: TheIconSelfPack = [
  'SwipeUp04',
  IconSwipeUp04StrokeRounded,
  IconSwipeUp04DuotoneRounded,
  IconSwipeUp04TwotoneRounded,
  IconSwipeUp04SolidRounded,
  IconSwipeUp04BulkRounded,
  IconSwipeUp04StrokeSharp,
  IconSwipeUp04SolidSharp,
];