...
export const IconSorting02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sorting02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSorting02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sorting02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSorting02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sorting02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconSorting02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sorting02 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconSorting02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sorting02 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconSorting02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sorting02 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfSorting02: TheIconSelfPack = [
  'Sorting02',
  IconSorting02StrokeRounded,
  IconSorting02DuotoneRounded,
  IconSorting02TwotoneRounded,
  IconSorting02SolidRounded,
  IconSorting02BulkRounded,
  IconSorting02StrokeSharp,
  IconSorting02SolidSharp,
];