...
export const IconSmartWatch03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmartWatch03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSmartWatch03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmartWatch03 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconSmartWatch03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmartWatch03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSmartWatch03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmartWatch03 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconSmartWatch03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmartWatch03 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconSmartWatch03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmartWatch03 StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sw"
...
export const IconSmartWatch03SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmartWatch03 SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfSmartWatch03: TheIconSelfPack = [
  'SmartWatch03',
  IconSmartWatch03StrokeRounded,
  IconSmartWatch03DuotoneRounded,
  IconSmartWatch03TwotoneRounded,
  IconSmartWatch03SolidRounded,
  IconSmartWatch03BulkRounded,
  IconSmartWatch03StrokeSharp,
  IconSmartWatch03SolidSharp,
];