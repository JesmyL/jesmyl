...
export const IconLocationAdd01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationAdd01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLocationAdd01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationAdd01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconLocationAdd01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationAdd01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLocationAdd01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationAdd01 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconLocationAdd01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationAdd01 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconLocationAdd01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationAdd01 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const IconLocationAdd01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationAdd01 SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfLocationAdd01: TheIconSelfPack = [
  'LocationAdd01',
  IconLocationAdd01StrokeRounded,
  IconLocationAdd01DuotoneRounded,
  IconLocationAdd01TwotoneRounded,
  IconLocationAdd01SolidRounded,
  IconLocationAdd01BulkRounded,
  IconLocationAdd01StrokeSharp,
  IconLocationAdd01SolidSharp,
];