...
export const IconDirections01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Directions01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDirections01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Directions01 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconDirections01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Directions01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDirections01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Directions01 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconDirections01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Directions01 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconDirections01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Directions01 StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sj sw"
...
export const IconDirections01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Directions01 SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="f"
...
export const iconPackOfDirections01: TheIconSelfPack = [
  'Directions01',
  IconDirections01StrokeRounded,
  IconDirections01DuotoneRounded,
  IconDirections01TwotoneRounded,
  IconDirections01SolidRounded,
  IconDirections01BulkRounded,
  IconDirections01StrokeSharp,
  IconDirections01SolidSharp,
];