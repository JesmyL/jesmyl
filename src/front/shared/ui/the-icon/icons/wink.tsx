...
export const iconPackOfWink: TheIconSelfPack = [
  'Wink',
  IconWinkStrokeRounded,
  IconWinkDuotoneRounded,
  IconWinkTwotoneRounded,
  IconWinkSolidRounded,
  IconWinkBulkRounded,
  IconWinkStrokeSharp,
  IconWinkSolidSharp,
];