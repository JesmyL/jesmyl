...
export const IconCheckUnread02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheckUnread02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCheckUnread02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheckUnread02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCheckUnread02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheckUnread02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconCheckUnread02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheckUnread02 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconCheckUnread02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheckUnread02 BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d4}
...
export const IconCheckUnread02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheckUnread02 StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s ss sw"
...
export const IconCheckUnread02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheckUnread02 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const iconPackOfCheckUnread02: TheIconSelfPack = [
  'CheckUnread02',
  IconCheckUnread02StrokeRounded,
  IconCheckUnread02DuotoneRounded,
  IconCheckUnread02TwotoneRounded,
  IconCheckUnread02SolidRounded,
  IconCheckUnread02BulkRounded,
  IconCheckUnread02StrokeSharp,
  IconCheckUnread02SolidSharp,
];