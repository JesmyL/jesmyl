...
export const IconFolderUploadStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderUpload StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFolderUploadDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderUpload DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconFolderUploadTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderUpload TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFolderUploadSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderUpload SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconFolderUploadBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderUpload BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconFolderUploadStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderUpload StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const IconFolderUploadSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderUpload SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfFolderUpload: TheIconSelfPack = [
  'FolderUpload',
  IconFolderUploadStrokeRounded,
  IconFolderUploadDuotoneRounded,
  IconFolderUploadTwotoneRounded,
  IconFolderUploadSolidRounded,
  IconFolderUploadBulkRounded,
  IconFolderUploadStrokeSharp,
  IconFolderUploadSolidSharp,
];