...
export const IconPizzaCutterStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PizzaCutter StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPizzaCutterDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PizzaCutter DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconPizzaCutterTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PizzaCutter TwotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="o4 s sj sr sw"
...
export const IconPizzaCutterSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PizzaCutter SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconPizzaCutterBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PizzaCutter BulkRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr o7"
...
export const IconPizzaCutterStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PizzaCutter StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sr sw"
...
export const IconPizzaCutterSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PizzaCutter SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfPizzaCutter: TheIconSelfPack = [
  'PizzaCutter',
  IconPizzaCutterStrokeRounded,
  IconPizzaCutterDuotoneRounded,
  IconPizzaCutterTwotoneRounded,
  IconPizzaCutterSolidRounded,
  IconPizzaCutterBulkRounded,
  IconPizzaCutterStrokeSharp,
  IconPizzaCutterSolidSharp,
];