...
export const IconArrowUpDoubleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUpDouble StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconArrowUpDoubleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUpDouble DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconArrowUpDoubleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUpDouble TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconArrowUpDoubleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUpDouble SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconArrowUpDoubleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUpDouble BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconArrowUpDoubleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUpDouble StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sw"
...
export const IconArrowUpDoubleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUpDouble SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfArrowUpDouble: TheIconSelfPack = [
  ...
  IconArrowUpDoubleDuotoneRounded,
  IconArrowUpDoubleTwotoneRounded,
  IconArrowUpDoubleSolidRounded,
  IconArrowUpDoubleBulkRounded,
  IconArrowUpDoubleStrokeSharp,
  IconArrowUpDoubleSolidSharp,
];