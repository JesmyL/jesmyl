...
export const IconMobileProgramming01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MobileProgramming01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconMobileProgramming01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MobileProgramming01 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconMobileProgramming01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MobileProgramming01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconMobileProgramming01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MobileProgramming01 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconMobileProgramming01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MobileProgramming01 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr o7"
...
export const IconMobileProgramming01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MobileProgramming01 StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const IconMobileProgramming01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MobileProgramming01 SolidSharp"
    >
      <path 
        d={d.d16}
        i-c="c f fr"
...
export const iconPackOfMobileProgramming01: TheIconSelfPack = [
  'MobileProgramming01',
  IconMobileProgramming01StrokeRounded,
  IconMobileProgramming01DuotoneRounded,
  IconMobileProgramming01TwotoneRounded,
  IconMobileProgramming01SolidRounded,
  IconMobileProgramming01BulkRounded,
  IconMobileProgramming01StrokeSharp,
  IconMobileProgramming01SolidSharp,
];