...
export const IconWorkflowCircle06StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowCircle06 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWorkflowCircle06DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowCircle06 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconWorkflowCircle06TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowCircle06 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWorkflowCircle06SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowCircle06 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconWorkflowCircle06BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowCircle06 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconWorkflowCircle06StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowCircle06 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconWorkflowCircle06SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowCircle06 SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const iconPackOfWorkflowCircle06: TheIconSelfPack = [
  'WorkflowCircle06',
  IconWorkflowCircle06StrokeRounded,
  IconWorkflowCircle06DuotoneRounded,
  IconWorkflowCircle06TwotoneRounded,
  IconWorkflowCircle06SolidRounded,
  IconWorkflowCircle06BulkRounded,
  IconWorkflowCircle06StrokeSharp,
  IconWorkflowCircle06SolidSharp,
];