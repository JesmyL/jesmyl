...
export const IconFileCloudStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileCloud StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFileCloudDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileCloud DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconFileCloudTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileCloud TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFileCloudSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileCloud SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconFileCloudBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileCloud BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconFileCloudStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileCloud StrokeSharp"
    >
      <path 
        d={d.d3}
        i-c="s sr sw"
...
export const iconPackOfFileCloud: TheIconSelfPack = [
  'FileCloud',
  IconFileCloudStrokeRounded,
  IconFileCloudDuotoneRounded,
  IconFileCloudTwotoneRounded,
  IconFileCloudSolidRounded,
  IconFileCloudBulkRounded,
  IconFileCloudStrokeSharp,
  IconFileCloudSolidSharp,
];