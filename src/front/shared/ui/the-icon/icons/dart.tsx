...
export const iconPackOfDart: TheIconSelfPack = [
  'Dart',
  IconDartStrokeRounded,
  IconDartDuotoneRounded,
  IconDartTwotoneRounded,
  IconDartSolidRounded,
  IconDartBulkRounded,
  IconDartStrokeSharp,
  IconDartSolidSharp,
];