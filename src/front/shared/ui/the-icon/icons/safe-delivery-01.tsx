...
export const IconSafeDelivery01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SafeDelivery01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSafeDelivery01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SafeDelivery01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconSafeDelivery01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SafeDelivery01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSafeDelivery01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SafeDelivery01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconSafeDelivery01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SafeDelivery01 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconSafeDelivery01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SafeDelivery01 StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const IconSafeDelivery01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SafeDelivery01 SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const iconPackOfSafeDelivery01: TheIconSelfPack = [
  'SafeDelivery01',
  IconSafeDelivery01StrokeRounded,
  IconSafeDelivery01DuotoneRounded,
  IconSafeDelivery01TwotoneRounded,
  IconSafeDelivery01SolidRounded,
  IconSafeDelivery01BulkRounded,
  IconSafeDelivery01StrokeSharp,
  IconSafeDelivery01SolidSharp,
];