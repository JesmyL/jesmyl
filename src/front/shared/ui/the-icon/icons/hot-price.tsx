...
export const IconHotPriceStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HotPrice StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconHotPriceDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HotPrice DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconHotPriceTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HotPrice TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconHotPriceSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HotPrice SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const iconPackOfHotPrice: TheIconSelfPack = [
  'HotPrice',
  IconHotPriceStrokeRounded,
  IconHotPriceDuotoneRounded,
  IconHotPriceTwotoneRounded,
  IconHotPriceSolidRounded,
  IconHotPriceBulkRounded,
  IconHotPriceStrokeSharp,
  IconHotPriceSolidSharp,
];