...
export const IconFloppyDiskStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FloppyDisk StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconFloppyDiskDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FloppyDisk DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconFloppyDiskTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FloppyDisk TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sw"
...
export const IconFloppyDiskSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FloppyDisk SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconFloppyDiskBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FloppyDisk BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconFloppyDiskStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FloppyDisk StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const IconFloppyDiskSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FloppyDisk SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfFloppyDisk: TheIconSelfPack = [
  'FloppyDisk',
  IconFloppyDiskStrokeRounded,
  IconFloppyDiskDuotoneRounded,
  IconFloppyDiskTwotoneRounded,
  IconFloppyDiskSolidRounded,
  IconFloppyDiskBulkRounded,
  IconFloppyDiskStrokeSharp,
  IconFloppyDiskSolidSharp,
];