...
export const IconSodaCanStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SodaCan StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSodaCanDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SodaCan DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconSodaCanTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SodaCan TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfSodaCan: TheIconSelfPack = [
  'SodaCan',
  IconSodaCanStrokeRounded,
  IconSodaCanDuotoneRounded,
  IconSodaCanTwotoneRounded,
  IconSodaCanSolidRounded,
  IconSodaCanBulkRounded,
  IconSodaCanStrokeSharp,
  IconSodaCanSolidSharp,
];