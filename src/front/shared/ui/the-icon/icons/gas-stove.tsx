...
export const IconGasStoveStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GasStove StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGasStoveDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GasStove DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconGasStoveTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GasStove TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGasStoveSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GasStove SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfGasStove: TheIconSelfPack = [
  'GasStove',
  IconGasStoveStrokeRounded,
  IconGasStoveDuotoneRounded,
  IconGasStoveTwotoneRounded,
  IconGasStoveSolidRounded,
  IconGasStoveBulkRounded,
  IconGasStoveStrokeSharp,
  IconGasStoveSolidSharp,
];