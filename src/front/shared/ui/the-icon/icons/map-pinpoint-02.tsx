...
export const IconMapPinpoint02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapPinpoint02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconMapPinpoint02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapPinpoint02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconMapPinpoint02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapPinpoint02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconMapPinpoint02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapPinpoint02 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconMapPinpoint02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapPinpoint02 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconMapPinpoint02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapPinpoint02 StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconMapPinpoint02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapPinpoint02 SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfMapPinpoint02: TheIconSelfPack = [
  'MapPinpoint02',
  IconMapPinpoint02StrokeRounded,
  IconMapPinpoint02DuotoneRounded,
  IconMapPinpoint02TwotoneRounded,
  IconMapPinpoint02SolidRounded,
  IconMapPinpoint02BulkRounded,
  IconMapPinpoint02StrokeSharp,
  IconMapPinpoint02SolidSharp,
];