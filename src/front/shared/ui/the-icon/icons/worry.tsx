...
export const iconPackOfWorry: TheIconSelfPack = [
  'Worry',
  IconWorryStrokeRounded,
  IconWorryDuotoneRounded,
  IconWorryTwotoneRounded,
  IconWorrySolidRounded,
  IconWorryBulkRounded,
  IconWorryStrokeSharp,
  IconWorrySolidSharp,
];