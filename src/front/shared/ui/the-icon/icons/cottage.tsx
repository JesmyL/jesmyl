...
export const IconCottageStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cottage StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCottageDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cottage DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconCottageTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cottage TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfCottage: TheIconSelfPack = [
  'Cottage',
  IconCottageStrokeRounded,
  IconCottageDuotoneRounded,
  IconCottageTwotoneRounded,
  IconCottageSolidRounded,
  IconCottageBulkRounded,
  IconCottageStrokeSharp,
  IconCottageSolidSharp,
];