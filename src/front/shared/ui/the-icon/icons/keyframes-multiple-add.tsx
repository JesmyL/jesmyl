...
export const IconKeyframesMultipleAddStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframesMultipleAdd StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconKeyframesMultipleAddDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframesMultipleAdd DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconKeyframesMultipleAddTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframesMultipleAdd TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconKeyframesMultipleAddSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframesMultipleAdd SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconKeyframesMultipleAddBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframesMultipleAdd BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconKeyframesMultipleAddStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframesMultipleAdd StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sw"
...
export const IconKeyframesMultipleAddSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframesMultipleAdd SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfKeyframesMultipleAdd: TheIconSelfPack = [
  ...
  IconKeyframesMultipleAddStrokeRounded,
  IconKeyframesMultipleAddDuotoneRounded,
  IconKeyframesMultipleAddTwotoneRounded,
  IconKeyframesMultipleAddSolidRounded,
  IconKeyframesMultipleAddBulkRounded,
  IconKeyframesMultipleAddStrokeSharp,
  IconKeyframesMultipleAddSolidSharp,
];