...
export const IconSecurityStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Security StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSecurityDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Security DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconSecurityTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Security TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSecuritySolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Security SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const iconPackOfSecurity: TheIconSelfPack = [
  'Security',
  IconSecurityStrokeRounded,
  IconSecurityDuotoneRounded,
  IconSecurityTwotoneRounded,
  IconSecuritySolidRounded,
  IconSecurityBulkRounded,
  IconSecurityStrokeSharp,
  IconSecuritySolidSharp,
];