...
export const IconWardrobe04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wardrobe04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconWardrobe04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wardrobe04 DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconWardrobe04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wardrobe04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconWardrobe04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wardrobe04 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconWardrobe04BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wardrobe04 BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconWardrobe04StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wardrobe04 StrokeSharp"
    >
      <path 
        d={d.d16}
        i-c="s sj sw"
...
export const IconWardrobe04SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wardrobe04 SolidSharp"
    >
      <path 
        d={d.d22}
        i-c="c f fr"
...
export const iconPackOfWardrobe04: TheIconSelfPack = [
  'Wardrobe04',
  IconWardrobe04StrokeRounded,
  IconWardrobe04DuotoneRounded,
  IconWardrobe04TwotoneRounded,
  IconWardrobe04SolidRounded,
  IconWardrobe04BulkRounded,
  IconWardrobe04StrokeSharp,
  IconWardrobe04SolidSharp,
];