...
export const IconDish02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Dish02 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconDish02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Dish02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const iconPackOfDish02: TheIconSelfPack = [
  'Dish02',
  IconDish02StrokeRounded,
  IconDish02DuotoneRounded,
  IconDish02TwotoneRounded,
  IconDish02SolidRounded,
  IconDish02BulkRounded,
  IconDish02StrokeSharp,
  IconDish02SolidSharp,
];