...
export const IconMoreVerticalCircle01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreVerticalCircle01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMoreVerticalCircle01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreVerticalCircle01 DuotoneRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d1}
...
export const IconMoreVerticalCircle01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreVerticalCircle01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMoreVerticalCircle01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreVerticalCircle01 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconMoreVerticalCircle01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreVerticalCircle01 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconMoreVerticalCircle01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreVerticalCircle01 StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const IconMoreVerticalCircle01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreVerticalCircle01 SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfMoreVerticalCircle01: TheIconSelfPack = [
  ...
  IconMoreVerticalCircle01DuotoneRounded,
  IconMoreVerticalCircle01TwotoneRounded,
  IconMoreVerticalCircle01SolidRounded,
  IconMoreVerticalCircle01BulkRounded,
  IconMoreVerticalCircle01StrokeSharp,
  IconMoreVerticalCircle01SolidSharp,
];