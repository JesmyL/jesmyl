...
export const IconMotorbike01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Motorbike01 StrokeRounded"
    >
      <circle 
        cx="19.5"
        cy="16.5"
...
export const IconMotorbike01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Motorbike01 DuotoneRounded"
    >
      <circle 
        cx="19.5"
        cy="16.5"
...
export const IconMotorbike01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Motorbike01 TwotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="s sw"
...
export const IconMotorbike01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Motorbike01 SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconMotorbike01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Motorbike01 BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconMotorbike01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Motorbike01 StrokeSharp"
    >
      <circle 
        cx="19.5"
        cy="16.5"
...
export const IconMotorbike01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Motorbike01 SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfMotorbike01: TheIconSelfPack = [
  'Motorbike01',
  IconMotorbike01StrokeRounded,
  IconMotorbike01DuotoneRounded,
  IconMotorbike01TwotoneRounded,
  IconMotorbike01SolidRounded,
  IconMotorbike01BulkRounded,
  IconMotorbike01StrokeSharp,
  IconMotorbike01SolidSharp,
];