...
export const IconNoInternetStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NoInternet StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconNoInternetDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NoInternet DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconNoInternetTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NoInternet TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconNoInternetSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NoInternet SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconNoInternetBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NoInternet BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconNoInternetStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NoInternet StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconNoInternetSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NoInternet SolidSharp"
    >
      <path 
        d={d.d18}
        i-c="f"
...
export const iconPackOfNoInternet: TheIconSelfPack = [
  'NoInternet',
  IconNoInternetStrokeRounded,
  IconNoInternetDuotoneRounded,
  IconNoInternetTwotoneRounded,
  IconNoInternetSolidRounded,
  IconNoInternetBulkRounded,
  IconNoInternetStrokeSharp,
  IconNoInternetSolidSharp,
];