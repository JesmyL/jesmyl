...
export const iconPackOfHappy: TheIconSelfPack = [
  'Happy',
  IconHappyStrokeRounded,
  IconHappyDuotoneRounded,
  IconHappyTwotoneRounded,
  IconHappySolidRounded,
  IconHappyBulkRounded,
  IconHappyStrokeSharp,
  IconHappySolidSharp,
];