...
export const IconGitMergeStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitMerge StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconGitMergeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitMerge DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconGitMergeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitMerge TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconGitMergeSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitMerge SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfGitMerge: TheIconSelfPack = [
  'GitMerge',
  IconGitMergeStrokeRounded,
  IconGitMergeDuotoneRounded,
  IconGitMergeTwotoneRounded,
  IconGitMergeSolidRounded,
  IconGitMergeBulkRounded,
  IconGitMergeStrokeSharp,
  IconGitMergeSolidSharp,
];