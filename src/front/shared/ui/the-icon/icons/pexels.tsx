...
export const IconPexelsDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pexels DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr o7"
...
export const IconPexelsTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pexels TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfPexels: TheIconSelfPack = [
  'Pexels',
  IconPexelsStrokeRounded,
  IconPexelsDuotoneRounded,
  IconPexelsTwotoneRounded,
  IconPexelsSolidRounded,
  IconPexelsBulkRounded,
  IconPexelsStrokeSharp,
  IconPexelsSolidSharp,
];