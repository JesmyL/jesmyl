...
export const IconRippleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Ripple DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRippleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Ripple TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfRipple: TheIconSelfPack = [
  'Ripple',
  IconRippleStrokeRounded,
  IconRippleDuotoneRounded,
  IconRippleTwotoneRounded,
  IconRippleSolidRounded,
  IconRippleBulkRounded,
  IconRippleStrokeSharp,
  IconRippleSolidSharp,
];