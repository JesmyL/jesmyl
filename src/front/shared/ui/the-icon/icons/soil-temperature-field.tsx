...
export const IconSoilTemperatureFieldStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoilTemperatureField StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconSoilTemperatureFieldDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoilTemperatureField DuotoneRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d1}
...
export const IconSoilTemperatureFieldTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoilTemperatureField TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconSoilTemperatureFieldSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoilTemperatureField SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconSoilTemperatureFieldBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoilTemperatureField BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconSoilTemperatureFieldStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoilTemperatureField StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSoilTemperatureFieldSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoilTemperatureField SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="f"
...
export const iconPackOfSoilTemperatureField: TheIconSelfPack = [
  ...
  IconSoilTemperatureFieldStrokeRounded,
  IconSoilTemperatureFieldDuotoneRounded,
  IconSoilTemperatureFieldTwotoneRounded,
  IconSoilTemperatureFieldSolidRounded,
  IconSoilTemperatureFieldBulkRounded,
  IconSoilTemperatureFieldStrokeSharp,
  IconSoilTemperatureFieldSolidSharp,
];