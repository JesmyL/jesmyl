...
export const IconTouchInteraction02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TouchInteraction02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTouchInteraction02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TouchInteraction02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconTouchInteraction02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TouchInteraction02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTouchInteraction02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TouchInteraction02 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconTouchInteraction02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TouchInteraction02 BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconTouchInteraction02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TouchInteraction02 StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sw"
...
export const IconTouchInteraction02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TouchInteraction02 SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfTouchInteraction02: TheIconSelfPack = [
  'TouchInteraction02',
  IconTouchInteraction02StrokeRounded,
  IconTouchInteraction02DuotoneRounded,
  IconTouchInteraction02TwotoneRounded,
  IconTouchInteraction02SolidRounded,
  IconTouchInteraction02BulkRounded,
  IconTouchInteraction02StrokeSharp,
  IconTouchInteraction02SolidSharp,
];