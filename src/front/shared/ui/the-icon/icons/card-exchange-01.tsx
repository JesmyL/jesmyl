...
export const IconCardExchange01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CardExchange01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCardExchange01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CardExchange01 DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconCardExchange01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CardExchange01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCardExchange01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CardExchange01 SolidRounded"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const IconCardExchange01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CardExchange01 BulkRounded"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const IconCardExchange01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CardExchange01 StrokeSharp"
    >
      <path 
        d={d.d17}
        i-c="s sj sw"
...
export const IconCardExchange01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CardExchange01 SolidSharp"
    >
      <path 
        d={d.d21}
        i-c="f"
...
export const iconPackOfCardExchange01: TheIconSelfPack = [
  'CardExchange01',
  IconCardExchange01StrokeRounded,
  IconCardExchange01DuotoneRounded,
  IconCardExchange01TwotoneRounded,
  IconCardExchange01SolidRounded,
  IconCardExchange01BulkRounded,
  IconCardExchange01StrokeSharp,
  IconCardExchange01SolidSharp,
];