...
export const IconWorkAlertStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkAlert StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconWorkAlertDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkAlert DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconWorkAlertTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkAlert TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconWorkAlertSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkAlert SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconWorkAlertBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkAlert BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconWorkAlertStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkAlert StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const iconPackOfWorkAlert: TheIconSelfPack = [
  'WorkAlert',
  IconWorkAlertStrokeRounded,
  IconWorkAlertDuotoneRounded,
  IconWorkAlertTwotoneRounded,
  IconWorkAlertSolidRounded,
  IconWorkAlertBulkRounded,
  IconWorkAlertStrokeSharp,
  IconWorkAlertSolidSharp,
];