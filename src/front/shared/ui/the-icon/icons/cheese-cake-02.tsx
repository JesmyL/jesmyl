...
export const IconCheeseCake02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheeseCake02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconCheeseCake02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheeseCake02 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconCheeseCake02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheeseCake02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconCheeseCake02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheeseCake02 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconCheeseCake02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheeseCake02 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconCheeseCake02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheeseCake02 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconCheeseCake02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheeseCake02 SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfCheeseCake02: TheIconSelfPack = [
  'CheeseCake02',
  IconCheeseCake02StrokeRounded,
  IconCheeseCake02DuotoneRounded,
  IconCheeseCake02TwotoneRounded,
  IconCheeseCake02SolidRounded,
  IconCheeseCake02BulkRounded,
  IconCheeseCake02StrokeSharp,
  IconCheeseCake02SolidSharp,
];