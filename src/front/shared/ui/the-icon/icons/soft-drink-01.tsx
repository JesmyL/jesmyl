...
export const IconSoftDrink01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoftDrink01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSoftDrink01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoftDrink01 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconSoftDrink01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoftDrink01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSoftDrink01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoftDrink01 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconSoftDrink01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoftDrink01 BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d9}
...
export const IconSoftDrink01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoftDrink01 StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const IconSoftDrink01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoftDrink01 SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfSoftDrink01: TheIconSelfPack = [
  'SoftDrink01',
  IconSoftDrink01StrokeRounded,
  IconSoftDrink01DuotoneRounded,
  IconSoftDrink01TwotoneRounded,
  IconSoftDrink01SolidRounded,
  IconSoftDrink01BulkRounded,
  IconSoftDrink01StrokeSharp,
  IconSoftDrink01SolidSharp,
];