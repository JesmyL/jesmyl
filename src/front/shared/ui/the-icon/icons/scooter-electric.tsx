...
export const IconScooterElectricStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ScooterElectric StrokeRounded"
    >
      <circle 
        cx="4"
        cy="18"
...
export const IconScooterElectricDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ScooterElectric DuotoneRounded"
    >
      <circle 
        cx="20"
        cy="18"
...
export const IconScooterElectricTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ScooterElectric TwotoneRounded"
    >
      <circle 
        cx="4"
        cy="18"
...
export const IconScooterElectricSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ScooterElectric SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconScooterElectricBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ScooterElectric BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconScooterElectricStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ScooterElectric StrokeSharp"
    >
      <circle 
        cx="4"
        cy="18"
...
export const IconScooterElectricSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ScooterElectric SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfScooterElectric: TheIconSelfPack = [
  'ScooterElectric',
  IconScooterElectricStrokeRounded,
  IconScooterElectricDuotoneRounded,
  IconScooterElectricTwotoneRounded,
  IconScooterElectricSolidRounded,
  IconScooterElectricBulkRounded,
  IconScooterElectricStrokeSharp,
  IconScooterElectricSolidSharp,
];