...
export const IconContact01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Contact01 StrokeRounded"
    >
      <rect 
        x="4"
        y="2"
...
export const IconContact01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Contact01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconContact01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Contact01 TwotoneRounded"
    >
      <rect 
        x="4"
        y="2"
...
export const IconContact01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Contact01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconContact01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Contact01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconContact01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Contact01 StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const iconPackOfContact01: TheIconSelfPack = [
  'Contact01',
  IconContact01StrokeRounded,
  IconContact01DuotoneRounded,
  IconContact01TwotoneRounded,
  IconContact01SolidRounded,
  IconContact01BulkRounded,
  IconContact01StrokeSharp,
  IconContact01SolidSharp,
];