...
export const IconDoNotTouch02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DoNotTouch02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDoNotTouch02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DoNotTouch02 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconDoNotTouch02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DoNotTouch02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDoNotTouch02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DoNotTouch02 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconDoNotTouch02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DoNotTouch02 BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d5}
...
export const IconDoNotTouch02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DoNotTouch02 StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sw"
...
export const IconDoNotTouch02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DoNotTouch02 SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const iconPackOfDoNotTouch02: TheIconSelfPack = [
  'DoNotTouch02',
  IconDoNotTouch02StrokeRounded,
  IconDoNotTouch02DuotoneRounded,
  IconDoNotTouch02TwotoneRounded,
  IconDoNotTouch02SolidRounded,
  IconDoNotTouch02BulkRounded,
  IconDoNotTouch02StrokeSharp,
  IconDoNotTouch02SolidSharp,
];