...
export const IconFlag03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Flag03 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconFlag03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Flag03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfFlag03: TheIconSelfPack = [
  ...
  IconFlag03DuotoneRounded,
  IconFlag03TwotoneRounded,
  IconFlag03SolidRounded,
  IconFlag03BulkRounded,
  IconFlag03StrokeSharp,
  IconFlag03SolidSharp,
];