...
export const IconEstimate02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Estimate02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconEstimate02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Estimate02 DuotoneRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconEstimate02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Estimate02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconEstimate02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Estimate02 SolidRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const IconEstimate02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Estimate02 BulkRounded"
    >
      <path 
        d={d.d12}
        i-c="f o7"
...
export const IconEstimate02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Estimate02 StrokeSharp"
    >
      <path 
        d={d.d19}
        i-c="s sw"
...
export const IconEstimate02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Estimate02 SolidSharp"
    >
      <path 
        d={d.d20}
        i-c="c f fr"
...
export const iconPackOfEstimate02: TheIconSelfPack = [
  'Estimate02',
  IconEstimate02StrokeRounded,
  IconEstimate02DuotoneRounded,
  IconEstimate02TwotoneRounded,
  IconEstimate02SolidRounded,
  IconEstimate02BulkRounded,
  IconEstimate02StrokeSharp,
  IconEstimate02SolidSharp,
];