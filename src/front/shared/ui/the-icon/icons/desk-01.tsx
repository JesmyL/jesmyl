...
export const IconDesk01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Desk01 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconDesk01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Desk01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfDesk01: TheIconSelfPack = [
  'Desk01',
  IconDesk01StrokeRounded,
  IconDesk01DuotoneRounded,
  IconDesk01TwotoneRounded,
  IconDesk01SolidRounded,
  IconDesk01BulkRounded,
  IconDesk01StrokeSharp,
  IconDesk01SolidSharp,
];