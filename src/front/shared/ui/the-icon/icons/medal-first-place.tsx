...
export const IconMedalFirstPlaceStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MedalFirstPlace StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMedalFirstPlaceDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MedalFirstPlace DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconMedalFirstPlaceTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MedalFirstPlace TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMedalFirstPlaceSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MedalFirstPlace SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconMedalFirstPlaceBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MedalFirstPlace BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconMedalFirstPlaceStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MedalFirstPlace StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconMedalFirstPlaceSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MedalFirstPlace SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const iconPackOfMedalFirstPlace: TheIconSelfPack = [
  'MedalFirstPlace',
  IconMedalFirstPlaceStrokeRounded,
  IconMedalFirstPlaceDuotoneRounded,
  IconMedalFirstPlaceTwotoneRounded,
  IconMedalFirstPlaceSolidRounded,
  IconMedalFirstPlaceBulkRounded,
  IconMedalFirstPlaceStrokeSharp,
  IconMedalFirstPlaceSolidSharp,
];