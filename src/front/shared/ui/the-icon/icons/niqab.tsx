...
export const iconPackOfNiqab: TheIconSelfPack = [
  'Niqab',
  IconNiqabStrokeRounded,
  IconNiqabDuotoneRounded,
  IconNiqabTwotoneRounded,
  IconNiqabSolidRounded,
  IconNiqabBulkRounded,
  IconNiqabStrokeSharp,
  IconNiqabSolidSharp,
];