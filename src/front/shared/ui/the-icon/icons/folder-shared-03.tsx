...
export const IconFolderShared03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderShared03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFolderShared03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderShared03 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconFolderShared03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderShared03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFolderShared03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderShared03 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconFolderShared03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderShared03 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconFolderShared03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderShared03 StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const IconFolderShared03SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderShared03 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const iconPackOfFolderShared03: TheIconSelfPack = [
  'FolderShared03',
  IconFolderShared03StrokeRounded,
  IconFolderShared03DuotoneRounded,
  IconFolderShared03TwotoneRounded,
  IconFolderShared03SolidRounded,
  IconFolderShared03BulkRounded,
  IconFolderShared03StrokeSharp,
  IconFolderShared03SolidSharp,
];