...
export const IconCardiganStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cardigan StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCardiganDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cardigan DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconCardiganTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cardigan TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCardiganSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cardigan SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const iconPackOfCardigan: TheIconSelfPack = [
  'Cardigan',
  IconCardiganStrokeRounded,
  IconCardiganDuotoneRounded,
  IconCardiganTwotoneRounded,
  IconCardiganSolidRounded,
  IconCardiganBulkRounded,
  IconCardiganStrokeSharp,
  IconCardiganSolidSharp,
];