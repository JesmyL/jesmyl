...
export const iconPackOfCafe: TheIconSelfPack = [
  'Cafe',
  IconCafeStrokeRounded,
  IconCafeDuotoneRounded,
  IconCafeTwotoneRounded,
  IconCafeSolidRounded,
  IconCafeBulkRounded,
  IconCafeStrokeSharp,
  IconCafeSolidSharp,
];