...
export const IconInboxUploadStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InboxUpload StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconInboxUploadDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InboxUpload DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconInboxUploadTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InboxUpload TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconInboxUploadSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InboxUpload SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconInboxUploadBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InboxUpload BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconInboxUploadStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InboxUpload StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconInboxUploadSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InboxUpload SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfInboxUpload: TheIconSelfPack = [
  'InboxUpload',
  IconInboxUploadStrokeRounded,
  IconInboxUploadDuotoneRounded,
  IconInboxUploadTwotoneRounded,
  IconInboxUploadSolidRounded,
  IconInboxUploadBulkRounded,
  IconInboxUploadStrokeSharp,
  IconInboxUploadSolidSharp,
];