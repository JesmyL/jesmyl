...
export const IconMoreVerticalSquare02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreVerticalSquare02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMoreVerticalSquare02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreVerticalSquare02 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconMoreVerticalSquare02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreVerticalSquare02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconMoreVerticalSquare02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreVerticalSquare02 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconMoreVerticalSquare02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreVerticalSquare02 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconMoreVerticalSquare02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreVerticalSquare02 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj ss sw"
...
export const IconMoreVerticalSquare02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreVerticalSquare02 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfMoreVerticalSquare02: TheIconSelfPack = [
  ...
  IconMoreVerticalSquare02StrokeRounded,
  IconMoreVerticalSquare02DuotoneRounded,
  IconMoreVerticalSquare02TwotoneRounded,
  IconMoreVerticalSquare02SolidRounded,
  IconMoreVerticalSquare02BulkRounded,
  IconMoreVerticalSquare02StrokeSharp,
  IconMoreVerticalSquare02SolidSharp,
];