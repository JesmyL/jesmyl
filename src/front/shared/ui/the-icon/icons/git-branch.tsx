...
export const IconGitBranchStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitBranch StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGitBranchDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitBranch DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGitBranchTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitBranch TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconGitBranchSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitBranch SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconGitBranchBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitBranch BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconGitBranchStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitBranch StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const iconPackOfGitBranch: TheIconSelfPack = [
  'GitBranch',
  IconGitBranchStrokeRounded,
  IconGitBranchDuotoneRounded,
  IconGitBranchTwotoneRounded,
  IconGitBranchSolidRounded,
  IconGitBranchBulkRounded,
  IconGitBranchStrokeSharp,
  IconGitBranchSolidSharp,
];