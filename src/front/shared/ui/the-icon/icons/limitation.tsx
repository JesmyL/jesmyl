...
export const IconLimitationStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Limitation StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLimitationDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Limitation DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr o7"
...
export const IconLimitationTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Limitation TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLimitationSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Limitation SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconLimitationBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Limitation BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconLimitationStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Limitation StrokeSharp"
    >
      <path 
        d={d.d2}
        i-c="s sj sw"
...
export const IconLimitationSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Limitation SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfLimitation: TheIconSelfPack = [
  'Limitation',
  IconLimitationStrokeRounded,
  IconLimitationDuotoneRounded,
  IconLimitationTwotoneRounded,
  IconLimitationSolidRounded,
  IconLimitationBulkRounded,
  IconLimitationStrokeSharp,
  IconLimitationSolidSharp,
];