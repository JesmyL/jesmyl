...
export const IconDoNotTouch01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DoNotTouch01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDoNotTouch01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DoNotTouch01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconDoNotTouch01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DoNotTouch01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDoNotTouch01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DoNotTouch01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconDoNotTouch01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DoNotTouch01 BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d6}
...
export const IconDoNotTouch01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DoNotTouch01 StrokeSharp"
    >
      <path 
        d={d.d3}
        i-c="s sw"
...
export const IconDoNotTouch01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DoNotTouch01 SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="f"
...
export const iconPackOfDoNotTouch01: TheIconSelfPack = [
  'DoNotTouch01',
  IconDoNotTouch01StrokeRounded,
  IconDoNotTouch01DuotoneRounded,
  IconDoNotTouch01TwotoneRounded,
  IconDoNotTouch01SolidRounded,
  IconDoNotTouch01BulkRounded,
  IconDoNotTouch01StrokeSharp,
  IconDoNotTouch01SolidSharp,
];