...
export const IconNotebook02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Notebook02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconNotebook02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Notebook02 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconNotebook02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Notebook02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconNotebook02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Notebook02 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconNotebook02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Notebook02 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconNotebook02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Notebook02 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sr sw"
...
export const IconNotebook02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Notebook02 SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfNotebook02: TheIconSelfPack = [
  'Notebook02',
  IconNotebook02StrokeRounded,
  IconNotebook02DuotoneRounded,
  IconNotebook02TwotoneRounded,
  IconNotebook02SolidRounded,
  IconNotebook02BulkRounded,
  IconNotebook02StrokeSharp,
  IconNotebook02SolidSharp,
];