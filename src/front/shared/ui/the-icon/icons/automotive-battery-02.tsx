...
export const IconAutomotiveBattery02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AutomotiveBattery02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconAutomotiveBattery02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AutomotiveBattery02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconAutomotiveBattery02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AutomotiveBattery02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconAutomotiveBattery02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AutomotiveBattery02 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconAutomotiveBattery02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AutomotiveBattery02 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconAutomotiveBattery02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AutomotiveBattery02 StrokeSharp"
    >
      <path 
        d={d.d2}
        i-c="s ss sw"
...
export const IconAutomotiveBattery02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AutomotiveBattery02 SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfAutomotiveBattery02: TheIconSelfPack = [
  'AutomotiveBattery02',
  IconAutomotiveBattery02StrokeRounded,
  IconAutomotiveBattery02DuotoneRounded,
  IconAutomotiveBattery02TwotoneRounded,
  IconAutomotiveBattery02SolidRounded,
  IconAutomotiveBattery02BulkRounded,
  IconAutomotiveBattery02StrokeSharp,
  IconAutomotiveBattery02SolidSharp,
];