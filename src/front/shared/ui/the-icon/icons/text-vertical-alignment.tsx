...
export const IconTextVerticalAlignmentStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextVerticalAlignment StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTextVerticalAlignmentDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextVerticalAlignment DuotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconTextVerticalAlignmentTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextVerticalAlignment TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTextVerticalAlignmentSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextVerticalAlignment SolidRounded"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const IconTextVerticalAlignmentBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextVerticalAlignment BulkRounded"
    >
      <path 
        d={d.d12}
        i-c="c f fr o7"
...
export const IconTextVerticalAlignmentStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextVerticalAlignment StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj ss sw"
...
export const IconTextVerticalAlignmentSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextVerticalAlignment SolidSharp"
    >
      <path 
        d={d.d21}
        i-c="c f fr"
...
export const iconPackOfTextVerticalAlignment: TheIconSelfPack = [
  ...
  IconTextVerticalAlignmentStrokeRounded,
  IconTextVerticalAlignmentDuotoneRounded,
  IconTextVerticalAlignmentTwotoneRounded,
  IconTextVerticalAlignmentSolidRounded,
  IconTextVerticalAlignmentBulkRounded,
  IconTextVerticalAlignmentStrokeSharp,
  IconTextVerticalAlignmentSolidSharp,
];