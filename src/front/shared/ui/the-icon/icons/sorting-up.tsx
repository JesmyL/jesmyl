...
export const IconSortingUpStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingUp StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSortingUpDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingUp DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="s sj sr sw"
...
export const IconSortingUpTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingUp TwotoneRounded"
    >
      <path 
        d={d.d11}
        i-c="s sj sr sw"
...
export const IconSortingUpSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingUp SolidRounded"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const IconSortingUpBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingUp BulkRounded"
    >
      <path 
        d={d.d15}
        i-c="c f fr o7"
...
export const IconSortingUpStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SortingUp StrokeSharp"
    >
      <path 
        d={d.d20}
        i-c="s sw"
...
export const iconPackOfSortingUp: TheIconSelfPack = [
  'SortingUp',
  IconSortingUpStrokeRounded,
  IconSortingUpDuotoneRounded,
  IconSortingUpTwotoneRounded,
  IconSortingUpSolidRounded,
  IconSortingUpBulkRounded,
  IconSortingUpStrokeSharp,
  IconSortingUpSolidSharp,
];