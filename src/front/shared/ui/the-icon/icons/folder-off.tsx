...
export const IconFolderOffStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderOff StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFolderOffDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderOff DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconFolderOffTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderOff TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFolderOffSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderOff SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconFolderOffBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderOff BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconFolderOffStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderOff StrokeSharp"
    >
      <path 
        d={d.d3}
        i-c="s sw"
...
export const iconPackOfFolderOff: TheIconSelfPack = [
  'FolderOff',
  IconFolderOffStrokeRounded,
  IconFolderOffDuotoneRounded,
  IconFolderOffTwotoneRounded,
  IconFolderOffSolidRounded,
  IconFolderOffBulkRounded,
  IconFolderOffStrokeSharp,
  IconFolderOffSolidSharp,
];