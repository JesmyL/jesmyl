...
export const iconPackOfNext: TheIconSelfPack = [
  'Next',
  IconNextStrokeRounded,
  IconNextDuotoneRounded,
  IconNextTwotoneRounded,
  IconNextSolidRounded,
  IconNextBulkRounded,
  IconNextStrokeSharp,
  IconNextSolidSharp,
];