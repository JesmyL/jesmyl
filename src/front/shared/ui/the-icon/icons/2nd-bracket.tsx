...
export const Icon2ndBracketStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="2ndBracket StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const Icon2ndBracketDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="2ndBracket DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const Icon2ndBracketTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="2ndBracket TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const Icon2ndBracketSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="2ndBracket SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const Icon2ndBracketBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="2ndBracket BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const Icon2ndBracketStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="2ndBracket StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const Icon2ndBracketSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="2ndBracket SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOf2ndBracket: TheIconSelfPack = [
  '2ndBracket',
  Icon2ndBracketStrokeRounded,
  Icon2ndBracketDuotoneRounded,
  Icon2ndBracketTwotoneRounded,
  Icon2ndBracketSolidRounded,
  Icon2ndBracketBulkRounded,
  Icon2ndBracketStrokeSharp,
  Icon2ndBracketSolidSharp,
];