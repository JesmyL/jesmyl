...
export const IconBedug02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bedug02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconBedug02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bedug02 DuotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconBedug02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bedug02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfBedug02: TheIconSelfPack = [
  'Bedug02',
  IconBedug02StrokeRounded,
  IconBedug02DuotoneRounded,
  IconBedug02TwotoneRounded,
  IconBedug02SolidRounded,
  IconBedug02BulkRounded,
  IconBedug02StrokeSharp,
  IconBedug02SolidSharp,
];