...
export const IconAnonymousStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Anonymous StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAnonymousDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Anonymous DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconAnonymousTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Anonymous TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAnonymousSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Anonymous SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconAnonymousBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Anonymous BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconAnonymousStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Anonymous StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfAnonymous: TheIconSelfPack = [
  'Anonymous',
  IconAnonymousStrokeRounded,
  IconAnonymousDuotoneRounded,
  IconAnonymousTwotoneRounded,
  IconAnonymousSolidRounded,
  IconAnonymousBulkRounded,
  IconAnonymousStrokeSharp,
  IconAnonymousSolidSharp,
];