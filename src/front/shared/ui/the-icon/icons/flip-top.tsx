...
export const IconFlipTopStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlipTop StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFlipTopDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlipTop DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconFlipTopTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlipTop TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const iconPackOfFlipTop: TheIconSelfPack = [
  'FlipTop',
  IconFlipTopStrokeRounded,
  IconFlipTopDuotoneRounded,
  IconFlipTopTwotoneRounded,
  IconFlipTopSolidRounded,
  IconFlipTopBulkRounded,
  IconFlipTopStrokeSharp,
  IconFlipTopSolidSharp,
];