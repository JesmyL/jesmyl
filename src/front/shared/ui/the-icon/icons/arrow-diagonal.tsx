...
export const IconArrowDiagonalStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowDiagonal StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconArrowDiagonalDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowDiagonal DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="o4 s sj sr sw"
...
export const IconArrowDiagonalTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowDiagonal TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconArrowDiagonalSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowDiagonal SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconArrowDiagonalBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowDiagonal BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconArrowDiagonalStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowDiagonal StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const IconArrowDiagonalSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowDiagonal SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfArrowDiagonal: TheIconSelfPack = [
  'ArrowDiagonal',
  IconArrowDiagonalStrokeRounded,
  IconArrowDiagonalDuotoneRounded,
  IconArrowDiagonalTwotoneRounded,
  IconArrowDiagonalSolidRounded,
  IconArrowDiagonalBulkRounded,
  IconArrowDiagonalStrokeSharp,
  IconArrowDiagonalSolidSharp,
];