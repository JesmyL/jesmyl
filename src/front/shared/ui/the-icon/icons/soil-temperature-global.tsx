...
export const IconSoilTemperatureGlobalStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoilTemperatureGlobal StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSoilTemperatureGlobalDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoilTemperatureGlobal DuotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="s sr sw"
...
export const IconSoilTemperatureGlobalTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoilTemperatureGlobal TwotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="o7 s sr sw"
...
export const IconSoilTemperatureGlobalSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoilTemperatureGlobal SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const IconSoilTemperatureGlobalBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoilTemperatureGlobal BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const IconSoilTemperatureGlobalStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoilTemperatureGlobal StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconSoilTemperatureGlobalSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoilTemperatureGlobal SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfSoilTemperatureGlobal: TheIconSelfPack = [
  ...
  IconSoilTemperatureGlobalStrokeRounded,
  IconSoilTemperatureGlobalDuotoneRounded,
  IconSoilTemperatureGlobalTwotoneRounded,
  IconSoilTemperatureGlobalSolidRounded,
  IconSoilTemperatureGlobalBulkRounded,
  IconSoilTemperatureGlobalStrokeSharp,
  IconSoilTemperatureGlobalSolidSharp,
];