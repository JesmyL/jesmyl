...
export const IconBitcoinGraphStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinGraph StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBitcoinGraphDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinGraph DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconBitcoinGraphTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinGraph TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBitcoinGraphSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinGraph SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconBitcoinGraphBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinGraph BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconBitcoinGraphStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinGraph StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sr sw"
...
export const IconBitcoinGraphSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinGraph SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const iconPackOfBitcoinGraph: TheIconSelfPack = [
  'BitcoinGraph',
  IconBitcoinGraphStrokeRounded,
  IconBitcoinGraphDuotoneRounded,
  IconBitcoinGraphTwotoneRounded,
  IconBitcoinGraphSolidRounded,
  IconBitcoinGraphBulkRounded,
  IconBitcoinGraphStrokeSharp,
  IconBitcoinGraphSolidSharp,
];