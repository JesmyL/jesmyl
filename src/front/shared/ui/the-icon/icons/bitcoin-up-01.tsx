...
export const IconBitcoinUp01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinUp01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBitcoinUp01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinUp01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconBitcoinUp01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinUp01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconBitcoinUp01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinUp01 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconBitcoinUp01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinUp01 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconBitcoinUp01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinUp01 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBitcoinUp01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinUp01 SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfBitcoinUp01: TheIconSelfPack = [
  'BitcoinUp01',
  IconBitcoinUp01StrokeRounded,
  IconBitcoinUp01DuotoneRounded,
  IconBitcoinUp01TwotoneRounded,
  IconBitcoinUp01SolidRounded,
  IconBitcoinUp01BulkRounded,
  IconBitcoinUp01StrokeSharp,
  IconBitcoinUp01SolidSharp,
];