...
export const IconLaptopAddStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopAdd StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconLaptopAddDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopAdd DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconLaptopAddTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopAdd TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconLaptopAddSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopAdd SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconLaptopAddBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopAdd BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconLaptopAddStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopAdd StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfLaptopAdd: TheIconSelfPack = [
  'LaptopAdd',
  IconLaptopAddStrokeRounded,
  IconLaptopAddDuotoneRounded,
  IconLaptopAddTwotoneRounded,
  IconLaptopAddSolidRounded,
  IconLaptopAddBulkRounded,
  IconLaptopAddStrokeSharp,
  IconLaptopAddSolidSharp,
];