...
export const IconHouse01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="House01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHouse01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="House01 DuotoneRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconHouse01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="House01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfHouse01: TheIconSelfPack = [
  'House01',
  IconHouse01StrokeRounded,
  IconHouse01DuotoneRounded,
  IconHouse01TwotoneRounded,
  IconHouse01SolidRounded,
  IconHouse01BulkRounded,
  IconHouse01StrokeSharp,
  IconHouse01SolidSharp,
];