...
export const IconDataRecoveryStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DataRecovery StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDataRecoveryDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DataRecovery DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconDataRecoveryTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DataRecovery TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDataRecoverySolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DataRecovery SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconDataRecoveryBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DataRecovery BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d8}
...
export const IconDataRecoveryStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DataRecovery StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconDataRecoverySolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DataRecovery SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfDataRecovery: TheIconSelfPack = [
  'DataRecovery',
  IconDataRecoveryStrokeRounded,
  IconDataRecoveryDuotoneRounded,
  IconDataRecoveryTwotoneRounded,
  IconDataRecoverySolidRounded,
  IconDataRecoveryBulkRounded,
  IconDataRecoveryStrokeSharp,
  IconDataRecoverySolidSharp,
];