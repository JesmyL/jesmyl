...
export const IconAiSearchStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiSearch StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAiSearchDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiSearch DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconAiSearchTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiSearch TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAiSearchSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiSearch SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const iconPackOfAiSearch: TheIconSelfPack = [
  'AiSearch',
  IconAiSearchStrokeRounded,
  IconAiSearchDuotoneRounded,
  IconAiSearchTwotoneRounded,
  IconAiSearchSolidRounded,
  IconAiSearchBulkRounded,
  IconAiSearchStrokeSharp,
  IconAiSearchSolidSharp,
];