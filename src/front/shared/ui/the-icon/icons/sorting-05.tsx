...
export const IconSorting05StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sorting05 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSorting05DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sorting05 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSorting05TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sorting05 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconSorting05SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sorting05 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconSorting05BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sorting05 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconSorting05StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sorting05 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfSorting05: TheIconSelfPack = [
  'Sorting05',
  IconSorting05StrokeRounded,
  IconSorting05DuotoneRounded,
  IconSorting05TwotoneRounded,
  IconSorting05SolidRounded,
  IconSorting05BulkRounded,
  IconSorting05StrokeSharp,
  IconSorting05SolidSharp,
];