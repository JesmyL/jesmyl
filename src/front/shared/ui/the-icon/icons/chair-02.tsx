...
export const IconChair02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Chair02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconChair02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Chair02 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconChair02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Chair02 TwotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="s sr sw"
...
export const iconPackOfChair02: TheIconSelfPack = [
  'Chair02',
  IconChair02StrokeRounded,
  IconChair02DuotoneRounded,
  IconChair02TwotoneRounded,
  IconChair02SolidRounded,
  IconChair02BulkRounded,
  IconChair02StrokeSharp,
  IconChair02SolidSharp,
];