...
export const IconHome04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Home04 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconHome04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Home04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfHome04: TheIconSelfPack = [
  'Home04',
  IconHome04StrokeRounded,
  IconHome04DuotoneRounded,
  IconHome04TwotoneRounded,
  IconHome04SolidRounded,
  IconHome04BulkRounded,
  IconHome04StrokeSharp,
  IconHome04SolidSharp,
];