...
export const IconDiningTableStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiningTable StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDiningTableDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiningTable DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconDiningTableTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiningTable TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDiningTableSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiningTable SolidRounded"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const IconDiningTableBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiningTable BulkRounded"
    >
      <path 
        d={d.d12}
        i-c="f o7"
...
export const IconDiningTableStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiningTable StrokeSharp"
    >
      <path 
        d={d.d16}
        i-c="s sw"
...
export const IconDiningTableSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiningTable SolidSharp"
    >
      <path 
        d={d.d20}
        i-c="f"
...
export const iconPackOfDiningTable: TheIconSelfPack = [
  'DiningTable',
  IconDiningTableStrokeRounded,
  IconDiningTableDuotoneRounded,
  IconDiningTableTwotoneRounded,
  IconDiningTableSolidRounded,
  IconDiningTableBulkRounded,
  IconDiningTableStrokeSharp,
  IconDiningTableSolidSharp,
];