...
export const iconPackOfDice: TheIconSelfPack = [
  'Dice',
  IconDiceStrokeRounded,
  IconDiceDuotoneRounded,
  IconDiceTwotoneRounded,
  IconDiceSolidRounded,
  IconDiceBulkRounded,
  IconDiceStrokeSharp,
  IconDiceSolidSharp,
];