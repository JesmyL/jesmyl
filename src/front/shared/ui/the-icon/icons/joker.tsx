...
export const iconPackOfJoker: TheIconSelfPack = [
  'Joker',
  IconJokerStrokeRounded,
  IconJokerDuotoneRounded,
  IconJokerTwotoneRounded,
  IconJokerSolidRounded,
  IconJokerBulkRounded,
  IconJokerStrokeSharp,
  IconJokerSolidSharp,
];