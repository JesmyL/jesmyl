...
export const IconHome06DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Home06 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconHome06TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Home06 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfHome06: TheIconSelfPack = [
  'Home06',
  IconHome06StrokeRounded,
  IconHome06DuotoneRounded,
  IconHome06TwotoneRounded,
  IconHome06SolidRounded,
  IconHome06BulkRounded,
  IconHome06StrokeSharp,
  IconHome06SolidSharp,
];