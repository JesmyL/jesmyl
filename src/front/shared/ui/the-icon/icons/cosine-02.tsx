...
export const IconCosine02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cosine02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconCosine02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cosine02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconCosine02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cosine02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconCosine02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cosine02 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const iconPackOfCosine02: TheIconSelfPack = [
  'Cosine02',
  IconCosine02StrokeRounded,
  IconCosine02DuotoneRounded,
  IconCosine02TwotoneRounded,
  IconCosine02SolidRounded,
  IconCosine02BulkRounded,
  IconCosine02StrokeSharp,
  IconCosine02SolidSharp,
];