...
export const IconCallMinusStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CallMinus StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconCallMinusDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CallMinus DuotoneRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d3}
...
export const IconCallMinusTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CallMinus TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconCallMinusSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CallMinus SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconCallMinusBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CallMinus BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconCallMinusStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CallMinus StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sw"
...
export const iconPackOfCallMinus: TheIconSelfPack = [
  'CallMinus',
  IconCallMinusStrokeRounded,
  IconCallMinusDuotoneRounded,
  IconCallMinusTwotoneRounded,
  IconCallMinusSolidRounded,
  IconCallMinusBulkRounded,
  IconCallMinusStrokeSharp,
  IconCallMinusSolidSharp,
];