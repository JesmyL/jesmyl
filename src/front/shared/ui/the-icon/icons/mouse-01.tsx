...
export const IconMouse01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mouse01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMouse01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mouse01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconMouse01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mouse01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfMouse01: TheIconSelfPack = [
  'Mouse01',
  IconMouse01StrokeRounded,
  IconMouse01DuotoneRounded,
  IconMouse01TwotoneRounded,
  IconMouse01SolidRounded,
  IconMouse01BulkRounded,
  IconMouse01StrokeSharp,
  IconMouse01SolidSharp,
];