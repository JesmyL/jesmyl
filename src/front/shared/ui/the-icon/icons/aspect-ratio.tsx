...
export const IconAspectRatioStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AspectRatio StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconAspectRatioDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AspectRatio DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconAspectRatioTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AspectRatio TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconAspectRatioSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AspectRatio SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconAspectRatioBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AspectRatio BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconAspectRatioStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AspectRatio StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconAspectRatioSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AspectRatio SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfAspectRatio: TheIconSelfPack = [
  'AspectRatio',
  IconAspectRatioStrokeRounded,
  IconAspectRatioDuotoneRounded,
  IconAspectRatioTwotoneRounded,
  IconAspectRatioSolidRounded,
  IconAspectRatioBulkRounded,
  IconAspectRatioStrokeSharp,
  IconAspectRatioSolidSharp,
];