...
export const IconUserShield01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserShield01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserShield01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserShield01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconUserShield01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserShield01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserShield01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserShield01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconUserShield01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserShield01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconUserShield01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserShield01 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sw"
...
export const IconUserShield01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserShield01 SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="f"
...
export const iconPackOfUserShield01: TheIconSelfPack = [
  'UserShield01',
  IconUserShield01StrokeRounded,
  IconUserShield01DuotoneRounded,
  IconUserShield01TwotoneRounded,
  IconUserShield01SolidRounded,
  IconUserShield01BulkRounded,
  IconUserShield01StrokeSharp,
  IconUserShield01SolidSharp,
];