...
export const IconBodySoapStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BodySoap StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBodySoapDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BodySoap DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconBodySoapTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BodySoap TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBodySoapSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BodySoap SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfBodySoap: TheIconSelfPack = [
  'BodySoap',
  IconBodySoapStrokeRounded,
  IconBodySoapDuotoneRounded,
  IconBodySoapTwotoneRounded,
  IconBodySoapSolidRounded,
  IconBodySoapBulkRounded,
  IconBodySoapStrokeSharp,
  IconBodySoapSolidSharp,
];