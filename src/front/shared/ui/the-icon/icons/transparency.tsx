...
export const IconTransparencyStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Transparency StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconTransparencyDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Transparency DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconTransparencyTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Transparency TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconTransparencySolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Transparency SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconTransparencyBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Transparency BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconTransparencyStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Transparency StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconTransparencySolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Transparency SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfTransparency: TheIconSelfPack = [
  'Transparency',
  IconTransparencyStrokeRounded,
  IconTransparencyDuotoneRounded,
  IconTransparencyTwotoneRounded,
  IconTransparencySolidRounded,
  IconTransparencyBulkRounded,
  IconTransparencyStrokeSharp,
  IconTransparencySolidSharp,
];