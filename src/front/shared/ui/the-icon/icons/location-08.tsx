...
export const IconLocation08StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location08 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLocation08DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location08 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLocation08TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location08 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconLocation08SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location08 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconLocation08BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location08 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconLocation08StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location08 StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const IconLocation08SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location08 SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfLocation08: TheIconSelfPack = [
  'Location08',
  IconLocation08StrokeRounded,
  IconLocation08DuotoneRounded,
  IconLocation08TwotoneRounded,
  IconLocation08SolidRounded,
  IconLocation08BulkRounded,
  IconLocation08StrokeSharp,
  IconLocation08SolidSharp,
];