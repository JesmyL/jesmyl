...
export const IconTextColorStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextColor StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconTextColorDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextColor DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconTextColorTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextColor TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconTextColorSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextColor SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconTextColorBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextColor BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconTextColorStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextColor StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfTextColor: TheIconSelfPack = [
  'TextColor',
  IconTextColorStrokeRounded,
  IconTextColorDuotoneRounded,
  IconTextColorTwotoneRounded,
  IconTextColorSolidRounded,
  IconTextColorBulkRounded,
  IconTextColorStrokeSharp,
  IconTextColorSolidSharp,
];