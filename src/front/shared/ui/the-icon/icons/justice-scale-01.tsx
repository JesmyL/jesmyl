...
export const IconJusticeScale01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="JusticeScale01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconJusticeScale01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="JusticeScale01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconJusticeScale01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="JusticeScale01 TwotoneRounded"
    >
      <path 
        d={d.d9}
        i-c="o7 s sj sr sw"
...
export const IconJusticeScale01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="JusticeScale01 SolidRounded"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const IconJusticeScale01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="JusticeScale01 BulkRounded"
    >
      <path 
        d={d.d16}
        i-c="c f fr o7"
...
export const IconJusticeScale01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="JusticeScale01 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconJusticeScale01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="JusticeScale01 SolidSharp"
    >
      <path 
        d={d.d21}
        i-c="c f fr"
...
export const iconPackOfJusticeScale01: TheIconSelfPack = [
  'JusticeScale01',
  IconJusticeScale01StrokeRounded,
  IconJusticeScale01DuotoneRounded,
  IconJusticeScale01TwotoneRounded,
  IconJusticeScale01SolidRounded,
  IconJusticeScale01BulkRounded,
  IconJusticeScale01StrokeSharp,
  IconJusticeScale01SolidSharp,
];