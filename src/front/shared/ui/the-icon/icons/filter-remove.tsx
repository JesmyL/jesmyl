...
export const IconFilterRemoveStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterRemove StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFilterRemoveDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterRemove DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconFilterRemoveTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterRemove TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFilterRemoveSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterRemove SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconFilterRemoveBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterRemove BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconFilterRemoveStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterRemove StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const IconFilterRemoveSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterRemove SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfFilterRemove: TheIconSelfPack = [
  'FilterRemove',
  IconFilterRemoveStrokeRounded,
  IconFilterRemoveDuotoneRounded,
  IconFilterRemoveTwotoneRounded,
  IconFilterRemoveSolidRounded,
  IconFilterRemoveBulkRounded,
  IconFilterRemoveStrokeSharp,
  IconFilterRemoveSolidSharp,
];