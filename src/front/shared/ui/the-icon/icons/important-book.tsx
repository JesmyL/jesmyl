...
export const IconImportantBookStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImportantBook StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconImportantBookDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImportantBook DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconImportantBookTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImportantBook TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconImportantBookSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImportantBook SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconImportantBookBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImportantBook BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconImportantBookStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImportantBook StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconImportantBookSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImportantBook SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfImportantBook: TheIconSelfPack = [
  'ImportantBook',
  IconImportantBookStrokeRounded,
  IconImportantBookDuotoneRounded,
  IconImportantBookTwotoneRounded,
  IconImportantBookSolidRounded,
  IconImportantBookBulkRounded,
  IconImportantBookStrokeSharp,
  IconImportantBookSolidSharp,
];