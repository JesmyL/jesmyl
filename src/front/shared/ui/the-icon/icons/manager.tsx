...
export const IconManagerStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Manager StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconManagerDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Manager DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconManagerTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Manager TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfManager: TheIconSelfPack = [
  'Manager',
  IconManagerStrokeRounded,
  IconManagerDuotoneRounded,
  IconManagerTwotoneRounded,
  IconManagerSolidRounded,
  IconManagerBulkRounded,
  IconManagerStrokeSharp,
  IconManagerSolidSharp,
];