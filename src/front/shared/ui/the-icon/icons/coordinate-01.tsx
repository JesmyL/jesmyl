...
export const IconCoordinate01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Coordinate01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCoordinate01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Coordinate01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="o7 s sr sw"
...
export const IconCoordinate01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Coordinate01 TwotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="o7 s sj sr sw"
...
export const IconCoordinate01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Coordinate01 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconCoordinate01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Coordinate01 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconCoordinate01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Coordinate01 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sw"
...
export const IconCoordinate01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Coordinate01 SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const iconPackOfCoordinate01: TheIconSelfPack = [
  'Coordinate01',
  IconCoordinate01StrokeRounded,
  IconCoordinate01DuotoneRounded,
  IconCoordinate01TwotoneRounded,
  IconCoordinate01SolidRounded,
  IconCoordinate01BulkRounded,
  IconCoordinate01StrokeSharp,
  IconCoordinate01SolidSharp,
];