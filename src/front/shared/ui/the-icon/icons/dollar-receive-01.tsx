...
export const IconDollarReceive01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DollarReceive01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDollarReceive01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DollarReceive01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="s sr sw"
...
export const IconDollarReceive01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DollarReceive01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDollarReceive01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DollarReceive01 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconDollarReceive01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DollarReceive01 BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr o7"
...
export const IconDollarReceive01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DollarReceive01 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconDollarReceive01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DollarReceive01 SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfDollarReceive01: TheIconSelfPack = [
  'DollarReceive01',
  IconDollarReceive01StrokeRounded,
  IconDollarReceive01DuotoneRounded,
  IconDollarReceive01TwotoneRounded,
  IconDollarReceive01SolidRounded,
  IconDollarReceive01BulkRounded,
  IconDollarReceive01StrokeSharp,
  IconDollarReceive01SolidSharp,
];