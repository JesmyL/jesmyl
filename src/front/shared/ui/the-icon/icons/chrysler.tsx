...
export const IconChryslerStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Chrysler StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconChryslerDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Chrysler DuotoneRounded"
    >
      <path 
        d={d.d10}
        i-c="f o7"
...
export const IconChryslerTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Chrysler TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconChryslerSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Chrysler SolidRounded"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfChrysler: TheIconSelfPack = [
  'Chrysler',
  IconChryslerStrokeRounded,
  IconChryslerDuotoneRounded,
  IconChryslerTwotoneRounded,
  IconChryslerSolidRounded,
  IconChryslerBulkRounded,
  IconChryslerStrokeSharp,
  IconChryslerSolidSharp,
];