...
export const IconForrstDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Forrst DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconForrstTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Forrst TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfForrst: TheIconSelfPack = [
  'Forrst',
  IconForrstStrokeRounded,
  IconForrstDuotoneRounded,
  IconForrstTwotoneRounded,
  IconForrstSolidRounded,
  IconForrstBulkRounded,
  IconForrstStrokeSharp,
  IconForrstSolidSharp,
];