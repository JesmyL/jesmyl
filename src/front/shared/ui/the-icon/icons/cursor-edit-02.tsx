...
export const IconCursorEdit02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorEdit02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconCursorEdit02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorEdit02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconCursorEdit02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorEdit02 TwotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="s sw"
...
export const IconCursorEdit02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorEdit02 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconCursorEdit02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorEdit02 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconCursorEdit02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorEdit02 StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const IconCursorEdit02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorEdit02 SolidSharp"
    >
      <path 
        d={d.d16}
        i-c="f"
...
export const iconPackOfCursorEdit02: TheIconSelfPack = [
  'CursorEdit02',
  IconCursorEdit02StrokeRounded,
  IconCursorEdit02DuotoneRounded,
  IconCursorEdit02TwotoneRounded,
  IconCursorEdit02SolidRounded,
  IconCursorEdit02BulkRounded,
  IconCursorEdit02StrokeSharp,
  IconCursorEdit02SolidSharp,
];