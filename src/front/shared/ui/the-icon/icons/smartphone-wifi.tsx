...
export const IconSmartphoneWifiStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmartphoneWifi StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSmartphoneWifiDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmartphoneWifi DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconSmartphoneWifiTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmartphoneWifi TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSmartphoneWifiSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmartphoneWifi SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconSmartphoneWifiBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmartphoneWifi BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconSmartphoneWifiStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmartphoneWifi StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconSmartphoneWifiSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmartphoneWifi SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfSmartphoneWifi: TheIconSelfPack = [
  'SmartphoneWifi',
  IconSmartphoneWifiStrokeRounded,
  IconSmartphoneWifiDuotoneRounded,
  IconSmartphoneWifiTwotoneRounded,
  IconSmartphoneWifiSolidRounded,
  IconSmartphoneWifiBulkRounded,
  IconSmartphoneWifiStrokeSharp,
  IconSmartphoneWifiSolidSharp,
];