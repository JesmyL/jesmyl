...
export const IconSwipeLeft04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeLeft04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSwipeLeft04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeLeft04 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconSwipeLeft04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeLeft04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSwipeLeft04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeLeft04 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconSwipeLeft04BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeLeft04 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconSwipeLeft04StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeLeft04 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const IconSwipeLeft04SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeLeft04 SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const iconPackOfSwipeLeft04: TheIconSelfPack = [
  'SwipeLeft04',
  IconSwipeLeft04StrokeRounded,
  IconSwipeLeft04DuotoneRounded,
  IconSwipeLeft04TwotoneRounded,
  IconSwipeLeft04SolidRounded,
  IconSwipeLeft04BulkRounded,
  IconSwipeLeft04StrokeSharp,
  IconSwipeLeft04SolidSharp,
];