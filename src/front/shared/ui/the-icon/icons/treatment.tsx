...
export const IconTreatmentStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Treatment StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconTreatmentDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Treatment DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconTreatmentTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Treatment TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconTreatmentSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Treatment SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconTreatmentBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Treatment BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconTreatmentStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Treatment StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sw"
...
export const iconPackOfTreatment: TheIconSelfPack = [
  'Treatment',
  IconTreatmentStrokeRounded,
  IconTreatmentDuotoneRounded,
  IconTreatmentTwotoneRounded,
  IconTreatmentSolidRounded,
  IconTreatmentBulkRounded,
  IconTreatmentStrokeSharp,
  IconTreatmentSolidSharp,
];