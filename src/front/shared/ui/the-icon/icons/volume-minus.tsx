...
export const IconVolumeMinusStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VolumeMinus StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconVolumeMinusDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VolumeMinus DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconVolumeMinusTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VolumeMinus TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconVolumeMinusSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VolumeMinus SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconVolumeMinusBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VolumeMinus BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconVolumeMinusStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VolumeMinus StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const IconVolumeMinusSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VolumeMinus SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const iconPackOfVolumeMinus: TheIconSelfPack = [
  'VolumeMinus',
  IconVolumeMinusStrokeRounded,
  IconVolumeMinusDuotoneRounded,
  IconVolumeMinusTwotoneRounded,
  IconVolumeMinusSolidRounded,
  IconVolumeMinusBulkRounded,
  IconVolumeMinusStrokeSharp,
  IconVolumeMinusSolidSharp,
];