...
export const IconAiCloud01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiCloud01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAiCloud01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiCloud01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAiCloud01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiCloud01 TwotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="s sj sr sw"
...
export const IconAiCloud01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiCloud01 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconAiCloud01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiCloud01 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconAiCloud01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiCloud01 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfAiCloud01: TheIconSelfPack = [
  'AiCloud01',
  IconAiCloud01StrokeRounded,
  IconAiCloud01DuotoneRounded,
  IconAiCloud01TwotoneRounded,
  IconAiCloud01SolidRounded,
  IconAiCloud01BulkRounded,
  IconAiCloud01StrokeSharp,
  IconAiCloud01SolidSharp,
];