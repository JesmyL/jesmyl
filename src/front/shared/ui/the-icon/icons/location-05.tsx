...
export const IconLocation05StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location05 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLocation05DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location05 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconLocation05TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location05 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLocation05SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location05 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconLocation05BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location05 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconLocation05StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location05 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLocation05SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location05 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfLocation05: TheIconSelfPack = [
  'Location05',
  IconLocation05StrokeRounded,
  IconLocation05DuotoneRounded,
  IconLocation05TwotoneRounded,
  IconLocation05SolidRounded,
  IconLocation05BulkRounded,
  IconLocation05StrokeSharp,
  IconLocation05SolidSharp,
];