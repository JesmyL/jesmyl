...
export const IconSolarPanel01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SolarPanel01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSolarPanel01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SolarPanel01 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconSolarPanel01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SolarPanel01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSolarPanel01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SolarPanel01 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconSolarPanel01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SolarPanel01 BulkRounded"
    >
      <path 
        d={d.d10}
        i-c="f o7"
...
export const IconSolarPanel01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SolarPanel01 StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sj sr sw"
...
export const IconSolarPanel01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SolarPanel01 SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const iconPackOfSolarPanel01: TheIconSelfPack = [
  'SolarPanel01',
  IconSolarPanel01StrokeRounded,
  IconSolarPanel01DuotoneRounded,
  IconSolarPanel01TwotoneRounded,
  IconSolarPanel01SolidRounded,
  IconSolarPanel01BulkRounded,
  IconSolarPanel01StrokeSharp,
  IconSolarPanel01SolidSharp,
];