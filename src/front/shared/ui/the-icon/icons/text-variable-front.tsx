...
export const IconTextVariableFrontStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextVariableFront StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconTextVariableFrontDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextVariableFront DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="19"
...
export const IconTextVariableFrontTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextVariableFront TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconTextVariableFrontSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextVariableFront SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconTextVariableFrontBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextVariableFront BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr o7"
...
export const IconTextVariableFrontStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextVariableFront StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const IconTextVariableFrontSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextVariableFront SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="f"
...
export const iconPackOfTextVariableFront: TheIconSelfPack = [
  'TextVariableFront',
  IconTextVariableFrontStrokeRounded,
  IconTextVariableFrontDuotoneRounded,
  IconTextVariableFrontTwotoneRounded,
  IconTextVariableFrontSolidRounded,
  IconTextVariableFrontBulkRounded,
  IconTextVariableFrontStrokeSharp,
  IconTextVariableFrontSolidSharp,
];