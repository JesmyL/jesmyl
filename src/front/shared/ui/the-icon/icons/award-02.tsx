...
export const IconAward02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Award02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAward02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Award02 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconAward02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Award02 TwotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="s sj sr sw"
...
export const iconPackOfAward02: TheIconSelfPack = [
  'Award02',
  IconAward02StrokeRounded,
  IconAward02DuotoneRounded,
  IconAward02TwotoneRounded,
  IconAward02SolidRounded,
  IconAward02BulkRounded,
  IconAward02StrokeSharp,
  IconAward02SolidSharp,
];