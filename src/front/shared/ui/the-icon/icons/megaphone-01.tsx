...
export const IconMegaphone01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Megaphone01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMegaphone01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Megaphone01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconMegaphone01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Megaphone01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMegaphone01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Megaphone01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconMegaphone01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Megaphone01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconMegaphone01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Megaphone01 StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sw"
...
export const IconMegaphone01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Megaphone01 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const iconPackOfMegaphone01: TheIconSelfPack = [
  'Megaphone01',
  IconMegaphone01StrokeRounded,
  IconMegaphone01DuotoneRounded,
  IconMegaphone01TwotoneRounded,
  IconMegaphone01SolidRounded,
  IconMegaphone01BulkRounded,
  IconMegaphone01StrokeSharp,
  IconMegaphone01SolidSharp,
];