...
export const IconMapPinDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapPin DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconMapPinTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapPin TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfMapPin: TheIconSelfPack = [
  'MapPin',
  IconMapPinStrokeRounded,
  IconMapPinDuotoneRounded,
  IconMapPinTwotoneRounded,
  IconMapPinSolidRounded,
  IconMapPinBulkRounded,
  IconMapPinStrokeSharp,
  IconMapPinSolidSharp,
];