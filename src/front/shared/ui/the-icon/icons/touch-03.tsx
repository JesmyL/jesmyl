...
export const IconTouch03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Touch03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTouch03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Touch03 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconTouch03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Touch03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfTouch03: TheIconSelfPack = [
  'Touch03',
  IconTouch03StrokeRounded,
  IconTouch03DuotoneRounded,
  IconTouch03TwotoneRounded,
  IconTouch03SolidRounded,
  IconTouch03BulkRounded,
  IconTouch03StrokeSharp,
  IconTouch03SolidSharp,
];