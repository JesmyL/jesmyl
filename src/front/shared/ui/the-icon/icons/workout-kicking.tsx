...
export const IconWorkoutKickingStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkoutKicking StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWorkoutKickingDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkoutKicking DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWorkoutKickingTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkoutKicking TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconWorkoutKickingSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkoutKicking SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconWorkoutKickingBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkoutKicking BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconWorkoutKickingStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkoutKicking StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconWorkoutKickingSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkoutKicking SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const iconPackOfWorkoutKicking: TheIconSelfPack = [
  'WorkoutKicking',
  IconWorkoutKickingStrokeRounded,
  IconWorkoutKickingDuotoneRounded,
  IconWorkoutKickingTwotoneRounded,
  IconWorkoutKickingSolidRounded,
  IconWorkoutKickingBulkRounded,
  IconWorkoutKickingStrokeSharp,
  IconWorkoutKickingSolidSharp,
];