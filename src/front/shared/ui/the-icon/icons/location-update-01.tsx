...
export const IconLocationUpdate01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationUpdate01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLocationUpdate01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationUpdate01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconLocationUpdate01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationUpdate01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconLocationUpdate01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationUpdate01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconLocationUpdate01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationUpdate01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconLocationUpdate01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationUpdate01 StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sw"
...
export const IconLocationUpdate01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationUpdate01 SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfLocationUpdate01: TheIconSelfPack = [
  'LocationUpdate01',
  IconLocationUpdate01StrokeRounded,
  IconLocationUpdate01DuotoneRounded,
  IconLocationUpdate01TwotoneRounded,
  IconLocationUpdate01SolidRounded,
  IconLocationUpdate01BulkRounded,
  IconLocationUpdate01StrokeSharp,
  IconLocationUpdate01SolidSharp,
];