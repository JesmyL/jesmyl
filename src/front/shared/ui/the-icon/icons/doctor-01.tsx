...
export const IconDoctor01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Doctor01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDoctor01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Doctor01 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconDoctor01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Doctor01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDoctor01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Doctor01 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const iconPackOfDoctor01: TheIconSelfPack = [
  'Doctor01',
  IconDoctor01StrokeRounded,
  IconDoctor01DuotoneRounded,
  IconDoctor01TwotoneRounded,
  IconDoctor01SolidRounded,
  IconDoctor01BulkRounded,
  IconDoctor01StrokeSharp,
  IconDoctor01SolidSharp,
];