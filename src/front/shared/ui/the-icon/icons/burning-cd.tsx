...
export const IconBurningCdStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BurningCd StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconBurningCdDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BurningCd DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconBurningCdTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BurningCd TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconBurningCdSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BurningCd SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconBurningCdBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BurningCd BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconBurningCdStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BurningCd StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sj sw"
...
export const iconPackOfBurningCd: TheIconSelfPack = [
  'BurningCd',
  IconBurningCdStrokeRounded,
  IconBurningCdDuotoneRounded,
  IconBurningCdTwotoneRounded,
  IconBurningCdSolidRounded,
  IconBurningCdBulkRounded,
  IconBurningCdStrokeSharp,
  IconBurningCdSolidSharp,
];