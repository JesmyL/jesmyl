...
export const IconArrowUpDownStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUpDown StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconArrowUpDownDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUpDown DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconArrowUpDownTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUpDown TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconArrowUpDownSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUpDown SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconArrowUpDownBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUpDown BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconArrowUpDownStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUpDown StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sw"
...
export const IconArrowUpDownSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUpDown SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfArrowUpDown: TheIconSelfPack = [
  'ArrowUpDown',
  IconArrowUpDownStrokeRounded,
  IconArrowUpDownDuotoneRounded,
  IconArrowUpDownTwotoneRounded,
  IconArrowUpDownSolidRounded,
  IconArrowUpDownBulkRounded,
  IconArrowUpDownStrokeSharp,
  IconArrowUpDownSolidSharp,
];