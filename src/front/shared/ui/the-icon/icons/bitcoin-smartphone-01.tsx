...
export const IconBitcoinSmartphone01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinSmartphone01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconBitcoinSmartphone01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinSmartphone01 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconBitcoinSmartphone01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinSmartphone01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconBitcoinSmartphone01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinSmartphone01 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconBitcoinSmartphone01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinSmartphone01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconBitcoinSmartphone01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinSmartphone01 StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sw"
...
export const IconBitcoinSmartphone01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinSmartphone01 SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfBitcoinSmartphone01: TheIconSelfPack = [
  'BitcoinSmartphone01',
  IconBitcoinSmartphone01StrokeRounded,
  IconBitcoinSmartphone01DuotoneRounded,
  IconBitcoinSmartphone01TwotoneRounded,
  IconBitcoinSmartphone01SolidRounded,
  IconBitcoinSmartphone01BulkRounded,
  IconBitcoinSmartphone01StrokeSharp,
  IconBitcoinSmartphone01SolidSharp,
];