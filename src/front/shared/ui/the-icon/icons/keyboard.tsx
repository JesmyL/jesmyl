...
export const IconKeyboardStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Keyboard StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconKeyboardDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Keyboard DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconKeyboardTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Keyboard TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconKeyboardSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Keyboard SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfKeyboard: TheIconSelfPack = [
  'Keyboard',
  IconKeyboardStrokeRounded,
  IconKeyboardDuotoneRounded,
  IconKeyboardTwotoneRounded,
  IconKeyboardSolidRounded,
  IconKeyboardBulkRounded,
  IconKeyboardStrokeSharp,
  IconKeyboardSolidSharp,
];