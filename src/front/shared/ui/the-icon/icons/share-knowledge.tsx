...
export const IconShareKnowledgeStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShareKnowledge StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShareKnowledgeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShareKnowledge DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconShareKnowledgeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShareKnowledge TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShareKnowledgeSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShareKnowledge SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconShareKnowledgeBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShareKnowledge BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d7}
...
export const IconShareKnowledgeStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShareKnowledge StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconShareKnowledgeSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShareKnowledge SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="f"
...
export const iconPackOfShareKnowledge: TheIconSelfPack = [
  'ShareKnowledge',
  IconShareKnowledgeStrokeRounded,
  IconShareKnowledgeDuotoneRounded,
  IconShareKnowledgeTwotoneRounded,
  IconShareKnowledgeSolidRounded,
  IconShareKnowledgeBulkRounded,
  IconShareKnowledgeStrokeSharp,
  IconShareKnowledgeSolidSharp,
];