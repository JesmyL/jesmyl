...
export const IconConfusedStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Confused StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconConfusedDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Confused DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconConfusedTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Confused TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconConfusedSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Confused SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const iconPackOfConfused: TheIconSelfPack = [
  'Confused',
  IconConfusedStrokeRounded,
  IconConfusedDuotoneRounded,
  IconConfusedTwotoneRounded,
  IconConfusedSolidRounded,
  IconConfusedBulkRounded,
  IconConfusedStrokeSharp,
  IconConfusedSolidSharp,
];