...
export const IconPacman02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pacman02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPacman02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pacman02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconPacman02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pacman02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPacman02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pacman02 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const iconPackOfPacman02: TheIconSelfPack = [
  'Pacman02',
  IconPacman02StrokeRounded,
  IconPacman02DuotoneRounded,
  IconPacman02TwotoneRounded,
  IconPacman02SolidRounded,
  IconPacman02BulkRounded,
  IconPacman02StrokeSharp,
  IconPacman02SolidSharp,
];