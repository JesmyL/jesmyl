...
export const IconFolderDownloadStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderDownload StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFolderDownloadDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderDownload DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconFolderDownloadTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderDownload TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFolderDownloadSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderDownload SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconFolderDownloadBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderDownload BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconFolderDownloadStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderDownload StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const IconFolderDownloadSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderDownload SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfFolderDownload: TheIconSelfPack = [
  'FolderDownload',
  IconFolderDownloadStrokeRounded,
  IconFolderDownloadDuotoneRounded,
  IconFolderDownloadTwotoneRounded,
  IconFolderDownloadSolidRounded,
  IconFolderDownloadBulkRounded,
  IconFolderDownloadStrokeSharp,
  IconFolderDownloadSolidSharp,
];