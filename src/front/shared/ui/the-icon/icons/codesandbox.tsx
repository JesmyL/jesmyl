...
export const IconCodesandboxStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Codesandbox StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCodesandboxDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Codesandbox DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconCodesandboxTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Codesandbox TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCodesandboxSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Codesandbox SolidRounded"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const IconCodesandboxBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Codesandbox BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d11}
...
export const IconCodesandboxStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Codesandbox StrokeSharp"
    >
      <path 
        d={d.d17}
        i-c="s sj sw"
...
export const IconCodesandboxSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Codesandbox SolidSharp"
    >
      <path 
        d={d.d21}
        i-c="f"
...
export const iconPackOfCodesandbox: TheIconSelfPack = [
  'Codesandbox',
  IconCodesandboxStrokeRounded,
  IconCodesandboxDuotoneRounded,
  IconCodesandboxTwotoneRounded,
  IconCodesandboxSolidRounded,
  IconCodesandboxBulkRounded,
  IconCodesandboxStrokeSharp,
  IconCodesandboxSolidSharp,
];