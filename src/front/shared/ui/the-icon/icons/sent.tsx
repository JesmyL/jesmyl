...
export const iconPackOfSent: TheIconSelfPack = [
  ...
  IconSentDuotoneRounded,
  IconSentTwotoneRounded,
  IconSentSolidRounded,
  IconSentBulkRounded,
  IconSentStrokeSharp,
  IconSentSolidSharp,
];