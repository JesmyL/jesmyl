...
export const IconTreadmill01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Treadmill01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconTreadmill01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Treadmill01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconTreadmill01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Treadmill01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconTreadmill01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Treadmill01 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconTreadmill01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Treadmill01 BulkRounded"
    >
      <path 
        d={d.d12}
        i-c="f o7"
...
export const IconTreadmill01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Treadmill01 StrokeSharp"
    >
      <path 
        d={d.d15}
        i-c="s sj sw"
...
export const IconTreadmill01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Treadmill01 SolidSharp"
    >
      <path 
        d={d.d21}
        i-c="c f fr"
...
export const iconPackOfTreadmill01: TheIconSelfPack = [
  'Treadmill01',
  IconTreadmill01StrokeRounded,
  IconTreadmill01DuotoneRounded,
  IconTreadmill01TwotoneRounded,
  IconTreadmill01SolidRounded,
  IconTreadmill01BulkRounded,
  IconTreadmill01StrokeSharp,
  IconTreadmill01SolidSharp,
];