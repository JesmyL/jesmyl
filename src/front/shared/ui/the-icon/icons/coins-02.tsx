...
export const IconCoins02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Coins02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconCoins02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Coins02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconCoins02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Coins02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfCoins02: TheIconSelfPack = [
  'Coins02',
  IconCoins02StrokeRounded,
  IconCoins02DuotoneRounded,
  IconCoins02TwotoneRounded,
  IconCoins02SolidRounded,
  IconCoins02BulkRounded,
  IconCoins02StrokeSharp,
  IconCoins02SolidSharp,
];