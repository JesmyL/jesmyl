...
export const IconMailBlock01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailBlock01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMailBlock01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailBlock01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconMailBlock01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailBlock01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMailBlock01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailBlock01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconMailBlock01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailBlock01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconMailBlock01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailBlock01 StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconMailBlock01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailBlock01 SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfMailBlock01: TheIconSelfPack = [
  'MailBlock01',
  IconMailBlock01StrokeRounded,
  IconMailBlock01DuotoneRounded,
  IconMailBlock01TwotoneRounded,
  IconMailBlock01SolidRounded,
  IconMailBlock01BulkRounded,
  IconMailBlock01StrokeSharp,
  IconMailBlock01SolidSharp,
];