...
export const IconMore02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="More02 DuotoneRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d3}
...
export const IconMore02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="More02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfMore02: TheIconSelfPack = [
  'More02',
  IconMore02StrokeRounded,
  IconMore02DuotoneRounded,
  IconMore02TwotoneRounded,
  IconMore02SolidRounded,
  IconMore02BulkRounded,
  IconMore02StrokeSharp,
  IconMore02SolidSharp,
];