...
export const iconPackOfMetro: TheIconSelfPack = [
  'Metro',
  IconMetroStrokeRounded,
  IconMetroDuotoneRounded,
  IconMetroTwotoneRounded,
  IconMetroSolidRounded,
  IconMetroBulkRounded,
  IconMetroStrokeSharp,
  IconMetroSolidSharp,
];