...
export const IconPiCircleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PiCircle StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconPiCircleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PiCircle DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconPiCircleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PiCircle TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconPiCircleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PiCircle SolidRounded"
    >
      <path 
        d={d.d2}
        i-c="c f fr"
...
export const iconPackOfPiCircle: TheIconSelfPack = [
  'PiCircle',
  IconPiCircleStrokeRounded,
  IconPiCircleDuotoneRounded,
  IconPiCircleTwotoneRounded,
  IconPiCircleSolidRounded,
  IconPiCircleBulkRounded,
  IconPiCircleStrokeSharp,
  IconPiCircleSolidSharp,
];