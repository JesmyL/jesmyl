...
export const IconPointingLeft04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PointingLeft04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPointingLeft04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PointingLeft04 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconPointingLeft04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PointingLeft04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPointingLeft04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PointingLeft04 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconPointingLeft04BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PointingLeft04 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconPointingLeft04StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PointingLeft04 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const IconPointingLeft04SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PointingLeft04 SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const iconPackOfPointingLeft04: TheIconSelfPack = [
  'PointingLeft04',
  IconPointingLeft04StrokeRounded,
  IconPointingLeft04DuotoneRounded,
  IconPointingLeft04TwotoneRounded,
  IconPointingLeft04SolidRounded,
  IconPointingLeft04BulkRounded,
  IconPointingLeft04StrokeSharp,
  IconPointingLeft04SolidSharp,
];