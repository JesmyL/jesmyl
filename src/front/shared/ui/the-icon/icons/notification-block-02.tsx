...
export const IconNotificationBlock02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationBlock02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconNotificationBlock02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationBlock02 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconNotificationBlock02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationBlock02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconNotificationBlock02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationBlock02 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconNotificationBlock02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationBlock02 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconNotificationBlock02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationBlock02 StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const IconNotificationBlock02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationBlock02 SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfNotificationBlock02: TheIconSelfPack = [
  'NotificationBlock02',
  IconNotificationBlock02StrokeRounded,
  IconNotificationBlock02DuotoneRounded,
  IconNotificationBlock02TwotoneRounded,
  IconNotificationBlock02SolidRounded,
  IconNotificationBlock02BulkRounded,
  IconNotificationBlock02StrokeSharp,
  IconNotificationBlock02SolidSharp,
];