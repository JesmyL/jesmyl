...
export const IconPresentation06StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation06 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPresentation06DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation06 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconPresentation06TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation06 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPresentation06SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation06 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconPresentation06BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation06 BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconPresentation06StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation06 StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sw"
...
export const IconPresentation06SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation06 SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="f"
...
export const iconPackOfPresentation06: TheIconSelfPack = [
  'Presentation06',
  IconPresentation06StrokeRounded,
  IconPresentation06DuotoneRounded,
  IconPresentation06TwotoneRounded,
  IconPresentation06SolidRounded,
  IconPresentation06BulkRounded,
  IconPresentation06StrokeSharp,
  IconPresentation06SolidSharp,
];