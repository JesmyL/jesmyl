...
export const IconEraserAddStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EraserAdd StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconEraserAddDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EraserAdd DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconEraserAddTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EraserAdd TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconEraserAddSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EraserAdd SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconEraserAddBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EraserAdd BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconEraserAddStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EraserAdd StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const iconPackOfEraserAdd: TheIconSelfPack = [
  'EraserAdd',
  IconEraserAddStrokeRounded,
  IconEraserAddDuotoneRounded,
  IconEraserAddTwotoneRounded,
  IconEraserAddSolidRounded,
  IconEraserAddBulkRounded,
  IconEraserAddStrokeSharp,
  IconEraserAddSolidSharp,
];