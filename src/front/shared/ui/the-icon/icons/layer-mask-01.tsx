...
export const IconLayerMask01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayerMask01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLayerMask01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayerMask01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o1"
...
export const IconLayerMask01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayerMask01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLayerMask01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayerMask01 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconLayerMask01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayerMask01 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconLayerMask01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayerMask01 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconLayerMask01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayerMask01 SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfLayerMask01: TheIconSelfPack = [
  'LayerMask01',
  IconLayerMask01StrokeRounded,
  IconLayerMask01DuotoneRounded,
  IconLayerMask01TwotoneRounded,
  IconLayerMask01SolidRounded,
  IconLayerMask01BulkRounded,
  IconLayerMask01StrokeSharp,
  IconLayerMask01SolidSharp,
];