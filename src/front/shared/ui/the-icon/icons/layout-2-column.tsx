...
export const IconLayout2ColumnStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout2Column StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLayout2ColumnDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout2Column DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconLayout2ColumnTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout2Column TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLayout2ColumnSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout2Column SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconLayout2ColumnBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout2Column BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr o7"
...
export const IconLayout2ColumnStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout2Column StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sj sw"
...
export const IconLayout2ColumnSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout2Column SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const iconPackOfLayout2Column: TheIconSelfPack = [
  'Layout2Column',
  IconLayout2ColumnStrokeRounded,
  IconLayout2ColumnDuotoneRounded,
  IconLayout2ColumnTwotoneRounded,
  IconLayout2ColumnSolidRounded,
  IconLayout2ColumnBulkRounded,
  IconLayout2ColumnStrokeSharp,
  IconLayout2ColumnSolidSharp,
];