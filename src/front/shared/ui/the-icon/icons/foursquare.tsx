...
export const IconFoursquareStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Foursquare StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconFoursquareDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Foursquare DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconFoursquareTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Foursquare TwotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="s sj sw"
...
export const IconFoursquareSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Foursquare SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconFoursquareBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Foursquare BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconFoursquareStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Foursquare StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconFoursquareSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Foursquare SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfFoursquare: TheIconSelfPack = [
  'Foursquare',
  IconFoursquareStrokeRounded,
  IconFoursquareDuotoneRounded,
  IconFoursquareTwotoneRounded,
  IconFoursquareSolidRounded,
  IconFoursquareBulkRounded,
  IconFoursquareStrokeSharp,
  IconFoursquareSolidSharp,
];