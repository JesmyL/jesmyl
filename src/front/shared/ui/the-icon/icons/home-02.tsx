...
export const IconHome02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Home02 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconHome02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Home02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const iconPackOfHome02: TheIconSelfPack = [
  'Home02',
  IconHome02StrokeRounded,
  IconHome02DuotoneRounded,
  IconHome02TwotoneRounded,
  IconHome02SolidRounded,
  IconHome02BulkRounded,
  IconHome02StrokeSharp,
  IconHome02SolidSharp,
];