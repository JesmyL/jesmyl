...
export const IconDownload02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDownload02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download02 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconDownload02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDownload02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download02 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconDownload02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download02 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconDownload02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download02 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const IconDownload02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download02 SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfDownload02: TheIconSelfPack = [
  'Download02',
  IconDownload02StrokeRounded,
  IconDownload02DuotoneRounded,
  IconDownload02TwotoneRounded,
  IconDownload02SolidRounded,
  IconDownload02BulkRounded,
  IconDownload02StrokeSharp,
  IconDownload02SolidSharp,
];