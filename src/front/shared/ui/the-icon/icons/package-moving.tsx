...
export const IconPackageMovingStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PackageMoving StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPackageMovingDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PackageMoving DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconPackageMovingTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PackageMoving TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPackageMovingSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PackageMoving SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconPackageMovingBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PackageMoving BulkRounded"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const IconPackageMovingStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PackageMoving StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sj sr sw"
...
export const IconPackageMovingSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PackageMoving SolidSharp"
    >
      <path 
        d={d.d18}
        i-c="c f fr"
...
export const iconPackOfPackageMoving: TheIconSelfPack = [
  'PackageMoving',
  IconPackageMovingStrokeRounded,
  IconPackageMovingDuotoneRounded,
  IconPackageMovingTwotoneRounded,
  IconPackageMovingSolidRounded,
  IconPackageMovingBulkRounded,
  IconPackageMovingStrokeSharp,
  IconPackageMovingSolidSharp,
];