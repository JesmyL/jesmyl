...
export const IconRelieved01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Relieved01 StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconRelieved01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Relieved01 DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconRelieved01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Relieved01 TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconRelieved01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Relieved01 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconRelieved01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Relieved01 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconRelieved01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Relieved01 StrokeSharp"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconRelieved01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Relieved01 SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfRelieved01: TheIconSelfPack = [
  'Relieved01',
  IconRelieved01StrokeRounded,
  IconRelieved01DuotoneRounded,
  IconRelieved01TwotoneRounded,
  IconRelieved01SolidRounded,
  IconRelieved01BulkRounded,
  IconRelieved01StrokeSharp,
  IconRelieved01SolidSharp,
];