...
export const IconAlignLeftStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignLeft StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAlignLeftDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignLeft DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconAlignLeftTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignLeft TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAlignLeftSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignLeft SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconAlignLeftBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignLeft BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconAlignLeftStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignLeft StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sr sw"
...
export const iconPackOfAlignLeft: TheIconSelfPack = [
  'AlignLeft',
  IconAlignLeftStrokeRounded,
  IconAlignLeftDuotoneRounded,
  IconAlignLeftTwotoneRounded,
  IconAlignLeftSolidRounded,
  IconAlignLeftBulkRounded,
  IconAlignLeftStrokeSharp,
  IconAlignLeftSolidSharp,
];