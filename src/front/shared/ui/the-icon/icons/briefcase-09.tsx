...
export const IconBriefcase09StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase09 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBriefcase09DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase09 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconBriefcase09TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase09 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconBriefcase09SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase09 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconBriefcase09BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase09 BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d11}
...
export const IconBriefcase09StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase09 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBriefcase09SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase09 SolidSharp"
    >
      <path 
        d={d.d16}
        i-c="f"
...
export const iconPackOfBriefcase09: TheIconSelfPack = [
  'Briefcase09',
  IconBriefcase09StrokeRounded,
  IconBriefcase09DuotoneRounded,
  IconBriefcase09TwotoneRounded,
  IconBriefcase09SolidRounded,
  IconBriefcase09BulkRounded,
  IconBriefcase09StrokeSharp,
  IconBriefcase09SolidSharp,
];