...
export const IconFolderUnknownStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderUnknown StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFolderUnknownDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderUnknown DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconFolderUnknownTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderUnknown TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFolderUnknownSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderUnknown SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconFolderUnknownBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderUnknown BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconFolderUnknownStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderUnknown StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const IconFolderUnknownSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderUnknown SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfFolderUnknown: TheIconSelfPack = [
  'FolderUnknown',
  IconFolderUnknownStrokeRounded,
  IconFolderUnknownDuotoneRounded,
  IconFolderUnknownTwotoneRounded,
  IconFolderUnknownSolidRounded,
  IconFolderUnknownBulkRounded,
  IconFolderUnknownStrokeSharp,
  IconFolderUnknownSolidSharp,
];