...
export const IconHangingClockStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HangingClock StrokeRounded"
    >
      <circle 
        cx="17.5"
        cy="4.5"
...
export const IconHangingClockDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HangingClock DuotoneRounded"
    >
      <circle 
        cx="17.5"
        cy="4.5"
...
export const IconHangingClockTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HangingClock TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sb sr sw"
...
export const IconHangingClockSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HangingClock SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconHangingClockBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HangingClock BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconHangingClockStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HangingClock StrokeSharp"
    >
      <circle 
        cx="17.5"
        cy="4.5"
...
export const IconHangingClockSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HangingClock SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const iconPackOfHangingClock: TheIconSelfPack = [
  'HangingClock',
  IconHangingClockStrokeRounded,
  IconHangingClockDuotoneRounded,
  IconHangingClockTwotoneRounded,
  IconHangingClockSolidRounded,
  IconHangingClockBulkRounded,
  IconHangingClockStrokeSharp,
  IconHangingClockSolidSharp,
];