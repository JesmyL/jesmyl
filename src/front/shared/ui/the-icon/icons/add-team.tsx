...
export const IconAddTeamStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AddTeam StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconAddTeamDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AddTeam DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconAddTeamTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AddTeam TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const iconPackOfAddTeam: TheIconSelfPack = [
  'AddTeam',
  IconAddTeamStrokeRounded,
  IconAddTeamDuotoneRounded,
  IconAddTeamTwotoneRounded,
  IconAddTeamSolidRounded,
  IconAddTeamBulkRounded,
  IconAddTeamStrokeSharp,
  IconAddTeamSolidSharp,
];