...
export const IconTextSubscriptStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextSubscript StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTextSubscriptDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextSubscript DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="o7 s sr sw"
...
export const IconTextSubscriptTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextSubscript TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTextSubscriptSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextSubscript SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconTextSubscriptBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextSubscript BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr o7"
...
export const IconTextSubscriptStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextSubscript StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconTextSubscriptSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextSubscript SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfTextSubscript: TheIconSelfPack = [
  'TextSubscript',
  IconTextSubscriptStrokeRounded,
  IconTextSubscriptDuotoneRounded,
  IconTextSubscriptTwotoneRounded,
  IconTextSubscriptSolidRounded,
  IconTextSubscriptBulkRounded,
  IconTextSubscriptStrokeSharp,
  IconTextSubscriptSolidSharp,
];