...
export const IconSidebarRightStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarRight StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSidebarRightDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarRight DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconSidebarRightTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarRight TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSidebarRightSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarRight SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconSidebarRightBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarRight BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconSidebarRightStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarRight StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconSidebarRightSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarRight SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfSidebarRight: TheIconSelfPack = [
  'SidebarRight',
  IconSidebarRightStrokeRounded,
  IconSidebarRightDuotoneRounded,
  IconSidebarRightTwotoneRounded,
  IconSidebarRightSolidRounded,
  IconSidebarRightBulkRounded,
  IconSidebarRightStrokeSharp,
  IconSidebarRightSolidSharp,
];