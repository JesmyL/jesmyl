...
export const IconRestaurant02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Restaurant02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRestaurant02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Restaurant02 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconRestaurant02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Restaurant02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRestaurant02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Restaurant02 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconRestaurant02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Restaurant02 BulkRounded"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const IconRestaurant02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Restaurant02 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s ss sw"
...
export const IconRestaurant02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Restaurant02 SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfRestaurant02: TheIconSelfPack = [
  'Restaurant02',
  IconRestaurant02StrokeRounded,
  IconRestaurant02DuotoneRounded,
  IconRestaurant02TwotoneRounded,
  IconRestaurant02SolidRounded,
  IconRestaurant02BulkRounded,
  IconRestaurant02StrokeSharp,
  IconRestaurant02SolidSharp,
];