...
export const IconMapsLocation01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapsLocation01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMapsLocation01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapsLocation01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMapsLocation01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapsLocation01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMapsLocation01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapsLocation01 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconMapsLocation01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapsLocation01 BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d7}
...
export const IconMapsLocation01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapsLocation01 StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sw"
...
export const IconMapsLocation01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapsLocation01 SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfMapsLocation01: TheIconSelfPack = [
  'MapsLocation01',
  IconMapsLocation01StrokeRounded,
  IconMapsLocation01DuotoneRounded,
  IconMapsLocation01TwotoneRounded,
  IconMapsLocation01SolidRounded,
  IconMapsLocation01BulkRounded,
  IconMapsLocation01StrokeSharp,
  IconMapsLocation01SolidSharp,
];