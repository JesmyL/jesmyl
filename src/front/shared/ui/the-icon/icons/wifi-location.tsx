...
export const IconWifiLocationStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WifiLocation StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWifiLocationDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WifiLocation DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconWifiLocationTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WifiLocation TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWifiLocationSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WifiLocation SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconWifiLocationBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WifiLocation BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconWifiLocationStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WifiLocation StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const IconWifiLocationSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WifiLocation SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfWifiLocation: TheIconSelfPack = [
  'WifiLocation',
  IconWifiLocationStrokeRounded,
  IconWifiLocationDuotoneRounded,
  IconWifiLocationTwotoneRounded,
  IconWifiLocationSolidRounded,
  IconWifiLocationBulkRounded,
  IconWifiLocationStrokeSharp,
  IconWifiLocationSolidSharp,
];