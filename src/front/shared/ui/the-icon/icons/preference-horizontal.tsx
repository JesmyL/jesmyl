...
export const IconPreferenceHorizontalStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PreferenceHorizontal StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPreferenceHorizontalDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PreferenceHorizontal DuotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconPreferenceHorizontalTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PreferenceHorizontal TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconPreferenceHorizontalSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PreferenceHorizontal SolidRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const IconPreferenceHorizontalBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PreferenceHorizontal BulkRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const IconPreferenceHorizontalStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PreferenceHorizontal StrokeSharp"
    >
      <path 
        d={d.d19}
        i-c="s sw"
...
export const IconPreferenceHorizontalSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PreferenceHorizontal SolidSharp"
    >
      <path 
        d={d.d25}
        i-c="f"
...
export const iconPackOfPreferenceHorizontal: TheIconSelfPack = [
  ...
  IconPreferenceHorizontalStrokeRounded,
  IconPreferenceHorizontalDuotoneRounded,
  IconPreferenceHorizontalTwotoneRounded,
  IconPreferenceHorizontalSolidRounded,
  IconPreferenceHorizontalBulkRounded,
  IconPreferenceHorizontalStrokeSharp,
  IconPreferenceHorizontalSolidSharp,
];