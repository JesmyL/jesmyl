...
export const IconLocation09StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location09 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconLocation09DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location09 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconLocation09TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location09 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconLocation09SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location09 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconLocation09BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location09 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconLocation09StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location09 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLocation09SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location09 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const iconPackOfLocation09: TheIconSelfPack = [
  'Location09',
  IconLocation09StrokeRounded,
  IconLocation09DuotoneRounded,
  IconLocation09TwotoneRounded,
  IconLocation09SolidRounded,
  IconLocation09BulkRounded,
  IconLocation09StrokeSharp,
  IconLocation09SolidSharp,
];