...
export const IconAdobePremierStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AdobePremier StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconAdobePremierDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AdobePremier DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconAdobePremierTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AdobePremier TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconAdobePremierSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AdobePremier SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconAdobePremierBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AdobePremier BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconAdobePremierStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AdobePremier StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconAdobePremierSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AdobePremier SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfAdobePremier: TheIconSelfPack = [
  'AdobePremier',
  IconAdobePremierStrokeRounded,
  IconAdobePremierDuotoneRounded,
  IconAdobePremierTwotoneRounded,
  IconAdobePremierSolidRounded,
  IconAdobePremierBulkRounded,
  IconAdobePremierStrokeSharp,
  IconAdobePremierSolidSharp,
];