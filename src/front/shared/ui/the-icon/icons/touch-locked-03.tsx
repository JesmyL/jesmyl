...
export const IconTouchLocked03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TouchLocked03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTouchLocked03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TouchLocked03 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconTouchLocked03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TouchLocked03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTouchLocked03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TouchLocked03 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconTouchLocked03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TouchLocked03 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconTouchLocked03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TouchLocked03 StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const IconTouchLocked03SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TouchLocked03 SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfTouchLocked03: TheIconSelfPack = [
  'TouchLocked03',
  IconTouchLocked03StrokeRounded,
  IconTouchLocked03DuotoneRounded,
  IconTouchLocked03TwotoneRounded,
  IconTouchLocked03SolidRounded,
  IconTouchLocked03BulkRounded,
  IconTouchLocked03StrokeSharp,
  IconTouchLocked03SolidSharp,
];