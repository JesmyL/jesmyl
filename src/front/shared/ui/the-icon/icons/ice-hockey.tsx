...
export const IconIceHockeyStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IceHockey StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconIceHockeyDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IceHockey DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconIceHockeyTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IceHockey TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconIceHockeySolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IceHockey SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconIceHockeyBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IceHockey BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d5}
...
export const IconIceHockeyStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IceHockey StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sw"
...
export const iconPackOfIceHockey: TheIconSelfPack = [
  'IceHockey',
  IconIceHockeyStrokeRounded,
  IconIceHockeyDuotoneRounded,
  IconIceHockeyTwotoneRounded,
  IconIceHockeySolidRounded,
  IconIceHockeyBulkRounded,
  IconIceHockeyStrokeSharp,
  IconIceHockeySolidSharp,
];