...
export const IconSearchReplaceStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SearchReplace StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSearchReplaceDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SearchReplace DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSearchReplaceTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SearchReplace TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSearchReplaceSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SearchReplace SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconSearchReplaceBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SearchReplace BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconSearchReplaceStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SearchReplace StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSearchReplaceSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SearchReplace SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfSearchReplace: TheIconSelfPack = [
  'SearchReplace',
  IconSearchReplaceStrokeRounded,
  IconSearchReplaceDuotoneRounded,
  IconSearchReplaceTwotoneRounded,
  IconSearchReplaceSolidRounded,
  IconSearchReplaceBulkRounded,
  IconSearchReplaceStrokeSharp,
  IconSearchReplaceSolidSharp,
];