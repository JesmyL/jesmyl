...
export const IconMenuSquareStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MenuSquare StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMenuSquareDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MenuSquare DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconMenuSquareTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MenuSquare TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconMenuSquareSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MenuSquare SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconMenuSquareBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MenuSquare BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconMenuSquareStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MenuSquare StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const IconMenuSquareSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MenuSquare SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const iconPackOfMenuSquare: TheIconSelfPack = [
  'MenuSquare',
  IconMenuSquareStrokeRounded,
  IconMenuSquareDuotoneRounded,
  IconMenuSquareTwotoneRounded,
  IconMenuSquareSolidRounded,
  IconMenuSquareBulkRounded,
  IconMenuSquareStrokeSharp,
  IconMenuSquareSolidSharp,
];