...
export const IconStethoscope02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Stethoscope02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconStethoscope02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Stethoscope02 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconStethoscope02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Stethoscope02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconStethoscope02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Stethoscope02 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconStethoscope02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Stethoscope02 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconStethoscope02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Stethoscope02 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s ss sw"
...
export const IconStethoscope02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Stethoscope02 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfStethoscope02: TheIconSelfPack = [
  'Stethoscope02',
  IconStethoscope02StrokeRounded,
  IconStethoscope02DuotoneRounded,
  IconStethoscope02TwotoneRounded,
  IconStethoscope02SolidRounded,
  IconStethoscope02BulkRounded,
  IconStethoscope02StrokeSharp,
  IconStethoscope02SolidSharp,
];