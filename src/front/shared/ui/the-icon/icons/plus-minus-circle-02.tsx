...
export const IconPlusMinusCircle02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlusMinusCircle02 StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconPlusMinusCircle02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlusMinusCircle02 DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconPlusMinusCircle02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlusMinusCircle02 TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconPlusMinusCircle02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlusMinusCircle02 SolidRounded"
    >
      <path 
        d={d.d2}
        i-c="c f fr"
...
export const IconPlusMinusCircle02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlusMinusCircle02 BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconPlusMinusCircle02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlusMinusCircle02 StrokeSharp"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconPlusMinusCircle02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlusMinusCircle02 SolidSharp"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const iconPackOfPlusMinusCircle02: TheIconSelfPack = [
  'PlusMinusCircle02',
  IconPlusMinusCircle02StrokeRounded,
  IconPlusMinusCircle02DuotoneRounded,
  IconPlusMinusCircle02TwotoneRounded,
  IconPlusMinusCircle02SolidRounded,
  IconPlusMinusCircle02BulkRounded,
  IconPlusMinusCircle02StrokeSharp,
  IconPlusMinusCircle02SolidSharp,
];