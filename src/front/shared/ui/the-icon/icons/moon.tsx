...
export const iconPackOfMoon: TheIconSelfPack = [
  'Moon',
  IconMoonStrokeRounded,
  IconMoonDuotoneRounded,
  IconMoonTwotoneRounded,
  IconMoonSolidRounded,
  IconMoonBulkRounded,
  IconMoonStrokeSharp,
  IconMoonSolidSharp,
];