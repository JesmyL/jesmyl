...
export const IconTransmissionStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Transmission StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconTransmissionDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Transmission DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconTransmissionTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Transmission TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconTransmissionSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Transmission SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconTransmissionBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Transmission BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconTransmissionStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Transmission StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconTransmissionSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Transmission SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfTransmission: TheIconSelfPack = [
  'Transmission',
  IconTransmissionStrokeRounded,
  IconTransmissionDuotoneRounded,
  IconTransmissionTwotoneRounded,
  IconTransmissionSolidRounded,
  IconTransmissionBulkRounded,
  IconTransmissionStrokeSharp,
  IconTransmissionSolidSharp,
];