...
export const IconWrench01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wrench01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWrench01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wrench01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconWrench01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wrench01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWrench01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wrench01 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const iconPackOfWrench01: TheIconSelfPack = [
  'Wrench01',
  IconWrench01StrokeRounded,
  IconWrench01DuotoneRounded,
  IconWrench01TwotoneRounded,
  IconWrench01SolidRounded,
  IconWrench01BulkRounded,
  IconWrench01StrokeSharp,
  IconWrench01SolidSharp,
];