...
export const IconHotTubeStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HotTube StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHotTubeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HotTube DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconHotTubeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HotTube TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfHotTube: TheIconSelfPack = [
  'HotTube',
  IconHotTubeStrokeRounded,
  IconHotTubeDuotoneRounded,
  IconHotTubeTwotoneRounded,
  IconHotTubeSolidRounded,
  IconHotTubeBulkRounded,
  IconHotTubeStrokeSharp,
  IconHotTubeSolidSharp,
];