...
export const IconProfileStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Profile StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconProfileDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Profile DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconProfileTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Profile TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfProfile: TheIconSelfPack = [
  'Profile',
  IconProfileStrokeRounded,
  IconProfileDuotoneRounded,
  IconProfileTwotoneRounded,
  IconProfileSolidRounded,
  IconProfileBulkRounded,
  IconProfileStrokeSharp,
  IconProfileSolidSharp,
];