...
export const iconPackOfEar: TheIconSelfPack = [
  'Ear',
  IconEarStrokeRounded,
  IconEarDuotoneRounded,
  IconEarTwotoneRounded,
  IconEarSolidRounded,
  IconEarBulkRounded,
  IconEarStrokeSharp,
  IconEarSolidSharp,
