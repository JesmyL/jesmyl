...
export const IconStudyLampStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StudyLamp StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconStudyLampDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StudyLamp DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconStudyLampTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StudyLamp TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconStudyLampSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StudyLamp SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconStudyLampBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StudyLamp BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconStudyLampStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StudyLamp StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const iconPackOfStudyLamp: TheIconSelfPack = [
  'StudyLamp',
  IconStudyLampStrokeRounded,
  IconStudyLampDuotoneRounded,
  IconStudyLampTwotoneRounded,
  IconStudyLampSolidRounded,
  IconStudyLampBulkRounded,
  IconStudyLampStrokeSharp,
  IconStudyLampSolidSharp,
];