...
export const IconComputerAddStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerAdd StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconComputerAddDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerAdd DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconComputerAddTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerAdd TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconComputerAddSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerAdd SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconComputerAddBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerAdd BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconComputerAddStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerAdd StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconComputerAddSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerAdd SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfComputerAdd: TheIconSelfPack = [
  'ComputerAdd',
  IconComputerAddStrokeRounded,
  IconComputerAddDuotoneRounded,
  IconComputerAddTwotoneRounded,
  IconComputerAddSolidRounded,
  IconComputerAddBulkRounded,
  IconComputerAddStrokeSharp,
  IconComputerAddSolidSharp,
];