...
export const IconCloudHailstoneStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CloudHailstone StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCloudHailstoneDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CloudHailstone DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconCloudHailstoneTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CloudHailstone TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCloudHailstoneSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CloudHailstone SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconCloudHailstoneBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CloudHailstone BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconCloudHailstoneStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CloudHailstone StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconCloudHailstoneSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CloudHailstone SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const iconPackOfCloudHailstone: TheIconSelfPack = [
  'CloudHailstone',
  IconCloudHailstoneStrokeRounded,
  IconCloudHailstoneDuotoneRounded,
  IconCloudHailstoneTwotoneRounded,
  IconCloudHailstoneSolidRounded,
  IconCloudHailstoneBulkRounded,
  IconCloudHailstoneStrokeSharp,
  IconCloudHailstoneSolidSharp,
];