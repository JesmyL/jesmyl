...
export const IconBookmarkAdd02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkAdd02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBookmarkAdd02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkAdd02 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconBookmarkAdd02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkAdd02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBookmarkAdd02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkAdd02 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconBookmarkAdd02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkAdd02 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconBookmarkAdd02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkAdd02 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const IconBookmarkAdd02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkAdd02 SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfBookmarkAdd02: TheIconSelfPack = [
  'BookmarkAdd02',
  IconBookmarkAdd02StrokeRounded,
  IconBookmarkAdd02DuotoneRounded,
  IconBookmarkAdd02TwotoneRounded,
  IconBookmarkAdd02SolidRounded,
  IconBookmarkAdd02BulkRounded,
  IconBookmarkAdd02StrokeSharp,
  IconBookmarkAdd02SolidSharp,
];