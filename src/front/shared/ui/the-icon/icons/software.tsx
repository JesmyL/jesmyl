...
export const IconSoftwareStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Software StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSoftwareDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Software DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconSoftwareTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Software TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconSoftwareSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Software SolidRounded"
    >
      <path 
        d={d.d1}
        i-c="f"
...
export const iconPackOfSoftware: TheIconSelfPack = [
  'Software',
  IconSoftwareStrokeRounded,
  IconSoftwareDuotoneRounded,
  IconSoftwareTwotoneRounded,
  IconSoftwareSolidRounded,
  IconSoftwareBulkRounded,
  IconSoftwareStrokeSharp,
  IconSoftwareSolidSharp,
];