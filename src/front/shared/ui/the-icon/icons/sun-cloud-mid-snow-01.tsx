...
export const IconSunCloudMidSnow01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SunCloudMidSnow01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSunCloudMidSnow01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SunCloudMidSnow01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconSunCloudMidSnow01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SunCloudMidSnow01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconSunCloudMidSnow01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SunCloudMidSnow01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconSunCloudMidSnow01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SunCloudMidSnow01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconSunCloudMidSnow01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SunCloudMidSnow01 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconSunCloudMidSnow01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SunCloudMidSnow01 SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfSunCloudMidSnow01: TheIconSelfPack = [
  'SunCloudMidSnow01',
  IconSunCloudMidSnow01StrokeRounded,
  IconSunCloudMidSnow01DuotoneRounded,
  IconSunCloudMidSnow01TwotoneRounded,
  IconSunCloudMidSnow01SolidRounded,
  IconSunCloudMidSnow01BulkRounded,
  IconSunCloudMidSnow01StrokeSharp,
  IconSunCloudMidSnow01SolidSharp,
];