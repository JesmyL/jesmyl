...
export const IconCalendarMinus01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarMinus01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCalendarMinus01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarMinus01 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconCalendarMinus01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarMinus01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCalendarMinus01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarMinus01 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconCalendarMinus01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarMinus01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconCalendarMinus01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarMinus01 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconCalendarMinus01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarMinus01 SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="f"
...
export const iconPackOfCalendarMinus01: TheIconSelfPack = [
  'CalendarMinus01',
  IconCalendarMinus01StrokeRounded,
  IconCalendarMinus01DuotoneRounded,
  IconCalendarMinus01TwotoneRounded,
  IconCalendarMinus01SolidRounded,
  IconCalendarMinus01BulkRounded,
  IconCalendarMinus01StrokeSharp,
  IconCalendarMinus01SolidSharp,
];