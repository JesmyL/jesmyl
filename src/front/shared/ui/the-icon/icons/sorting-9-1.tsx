...
export const IconSorting91StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sorting91 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSorting91DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sorting91 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSorting91TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sorting91 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconSorting91SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sorting91 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconSorting91BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sorting91 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconSorting91StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sorting91 StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sw"
...
export const iconPackOfSorting91: TheIconSelfPack = [
  'Sorting91',
  IconSorting91StrokeRounded,
  IconSorting91DuotoneRounded,
  IconSorting91TwotoneRounded,
  IconSorting91SolidRounded,
  IconSorting91BulkRounded,
  IconSorting91StrokeSharp,
  IconSorting91SolidSharp,
];