...
export const IconTorriGateStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TorriGate StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTorriGateDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TorriGate DuotoneRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d5}
...
export const IconTorriGateTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TorriGate TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTorriGateSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TorriGate SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconTorriGateBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TorriGate BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr o7"
...
export const IconTorriGateStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TorriGate StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfTorriGate: TheIconSelfPack = [
  'TorriGate',
  IconTorriGateStrokeRounded,
  IconTorriGateDuotoneRounded,
  IconTorriGateTwotoneRounded,
  IconTorriGateSolidRounded,
  IconTorriGateBulkRounded,
  IconTorriGateStrokeSharp,
  IconTorriGateSolidSharp,
];