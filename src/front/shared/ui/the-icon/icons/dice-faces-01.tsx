...
export const IconDiceFaces01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDiceFaces01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconDiceFaces01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDiceFaces01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces01 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconDiceFaces01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces01 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconDiceFaces01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces01 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const IconDiceFaces01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces01 SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfDiceFaces01: TheIconSelfPack = [
  'DiceFaces01',
  IconDiceFaces01StrokeRounded,
  IconDiceFaces01DuotoneRounded,
  IconDiceFaces01TwotoneRounded,
  IconDiceFaces01SolidRounded,
  IconDiceFaces01BulkRounded,
  IconDiceFaces01StrokeSharp,
  IconDiceFaces01SolidSharp,
];