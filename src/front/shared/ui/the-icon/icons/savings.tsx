...
export const IconSavingsStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Savings StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSavingsDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Savings DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconSavingsTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Savings TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfSavings: TheIconSelfPack = [
  'Savings',
  IconSavingsStrokeRounded,
  IconSavingsDuotoneRounded,
  IconSavingsTwotoneRounded,
  IconSavingsSolidRounded,
  IconSavingsBulkRounded,
  IconSavingsStrokeSharp,
  IconSavingsSolidSharp,
];