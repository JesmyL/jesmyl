...
export const IconAiInnovation02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiInnovation02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconAiInnovation02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiInnovation02 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconAiInnovation02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiInnovation02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconAiInnovation02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiInnovation02 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconAiInnovation02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiInnovation02 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr o7"
...
export const IconAiInnovation02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiInnovation02 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconAiInnovation02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiInnovation02 SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfAiInnovation02: TheIconSelfPack = [
  'AiInnovation02',
  IconAiInnovation02StrokeRounded,
  IconAiInnovation02DuotoneRounded,
  IconAiInnovation02TwotoneRounded,
  IconAiInnovation02SolidRounded,
  IconAiInnovation02BulkRounded,
  IconAiInnovation02StrokeSharp,
  IconAiInnovation02SolidSharp,
];