...
export const IconThreadDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Thread DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconThreadTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Thread TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfThread: TheIconSelfPack = [
  'Thread',
  IconThreadStrokeRounded,
  IconThreadDuotoneRounded,
  IconThreadTwotoneRounded,
  IconThreadSolidRounded,
  IconThreadBulkRounded,
  IconThreadStrokeSharp,
  IconThreadSolidSharp,
];