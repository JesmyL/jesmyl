...
export const IconChartRingStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartRing StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconChartRingDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartRing DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconChartRingTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartRing TwotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="o7 s sr sw"
...
export const IconChartRingSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartRing SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconChartRingBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartRing BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d5}
...
export const IconChartRingStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartRing StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfChartRing: TheIconSelfPack = [
  'ChartRing',
  IconChartRingStrokeRounded,
  IconChartRingDuotoneRounded,
  IconChartRingTwotoneRounded,
  IconChartRingSolidRounded,
  IconChartRingBulkRounded,
  IconChartRingStrokeSharp,
  IconChartRingSolidSharp,
];