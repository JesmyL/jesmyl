...
export const iconPackOfSeo: TheIconSelfPack = [
  'Seo',
  IconSeoStrokeRounded,
  IconSeoDuotoneRounded,
  IconSeoTwotoneRounded,
  IconSeoSolidRounded,
  IconSeoBulkRounded,
  IconSeoStrokeSharp,
  IconSeoSolidSharp,
