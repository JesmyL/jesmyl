...
export const IconTextCenterlineRightStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextCenterlineRight StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTextCenterlineRightDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextCenterlineRight DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconTextCenterlineRightTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextCenterlineRight TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTextCenterlineRightSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextCenterlineRight SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconTextCenterlineRightBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextCenterlineRight BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconTextCenterlineRightStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextCenterlineRight StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj ss sw"
...
export const IconTextCenterlineRightSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextCenterlineRight SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfTextCenterlineRight: TheIconSelfPack = [
  'TextCenterlineRight',
  IconTextCenterlineRightStrokeRounded,
  IconTextCenterlineRightDuotoneRounded,
  IconTextCenterlineRightTwotoneRounded,
  IconTextCenterlineRightSolidRounded,
  IconTextCenterlineRightBulkRounded,
  IconTextCenterlineRightStrokeSharp,
  IconTextCenterlineRightSolidSharp,
];