...
export const IconTable03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Table03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTable03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Table03 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="s sj sr sw"
...
export const IconTable03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Table03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfTable03: TheIconSelfPack = [
  'Table03',
  IconTable03StrokeRounded,
  IconTable03DuotoneRounded,
  IconTable03TwotoneRounded,
  IconTable03SolidRounded,
  IconTable03BulkRounded,
  IconTable03StrokeSharp,
  IconTable03SolidSharp,
];