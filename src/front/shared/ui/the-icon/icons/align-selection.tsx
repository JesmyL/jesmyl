...
export const IconAlignSelectionStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignSelection StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAlignSelectionDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignSelection DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconAlignSelectionTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignSelection TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconAlignSelectionSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignSelection SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconAlignSelectionBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignSelection BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr o7"
...
export const IconAlignSelectionStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignSelection StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconAlignSelectionSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignSelection SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfAlignSelection: TheIconSelfPack = [
  'AlignSelection',
  IconAlignSelectionStrokeRounded,
  IconAlignSelectionDuotoneRounded,
  IconAlignSelectionTwotoneRounded,
  IconAlignSelectionSolidRounded,
  IconAlignSelectionBulkRounded,
  IconAlignSelectionStrokeSharp,
  IconAlignSelectionSolidSharp,
];