...
export const IconWifiDisconnected01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WifiDisconnected01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconWifiDisconnected01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WifiDisconnected01 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="o7 s sj sr sw"
...
export const IconWifiDisconnected01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WifiDisconnected01 TwotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="s sj sr sw"
...
export const IconWifiDisconnected01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WifiDisconnected01 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconWifiDisconnected01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WifiDisconnected01 BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d6}
...
export const IconWifiDisconnected01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WifiDisconnected01 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconWifiDisconnected01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WifiDisconnected01 SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfWifiDisconnected01: TheIconSelfPack = [
  'WifiDisconnected01',
  IconWifiDisconnected01StrokeRounded,
  IconWifiDisconnected01DuotoneRounded,
  IconWifiDisconnected01TwotoneRounded,
  IconWifiDisconnected01SolidRounded,
  IconWifiDisconnected01BulkRounded,
  IconWifiDisconnected01StrokeSharp,
  IconWifiDisconnected01SolidSharp,
];