...
export const IconDatabase02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Database02 StrokeRounded"
    >
      <ellipse 
        cx="12"
        cy="5"
...
export const IconDatabase02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Database02 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconDatabase02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Database02 TwotoneRounded"
    >
      <ellipse 
        cx="12"
        cy="5"
...
export const IconDatabase02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Database02 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconDatabase02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Database02 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconDatabase02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Database02 StrokeSharp"
    >
      <ellipse 
        cx="12"
        cy="5"
...
export const IconDatabase02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Database02 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfDatabase02: TheIconSelfPack = [
  'Database02',
  IconDatabase02StrokeRounded,
  IconDatabase02DuotoneRounded,
  IconDatabase02TwotoneRounded,
  IconDatabase02SolidRounded,
  IconDatabase02BulkRounded,
  IconDatabase02StrokeSharp,
  IconDatabase02SolidSharp,
];