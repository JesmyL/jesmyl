...
export const IconDiaperDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Diaper DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconDiaperTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Diaper TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfDiaper: TheIconSelfPack = [
  'Diaper',
  IconDiaperStrokeRounded,
  IconDiaperDuotoneRounded,
  IconDiaperTwotoneRounded,
  IconDiaperSolidRounded,
  IconDiaperBulkRounded,
  IconDiaperStrokeSharp,
  IconDiaperSolidSharp,
];