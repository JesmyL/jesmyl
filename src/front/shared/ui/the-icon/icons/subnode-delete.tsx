...
export const IconSubnodeDeleteStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SubnodeDelete StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSubnodeDeleteDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SubnodeDelete DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconSubnodeDeleteTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SubnodeDelete TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconSubnodeDeleteSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SubnodeDelete SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconSubnodeDeleteBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SubnodeDelete BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconSubnodeDeleteStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SubnodeDelete StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconSubnodeDeleteSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SubnodeDelete SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfSubnodeDelete: TheIconSelfPack = [
  'SubnodeDelete',
  IconSubnodeDeleteStrokeRounded,
  IconSubnodeDeleteDuotoneRounded,
  IconSubnodeDeleteTwotoneRounded,
  IconSubnodeDeleteSolidRounded,
  IconSubnodeDeleteBulkRounded,
  IconSubnodeDeleteStrokeSharp,
  IconSubnodeDeleteSolidSharp,
];