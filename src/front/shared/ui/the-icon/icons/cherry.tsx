...
export const IconCherryDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cherry DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconCherryTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cherry TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfCherry: TheIconSelfPack = [
  'Cherry',
  IconCherryStrokeRounded,
  IconCherryDuotoneRounded,
  IconCherryTwotoneRounded,
  IconCherrySolidRounded,
  IconCherryBulkRounded,
  IconCherryStrokeSharp,
  IconCherrySolidSharp,
];