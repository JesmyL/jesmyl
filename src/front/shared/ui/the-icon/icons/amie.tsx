...
export const iconPackOfAmie: TheIconSelfPack = [
  'Amie',
  IconAmieStrokeRounded,
  IconAmieDuotoneRounded,
  IconAmieTwotoneRounded,
  IconAmieSolidRounded,
  IconAmieBulkRounded,
  IconAmieStrokeSharp,
  IconAmieSolidSharp,
];