...
export const IconFileMinusStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileMinus StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFileMinusDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileMinus DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconFileMinusTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileMinus TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconFileMinusSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileMinus SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconFileMinusBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileMinus BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconFileMinusStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileMinus StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const iconPackOfFileMinus: TheIconSelfPack = [
  'FileMinus',
  IconFileMinusStrokeRounded,
  IconFileMinusDuotoneRounded,
  IconFileMinusTwotoneRounded,
  IconFileMinusSolidRounded,
  IconFileMinusBulkRounded,
  IconFileMinusStrokeSharp,
  IconFileMinusSolidSharp,
];