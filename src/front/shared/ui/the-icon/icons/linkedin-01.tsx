...
export const IconLinkedin01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Linkedin01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLinkedin01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Linkedin01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconLinkedin01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Linkedin01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconLinkedin01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Linkedin01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconLinkedin01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Linkedin01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconLinkedin01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Linkedin01 StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconLinkedin01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Linkedin01 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfLinkedin01: TheIconSelfPack = [
  'Linkedin01',
  IconLinkedin01StrokeRounded,
  IconLinkedin01DuotoneRounded,
  IconLinkedin01TwotoneRounded,
  IconLinkedin01SolidRounded,
  IconLinkedin01BulkRounded,
  IconLinkedin01StrokeSharp,
  IconLinkedin01SolidSharp,
];