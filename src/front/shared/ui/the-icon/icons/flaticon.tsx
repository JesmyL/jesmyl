...
export const IconFlaticonStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Flaticon StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFlaticonDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Flaticon DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconFlaticonTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Flaticon TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFlaticonSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Flaticon SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const iconPackOfFlaticon: TheIconSelfPack = [
  'Flaticon',
  IconFlaticonStrokeRounded,
  IconFlaticonDuotoneRounded,
  IconFlaticonTwotoneRounded,
  IconFlaticonSolidRounded,
  IconFlaticonBulkRounded,
  IconFlaticonStrokeSharp,
  IconFlaticonSolidSharp,
];