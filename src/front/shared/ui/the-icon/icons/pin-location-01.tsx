...
export const IconPinLocation01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PinLocation01 StrokeRounded"
    >
      <circle 
        cx="12"
        cy="7"
...
export const IconPinLocation01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PinLocation01 DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="7"
...
export const IconPinLocation01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PinLocation01 TwotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="o7 s sr sw"
...
export const IconPinLocation01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PinLocation01 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconPinLocation01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PinLocation01 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconPinLocation01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PinLocation01 StrokeSharp"
    >
      <circle 
        cx="12"
        cy="7"
...
export const IconPinLocation01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PinLocation01 SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const iconPackOfPinLocation01: TheIconSelfPack = [
  'PinLocation01',
  IconPinLocation01StrokeRounded,
  IconPinLocation01DuotoneRounded,
  IconPinLocation01TwotoneRounded,
  IconPinLocation01SolidRounded,
  IconPinLocation01BulkRounded,
  IconPinLocation01StrokeSharp,
  IconPinLocation01SolidSharp,
];