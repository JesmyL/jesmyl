...
export const IconDelete02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Delete02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDelete02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Delete02 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconDelete02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Delete02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDelete02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Delete02 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfDelete02: TheIconSelfPack = [
  'Delete02',
  IconDelete02StrokeRounded,
  IconDelete02DuotoneRounded,
  IconDelete02TwotoneRounded,
  IconDelete02SolidRounded,
  IconDelete02BulkRounded,
  IconDelete02StrokeSharp,
  IconDelete02SolidSharp,
];