...
export const IconRainbowStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Rainbow StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRainbowDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Rainbow DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconRainbowTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Rainbow TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfRainbow: TheIconSelfPack = [
  'Rainbow',
  IconRainbowStrokeRounded,
  IconRainbowDuotoneRounded,
  IconRainbowTwotoneRounded,
  IconRainbowSolidRounded,
  IconRainbowBulkRounded,
  IconRainbowStrokeSharp,
  IconRainbowSolidSharp,
];