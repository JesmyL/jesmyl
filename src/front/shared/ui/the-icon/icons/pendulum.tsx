...
export const IconPendulumStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pendulum StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPendulumDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pendulum DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPendulumTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pendulum TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPendulumSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pendulum SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const iconPackOfPendulum: TheIconSelfPack = [
  'Pendulum',
  IconPendulumStrokeRounded,
  IconPendulumDuotoneRounded,
  IconPendulumTwotoneRounded,
  IconPendulumSolidRounded,
  IconPendulumBulkRounded,
  IconPendulumStrokeSharp,
  IconPendulumSolidSharp,
];