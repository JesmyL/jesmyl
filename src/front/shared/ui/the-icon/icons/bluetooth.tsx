...
export const IconBluetoothStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bluetooth StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBluetoothDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bluetooth DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconBluetoothTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bluetooth TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBluetoothSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bluetooth SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconBluetoothBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bluetooth BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconBluetoothStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bluetooth StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const iconPackOfBluetooth: TheIconSelfPack = [
  'Bluetooth',
  IconBluetoothStrokeRounded,
  IconBluetoothDuotoneRounded,
  IconBluetoothTwotoneRounded,
  IconBluetoothSolidRounded,
  IconBluetoothBulkRounded,
  IconBluetoothStrokeSharp,
  IconBluetoothSolidSharp,
];