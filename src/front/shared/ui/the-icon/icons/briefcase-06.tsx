...
export const IconBriefcase06StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase06 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBriefcase06DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase06 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconBriefcase06TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase06 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconBriefcase06SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase06 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconBriefcase06BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase06 BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconBriefcase06StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase06 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconBriefcase06SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Briefcase06 SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfBriefcase06: TheIconSelfPack = [
  'Briefcase06',
  IconBriefcase06StrokeRounded,
  IconBriefcase06DuotoneRounded,
  IconBriefcase06TwotoneRounded,
  IconBriefcase06SolidRounded,
  IconBriefcase06BulkRounded,
  IconBriefcase06StrokeSharp,
  IconBriefcase06SolidSharp,
];