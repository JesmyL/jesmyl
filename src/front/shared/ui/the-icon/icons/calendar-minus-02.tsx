...
export const IconCalendarMinus02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarMinus02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCalendarMinus02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarMinus02 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconCalendarMinus02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarMinus02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCalendarMinus02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarMinus02 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconCalendarMinus02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarMinus02 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconCalendarMinus02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarMinus02 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconCalendarMinus02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarMinus02 SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfCalendarMinus02: TheIconSelfPack = [
  'CalendarMinus02',
  IconCalendarMinus02StrokeRounded,
  IconCalendarMinus02DuotoneRounded,
  IconCalendarMinus02TwotoneRounded,
  IconCalendarMinus02SolidRounded,
  IconCalendarMinus02BulkRounded,
  IconCalendarMinus02StrokeSharp,
  IconCalendarMinus02SolidSharp,
];