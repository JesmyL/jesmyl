...
export const IconJobLinkStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="JobLink StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconJobLinkDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="JobLink DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconJobLinkTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="JobLink TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfJobLink: TheIconSelfPack = [
  'JobLink',
  IconJobLinkStrokeRounded,
  IconJobLinkDuotoneRounded,
  IconJobLinkTwotoneRounded,
  IconJobLinkSolidRounded,
  IconJobLinkBulkRounded,
  IconJobLinkStrokeSharp,
  IconJobLinkSolidSharp,
];