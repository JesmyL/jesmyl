...
export const IconFileAddStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileAdd StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFileAddDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileAdd DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconFileAddTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileAdd TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfFileAdd: TheIconSelfPack = [
  'FileAdd',
  IconFileAddStrokeRounded,
  IconFileAddDuotoneRounded,
  IconFileAddTwotoneRounded,
  IconFileAddSolidRounded,
  IconFileAddBulkRounded,
  IconFileAddStrokeSharp,
  IconFileAddSolidSharp,
];