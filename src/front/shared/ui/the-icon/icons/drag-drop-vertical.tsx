...
export const IconDragDropVerticalStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DragDropVertical StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDragDropVerticalDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DragDropVertical DuotoneRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d1}
...
export const IconDragDropVerticalTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DragDropVertical TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDragDropVerticalSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DragDropVertical SolidRounded"
    >
      <path 
        d={d.d2}
        i-c="c f fr"
...
export const IconDragDropVerticalBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DragDropVertical BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr o7"
...
export const IconDragDropVerticalStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DragDropVertical StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj ss sw"
...
export const IconDragDropVerticalSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DragDropVertical SolidSharp"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const iconPackOfDragDropVertical: TheIconSelfPack = [
  'DragDropVertical',
  IconDragDropVerticalStrokeRounded,
  IconDragDropVerticalDuotoneRounded,
  IconDragDropVerticalTwotoneRounded,
  IconDragDropVerticalSolidRounded,
  IconDragDropVerticalBulkRounded,
  IconDragDropVerticalStrokeSharp,
  IconDragDropVerticalSolidSharp,
];