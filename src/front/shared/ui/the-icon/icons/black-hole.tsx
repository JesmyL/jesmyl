...
export const IconBlackHoleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BlackHole StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBlackHoleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BlackHole DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconBlackHoleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BlackHole TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBlackHoleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BlackHole SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconBlackHoleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BlackHole BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconBlackHoleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BlackHole StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfBlackHole: TheIconSelfPack = [
  'BlackHole',
  IconBlackHoleStrokeRounded,
  IconBlackHoleDuotoneRounded,
  IconBlackHoleTwotoneRounded,
  IconBlackHoleSolidRounded,
  IconBlackHoleBulkRounded,
  IconBlackHoleStrokeSharp,
  IconBlackHoleSolidSharp,
];