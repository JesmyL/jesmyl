...
export const IconUserBlock02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserBlock02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserBlock02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserBlock02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconUserBlock02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserBlock02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserBlock02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserBlock02 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconUserBlock02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserBlock02 BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d4}
...
export const IconUserBlock02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserBlock02 StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const IconUserBlock02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserBlock02 SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfUserBlock02: TheIconSelfPack = [
  'UserBlock02',
  IconUserBlock02StrokeRounded,
  IconUserBlock02DuotoneRounded,
  IconUserBlock02TwotoneRounded,
  IconUserBlock02SolidRounded,
  IconUserBlock02BulkRounded,
  IconUserBlock02StrokeSharp,
  IconUserBlock02SolidSharp,
];