...
export const IconHotspotOfflineStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HotspotOffline StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconHotspotOfflineDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HotspotOffline DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconHotspotOfflineTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HotspotOffline TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconHotspotOfflineSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HotspotOffline SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconHotspotOfflineBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HotspotOffline BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconHotspotOfflineStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HotspotOffline StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconHotspotOfflineSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HotspotOffline SolidSharp"
    >
      <path 
        d={d.d16}
        i-c="f"
...
export const iconPackOfHotspotOffline: TheIconSelfPack = [
  'HotspotOffline',
  IconHotspotOfflineStrokeRounded,
  IconHotspotOfflineDuotoneRounded,
  IconHotspotOfflineTwotoneRounded,
  IconHotspotOfflineSolidRounded,
  IconHotspotOfflineBulkRounded,
  IconHotspotOfflineStrokeSharp,
  IconHotspotOfflineSolidSharp,
];