...
export const IconLollipopStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Lollipop StrokeRounded"
    >
      <circle 
        cx="12"
        cy="8"
...
export const IconLollipopDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Lollipop DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconLollipopTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Lollipop TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="8"
...
export const IconLollipopSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Lollipop SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const iconPackOfLollipop: TheIconSelfPack = [
  'Lollipop',
  IconLollipopStrokeRounded,
  IconLollipopDuotoneRounded,
  IconLollipopTwotoneRounded,
  IconLollipopSolidRounded,
  IconLollipopBulkRounded,
  IconLollipopStrokeSharp,
  IconLollipopSolidSharp,
];