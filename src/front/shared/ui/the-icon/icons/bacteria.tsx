...
export const IconBacteriaStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bacteria StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconBacteriaDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bacteria DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconBacteriaTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bacteria TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconBacteriaSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bacteria SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfBacteria: TheIconSelfPack = [
  'Bacteria',
  IconBacteriaStrokeRounded,
  IconBacteriaDuotoneRounded,
  IconBacteriaTwotoneRounded,
  IconBacteriaSolidRounded,
  IconBacteriaBulkRounded,
  IconBacteriaStrokeSharp,
  IconBacteriaSolidSharp,
];