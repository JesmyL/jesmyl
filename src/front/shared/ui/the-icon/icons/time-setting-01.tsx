...
export const IconTimeSetting01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TimeSetting01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTimeSetting01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TimeSetting01 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconTimeSetting01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TimeSetting01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconTimeSetting01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TimeSetting01 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconTimeSetting01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TimeSetting01 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconTimeSetting01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TimeSetting01 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const IconTimeSetting01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TimeSetting01 SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfTimeSetting01: TheIconSelfPack = [
  'TimeSetting01',
  IconTimeSetting01StrokeRounded,
  IconTimeSetting01DuotoneRounded,
  IconTimeSetting01TwotoneRounded,
  IconTimeSetting01SolidRounded,
  IconTimeSetting01BulkRounded,
  IconTimeSetting01StrokeSharp,
  IconTimeSetting01SolidSharp,
];