...
export const IconChartHighLowStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartHighLow StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconChartHighLowDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartHighLow DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconChartHighLowTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartHighLow TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconChartHighLowSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartHighLow SolidRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const IconChartHighLowBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartHighLow BulkRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const IconChartHighLowStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartHighLow StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sj sw"
...
export const IconChartHighLowSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartHighLow SolidSharp"
    >
      <path 
        d={d.d18}
        i-c="c f fr"
...
export const iconPackOfChartHighLow: TheIconSelfPack = [
  'ChartHighLow',
  IconChartHighLowStrokeRounded,
  IconChartHighLowDuotoneRounded,
  IconChartHighLowTwotoneRounded,
  IconChartHighLowSolidRounded,
  IconChartHighLowBulkRounded,
  IconChartHighLowStrokeSharp,
  IconChartHighLowSolidSharp,
];