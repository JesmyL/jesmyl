...
export const IconSquareArrowDataTransferHorizontalStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowDataTransferHorizontal StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSquareArrowDataTransferHorizontalDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowDataTransferHorizontal DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconSquareArrowDataTransferHorizontalTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowDataTransferHorizontal TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSquareArrowDataTransferHorizontalSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowDataTransferHorizontal SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconSquareArrowDataTransferHorizontalBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowDataTransferHorizontal BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconSquareArrowDataTransferHorizontalStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowDataTransferHorizontal StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconSquareArrowDataTransferHorizontalSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowDataTransferHorizontal SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfSquareArrowDataTransferHorizontal: TheIconSelfPack = [
  ...
  IconSquareArrowDataTransferHorizontalStrokeRounded,
  IconSquareArrowDataTransferHorizontalDuotoneRounded,
  IconSquareArrowDataTransferHorizontalTwotoneRounded,
  IconSquareArrowDataTransferHorizontalSolidRounded,
  IconSquareArrowDataTransferHorizontalBulkRounded,
  IconSquareArrowDataTransferHorizontalStrokeSharp,
  IconSquareArrowDataTransferHorizontalSolidSharp,
];