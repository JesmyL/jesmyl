...
export const IconImageDelete01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDelete01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconImageDelete01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDelete01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconImageDelete01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDelete01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconImageDelete01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDelete01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconImageDelete01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDelete01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconImageDelete01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDelete01 StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconImageDelete01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDelete01 SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfImageDelete01: TheIconSelfPack = [
  'ImageDelete01',
  IconImageDelete01StrokeRounded,
  IconImageDelete01DuotoneRounded,
  IconImageDelete01TwotoneRounded,
  IconImageDelete01SolidRounded,
  IconImageDelete01BulkRounded,
  IconImageDelete01StrokeSharp,
  IconImageDelete01SolidSharp,
];