...
export const IconEuroCircleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EuroCircle StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconEuroCircleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EuroCircle DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconEuroCircleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EuroCircle TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconEuroCircleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EuroCircle SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconEuroCircleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EuroCircle BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconEuroCircleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EuroCircle StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconEuroCircleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EuroCircle SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfEuroCircle: TheIconSelfPack = [
  'EuroCircle',
  IconEuroCircleStrokeRounded,
  IconEuroCircleDuotoneRounded,
  IconEuroCircleTwotoneRounded,
  IconEuroCircleSolidRounded,
  IconEuroCircleBulkRounded,
  IconEuroCircleStrokeSharp,
  IconEuroCircleSolidSharp,
];