...
export const IconTextCheckStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextCheck StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTextCheckDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextCheck DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconTextCheckTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextCheck TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTextCheckSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextCheck SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconTextCheckBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextCheck BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconTextCheckStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextCheck StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s ss sw"
...
export const iconPackOfTextCheck: TheIconSelfPack = [
  'TextCheck',
  IconTextCheckStrokeRounded,
  IconTextCheckDuotoneRounded,
  IconTextCheckTwotoneRounded,
  IconTextCheckSolidRounded,
  IconTextCheckBulkRounded,
  IconTextCheckStrokeSharp,
  IconTextCheckSolidSharp,
];