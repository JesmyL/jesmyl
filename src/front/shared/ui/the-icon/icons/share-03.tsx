...
export const IconShare03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Share03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconShare03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Share03 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconShare03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Share03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfShare03: TheIconSelfPack = [
  'Share03',
  IconShare03StrokeRounded,
  IconShare03DuotoneRounded,
  IconShare03TwotoneRounded,
  IconShare03SolidRounded,
  IconShare03BulkRounded,
  IconShare03StrokeSharp,
  IconShare03SolidSharp,
];