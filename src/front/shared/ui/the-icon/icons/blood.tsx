...
export const iconPackOfBlood: TheIconSelfPack = [
  'Blood',
  IconBloodStrokeRounded,
  IconBloodDuotoneRounded,
  IconBloodTwotoneRounded,
  IconBloodSolidRounded,
  IconBloodBulkRounded,
  IconBloodStrokeSharp,
  IconBloodSolidSharp,
];