...
export const IconTwitterStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Twitter StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconTwitterDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Twitter DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconTwitterTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Twitter TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sw"
...
export const iconPackOfTwitter: TheIconSelfPack = [
  'Twitter',
  IconTwitterStrokeRounded,
  IconTwitterDuotoneRounded,
  IconTwitterTwotoneRounded,
  IconTwitterSolidRounded,
  IconTwitterBulkRounded,
  IconTwitterStrokeSharp,
  IconTwitterSolidSharp,
];