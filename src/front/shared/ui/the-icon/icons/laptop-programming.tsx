...
export const IconLaptopProgrammingStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopProgramming StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLaptopProgrammingDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopProgramming DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconLaptopProgrammingTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopProgramming TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLaptopProgrammingSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopProgramming SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconLaptopProgrammingBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopProgramming BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconLaptopProgrammingStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopProgramming StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sw"
...
export const IconLaptopProgrammingSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopProgramming SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfLaptopProgramming: TheIconSelfPack = [
  'LaptopProgramming',
  IconLaptopProgrammingStrokeRounded,
  IconLaptopProgrammingDuotoneRounded,
  IconLaptopProgrammingTwotoneRounded,
  IconLaptopProgrammingSolidRounded,
  IconLaptopProgrammingBulkRounded,
  IconLaptopProgrammingStrokeSharp,
  IconLaptopProgrammingSolidSharp,
];