...
export const IconTick04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Tick04 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconTick04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Tick04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfTick04: TheIconSelfPack = [
  'Tick04',
  IconTick04StrokeRounded,
  IconTick04DuotoneRounded,
  IconTick04TwotoneRounded,
  IconTick04SolidRounded,
  IconTick04BulkRounded,
  IconTick04StrokeSharp,
  IconTick04SolidSharp,
];