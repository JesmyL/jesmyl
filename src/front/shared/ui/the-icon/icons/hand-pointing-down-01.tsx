...
export const IconHandPointingDown01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HandPointingDown01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHandPointingDown01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HandPointingDown01 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconHandPointingDown01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HandPointingDown01 TwotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="s sj sr sw"
...
export const IconHandPointingDown01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HandPointingDown01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconHandPointingDown01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HandPointingDown01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconHandPointingDown01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HandPointingDown01 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const IconHandPointingDown01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HandPointingDown01 SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const iconPackOfHandPointingDown01: TheIconSelfPack = [
  'HandPointingDown01',
  IconHandPointingDown01StrokeRounded,
  IconHandPointingDown01DuotoneRounded,
  IconHandPointingDown01TwotoneRounded,
  IconHandPointingDown01SolidRounded,
  IconHandPointingDown01BulkRounded,
  IconHandPointingDown01StrokeSharp,
  IconHandPointingDown01SolidSharp,
];