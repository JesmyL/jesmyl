...
export const IconPunchingBall02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PunchingBall02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPunchingBall02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PunchingBall02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPunchingBall02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PunchingBall02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPunchingBall02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PunchingBall02 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconPunchingBall02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PunchingBall02 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconPunchingBall02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PunchingBall02 StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sr sw"
...
export const IconPunchingBall02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PunchingBall02 SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfPunchingBall02: TheIconSelfPack = [
  'PunchingBall02',
  IconPunchingBall02StrokeRounded,
  IconPunchingBall02DuotoneRounded,
  IconPunchingBall02TwotoneRounded,
  IconPunchingBall02SolidRounded,
  IconPunchingBall02BulkRounded,
  IconPunchingBall02StrokeSharp,
  IconPunchingBall02SolidSharp,
];