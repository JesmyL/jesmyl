...
export const IconTradeMarkStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TradeMark StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconTradeMarkDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TradeMark DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconTradeMarkTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TradeMark TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconTradeMarkSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TradeMark SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconTradeMarkBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TradeMark BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconTradeMarkStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TradeMark StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfTradeMark: TheIconSelfPack = [
  'TradeMark',
  IconTradeMarkStrokeRounded,
  IconTradeMarkDuotoneRounded,
  IconTradeMarkTwotoneRounded,
  IconTradeMarkSolidRounded,
  IconTradeMarkBulkRounded,
  IconTradeMarkStrokeSharp,
  IconTradeMarkSolidSharp,
];