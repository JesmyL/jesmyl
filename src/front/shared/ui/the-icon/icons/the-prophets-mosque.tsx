...
export const IconTheProphetsMosqueStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TheProphetsMosque StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTheProphetsMosqueDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TheProphetsMosque DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconTheProphetsMosqueTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TheProphetsMosque TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTheProphetsMosqueSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TheProphetsMosque SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const IconTheProphetsMosqueBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TheProphetsMosque BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d11}
...
export const IconTheProphetsMosqueStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TheProphetsMosque StrokeSharp"
    >
      <path 
        d={d.d16}
        i-c="s sj ss sw"
...
export const IconTheProphetsMosqueSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TheProphetsMosque SolidSharp"
    >
      <path 
        d={d.d19}
        i-c="f"
...
export const iconPackOfTheProphetsMosque: TheIconSelfPack = [
  'TheProphetsMosque',
  IconTheProphetsMosqueStrokeRounded,
  IconTheProphetsMosqueDuotoneRounded,
  IconTheProphetsMosqueTwotoneRounded,
  IconTheProphetsMosqueSolidRounded,
  IconTheProphetsMosqueBulkRounded,
  IconTheProphetsMosqueStrokeSharp,
  IconTheProphetsMosqueSolidSharp,
];