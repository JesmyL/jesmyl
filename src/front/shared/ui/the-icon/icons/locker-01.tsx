...
export const IconLocker01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Locker01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLocker01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Locker01 DuotoneRounded"
    >
      <path 
        d={d.d10}
        i-c="f o7"
...
export const IconLocker01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Locker01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLocker01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Locker01 SolidRounded"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfLocker01: TheIconSelfPack = [
  'Locker01',
  IconLocker01StrokeRounded,
  IconLocker01DuotoneRounded,
  IconLocker01TwotoneRounded,
  IconLocker01SolidRounded,
  IconLocker01BulkRounded,
  IconLocker01StrokeSharp,
  IconLocker01SolidSharp,
];