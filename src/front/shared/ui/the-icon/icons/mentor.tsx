...
export const IconMentorDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mentor DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconMentorTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mentor TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const iconPackOfMentor: TheIconSelfPack = [
  'Mentor',
  IconMentorStrokeRounded,
  IconMentorDuotoneRounded,
  IconMentorTwotoneRounded,
  IconMentorSolidRounded,
  IconMentorBulkRounded,
  IconMentorStrokeSharp,
  IconMentorSolidSharp,
];