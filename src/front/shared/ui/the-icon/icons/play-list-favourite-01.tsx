...
export const IconPlayListFavourite01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListFavourite01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconPlayListFavourite01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListFavourite01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconPlayListFavourite01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListFavourite01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconPlayListFavourite01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListFavourite01 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconPlayListFavourite01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListFavourite01 BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d7}
...
export const IconPlayListFavourite01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListFavourite01 StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const IconPlayListFavourite01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListFavourite01 SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="f"
...
export const iconPackOfPlayListFavourite01: TheIconSelfPack = [
  'PlayListFavourite01',
  IconPlayListFavourite01StrokeRounded,
  IconPlayListFavourite01DuotoneRounded,
  IconPlayListFavourite01TwotoneRounded,
  IconPlayListFavourite01SolidRounded,
  IconPlayListFavourite01BulkRounded,
  IconPlayListFavourite01StrokeSharp,
  IconPlayListFavourite01SolidSharp,
];