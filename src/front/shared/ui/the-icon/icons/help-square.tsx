...
export const IconHelpSquareStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HelpSquare StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconHelpSquareDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HelpSquare DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconHelpSquareTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HelpSquare TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconHelpSquareSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HelpSquare SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconHelpSquareBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HelpSquare BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconHelpSquareStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HelpSquare StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj ss sw"
...
export const IconHelpSquareSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HelpSquare SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfHelpSquare: TheIconSelfPack = [
  'HelpSquare',
  IconHelpSquareStrokeRounded,
  IconHelpSquareDuotoneRounded,
  IconHelpSquareTwotoneRounded,
  IconHelpSquareSolidRounded,
  IconHelpSquareBulkRounded,
  IconHelpSquareStrokeSharp,
  IconHelpSquareSolidSharp,
];