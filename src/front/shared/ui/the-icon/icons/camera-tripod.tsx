...
export const IconCameraTripodStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraTripod StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconCameraTripodDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraTripod DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconCameraTripodTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraTripod TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconCameraTripodSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraTripod SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconCameraTripodBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraTripod BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconCameraTripodStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraTripod StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sw"
...
export const IconCameraTripodSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraTripod SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfCameraTripod: TheIconSelfPack = [
  'CameraTripod',
  IconCameraTripodStrokeRounded,
  IconCameraTripodDuotoneRounded,
  IconCameraTripodTwotoneRounded,
  IconCameraTripodSolidRounded,
  IconCameraTripodBulkRounded,
  IconCameraTripodStrokeSharp,
  IconCameraTripodSolidSharp,
];