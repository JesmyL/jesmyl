...
export const IconEquipmentChestPressStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EquipmentChestPress StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconEquipmentChestPressDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EquipmentChestPress DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconEquipmentChestPressTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EquipmentChestPress TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconEquipmentChestPressSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EquipmentChestPress SolidRounded"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const IconEquipmentChestPressBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EquipmentChestPress BulkRounded"
    >
      <path 
        d={d.d16}
        i-c="f o7"
...
export const IconEquipmentChestPressStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EquipmentChestPress StrokeSharp"
    >
      <path 
        d={d.d19}
        i-c="s sj sw"
...
export const IconEquipmentChestPressSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EquipmentChestPress SolidSharp"
    >
      <path 
        d={d.d22}
        i-c="f"
...
export const iconPackOfEquipmentChestPress: TheIconSelfPack = [
  'EquipmentChestPress',
  IconEquipmentChestPressStrokeRounded,
  IconEquipmentChestPressDuotoneRounded,
  IconEquipmentChestPressTwotoneRounded,
  IconEquipmentChestPressSolidRounded,
  IconEquipmentChestPressBulkRounded,
  IconEquipmentChestPressStrokeSharp,
  IconEquipmentChestPressSolidSharp,
];