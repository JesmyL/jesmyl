...
export const IconBbqGrillStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BbqGrill StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconBbqGrillDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BbqGrill DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconBbqGrillTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BbqGrill TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconBbqGrillSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BbqGrill SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfBbqGrill: TheIconSelfPack = [
  'BbqGrill',
  IconBbqGrillStrokeRounded,
  IconBbqGrillDuotoneRounded,
  IconBbqGrillTwotoneRounded,
  IconBbqGrillSolidRounded,
  IconBbqGrillBulkRounded,
  IconBbqGrillStrokeSharp,
  IconBbqGrillSolidSharp,
];