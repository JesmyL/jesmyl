...
export const IconPopcornStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Popcorn StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPopcornDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Popcorn DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconPopcornTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Popcorn TwotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="s sj sw"
...
export const iconPackOfPopcorn: TheIconSelfPack = [
  'Popcorn',
  IconPopcornStrokeRounded,
  IconPopcornDuotoneRounded,
  IconPopcornTwotoneRounded,
  IconPopcornSolidRounded,
  IconPopcornBulkRounded,
  IconPopcornStrokeSharp,
  IconPopcornSolidSharp,
];