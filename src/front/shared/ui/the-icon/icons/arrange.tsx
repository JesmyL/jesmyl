...
export const IconArrangeStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Arrange StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconArrangeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Arrange DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconArrangeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Arrange TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfArrange: TheIconSelfPack = [
  'Arrange',
  IconArrangeStrokeRounded,
  IconArrangeDuotoneRounded,
  IconArrangeTwotoneRounded,
  IconArrangeSolidRounded,
  IconArrangeBulkRounded,
  IconArrangeStrokeSharp,
  IconArrangeSolidSharp,
];