...
export const iconPackOfHaji: TheIconSelfPack = [
  'Haji',
  IconHajiStrokeRounded,
  IconHajiDuotoneRounded,
  IconHajiTwotoneRounded,
  IconHajiSolidRounded,
  IconHajiBulkRounded,
  IconHajiStrokeSharp,
  IconHajiSolidSharp,
];