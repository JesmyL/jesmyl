...
export const iconPackOfTram: TheIconSelfPack = [
  'Tram',
  IconTramStrokeRounded,
  IconTramDuotoneRounded,
  IconTramTwotoneRounded,
  IconTramSolidRounded,
  IconTramBulkRounded,
  IconTramStrokeSharp,
  IconTramSolidSharp,
];