...
export const IconAlphabetArabicStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlphabetArabic StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconAlphabetArabicDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlphabetArabic DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconAlphabetArabicTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlphabetArabic TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconAlphabetArabicSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlphabetArabic SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconAlphabetArabicBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlphabetArabic BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr o7"
...
export const IconAlphabetArabicStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlphabetArabic StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconAlphabetArabicSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlphabetArabic SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfAlphabetArabic: TheIconSelfPack = [
  'AlphabetArabic',
  IconAlphabetArabicStrokeRounded,
  IconAlphabetArabicDuotoneRounded,
  IconAlphabetArabicTwotoneRounded,
  IconAlphabetArabicSolidRounded,
  IconAlphabetArabicBulkRounded,
  IconAlphabetArabicStrokeSharp,
  IconAlphabetArabicSolidSharp,
];