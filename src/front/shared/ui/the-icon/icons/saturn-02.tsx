...
export const IconSaturn02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Saturn02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSaturn02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Saturn02 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconSaturn02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Saturn02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSaturn02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Saturn02 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const iconPackOfSaturn02: TheIconSelfPack = [
  'Saturn02',
  IconSaturn02StrokeRounded,
  IconSaturn02DuotoneRounded,
  IconSaturn02TwotoneRounded,
  IconSaturn02SolidRounded,
  IconSaturn02BulkRounded,
  IconSaturn02StrokeSharp,
  IconSaturn02SolidSharp,
];