...
export const IconShoppingBasketAdd02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketAdd02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShoppingBasketAdd02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketAdd02 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconShoppingBasketAdd02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketAdd02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconShoppingBasketAdd02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketAdd02 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconShoppingBasketAdd02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketAdd02 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconShoppingBasketAdd02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketAdd02 StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sw"
...
export const IconShoppingBasketAdd02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketAdd02 SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfShoppingBasketAdd02: TheIconSelfPack = [
  'ShoppingBasketAdd02',
  IconShoppingBasketAdd02StrokeRounded,
  IconShoppingBasketAdd02DuotoneRounded,
  IconShoppingBasketAdd02TwotoneRounded,
  IconShoppingBasketAdd02SolidRounded,
  IconShoppingBasketAdd02BulkRounded,
  IconShoppingBasketAdd02StrokeSharp,
  IconShoppingBasketAdd02SolidSharp,
];