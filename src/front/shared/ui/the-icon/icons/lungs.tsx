...
export const iconPackOfLungs: TheIconSelfPack = [
  'Lungs',
  IconLungsStrokeRounded,
  IconLungsDuotoneRounded,
  IconLungsTwotoneRounded,
  IconLungsSolidRounded,
  IconLungsBulkRounded,
  IconLungsStrokeSharp,
  IconLungsSolidSharp,
];