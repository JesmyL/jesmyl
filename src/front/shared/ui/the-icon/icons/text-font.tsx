...
export const IconTextFontStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextFont StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTextFontDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextFont DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconTextFontTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextFont TwotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="s sr sw"
...
export const IconTextFontSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextFont SolidRounded"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfTextFont: TheIconSelfPack = [
  'TextFont',
  IconTextFontStrokeRounded,
  IconTextFontDuotoneRounded,
  IconTextFontTwotoneRounded,
  IconTextFontSolidRounded,
  IconTextFontBulkRounded,
  IconTextFontStrokeSharp,
  IconTextFontSolidSharp,
];