...
export const IconBookshelf01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookshelf01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBookshelf01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookshelf01 DuotoneRounded"
    >
      <path 
        d={d.d10}
        i-c="f o7"
...
export const IconBookshelf01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookshelf01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBookshelf01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookshelf01 SolidRounded"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const IconBookshelf01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookshelf01 BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d13}
...
export const IconBookshelf01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookshelf01 StrokeSharp"
    >
      <path 
        d={d.d24}
        i-c="s sj sw"
...
export const IconBookshelf01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookshelf01 SolidSharp"
    >
      <path 
        d={d.d31}
        i-c="c f fr"
...
export const iconPackOfBookshelf01: TheIconSelfPack = [
  'Bookshelf01',
  IconBookshelf01StrokeRounded,
  IconBookshelf01DuotoneRounded,
  IconBookshelf01TwotoneRounded,
  IconBookshelf01SolidRounded,
  IconBookshelf01BulkRounded,
  IconBookshelf01StrokeSharp,
  IconBookshelf01SolidSharp,
];