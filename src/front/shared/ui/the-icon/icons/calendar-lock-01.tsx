...
export const IconCalendarLock01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarLock01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCalendarLock01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarLock01 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconCalendarLock01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarLock01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCalendarLock01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarLock01 SolidRounded"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const IconCalendarLock01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarLock01 BulkRounded"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const IconCalendarLock01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarLock01 StrokeSharp"
    >
      <path 
        d={d.d14}
        i-c="s sj sw"
...
export const IconCalendarLock01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarLock01 SolidSharp"
    >
      <path 
        d={d.d18}
        i-c="f"
...
export const iconPackOfCalendarLock01: TheIconSelfPack = [
  'CalendarLock01',
  IconCalendarLock01StrokeRounded,
  IconCalendarLock01DuotoneRounded,
  IconCalendarLock01TwotoneRounded,
  IconCalendarLock01SolidRounded,
  IconCalendarLock01BulkRounded,
  IconCalendarLock01StrokeSharp,
  IconCalendarLock01SolidSharp,
];