...
export const IconAccessDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Access DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconAccessTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Access TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfAccess: TheIconSelfPack = [
  'Access',
  IconAccessStrokeRounded,
  IconAccessDuotoneRounded,
  IconAccessTwotoneRounded,
  IconAccessSolidRounded,
  IconAccessBulkRounded,
  IconAccessStrokeSharp,
  IconAccessSolidSharp,
];