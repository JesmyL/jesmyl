...
export const IconLamp04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Lamp04 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconLamp04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Lamp04 TwotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="o7 s sr sw"
...
export const iconPackOfLamp04: TheIconSelfPack = [
  'Lamp04',
  IconLamp04StrokeRounded,
  IconLamp04DuotoneRounded,
  IconLamp04TwotoneRounded,
  IconLamp04SolidRounded,
  IconLamp04BulkRounded,
  IconLamp04StrokeSharp,
  IconLamp04SolidSharp,
];