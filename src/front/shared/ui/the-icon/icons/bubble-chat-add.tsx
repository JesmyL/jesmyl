...
export const IconBubbleChatAddStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BubbleChatAdd StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBubbleChatAddDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BubbleChatAdd DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconBubbleChatAddTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BubbleChatAdd TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBubbleChatAddSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BubbleChatAdd SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconBubbleChatAddBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BubbleChatAdd BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconBubbleChatAddStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BubbleChatAdd StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const IconBubbleChatAddSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BubbleChatAdd SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfBubbleChatAdd: TheIconSelfPack = [
  'BubbleChatAdd',
  IconBubbleChatAddStrokeRounded,
  IconBubbleChatAddDuotoneRounded,
  IconBubbleChatAddTwotoneRounded,
  IconBubbleChatAddSolidRounded,
  IconBubbleChatAddBulkRounded,
  IconBubbleChatAddStrokeSharp,
  IconBubbleChatAddSolidSharp,
];