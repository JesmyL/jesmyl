...
export const IconTransitionLeftStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TransitionLeft StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconTransitionLeftDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TransitionLeft DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconTransitionLeftTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TransitionLeft TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconTransitionLeftSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TransitionLeft SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconTransitionLeftBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TransitionLeft BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconTransitionLeftStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TransitionLeft StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconTransitionLeftSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TransitionLeft SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfTransitionLeft: TheIconSelfPack = [
  'TransitionLeft',
  IconTransitionLeftStrokeRounded,
  IconTransitionLeftDuotoneRounded,
  IconTransitionLeftTwotoneRounded,
  IconTransitionLeftSolidRounded,
  IconTransitionLeftBulkRounded,
  IconTransitionLeftStrokeSharp,
  IconTransitionLeftSolidSharp,
];