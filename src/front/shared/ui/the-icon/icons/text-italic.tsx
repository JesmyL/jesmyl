...
export const IconTextItalicStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextItalic StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconTextItalicDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextItalic DuotoneRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d1}
...
export const IconTextItalicTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextItalic TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconTextItalicSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextItalic SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconTextItalicBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextItalic BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconTextItalicStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextItalic StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const IconTextItalicSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextItalic SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfTextItalic: TheIconSelfPack = [
  'TextItalic',
  IconTextItalicStrokeRounded,
  IconTextItalicDuotoneRounded,
  IconTextItalicTwotoneRounded,
  IconTextItalicSolidRounded,
  IconTextItalicBulkRounded,
  IconTextItalicStrokeSharp,
  IconTextItalicSolidSharp,
];