...
export const IconThermometerWarmStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ThermometerWarm StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconThermometerWarmDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ThermometerWarm DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconThermometerWarmTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ThermometerWarm TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconThermometerWarmSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ThermometerWarm SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconThermometerWarmBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ThermometerWarm BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconThermometerWarmStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ThermometerWarm StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const IconThermometerWarmSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ThermometerWarm SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const iconPackOfThermometerWarm: TheIconSelfPack = [
  'ThermometerWarm',
  IconThermometerWarmStrokeRounded,
  IconThermometerWarmDuotoneRounded,
  IconThermometerWarmTwotoneRounded,
  IconThermometerWarmSolidRounded,
  IconThermometerWarmBulkRounded,
  IconThermometerWarmStrokeSharp,
  IconThermometerWarmSolidSharp,
];