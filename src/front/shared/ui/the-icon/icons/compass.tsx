...
export const IconCompassStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Compass StrokeRounded"
    >
      <circle 
        cx="12"
        cy="13"
...
export const IconCompassDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Compass DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="13"
...
export const IconCompassTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Compass TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="13"
...
export const iconPackOfCompass: TheIconSelfPack = [
  'Compass',
  IconCompassStrokeRounded,
  IconCompassDuotoneRounded,
  IconCompassTwotoneRounded,
  IconCompassSolidRounded,
  IconCompassBulkRounded,
  IconCompassStrokeSharp,
  IconCompassSolidSharp,
];