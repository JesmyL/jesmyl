...
export const IconLoading02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Loading02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconLoading02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Loading02 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7 s sr sw"
...
export const IconLoading02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Loading02 TwotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="s sr sw"
...
export const IconLoading02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Loading02 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f s sr sw"
...
export const IconLoading02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Loading02 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7 s sr sw"
...
export const IconLoading02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Loading02 StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sw"
...
export const iconPackOfLoading02: TheIconSelfPack = [
  'Loading02',
  IconLoading02StrokeRounded,
  IconLoading02DuotoneRounded,
  IconLoading02TwotoneRounded,
  IconLoading02SolidRounded,
  IconLoading02BulkRounded,
  IconLoading02StrokeSharp,
  IconLoading02SolidSharp,
];