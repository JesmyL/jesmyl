...
export const IconCalendarBlock02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarBlock02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCalendarBlock02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarBlock02 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconCalendarBlock02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarBlock02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCalendarBlock02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarBlock02 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconCalendarBlock02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarBlock02 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconCalendarBlock02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarBlock02 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconCalendarBlock02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarBlock02 SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfCalendarBlock02: TheIconSelfPack = [
  'CalendarBlock02',
  IconCalendarBlock02StrokeRounded,
  IconCalendarBlock02DuotoneRounded,
  IconCalendarBlock02TwotoneRounded,
  IconCalendarBlock02SolidRounded,
  IconCalendarBlock02BulkRounded,
  IconCalendarBlock02StrokeSharp,
  IconCalendarBlock02SolidSharp,
];