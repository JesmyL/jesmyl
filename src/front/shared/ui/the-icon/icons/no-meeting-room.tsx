...
export const IconNoMeetingRoomStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NoMeetingRoom StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconNoMeetingRoomDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NoMeetingRoom DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconNoMeetingRoomTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NoMeetingRoom TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconNoMeetingRoomSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NoMeetingRoom SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconNoMeetingRoomBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NoMeetingRoom BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconNoMeetingRoomStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NoMeetingRoom StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconNoMeetingRoomSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NoMeetingRoom SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="f"
...
export const iconPackOfNoMeetingRoom: TheIconSelfPack = [
  'NoMeetingRoom',
  IconNoMeetingRoomStrokeRounded,
  IconNoMeetingRoomDuotoneRounded,
  IconNoMeetingRoomTwotoneRounded,
  IconNoMeetingRoomSolidRounded,
  IconNoMeetingRoomBulkRounded,
  IconNoMeetingRoomStrokeSharp,
  IconNoMeetingRoomSolidSharp,
];