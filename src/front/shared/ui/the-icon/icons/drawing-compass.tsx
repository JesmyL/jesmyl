...
export const IconDrawingCompassStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DrawingCompass StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDrawingCompassDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DrawingCompass DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="7"
...
export const IconDrawingCompassTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DrawingCompass TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDrawingCompassSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DrawingCompass SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconDrawingCompassBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DrawingCompass BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconDrawingCompassStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DrawingCompass StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sj sw"
...
export const IconDrawingCompassSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DrawingCompass SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfDrawingCompass: TheIconSelfPack = [
  'DrawingCompass',
  IconDrawingCompassStrokeRounded,
  IconDrawingCompassDuotoneRounded,
  IconDrawingCompassTwotoneRounded,
  IconDrawingCompassSolidRounded,
  IconDrawingCompassBulkRounded,
  IconDrawingCompassStrokeSharp,
  IconDrawingCompassSolidSharp,
];