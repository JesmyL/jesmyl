...
export const IconCopyLinkStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CopyLink StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconCopyLinkDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CopyLink DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconCopyLinkTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CopyLink TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconCopyLinkSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CopyLink SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const iconPackOfCopyLink: TheIconSelfPack = [
  'CopyLink',
  IconCopyLinkStrokeRounded,
  IconCopyLinkDuotoneRounded,
  IconCopyLinkTwotoneRounded,
  IconCopyLinkSolidRounded,
  IconCopyLinkBulkRounded,
  IconCopyLinkStrokeSharp,
  IconCopyLinkSolidSharp,
];