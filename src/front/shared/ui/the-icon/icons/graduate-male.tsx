...
export const IconGraduateMaleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GraduateMale StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconGraduateMaleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GraduateMale DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconGraduateMaleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GraduateMale TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconGraduateMaleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GraduateMale SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconGraduateMaleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GraduateMale BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr o7"
...
export const IconGraduateMaleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GraduateMale StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const IconGraduateMaleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GraduateMale SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfGraduateMale: TheIconSelfPack = [
  'GraduateMale',
  IconGraduateMaleStrokeRounded,
  IconGraduateMaleDuotoneRounded,
  IconGraduateMaleTwotoneRounded,
  IconGraduateMaleSolidRounded,
  IconGraduateMaleBulkRounded,
  IconGraduateMaleStrokeSharp,
  IconGraduateMaleSolidSharp,
];