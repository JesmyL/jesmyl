...
export const IconIdentityCardStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IdentityCard StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconIdentityCardDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IdentityCard DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconIdentityCardTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IdentityCard TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconIdentityCardSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IdentityCard SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconIdentityCardBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IdentityCard BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconIdentityCardStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IdentityCard StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s ss sw"
...
export const IconIdentityCardSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IdentityCard SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfIdentityCard: TheIconSelfPack = [
  'IdentityCard',
  IconIdentityCardStrokeRounded,
  IconIdentityCardDuotoneRounded,
  IconIdentityCardTwotoneRounded,
  IconIdentityCardSolidRounded,
  IconIdentityCardBulkRounded,
  IconIdentityCardStrokeSharp,
  IconIdentityCardSolidSharp,
];