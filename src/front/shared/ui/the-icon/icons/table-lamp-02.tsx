...
export const IconTableLamp02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TableLamp02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTableLamp02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TableLamp02 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconTableLamp02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TableLamp02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTableLamp02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TableLamp02 SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconTableLamp02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TableLamp02 BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d12}
...
export const IconTableLamp02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TableLamp02 StrokeSharp"
    >
      <path 
        d={d.d21}
        i-c="s sj sw"
...
export const IconTableLamp02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TableLamp02 SolidSharp"
    >
      <path 
        d={d.d29}
        i-c="c f fr"
...
export const iconPackOfTableLamp02: TheIconSelfPack = [
  'TableLamp02',
  IconTableLamp02StrokeRounded,
  IconTableLamp02DuotoneRounded,
  IconTableLamp02TwotoneRounded,
  IconTableLamp02SolidRounded,
  IconTableLamp02BulkRounded,
  IconTableLamp02StrokeSharp,
  IconTableLamp02SolidSharp,
];