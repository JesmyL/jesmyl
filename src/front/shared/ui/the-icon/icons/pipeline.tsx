...
export const IconPipelineStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pipeline StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconPipelineDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pipeline DuotoneRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d3}
...
export const IconPipelineTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pipeline TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconPipelineSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pipeline SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const iconPackOfPipeline: TheIconSelfPack = [
  'Pipeline',
  IconPipelineStrokeRounded,
  IconPipelineDuotoneRounded,
  IconPipelineTwotoneRounded,
  IconPipelineSolidRounded,
  IconPipelineBulkRounded,
  IconPipelineStrokeSharp,
  IconPipelineSolidSharp,
];