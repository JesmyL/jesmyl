...
export const IconUngroupItemsStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UngroupItems StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconUngroupItemsDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UngroupItems DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconUngroupItemsTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UngroupItems TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconUngroupItemsSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UngroupItems SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconUngroupItemsBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UngroupItems BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconUngroupItemsStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UngroupItems StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconUngroupItemsSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UngroupItems SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfUngroupItems: TheIconSelfPack = [
  'UngroupItems',
  IconUngroupItemsStrokeRounded,
  IconUngroupItemsDuotoneRounded,
  IconUngroupItemsTwotoneRounded,
  IconUngroupItemsSolidRounded,
  IconUngroupItemsBulkRounded,
  IconUngroupItemsStrokeSharp,
  IconUngroupItemsSolidSharp,
];