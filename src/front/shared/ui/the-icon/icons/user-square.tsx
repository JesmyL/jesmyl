...
export const IconUserSquareStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSquare StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconUserSquareDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSquare DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr o7"
...
export const IconUserSquareTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSquare TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconUserSquareSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSquare SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconUserSquareBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSquare BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconUserSquareStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSquare StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconUserSquareSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSquare SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfUserSquare: TheIconSelfPack = [
  'UserSquare',
  IconUserSquareStrokeRounded,
  IconUserSquareDuotoneRounded,
  IconUserSquareTwotoneRounded,
  IconUserSquareSolidRounded,
  IconUserSquareBulkRounded,
  IconUserSquareStrokeSharp,
  IconUserSquareSolidSharp,
];