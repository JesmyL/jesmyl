...
export const iconPackOfWaste: TheIconSelfPack = [
  'Waste',
  IconWasteStrokeRounded,
  IconWasteDuotoneRounded,
  IconWasteTwotoneRounded,
  IconWasteSolidRounded,
  IconWasteBulkRounded,
  IconWasteStrokeSharp,
  IconWasteSolidSharp,
];