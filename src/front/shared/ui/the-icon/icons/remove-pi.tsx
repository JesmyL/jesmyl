...
export const IconRemovePiStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RemovePi StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRemovePiDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RemovePi DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconRemovePiTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RemovePi TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRemovePiSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RemovePi SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const iconPackOfRemovePi: TheIconSelfPack = [
  'RemovePi',
  IconRemovePiStrokeRounded,
  IconRemovePiDuotoneRounded,
  IconRemovePiTwotoneRounded,
  IconRemovePiSolidRounded,
  IconRemovePiBulkRounded,
  IconRemovePiStrokeSharp,
  IconRemovePiSolidSharp,
];