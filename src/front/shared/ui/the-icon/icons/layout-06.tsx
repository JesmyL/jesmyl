...
export const IconLayout06StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout06 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLayout06DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout06 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconLayout06TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout06 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLayout06SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout06 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const iconPackOfLayout06: TheIconSelfPack = [
  'Layout06',
  IconLayout06StrokeRounded,
  IconLayout06DuotoneRounded,
  IconLayout06TwotoneRounded,
  IconLayout06SolidRounded,
  IconLayout06BulkRounded,
  IconLayout06StrokeSharp,
  IconLayout06SolidSharp,
];