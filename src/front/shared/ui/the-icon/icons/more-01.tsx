...
export const IconMore01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="More01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconMore01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="More01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfMore01: TheIconSelfPack = [
  'More01',
  IconMore01StrokeRounded,
  IconMore01DuotoneRounded,
  IconMore01TwotoneRounded,
  IconMore01SolidRounded,
  IconMore01BulkRounded,
  IconMore01StrokeSharp,
  IconMore01SolidSharp,
];