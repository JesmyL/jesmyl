...
export const IconWaitersStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Waiters StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconWaitersDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Waiters DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconWaitersTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Waiters TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfWaiters: TheIconSelfPack = [
  'Waiters',
  IconWaitersStrokeRounded,
  IconWaitersDuotoneRounded,
  IconWaitersTwotoneRounded,
  IconWaitersSolidRounded,
  IconWaitersBulkRounded,
  IconWaitersStrokeSharp,
  IconWaitersSolidSharp,
];