...
export const IconBarCode02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BarCode02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBarCode02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BarCode02 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconBarCode02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BarCode02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBarCode02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BarCode02 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconBarCode02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BarCode02 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconBarCode02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BarCode02 StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sr sw"
...
export const iconPackOfBarCode02: TheIconSelfPack = [
  'BarCode02',
  IconBarCode02StrokeRounded,
  IconBarCode02DuotoneRounded,
  IconBarCode02TwotoneRounded,
  IconBarCode02SolidRounded,
  IconBarCode02BulkRounded,
  IconBarCode02StrokeSharp,
  IconBarCode02SolidSharp,
];