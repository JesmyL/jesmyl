...
export const IconCalendarFavorite01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarFavorite01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCalendarFavorite01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarFavorite01 DuotoneRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d5}
...
export const IconCalendarFavorite01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarFavorite01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconCalendarFavorite01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarFavorite01 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconCalendarFavorite01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarFavorite01 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconCalendarFavorite01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarFavorite01 StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const IconCalendarFavorite01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarFavorite01 SolidSharp"
    >
      <path 
        d={d.d16}
        i-c="f"
...
export const iconPackOfCalendarFavorite01: TheIconSelfPack = [
  'CalendarFavorite01',
  IconCalendarFavorite01StrokeRounded,
  IconCalendarFavorite01DuotoneRounded,
  IconCalendarFavorite01TwotoneRounded,
  IconCalendarFavorite01SolidRounded,
  IconCalendarFavorite01BulkRounded,
  IconCalendarFavorite01StrokeSharp,
  IconCalendarFavorite01SolidSharp,
];