...
export const IconWorkflowSquare04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWorkflowSquare04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare04 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconWorkflowSquare04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWorkflowSquare04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare04 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconWorkflowSquare04BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare04 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconWorkflowSquare04StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare04 StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const IconWorkflowSquare04SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare04 SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="f"
...
export const iconPackOfWorkflowSquare04: TheIconSelfPack = [
  'WorkflowSquare04',
  IconWorkflowSquare04StrokeRounded,
  IconWorkflowSquare04DuotoneRounded,
  IconWorkflowSquare04TwotoneRounded,
  IconWorkflowSquare04SolidRounded,
  IconWorkflowSquare04BulkRounded,
  IconWorkflowSquare04StrokeSharp,
  IconWorkflowSquare04SolidSharp,
];