...
export const IconCoinsSwapStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsSwap StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCoinsSwapDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsSwap DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconCoinsSwapTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsSwap TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCoinsSwapSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsSwap SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconCoinsSwapBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsSwap BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconCoinsSwapStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsSwap StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfCoinsSwap: TheIconSelfPack = [
  'CoinsSwap',
  IconCoinsSwapStrokeRounded,
  IconCoinsSwapDuotoneRounded,
  IconCoinsSwapTwotoneRounded,
  IconCoinsSwapSolidRounded,
  IconCoinsSwapBulkRounded,
  IconCoinsSwapStrokeSharp,
  IconCoinsSwapSolidSharp,
];