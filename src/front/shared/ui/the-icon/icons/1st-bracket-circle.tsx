...
export const Icon1stBracketCircleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="1stBracketCircle StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const Icon1stBracketCircleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="1stBracketCircle DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const Icon1stBracketCircleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="1stBracketCircle TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const Icon1stBracketCircleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="1stBracketCircle SolidRounded"
    >
      <path 
        d={d.d2}
        i-c="c f fr"
...
export const Icon1stBracketCircleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="1stBracketCircle BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const Icon1stBracketCircleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="1stBracketCircle StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const Icon1stBracketCircleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="1stBracketCircle SolidSharp"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const iconPackOf1stBracketCircle: TheIconSelfPack = [
  '1stBracketCircle',
  Icon1stBracketCircleStrokeRounded,
  Icon1stBracketCircleDuotoneRounded,
  Icon1stBracketCircleTwotoneRounded,
  Icon1stBracketCircleSolidRounded,
  Icon1stBracketCircleBulkRounded,
  Icon1stBracketCircleStrokeSharp,
  Icon1stBracketCircleSolidSharp,
];