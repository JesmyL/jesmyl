...
export const IconEaseInDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EaseIn DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconEaseInTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EaseIn TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfEaseIn: TheIconSelfPack = [
  'EaseIn',
  IconEaseInStrokeRounded,
  IconEaseInDuotoneRounded,
  IconEaseInTwotoneRounded,
  IconEaseInSolidRounded,
  IconEaseInBulkRounded,
  IconEaseInStrokeSharp,
  IconEaseInSolidSharp,
];