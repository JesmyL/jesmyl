...
export const IconBatteriesEnergyStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BatteriesEnergy StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBatteriesEnergyDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BatteriesEnergy DuotoneRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconBatteriesEnergyTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BatteriesEnergy TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconBatteriesEnergySolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BatteriesEnergy SolidRounded"
    >
      <path 
        d={d.d18}
        i-c="c f fr"
...
export const IconBatteriesEnergyBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BatteriesEnergy BulkRounded"
    >
      <path 
        d={d.d26}
        i-c="f"
...
export const IconBatteriesEnergyStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BatteriesEnergy StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s ss sw"
...
export const IconBatteriesEnergySolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BatteriesEnergy SolidSharp"
    >
      <path 
        d={d.d35}
        i-c="c f fr"
...
export const iconPackOfBatteriesEnergy: TheIconSelfPack = [
  'BatteriesEnergy',
  IconBatteriesEnergyStrokeRounded,
  IconBatteriesEnergyDuotoneRounded,
  IconBatteriesEnergyTwotoneRounded,
  IconBatteriesEnergySolidRounded,
  IconBatteriesEnergyBulkRounded,
  IconBatteriesEnergyStrokeSharp,
  IconBatteriesEnergySolidSharp,
];