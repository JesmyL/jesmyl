...
export const IconCoinsYenStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsYen StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconCoinsYenDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsYen DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconCoinsYenTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsYen TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconCoinsYenSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsYen SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const iconPackOfCoinsYen: TheIconSelfPack = [
  'CoinsYen',
  IconCoinsYenStrokeRounded,
  IconCoinsYenDuotoneRounded,
  IconCoinsYenTwotoneRounded,
  IconCoinsYenSolidRounded,
  IconCoinsYenBulkRounded,
  IconCoinsYenStrokeSharp,
  IconCoinsYenSolidSharp,
];