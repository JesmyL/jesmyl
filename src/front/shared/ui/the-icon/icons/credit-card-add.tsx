...
export const IconCreditCardAddStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CreditCardAdd StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCreditCardAddDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CreditCardAdd DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconCreditCardAddTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CreditCardAdd TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCreditCardAddSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CreditCardAdd SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconCreditCardAddBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CreditCardAdd BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconCreditCardAddStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CreditCardAdd StrokeSharp"
    >
      <path 
        d={d.d2}
        i-c="s sj sw"
...
export const IconCreditCardAddSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CreditCardAdd SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfCreditCardAdd: TheIconSelfPack = [
  'CreditCardAdd',
  IconCreditCardAddStrokeRounded,
  IconCreditCardAddDuotoneRounded,
  IconCreditCardAddTwotoneRounded,
  IconCreditCardAddSolidRounded,
  IconCreditCardAddBulkRounded,
  IconCreditCardAddStrokeSharp,
  IconCreditCardAddSolidSharp,
];