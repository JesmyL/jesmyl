...
export const IconLockerDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Locker DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconLockerTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Locker TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfLocker: TheIconSelfPack = [
  'Locker',
  IconLockerStrokeRounded,
  IconLockerDuotoneRounded,
  IconLockerTwotoneRounded,
  IconLockerSolidRounded,
  IconLockerBulkRounded,
  IconLockerStrokeSharp,
  IconLockerSolidSharp,
];