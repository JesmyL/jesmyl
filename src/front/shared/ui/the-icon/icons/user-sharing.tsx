...
export const IconUserSharingStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSharing StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserSharingDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSharing DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconUserSharingTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSharing TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserSharingSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSharing SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconUserSharingBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSharing BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconUserSharingStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSharing StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sw"
...
export const IconUserSharingSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSharing SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfUserSharing: TheIconSelfPack = [
  'UserSharing',
  IconUserSharingStrokeRounded,
  IconUserSharingDuotoneRounded,
  IconUserSharingTwotoneRounded,
  IconUserSharingSolidRounded,
  IconUserSharingBulkRounded,
  IconUserSharingStrokeSharp,
  IconUserSharingSolidSharp,
];