...
export const IconShoppingBag01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBag01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconShoppingBag01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBag01 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconShoppingBag01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBag01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconShoppingBag01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBag01 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconShoppingBag01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBag01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconShoppingBag01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBag01 StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sw"
...
export const IconShoppingBag01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBag01 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfShoppingBag01: TheIconSelfPack = [
  'ShoppingBag01',
  IconShoppingBag01StrokeRounded,
  IconShoppingBag01DuotoneRounded,
  IconShoppingBag01TwotoneRounded,
  IconShoppingBag01SolidRounded,
  IconShoppingBag01BulkRounded,
  IconShoppingBag01StrokeSharp,
  IconShoppingBag01SolidSharp,
];