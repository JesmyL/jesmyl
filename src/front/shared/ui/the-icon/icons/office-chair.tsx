...
export const IconOfficeChairStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OfficeChair StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconOfficeChairDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OfficeChair DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconOfficeChairTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OfficeChair TwotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="s sr sw"
...
export const IconOfficeChairSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OfficeChair SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const IconOfficeChairBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OfficeChair BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconOfficeChairStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OfficeChair StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconOfficeChairSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OfficeChair SolidSharp"
    >
      <path 
        d={d.d23}
        i-c="c f fr"
...
export const iconPackOfOfficeChair: TheIconSelfPack = [
  'OfficeChair',
  IconOfficeChairStrokeRounded,
  IconOfficeChairDuotoneRounded,
  IconOfficeChairTwotoneRounded,
  IconOfficeChairSolidRounded,
  IconOfficeChairBulkRounded,
  IconOfficeChairStrokeSharp,
  IconOfficeChairSolidSharp,
];