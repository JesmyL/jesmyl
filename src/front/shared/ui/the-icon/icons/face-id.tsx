...
export const IconFaceIdDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FaceId DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconFaceIdTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FaceId TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfFaceId: TheIconSelfPack = [
  'FaceId',
  IconFaceIdStrokeRounded,
  IconFaceIdDuotoneRounded,
  IconFaceIdTwotoneRounded,
  IconFaceIdSolidRounded,
  IconFaceIdBulkRounded,
  IconFaceIdStrokeSharp,
  IconFaceIdSolidSharp,
];