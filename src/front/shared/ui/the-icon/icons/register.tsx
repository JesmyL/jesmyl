...
export const IconRegisterStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Register StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconRegisterDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Register DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconRegisterTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Register TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconRegisterSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Register SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const iconPackOfRegister: TheIconSelfPack = [
  'Register',
  IconRegisterStrokeRounded,
  IconRegisterDuotoneRounded,
  IconRegisterTwotoneRounded,
  IconRegisterSolidRounded,
  IconRegisterBulkRounded,
  IconRegisterStrokeSharp,
  IconRegisterSolidSharp,
];