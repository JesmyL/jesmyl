...
export const IconWirelessStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wireless StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconWirelessDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wireless DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconWirelessTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wireless TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconWirelessSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wireless SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfWireless: TheIconSelfPack = [
  'Wireless',
  IconWirelessStrokeRounded,
  IconWirelessDuotoneRounded,
  IconWirelessTwotoneRounded,
  IconWirelessSolidRounded,
  IconWirelessBulkRounded,
  IconWirelessStrokeSharp,
  IconWirelessSolidSharp,
];