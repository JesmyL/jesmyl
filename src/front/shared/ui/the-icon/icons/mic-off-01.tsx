...
export const IconMicOff01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MicOff01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconMicOff01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MicOff01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconMicOff01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MicOff01 TwotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="o7 s sr sw"
...
export const IconMicOff01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MicOff01 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfMicOff01: TheIconSelfPack = [
  'MicOff01',
  IconMicOff01StrokeRounded,
  IconMicOff01DuotoneRounded,
  IconMicOff01TwotoneRounded,
  IconMicOff01SolidRounded,
  IconMicOff01BulkRounded,
  IconMicOff01StrokeSharp,
  IconMicOff01SolidSharp,
];