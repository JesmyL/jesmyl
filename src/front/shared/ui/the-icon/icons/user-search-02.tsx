...
export const IconUserSearch02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSearch02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserSearch02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSearch02 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconUserSearch02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSearch02 TwotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="s sj sr sw"
...
export const IconUserSearch02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSearch02 SolidRounded"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const IconUserSearch02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSearch02 BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d11}
...
export const IconUserSearch02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSearch02 StrokeSharp"
    >
      <path 
        d={d.d14}
        i-c="s sw"
...
export const IconUserSearch02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSearch02 SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="f"
...
export const iconPackOfUserSearch02: TheIconSelfPack = [
  'UserSearch02',
  IconUserSearch02StrokeRounded,
  IconUserSearch02DuotoneRounded,
  IconUserSearch02TwotoneRounded,
  IconUserSearch02SolidRounded,
  IconUserSearch02BulkRounded,
  IconUserSearch02StrokeSharp,
  IconUserSearch02SolidSharp,
];