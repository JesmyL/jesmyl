...
export const iconPackOfEggs: TheIconSelfPack = [
  'Eggs',
  IconEggsStrokeRounded,
  IconEggsDuotoneRounded,
  IconEggsTwotoneRounded,
  IconEggsSolidRounded,
  IconEggsBulkRounded,
  IconEggsStrokeSharp,
  IconEggsSolidSharp,
];