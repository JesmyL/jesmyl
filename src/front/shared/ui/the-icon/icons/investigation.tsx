...
export const IconInvestigationStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Investigation StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconInvestigationDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Investigation DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconInvestigationTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Investigation TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconInvestigationSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Investigation SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconInvestigationBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Investigation BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconInvestigationStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Investigation StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sw"
...
export const IconInvestigationSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Investigation SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfInvestigation: TheIconSelfPack = [
  'Investigation',
  IconInvestigationStrokeRounded,
  IconInvestigationDuotoneRounded,
  IconInvestigationTwotoneRounded,
  IconInvestigationSolidRounded,
  IconInvestigationBulkRounded,
  IconInvestigationStrokeSharp,
  IconInvestigationSolidSharp,
];