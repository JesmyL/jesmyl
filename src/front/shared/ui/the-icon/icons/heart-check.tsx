...
export const IconHeartCheckStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HeartCheck StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconHeartCheckDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HeartCheck DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconHeartCheckTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HeartCheck TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconHeartCheckSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HeartCheck SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconHeartCheckBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HeartCheck BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconHeartCheckStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HeartCheck StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const IconHeartCheckSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HeartCheck SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfHeartCheck: TheIconSelfPack = [
  'HeartCheck',
  IconHeartCheckStrokeRounded,
  IconHeartCheckDuotoneRounded,
  IconHeartCheckTwotoneRounded,
  IconHeartCheckSolidRounded,
  IconHeartCheckBulkRounded,
  IconHeartCheckStrokeSharp,
  IconHeartCheckSolidSharp,
];