...
export const IconIrisScanStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IrisScan StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconIrisScanDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IrisScan DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconIrisScanTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IrisScan TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconIrisScanSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IrisScan SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const iconPackOfIrisScan: TheIconSelfPack = [
  'IrisScan',
  IconIrisScanStrokeRounded,
  IconIrisScanDuotoneRounded,
  IconIrisScanTwotoneRounded,
  IconIrisScanSolidRounded,
  IconIrisScanBulkRounded,
  IconIrisScanStrokeSharp,
  IconIrisScanSolidSharp,
];