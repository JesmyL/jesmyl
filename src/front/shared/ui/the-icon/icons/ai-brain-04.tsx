...
export const IconAiBrain04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiBrain04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAiBrain04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiBrain04 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconAiBrain04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiBrain04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAiBrain04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiBrain04 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconAiBrain04BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiBrain04 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconAiBrain04StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiBrain04 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfAiBrain04: TheIconSelfPack = [
  'AiBrain04',
  IconAiBrain04StrokeRounded,
  IconAiBrain04DuotoneRounded,
  IconAiBrain04TwotoneRounded,
  IconAiBrain04SolidRounded,
  IconAiBrain04BulkRounded,
  IconAiBrain04StrokeSharp,
  IconAiBrain04SolidSharp,
];