...
export const IconLeftAngleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftAngle StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLeftAngleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftAngle DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o4"
...
export const IconLeftAngleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftAngle TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLeftAngleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftAngle SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconLeftAngleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftAngle BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconLeftAngleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftAngle StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const iconPackOfLeftAngle: TheIconSelfPack = [
  'LeftAngle',
  IconLeftAngleStrokeRounded,
  IconLeftAngleDuotoneRounded,
  IconLeftAngleTwotoneRounded,
  IconLeftAngleSolidRounded,
  IconLeftAngleBulkRounded,
  IconLeftAngleStrokeSharp,
  IconLeftAngleSolidSharp,
];