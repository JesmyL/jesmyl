...
export const IconTextTrackingStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextTracking StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTextTrackingDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextTracking DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconTextTrackingTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextTracking TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconTextTrackingSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextTracking SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconTextTrackingBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextTracking BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconTextTrackingStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextTracking StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sw"
...
export const IconTextTrackingSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextTracking SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfTextTracking: TheIconSelfPack = [
  'TextTracking',
  IconTextTrackingStrokeRounded,
  IconTextTrackingDuotoneRounded,
  IconTextTrackingTwotoneRounded,
  IconTextTrackingSolidRounded,
  IconTextTrackingBulkRounded,
  IconTextTrackingStrokeSharp,
  IconTextTrackingSolidSharp,
];