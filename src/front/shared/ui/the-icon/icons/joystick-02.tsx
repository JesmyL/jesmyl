...
export const IconJoystick02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconJoystick02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconJoystick02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconJoystick02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick02 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconJoystick02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick02 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconJoystick02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick02 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconJoystick02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick02 SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="f"
...
export const iconPackOfJoystick02: TheIconSelfPack = [
  'Joystick02',
  IconJoystick02StrokeRounded,
  IconJoystick02DuotoneRounded,
  IconJoystick02TwotoneRounded,
  IconJoystick02SolidRounded,
  IconJoystick02BulkRounded,
  IconJoystick02StrokeSharp,
  IconJoystick02SolidSharp,
];