...
export const IconConstellationStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Constellation StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconConstellationDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Constellation DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconConstellationTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Constellation TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconConstellationSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Constellation SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconConstellationBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Constellation BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d7}
...
export const IconConstellationStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Constellation StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconConstellationSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Constellation SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const iconPackOfConstellation: TheIconSelfPack = [
  'Constellation',
  IconConstellationStrokeRounded,
  IconConstellationDuotoneRounded,
  IconConstellationTwotoneRounded,
  IconConstellationSolidRounded,
  IconConstellationBulkRounded,
  IconConstellationStrokeSharp,
  IconConstellationSolidSharp,
];