...
export const IconBitcoinSearchStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinSearch StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBitcoinSearchDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinSearch DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconBitcoinSearchTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinSearch TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBitcoinSearchSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinSearch SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconBitcoinSearchBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinSearch BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr o7"
...
export const IconBitcoinSearchStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinSearch StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconBitcoinSearchSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinSearch SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfBitcoinSearch: TheIconSelfPack = [
  'BitcoinSearch',
  IconBitcoinSearchStrokeRounded,
  IconBitcoinSearchDuotoneRounded,
  IconBitcoinSearchTwotoneRounded,
  IconBitcoinSearchSolidRounded,
  IconBitcoinSearchBulkRounded,
  IconBitcoinSearchStrokeSharp,
  IconBitcoinSearchSolidSharp,
];