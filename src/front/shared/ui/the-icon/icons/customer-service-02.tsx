...
export const IconCustomerService02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CustomerService02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconCustomerService02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CustomerService02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconCustomerService02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CustomerService02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconCustomerService02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CustomerService02 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconCustomerService02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CustomerService02 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconCustomerService02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CustomerService02 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sw"
...
export const IconCustomerService02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CustomerService02 SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const iconPackOfCustomerService02: TheIconSelfPack = [
  'CustomerService02',
  IconCustomerService02StrokeRounded,
  IconCustomerService02DuotoneRounded,
  IconCustomerService02TwotoneRounded,
  IconCustomerService02SolidRounded,
  IconCustomerService02BulkRounded,
  IconCustomerService02StrokeSharp,
  IconCustomerService02SolidSharp,
];