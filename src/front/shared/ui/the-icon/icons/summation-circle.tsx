...
export const IconSummationCircleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SummationCircle StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSummationCircleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SummationCircle DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconSummationCircleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SummationCircle TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconSummationCircleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SummationCircle SolidRounded"
    >
      <path 
        d={d.d2}
        i-c="c f fr"
...
export const IconSummationCircleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SummationCircle BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconSummationCircleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SummationCircle StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sw"
...
export const IconSummationCircleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SummationCircle SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfSummationCircle: TheIconSelfPack = [
  'SummationCircle',
  IconSummationCircleStrokeRounded,
  IconSummationCircleDuotoneRounded,
  IconSummationCircleTwotoneRounded,
  IconSummationCircleSolidRounded,
  IconSummationCircleBulkRounded,
  IconSummationCircleStrokeSharp,
  IconSummationCircleSolidSharp,
];