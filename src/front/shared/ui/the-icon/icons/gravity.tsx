...
export const IconGravityStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Gravity StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGravityDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Gravity DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconGravityTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Gravity TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfGravity: TheIconSelfPack = [
  'Gravity',
  IconGravityStrokeRounded,
  IconGravityDuotoneRounded,
  IconGravityTwotoneRounded,
  IconGravitySolidRounded,
  IconGravityBulkRounded,
  IconGravityStrokeSharp,
  IconGravitySolidSharp,
];