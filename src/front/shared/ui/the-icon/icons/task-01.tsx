...
export const IconTask01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Task01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconTask01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Task01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const iconPackOfTask01: TheIconSelfPack = [
  ...
  IconTask01DuotoneRounded,
  IconTask01TwotoneRounded,
  IconTask01SolidRounded,
  IconTask01BulkRounded,
  IconTask01StrokeSharp,
  IconTask01SolidSharp,
];