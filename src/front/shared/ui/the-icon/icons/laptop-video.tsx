...
export const IconLaptopVideoStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopVideo StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLaptopVideoDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopVideo DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconLaptopVideoTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopVideo TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLaptopVideoSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopVideo SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconLaptopVideoBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopVideo BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconLaptopVideoStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopVideo StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const IconLaptopVideoSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopVideo SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfLaptopVideo: TheIconSelfPack = [
  'LaptopVideo',
  IconLaptopVideoStrokeRounded,
  IconLaptopVideoDuotoneRounded,
  IconLaptopVideoTwotoneRounded,
  IconLaptopVideoSolidRounded,
  IconLaptopVideoBulkRounded,
  IconLaptopVideoStrokeSharp,
  IconLaptopVideoSolidSharp,
];