...
export const IconSidebarLeft01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarLeft01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconSidebarLeft01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarLeft01 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconSidebarLeft01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarLeft01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconSidebarLeft01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarLeft01 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconSidebarLeft01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarLeft01 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconSidebarLeft01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarLeft01 StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sw"
...
export const IconSidebarLeft01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarLeft01 SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfSidebarLeft01: TheIconSelfPack = [
  'SidebarLeft01',
  IconSidebarLeft01StrokeRounded,
  IconSidebarLeft01DuotoneRounded,
  IconSidebarLeft01TwotoneRounded,
  IconSidebarLeft01SolidRounded,
  IconSidebarLeft01BulkRounded,
  IconSidebarLeft01StrokeSharp,
  IconSidebarLeft01SolidSharp,
];