...
export const IconLocation10StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location10 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLocation10DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location10 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="s sr sw"
...
export const IconLocation10TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location10 TwotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="o7 s sr sw"
...
export const IconLocation10SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location10 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconLocation10BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location10 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconLocation10StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location10 StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const IconLocation10SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location10 SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfLocation10: TheIconSelfPack = [
  'Location10',
  IconLocation10StrokeRounded,
  IconLocation10DuotoneRounded,
  IconLocation10TwotoneRounded,
  IconLocation10SolidRounded,
  IconLocation10BulkRounded,
  IconLocation10StrokeSharp,
  IconLocation10SolidSharp,
];