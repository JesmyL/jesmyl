...
export const IconUserArrowLeftRightStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserArrowLeftRight StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserArrowLeftRightDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserArrowLeftRight DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconUserArrowLeftRightTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserArrowLeftRight TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserArrowLeftRightSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserArrowLeftRight SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconUserArrowLeftRightBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserArrowLeftRight BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d5}
...
export const IconUserArrowLeftRightStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserArrowLeftRight StrokeSharp"
    >
      <path 
        d={d.d2}
        i-c="s sw"
...
export const IconUserArrowLeftRightSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserArrowLeftRight SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="f"
...
export const iconPackOfUserArrowLeftRight: TheIconSelfPack = [
  'UserArrowLeftRight',
  IconUserArrowLeftRightStrokeRounded,
  IconUserArrowLeftRightDuotoneRounded,
  IconUserArrowLeftRightTwotoneRounded,
  IconUserArrowLeftRightSolidRounded,
  IconUserArrowLeftRightBulkRounded,
  IconUserArrowLeftRightStrokeSharp,
  IconUserArrowLeftRightSolidSharp,
];