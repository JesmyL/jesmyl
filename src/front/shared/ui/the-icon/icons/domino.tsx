...
export const IconDominoDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Domino DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconDominoTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Domino TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfDomino: TheIconSelfPack = [
  'Domino',
  IconDominoStrokeRounded,
  IconDominoDuotoneRounded,
  IconDominoTwotoneRounded,
  IconDominoSolidRounded,
  IconDominoBulkRounded,
  IconDominoStrokeSharp,
  IconDominoSolidSharp,
];