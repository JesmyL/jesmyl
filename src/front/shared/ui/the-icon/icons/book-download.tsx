...
export const IconBookDownloadStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookDownload StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconBookDownloadDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookDownload DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconBookDownloadTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookDownload TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconBookDownloadSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookDownload SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconBookDownloadBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookDownload BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr o7"
...
export const IconBookDownloadStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookDownload StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const IconBookDownloadSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookDownload SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfBookDownload: TheIconSelfPack = [
  'BookDownload',
  IconBookDownloadStrokeRounded,
  IconBookDownloadDuotoneRounded,
  IconBookDownloadTwotoneRounded,
  IconBookDownloadSolidRounded,
  IconBookDownloadBulkRounded,
  IconBookDownloadStrokeSharp,
  IconBookDownloadSolidSharp,
];