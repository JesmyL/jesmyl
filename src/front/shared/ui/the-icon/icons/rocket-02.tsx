...
export const IconRocket02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Rocket02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconRocket02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Rocket02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconRocket02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Rocket02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconRocket02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Rocket02 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const iconPackOfRocket02: TheIconSelfPack = [
  'Rocket02',
  IconRocket02StrokeRounded,
  IconRocket02DuotoneRounded,
  IconRocket02TwotoneRounded,
  IconRocket02SolidRounded,
  IconRocket02BulkRounded,
  IconRocket02StrokeSharp,
  IconRocket02SolidSharp,
];