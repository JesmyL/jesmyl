...
export const IconHeading03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Heading03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHeading03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Heading03 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHeading03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Heading03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHeading03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Heading03 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconHeading03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Heading03 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconHeading03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Heading03 StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const iconPackOfHeading03: TheIconSelfPack = [
  'Heading03',
  IconHeading03StrokeRounded,
  IconHeading03DuotoneRounded,
  IconHeading03TwotoneRounded,
  IconHeading03SolidRounded,
  IconHeading03BulkRounded,
  IconHeading03StrokeSharp,
  IconHeading03SolidSharp,
];