...
export const IconPresentation07StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation07 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPresentation07DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation07 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconPresentation07TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation07 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPresentation07SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation07 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconPresentation07BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation07 BulkRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const IconPresentation07StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation07 StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sw"
...
export const IconPresentation07SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation07 SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="f"
...
export const iconPackOfPresentation07: TheIconSelfPack = [
  'Presentation07',
  IconPresentation07StrokeRounded,
  IconPresentation07DuotoneRounded,
  IconPresentation07TwotoneRounded,
  IconPresentation07SolidRounded,
  IconPresentation07BulkRounded,
  IconPresentation07StrokeSharp,
  IconPresentation07SolidSharp,
];