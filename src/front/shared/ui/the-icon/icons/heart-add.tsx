...
export const IconHeartAddStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HeartAdd StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconHeartAddDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HeartAdd DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconHeartAddTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HeartAdd TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconHeartAddSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HeartAdd SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const iconPackOfHeartAdd: TheIconSelfPack = [
  'HeartAdd',
  IconHeartAddStrokeRounded,
  IconHeartAddDuotoneRounded,
  IconHeartAddTwotoneRounded,
  IconHeartAddSolidRounded,
  IconHeartAddBulkRounded,
  IconHeartAddStrokeSharp,
  IconHeartAddSolidSharp,
];