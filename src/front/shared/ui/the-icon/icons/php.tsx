...
export const iconPackOfPhp: TheIconSelfPack = [
  'Php',
  IconPhpStrokeRounded,
  IconPhpDuotoneRounded,
  IconPhpTwotoneRounded,
  IconPhpSolidRounded,
  IconPhpBulkRounded,
  IconPhpStrokeSharp,
  IconPhpSolidSharp,
