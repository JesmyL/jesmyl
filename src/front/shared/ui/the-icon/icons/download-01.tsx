...
export const IconDownload01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDownload01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconDownload01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDownload01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download01 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconDownload01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download01 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconDownload01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download01 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconDownload01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download01 SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfDownload01: TheIconSelfPack = [
  'Download01',
  IconDownload01StrokeRounded,
  IconDownload01DuotoneRounded,
  IconDownload01TwotoneRounded,
  IconDownload01SolidRounded,
  IconDownload01BulkRounded,
  IconDownload01StrokeSharp,
  IconDownload01SolidSharp,
];