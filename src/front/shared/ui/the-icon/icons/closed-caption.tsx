...
export const IconClosedCaptionDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="closed-caption-duotone-rounded IconClosedCaptionDuotoneRounded"
    >
      <path 
...
export const IconClosedCaptionTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="closed-caption-twotone-rounded IconClosedCaptionTwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconClosedCaptionSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="closed-caption-solid-rounded IconClosedCaptionSolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconClosedCaptionBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="closed-caption-bulk-rounded IconClosedCaptionBulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d4} 
...
export const IconClosedCaptionStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="closed-caption-stroke-sharp IconClosedCaptionStrokeSharp"
    >
      <path 
        d={d.d6} 
        stroke="var(--icon-stroke)" 
...
export const IconClosedCaptionSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="closed-caption-solid-sharp IconClosedCaptionSolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfClosedCaption: TheIconSelfPack = {
  name: 'ClosedCaption',
  StrokeRounded: IconClosedCaptionStrokeRounded,
  DuotoneRounded: IconClosedCaptionDuotoneRounded,
  TwotoneRounded: IconClosedCaptionTwotoneRounded,
  SolidRounded: IconClosedCaptionSolidRounded,
  BulkRounded: IconClosedCaptionBulkRounded,
  StrokeSharp: IconClosedCaptionStrokeSharp,
  SolidSharp: IconClosedCaptionSolidSharp,
};