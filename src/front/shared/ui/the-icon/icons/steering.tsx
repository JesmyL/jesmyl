...
export const IconSteeringStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Steering StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSteeringDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Steering DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconSteeringTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Steering TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSteeringSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Steering SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const iconPackOfSteering: TheIconSelfPack = [
  'Steering',
  IconSteeringStrokeRounded,
  IconSteeringDuotoneRounded,
  IconSteeringTwotoneRounded,
  IconSteeringSolidRounded,
  IconSteeringBulkRounded,
  IconSteeringStrokeSharp,
  IconSteeringSolidSharp,
];