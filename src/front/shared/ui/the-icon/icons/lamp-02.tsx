...
export const IconLamp02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Lamp02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconLamp02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Lamp02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfLamp02: TheIconSelfPack = [
  'Lamp02',
  IconLamp02StrokeRounded,
  IconLamp02DuotoneRounded,
  IconLamp02TwotoneRounded,
  IconLamp02SolidRounded,
  IconLamp02BulkRounded,
  IconLamp02StrokeSharp,
  IconLamp02SolidSharp,
];