...
export const IconPlug02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Plug02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPlug02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Plug02 TwotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="s sj sr sw"
...
export const iconPackOfPlug02: TheIconSelfPack = [
  'Plug02',
  IconPlug02StrokeRounded,
  IconPlug02DuotoneRounded,
  IconPlug02TwotoneRounded,
  IconPlug02SolidRounded,
  IconPlug02BulkRounded,
  IconPlug02StrokeSharp,
  IconPlug02SolidSharp,
];