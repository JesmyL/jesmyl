...
export const IconLayout07StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout07 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLayout07DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout07 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconLayout07TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout07 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLayout07SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout07 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const iconPackOfLayout07: TheIconSelfPack = [
  'Layout07',
  IconLayout07StrokeRounded,
  IconLayout07DuotoneRounded,
  IconLayout07TwotoneRounded,
  IconLayout07SolidRounded,
  IconLayout07BulkRounded,
  IconLayout07StrokeSharp,
  IconLayout07SolidSharp,
];