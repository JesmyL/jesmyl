...
export const IconStructure02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Structure02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconStructure02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Structure02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconStructure02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Structure02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconStructure02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Structure02 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconStructure02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Structure02 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconStructure02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Structure02 StrokeSharp"
    >
      <path 
        d={d.d15}
        i-c="s sj sw"
...
export const IconStructure02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Structure02 SolidSharp"
    >
      <path 
        d={d.d19}
        i-c="f"
...
export const iconPackOfStructure02: TheIconSelfPack = [
  'Structure02',
  IconStructure02StrokeRounded,
  IconStructure02DuotoneRounded,
  IconStructure02TwotoneRounded,
  IconStructure02SolidRounded,
  IconStructure02BulkRounded,
  IconStructure02StrokeSharp,
  IconStructure02SolidSharp,
];