...
export const IconBreastPumpStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BreastPump StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBreastPumpDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BreastPump DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconBreastPumpTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BreastPump TwotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="s sj sr sw"
...
export const IconBreastPumpSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BreastPump SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconBreastPumpBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BreastPump BulkRounded"
    >
      <path 
        d={d.d12}
        i-c="f o7"
...
export const IconBreastPumpStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BreastPump StrokeSharp"
    >
      <path 
        d={d.d16}
        i-c="s sj sr sw"
...
export const IconBreastPumpSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BreastPump SolidSharp"
    >
      <path 
        d={d.d19}
        i-c="c f fr"
...
export const iconPackOfBreastPump: TheIconSelfPack = [
  'BreastPump',
  IconBreastPumpStrokeRounded,
  IconBreastPumpDuotoneRounded,
  IconBreastPumpTwotoneRounded,
  IconBreastPumpSolidRounded,
  IconBreastPumpBulkRounded,
  IconBreastPumpStrokeSharp,
  IconBreastPumpSolidSharp,
];