...
export const IconHomeWifiStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HomeWifi StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHomeWifiDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HomeWifi DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconHomeWifiTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HomeWifi TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHomeWifiSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HomeWifi SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const iconPackOfHomeWifi: TheIconSelfPack = [
  'HomeWifi',
  IconHomeWifiStrokeRounded,
  IconHomeWifiDuotoneRounded,
  IconHomeWifiTwotoneRounded,
  IconHomeWifiSolidRounded,
  IconHomeWifiBulkRounded,
  IconHomeWifiStrokeSharp,
  IconHomeWifiSolidSharp,
];