...
export const IconPotionDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Potion DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconPotionTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Potion TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfPotion: TheIconSelfPack = [
  'Potion',
  IconPotionStrokeRounded,
  IconPotionDuotoneRounded,
  IconPotionTwotoneRounded,
  IconPotionSolidRounded,
  IconPotionBulkRounded,
  IconPotionStrokeSharp,
  IconPotionSolidSharp,
];