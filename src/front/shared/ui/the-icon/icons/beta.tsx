...
export const iconPackOfBeta: TheIconSelfPack = [
  'Beta',
  IconBetaStrokeRounded,
  IconBetaDuotoneRounded,
  IconBetaTwotoneRounded,
  IconBetaSolidRounded,
  IconBetaBulkRounded,
  IconBetaStrokeSharp,
  IconBetaSolidSharp,
];