...
export const IconBookBookmark02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookBookmark02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconBookBookmark02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookBookmark02 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconBookBookmark02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookBookmark02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconBookBookmark02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookBookmark02 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconBookBookmark02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookBookmark02 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr o7"
...
export const IconBookBookmark02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookBookmark02 StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const IconBookBookmark02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookBookmark02 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfBookBookmark02: TheIconSelfPack = [
  'BookBookmark02',
  IconBookBookmark02StrokeRounded,
  IconBookBookmark02DuotoneRounded,
  IconBookBookmark02TwotoneRounded,
  IconBookBookmark02SolidRounded,
  IconBookBookmark02BulkRounded,
  IconBookBookmark02StrokeSharp,
  IconBookBookmark02SolidSharp,
];