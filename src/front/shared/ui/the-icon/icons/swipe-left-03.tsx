...
export const IconSwipeLeft03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeLeft03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSwipeLeft03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeLeft03 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconSwipeLeft03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeLeft03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSwipeLeft03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeLeft03 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconSwipeLeft03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeLeft03 BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconSwipeLeft03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeLeft03 StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sw"
...
export const IconSwipeLeft03SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeLeft03 SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const iconPackOfSwipeLeft03: TheIconSelfPack = [
  'SwipeLeft03',
  IconSwipeLeft03StrokeRounded,
  IconSwipeLeft03DuotoneRounded,
  IconSwipeLeft03TwotoneRounded,
  IconSwipeLeft03SolidRounded,
  IconSwipeLeft03BulkRounded,
  IconSwipeLeft03StrokeSharp,
  IconSwipeLeft03SolidSharp,
];