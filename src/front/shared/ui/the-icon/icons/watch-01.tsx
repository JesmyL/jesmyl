...
export const IconWatch01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Watch01 StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconWatch01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Watch01 DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconWatch01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Watch01 TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const iconPackOfWatch01: TheIconSelfPack = [
  'Watch01',
  IconWatch01StrokeRounded,
  IconWatch01DuotoneRounded,
  IconWatch01TwotoneRounded,
  IconWatch01SolidRounded,
  IconWatch01BulkRounded,
  IconWatch01StrokeSharp,
  IconWatch01SolidSharp,
];