...
export const IconStrokeBottomStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeBottom StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconStrokeBottomDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeBottom DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconStrokeBottomTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeBottom TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconStrokeBottomSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeBottom SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconStrokeBottomBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeBottom BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconStrokeBottomStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeBottom StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s ss sw"
...
export const IconStrokeBottomSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeBottom SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfStrokeBottom: TheIconSelfPack = [
  'StrokeBottom',
  IconStrokeBottomStrokeRounded,
  IconStrokeBottomDuotoneRounded,
  IconStrokeBottomTwotoneRounded,
  IconStrokeBottomSolidRounded,
  IconStrokeBottomBulkRounded,
  IconStrokeBottomStrokeSharp,
  IconStrokeBottomSolidSharp,
];