...
export const IconBuilding05StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Building05 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconBuilding05DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Building05 DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconBuilding05TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Building05 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconBuilding05SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Building05 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconBuilding05BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Building05 BulkRounded"
    >
      <path 
        d={d.d11}
        i-c="f o7"
...
export const IconBuilding05StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Building05 StrokeSharp"
    >
      <path 
        d={d.d16}
        i-c="s sj sw"
...
export const IconBuilding05SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Building05 SolidSharp"
    >
      <path 
        d={d.d21}
        i-c="c f fr"
...
export const iconPackOfBuilding05: TheIconSelfPack = [
  'Building05',
  IconBuilding05StrokeRounded,
  IconBuilding05DuotoneRounded,
  IconBuilding05TwotoneRounded,
  IconBuilding05SolidRounded,
  IconBuilding05BulkRounded,
  IconBuilding05StrokeSharp,
  IconBuilding05SolidSharp,
];