...
export const IconTradeUpStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TradeUp StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTradeUpDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TradeUp DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTradeUpTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TradeUp TwotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="o7 s sj sr sw"
...
export const iconPackOfTradeUp: TheIconSelfPack = [
  'TradeUp',
  IconTradeUpStrokeRounded,
  IconTradeUpDuotoneRounded,
  IconTradeUpTwotoneRounded,
  IconTradeUpSolidRounded,
  IconTradeUpBulkRounded,
  IconTradeUpStrokeSharp,
  IconTradeUpSolidSharp,
];