...
export const IconDropletStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Droplet StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconDropletDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Droplet DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7 s sw"
...
export const IconDropletTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Droplet TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfDroplet: TheIconSelfPack = [
  'Droplet',
  IconDropletStrokeRounded,
  IconDropletDuotoneRounded,
  IconDropletTwotoneRounded,
  IconDropletSolidRounded,
  IconDropletBulkRounded,
  IconDropletStrokeSharp,
  IconDropletSolidSharp,
];