...
export const IconPerfumeStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Perfume StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPerfumeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Perfume DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconPerfumeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Perfume TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfPerfume: TheIconSelfPack = [
  'Perfume',
  IconPerfumeStrokeRounded,
  IconPerfumeDuotoneRounded,
  IconPerfumeTwotoneRounded,
  IconPerfumeSolidRounded,
  IconPerfumeBulkRounded,
  IconPerfumeStrokeSharp,
  IconPerfumeSolidSharp,
];