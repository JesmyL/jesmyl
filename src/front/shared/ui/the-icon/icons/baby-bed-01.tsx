...
export const IconBabyBed01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BabyBed01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBabyBed01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BabyBed01 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconBabyBed01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BabyBed01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconBabyBed01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BabyBed01 SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconBabyBed01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BabyBed01 BulkRounded"
    >
      <path 
        d={d.d11}
        i-c="c f fr o7"
...
export const IconBabyBed01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BabyBed01 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfBabyBed01: TheIconSelfPack = [
  'BabyBed01',
  IconBabyBed01StrokeRounded,
  IconBabyBed01DuotoneRounded,
  IconBabyBed01TwotoneRounded,
  IconBabyBed01SolidRounded,
  IconBabyBed01BulkRounded,
  IconBabyBed01StrokeSharp,
  IconBabyBed01SolidSharp,
];