...
export const IconDiceFaces06StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces06 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDiceFaces06DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces06 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconDiceFaces06TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces06 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDiceFaces06SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces06 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconDiceFaces06BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces06 BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconDiceFaces06StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces06 StrokeSharp"
    >
      <path 
        d={d.d16}
        i-c="s ss sw"
...
export const IconDiceFaces06SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces06 SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const iconPackOfDiceFaces06: TheIconSelfPack = [
  'DiceFaces06',
  IconDiceFaces06StrokeRounded,
  IconDiceFaces06DuotoneRounded,
  IconDiceFaces06TwotoneRounded,
  IconDiceFaces06SolidRounded,
  IconDiceFaces06BulkRounded,
  IconDiceFaces06StrokeSharp,
  IconDiceFaces06SolidSharp,
];