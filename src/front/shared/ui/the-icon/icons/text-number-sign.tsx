...
export const IconTextNumberSignStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextNumberSign StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTextNumberSignDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextNumberSign DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconTextNumberSignTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextNumberSign TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTextNumberSignSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextNumberSign SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconTextNumberSignBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextNumberSign BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconTextNumberSignStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextNumberSign StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj ss sw"
...
export const IconTextNumberSignSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextNumberSign SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfTextNumberSign: TheIconSelfPack = [
  'TextNumberSign',
  IconTextNumberSignStrokeRounded,
  IconTextNumberSignDuotoneRounded,
  IconTextNumberSignTwotoneRounded,
  IconTextNumberSignSolidRounded,
  IconTextNumberSignBulkRounded,
  IconTextNumberSignStrokeSharp,
  IconTextNumberSignSolidSharp,
];