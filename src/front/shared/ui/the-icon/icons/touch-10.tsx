...
export const IconTouch10StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Touch10 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTouch10DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Touch10 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTouch10TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Touch10 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfTouch10: TheIconSelfPack = [
  'Touch10',
  IconTouch10StrokeRounded,
  IconTouch10DuotoneRounded,
  IconTouch10TwotoneRounded,
  IconTouch10SolidRounded,
  IconTouch10BulkRounded,
  IconTouch10StrokeSharp,
  IconTouch10SolidSharp,
];