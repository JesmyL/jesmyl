...
export const Icon3DViewDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="3DView DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const Icon3DViewTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="3DView TwotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="o7 s sj sw"
...
export const iconPackOf3DView: TheIconSelfPack = [
  '3DView',
  Icon3DViewStrokeRounded,
  Icon3DViewDuotoneRounded,
  Icon3DViewTwotoneRounded,
  Icon3DViewSolidRounded,
  Icon3DViewBulkRounded,
  Icon3DViewStrokeSharp,
  Icon3DViewSolidSharp,
];