...
export const IconMailRemove01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailRemove01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconMailRemove01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailRemove01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconMailRemove01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailRemove01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconMailRemove01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailRemove01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconMailRemove01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailRemove01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconMailRemove01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailRemove01 StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconMailRemove01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailRemove01 SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfMailRemove01: TheIconSelfPack = [
  'MailRemove01',
  IconMailRemove01StrokeRounded,
  IconMailRemove01DuotoneRounded,
  IconMailRemove01TwotoneRounded,
  IconMailRemove01SolidRounded,
  IconMailRemove01BulkRounded,
  IconMailRemove01StrokeSharp,
  IconMailRemove01SolidSharp,
];