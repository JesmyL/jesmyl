...
export const IconVerticalResizeStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VerticalResize StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconVerticalResizeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VerticalResize DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconVerticalResizeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VerticalResize TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconVerticalResizeSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VerticalResize SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconVerticalResizeBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VerticalResize BulkRounded"
    >
      <path 
        d={d.d13}
        i-c="c f fr o7"
...
export const IconVerticalResizeStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VerticalResize StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconVerticalResizeSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VerticalResize SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const iconPackOfVerticalResize: TheIconSelfPack = [
  'VerticalResize',
  IconVerticalResizeStrokeRounded,
  IconVerticalResizeDuotoneRounded,
  IconVerticalResizeTwotoneRounded,
  IconVerticalResizeSolidRounded,
  IconVerticalResizeBulkRounded,
  IconVerticalResizeStrokeSharp,
  IconVerticalResizeSolidSharp,
];