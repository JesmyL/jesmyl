...
export const iconPackOfStamp: TheIconSelfPack = [
  'Stamp',
  IconStampStrokeRounded,
  IconStampDuotoneRounded,
  IconStampTwotoneRounded,
  IconStampSolidRounded,
  IconStampBulkRounded,
  IconStampStrokeSharp,
  IconStampSolidSharp,
];