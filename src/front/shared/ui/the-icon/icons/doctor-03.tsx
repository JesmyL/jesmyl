...
export const IconDoctor03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Doctor03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDoctor03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Doctor03 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconDoctor03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Doctor03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDoctor03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Doctor03 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const iconPackOfDoctor03: TheIconSelfPack = [
  'Doctor03',
  IconDoctor03StrokeRounded,
  IconDoctor03DuotoneRounded,
  IconDoctor03TwotoneRounded,
  IconDoctor03SolidRounded,
  IconDoctor03BulkRounded,
  IconDoctor03StrokeSharp,
  IconDoctor03SolidSharp,
];