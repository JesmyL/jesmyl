...
export const IconResourcesAddStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ResourcesAdd StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconResourcesAddDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ResourcesAdd DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconResourcesAddTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ResourcesAdd TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconResourcesAddSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ResourcesAdd SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconResourcesAddBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ResourcesAdd BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconResourcesAddStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ResourcesAdd StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const IconResourcesAddSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ResourcesAdd SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const iconPackOfResourcesAdd: TheIconSelfPack = [
  'ResourcesAdd',
  IconResourcesAddStrokeRounded,
  IconResourcesAddDuotoneRounded,
  IconResourcesAddTwotoneRounded,
  IconResourcesAddSolidRounded,
  IconResourcesAddBulkRounded,
  IconResourcesAddStrokeSharp,
  IconResourcesAddSolidSharp,
];