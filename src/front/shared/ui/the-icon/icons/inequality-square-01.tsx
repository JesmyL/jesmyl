...
export const IconInequalitySquare01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InequalitySquare01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconInequalitySquare01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InequalitySquare01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconInequalitySquare01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InequalitySquare01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconInequalitySquare01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InequalitySquare01 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconInequalitySquare01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InequalitySquare01 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconInequalitySquare01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InequalitySquare01 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconInequalitySquare01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InequalitySquare01 SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfInequalitySquare01: TheIconSelfPack = [
  'InequalitySquare01',
  IconInequalitySquare01StrokeRounded,
  IconInequalitySquare01DuotoneRounded,
  IconInequalitySquare01TwotoneRounded,
  IconInequalitySquare01SolidRounded,
  IconInequalitySquare01BulkRounded,
  IconInequalitySquare01StrokeSharp,
  IconInequalitySquare01SolidSharp,
];