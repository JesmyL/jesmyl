...
export const IconLayoutRightStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayoutRight StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLayoutRightDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayoutRight DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconLayoutRightTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayoutRight TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLayoutRightSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayoutRight SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconLayoutRightBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayoutRight BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconLayoutRightStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayoutRight StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconLayoutRightSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayoutRight SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfLayoutRight: TheIconSelfPack = [
  'LayoutRight',
  IconLayoutRightStrokeRounded,
  IconLayoutRightDuotoneRounded,
  IconLayoutRightTwotoneRounded,
  IconLayoutRightSolidRounded,
  IconLayoutRightBulkRounded,
  IconLayoutRightStrokeSharp,
  IconLayoutRightSolidSharp,
];