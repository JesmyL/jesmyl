...
export const IconSubtitleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Subtitle StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSubtitleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Subtitle DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconSubtitleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Subtitle TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSubtitleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Subtitle SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const iconPackOfSubtitle: TheIconSelfPack = [
  'Subtitle',
  IconSubtitleStrokeRounded,
  IconSubtitleDuotoneRounded,
  IconSubtitleTwotoneRounded,
  IconSubtitleSolidRounded,
  IconSubtitleBulkRounded,
  IconSubtitleStrokeSharp,
  IconSubtitleSolidSharp,
];