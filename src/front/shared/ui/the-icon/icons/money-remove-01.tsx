...
export const IconMoneyRemove01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneyRemove01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMoneyRemove01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneyRemove01 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconMoneyRemove01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneyRemove01 TwotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="s sj sr sw"
...
export const IconMoneyRemove01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneyRemove01 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconMoneyRemove01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneyRemove01 BulkRounded"
    >
      <path 
        d={d.d10}
        i-c="f o7"
...
export const IconMoneyRemove01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneyRemove01 StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sj sw"
...
export const IconMoneyRemove01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneyRemove01 SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfMoneyRemove01: TheIconSelfPack = [
  'MoneyRemove01',
  IconMoneyRemove01StrokeRounded,
  IconMoneyRemove01DuotoneRounded,
  IconMoneyRemove01TwotoneRounded,
  IconMoneyRemove01SolidRounded,
  IconMoneyRemove01BulkRounded,
  IconMoneyRemove01StrokeSharp,
  IconMoneyRemove01SolidSharp,
];