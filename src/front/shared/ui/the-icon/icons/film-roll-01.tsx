...
export const IconFilmRoll01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilmRoll01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconFilmRoll01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilmRoll01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconFilmRoll01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilmRoll01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconFilmRoll01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilmRoll01 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconFilmRoll01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilmRoll01 BulkRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const IconFilmRoll01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilmRoll01 StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sj sw"
...
export const IconFilmRoll01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilmRoll01 SolidSharp"
    >
      <path 
        d={d.d18}
        i-c="f"
...
export const iconPackOfFilmRoll01: TheIconSelfPack = [
  'FilmRoll01',
  IconFilmRoll01StrokeRounded,
  IconFilmRoll01DuotoneRounded,
  IconFilmRoll01TwotoneRounded,
  IconFilmRoll01SolidRounded,
  IconFilmRoll01BulkRounded,
  IconFilmRoll01StrokeSharp,
  IconFilmRoll01SolidSharp,
];