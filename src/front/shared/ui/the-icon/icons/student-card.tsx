...
export const IconStudentCardStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StudentCard StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconStudentCardDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StudentCard DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconStudentCardTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StudentCard TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconStudentCardSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StudentCard SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconStudentCardBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StudentCard BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconStudentCardStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StudentCard StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sr sw"
...
export const IconStudentCardSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StudentCard SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfStudentCard: TheIconSelfPack = [
  'StudentCard',
  IconStudentCardStrokeRounded,
  IconStudentCardDuotoneRounded,
  IconStudentCardTwotoneRounded,
  IconStudentCardSolidRounded,
  IconStudentCardBulkRounded,
  IconStudentCardStrokeSharp,
  IconStudentCardSolidSharp,
];