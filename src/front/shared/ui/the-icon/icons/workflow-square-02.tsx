...
export const IconWorkflowSquare02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWorkflowSquare02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconWorkflowSquare02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWorkflowSquare02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare02 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconWorkflowSquare02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare02 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconWorkflowSquare02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare02 StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sj sw"
...
export const IconWorkflowSquare02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare02 SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="f"
...
export const iconPackOfWorkflowSquare02: TheIconSelfPack = [
  'WorkflowSquare02',
  IconWorkflowSquare02StrokeRounded,
  IconWorkflowSquare02DuotoneRounded,
  IconWorkflowSquare02TwotoneRounded,
  IconWorkflowSquare02SolidRounded,
  IconWorkflowSquare02BulkRounded,
  IconWorkflowSquare02StrokeSharp,
  IconWorkflowSquare02SolidSharp,
];