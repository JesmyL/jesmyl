...
export const IconMailboxStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mailbox StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMailboxDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mailbox DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconMailboxTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mailbox TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfMailbox: TheIconSelfPack = [
  'Mailbox',
  IconMailboxStrokeRounded,
  IconMailboxDuotoneRounded,
  IconMailboxTwotoneRounded,
  IconMailboxSolidRounded,
  IconMailboxBulkRounded,
  IconMailboxStrokeSharp,
  IconMailboxSolidSharp,
];