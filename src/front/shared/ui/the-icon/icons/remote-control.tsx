...
export const IconRemoteControlStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RemoteControl StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconRemoteControlDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RemoteControl DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr o7"
...
export const IconRemoteControlTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RemoteControl TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconRemoteControlSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RemoteControl SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconRemoteControlBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RemoteControl BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d9}
...
export const IconRemoteControlStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RemoteControl StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sj sw"
...
export const IconRemoteControlSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RemoteControl SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfRemoteControl: TheIconSelfPack = [
  'RemoteControl',
  IconRemoteControlStrokeRounded,
  IconRemoteControlDuotoneRounded,
  IconRemoteControlTwotoneRounded,
  IconRemoteControlSolidRounded,
  IconRemoteControlBulkRounded,
  IconRemoteControlStrokeSharp,
  IconRemoteControlSolidSharp,
];