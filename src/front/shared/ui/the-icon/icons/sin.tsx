...
export const iconPackOfSin: TheIconSelfPack = [
  'Sin',
  IconSinStrokeRounded,
  IconSinDuotoneRounded,
  IconSinTwotoneRounded,
  IconSinSolidRounded,
  IconSinBulkRounded,
  IconSinStrokeSharp,
  IconSinSolidSharp,
