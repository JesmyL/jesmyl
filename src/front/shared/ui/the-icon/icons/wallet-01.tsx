...
export const IconWallet01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wallet01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWallet01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wallet01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr o7"
...
export const IconWallet01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wallet01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconWallet01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wallet01 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const iconPackOfWallet01: TheIconSelfPack = [
  'Wallet01',
  IconWallet01StrokeRounded,
  IconWallet01DuotoneRounded,
  IconWallet01TwotoneRounded,
  IconWallet01SolidRounded,
  IconWallet01BulkRounded,
  IconWallet01StrokeSharp,
  IconWallet01SolidSharp,
];