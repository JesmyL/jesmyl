...
export const IconMoneySendFlow01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneySendFlow01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconMoneySendFlow01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneySendFlow01 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconMoneySendFlow01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneySendFlow01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconMoneySendFlow01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneySendFlow01 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconMoneySendFlow01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneySendFlow01 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconMoneySendFlow01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneySendFlow01 StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sj sw"
...
export const IconMoneySendFlow01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoneySendFlow01 SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfMoneySendFlow01: TheIconSelfPack = [
  'MoneySendFlow01',
  IconMoneySendFlow01StrokeRounded,
  IconMoneySendFlow01DuotoneRounded,
  IconMoneySendFlow01TwotoneRounded,
  IconMoneySendFlow01SolidRounded,
  IconMoneySendFlow01BulkRounded,
  IconMoneySendFlow01StrokeSharp,
  IconMoneySendFlow01SolidSharp,
];