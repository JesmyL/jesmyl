...
export const IconCoinsBitcoinStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsBitcoin StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconCoinsBitcoinDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsBitcoin DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconCoinsBitcoinTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsBitcoin TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconCoinsBitcoinSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsBitcoin SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconCoinsBitcoinBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsBitcoin BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconCoinsBitcoinStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsBitcoin StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCoinsBitcoinSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoinsBitcoin SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfCoinsBitcoin: TheIconSelfPack = [
  'CoinsBitcoin',
  IconCoinsBitcoinStrokeRounded,
  IconCoinsBitcoinDuotoneRounded,
  IconCoinsBitcoinTwotoneRounded,
  IconCoinsBitcoinSolidRounded,
  IconCoinsBitcoinBulkRounded,
  IconCoinsBitcoinStrokeSharp,
  IconCoinsBitcoinSolidSharp,
];