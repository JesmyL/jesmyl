...
export const IconRightTriangleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RightTriangle StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRightTriangleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RightTriangle DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconRightTriangleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RightTriangle TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRightTriangleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RightTriangle SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconRightTriangleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RightTriangle BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconRightTriangleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RightTriangle StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const IconRightTriangleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RightTriangle SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const iconPackOfRightTriangle: TheIconSelfPack = [
  'RightTriangle',
  IconRightTriangleStrokeRounded,
  IconRightTriangleDuotoneRounded,
  IconRightTriangleTwotoneRounded,
  IconRightTriangleSolidRounded,
  IconRightTriangleBulkRounded,
  IconRightTriangleStrokeSharp,
  IconRightTriangleSolidSharp,
];