...
export const IconTractorStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Tractor StrokeRounded"
    >
      <circle 
        cx="6.5"
        cy="16.5"
...
export const IconTractorDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Tractor DuotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconTractorTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Tractor TwotoneRounded"
    >
      <circle 
        cx="6.5"
        cy="16.5"
...
export const iconPackOfTractor: TheIconSelfPack = [
  'Tractor',
  IconTractorStrokeRounded,
  IconTractorDuotoneRounded,
  IconTractorTwotoneRounded,
  IconTractorSolidRounded,
  IconTractorBulkRounded,
  IconTractorStrokeSharp,
  IconTractorSolidSharp,
];