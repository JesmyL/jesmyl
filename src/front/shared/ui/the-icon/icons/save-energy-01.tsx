...
export const IconSaveEnergy01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SaveEnergy01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSaveEnergy01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SaveEnergy01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconSaveEnergy01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SaveEnergy01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconSaveEnergy01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SaveEnergy01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconSaveEnergy01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SaveEnergy01 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconSaveEnergy01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SaveEnergy01 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSaveEnergy01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SaveEnergy01 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfSaveEnergy01: TheIconSelfPack = [
  'SaveEnergy01',
  IconSaveEnergy01StrokeRounded,
  IconSaveEnergy01DuotoneRounded,
  IconSaveEnergy01TwotoneRounded,
  IconSaveEnergy01SolidRounded,
  IconSaveEnergy01BulkRounded,
  IconSaveEnergy01StrokeSharp,
  IconSaveEnergy01SolidSharp,
];