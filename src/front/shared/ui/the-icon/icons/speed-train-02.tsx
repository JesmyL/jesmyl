...
export const IconSpeedTrain02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpeedTrain02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSpeedTrain02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpeedTrain02 DuotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconSpeedTrain02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpeedTrain02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSpeedTrain02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpeedTrain02 SolidRounded"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const IconSpeedTrain02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpeedTrain02 BulkRounded"
    >
      <path 
        d={d.d14}
        i-c="f o7"
...
export const IconSpeedTrain02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpeedTrain02 StrokeSharp"
    >
      <path 
        d={d.d16}
        i-c="s sj sw"
...
export const IconSpeedTrain02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpeedTrain02 SolidSharp"
    >
      <path 
        d={d.d21}
        i-c="f"
...
export const iconPackOfSpeedTrain02: TheIconSelfPack = [
  'SpeedTrain02',
  IconSpeedTrain02StrokeRounded,
  IconSpeedTrain02DuotoneRounded,
  IconSpeedTrain02TwotoneRounded,
  IconSpeedTrain02SolidRounded,
  IconSpeedTrain02BulkRounded,
  IconSpeedTrain02StrokeSharp,
  IconSpeedTrain02SolidSharp,
];