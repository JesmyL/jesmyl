...
export const IconArrowExpandDiagonal01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowExpandDiagonal01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconArrowExpandDiagonal01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowExpandDiagonal01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconArrowExpandDiagonal01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowExpandDiagonal01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconArrowExpandDiagonal01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowExpandDiagonal01 SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconArrowExpandDiagonal01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowExpandDiagonal01 BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconArrowExpandDiagonal01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowExpandDiagonal01 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconArrowExpandDiagonal01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowExpandDiagonal01 SolidSharp"
    >
      <path 
        d={d.d20}
        i-c="c f fr"
...
export const iconPackOfArrowExpandDiagonal01: TheIconSelfPack = [
  ...
  IconArrowExpandDiagonal01StrokeRounded,
  IconArrowExpandDiagonal01DuotoneRounded,
  IconArrowExpandDiagonal01TwotoneRounded,
  IconArrowExpandDiagonal01SolidRounded,
  IconArrowExpandDiagonal01BulkRounded,
  IconArrowExpandDiagonal01StrokeSharp,
  IconArrowExpandDiagonal01SolidSharp,
];