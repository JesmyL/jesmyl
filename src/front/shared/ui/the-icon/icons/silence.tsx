...
export const IconSilenceStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Silence StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconSilenceDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Silence DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconSilenceTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Silence TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const iconPackOfSilence: TheIconSelfPack = [
  'Silence',
  IconSilenceStrokeRounded,
  IconSilenceDuotoneRounded,
  IconSilenceTwotoneRounded,
  IconSilenceSolidRounded,
  IconSilenceBulkRounded,
  IconSilenceStrokeSharp,
  IconSilenceSolidSharp,
];