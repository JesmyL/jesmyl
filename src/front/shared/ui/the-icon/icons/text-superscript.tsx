...
export const IconTextSuperscriptStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextSuperscript StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTextSuperscriptDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextSuperscript DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="o7 s sr sw"
...
export const IconTextSuperscriptTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextSuperscript TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTextSuperscriptSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextSuperscript SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconTextSuperscriptBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextSuperscript BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr o7"
...
export const IconTextSuperscriptStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextSuperscript StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const IconTextSuperscriptSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextSuperscript SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfTextSuperscript: TheIconSelfPack = [
  'TextSuperscript',
  IconTextSuperscriptStrokeRounded,
  IconTextSuperscriptDuotoneRounded,
  IconTextSuperscriptTwotoneRounded,
  IconTextSuperscriptSolidRounded,
  IconTextSuperscriptBulkRounded,
  IconTextSuperscriptStrokeSharp,
  IconTextSuperscriptSolidSharp,
];