...
export const IconImageUpload01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageUpload01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconImageUpload01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageUpload01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconImageUpload01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageUpload01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconImageUpload01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageUpload01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconImageUpload01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageUpload01 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconImageUpload01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageUpload01 StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconImageUpload01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageUpload01 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const iconPackOfImageUpload01: TheIconSelfPack = [
  'ImageUpload01',
  IconImageUpload01StrokeRounded,
  IconImageUpload01DuotoneRounded,
  IconImageUpload01TwotoneRounded,
  IconImageUpload01SolidRounded,
  IconImageUpload01BulkRounded,
  IconImageUpload01StrokeSharp,
  IconImageUpload01SolidSharp,
];