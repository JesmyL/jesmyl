...
export const IconLayersLogoStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayersLogo StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLayersLogoDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayersLogo DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconLayersLogoTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayersLogo TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLayersLogoSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayersLogo SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconLayersLogoBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayersLogo BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconLayersLogoStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayersLogo StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sr sw"
...
export const IconLayersLogoSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayersLogo SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const iconPackOfLayersLogo: TheIconSelfPack = [
  'LayersLogo',
  IconLayersLogoStrokeRounded,
  IconLayersLogoDuotoneRounded,
  IconLayersLogoTwotoneRounded,
  IconLayersLogoSolidRounded,
  IconLayersLogoBulkRounded,
  IconLayersLogoStrokeSharp,
  IconLayersLogoSolidSharp,
];