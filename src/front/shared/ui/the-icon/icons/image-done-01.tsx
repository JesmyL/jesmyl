...
export const IconImageDone01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDone01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconImageDone01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDone01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconImageDone01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDone01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconImageDone01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDone01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconImageDone01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDone01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconImageDone01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDone01 StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconImageDone01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDone01 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const iconPackOfImageDone01: TheIconSelfPack = [
  'ImageDone01',
  IconImageDone01StrokeRounded,
  IconImageDone01DuotoneRounded,
  IconImageDone01TwotoneRounded,
  IconImageDone01SolidRounded,
  IconImageDone01BulkRounded,
  IconImageDone01StrokeSharp,
  IconImageDone01SolidSharp,
];