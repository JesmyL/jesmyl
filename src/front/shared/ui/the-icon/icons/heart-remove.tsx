...
export const IconHeartRemoveStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HeartRemove StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconHeartRemoveDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HeartRemove DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconHeartRemoveTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HeartRemove TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconHeartRemoveSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HeartRemove SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconHeartRemoveBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HeartRemove BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconHeartRemoveStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HeartRemove StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const IconHeartRemoveSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HeartRemove SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfHeartRemove: TheIconSelfPack = [
  'HeartRemove',
  IconHeartRemoveStrokeRounded,
  IconHeartRemoveDuotoneRounded,
  IconHeartRemoveTwotoneRounded,
  IconHeartRemoveSolidRounded,
  IconHeartRemoveBulkRounded,
  IconHeartRemoveStrokeSharp,
  IconHeartRemoveSolidSharp,
];