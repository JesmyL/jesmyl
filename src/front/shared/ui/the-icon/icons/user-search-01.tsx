...
export const IconUserSearch01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSearch01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserSearch01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSearch01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconUserSearch01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSearch01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserSearch01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSearch01 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconUserSearch01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSearch01 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconUserSearch01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSearch01 StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sw"
...
export const IconUserSearch01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSearch01 SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfUserSearch01: TheIconSelfPack = [
  'UserSearch01',
  IconUserSearch01StrokeRounded,
  IconUserSearch01DuotoneRounded,
  IconUserSearch01TwotoneRounded,
  IconUserSearch01SolidRounded,
  IconUserSearch01BulkRounded,
  IconUserSearch01StrokeSharp,
  IconUserSearch01SolidSharp,
];