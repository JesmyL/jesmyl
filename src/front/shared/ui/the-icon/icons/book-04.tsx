...
export const IconBook04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Book04 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconBook04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Book04 TwotoneRounded"
    >
      <path 
        d={d.d10}
        i-c="o7 s sj sr sw"
...
export const iconPackOfBook04: TheIconSelfPack = [
  'Book04',
  IconBook04StrokeRounded,
  IconBook04DuotoneRounded,
  IconBook04TwotoneRounded,
  IconBook04SolidRounded,
  IconBook04BulkRounded,
  IconBook04StrokeSharp,
  IconBook04SolidSharp,
];