...
export const IconScooter01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Scooter01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconScooter01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Scooter01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconScooter01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Scooter01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconScooter01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Scooter01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconScooter01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Scooter01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconScooter01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Scooter01 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const iconPackOfScooter01: TheIconSelfPack = [
  'Scooter01',
  IconScooter01StrokeRounded,
  IconScooter01DuotoneRounded,
  IconScooter01TwotoneRounded,
  IconScooter01SolidRounded,
  IconScooter01BulkRounded,
  IconScooter01StrokeSharp,
  IconScooter01SolidSharp,
];