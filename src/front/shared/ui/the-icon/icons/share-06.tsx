...
export const IconShare06StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Share06 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShare06DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Share06 DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="13"
...
export const IconShare06TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Share06 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfShare06: TheIconSelfPack = [
  'Share06',
  IconShare06StrokeRounded,
  IconShare06DuotoneRounded,
  IconShare06TwotoneRounded,
  IconShare06SolidRounded,
  IconShare06BulkRounded,
  IconShare06StrokeSharp,
  IconShare06SolidSharp,
];