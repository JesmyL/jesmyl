...
export const IconAppleReminderStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AppleReminder StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconAppleReminderDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AppleReminder DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconAppleReminderTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AppleReminder TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconAppleReminderSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AppleReminder SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconAppleReminderBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AppleReminder BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconAppleReminderStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AppleReminder StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sj sw"
...
export const IconAppleReminderSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AppleReminder SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const iconPackOfAppleReminder: TheIconSelfPack = [
  'AppleReminder',
  IconAppleReminderStrokeRounded,
  IconAppleReminderDuotoneRounded,
  IconAppleReminderTwotoneRounded,
  IconAppleReminderSolidRounded,
  IconAppleReminderBulkRounded,
  IconAppleReminderStrokeSharp,
  IconAppleReminderSolidSharp,
];