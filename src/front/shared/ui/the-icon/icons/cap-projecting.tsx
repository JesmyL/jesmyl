...
export const IconCapProjectingStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CapProjecting StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCapProjectingDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CapProjecting DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconCapProjectingTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CapProjecting TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCapProjectingSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CapProjecting SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconCapProjectingBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CapProjecting BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconCapProjectingStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CapProjecting StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconCapProjectingSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CapProjecting SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfCapProjecting: TheIconSelfPack = [
  'CapProjecting',
  IconCapProjectingStrokeRounded,
  IconCapProjectingDuotoneRounded,
  IconCapProjectingTwotoneRounded,
  IconCapProjectingSolidRounded,
  IconCapProjectingBulkRounded,
  IconCapProjectingStrokeSharp,
  IconCapProjectingSolidSharp,
];