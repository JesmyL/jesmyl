...
export const IconSlowWindsStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SlowWinds StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSlowWindsDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SlowWinds DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconSlowWindsTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SlowWinds TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconSlowWindsSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SlowWinds SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconSlowWindsBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SlowWinds BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconSlowWindsStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SlowWinds StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfSlowWinds: TheIconSelfPack = [
  'SlowWinds',
  IconSlowWindsStrokeRounded,
  IconSlowWindsDuotoneRounded,
  IconSlowWindsTwotoneRounded,
  IconSlowWindsSolidRounded,
  IconSlowWindsBulkRounded,
  IconSlowWindsStrokeSharp,
  IconSlowWindsSolidSharp,
];