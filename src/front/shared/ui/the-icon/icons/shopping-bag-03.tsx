...
export const IconShoppingBag03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBag03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconShoppingBag03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBag03 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconShoppingBag03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBag03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconShoppingBag03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBag03 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconShoppingBag03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBag03 BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconShoppingBag03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBag03 StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sw"
...
export const IconShoppingBag03SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBag03 SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfShoppingBag03: TheIconSelfPack = [
  'ShoppingBag03',
  IconShoppingBag03StrokeRounded,
  IconShoppingBag03DuotoneRounded,
  IconShoppingBag03TwotoneRounded,
  IconShoppingBag03SolidRounded,
  IconShoppingBag03BulkRounded,
  IconShoppingBag03StrokeSharp,
  IconShoppingBag03SolidSharp,
];