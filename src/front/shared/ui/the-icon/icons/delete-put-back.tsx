...
export const IconDeletePutBackStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeletePutBack StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDeletePutBackDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeletePutBack DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconDeletePutBackTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeletePutBack TwotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="o7 s sr sw"
...
export const IconDeletePutBackSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeletePutBack SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconDeletePutBackBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeletePutBack BulkRounded"
    >
      <path 
        d={d.d10}
        i-c="f o7"
...
export const IconDeletePutBackStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeletePutBack StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sw"
...
export const IconDeletePutBackSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeletePutBack SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfDeletePutBack: TheIconSelfPack = [
  'DeletePutBack',
  IconDeletePutBackStrokeRounded,
  IconDeletePutBackDuotoneRounded,
  IconDeletePutBackTwotoneRounded,
  IconDeletePutBackSolidRounded,
  IconDeletePutBackBulkRounded,
  IconDeletePutBackStrokeSharp,
  IconDeletePutBackSolidSharp,
];