...
export const IconCustomerService01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CustomerService01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconCustomerService01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CustomerService01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconCustomerService01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CustomerService01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconCustomerService01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CustomerService01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconCustomerService01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CustomerService01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconCustomerService01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CustomerService01 StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sw"
...
export const IconCustomerService01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CustomerService01 SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="f"
...
export const iconPackOfCustomerService01: TheIconSelfPack = [
  'CustomerService01',
  IconCustomerService01StrokeRounded,
  IconCustomerService01DuotoneRounded,
  IconCustomerService01TwotoneRounded,
  IconCustomerService01SolidRounded,
  IconCustomerService01BulkRounded,
  IconCustomerService01StrokeSharp,
  IconCustomerService01SolidSharp,
];