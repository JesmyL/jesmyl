...
export const iconPackOfPatio: TheIconSelfPack = [
  'Patio',
  IconPatioStrokeRounded,
  IconPatioDuotoneRounded,
  IconPatioTwotoneRounded,
  IconPatioSolidRounded,
  IconPatioBulkRounded,
  IconPatioStrokeSharp,
  IconPatioSolidSharp,
];