...
export const IconAlAqsaMosqueStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlAqsaMosque StrokeRounded"
    >
      <rect 
        x="6"
        y="12"
        i-c="h1 s sj sr sw w3"
      />
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAlAqsaMosqueDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlAqsaMosque DuotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconAlAqsaMosqueTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlAqsaMosque TwotoneRounded"
    >
      <rect 
        x="6"
        y="12"
...
export const IconAlAqsaMosqueSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlAqsaMosque SolidRounded"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const IconAlAqsaMosqueBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlAqsaMosque BulkRounded"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const IconAlAqsaMosqueStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlAqsaMosque StrokeSharp"
    >
      <path 
        d={d.d20}
        i-c="s sj sw"
...
export const IconAlAqsaMosqueSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlAqsaMosque SolidSharp"
    >
      <path 
        d={d.d28}
        i-c="f"
...
export const iconPackOfAlAqsaMosque: TheIconSelfPack = [
  'AlAqsaMosque',
  IconAlAqsaMosqueStrokeRounded,
  IconAlAqsaMosqueDuotoneRounded,
  IconAlAqsaMosqueTwotoneRounded,
  IconAlAqsaMosqueSolidRounded,
  IconAlAqsaMosqueBulkRounded,
  IconAlAqsaMosqueStrokeSharp,
  IconAlAqsaMosqueSolidSharp,
];