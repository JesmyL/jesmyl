...
export const IconLocation03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLocation03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location03 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconLocation03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLocation03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location03 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconLocation03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location03 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconLocation03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location03 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLocation03SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Location03 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfLocation03: TheIconSelfPack = [
  'Location03',
  IconLocation03StrokeRounded,
  IconLocation03DuotoneRounded,
  IconLocation03TwotoneRounded,
  IconLocation03SolidRounded,
  IconLocation03BulkRounded,
  IconLocation03StrokeSharp,
  IconLocation03SolidSharp,
];