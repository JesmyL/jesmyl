...
export const IconLuggage01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Luggage01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLuggage01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Luggage01 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconLuggage01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Luggage01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLuggage01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Luggage01 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconLuggage01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Luggage01 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconLuggage01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Luggage01 StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj ss sw"
...
export const iconPackOfLuggage01: TheIconSelfPack = [
  'Luggage01',
  IconLuggage01StrokeRounded,
  IconLuggage01DuotoneRounded,
  IconLuggage01TwotoneRounded,
  IconLuggage01SolidRounded,
  IconLuggage01BulkRounded,
  IconLuggage01StrokeSharp,
  IconLuggage01SolidSharp,
];