...
export const IconWaiterDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Waiter DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconWaiterTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Waiter TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfWaiter: TheIconSelfPack = [
  'Waiter',
  IconWaiterStrokeRounded,
  IconWaiterDuotoneRounded,
  IconWaiterTwotoneRounded,
  IconWaiterSolidRounded,
  IconWaiterBulkRounded,
  IconWaiterStrokeSharp,
  IconWaiterSolidSharp,
];