...
export const IconArrowUp05StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUp05 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconArrowUp05DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUp05 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconArrowUp05TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUp05 TwotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconArrowUp05SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUp05 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconArrowUp05BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUp05 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconArrowUp05StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUp05 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const iconPackOfArrowUp05: TheIconSelfPack = [
  'ArrowUp05',
  IconArrowUp05StrokeRounded,
  IconArrowUp05DuotoneRounded,
  IconArrowUp05TwotoneRounded,
  IconArrowUp05SolidRounded,
  IconArrowUp05BulkRounded,
  IconArrowUp05StrokeSharp,
  IconArrowUp05SolidSharp,
];