...
export const IconThumbsUpStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ThumbsUp StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconThumbsUpDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ThumbsUp DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconThumbsUpTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ThumbsUp TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconThumbsUpSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ThumbsUp SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const iconPackOfThumbsUp: TheIconSelfPack = [
  'ThumbsUp',
  IconThumbsUpStrokeRounded,
  IconThumbsUpDuotoneRounded,
  IconThumbsUpTwotoneRounded,
  IconThumbsUpSolidRounded,
  IconThumbsUpBulkRounded,
  IconThumbsUpStrokeSharp,
  IconThumbsUpSolidSharp,
];