...
export const IconMicrosoftStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Microsoft StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMicrosoftDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Microsoft DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconMicrosoftTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Microsoft TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMicrosoftSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Microsoft SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconMicrosoftBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Microsoft BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconMicrosoftStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Microsoft StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sr sw"
...
export const iconPackOfMicrosoft: TheIconSelfPack = [
  'Microsoft',
  IconMicrosoftStrokeRounded,
  IconMicrosoftDuotoneRounded,
  IconMicrosoftTwotoneRounded,
  IconMicrosoftSolidRounded,
  IconMicrosoftBulkRounded,
  IconMicrosoftStrokeSharp,
  IconMicrosoftSolidSharp,
];