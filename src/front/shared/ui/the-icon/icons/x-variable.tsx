...
export const IconXVariableStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="XVariable StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconXVariableDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="XVariable DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="o7 s sj sr sw"
...
export const IconXVariableTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="XVariable TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconXVariableSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="XVariable SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconXVariableBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="XVariable BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconXVariableStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="XVariable StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfXVariable: TheIconSelfPack = [
  'XVariable',
  IconXVariableStrokeRounded,
  IconXVariableDuotoneRounded,
  IconXVariableTwotoneRounded,
  IconXVariableSolidRounded,
  IconXVariableBulkRounded,
  IconXVariableStrokeSharp,
  IconXVariableSolidSharp,
];