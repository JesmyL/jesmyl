...
export const IconMotion02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Motion02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMotion02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Motion02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconMotion02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Motion02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMotion02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Motion02 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const iconPackOfMotion02: TheIconSelfPack = [
  'Motion02',
  IconMotion02StrokeRounded,
  IconMotion02DuotoneRounded,
  IconMotion02TwotoneRounded,
  IconMotion02SolidRounded,
  IconMotion02BulkRounded,
  IconMotion02StrokeSharp,
  IconMotion02SolidSharp,
];