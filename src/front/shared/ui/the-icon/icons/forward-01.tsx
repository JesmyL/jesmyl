...
export const IconForward01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Forward01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconForward01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Forward01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconForward01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Forward01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconForward01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Forward01 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconForward01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Forward01 BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr o7"
...
export const IconForward01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Forward01 StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sj sw"
...
export const iconPackOfForward01: TheIconSelfPack = [
  'Forward01',
  IconForward01StrokeRounded,
  IconForward01DuotoneRounded,
  IconForward01TwotoneRounded,
  IconForward01SolidRounded,
  IconForward01BulkRounded,
  IconForward01StrokeSharp,
  IconForward01SolidSharp,
];