...
export const IconWorkoutSportStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkoutSport StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWorkoutSportDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkoutSport DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWorkoutSportTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkoutSport TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconWorkoutSportSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkoutSport SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconWorkoutSportBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkoutSport BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconWorkoutSportStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkoutSport StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWorkoutSportSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkoutSport SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfWorkoutSport: TheIconSelfPack = [
  'WorkoutSport',
  IconWorkoutSportStrokeRounded,
  IconWorkoutSportDuotoneRounded,
  IconWorkoutSportTwotoneRounded,
  IconWorkoutSportSolidRounded,
  IconWorkoutSportBulkRounded,
  IconWorkoutSportStrokeSharp,
  IconWorkoutSportSolidSharp,
];