...
export const IconWebDesign02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WebDesign02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconWebDesign02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WebDesign02 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconWebDesign02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WebDesign02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconWebDesign02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WebDesign02 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconWebDesign02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WebDesign02 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconWebDesign02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WebDesign02 StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const IconWebDesign02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WebDesign02 SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfWebDesign02: TheIconSelfPack = [
  'WebDesign02',
  IconWebDesign02StrokeRounded,
  IconWebDesign02DuotoneRounded,
  IconWebDesign02TwotoneRounded,
  IconWebDesign02SolidRounded,
  IconWebDesign02BulkRounded,
  IconWebDesign02StrokeSharp,
  IconWebDesign02SolidSharp,
];