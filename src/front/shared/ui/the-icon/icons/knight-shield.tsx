...
export const IconKnightShieldStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KnightShield StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconKnightShieldDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KnightShield DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="s sj sr sw"
...
export const IconKnightShieldTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KnightShield TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconKnightShieldSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KnightShield SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconKnightShieldBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KnightShield BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconKnightShieldStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KnightShield StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconKnightShieldSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KnightShield SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="f"
...
export const iconPackOfKnightShield: TheIconSelfPack = [
  'KnightShield',
  IconKnightShieldStrokeRounded,
  IconKnightShieldDuotoneRounded,
  IconKnightShieldTwotoneRounded,
  IconKnightShieldSolidRounded,
  IconKnightShieldBulkRounded,
  IconKnightShieldStrokeSharp,
  IconKnightShieldSolidSharp,
];