...
export const IconColumnInsertStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ColumnInsert StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconColumnInsertDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ColumnInsert DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconColumnInsertTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ColumnInsert TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconColumnInsertSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ColumnInsert SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconColumnInsertBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ColumnInsert BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconColumnInsertStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ColumnInsert StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sr sw"
...
export const IconColumnInsertSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ColumnInsert SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfColumnInsert: TheIconSelfPack = [
  'ColumnInsert',
  IconColumnInsertStrokeRounded,
  IconColumnInsertDuotoneRounded,
  IconColumnInsertTwotoneRounded,
  IconColumnInsertSolidRounded,
  IconColumnInsertBulkRounded,
  IconColumnInsertStrokeSharp,
  IconColumnInsertSolidSharp,
];