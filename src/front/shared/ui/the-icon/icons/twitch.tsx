...
export const IconTwitchDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Twitch DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconTwitchTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Twitch TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfTwitch: TheIconSelfPack = [
  'Twitch',
  IconTwitchStrokeRounded,
  IconTwitchDuotoneRounded,
  IconTwitchTwotoneRounded,
  IconTwitchSolidRounded,
  IconTwitchBulkRounded,
  IconTwitchStrokeSharp,
  IconTwitchSolidSharp,
];