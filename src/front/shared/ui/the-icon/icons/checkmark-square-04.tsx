...
export const IconCheckmarkSquare04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheckmarkSquare04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconCheckmarkSquare04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheckmarkSquare04 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconCheckmarkSquare04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheckmarkSquare04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconCheckmarkSquare04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheckmarkSquare04 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconCheckmarkSquare04BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheckmarkSquare04 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconCheckmarkSquare04StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheckmarkSquare04 StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconCheckmarkSquare04SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CheckmarkSquare04 SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const iconPackOfCheckmarkSquare04: TheIconSelfPack = [
  'CheckmarkSquare04',
  IconCheckmarkSquare04StrokeRounded,
  IconCheckmarkSquare04DuotoneRounded,
  IconCheckmarkSquare04TwotoneRounded,
  IconCheckmarkSquare04SolidRounded,
  IconCheckmarkSquare04BulkRounded,
  IconCheckmarkSquare04StrokeSharp,
  IconCheckmarkSquare04SolidSharp,
];