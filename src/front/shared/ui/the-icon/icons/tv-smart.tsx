...
export const IconTvSmartStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TvSmart StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconTvSmartDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TvSmart DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconTvSmartTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TvSmart TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfTvSmart: TheIconSelfPack = [
  ...
  IconTvSmartDuotoneRounded,
  IconTvSmartTwotoneRounded,
  IconTvSmartSolidRounded,
  IconTvSmartBulkRounded,
  IconTvSmartStrokeSharp,
  IconTvSmartSolidSharp,
];