...
export const IconShoppingBasketCheckIn01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketCheckIn01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShoppingBasketCheckIn01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketCheckIn01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconShoppingBasketCheckIn01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketCheckIn01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShoppingBasketCheckIn01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketCheckIn01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconShoppingBasketCheckIn01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketCheckIn01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconShoppingBasketCheckIn01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketCheckIn01 StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sw"
...
export const IconShoppingBasketCheckIn01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketCheckIn01 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfShoppingBasketCheckIn01: TheIconSelfPack = [
  ...
  IconShoppingBasketCheckIn01StrokeRounded,
  IconShoppingBasketCheckIn01DuotoneRounded,
  IconShoppingBasketCheckIn01TwotoneRounded,
  IconShoppingBasketCheckIn01SolidRounded,
  IconShoppingBasketCheckIn01BulkRounded,
  IconShoppingBasketCheckIn01StrokeSharp,
  IconShoppingBasketCheckIn01SolidSharp,
];