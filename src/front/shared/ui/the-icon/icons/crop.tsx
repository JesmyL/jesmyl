...
export const iconPackOfCrop: TheIconSelfPack = [
  'Crop',
  IconCropStrokeRounded,
  IconCropDuotoneRounded,
  IconCropTwotoneRounded,
  IconCropSolidRounded,
  IconCropBulkRounded,
  IconCropStrokeSharp,
  IconCropSolidSharp,
];