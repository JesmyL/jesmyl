...
export const IconSushi03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sushi03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSushi03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sushi03 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconSushi03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sushi03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfSushi03: TheIconSelfPack = [
  'Sushi03',
  IconSushi03StrokeRounded,
  IconSushi03DuotoneRounded,
  IconSushi03TwotoneRounded,
  IconSushi03SolidRounded,
  IconSushi03BulkRounded,
  IconSushi03StrokeSharp,
  IconSushi03SolidSharp,
];