...
export const IconNodeAddStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NodeAdd StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconNodeAddDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NodeAdd DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconNodeAddTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NodeAdd TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfNodeAdd: TheIconSelfPack = [
  'NodeAdd',
  IconNodeAddStrokeRounded,
  IconNodeAddDuotoneRounded,
  IconNodeAddTwotoneRounded,
  IconNodeAddSolidRounded,
  IconNodeAddBulkRounded,
  IconNodeAddStrokeSharp,
  IconNodeAddSolidSharp,
];