...
export const IconNThRootStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NThRoot StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconNThRootDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NThRoot DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconNThRootTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NThRoot TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfNThRoot: TheIconSelfPack = [
  'NThRoot',
  IconNThRootStrokeRounded,
  IconNThRootDuotoneRounded,
  IconNThRootTwotoneRounded,
  IconNThRootSolidRounded,
  IconNThRootBulkRounded,
  IconNThRootStrokeSharp,
  IconNThRootSolidSharp,
];