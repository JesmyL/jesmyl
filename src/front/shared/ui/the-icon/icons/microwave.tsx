...
export const IconMicrowaveStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Microwave StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconMicrowaveDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Microwave DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconMicrowaveTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Microwave TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconMicrowaveSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Microwave SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconMicrowaveBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Microwave BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconMicrowaveStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Microwave StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const iconPackOfMicrowave: TheIconSelfPack = [
  'Microwave',
  IconMicrowaveStrokeRounded,
  IconMicrowaveDuotoneRounded,
  IconMicrowaveTwotoneRounded,
  IconMicrowaveSolidRounded,
  IconMicrowaveBulkRounded,
  IconMicrowaveStrokeSharp,
  IconMicrowaveSolidSharp,
];