...
export const IconLetterSpacingStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LetterSpacing StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconLetterSpacingDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LetterSpacing DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="s sr sw"
...
export const IconLetterSpacingTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LetterSpacing TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconLetterSpacingSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LetterSpacing SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconLetterSpacingBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LetterSpacing BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconLetterSpacingStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LetterSpacing StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconLetterSpacingSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LetterSpacing SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfLetterSpacing: TheIconSelfPack = [
  'LetterSpacing',
  IconLetterSpacingStrokeRounded,
  IconLetterSpacingDuotoneRounded,
  IconLetterSpacingTwotoneRounded,
  IconLetterSpacingSolidRounded,
  IconLetterSpacingBulkRounded,
  IconLetterSpacingStrokeSharp,
  IconLetterSpacingSolidSharp,
];