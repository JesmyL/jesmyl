...
export const IconNintendoSwitchStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NintendoSwitch StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconNintendoSwitchDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NintendoSwitch DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconNintendoSwitchTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NintendoSwitch TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconNintendoSwitchSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NintendoSwitch SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconNintendoSwitchBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NintendoSwitch BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconNintendoSwitchStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NintendoSwitch StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sw"
...
export const IconNintendoSwitchSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NintendoSwitch SolidSharp"
    >
      <path 
        d={d.d16}
        i-c="c f fr"
...
export const iconPackOfNintendoSwitch: TheIconSelfPack = [
  'NintendoSwitch',
  IconNintendoSwitchStrokeRounded,
  IconNintendoSwitchDuotoneRounded,
  IconNintendoSwitchTwotoneRounded,
  IconNintendoSwitchSolidRounded,
  IconNintendoSwitchBulkRounded,
  IconNintendoSwitchStrokeSharp,
  IconNintendoSwitchSolidSharp,
];