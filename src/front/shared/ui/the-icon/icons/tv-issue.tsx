...
export const IconTvIssueStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TvIssue StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconTvIssueDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TvIssue DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconTvIssueTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TvIssue TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfTvIssue: TheIconSelfPack = [
  'TvIssue',
  IconTvIssueStrokeRounded,
  IconTvIssueDuotoneRounded,
  IconTvIssueTwotoneRounded,
  IconTvIssueSolidRounded,
  IconTvIssueBulkRounded,
  IconTvIssueStrokeSharp,
  IconTvIssueSolidSharp,
];