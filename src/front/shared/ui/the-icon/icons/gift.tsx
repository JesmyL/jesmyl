...
export const iconPackOfGift: TheIconSelfPack = [
  'Gift',
  IconGiftStrokeRounded,
  IconGiftDuotoneRounded,
  IconGiftTwotoneRounded,
  IconGiftSolidRounded,
  IconGiftBulkRounded,
  IconGiftStrokeSharp,
  IconGiftSolidSharp,
];