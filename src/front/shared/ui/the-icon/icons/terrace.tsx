...
export const IconTerraceStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Terrace StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTerraceDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Terrace DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconTerraceTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Terrace TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfTerrace: TheIconSelfPack = [
  'Terrace',
  IconTerraceStrokeRounded,
  IconTerraceDuotoneRounded,
  IconTerraceTwotoneRounded,
  IconTerraceSolidRounded,
  IconTerraceBulkRounded,
  IconTerraceStrokeSharp,
  IconTerraceSolidSharp,
];