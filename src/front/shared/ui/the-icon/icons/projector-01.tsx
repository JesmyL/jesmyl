...
export const IconProjector01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Projector01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconProjector01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Projector01 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconProjector01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Projector01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconProjector01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Projector01 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconProjector01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Projector01 BulkRounded"
    >
      <path 
        d={d.d12}
        i-c="f o7"
...
export const IconProjector01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Projector01 StrokeSharp"
    >
      <path 
        d={d.d16}
        i-c="s sj sw"
...
export const IconProjector01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Projector01 SolidSharp"
    >
      <path 
        d={d.d18}
        i-c="c f fr"
...
export const iconPackOfProjector01: TheIconSelfPack = [
  'Projector01',
  IconProjector01StrokeRounded,
  IconProjector01DuotoneRounded,
  IconProjector01TwotoneRounded,
  IconProjector01SolidRounded,
  IconProjector01BulkRounded,
  IconProjector01StrokeSharp,
  IconProjector01SolidSharp,
];