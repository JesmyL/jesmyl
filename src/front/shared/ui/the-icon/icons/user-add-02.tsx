...
export const IconUserAdd02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserAdd02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserAdd02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserAdd02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconUserAdd02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserAdd02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserAdd02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserAdd02 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconUserAdd02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserAdd02 BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d4}
...
export const IconUserAdd02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserAdd02 StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const iconPackOfUserAdd02: TheIconSelfPack = [
  'UserAdd02',
  IconUserAdd02StrokeRounded,
  IconUserAdd02DuotoneRounded,
  IconUserAdd02TwotoneRounded,
  IconUserAdd02SolidRounded,
  IconUserAdd02BulkRounded,
  IconUserAdd02StrokeSharp,
  IconUserAdd02SolidSharp,
];