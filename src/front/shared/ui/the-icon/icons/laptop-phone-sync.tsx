...
export const IconLaptopPhoneSyncStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopPhoneSync StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLaptopPhoneSyncDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopPhoneSync DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconLaptopPhoneSyncTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopPhoneSync TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLaptopPhoneSyncSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopPhoneSync SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconLaptopPhoneSyncBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopPhoneSync BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconLaptopPhoneSyncStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopPhoneSync StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sw"
...
export const IconLaptopPhoneSyncSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopPhoneSync SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="f"
...
export const iconPackOfLaptopPhoneSync: TheIconSelfPack = [
  'LaptopPhoneSync',
  IconLaptopPhoneSyncStrokeRounded,
  IconLaptopPhoneSyncDuotoneRounded,
  IconLaptopPhoneSyncTwotoneRounded,
  IconLaptopPhoneSyncSolidRounded,
  IconLaptopPhoneSyncBulkRounded,
  IconLaptopPhoneSyncStrokeSharp,
  IconLaptopPhoneSyncSolidSharp,
];