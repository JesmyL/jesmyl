...
export const IconPinCodeStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PinCode StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPinCodeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PinCode DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconPinCodeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PinCode TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfPinCode: TheIconSelfPack = [
  'PinCode',
  IconPinCodeStrokeRounded,
  IconPinCodeDuotoneRounded,
  IconPinCodeTwotoneRounded,
  IconPinCodeSolidRounded,
  IconPinCodeBulkRounded,
  IconPinCodeStrokeSharp,
  IconPinCodeSolidSharp,
];