...
export const IconSidebarLeftStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarLeft StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSidebarLeftDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarLeft DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconSidebarLeftTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarLeft TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSidebarLeftSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarLeft SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconSidebarLeftBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarLeft BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconSidebarLeftStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarLeft StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconSidebarLeftSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarLeft SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfSidebarLeft: TheIconSelfPack = [
  'SidebarLeft',
  IconSidebarLeftStrokeRounded,
  IconSidebarLeftDuotoneRounded,
  IconSidebarLeftTwotoneRounded,
  IconSidebarLeftSolidRounded,
  IconSidebarLeftBulkRounded,
  IconSidebarLeftStrokeSharp,
  IconSidebarLeftSolidSharp,
];