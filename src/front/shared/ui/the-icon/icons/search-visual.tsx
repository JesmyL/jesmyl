...
export const IconSearchVisualStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SearchVisual StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSearchVisualDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SearchVisual DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr o7"
...
export const IconSearchVisualTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SearchVisual TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSearchVisualSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SearchVisual SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconSearchVisualBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SearchVisual BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconSearchVisualStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SearchVisual StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sw"
...
export const IconSearchVisualSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SearchVisual SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfSearchVisual: TheIconSelfPack = [
  'SearchVisual',
  IconSearchVisualStrokeRounded,
  IconSearchVisualDuotoneRounded,
  IconSearchVisualTwotoneRounded,
  IconSearchVisualSolidRounded,
  IconSearchVisualBulkRounded,
  IconSearchVisualStrokeSharp,
  IconSearchVisualSolidSharp,
];