...
export const IconMoveRightStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoveRight StrokeRounded"
    >
      <circle 
        cx="5"
        cy="12"
...
export const IconMoveRightDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoveRight DuotoneRounded"
    >
      <circle 
        cx="5"
        cy="12"
...
export const IconMoveRightTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoveRight TwotoneRounded"
    >
      <circle 
        cx="5"
        cy="12"
...
export const IconMoveRightSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoveRight SolidRounded"
    >
      <path 
        d={d.d2}
        i-c="f"
...
export const IconMoveRightBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoveRight BulkRounded"
    >
      <path 
        d={d.d2}
        i-c="f"
...
export const IconMoveRightStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoveRight StrokeSharp"
    >
      <circle 
        cx="5"
        cy="12"
...
export const iconPackOfMoveRight: TheIconSelfPack = [
  'MoveRight',
  IconMoveRightStrokeRounded,
  IconMoveRightDuotoneRounded,
  IconMoveRightTwotoneRounded,
  IconMoveRightSolidRounded,
  IconMoveRightBulkRounded,
  IconMoveRightStrokeSharp,
  IconMoveRightSolidSharp,
];