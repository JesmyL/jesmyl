...
export const iconPackOfRss: TheIconSelfPack = [
  'Rss',
  IconRssStrokeRounded,
  IconRssDuotoneRounded,
  IconRssTwotoneRounded,
  IconRssSolidRounded,
  IconRssBulkRounded,
  IconRssStrokeSharp,
  IconRssSolidSharp,
