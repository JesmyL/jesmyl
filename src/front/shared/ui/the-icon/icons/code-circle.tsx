...
export const IconCodeCircleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CodeCircle StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCodeCircleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CodeCircle DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconCodeCircleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CodeCircle TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconCodeCircleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CodeCircle SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconCodeCircleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CodeCircle BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconCodeCircleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CodeCircle StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const IconCodeCircleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CodeCircle SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfCodeCircle: TheIconSelfPack = [
  'CodeCircle',
  IconCodeCircleStrokeRounded,
  IconCodeCircleDuotoneRounded,
  IconCodeCircleTwotoneRounded,
  IconCodeCircleSolidRounded,
  IconCodeCircleBulkRounded,
  IconCodeCircleStrokeSharp,
  IconCodeCircleSolidSharp,
];