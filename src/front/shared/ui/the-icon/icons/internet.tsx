...
export const IconInternetStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Internet StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconInternetDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Internet DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="c f fr o7"
...
export const IconInternetTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Internet TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconInternetSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Internet SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const iconPackOfInternet: TheIconSelfPack = [
  'Internet',
  IconInternetStrokeRounded,
  IconInternetDuotoneRounded,
  IconInternetTwotoneRounded,
  IconInternetSolidRounded,
  IconInternetBulkRounded,
  IconInternetStrokeSharp,
  IconInternetSolidSharp,
];