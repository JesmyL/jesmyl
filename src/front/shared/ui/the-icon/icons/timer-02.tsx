...
export const IconTimer02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Timer02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconTimer02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Timer02 DuotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr o7"
...
export const IconTimer02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Timer02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfTimer02: TheIconSelfPack = [
  'Timer02',
  IconTimer02StrokeRounded,
  IconTimer02DuotoneRounded,
  IconTimer02TwotoneRounded,
  IconTimer02SolidRounded,
  IconTimer02BulkRounded,
  IconTimer02StrokeSharp,
  IconTimer02SolidSharp,
];