...
export const IconHelicopterStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Helicopter StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHelicopterDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Helicopter DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHelicopterTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Helicopter TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconHelicopterSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Helicopter SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconHelicopterBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Helicopter BulkRounded"
    >
      <path 
        d={d.d12}
        i-c="f o7"
...
export const IconHelicopterStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Helicopter StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconHelicopterSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Helicopter SolidSharp"
    >
      <path 
        d={d.d19}
        i-c="c f fr"
...
export const iconPackOfHelicopter: TheIconSelfPack = [
  'Helicopter',
  IconHelicopterStrokeRounded,
  IconHelicopterDuotoneRounded,
  IconHelicopterTwotoneRounded,
  IconHelicopterSolidRounded,
  IconHelicopterBulkRounded,
  IconHelicopterStrokeSharp,
  IconHelicopterSolidSharp,
];