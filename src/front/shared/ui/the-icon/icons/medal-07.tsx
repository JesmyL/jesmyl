...
export const IconMedal07StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Medal07 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMedal07DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Medal07 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMedal07TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Medal07 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfMedal07: TheIconSelfPack = [
  'Medal07',
  IconMedal07StrokeRounded,
  IconMedal07DuotoneRounded,
  IconMedal07TwotoneRounded,
  IconMedal07SolidRounded,
  IconMedal07BulkRounded,
  IconMedal07StrokeSharp,
  IconMedal07SolidSharp,
];