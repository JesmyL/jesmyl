...
export const IconCopy01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Copy01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconCopy01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Copy01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfCopy01: TheIconSelfPack = [
  ...
  IconCopy01DuotoneRounded,
  IconCopy01TwotoneRounded,
  IconCopy01SolidRounded,
  IconCopy01BulkRounded,
  IconCopy01StrokeSharp,
  IconCopy01SolidSharp,
];