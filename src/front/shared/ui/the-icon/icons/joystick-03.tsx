...
export const IconJoystick03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconJoystick03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick03 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconJoystick03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconJoystick03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick03 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconJoystick03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick03 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconJoystick03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick03 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconJoystick03SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick03 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfJoystick03: TheIconSelfPack = [
  'Joystick03',
  IconJoystick03StrokeRounded,
  IconJoystick03DuotoneRounded,
  IconJoystick03TwotoneRounded,
  IconJoystick03SolidRounded,
  IconJoystick03BulkRounded,
  IconJoystick03StrokeSharp,
  IconJoystick03SolidSharp,
];