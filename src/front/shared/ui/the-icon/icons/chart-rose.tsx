...
export const IconChartRoseStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartRose StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconChartRoseDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartRose DuotoneRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d5}
...
export const IconChartRoseTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartRose TwotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="o7 s sw"
...
export const IconChartRoseSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartRose SolidRounded"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const IconChartRoseBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartRose BulkRounded"
    >
      <path 
        d={d.d12}
        i-c="f o7"
...
export const IconChartRoseStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartRose StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const iconPackOfChartRose: TheIconSelfPack = [
  'ChartRose',
  IconChartRoseStrokeRounded,
  IconChartRoseDuotoneRounded,
  IconChartRoseTwotoneRounded,
  IconChartRoseSolidRounded,
  IconChartRoseBulkRounded,
  IconChartRoseStrokeSharp,
  IconChartRoseSolidSharp,
];