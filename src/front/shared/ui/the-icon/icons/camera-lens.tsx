...
export const IconCameraLensStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraLens StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconCameraLensDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraLens DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="c f fr o7"
...
export const IconCameraLensTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraLens TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconCameraLensSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraLens SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconCameraLensBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraLens BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d5}
...
export const IconCameraLensStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraLens StrokeSharp"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconCameraLensSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CameraLens SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfCameraLens: TheIconSelfPack = [
  'CameraLens',
  IconCameraLensStrokeRounded,
  IconCameraLensDuotoneRounded,
  IconCameraLensTwotoneRounded,
  IconCameraLensSolidRounded,
  IconCameraLensBulkRounded,
  IconCameraLensStrokeSharp,
  IconCameraLensSolidSharp,
];