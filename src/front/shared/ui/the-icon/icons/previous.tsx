...
export const IconPreviousStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Previous StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconPreviousDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Previous DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconPreviousTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Previous TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconPreviousSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Previous SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const iconPackOfPrevious: TheIconSelfPack = [
  'Previous',
  IconPreviousStrokeRounded,
  IconPreviousDuotoneRounded,
  IconPreviousTwotoneRounded,
  IconPreviousSolidRounded,
  IconPreviousBulkRounded,
  IconPreviousStrokeSharp,
  IconPreviousSolidSharp,
];