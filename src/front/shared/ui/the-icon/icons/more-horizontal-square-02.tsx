...
export const IconMoreHorizontalSquare02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreHorizontalSquare02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMoreHorizontalSquare02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreHorizontalSquare02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconMoreHorizontalSquare02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreHorizontalSquare02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMoreHorizontalSquare02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreHorizontalSquare02 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconMoreHorizontalSquare02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreHorizontalSquare02 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconMoreHorizontalSquare02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreHorizontalSquare02 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconMoreHorizontalSquare02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreHorizontalSquare02 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfMoreHorizontalSquare02: TheIconSelfPack = [
  ...
  IconMoreHorizontalSquare02StrokeRounded,
  IconMoreHorizontalSquare02DuotoneRounded,
  IconMoreHorizontalSquare02TwotoneRounded,
  IconMoreHorizontalSquare02SolidRounded,
  IconMoreHorizontalSquare02BulkRounded,
  IconMoreHorizontalSquare02StrokeSharp,
  IconMoreHorizontalSquare02SolidSharp,
];