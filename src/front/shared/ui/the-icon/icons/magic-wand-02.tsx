...
export const IconMagicWand02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MagicWand02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMagicWand02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MagicWand02 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconMagicWand02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MagicWand02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMagicWand02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MagicWand02 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconMagicWand02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MagicWand02 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconMagicWand02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MagicWand02 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const IconMagicWand02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MagicWand02 SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfMagicWand02: TheIconSelfPack = [
  'MagicWand02',
  IconMagicWand02StrokeRounded,
  IconMagicWand02DuotoneRounded,
  IconMagicWand02TwotoneRounded,
  IconMagicWand02SolidRounded,
  IconMagicWand02BulkRounded,
  IconMagicWand02StrokeSharp,
  IconMagicWand02SolidSharp,
];