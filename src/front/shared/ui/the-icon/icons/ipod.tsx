...
export const iconPackOfIpod: TheIconSelfPack = [
  'Ipod',
  IconIpodStrokeRounded,
  IconIpodDuotoneRounded,
  IconIpodTwotoneRounded,
  IconIpodSolidRounded,
  IconIpodBulkRounded,
  IconIpodStrokeSharp,
  IconIpodSolidSharp,
];