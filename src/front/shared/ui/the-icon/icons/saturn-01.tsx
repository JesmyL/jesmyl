...
export const IconSaturn01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Saturn01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSaturn01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Saturn01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconSaturn01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Saturn01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconSaturn01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Saturn01 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const iconPackOfSaturn01: TheIconSelfPack = [
  'Saturn01',
  IconSaturn01StrokeRounded,
  IconSaturn01DuotoneRounded,
  IconSaturn01TwotoneRounded,
  IconSaturn01SolidRounded,
  IconSaturn01BulkRounded,
  IconSaturn01StrokeSharp,
  IconSaturn01SolidSharp,
];