...
export const IconCalendar03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Calendar03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCalendar03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Calendar03 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconCalendar03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Calendar03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCalendar03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Calendar03 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconCalendar03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Calendar03 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconCalendar03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Calendar03 StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj ss sw"
...
export const IconCalendar03SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Calendar03 SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfCalendar03: TheIconSelfPack = [
  'Calendar03',
  IconCalendar03StrokeRounded,
  IconCalendar03DuotoneRounded,
  IconCalendar03TwotoneRounded,
  IconCalendar03SolidRounded,
  IconCalendar03BulkRounded,
  IconCalendar03StrokeSharp,
  IconCalendar03SolidSharp,
];