...
export const IconColorPickerStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ColorPicker StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconColorPickerDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ColorPicker DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconColorPickerTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ColorPicker TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconColorPickerSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ColorPicker SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconColorPickerBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ColorPicker BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconColorPickerStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ColorPicker StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const IconColorPickerSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ColorPicker SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfColorPicker: TheIconSelfPack = [
  'ColorPicker',
  IconColorPickerStrokeRounded,
  IconColorPickerDuotoneRounded,
  IconColorPickerTwotoneRounded,
  IconColorPickerSolidRounded,
  IconColorPickerBulkRounded,
  IconColorPickerStrokeSharp,
  IconColorPickerSolidSharp,
];