...
export const IconLessThanSquareStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LessThanSquare StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconLessThanSquareDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LessThanSquare DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconLessThanSquareTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LessThanSquare TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconLessThanSquareSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LessThanSquare SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconLessThanSquareBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LessThanSquare BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconLessThanSquareStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LessThanSquare StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const IconLessThanSquareSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LessThanSquare SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfLessThanSquare: TheIconSelfPack = [
  'LessThanSquare',
  IconLessThanSquareStrokeRounded,
  IconLessThanSquareDuotoneRounded,
  IconLessThanSquareTwotoneRounded,
  IconLessThanSquareSolidRounded,
  IconLessThanSquareBulkRounded,
  IconLessThanSquareStrokeSharp,
  IconLessThanSquareSolidSharp,
];