...
export const IconSchoolBusStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SchoolBus StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSchoolBusDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SchoolBus DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSchoolBusTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SchoolBus TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSchoolBusSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SchoolBus SolidRounded"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const IconSchoolBusBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SchoolBus BulkRounded"
    >
      <path 
        d={d.d16}
        i-c="f o7"
...
export const IconSchoolBusStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SchoolBus StrokeSharp"
    >
      <path 
        d={d.d19}
        i-c="s sj sw"
...
export const iconPackOfSchoolBus: TheIconSelfPack = [
  'SchoolBus',
  IconSchoolBusStrokeRounded,
  IconSchoolBusDuotoneRounded,
  IconSchoolBusTwotoneRounded,
  IconSchoolBusSolidRounded,
  IconSchoolBusBulkRounded,
  IconSchoolBusStrokeSharp,
  IconSchoolBusSolidSharp,
];