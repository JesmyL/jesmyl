...
export const IconSparklesStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sparkles StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconSparklesDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sparkles DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconSparklesTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sparkles TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconSparklesSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sparkles SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const iconPackOfSparkles: TheIconSelfPack = [
  'Sparkles',
  IconSparklesStrokeRounded,
  IconSparklesDuotoneRounded,
  IconSparklesTwotoneRounded,
  IconSparklesSolidRounded,
  IconSparklesBulkRounded,
  IconSparklesStrokeSharp,
  IconSparklesSolidSharp,
];