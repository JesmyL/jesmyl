...
export const IconUserSwitchStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSwitch StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconUserSwitchDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSwitch DuotoneRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d7}
...
export const IconUserSwitchTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSwitch TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconUserSwitchSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSwitch SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const IconUserSwitchBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSwitch BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const IconUserSwitchStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSwitch StrokeSharp"
    >
      <path 
        d={d.d15}
        i-c="s sw"
...
export const IconUserSwitchSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserSwitch SolidSharp"
    >
      <path 
        d={d.d21}
        i-c="f"
...
export const iconPackOfUserSwitch: TheIconSelfPack = [
  'UserSwitch',
  IconUserSwitchStrokeRounded,
  IconUserSwitchDuotoneRounded,
  IconUserSwitchTwotoneRounded,
  IconUserSwitchSolidRounded,
  IconUserSwitchBulkRounded,
  IconUserSwitchStrokeSharp,
  IconUserSwitchSolidSharp,
];