...
export const IconKeyframeRightStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframeRight StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconKeyframeRightDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframeRight DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconKeyframeRightTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframeRight TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconKeyframeRightSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframeRight SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconKeyframeRightBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframeRight BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconKeyframeRightStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframeRight StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sw"
...
export const IconKeyframeRightSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframeRight SolidSharp"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const iconPackOfKeyframeRight: TheIconSelfPack = [
  'KeyframeRight',
  IconKeyframeRightStrokeRounded,
  IconKeyframeRightDuotoneRounded,
  IconKeyframeRightTwotoneRounded,
  IconKeyframeRightSolidRounded,
  IconKeyframeRightBulkRounded,
  IconKeyframeRightStrokeSharp,
  IconKeyframeRightSolidSharp,
];