...
export const iconPackOfZoom: TheIconSelfPack = [
  'Zoom',
  IconZoomStrokeRounded,
  IconZoomDuotoneRounded,
  IconZoomTwotoneRounded,
  IconZoomSolidRounded,
  IconZoomBulkRounded,
  IconZoomStrokeSharp,
  IconZoomSolidSharp,
];