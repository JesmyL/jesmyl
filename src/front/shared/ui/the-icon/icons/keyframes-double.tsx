...
export const IconKeyframesDoubleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframesDouble StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconKeyframesDoubleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframesDouble DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconKeyframesDoubleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframesDouble TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconKeyframesDoubleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframesDouble SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconKeyframesDoubleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframesDouble BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr o7"
...
export const IconKeyframesDoubleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframesDouble StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sw"
...
export const IconKeyframesDoubleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframesDouble SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const iconPackOfKeyframesDouble: TheIconSelfPack = [
  'KeyframesDouble',
  IconKeyframesDoubleStrokeRounded,
  IconKeyframesDoubleDuotoneRounded,
  IconKeyframesDoubleTwotoneRounded,
  IconKeyframesDoubleSolidRounded,
  IconKeyframesDoubleBulkRounded,
  IconKeyframesDoubleStrokeSharp,
  IconKeyframesDoubleSolidSharp,
];