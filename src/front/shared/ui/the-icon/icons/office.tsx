...
export const IconOfficeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Office DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconOfficeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Office TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfOffice: TheIconSelfPack = [
  'Office',
  IconOfficeStrokeRounded,
  IconOfficeDuotoneRounded,
  IconOfficeTwotoneRounded,
  IconOfficeSolidRounded,
  IconOfficeBulkRounded,
  IconOfficeStrokeSharp,
  IconOfficeSolidSharp,
];