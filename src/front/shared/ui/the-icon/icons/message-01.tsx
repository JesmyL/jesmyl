...
export const IconMessage01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Message01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMessage01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Message01 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconMessage01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Message01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconMessage01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Message01 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconMessage01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Message01 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconMessage01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Message01 StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const iconPackOfMessage01: TheIconSelfPack = [
  ...
  IconMessage01DuotoneRounded,
  IconMessage01TwotoneRounded,
  IconMessage01SolidRounded,
  IconMessage01BulkRounded,
  IconMessage01StrokeSharp,
  IconMessage01SolidSharp,
];