...
export const IconBitcoin01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bitcoin01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBitcoin01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bitcoin01 DuotoneRounded"
    >
      <path 
        d={d.d10}
        i-c="f o7"
...
export const IconBitcoin01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bitcoin01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBitcoin01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bitcoin01 SolidRounded"
    >
      <path 
        d={d.d12}
        i-c="f"
...
export const IconBitcoin01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bitcoin01 BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d13}
...
export const IconBitcoin01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bitcoin01 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfBitcoin01: TheIconSelfPack = [
  'Bitcoin01',
  IconBitcoin01StrokeRounded,
  IconBitcoin01DuotoneRounded,
  IconBitcoin01TwotoneRounded,
  IconBitcoin01SolidRounded,
  IconBitcoin01BulkRounded,
  IconBitcoin01StrokeSharp,
  IconBitcoin01SolidSharp,
];