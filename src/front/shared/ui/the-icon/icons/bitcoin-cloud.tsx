...
export const IconBitcoinCloudStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinCloud StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBitcoinCloudDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinCloud DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBitcoinCloudTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinCloud TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBitcoinCloudSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinCloud SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconBitcoinCloudBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinCloud BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconBitcoinCloudStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinCloud StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconBitcoinCloudSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinCloud SolidSharp"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const iconPackOfBitcoinCloud: TheIconSelfPack = [
  'BitcoinCloud',
  IconBitcoinCloudStrokeRounded,
  IconBitcoinCloudDuotoneRounded,
  IconBitcoinCloudTwotoneRounded,
  IconBitcoinCloudSolidRounded,
  IconBitcoinCloudBulkRounded,
  IconBitcoinCloudStrokeSharp,
  IconBitcoinCloudSolidSharp,
];