...
export const IconChurchDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Church DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconChurchTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Church TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfChurch: TheIconSelfPack = [
  'Church',
  IconChurchStrokeRounded,
  IconChurchDuotoneRounded,
  IconChurchTwotoneRounded,
  IconChurchSolidRounded,
  IconChurchBulkRounded,
  IconChurchStrokeSharp,
  IconChurchSolidSharp,
];