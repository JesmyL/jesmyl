...
export const IconZoomInAreaStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ZoomInArea StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconZoomInAreaDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ZoomInArea DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconZoomInAreaTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ZoomInArea TwotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="s sj sr sw"
...
export const IconZoomInAreaSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ZoomInArea SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconZoomInAreaBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ZoomInArea BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconZoomInAreaStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ZoomInArea StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconZoomInAreaSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ZoomInArea SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfZoomInArea: TheIconSelfPack = [
  'ZoomInArea',
  IconZoomInAreaStrokeRounded,
  IconZoomInAreaDuotoneRounded,
  IconZoomInAreaTwotoneRounded,
  IconZoomInAreaSolidRounded,
  IconZoomInAreaBulkRounded,
  IconZoomInAreaStrokeSharp,
  IconZoomInAreaSolidSharp,
];