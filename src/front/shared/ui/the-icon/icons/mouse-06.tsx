...
export const IconMouse06StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mouse06 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMouse06DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mouse06 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconMouse06TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mouse06 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfMouse06: TheIconSelfPack = [
  'Mouse06',
  IconMouse06StrokeRounded,
  IconMouse06DuotoneRounded,
  IconMouse06TwotoneRounded,
  IconMouse06SolidRounded,
  IconMouse06BulkRounded,
  IconMouse06StrokeSharp,
  IconMouse06SolidSharp,
];