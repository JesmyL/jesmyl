...
export const IconDeleteThrowStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeleteThrow StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDeleteThrowDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeleteThrow DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconDeleteThrowTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeleteThrow TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDeleteThrowSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeleteThrow SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconDeleteThrowBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeleteThrow BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconDeleteThrowStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeleteThrow StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sw"
...
export const IconDeleteThrowSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeleteThrow SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfDeleteThrow: TheIconSelfPack = [
  'DeleteThrow',
  IconDeleteThrowStrokeRounded,
  IconDeleteThrowDuotoneRounded,
  IconDeleteThrowTwotoneRounded,
  IconDeleteThrowSolidRounded,
  IconDeleteThrowBulkRounded,
  IconDeleteThrowStrokeSharp,
  IconDeleteThrowSolidSharp,
];