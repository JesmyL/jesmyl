...
export const IconHologramStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Hologram StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconHologramDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Hologram DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconHologramTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Hologram TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconHologramSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Hologram SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfHologram: TheIconSelfPack = [
  'Hologram',
  IconHologramStrokeRounded,
  IconHologramDuotoneRounded,
  IconHologramTwotoneRounded,
  IconHologramSolidRounded,
  IconHologramBulkRounded,
  IconHologramStrokeSharp,
  IconHologramSolidSharp,
];