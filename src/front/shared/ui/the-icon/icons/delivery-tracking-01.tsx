...
export const IconDeliveryTracking01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveryTracking01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDeliveryTracking01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveryTracking01 DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconDeliveryTracking01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveryTracking01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDeliveryTracking01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveryTracking01 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconDeliveryTracking01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveryTracking01 BulkRounded"
    >
      <path 
        d={d.d11}
        i-c="f o7"
...
export const IconDeliveryTracking01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveryTracking01 StrokeSharp"
    >
      <path 
        d={d.d14}
        i-c="s sj sw"
...
export const IconDeliveryTracking01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DeliveryTracking01 SolidSharp"
    >
      <path 
        d={d.d18}
        i-c="c f fr"
...
export const iconPackOfDeliveryTracking01: TheIconSelfPack = [
  'DeliveryTracking01',
  IconDeliveryTracking01StrokeRounded,
  IconDeliveryTracking01DuotoneRounded,
  IconDeliveryTracking01TwotoneRounded,
  IconDeliveryTracking01SolidRounded,
  IconDeliveryTracking01BulkRounded,
  IconDeliveryTracking01StrokeSharp,
  IconDeliveryTracking01SolidSharp,
];