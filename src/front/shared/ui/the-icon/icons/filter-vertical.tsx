...
export const IconFilterVerticalStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterVertical StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFilterVerticalDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterVertical DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconFilterVerticalTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterVertical TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFilterVerticalSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterVertical SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconFilterVerticalBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterVertical BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconFilterVerticalStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterVertical StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconFilterVerticalSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterVertical SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfFilterVertical: TheIconSelfPack = [
  'FilterVertical',
  IconFilterVerticalStrokeRounded,
  IconFilterVerticalDuotoneRounded,
  IconFilterVerticalTwotoneRounded,
  IconFilterVerticalSolidRounded,
  IconFilterVerticalBulkRounded,
  IconFilterVerticalStrokeSharp,
  IconFilterVerticalSolidSharp,
];