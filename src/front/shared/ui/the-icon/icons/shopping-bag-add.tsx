...
export const IconShoppingBagAddStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBagAdd StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShoppingBagAddDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBagAdd DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconShoppingBagAddTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBagAdd TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShoppingBagAddSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBagAdd SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconShoppingBagAddBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBagAdd BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconShoppingBagAddStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBagAdd StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sw"
...
export const IconShoppingBagAddSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBagAdd SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfShoppingBagAdd: TheIconSelfPack = [
  'ShoppingBagAdd',
  IconShoppingBagAddStrokeRounded,
  IconShoppingBagAddDuotoneRounded,
  IconShoppingBagAddTwotoneRounded,
  IconShoppingBagAddSolidRounded,
  IconShoppingBagAddBulkRounded,
  IconShoppingBagAddStrokeSharp,
  IconShoppingBagAddSolidSharp,
];