...
export const IconMouseLeftClick05StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MouseLeftClick05 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconMouseLeftClick05DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MouseLeftClick05 DuotoneRounded"
    >
      <circle 
        cx="5.5"
        cy="5.5"
...
export const IconMouseLeftClick05TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MouseLeftClick05 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconMouseLeftClick05SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MouseLeftClick05 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconMouseLeftClick05BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MouseLeftClick05 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconMouseLeftClick05StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MouseLeftClick05 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconMouseLeftClick05SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MouseLeftClick05 SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfMouseLeftClick05: TheIconSelfPack = [
  'MouseLeftClick05',
  IconMouseLeftClick05StrokeRounded,
  IconMouseLeftClick05DuotoneRounded,
  IconMouseLeftClick05TwotoneRounded,
  IconMouseLeftClick05SolidRounded,
  IconMouseLeftClick05BulkRounded,
  IconMouseLeftClick05StrokeSharp,
  IconMouseLeftClick05SolidSharp,
];