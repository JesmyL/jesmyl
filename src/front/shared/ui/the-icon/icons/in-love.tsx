...
export const IconInLoveDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InLove DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconInLoveTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InLove TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfInLove: TheIconSelfPack = [
  'InLove',
  IconInLoveStrokeRounded,
  IconInLoveDuotoneRounded,
  IconInLoveTwotoneRounded,
  IconInLoveSolidRounded,
  IconInLoveBulkRounded,
  IconInLoveStrokeSharp,
  IconInLoveSolidSharp,
];