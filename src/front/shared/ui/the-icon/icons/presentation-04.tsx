...
export const IconPresentation04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPresentation04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation04 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconPresentation04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPresentation04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation04 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconPresentation04BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation04 BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconPresentation04StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation04 StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sw"
...
export const IconPresentation04SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Presentation04 SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="f"
...
export const iconPackOfPresentation04: TheIconSelfPack = [
  'Presentation04',
  IconPresentation04StrokeRounded,
  IconPresentation04DuotoneRounded,
  IconPresentation04TwotoneRounded,
  IconPresentation04SolidRounded,
  IconPresentation04BulkRounded,
  IconPresentation04StrokeSharp,
  IconPresentation04SolidSharp,
];