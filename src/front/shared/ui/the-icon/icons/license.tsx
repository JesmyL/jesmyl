...
export const IconLicenseStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="License StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconLicenseDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="License DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconLicenseTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="License TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfLicense: TheIconSelfPack = [
  'License',
  IconLicenseStrokeRounded,
  IconLicenseDuotoneRounded,
  IconLicenseTwotoneRounded,
  IconLicenseSolidRounded,
  IconLicenseBulkRounded,
  IconLicenseStrokeSharp,
  IconLicenseSolidSharp,
];