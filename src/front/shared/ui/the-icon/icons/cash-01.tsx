...
export const IconCash01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cash01 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconCash01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cash01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const iconPackOfCash01: TheIconSelfPack = [
  'Cash01',
  IconCash01StrokeRounded,
  IconCash01DuotoneRounded,
  IconCash01TwotoneRounded,
  IconCash01SolidRounded,
  IconCash01BulkRounded,
  IconCash01StrokeSharp,
  IconCash01SolidSharp,
];