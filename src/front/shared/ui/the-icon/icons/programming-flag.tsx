...
export const IconProgrammingFlagStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ProgrammingFlag StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconProgrammingFlagDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ProgrammingFlag DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconProgrammingFlagTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ProgrammingFlag TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconProgrammingFlagSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ProgrammingFlag SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconProgrammingFlagBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ProgrammingFlag BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconProgrammingFlagStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ProgrammingFlag StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sw"
...
export const IconProgrammingFlagSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ProgrammingFlag SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfProgrammingFlag: TheIconSelfPack = [
  'ProgrammingFlag',
  IconProgrammingFlagStrokeRounded,
  IconProgrammingFlagDuotoneRounded,
  IconProgrammingFlagTwotoneRounded,
  IconProgrammingFlagSolidRounded,
  IconProgrammingFlagBulkRounded,
  IconProgrammingFlagStrokeSharp,
  IconProgrammingFlagSolidSharp,
];