...
export const IconColumnDeleteStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ColumnDelete StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconColumnDeleteDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ColumnDelete DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconColumnDeleteTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ColumnDelete TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconColumnDeleteSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ColumnDelete SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconColumnDeleteBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ColumnDelete BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconColumnDeleteStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ColumnDelete StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sr sw"
...
export const IconColumnDeleteSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ColumnDelete SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const iconPackOfColumnDelete: TheIconSelfPack = [
  'ColumnDelete',
  IconColumnDeleteStrokeRounded,
  IconColumnDeleteDuotoneRounded,
  IconColumnDeleteTwotoneRounded,
  IconColumnDeleteSolidRounded,
  IconColumnDeleteBulkRounded,
  IconColumnDeleteStrokeSharp,
  IconColumnDeleteSolidSharp,
];