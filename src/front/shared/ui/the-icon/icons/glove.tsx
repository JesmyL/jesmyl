...
export const iconPackOfGlove: TheIconSelfPack = [
  'Glove',
  IconGloveStrokeRounded,
  IconGloveDuotoneRounded,
  IconGloveTwotoneRounded,
  IconGloveSolidRounded,
  IconGloveBulkRounded,
  IconGloveStrokeSharp,
  IconGloveSolidSharp,
];