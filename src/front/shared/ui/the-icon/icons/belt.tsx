...
export const iconPackOfBelt: TheIconSelfPack = [
  'Belt',
  IconBeltStrokeRounded,
  IconBeltDuotoneRounded,
  IconBeltTwotoneRounded,
  IconBeltSolidRounded,
  IconBeltBulkRounded,
  IconBeltStrokeSharp,
  IconBeltSolidSharp,
];