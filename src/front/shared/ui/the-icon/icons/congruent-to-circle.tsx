...
export const IconCongruentToCircleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CongruentToCircle StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCongruentToCircleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CongruentToCircle DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconCongruentToCircleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CongruentToCircle TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconCongruentToCircleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CongruentToCircle SolidRounded"
    >
      <path 
        d={d.d2}
        i-c="c f fr"
...
export const IconCongruentToCircleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CongruentToCircle BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconCongruentToCircleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CongruentToCircle StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconCongruentToCircleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CongruentToCircle SolidSharp"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const iconPackOfCongruentToCircle: TheIconSelfPack = [
  'CongruentToCircle',
  IconCongruentToCircleStrokeRounded,
  IconCongruentToCircleDuotoneRounded,
  IconCongruentToCircleTwotoneRounded,
  IconCongruentToCircleSolidRounded,
  IconCongruentToCircleBulkRounded,
  IconCongruentToCircleStrokeSharp,
  IconCongruentToCircleSolidSharp,
];