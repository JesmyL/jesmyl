...
export const IconComingSoon01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComingSoon01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconComingSoon01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComingSoon01 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconComingSoon01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComingSoon01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconComingSoon01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComingSoon01 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconComingSoon01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComingSoon01 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconComingSoon01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComingSoon01 StrokeSharp"
    >
      <path 
        d={d.d14}
        i-c="s sj ss sw"
...
export const IconComingSoon01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComingSoon01 SolidSharp"
    >
      <path 
        d={d.d18}
        i-c="c f fr"
...
export const iconPackOfComingSoon01: TheIconSelfPack = [
  'ComingSoon01',
  IconComingSoon01StrokeRounded,
  IconComingSoon01DuotoneRounded,
  IconComingSoon01TwotoneRounded,
  IconComingSoon01SolidRounded,
  IconComingSoon01BulkRounded,
  IconComingSoon01StrokeSharp,
  IconComingSoon01SolidSharp,
];