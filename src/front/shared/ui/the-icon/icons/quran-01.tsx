...
export const IconQuran01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Quran01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconQuran01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Quran01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconQuran01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Quran01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfQuran01: TheIconSelfPack = [
  'Quran01',
  IconQuran01StrokeRounded,
  IconQuran01DuotoneRounded,
  IconQuran01TwotoneRounded,
  IconQuran01SolidRounded,
  IconQuran01BulkRounded,
  IconQuran01StrokeSharp,
  IconQuran01SolidSharp,
];