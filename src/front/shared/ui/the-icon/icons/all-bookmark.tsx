...
export const IconAllBookmarkStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AllBookmark StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAllBookmarkDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AllBookmark DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconAllBookmarkTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AllBookmark TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconAllBookmarkSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AllBookmark SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconAllBookmarkBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AllBookmark BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconAllBookmarkStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AllBookmark StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sj sw"
...
export const IconAllBookmarkSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AllBookmark SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const iconPackOfAllBookmark: TheIconSelfPack = [
  'AllBookmark',
  IconAllBookmarkStrokeRounded,
  IconAllBookmarkDuotoneRounded,
  IconAllBookmarkTwotoneRounded,
  IconAllBookmarkSolidRounded,
  IconAllBookmarkBulkRounded,
  IconAllBookmarkStrokeSharp,
  IconAllBookmarkSolidSharp,
];