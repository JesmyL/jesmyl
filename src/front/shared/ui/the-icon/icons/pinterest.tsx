...
export const IconPinterestStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pinterest StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPinterestDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pinterest DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconPinterestTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pinterest TwotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="o7 s sj sr sw"
...
export const IconPinterestSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pinterest SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconPinterestBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pinterest BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconPinterestStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pinterest StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfPinterest: TheIconSelfPack = [
  'Pinterest',
  IconPinterestStrokeRounded,
  IconPinterestDuotoneRounded,
  IconPinterestTwotoneRounded,
  IconPinterestSolidRounded,
  IconPinterestBulkRounded,
  IconPinterestStrokeSharp,
  IconPinterestSolidSharp,
];