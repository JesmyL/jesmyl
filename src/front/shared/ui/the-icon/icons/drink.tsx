...
export const iconPackOfDrink: TheIconSelfPack = [
  'Drink',
  IconDrinkStrokeRounded,
  IconDrinkDuotoneRounded,
  IconDrinkTwotoneRounded,
  IconDrinkSolidRounded,
  IconDrinkBulkRounded,
  IconDrinkStrokeSharp,
  IconDrinkSolidSharp,
];