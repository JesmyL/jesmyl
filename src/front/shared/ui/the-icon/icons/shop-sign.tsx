...
export const IconShopSignStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShopSign StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconShopSignDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShopSign DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconShopSignTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShopSign TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconShopSignSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShopSign SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const iconPackOfShopSign: TheIconSelfPack = [
  'ShopSign',
  IconShopSignStrokeRounded,
  IconShopSignDuotoneRounded,
  IconShopSignTwotoneRounded,
  IconShopSignSolidRounded,
  IconShopSignBulkRounded,
  IconShopSignStrokeSharp,
  IconShopSignSolidSharp,
];