...
export const IconSafetyPin01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SafetyPin01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSafetyPin01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SafetyPin01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconSafetyPin01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SafetyPin01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSafetyPin01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SafetyPin01 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconSafetyPin01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SafetyPin01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconSafetyPin01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SafetyPin01 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sr sw"
...
export const IconSafetyPin01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SafetyPin01 SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfSafetyPin01: TheIconSelfPack = [
  'SafetyPin01',
  IconSafetyPin01StrokeRounded,
  IconSafetyPin01DuotoneRounded,
  IconSafetyPin01TwotoneRounded,
  IconSafetyPin01SolidRounded,
  IconSafetyPin01BulkRounded,
  IconSafetyPin01StrokeSharp,
  IconSafetyPin01SolidSharp,
];