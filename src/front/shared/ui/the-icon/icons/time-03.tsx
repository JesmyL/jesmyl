...
export const IconTime03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Time03 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconTime03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Time03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfTime03: TheIconSelfPack = [
  'Time03',
  IconTime03StrokeRounded,
  IconTime03DuotoneRounded,
  IconTime03TwotoneRounded,
  IconTime03SolidRounded,
  IconTime03BulkRounded,
  IconTime03StrokeSharp,
  IconTime03SolidSharp,
];