...
export const IconMusicNote01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNote01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMusicNote01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNote01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconMusicNote01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNote01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconMusicNote01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNote01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconMusicNote01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNote01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconMusicNote01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNote01 StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconMusicNote01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNote01 SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfMusicNote01: TheIconSelfPack = [
  'MusicNote01',
  IconMusicNote01StrokeRounded,
  IconMusicNote01DuotoneRounded,
  IconMusicNote01TwotoneRounded,
  IconMusicNote01SolidRounded,
  IconMusicNote01BulkRounded,
  IconMusicNote01StrokeSharp,
  IconMusicNote01SolidSharp,
];