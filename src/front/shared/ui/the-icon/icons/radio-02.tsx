...
export const IconRadio02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Radio02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRadio02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Radio02 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconRadio02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Radio02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfRadio02: TheIconSelfPack = [
  'Radio02',
  IconRadio02StrokeRounded,
  IconRadio02DuotoneRounded,
  IconRadio02TwotoneRounded,
  IconRadio02SolidRounded,
  IconRadio02BulkRounded,
  IconRadio02StrokeSharp,
  IconRadio02SolidSharp,
];