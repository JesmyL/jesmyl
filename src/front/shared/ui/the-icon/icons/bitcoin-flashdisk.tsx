...
export const IconBitcoinFlashdiskStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinFlashdisk StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBitcoinFlashdiskDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinFlashdisk DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconBitcoinFlashdiskTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinFlashdisk TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBitcoinFlashdiskSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinFlashdisk SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconBitcoinFlashdiskBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinFlashdisk BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconBitcoinFlashdiskStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinFlashdisk StrokeSharp"
    >
      <path 
        d={d.d2}
        i-c="s sj ss sw"
...
export const IconBitcoinFlashdiskSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinFlashdisk SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfBitcoinFlashdisk: TheIconSelfPack = [
  'BitcoinFlashdisk',
  IconBitcoinFlashdiskStrokeRounded,
  IconBitcoinFlashdiskDuotoneRounded,
  IconBitcoinFlashdiskTwotoneRounded,
  IconBitcoinFlashdiskSolidRounded,
  IconBitcoinFlashdiskBulkRounded,
  IconBitcoinFlashdiskStrokeSharp,
  IconBitcoinFlashdiskSolidSharp,
];