...
export const iconPackOfPi: TheIconSelfPack = [
  'Pi',
  IconPiStrokeRounded,
  IconPiDuotoneRounded,
  IconPiTwotoneRounded,
  IconPiSolidRounded,
  IconPiBulkRounded,
  IconPiStrokeSharp,
  IconPiSolidSharp,
