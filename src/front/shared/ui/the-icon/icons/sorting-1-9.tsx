...
export const IconSorting19StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sorting19 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSorting19DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sorting19 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSorting19TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sorting19 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconSorting19SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sorting19 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconSorting19BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sorting19 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconSorting19StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sorting19 StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const iconPackOfSorting19: TheIconSelfPack = [
  'Sorting19',
  IconSorting19StrokeRounded,
  IconSorting19DuotoneRounded,
  IconSorting19TwotoneRounded,
  IconSorting19SolidRounded,
  IconSorting19BulkRounded,
  IconSorting19StrokeSharp,
  IconSorting19SolidSharp,
];