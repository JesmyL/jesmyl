...
export const IconStraightEdgeStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StraightEdge StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconStraightEdgeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StraightEdge DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconStraightEdgeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StraightEdge TwotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="o7 s sj sr sw"
...
export const IconStraightEdgeSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StraightEdge SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconStraightEdgeBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StraightEdge BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconStraightEdgeStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StraightEdge StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sj sw"
...
export const IconStraightEdgeSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StraightEdge SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfStraightEdge: TheIconSelfPack = [
  'StraightEdge',
  IconStraightEdgeStrokeRounded,
  IconStraightEdgeDuotoneRounded,
  IconStraightEdgeTwotoneRounded,
  IconStraightEdgeSolidRounded,
  IconStraightEdgeBulkRounded,
  IconStraightEdgeStrokeSharp,
  IconStraightEdgeSolidSharp,
];