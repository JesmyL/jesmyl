...
export const IconRowInsertStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RowInsert StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconRowInsertDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RowInsert DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconRowInsertTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RowInsert TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconRowInsertSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RowInsert SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconRowInsertBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RowInsert BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconRowInsertStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RowInsert StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const iconPackOfRowInsert: TheIconSelfPack = [
  'RowInsert',
  IconRowInsertStrokeRounded,
  IconRowInsertDuotoneRounded,
  IconRowInsertTwotoneRounded,
  IconRowInsertSolidRounded,
  IconRowInsertBulkRounded,
  IconRowInsertStrokeSharp,
  IconRowInsertSolidSharp,
];