...
export const IconKnife01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Knife01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconKnife01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Knife01 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconKnife01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Knife01 TwotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="o7 s sj sr sw"
...
export const iconPackOfKnife01: TheIconSelfPack = [
  'Knife01',
  IconKnife01StrokeRounded,
  IconKnife01DuotoneRounded,
  IconKnife01TwotoneRounded,
  IconKnife01SolidRounded,
  IconKnife01BulkRounded,
  IconKnife01StrokeSharp,
  IconKnife01SolidSharp,
];