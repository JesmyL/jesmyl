...
export const IconBathtub02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bathtub02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBathtub02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bathtub02 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconBathtub02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bathtub02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBathtub02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bathtub02 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconBathtub02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bathtub02 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconBathtub02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bathtub02 StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sw"
...
export const iconPackOfBathtub02: TheIconSelfPack = [
  'Bathtub02',
  IconBathtub02StrokeRounded,
  IconBathtub02DuotoneRounded,
  IconBathtub02TwotoneRounded,
  IconBathtub02SolidRounded,
  IconBathtub02BulkRounded,
  IconBathtub02StrokeSharp,
  IconBathtub02SolidSharp,
];