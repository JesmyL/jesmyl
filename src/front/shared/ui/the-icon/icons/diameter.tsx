...
export const IconDiameterStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Diameter StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDiameterDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Diameter DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr o7"
...
export const IconDiameterTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Diameter TwotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="s sw"
...
export const IconDiameterSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Diameter SolidRounded"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfDiameter: TheIconSelfPack = [
  'Diameter',
  IconDiameterStrokeRounded,
  IconDiameterDuotoneRounded,
  IconDiameterTwotoneRounded,
  IconDiameterSolidRounded,
  IconDiameterBulkRounded,
  IconDiameterStrokeSharp,
  IconDiameterSolidSharp,
];