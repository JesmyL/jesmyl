...
export const IconPreferenceVerticalStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PreferenceVertical StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPreferenceVerticalDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PreferenceVertical DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconPreferenceVerticalTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PreferenceVertical TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconPreferenceVerticalSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PreferenceVertical SolidRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const IconPreferenceVerticalBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PreferenceVertical BulkRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const IconPreferenceVerticalStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PreferenceVertical StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconPreferenceVerticalSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PreferenceVertical SolidSharp"
    >
      <path 
        d={d.d25}
        i-c="c f fr"
...
export const iconPackOfPreferenceVertical: TheIconSelfPack = [
  'PreferenceVertical',
  IconPreferenceVerticalStrokeRounded,
  IconPreferenceVerticalDuotoneRounded,
  IconPreferenceVerticalTwotoneRounded,
  IconPreferenceVerticalSolidRounded,
  IconPreferenceVerticalBulkRounded,
  IconPreferenceVerticalStrokeSharp,
  IconPreferenceVerticalSolidSharp,
];