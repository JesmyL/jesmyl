...
export const IconUnavailableStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Unavailable StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUnavailableDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Unavailable DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconUnavailableTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Unavailable TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconUnavailableSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Unavailable SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconUnavailableBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Unavailable BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconUnavailableStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Unavailable StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const IconUnavailableSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Unavailable SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfUnavailable: TheIconSelfPack = [
  'Unavailable',
  IconUnavailableStrokeRounded,
  IconUnavailableDuotoneRounded,
  IconUnavailableTwotoneRounded,
  IconUnavailableSolidRounded,
  IconUnavailableBulkRounded,
  IconUnavailableStrokeSharp,
  IconUnavailableSolidSharp,
];