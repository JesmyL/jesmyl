...
export const IconImageNotFound01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageNotFound01 StrokeRounded"
    >
      <circle 
        cx="16.5"
        cy="7.5"
...
export const IconImageNotFound01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageNotFound01 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconImageNotFound01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageNotFound01 TwotoneRounded"
    >
      <circle 
        cx="16.5"
        cy="7.5"
...
export const IconImageNotFound01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageNotFound01 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconImageNotFound01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageNotFound01 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconImageNotFound01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageNotFound01 StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const IconImageNotFound01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageNotFound01 SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="f"
...
export const iconPackOfImageNotFound01: TheIconSelfPack = [
  'ImageNotFound01',
  IconImageNotFound01StrokeRounded,
  IconImageNotFound01DuotoneRounded,
  IconImageNotFound01TwotoneRounded,
  IconImageNotFound01SolidRounded,
  IconImageNotFound01BulkRounded,
  IconImageNotFound01StrokeSharp,
  IconImageNotFound01SolidSharp,
];