...
export const IconShoppingBasketRemove01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketRemove01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShoppingBasketRemove01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketRemove01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconShoppingBasketRemove01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketRemove01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShoppingBasketRemove01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketRemove01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconShoppingBasketRemove01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketRemove01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconShoppingBasketRemove01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketRemove01 StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sw"
...
export const IconShoppingBasketRemove01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketRemove01 SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfShoppingBasketRemove01: TheIconSelfPack = [
  ...
  IconShoppingBasketRemove01StrokeRounded,
  IconShoppingBasketRemove01DuotoneRounded,
  IconShoppingBasketRemove01TwotoneRounded,
  IconShoppingBasketRemove01SolidRounded,
  IconShoppingBasketRemove01BulkRounded,
  IconShoppingBasketRemove01StrokeSharp,
  IconShoppingBasketRemove01SolidSharp,
];