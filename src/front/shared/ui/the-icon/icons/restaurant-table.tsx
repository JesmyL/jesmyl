...
export const IconRestaurantTableStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RestaurantTable StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRestaurantTableDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RestaurantTable DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconRestaurantTableTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RestaurantTable TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRestaurantTableSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RestaurantTable SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconRestaurantTableBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RestaurantTable BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconRestaurantTableStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RestaurantTable StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s ss sw"
...
export const IconRestaurantTableSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RestaurantTable SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfRestaurantTable: TheIconSelfPack = [
  'RestaurantTable',
  IconRestaurantTableStrokeRounded,
  IconRestaurantTableDuotoneRounded,
  IconRestaurantTableTwotoneRounded,
  IconRestaurantTableSolidRounded,
  IconRestaurantTableBulkRounded,
  IconRestaurantTableStrokeSharp,
  IconRestaurantTableSolidSharp,
];