...
export const IconAlarmClockStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlarmClock StrokeRounded"
    >
      <circle 
        cx="12"
        cy="13"
...
export const IconAlarmClockDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlarmClock DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="13"
...
export const IconAlarmClockTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlarmClock TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="13"
...
export const IconAlarmClockSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlarmClock SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconAlarmClockBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlarmClock BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconAlarmClockStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlarmClock StrokeSharp"
    >
      <circle 
        cx="12"
        cy="13"
...
export const IconAlarmClockSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlarmClock SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const iconPackOfAlarmClock: TheIconSelfPack = [
  'AlarmClock',
  IconAlarmClockStrokeRounded,
  IconAlarmClockDuotoneRounded,
  IconAlarmClockTwotoneRounded,
  IconAlarmClockSolidRounded,
  IconAlarmClockBulkRounded,
  IconAlarmClockStrokeSharp,
  IconAlarmClockSolidSharp,
];