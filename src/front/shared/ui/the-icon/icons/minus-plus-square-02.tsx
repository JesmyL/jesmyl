...
export const IconMinusPlusSquare02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MinusPlusSquare02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconMinusPlusSquare02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MinusPlusSquare02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconMinusPlusSquare02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MinusPlusSquare02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconMinusPlusSquare02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MinusPlusSquare02 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconMinusPlusSquare02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MinusPlusSquare02 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconMinusPlusSquare02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MinusPlusSquare02 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const IconMinusPlusSquare02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MinusPlusSquare02 SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfMinusPlusSquare02: TheIconSelfPack = [
  'MinusPlusSquare02',
  IconMinusPlusSquare02StrokeRounded,
  IconMinusPlusSquare02DuotoneRounded,
  IconMinusPlusSquare02TwotoneRounded,
  IconMinusPlusSquare02SolidRounded,
  IconMinusPlusSquare02BulkRounded,
  IconMinusPlusSquare02StrokeSharp,
  IconMinusPlusSquare02SolidSharp,
];