...
export const iconPackOfYen: TheIconSelfPack = [
  'Yen',
  IconYenStrokeRounded,
  IconYenDuotoneRounded,
  IconYenTwotoneRounded,
  IconYenSolidRounded,
  IconYenBulkRounded,
  IconYenStrokeSharp,
  IconYenSolidSharp,
