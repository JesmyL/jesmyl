...
export const IconArrowLeft04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowLeft04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconArrowLeft04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowLeft04 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconArrowLeft04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowLeft04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconArrowLeft04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowLeft04 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconArrowLeft04BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowLeft04 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconArrowLeft04StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowLeft04 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const IconArrowLeft04SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowLeft04 SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const iconPackOfArrowLeft04: TheIconSelfPack = [
  'ArrowLeft04',
  IconArrowLeft04StrokeRounded,
  IconArrowLeft04DuotoneRounded,
  IconArrowLeft04TwotoneRounded,
  IconArrowLeft04SolidRounded,
  IconArrowLeft04BulkRounded,
  IconArrowLeft04StrokeSharp,
  IconArrowLeft04SolidSharp,
];