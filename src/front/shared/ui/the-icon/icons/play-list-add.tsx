...
export const IconPlayListAddStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListAdd StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconPlayListAddDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListAdd DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconPlayListAddTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListAdd TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconPlayListAddSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListAdd SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconPlayListAddBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListAdd BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d7}
...
export const IconPlayListAddStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListAdd StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const IconPlayListAddSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListAdd SolidSharp"
    >
      <path 
        d={d.d16}
        i-c="f"
...
export const iconPackOfPlayListAdd: TheIconSelfPack = [
  'PlayListAdd',
  IconPlayListAddStrokeRounded,
  IconPlayListAddDuotoneRounded,
  IconPlayListAddTwotoneRounded,
  IconPlayListAddSolidRounded,
  IconPlayListAddBulkRounded,
  IconPlayListAddStrokeSharp,
  IconPlayListAddSolidSharp,
];