...
export const IconDish01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Dish01 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconDish01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Dish01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfDish01: TheIconSelfPack = [
  'Dish01',
  IconDish01StrokeRounded,
  IconDish01DuotoneRounded,
  IconDish01TwotoneRounded,
  IconDish01SolidRounded,
  IconDish01BulkRounded,
  IconDish01StrokeSharp,
  IconDish01SolidSharp,
];