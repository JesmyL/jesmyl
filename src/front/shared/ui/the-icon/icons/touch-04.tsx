...
export const IconTouch04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Touch04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTouch04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Touch04 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconTouch04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Touch04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfTouch04: TheIconSelfPack = [
  'Touch04',
  IconTouch04StrokeRounded,
  IconTouch04DuotoneRounded,
  IconTouch04TwotoneRounded,
  IconTouch04SolidRounded,
  IconTouch04BulkRounded,
  IconTouch04StrokeSharp,
  IconTouch04SolidSharp,
];