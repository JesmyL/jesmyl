...
export const IconCursorTextStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorText StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCursorTextDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorText DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconCursorTextTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorText TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCursorTextSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorText SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconCursorTextBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorText BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconCursorTextStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorText StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const IconCursorTextSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorText SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfCursorText: TheIconSelfPack = [
  'CursorText',
  IconCursorTextStrokeRounded,
  IconCursorTextDuotoneRounded,
  IconCursorTextTwotoneRounded,
  IconCursorTextSolidRounded,
  IconCursorTextBulkRounded,
  IconCursorTextStrokeSharp,
  IconCursorTextSolidSharp,
];