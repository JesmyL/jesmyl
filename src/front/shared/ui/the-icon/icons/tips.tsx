...
export const iconPackOfTips: TheIconSelfPack = [
  'Tips',
  IconTipsStrokeRounded,
  IconTipsDuotoneRounded,
  IconTipsTwotoneRounded,
  IconTipsSolidRounded,
  IconTipsBulkRounded,
  IconTipsStrokeSharp,
  IconTipsSolidSharp,
];