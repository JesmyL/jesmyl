...
export const IconBorderFullStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BorderFull StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBorderFullDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BorderFull DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconBorderFullTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BorderFull TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBorderFullSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BorderFull SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconBorderFullBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BorderFull BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconBorderFullStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BorderFull StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sr sw"
...
export const IconBorderFullSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BorderFull SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfBorderFull: TheIconSelfPack = [
  'BorderFull',
  IconBorderFullStrokeRounded,
  IconBorderFullDuotoneRounded,
  IconBorderFullTwotoneRounded,
  IconBorderFullSolidRounded,
  IconBorderFullBulkRounded,
  IconBorderFullStrokeSharp,
  IconBorderFullSolidSharp,
];