...
export const IconTemperatureStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Temperature StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconTemperatureDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Temperature DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconTemperatureTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Temperature TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconTemperatureSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Temperature SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconTemperatureBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Temperature BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconTemperatureStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Temperature StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s ss sw"
...
export const IconTemperatureSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Temperature SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfTemperature: TheIconSelfPack = [
  'Temperature',
  IconTemperatureStrokeRounded,
  IconTemperatureDuotoneRounded,
  IconTemperatureTwotoneRounded,
  IconTemperatureSolidRounded,
  IconTemperatureBulkRounded,
  IconTemperatureStrokeSharp,
  IconTemperatureSolidSharp,
];