...
export const iconPackOfPlaza: TheIconSelfPack = [
  'Plaza',
  IconPlazaStrokeRounded,
  IconPlazaDuotoneRounded,
  IconPlazaTwotoneRounded,
  IconPlazaSolidRounded,
  IconPlazaBulkRounded,
  IconPlazaStrokeSharp,
  IconPlazaSolidSharp,
];