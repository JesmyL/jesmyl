...
export const IconHandPointingRight02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HandPointingRight02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHandPointingRight02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HandPointingRight02 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconHandPointingRight02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HandPointingRight02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconHandPointingRight02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HandPointingRight02 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconHandPointingRight02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HandPointingRight02 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconHandPointingRight02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HandPointingRight02 StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sw"
...
export const IconHandPointingRight02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HandPointingRight02 SolidSharp"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const iconPackOfHandPointingRight02: TheIconSelfPack = [
  'HandPointingRight02',
  IconHandPointingRight02StrokeRounded,
  IconHandPointingRight02DuotoneRounded,
  IconHandPointingRight02TwotoneRounded,
  IconHandPointingRight02SolidRounded,
  IconHandPointingRight02BulkRounded,
  IconHandPointingRight02StrokeSharp,
  IconHandPointingRight02SolidSharp,
];