...
export const iconPackOfUfo: TheIconSelfPack = [
  'Ufo',
  IconUfoStrokeRounded,
  IconUfoDuotoneRounded,
  IconUfoTwotoneRounded,
  IconUfoSolidRounded,
  IconUfoBulkRounded,
  IconUfoStrokeSharp,
  IconUfoSolidSharp,
