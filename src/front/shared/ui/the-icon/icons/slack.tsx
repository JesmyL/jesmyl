...
export const iconPackOfSlack: TheIconSelfPack = [
  'Slack',
  IconSlackStrokeRounded,
  IconSlackDuotoneRounded,
  IconSlackTwotoneRounded,
  IconSlackSolidRounded,
  IconSlackBulkRounded,
  IconSlackStrokeSharp,
  IconSlackSolidSharp,
];