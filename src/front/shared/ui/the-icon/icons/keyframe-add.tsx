...
export const IconKeyframeAddStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframeAdd StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconKeyframeAddDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframeAdd DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconKeyframeAddTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframeAdd TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconKeyframeAddSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframeAdd SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconKeyframeAddBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframeAdd BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconKeyframeAddStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframeAdd StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sw"
...
export const IconKeyframeAddSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframeAdd SolidSharp"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const iconPackOfKeyframeAdd: TheIconSelfPack = [
  'KeyframeAdd',
  IconKeyframeAddStrokeRounded,
  IconKeyframeAddDuotoneRounded,
  IconKeyframeAddTwotoneRounded,
  IconKeyframeAddSolidRounded,
  IconKeyframeAddBulkRounded,
  IconKeyframeAddStrokeSharp,
  IconKeyframeAddSolidSharp,
];