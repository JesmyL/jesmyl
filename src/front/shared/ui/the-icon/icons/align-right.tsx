...
export const IconAlignRightStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignRight StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAlignRightDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignRight DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconAlignRightTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignRight TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAlignRightSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignRight SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconAlignRightBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignRight BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconAlignRightStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignRight StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sr sw"
...
export const IconAlignRightSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignRight SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfAlignRight: TheIconSelfPack = [
  'AlignRight',
  IconAlignRightStrokeRounded,
  IconAlignRightDuotoneRounded,
  IconAlignRightTwotoneRounded,
  IconAlignRightSolidRounded,
  IconAlignRightBulkRounded,
  IconAlignRightStrokeSharp,
  IconAlignRightSolidSharp,
];