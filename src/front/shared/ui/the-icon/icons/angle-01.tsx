...
export const IconAngle01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Angle01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAngle01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Angle01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconAngle01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Angle01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfAngle01: TheIconSelfPack = [
  'Angle01',
  IconAngle01StrokeRounded,
  IconAngle01DuotoneRounded,
  IconAngle01TwotoneRounded,
  IconAngle01SolidRounded,
  IconAngle01BulkRounded,
  IconAngle01StrokeSharp,
  IconAngle01SolidSharp,
];