...
export const IconLayoutLeftStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayoutLeft StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLayoutLeftDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayoutLeft DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconLayoutLeftTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayoutLeft TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLayoutLeftSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayoutLeft SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconLayoutLeftBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayoutLeft BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconLayoutLeftStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayoutLeft StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const IconLayoutLeftSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LayoutLeft SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const iconPackOfLayoutLeft: TheIconSelfPack = [
  'LayoutLeft',
  IconLayoutLeftStrokeRounded,
  IconLayoutLeftDuotoneRounded,
  IconLayoutLeftTwotoneRounded,
  IconLayoutLeftSolidRounded,
  IconLayoutLeftBulkRounded,
  IconLayoutLeftStrokeSharp,
  IconLayoutLeftSolidSharp,
];