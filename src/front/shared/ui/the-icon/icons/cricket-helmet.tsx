...
export const IconCricketHelmetStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CricketHelmet StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCricketHelmetDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CricketHelmet DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconCricketHelmetTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CricketHelmet TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCricketHelmetSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CricketHelmet SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconCricketHelmetBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CricketHelmet BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconCricketHelmetStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CricketHelmet StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sw"
...
export const IconCricketHelmetSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CricketHelmet SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfCricketHelmet: TheIconSelfPack = [
  'CricketHelmet',
  IconCricketHelmetStrokeRounded,
  IconCricketHelmetDuotoneRounded,
  IconCricketHelmetTwotoneRounded,
  IconCricketHelmetSolidRounded,
  IconCricketHelmetBulkRounded,
  IconCricketHelmetStrokeSharp,
  IconCricketHelmetSolidSharp,
];