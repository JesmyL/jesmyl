...
export const IconInformationSquareStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InformationSquare StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconInformationSquareDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InformationSquare DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconInformationSquareTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InformationSquare TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconInformationSquareSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InformationSquare SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconInformationSquareBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InformationSquare BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconInformationSquareStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InformationSquare StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconInformationSquareSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InformationSquare SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfInformationSquare: TheIconSelfPack = [
  'InformationSquare',
  IconInformationSquareStrokeRounded,
  IconInformationSquareDuotoneRounded,
  IconInformationSquareTwotoneRounded,
  IconInformationSquareSolidRounded,
  IconInformationSquareBulkRounded,
  IconInformationSquareStrokeSharp,
  IconInformationSquareSolidSharp,
];