...
export const IconCircleArrowDataTransferVerticalStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CircleArrowDataTransferVertical StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconCircleArrowDataTransferVerticalDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CircleArrowDataTransferVertical DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconCircleArrowDataTransferVerticalTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CircleArrowDataTransferVertical TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconCircleArrowDataTransferVerticalSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CircleArrowDataTransferVertical SolidRounded"
    >
      <path 
        d={d.d2}
        i-c="c f fr"
...
export const IconCircleArrowDataTransferVerticalBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CircleArrowDataTransferVertical BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconCircleArrowDataTransferVerticalStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CircleArrowDataTransferVertical StrokeSharp"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconCircleArrowDataTransferVerticalSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CircleArrowDataTransferVertical SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfCircleArrowDataTransferVertical: TheIconSelfPack = [
  ...
  IconCircleArrowDataTransferVerticalStrokeRounded,
  IconCircleArrowDataTransferVerticalDuotoneRounded,
  IconCircleArrowDataTransferVerticalTwotoneRounded,
  IconCircleArrowDataTransferVerticalSolidRounded,
  IconCircleArrowDataTransferVerticalBulkRounded,
  IconCircleArrowDataTransferVerticalStrokeSharp,
  IconCircleArrowDataTransferVerticalSolidSharp,
];