...
export const iconPackOfFins: TheIconSelfPack = [
  'Fins',
  IconFinsStrokeRounded,
  IconFinsDuotoneRounded,
  IconFinsTwotoneRounded,
  IconFinsSolidRounded,
  IconFinsBulkRounded,
  IconFinsStrokeSharp,
  IconFinsSolidSharp,
];