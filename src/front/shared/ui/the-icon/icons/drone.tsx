...
export const iconPackOfDrone: TheIconSelfPack = [
  'Drone',
  IconDroneStrokeRounded,
  IconDroneDuotoneRounded,
  IconDroneTwotoneRounded,
  IconDroneSolidRounded,
  IconDroneBulkRounded,
  IconDroneStrokeSharp,
  IconDroneSolidSharp,
];