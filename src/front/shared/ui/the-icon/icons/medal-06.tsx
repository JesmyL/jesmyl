...
export const IconMedal06StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Medal06 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMedal06DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Medal06 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMedal06TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Medal06 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfMedal06: TheIconSelfPack = [
  'Medal06',
  IconMedal06StrokeRounded,
  IconMedal06DuotoneRounded,
  IconMedal06TwotoneRounded,
  IconMedal06SolidRounded,
  IconMedal06BulkRounded,
  IconMedal06StrokeSharp,
  IconMedal06SolidSharp,
];