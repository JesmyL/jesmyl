...
export const IconSwipeRight04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeRight04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSwipeRight04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeRight04 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconSwipeRight04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeRight04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSwipeRight04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeRight04 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconSwipeRight04BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeRight04 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconSwipeRight04StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeRight04 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const IconSwipeRight04SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeRight04 SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const iconPackOfSwipeRight04: TheIconSelfPack = [
  'SwipeRight04',
  IconSwipeRight04StrokeRounded,
  IconSwipeRight04DuotoneRounded,
  IconSwipeRight04TwotoneRounded,
  IconSwipeRight04SolidRounded,
  IconSwipeRight04BulkRounded,
  IconSwipeRight04StrokeSharp,
  IconSwipeRight04SolidSharp,
];