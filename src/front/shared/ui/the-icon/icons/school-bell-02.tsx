...
export const IconSchoolBell02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SchoolBell02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSchoolBell02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SchoolBell02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconSchoolBell02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SchoolBell02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSchoolBell02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SchoolBell02 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconSchoolBell02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SchoolBell02 BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconSchoolBell02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SchoolBell02 StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const IconSchoolBell02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SchoolBell02 SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="f"
...
export const iconPackOfSchoolBell02: TheIconSelfPack = [
  'SchoolBell02',
  IconSchoolBell02StrokeRounded,
  IconSchoolBell02DuotoneRounded,
  IconSchoolBell02TwotoneRounded,
  IconSchoolBell02SolidRounded,
  IconSchoolBell02BulkRounded,
  IconSchoolBell02StrokeSharp,
  IconSchoolBell02SolidSharp,
];