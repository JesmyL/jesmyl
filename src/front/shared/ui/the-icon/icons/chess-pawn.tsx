...
export const IconChessPawnStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChessPawn StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconChessPawnDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChessPawn DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconChessPawnTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChessPawn TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconChessPawnSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChessPawn SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconChessPawnBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChessPawn BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconChessPawnStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChessPawn StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfChessPawn: TheIconSelfPack = [
  'ChessPawn',
  IconChessPawnStrokeRounded,
  IconChessPawnDuotoneRounded,
  IconChessPawnTwotoneRounded,
  IconChessPawnSolidRounded,
  IconChessPawnBulkRounded,
  IconChessPawnStrokeSharp,
  IconChessPawnSolidSharp,
];