...
export const IconGymnasticStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Gymnastic StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGymnasticDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Gymnastic DuotoneRounded"
    >
      <circle 
        cx="8"
        cy="16"
...
export const IconGymnasticTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Gymnastic TwotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="s sj sr sw"
...
export const IconGymnasticSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Gymnastic SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconGymnasticBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Gymnastic BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconGymnasticStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Gymnastic StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sw"
...
export const iconPackOfGymnastic: TheIconSelfPack = [
  'Gymnastic',
  IconGymnasticStrokeRounded,
  IconGymnasticDuotoneRounded,
  IconGymnasticTwotoneRounded,
  IconGymnasticSolidRounded,
  IconGymnasticBulkRounded,
  IconGymnasticStrokeSharp,
  IconGymnasticSolidSharp,
];