...
export const IconArrowUp02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUp02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconArrowUp02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUp02 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="o7 s sj sr sw"
...
export const IconArrowUp02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUp02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconArrowUp02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUp02 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconArrowUp02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUp02 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconArrowUp02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowUp02 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const iconPackOfArrowUp02: TheIconSelfPack = [
  'ArrowUp02',
  IconArrowUp02StrokeRounded,
  IconArrowUp02DuotoneRounded,
  IconArrowUp02TwotoneRounded,
  IconArrowUp02SolidRounded,
  IconArrowUp02BulkRounded,
  IconArrowUp02StrokeSharp,
  IconArrowUp02SolidSharp,
];