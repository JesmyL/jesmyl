...
export const IconBicycleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bicycle StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBicycleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bicycle DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconBicycleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bicycle TwotoneRounded"
    >
      <path 
        d={d.d11}
        i-c="s sj sr sw"
...
export const iconPackOfBicycle: TheIconSelfPack = [
  'Bicycle',
  IconBicycleStrokeRounded,
  IconBicycleDuotoneRounded,
  IconBicycleTwotoneRounded,
  IconBicycleSolidRounded,
  IconBicycleBulkRounded,
  IconBicycleStrokeSharp,
  IconBicycleSolidSharp,
];