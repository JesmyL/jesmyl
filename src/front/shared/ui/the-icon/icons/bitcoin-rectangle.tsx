...
export const IconBitcoinRectangleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinRectangle StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconBitcoinRectangleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinRectangle DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconBitcoinRectangleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinRectangle TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconBitcoinRectangleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinRectangle SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconBitcoinRectangleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinRectangle BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconBitcoinRectangleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinRectangle StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sr sw"
...
export const IconBitcoinRectangleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinRectangle SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfBitcoinRectangle: TheIconSelfPack = [
  'BitcoinRectangle',
  IconBitcoinRectangleStrokeRounded,
  IconBitcoinRectangleDuotoneRounded,
  IconBitcoinRectangleTwotoneRounded,
  IconBitcoinRectangleSolidRounded,
  IconBitcoinRectangleBulkRounded,
  IconBitcoinRectangleStrokeSharp,
  IconBitcoinRectangleSolidSharp,
];