...
export const IconMentoringStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mentoring StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMentoringDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mentoring DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconMentoringTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mentoring TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMentoringSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mentoring SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconMentoringBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mentoring BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconMentoringStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mentoring StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sj sw"
...
export const iconPackOfMentoring: TheIconSelfPack = [
  'Mentoring',
  IconMentoringStrokeRounded,
  IconMentoringDuotoneRounded,
  IconMentoringTwotoneRounded,
  IconMentoringSolidRounded,
  IconMentoringBulkRounded,
  IconMentoringStrokeSharp,
  IconMentoringSolidSharp,
];