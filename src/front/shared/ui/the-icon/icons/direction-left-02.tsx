...
export const IconDirectionLeft02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DirectionLeft02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDirectionLeft02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DirectionLeft02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconDirectionLeft02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DirectionLeft02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDirectionLeft02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DirectionLeft02 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconDirectionLeft02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DirectionLeft02 BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconDirectionLeft02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DirectionLeft02 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconDirectionLeft02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DirectionLeft02 SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="f"
...
export const iconPackOfDirectionLeft02: TheIconSelfPack = [
  'DirectionLeft02',
  IconDirectionLeft02StrokeRounded,
  IconDirectionLeft02DuotoneRounded,
  IconDirectionLeft02TwotoneRounded,
  IconDirectionLeft02SolidRounded,
  IconDirectionLeft02BulkRounded,
  IconDirectionLeft02StrokeSharp,
  IconDirectionLeft02SolidSharp,
];