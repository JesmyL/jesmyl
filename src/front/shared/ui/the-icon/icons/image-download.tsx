...
export const IconImageDownloadStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDownload StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconImageDownloadDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDownload DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconImageDownloadTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDownload TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconImageDownloadSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDownload SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconImageDownloadBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDownload BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconImageDownloadStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDownload StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconImageDownloadSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDownload SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const iconPackOfImageDownload: TheIconSelfPack = [
  'ImageDownload',
  IconImageDownloadStrokeRounded,
  IconImageDownloadDuotoneRounded,
  IconImageDownloadTwotoneRounded,
  IconImageDownloadSolidRounded,
  IconImageDownloadBulkRounded,
  IconImageDownloadStrokeSharp,
  IconImageDownloadSolidSharp,
];