...
export const IconDirhamDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Dirham DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconDirhamTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Dirham TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfDirham: TheIconSelfPack = [
  'Dirham',
  IconDirhamStrokeRounded,
  IconDirhamDuotoneRounded,
  IconDirhamTwotoneRounded,
  IconDirhamSolidRounded,
  IconDirhamBulkRounded,
  IconDirhamStrokeSharp,
  IconDirhamSolidSharp,
];