...
export const IconSmartWatch04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmartWatch04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSmartWatch04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmartWatch04 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconSmartWatch04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmartWatch04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSmartWatch04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmartWatch04 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconSmartWatch04BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmartWatch04 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconSmartWatch04StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmartWatch04 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconSmartWatch04SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmartWatch04 SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfSmartWatch04: TheIconSelfPack = [
  'SmartWatch04',
  IconSmartWatch04StrokeRounded,
  IconSmartWatch04DuotoneRounded,
  IconSmartWatch04TwotoneRounded,
  IconSmartWatch04SolidRounded,
  IconSmartWatch04BulkRounded,
  IconSmartWatch04StrokeSharp,
  IconSmartWatch04SolidSharp,
];