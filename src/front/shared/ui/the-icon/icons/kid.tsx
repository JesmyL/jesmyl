...
export const iconPackOfKid: TheIconSelfPack = [
  'Kid',
  IconKidStrokeRounded,
  IconKidDuotoneRounded,
  IconKidTwotoneRounded,
  IconKidSolidRounded,
  IconKidBulkRounded,
  IconKidStrokeSharp,
  IconKidSolidSharp,
