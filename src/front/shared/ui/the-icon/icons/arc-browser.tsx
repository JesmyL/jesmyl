...
export const IconArcBrowserStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArcBrowser StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconArcBrowserDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArcBrowser DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconArcBrowserTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArcBrowser TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconArcBrowserSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArcBrowser SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconArcBrowserBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArcBrowser BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconArcBrowserStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArcBrowser StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconArcBrowserSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArcBrowser SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const iconPackOfArcBrowser: TheIconSelfPack = [
  'ArcBrowser',
  IconArcBrowserStrokeRounded,
  IconArcBrowserDuotoneRounded,
  IconArcBrowserTwotoneRounded,
  IconArcBrowserSolidRounded,
  IconArcBrowserBulkRounded,
  IconArcBrowserStrokeSharp,
  IconArcBrowserSolidSharp,
];