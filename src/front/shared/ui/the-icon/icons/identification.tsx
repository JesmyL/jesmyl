...
export const IconIdentificationStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Identification StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconIdentificationDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Identification DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconIdentificationTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Identification TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconIdentificationSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Identification SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconIdentificationBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Identification BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconIdentificationStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Identification StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sw"
...
export const IconIdentificationSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Identification SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfIdentification: TheIconSelfPack = [
  'Identification',
  IconIdentificationStrokeRounded,
  IconIdentificationDuotoneRounded,
  IconIdentificationTwotoneRounded,
  IconIdentificationSolidRounded,
  IconIdentificationBulkRounded,
  IconIdentificationStrokeSharp,
  IconIdentificationSolidSharp,
];