...
export const IconWorkflowSquare05StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare05 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWorkflowSquare05DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare05 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconWorkflowSquare05TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare05 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWorkflowSquare05SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare05 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconWorkflowSquare05BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare05 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconWorkflowSquare05StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare05 StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const IconWorkflowSquare05SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare05 SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="f"
...
export const iconPackOfWorkflowSquare05: TheIconSelfPack = [
  'WorkflowSquare05',
  IconWorkflowSquare05StrokeRounded,
  IconWorkflowSquare05DuotoneRounded,
  IconWorkflowSquare05TwotoneRounded,
  IconWorkflowSquare05SolidRounded,
  IconWorkflowSquare05BulkRounded,
  IconWorkflowSquare05StrokeSharp,
  IconWorkflowSquare05SolidSharp,
];