...
export const IconMouseRightClick06StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MouseRightClick06 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMouseRightClick06DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MouseRightClick06 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconMouseRightClick06TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MouseRightClick06 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconMouseRightClick06SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MouseRightClick06 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconMouseRightClick06BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MouseRightClick06 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr o7"
...
export const IconMouseRightClick06StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MouseRightClick06 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconMouseRightClick06SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MouseRightClick06 SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfMouseRightClick06: TheIconSelfPack = [
  'MouseRightClick06',
  IconMouseRightClick06StrokeRounded,
  IconMouseRightClick06DuotoneRounded,
  IconMouseRightClick06TwotoneRounded,
  IconMouseRightClick06SolidRounded,
  IconMouseRightClick06BulkRounded,
  IconMouseRightClick06StrokeSharp,
  IconMouseRightClick06SolidSharp,
];