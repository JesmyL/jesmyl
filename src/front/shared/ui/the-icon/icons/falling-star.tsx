...
export const IconFallingStarStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FallingStar StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFallingStarDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FallingStar DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconFallingStarTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FallingStar TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconFallingStarSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FallingStar SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconFallingStarBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FallingStar BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconFallingStarStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FallingStar StrokeSharp"
    >
      <path 
        d={d.d2}
        i-c="s sw"
...
export const IconFallingStarSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FallingStar SolidSharp"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const iconPackOfFallingStar: TheIconSelfPack = [
  'FallingStar',
  IconFallingStarStrokeRounded,
  IconFallingStarDuotoneRounded,
  IconFallingStarTwotoneRounded,
  IconFallingStarSolidRounded,
  IconFallingStarBulkRounded,
  IconFallingStarStrokeSharp,
  IconFallingStarSolidSharp,
];