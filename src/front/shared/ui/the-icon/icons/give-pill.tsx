...
export const IconGivePillStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GivePill StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGivePillDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GivePill DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconGivePillTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GivePill TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconGivePillSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GivePill SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const iconPackOfGivePill: TheIconSelfPack = [
  'GivePill',
  IconGivePillStrokeRounded,
  IconGivePillDuotoneRounded,
  IconGivePillTwotoneRounded,
  IconGivePillSolidRounded,
  IconGivePillBulkRounded,
  IconGivePillStrokeSharp,
  IconGivePillSolidSharp,
];