...
export const IconBerlinDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Berlin DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconBerlinTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Berlin TwotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="s sj sr sw"
...
export const iconPackOfBerlin: TheIconSelfPack = [
  'Berlin',
  IconBerlinStrokeRounded,
  IconBerlinDuotoneRounded,
  IconBerlinTwotoneRounded,
  IconBerlinSolidRounded,
  IconBerlinBulkRounded,
  IconBerlinStrokeSharp,
  IconBerlinSolidSharp,
];