...
export const IconYenCircleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="YenCircle StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconYenCircleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="YenCircle DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconYenCircleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="YenCircle TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconYenCircleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="YenCircle SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconYenCircleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="YenCircle BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconYenCircleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="YenCircle StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfYenCircle: TheIconSelfPack = [
  'YenCircle',
  IconYenCircleStrokeRounded,
  IconYenCircleDuotoneRounded,
  IconYenCircleTwotoneRounded,
  IconYenCircleSolidRounded,
  IconYenCircleBulkRounded,
  IconYenCircleStrokeSharp,
  IconYenCircleSolidSharp,
];