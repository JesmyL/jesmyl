...
export const IconLatitudeStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Latitude StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLatitudeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Latitude DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconLatitudeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Latitude TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLatitudeSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Latitude SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfLatitude: TheIconSelfPack = [
  'Latitude',
  IconLatitudeStrokeRounded,
  IconLatitudeDuotoneRounded,
  IconLatitudeTwotoneRounded,
  IconLatitudeSolidRounded,
  IconLatitudeBulkRounded,
  IconLatitudeStrokeSharp,
  IconLatitudeSolidSharp,
];