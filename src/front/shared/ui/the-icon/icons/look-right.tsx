...
export const IconLookRightStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LookRight StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconLookRightDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LookRight DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconLookRightTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LookRight TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconLookRightSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LookRight SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconLookRightBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LookRight BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconLookRightStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LookRight StrokeSharp"
    >
      <circle 
        cx="12"
        cy="12"
...
export const iconPackOfLookRight: TheIconSelfPack = [
  'LookRight',
  IconLookRightStrokeRounded,
  IconLookRightDuotoneRounded,
  IconLookRightTwotoneRounded,
  IconLookRightSolidRounded,
  IconLookRightBulkRounded,
  IconLookRightStrokeSharp,
  IconLookRightSolidSharp,
];