...
export const IconMagicWand03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MagicWand03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMagicWand03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MagicWand03 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconMagicWand03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MagicWand03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMagicWand03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MagicWand03 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconMagicWand03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MagicWand03 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconMagicWand03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MagicWand03 StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconMagicWand03SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MagicWand03 SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfMagicWand03: TheIconSelfPack = [
  'MagicWand03',
  IconMagicWand03StrokeRounded,
  IconMagicWand03DuotoneRounded,
  IconMagicWand03TwotoneRounded,
  IconMagicWand03SolidRounded,
  IconMagicWand03BulkRounded,
  IconMagicWand03StrokeSharp,
  IconMagicWand03SolidSharp,
];