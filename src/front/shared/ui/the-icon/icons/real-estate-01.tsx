...
export const IconRealEstate01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RealEstate01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconRealEstate01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RealEstate01 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconRealEstate01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RealEstate01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconRealEstate01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RealEstate01 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconRealEstate01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RealEstate01 BulkRounded"
    >
      <path 
        d={d.d13}
        i-c="f o7"
...
export const IconRealEstate01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RealEstate01 StrokeSharp"
    >
      <path 
        d={d.d18}
        i-c="s sj sw"
...
export const IconRealEstate01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RealEstate01 SolidSharp"
    >
      <path 
        d={d.d25}
        i-c="c f fr"
...
export const iconPackOfRealEstate01: TheIconSelfPack = [
  'RealEstate01',
  IconRealEstate01StrokeRounded,
  IconRealEstate01DuotoneRounded,
  IconRealEstate01TwotoneRounded,
  IconRealEstate01SolidRounded,
  IconRealEstate01BulkRounded,
  IconRealEstate01StrokeSharp,
  IconRealEstate01SolidSharp,
];