...
export const IconIceCream01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IceCream01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconIceCream01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IceCream01 DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconIceCream01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IceCream01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconIceCream01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IceCream01 SolidRounded"
    >
      <path 
        d={d.d16}
        i-c="f"
...
export const IconIceCream01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IceCream01 BulkRounded"
    >
      <path 
        d={d.d16}
        i-c="f"
...
export const IconIceCream01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IceCream01 StrokeSharp"
    >
      <path 
        d={d.d20}
        i-c="s sw"
...
export const IconIceCream01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IceCream01 SolidSharp"
    >
      <path 
        d={d.d25}
        i-c="f"
...
export const iconPackOfIceCream01: TheIconSelfPack = [
  'IceCream01',
  IconIceCream01StrokeRounded,
  IconIceCream01DuotoneRounded,
  IconIceCream01TwotoneRounded,
  IconIceCream01SolidRounded,
  IconIceCream01BulkRounded,
  IconIceCream01StrokeSharp,
  IconIceCream01SolidSharp,
];