...
export const iconPackOfEuro: TheIconSelfPack = [
  'Euro',
  IconEuroStrokeRounded,
  IconEuroDuotoneRounded,
  IconEuroTwotoneRounded,
  IconEuroSolidRounded,
  IconEuroBulkRounded,
  IconEuroStrokeSharp,
  IconEuroSolidSharp,
];