...
export const IconMoney01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Money01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMoney01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Money01 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconMoney01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Money01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfMoney01: TheIconSelfPack = [
  'Money01',
  IconMoney01StrokeRounded,
  IconMoney01DuotoneRounded,
  IconMoney01TwotoneRounded,
  IconMoney01SolidRounded,
  IconMoney01BulkRounded,
  IconMoney01StrokeSharp,
  IconMoney01SolidSharp,
];