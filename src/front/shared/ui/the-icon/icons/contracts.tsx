...
export const IconContractsStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Contracts StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconContractsDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Contracts DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconContractsTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Contracts TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconContractsSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Contracts SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconContractsBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Contracts BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconContractsStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Contracts StrokeSharp"
    >
      <path 
        d={d.d14}
        i-c="s ss sw"
...
export const iconPackOfContracts: TheIconSelfPack = [
  'Contracts',
  IconContractsStrokeRounded,
  IconContractsDuotoneRounded,
  IconContractsTwotoneRounded,
  IconContractsSolidRounded,
  IconContractsBulkRounded,
  IconContractsStrokeSharp,
  IconContractsSolidSharp,
];