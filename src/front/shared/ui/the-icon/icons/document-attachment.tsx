...
export const IconDocumentAttachmentStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DocumentAttachment StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDocumentAttachmentDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DocumentAttachment DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconDocumentAttachmentTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DocumentAttachment TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDocumentAttachmentSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DocumentAttachment SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconDocumentAttachmentBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DocumentAttachment BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconDocumentAttachmentStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DocumentAttachment StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sw"
...
export const IconDocumentAttachmentSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DocumentAttachment SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfDocumentAttachment: TheIconSelfPack = [
  'DocumentAttachment',
  IconDocumentAttachmentStrokeRounded,
  IconDocumentAttachmentDuotoneRounded,
  IconDocumentAttachmentTwotoneRounded,
  IconDocumentAttachmentSolidRounded,
  IconDocumentAttachmentBulkRounded,
  IconDocumentAttachmentStrokeSharp,
  IconDocumentAttachmentSolidSharp,
];