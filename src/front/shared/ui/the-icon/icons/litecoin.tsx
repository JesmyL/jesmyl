...
export const IconLitecoinStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Litecoin StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLitecoinDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Litecoin DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconLitecoinTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Litecoin TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLitecoinSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Litecoin SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const iconPackOfLitecoin: TheIconSelfPack = [
  'Litecoin',
  IconLitecoinStrokeRounded,
  IconLitecoinDuotoneRounded,
  IconLitecoinTwotoneRounded,
  IconLitecoinSolidRounded,
  IconLitecoinBulkRounded,
  IconLitecoinStrokeSharp,
  IconLitecoinSolidSharp,
];