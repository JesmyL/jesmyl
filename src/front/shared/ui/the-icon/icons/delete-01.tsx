...
export const IconDelete01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Delete01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDelete01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Delete01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconDelete01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Delete01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconDelete01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Delete01 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const iconPackOfDelete01: TheIconSelfPack = [
  ...
  IconDelete01DuotoneRounded,
  IconDelete01TwotoneRounded,
  IconDelete01SolidRounded,
  IconDelete01BulkRounded,
  IconDelete01StrokeSharp,
  IconDelete01SolidSharp,
];