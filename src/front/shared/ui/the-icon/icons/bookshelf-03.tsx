...
export const IconBookshelf03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookshelf03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBookshelf03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookshelf03 DuotoneRounded"
    >
      <path 
        d={d.d12}
        i-c="f o7"
...
export const IconBookshelf03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookshelf03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBookshelf03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookshelf03 SolidRounded"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const IconBookshelf03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookshelf03 BulkRounded"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const IconBookshelf03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookshelf03 StrokeSharp"
    >
      <path 
        d={d.d25}
        i-c="s sj sr sw"
...
export const IconBookshelf03SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookshelf03 SolidSharp"
    >
      <path 
        d={d.d31}
        i-c="c f fr"
...
export const iconPackOfBookshelf03: TheIconSelfPack = [
  'Bookshelf03',
  IconBookshelf03StrokeRounded,
  IconBookshelf03DuotoneRounded,
  IconBookshelf03TwotoneRounded,
  IconBookshelf03SolidRounded,
  IconBookshelf03BulkRounded,
  IconBookshelf03StrokeSharp,
  IconBookshelf03SolidSharp,
];