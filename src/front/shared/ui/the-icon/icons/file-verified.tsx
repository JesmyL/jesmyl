...
export const IconFileVerifiedStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileVerified StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFileVerifiedDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileVerified DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconFileVerifiedTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileVerified TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconFileVerifiedSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileVerified SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconFileVerifiedBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileVerified BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconFileVerifiedStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileVerified StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const IconFileVerifiedSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileVerified SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfFileVerified: TheIconSelfPack = [
  'FileVerified',
  IconFileVerifiedStrokeRounded,
  IconFileVerifiedDuotoneRounded,
  IconFileVerifiedTwotoneRounded,
  IconFileVerifiedSolidRounded,
  IconFileVerifiedBulkRounded,
  IconFileVerifiedStrokeSharp,
  IconFileVerifiedSolidSharp,
];