...
export const iconPackOfFlow: TheIconSelfPack = [
  'Flow',
  IconFlowStrokeRounded,
  IconFlowDuotoneRounded,
  IconFlowTwotoneRounded,
  IconFlowSolidRounded,
  IconFlowBulkRounded,
  IconFlowStrokeSharp,
  IconFlowSolidSharp,
];