...
export const IconComputerProgramming01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerProgramming01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconComputerProgramming01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerProgramming01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconComputerProgramming01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerProgramming01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconComputerProgramming01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerProgramming01 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconComputerProgramming01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerProgramming01 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr o7"
...
export const IconComputerProgramming01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerProgramming01 StrokeSharp"
    >
      <path 
        d={d.d14}
        i-c="s sj sw"
...
export const IconComputerProgramming01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerProgramming01 SolidSharp"
    >
      <path 
        d={d.d18}
        i-c="c f fr"
...
export const iconPackOfComputerProgramming01: TheIconSelfPack = [
  ...
  IconComputerProgramming01StrokeRounded,
  IconComputerProgramming01DuotoneRounded,
  IconComputerProgramming01TwotoneRounded,
  IconComputerProgramming01SolidRounded,
  IconComputerProgramming01BulkRounded,
  IconComputerProgramming01StrokeSharp,
  IconComputerProgramming01SolidSharp,
];