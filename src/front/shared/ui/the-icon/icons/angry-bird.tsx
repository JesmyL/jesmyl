...
export const IconAngryBirdStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AngryBird StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconAngryBirdDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AngryBird DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconAngryBirdTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AngryBird TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconAngryBirdSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AngryBird SolidRounded"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const IconAngryBirdBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AngryBird BulkRounded"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const IconAngryBirdStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AngryBird StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfAngryBird: TheIconSelfPack = [
  'AngryBird',
  IconAngryBirdStrokeRounded,
  IconAngryBirdDuotoneRounded,
  IconAngryBirdTwotoneRounded,
  IconAngryBirdSolidRounded,
  IconAngryBirdBulkRounded,
  IconAngryBirdStrokeSharp,
  IconAngryBirdSolidSharp,
];