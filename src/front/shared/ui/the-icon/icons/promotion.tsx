...
export const IconPromotionStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Promotion StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPromotionDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Promotion DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconPromotionTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Promotion TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPromotionSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Promotion SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconPromotionBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Promotion BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconPromotionStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Promotion StrokeSharp"
    >
      <path 
        d={d.d3}
        i-c="s sj sr sw"
...
export const iconPackOfPromotion: TheIconSelfPack = [
  'Promotion',
  IconPromotionStrokeRounded,
  IconPromotionDuotoneRounded,
  IconPromotionTwotoneRounded,
  IconPromotionSolidRounded,
  IconPromotionBulkRounded,
  IconPromotionStrokeSharp,
  IconPromotionSolidSharp,
];