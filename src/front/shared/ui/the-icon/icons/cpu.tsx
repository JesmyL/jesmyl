...
export const iconPackOfCpu: TheIconSelfPack = [
  'Cpu',
  IconCpuStrokeRounded,
  IconCpuDuotoneRounded,
  IconCpuTwotoneRounded,
  IconCpuSolidRounded,
  IconCpuBulkRounded,
  IconCpuStrokeSharp,
  IconCpuSolidSharp,
