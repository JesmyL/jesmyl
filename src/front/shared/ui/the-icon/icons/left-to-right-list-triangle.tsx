...
export const IconLeftToRightListTriangleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftToRightListTriangle StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconLeftToRightListTriangleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftToRightListTriangle DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o1"
...
export const IconLeftToRightListTriangleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftToRightListTriangle TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconLeftToRightListTriangleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftToRightListTriangle SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconLeftToRightListTriangleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftToRightListTriangle BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconLeftToRightListTriangleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftToRightListTriangle StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sw"
...
export const IconLeftToRightListTriangleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftToRightListTriangle SolidSharp"
    >
      <path 
        d={d.d16}
        i-c="c f fr"
...
export const iconPackOfLeftToRightListTriangle: TheIconSelfPack = [
  ...
  IconLeftToRightListTriangleStrokeRounded,
  IconLeftToRightListTriangleDuotoneRounded,
  IconLeftToRightListTriangleTwotoneRounded,
  IconLeftToRightListTriangleSolidRounded,
  IconLeftToRightListTriangleBulkRounded,
  IconLeftToRightListTriangleStrokeSharp,
  IconLeftToRightListTriangleSolidSharp,
];