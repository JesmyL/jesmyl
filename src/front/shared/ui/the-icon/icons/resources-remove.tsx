...
export const IconResourcesRemoveStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ResourcesRemove StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconResourcesRemoveDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ResourcesRemove DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconResourcesRemoveTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ResourcesRemove TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconResourcesRemoveSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ResourcesRemove SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconResourcesRemoveBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ResourcesRemove BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconResourcesRemoveStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ResourcesRemove StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const IconResourcesRemoveSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ResourcesRemove SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const iconPackOfResourcesRemove: TheIconSelfPack = [
  'ResourcesRemove',
  IconResourcesRemoveStrokeRounded,
  IconResourcesRemoveDuotoneRounded,
  IconResourcesRemoveTwotoneRounded,
  IconResourcesRemoveSolidRounded,
  IconResourcesRemoveBulkRounded,
  IconResourcesRemoveStrokeSharp,
  IconResourcesRemoveSolidSharp,
];