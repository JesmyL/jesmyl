...
export const IconLiftTruckStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LiftTruck StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLiftTruckDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LiftTruck DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconLiftTruckTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LiftTruck TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLiftTruckSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LiftTruck SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const IconLiftTruckBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LiftTruck BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const IconLiftTruckStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LiftTruck StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfLiftTruck: TheIconSelfPack = [
  'LiftTruck',
  IconLiftTruckStrokeRounded,
  IconLiftTruckDuotoneRounded,
  IconLiftTruckTwotoneRounded,
  IconLiftTruckSolidRounded,
  IconLiftTruckBulkRounded,
  IconLiftTruckStrokeSharp,
  IconLiftTruckSolidSharp,
];