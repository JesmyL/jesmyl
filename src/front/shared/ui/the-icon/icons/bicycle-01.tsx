...
export const IconBicycle01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bicycle01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBicycle01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bicycle01 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconBicycle01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bicycle01 TwotoneRounded"
    >
      <path 
        d={d.d11}
        i-c="s sj sr sw"
...
export const IconBicycle01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bicycle01 SolidRounded"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const IconBicycle01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bicycle01 BulkRounded"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const IconBicycle01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bicycle01 StrokeSharp"
    >
      <path 
        d={d.d22}
        i-c="s sj sw"
...
export const iconPackOfBicycle01: TheIconSelfPack = [
  'Bicycle01',
  IconBicycle01StrokeRounded,
  IconBicycle01DuotoneRounded,
  IconBicycle01TwotoneRounded,
  IconBicycle01SolidRounded,
  IconBicycle01BulkRounded,
  IconBicycle01StrokeSharp,
  IconBicycle01SolidSharp,
];