...
export const iconPackOfBomb: TheIconSelfPack = [
  'Bomb',
  IconBombStrokeRounded,
  IconBombDuotoneRounded,
  IconBombTwotoneRounded,
  IconBombSolidRounded,
  IconBombBulkRounded,
  IconBombStrokeSharp,
  IconBombSolidSharp,
];