...
export const IconAirpod03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Airpod03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconAirpod03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Airpod03 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconAirpod03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Airpod03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconAirpod03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Airpod03 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const iconPackOfAirpod03: TheIconSelfPack = [
  'Airpod03',
  IconAirpod03StrokeRounded,
  IconAirpod03DuotoneRounded,
  IconAirpod03TwotoneRounded,
  IconAirpod03SolidRounded,
  IconAirpod03BulkRounded,
  IconAirpod03StrokeSharp,
  IconAirpod03SolidSharp,
];