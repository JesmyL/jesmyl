...
export const IconCopilotStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Copilot StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCopilotDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Copilot DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconCopilotTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Copilot TwotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="s sj sr sw"
...
export const iconPackOfCopilot: TheIconSelfPack = [
  'Copilot',
  IconCopilotStrokeRounded,
  IconCopilotDuotoneRounded,
  IconCopilotTwotoneRounded,
  IconCopilotSolidRounded,
  IconCopilotBulkRounded,
  IconCopilotStrokeSharp,
  IconCopilotSolidSharp,
];