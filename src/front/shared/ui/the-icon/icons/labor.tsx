...
export const iconPackOfLabor: TheIconSelfPack = [
  'Labor',
  IconLaborStrokeRounded,
  IconLaborDuotoneRounded,
  IconLaborTwotoneRounded,
  IconLaborSolidRounded,
  IconLaborBulkRounded,
  IconLaborStrokeSharp,
  IconLaborSolidSharp,
];