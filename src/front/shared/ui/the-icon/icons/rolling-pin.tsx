...
export const IconRollingPinStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RollingPin StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconRollingPinDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RollingPin DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconRollingPinTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RollingPin TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconRollingPinSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RollingPin SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconRollingPinBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RollingPin BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconRollingPinStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RollingPin StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const IconRollingPinSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RollingPin SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfRollingPin: TheIconSelfPack = [
  'RollingPin',
  IconRollingPinStrokeRounded,
  IconRollingPinDuotoneRounded,
  IconRollingPinTwotoneRounded,
  IconRollingPinSolidRounded,
  IconRollingPinBulkRounded,
  IconRollingPinStrokeSharp,
  IconRollingPinSolidSharp,
];