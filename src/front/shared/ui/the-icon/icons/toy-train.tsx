...
export const IconToyTrainStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ToyTrain StrokeRounded"
    >
      <circle 
        cx="7"
        cy="18"
...
export const IconToyTrainDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ToyTrain DuotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconToyTrainTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ToyTrain TwotoneRounded"
    >
      <circle 
        cx="7"
        cy="18"
...
export const IconToyTrainSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ToyTrain SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfToyTrain: TheIconSelfPack = [
  'ToyTrain',
  IconToyTrainStrokeRounded,
  IconToyTrainDuotoneRounded,
  IconToyTrainTwotoneRounded,
  IconToyTrainSolidRounded,
  IconToyTrainBulkRounded,
  IconToyTrainStrokeSharp,
  IconToyTrainSolidSharp,
];