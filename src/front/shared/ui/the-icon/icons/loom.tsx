...
export const iconPackOfLoom: TheIconSelfPack = [
  'Loom',
  IconLoomStrokeRounded,
  IconLoomDuotoneRounded,
  IconLoomTwotoneRounded,
  IconLoomSolidRounded,
  IconLoomBulkRounded,
  IconLoomStrokeSharp,
  IconLoomSolidSharp,
];