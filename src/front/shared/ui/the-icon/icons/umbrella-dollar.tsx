...
export const IconUmbrellaDollarStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UmbrellaDollar StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUmbrellaDollarDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UmbrellaDollar DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconUmbrellaDollarTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UmbrellaDollar TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconUmbrellaDollarSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UmbrellaDollar SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconUmbrellaDollarBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UmbrellaDollar BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconUmbrellaDollarStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UmbrellaDollar StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sw"
...
export const IconUmbrellaDollarSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UmbrellaDollar SolidSharp"
    >
      <path 
        d={d.d16}
        i-c="c f fr"
...
export const iconPackOfUmbrellaDollar: TheIconSelfPack = [
  'UmbrellaDollar',
  IconUmbrellaDollarStrokeRounded,
  IconUmbrellaDollarDuotoneRounded,
  IconUmbrellaDollarTwotoneRounded,
  IconUmbrellaDollarSolidRounded,
  IconUmbrellaDollarBulkRounded,
  IconUmbrellaDollarStrokeSharp,
  IconUmbrellaDollarSolidSharp,
];