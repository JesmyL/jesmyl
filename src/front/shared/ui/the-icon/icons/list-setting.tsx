...
export const IconListSettingStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ListSetting StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconListSettingDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ListSetting DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7 s sr sw"
...
export const IconListSettingTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ListSetting TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconListSettingSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ListSetting SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconListSettingBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ListSetting BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconListSettingStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ListSetting StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s ss sw"
...
export const IconListSettingSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ListSetting SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfListSetting: TheIconSelfPack = [
  'ListSetting',
  IconListSettingStrokeRounded,
  IconListSettingDuotoneRounded,
  IconListSettingTwotoneRounded,
  IconListSettingSolidRounded,
  IconListSettingBulkRounded,
  IconListSettingStrokeSharp,
  IconListSettingSolidSharp,
];