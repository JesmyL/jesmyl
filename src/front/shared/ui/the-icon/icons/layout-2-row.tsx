...
export const IconLayout2RowStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout2Row StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLayout2RowDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout2Row DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconLayout2RowTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout2Row TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLayout2RowSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout2Row SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconLayout2RowBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout2Row BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconLayout2RowStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout2Row StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const IconLayout2RowSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout2Row SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const iconPackOfLayout2Row: TheIconSelfPack = [
  'Layout2Row',
  IconLayout2RowStrokeRounded,
  IconLayout2RowDuotoneRounded,
  IconLayout2RowTwotoneRounded,
  IconLayout2RowSolidRounded,
  IconLayout2RowBulkRounded,
  IconLayout2RowStrokeSharp,
  IconLayout2RowSolidSharp,
];