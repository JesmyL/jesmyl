...
export const IconLogin03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Login03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconLogin03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Login03 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconLogin03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Login03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfLogin03: TheIconSelfPack = [
  'Login03',
  IconLogin03StrokeRounded,
  IconLogin03DuotoneRounded,
  IconLogin03TwotoneRounded,
  IconLogin03SolidRounded,
  IconLogin03BulkRounded,
  IconLogin03StrokeSharp,
  IconLogin03SolidSharp,
];