...
export const IconCollectionsBookmarkStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CollectionsBookmark StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCollectionsBookmarkDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CollectionsBookmark DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconCollectionsBookmarkTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CollectionsBookmark TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCollectionsBookmarkSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CollectionsBookmark SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconCollectionsBookmarkBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CollectionsBookmark BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconCollectionsBookmarkStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CollectionsBookmark StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sr sw"
...
export const IconCollectionsBookmarkSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CollectionsBookmark SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfCollectionsBookmark: TheIconSelfPack = [
  'CollectionsBookmark',
  IconCollectionsBookmarkStrokeRounded,
  IconCollectionsBookmarkDuotoneRounded,
  IconCollectionsBookmarkTwotoneRounded,
  IconCollectionsBookmarkSolidRounded,
  IconCollectionsBookmarkBulkRounded,
  IconCollectionsBookmarkStrokeSharp,
  IconCollectionsBookmarkSolidSharp,
];