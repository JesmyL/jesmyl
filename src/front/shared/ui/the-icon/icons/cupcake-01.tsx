...
export const IconCupcake01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cupcake01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconCupcake01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cupcake01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconCupcake01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cupcake01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sw"
...
export const IconCupcake01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cupcake01 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconCupcake01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cupcake01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconCupcake01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cupcake01 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const iconPackOfCupcake01: TheIconSelfPack = [
  'Cupcake01',
  IconCupcake01StrokeRounded,
  IconCupcake01DuotoneRounded,
  IconCupcake01TwotoneRounded,
  IconCupcake01SolidRounded,
  IconCupcake01BulkRounded,
  IconCupcake01StrokeSharp,
  IconCupcake01SolidSharp,
];