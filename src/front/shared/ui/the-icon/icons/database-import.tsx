...
export const IconDatabaseImportStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DatabaseImport StrokeRounded"
    >
      <ellipse 
        cx="12"
        cy="5"
...
export const IconDatabaseImportDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DatabaseImport DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconDatabaseImportTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DatabaseImport TwotoneRounded"
    >
      <ellipse 
        cx="12"
        cy="5"
...
export const IconDatabaseImportSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DatabaseImport SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconDatabaseImportBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DatabaseImport BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d7}
...
export const IconDatabaseImportStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DatabaseImport StrokeSharp"
    >
      <ellipse 
        cx="12"
        cy="5"
...
export const IconDatabaseImportSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DatabaseImport SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfDatabaseImport: TheIconSelfPack = [
  'DatabaseImport',
  IconDatabaseImportStrokeRounded,
  IconDatabaseImportDuotoneRounded,
  IconDatabaseImportTwotoneRounded,
  IconDatabaseImportSolidRounded,
  IconDatabaseImportBulkRounded,
  IconDatabaseImportStrokeSharp,
  IconDatabaseImportSolidSharp,
];