...
export const IconPackageStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Package StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPackageDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Package DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconPackageTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Package TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfPackage: TheIconSelfPack = [
  'Package',
  IconPackageStrokeRounded,
  IconPackageDuotoneRounded,
  IconPackageTwotoneRounded,
  IconPackageSolidRounded,
  IconPackageBulkRounded,
  IconPackageStrokeSharp,
  IconPackageSolidSharp,
];