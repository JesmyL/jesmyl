...
export const IconTree05DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Tree05 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconTree05TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Tree05 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfTree05: TheIconSelfPack = [
  'Tree05',
  IconTree05StrokeRounded,
  IconTree05DuotoneRounded,
  IconTree05TwotoneRounded,
  IconTree05SolidRounded,
  IconTree05BulkRounded,
  IconTree05StrokeSharp,
  IconTree05SolidSharp,
];