...
export const IconDashboardBrowsingStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DashboardBrowsing StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconDashboardBrowsingDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DashboardBrowsing DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconDashboardBrowsingTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DashboardBrowsing TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconDashboardBrowsingSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DashboardBrowsing SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconDashboardBrowsingBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DashboardBrowsing BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconDashboardBrowsingStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DashboardBrowsing StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const IconDashboardBrowsingSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DashboardBrowsing SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfDashboardBrowsing: TheIconSelfPack = [
  'DashboardBrowsing',
  IconDashboardBrowsingStrokeRounded,
  IconDashboardBrowsingDuotoneRounded,
  IconDashboardBrowsingTwotoneRounded,
  IconDashboardBrowsingSolidRounded,
  IconDashboardBrowsingBulkRounded,
  IconDashboardBrowsingStrokeSharp,
  IconDashboardBrowsingSolidSharp,
];