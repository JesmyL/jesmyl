...
export const IconStructure05StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Structure05 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconStructure05DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Structure05 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconStructure05TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Structure05 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconStructure05SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Structure05 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconStructure05BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Structure05 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconStructure05StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Structure05 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconStructure05SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Structure05 SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const iconPackOfStructure05: TheIconSelfPack = [
  'Structure05',
  IconStructure05StrokeRounded,
  IconStructure05DuotoneRounded,
  IconStructure05TwotoneRounded,
  IconStructure05SolidRounded,
  IconStructure05BulkRounded,
  IconStructure05StrokeSharp,
  IconStructure05SolidSharp,
];