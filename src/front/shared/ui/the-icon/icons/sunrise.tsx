...
export const IconSunriseStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sunrise StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSunriseDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sunrise DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSunriseTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sunrise TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfSunrise: TheIconSelfPack = [
  'Sunrise',
  IconSunriseStrokeRounded,
  IconSunriseDuotoneRounded,
  IconSunriseTwotoneRounded,
  IconSunriseSolidRounded,
  IconSunriseBulkRounded,
  IconSunriseStrokeSharp,
  IconSunriseSolidSharp,
];