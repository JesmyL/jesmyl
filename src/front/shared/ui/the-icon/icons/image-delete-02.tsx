...
export const IconImageDelete02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDelete02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconImageDelete02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDelete02 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconImageDelete02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDelete02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconImageDelete02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDelete02 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconImageDelete02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDelete02 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr o7"
...
export const IconImageDelete02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDelete02 StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const IconImageDelete02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageDelete02 SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="f"
...
export const iconPackOfImageDelete02: TheIconSelfPack = [
  'ImageDelete02',
  IconImageDelete02StrokeRounded,
  IconImageDelete02DuotoneRounded,
  IconImageDelete02TwotoneRounded,
  IconImageDelete02SolidRounded,
  IconImageDelete02BulkRounded,
  IconImageDelete02StrokeSharp,
  IconImageDelete02SolidSharp,
];