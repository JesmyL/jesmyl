...
export const IconGrapesDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Grapes DuotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconGrapesTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Grapes TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const iconPackOfGrapes: TheIconSelfPack = [
  'Grapes',
  IconGrapesStrokeRounded,
  IconGrapesDuotoneRounded,
  IconGrapesTwotoneRounded,
  IconGrapesSolidRounded,
  IconGrapesBulkRounded,
  IconGrapesStrokeSharp,
  IconGrapesSolidSharp,
];