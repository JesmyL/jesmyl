...
export const IconAudit02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Audit02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAudit02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Audit02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAudit02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Audit02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfAudit02: TheIconSelfPack = [
  'Audit02',
  IconAudit02StrokeRounded,
  IconAudit02DuotoneRounded,
  IconAudit02TwotoneRounded,
  IconAudit02SolidRounded,
  IconAudit02BulkRounded,
  IconAudit02StrokeSharp,
  IconAudit02SolidSharp,
];