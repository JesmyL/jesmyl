...
export const IconDocumentValidationStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DocumentValidation StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDocumentValidationDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DocumentValidation DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconDocumentValidationTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DocumentValidation TwotoneRounded"
    >
      <path 
        d={d.d12}
        i-c="o7 s sj sr sw"
...
export const IconDocumentValidationSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DocumentValidation SolidRounded"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const IconDocumentValidationBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DocumentValidation BulkRounded"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const IconDocumentValidationStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DocumentValidation StrokeSharp"
    >
      <path 
        d={d.d22}
        i-c="s sw"
...
export const IconDocumentValidationSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DocumentValidation SolidSharp"
    >
      <path 
        d={d.d26}
        i-c="c f fr"
...
export const iconPackOfDocumentValidation: TheIconSelfPack = [
  'DocumentValidation',
  IconDocumentValidationStrokeRounded,
  IconDocumentValidationDuotoneRounded,
  IconDocumentValidationTwotoneRounded,
  IconDocumentValidationSolidRounded,
  IconDocumentValidationBulkRounded,
  IconDocumentValidationStrokeSharp,
  IconDocumentValidationSolidSharp,
];