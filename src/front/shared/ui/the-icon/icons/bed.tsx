...
export const iconPackOfBed: TheIconSelfPack = [
  'Bed',
  IconBedStrokeRounded,
  IconBedDuotoneRounded,
  IconBedTwotoneRounded,
  IconBedSolidRounded,
  IconBedBulkRounded,
  IconBedStrokeSharp,
  IconBedSolidSharp,
