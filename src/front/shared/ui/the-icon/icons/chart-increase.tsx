...
export const IconChartIncreaseStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartIncrease StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconChartIncreaseDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartIncrease DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="o7 s sr sw"
...
export const IconChartIncreaseTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartIncrease TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconChartIncreaseSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartIncrease SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconChartIncreaseBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartIncrease BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconChartIncreaseStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartIncrease StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconChartIncreaseSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartIncrease SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfChartIncrease: TheIconSelfPack = [
  'ChartIncrease',
  IconChartIncreaseStrokeRounded,
  IconChartIncreaseDuotoneRounded,
  IconChartIncreaseTwotoneRounded,
  IconChartIncreaseSolidRounded,
  IconChartIncreaseBulkRounded,
  IconChartIncreaseStrokeSharp,
  IconChartIncreaseSolidSharp,
];