...
export const IconPowerSocket01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PowerSocket01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPowerSocket01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PowerSocket01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPowerSocket01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PowerSocket01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPowerSocket01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PowerSocket01 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconPowerSocket01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PowerSocket01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconPowerSocket01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PowerSocket01 StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconPowerSocket01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PowerSocket01 SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfPowerSocket01: TheIconSelfPack = [
  'PowerSocket01',
  IconPowerSocket01StrokeRounded,
  IconPowerSocket01DuotoneRounded,
  IconPowerSocket01TwotoneRounded,
  IconPowerSocket01SolidRounded,
  IconPowerSocket01BulkRounded,
  IconPowerSocket01StrokeSharp,
  IconPowerSocket01SolidSharp,
];