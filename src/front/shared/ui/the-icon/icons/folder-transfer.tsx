...
export const IconFolderTransferStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderTransfer StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFolderTransferDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderTransfer DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconFolderTransferTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderTransfer TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFolderTransferSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderTransfer SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconFolderTransferBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderTransfer BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconFolderTransferStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderTransfer StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const IconFolderTransferSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderTransfer SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const iconPackOfFolderTransfer: TheIconSelfPack = [
  'FolderTransfer',
  IconFolderTransferStrokeRounded,
  IconFolderTransferDuotoneRounded,
  IconFolderTransferTwotoneRounded,
  IconFolderTransferSolidRounded,
  IconFolderTransferBulkRounded,
  IconFolderTransferStrokeSharp,
  IconFolderTransferSolidSharp,
];