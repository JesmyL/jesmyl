...
export const iconPackOfMove: TheIconSelfPack = [
  'Move',
  IconMoveStrokeRounded,
  IconMoveDuotoneRounded,
  IconMoveTwotoneRounded,
  IconMoveSolidRounded,
  IconMoveBulkRounded,
  IconMoveStrokeSharp,
  IconMoveSolidSharp,
];