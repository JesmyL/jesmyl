...
export const IconCoins01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Coins01 StrokeRounded"
    >
      <ellipse 
        cx="15.5"
        cy="11"
...
export const IconCoins01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Coins01 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconCoins01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Coins01 TwotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="o7 s sw"
...
export const iconPackOfCoins01: TheIconSelfPack = [
  'Coins01',
  IconCoins01StrokeRounded,
  IconCoins01DuotoneRounded,
  IconCoins01TwotoneRounded,
  IconCoins01SolidRounded,
  IconCoins01BulkRounded,
  IconCoins01StrokeSharp,
  IconCoins01SolidSharp,
];