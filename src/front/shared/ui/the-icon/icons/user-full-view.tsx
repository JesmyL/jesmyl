...
export const IconUserFullViewStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserFullView StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconUserFullViewDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserFullView DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconUserFullViewTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserFullView TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconUserFullViewSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserFullView SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconUserFullViewBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserFullView BulkRounded"
    >
      <path 
        d={d.d1}
        i-c="f"
...
export const IconUserFullViewStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserFullView StrokeSharp"
    >
      <circle 
        cx="12"
        cy="5"
...
export const IconUserFullViewSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserFullView SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const iconPackOfUserFullView: TheIconSelfPack = [
  'UserFullView',
  IconUserFullViewStrokeRounded,
  IconUserFullViewDuotoneRounded,
  IconUserFullViewTwotoneRounded,
  IconUserFullViewSolidRounded,
  IconUserFullViewBulkRounded,
  IconUserFullViewStrokeSharp,
  IconUserFullViewSolidSharp,
];