...
export const IconNotification03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Notification03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconNotification03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Notification03 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconNotification03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Notification03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconNotification03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Notification03 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconNotification03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Notification03 BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconNotification03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Notification03 StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sj sw"
...
export const IconNotification03SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Notification03 SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const iconPackOfNotification03: TheIconSelfPack = [
  'Notification03',
  IconNotification03StrokeRounded,
  IconNotification03DuotoneRounded,
  IconNotification03TwotoneRounded,
  IconNotification03SolidRounded,
  IconNotification03BulkRounded,
  IconNotification03StrokeSharp,
  IconNotification03SolidSharp,
];