...
export const IconLocationFavourite01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationFavourite01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLocationFavourite01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationFavourite01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLocationFavourite01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationFavourite01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLocationFavourite01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationFavourite01 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconLocationFavourite01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationFavourite01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconLocationFavourite01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationFavourite01 StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const IconLocationFavourite01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationFavourite01 SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfLocationFavourite01: TheIconSelfPack = [
  'LocationFavourite01',
  IconLocationFavourite01StrokeRounded,
  IconLocationFavourite01DuotoneRounded,
  IconLocationFavourite01TwotoneRounded,
  IconLocationFavourite01SolidRounded,
  IconLocationFavourite01BulkRounded,
  IconLocationFavourite01StrokeSharp,
  IconLocationFavourite01SolidSharp,
];