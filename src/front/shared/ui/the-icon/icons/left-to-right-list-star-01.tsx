...
export const IconLeftToRightListStar01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftToRightListStar01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconLeftToRightListStar01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftToRightListStar01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconLeftToRightListStar01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftToRightListStar01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconLeftToRightListStar01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftToRightListStar01 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconLeftToRightListStar01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftToRightListStar01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconLeftToRightListStar01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftToRightListStar01 StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sw"
...
export const IconLeftToRightListStar01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LeftToRightListStar01 SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfLeftToRightListStar01: TheIconSelfPack = [
  ...
  IconLeftToRightListStar01StrokeRounded,
  IconLeftToRightListStar01DuotoneRounded,
  IconLeftToRightListStar01TwotoneRounded,
  IconLeftToRightListStar01SolidRounded,
  IconLeftToRightListStar01BulkRounded,
  IconLeftToRightListStar01StrokeSharp,
  IconLeftToRightListStar01SolidSharp,
];