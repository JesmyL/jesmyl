...
export const iconPackOfChef: TheIconSelfPack = [
  'Chef',
  IconChefStrokeRounded,
  IconChefDuotoneRounded,
  IconChefTwotoneRounded,
  IconChefSolidRounded,
  IconChefBulkRounded,
  IconChefStrokeSharp,
  IconChefSolidSharp,
];