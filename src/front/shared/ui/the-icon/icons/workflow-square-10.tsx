...
export const IconWorkflowSquare10StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare10 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWorkflowSquare10DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare10 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconWorkflowSquare10TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare10 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWorkflowSquare10SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare10 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconWorkflowSquare10BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare10 BulkRounded"
    >
      <path 
        d={d.d11}
        i-c="f o7"
...
export const IconWorkflowSquare10StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare10 StrokeSharp"
    >
      <path 
        d={d.d18}
        i-c="s sj sw"
...
export const IconWorkflowSquare10SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowSquare10 SolidSharp"
    >
      <path 
        d={d.d20}
        i-c="f"
...
export const iconPackOfWorkflowSquare10: TheIconSelfPack = [
  'WorkflowSquare10',
  IconWorkflowSquare10StrokeRounded,
  IconWorkflowSquare10DuotoneRounded,
  IconWorkflowSquare10TwotoneRounded,
  IconWorkflowSquare10SolidRounded,
  IconWorkflowSquare10BulkRounded,
  IconWorkflowSquare10StrokeSharp,
  IconWorkflowSquare10SolidSharp,
];