...
export const IconPlayListRemoveStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListRemove StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconPlayListRemoveDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListRemove DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconPlayListRemoveTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListRemove TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconPlayListRemoveSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListRemove SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconPlayListRemoveBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListRemove BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d7}
...
export const IconPlayListRemoveStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListRemove StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const IconPlayListRemoveSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayListRemove SolidSharp"
    >
      <path 
        d={d.d16}
        i-c="c f fr"
...
export const iconPackOfPlayListRemove: TheIconSelfPack = [
  'PlayListRemove',
  IconPlayListRemoveStrokeRounded,
  IconPlayListRemoveDuotoneRounded,
  IconPlayListRemoveTwotoneRounded,
  IconPlayListRemoveSolidRounded,
  IconPlayListRemoveBulkRounded,
  IconPlayListRemoveStrokeSharp,
  IconPlayListRemoveSolidSharp,
];