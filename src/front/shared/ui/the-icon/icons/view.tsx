...
export const iconPackOfView: TheIconSelfPack = [
  'View',
  IconViewStrokeRounded,
  IconViewDuotoneRounded,
  IconViewTwotoneRounded,
  IconViewSolidRounded,
  IconViewBulkRounded,
  IconViewStrokeSharp,
  IconViewSolidSharp,
];