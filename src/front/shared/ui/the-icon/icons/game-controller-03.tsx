...
export const IconGameController03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GameController03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGameController03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GameController03 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconGameController03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GameController03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGameController03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GameController03 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconGameController03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GameController03 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconGameController03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GameController03 StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sw"
...
export const IconGameController03SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GameController03 SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfGameController03: TheIconSelfPack = [
  'GameController03',
  IconGameController03StrokeRounded,
  IconGameController03DuotoneRounded,
  IconGameController03TwotoneRounded,
  IconGameController03SolidRounded,
  IconGameController03BulkRounded,
  IconGameController03StrokeSharp,
  IconGameController03SolidSharp,
];