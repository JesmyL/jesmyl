...
export const IconCandelier01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Candelier01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCandelier01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Candelier01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconCandelier01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Candelier01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCandelier01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Candelier01 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconCandelier01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Candelier01 BulkRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const IconCandelier01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Candelier01 StrokeSharp"
    >
      <path 
        d={d.d14}
        i-c="s sj sw"
...
export const IconCandelier01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Candelier01 SolidSharp"
    >
      <path 
        d={d.d20}
        i-c="f"
...
export const iconPackOfCandelier01: TheIconSelfPack = [
  'Candelier01',
  IconCandelier01StrokeRounded,
  IconCandelier01DuotoneRounded,
  IconCandelier01TwotoneRounded,
  IconCandelier01SolidRounded,
  IconCandelier01BulkRounded,
  IconCandelier01StrokeSharp,
  IconCandelier01SolidSharp,
];