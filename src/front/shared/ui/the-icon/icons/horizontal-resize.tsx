...
export const IconHorizontalResizeStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HorizontalResize StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHorizontalResizeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HorizontalResize DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHorizontalResizeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HorizontalResize TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHorizontalResizeSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HorizontalResize SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconHorizontalResizeBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HorizontalResize BulkRounded"
    >
      <path 
        d={d.d14}
        i-c="c f fr o7"
...
export const IconHorizontalResizeStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HorizontalResize StrokeSharp"
    >
      <path 
        d={d.d16}
        i-c="s sj sw"
...
export const IconHorizontalResizeSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HorizontalResize SolidSharp"
    >
      <path 
        d={d.d22}
        i-c="c f fr"
...
export const iconPackOfHorizontalResize: TheIconSelfPack = [
  'HorizontalResize',
  IconHorizontalResizeStrokeRounded,
  IconHorizontalResizeDuotoneRounded,
  IconHorizontalResizeTwotoneRounded,
  IconHorizontalResizeSolidRounded,
  IconHorizontalResizeBulkRounded,
  IconHorizontalResizeStrokeSharp,
  IconHorizontalResizeSolidSharp,
];