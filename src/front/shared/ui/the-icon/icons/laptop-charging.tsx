...
export const IconLaptopChargingStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopCharging StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLaptopChargingDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopCharging DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconLaptopChargingTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopCharging TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLaptopChargingSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopCharging SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconLaptopChargingBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopCharging BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o1"
...
export const IconLaptopChargingStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopCharging StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const IconLaptopChargingSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopCharging SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfLaptopCharging: TheIconSelfPack = [
  'LaptopCharging',
  IconLaptopChargingStrokeRounded,
  IconLaptopChargingDuotoneRounded,
  IconLaptopChargingTwotoneRounded,
  IconLaptopChargingSolidRounded,
  IconLaptopChargingBulkRounded,
  IconLaptopChargingStrokeSharp,
  IconLaptopChargingSolidSharp,
];