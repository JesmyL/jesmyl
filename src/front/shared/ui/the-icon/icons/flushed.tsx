...
export const IconFlushedStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Flushed StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconFlushedDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Flushed DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconFlushedTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Flushed TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const iconPackOfFlushed: TheIconSelfPack = [
  'Flushed',
  IconFlushedStrokeRounded,
  IconFlushedDuotoneRounded,
  IconFlushedTwotoneRounded,
  IconFlushedSolidRounded,
  IconFlushedBulkRounded,
  IconFlushedStrokeSharp,
  IconFlushedSolidSharp,
];