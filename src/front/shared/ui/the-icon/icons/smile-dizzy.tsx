...
export const IconSmileDizzyStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmileDizzy StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconSmileDizzyDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmileDizzy DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconSmileDizzyTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmileDizzy TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconSmileDizzySolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmileDizzy SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconSmileDizzyBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmileDizzy BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconSmileDizzyStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmileDizzy StrokeSharp"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconSmileDizzySolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SmileDizzy SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfSmileDizzy: TheIconSelfPack = [
  'SmileDizzy',
  IconSmileDizzyStrokeRounded,
  IconSmileDizzyDuotoneRounded,
  IconSmileDizzyTwotoneRounded,
  IconSmileDizzySolidRounded,
  IconSmileDizzyBulkRounded,
  IconSmileDizzyStrokeSharp,
  IconSmileDizzySolidSharp,
];