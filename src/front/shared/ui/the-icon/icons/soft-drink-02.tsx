...
export const IconSoftDrink02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoftDrink02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSoftDrink02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoftDrink02 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconSoftDrink02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoftDrink02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSoftDrink02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoftDrink02 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconSoftDrink02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoftDrink02 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconSoftDrink02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoftDrink02 StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sw"
...
export const IconSoftDrink02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoftDrink02 SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfSoftDrink02: TheIconSelfPack = [
  'SoftDrink02',
  IconSoftDrink02StrokeRounded,
  IconSoftDrink02DuotoneRounded,
  IconSoftDrink02TwotoneRounded,
  IconSoftDrink02SolidRounded,
  IconSoftDrink02BulkRounded,
  IconSoftDrink02StrokeSharp,
  IconSoftDrink02SolidSharp,
];