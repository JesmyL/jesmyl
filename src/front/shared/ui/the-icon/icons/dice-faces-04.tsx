...
export const IconDiceFaces04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDiceFaces04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces04 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconDiceFaces04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDiceFaces04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces04 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconDiceFaces04BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces04 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconDiceFaces04StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces04 StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sw"
...
export const IconDiceFaces04SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiceFaces04 SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfDiceFaces04: TheIconSelfPack = [
  'DiceFaces04',
  IconDiceFaces04StrokeRounded,
  IconDiceFaces04DuotoneRounded,
  IconDiceFaces04TwotoneRounded,
  IconDiceFaces04SolidRounded,
  IconDiceFaces04BulkRounded,
  IconDiceFaces04StrokeSharp,
  IconDiceFaces04SolidSharp,
];