...
export const IconMayanPyramidStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MayanPyramid StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMayanPyramidDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MayanPyramid DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconMayanPyramidTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MayanPyramid TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMayanPyramidSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MayanPyramid SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconMayanPyramidBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MayanPyramid BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d7}
...
export const IconMayanPyramidStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MayanPyramid StrokeSharp"
    >
      <path 
        d={d.d15}
        i-c="s sj sr sw"
...
export const IconMayanPyramidSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MayanPyramid SolidSharp"
    >
      <path 
        d={d.d20}
        i-c="f"
...
export const iconPackOfMayanPyramid: TheIconSelfPack = [
  'MayanPyramid',
  IconMayanPyramidStrokeRounded,
  IconMayanPyramidDuotoneRounded,
  IconMayanPyramidTwotoneRounded,
  IconMayanPyramidSolidRounded,
  IconMayanPyramidBulkRounded,
  IconMayanPyramidStrokeSharp,
  IconMayanPyramidSolidSharp,
];