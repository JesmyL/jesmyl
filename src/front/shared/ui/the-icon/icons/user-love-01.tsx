...
export const IconUserLove01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserLove01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserLove01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserLove01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconUserLove01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserLove01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserLove01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserLove01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconUserLove01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserLove01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconUserLove01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserLove01 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sw"
...
export const IconUserLove01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserLove01 SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="f"
...
export const iconPackOfUserLove01: TheIconSelfPack = [
  'UserLove01',
  IconUserLove01StrokeRounded,
  IconUserLove01DuotoneRounded,
  IconUserLove01TwotoneRounded,
  IconUserLove01SolidRounded,
  IconUserLove01BulkRounded,
  IconUserLove01StrokeSharp,
  IconUserLove01SolidSharp,
];