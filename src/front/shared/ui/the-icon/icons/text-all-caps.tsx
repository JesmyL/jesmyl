...
export const IconTextAllCapsStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextAllCaps StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconTextAllCapsDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextAllCaps DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconTextAllCapsTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextAllCaps TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconTextAllCapsSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextAllCaps SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconTextAllCapsBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextAllCaps BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconTextAllCapsStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextAllCaps StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const IconTextAllCapsSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextAllCaps SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfTextAllCaps: TheIconSelfPack = [
  'TextAllCaps',
  IconTextAllCapsStrokeRounded,
  IconTextAllCapsDuotoneRounded,
  IconTextAllCapsTwotoneRounded,
  IconTextAllCapsSolidRounded,
  IconTextAllCapsBulkRounded,
  IconTextAllCapsStrokeSharp,
  IconTextAllCapsSolidSharp,
];