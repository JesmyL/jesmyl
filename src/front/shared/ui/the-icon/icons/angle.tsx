...
export const iconPackOfAngle: TheIconSelfPack = [
  'Angle',
  IconAngleStrokeRounded,
  IconAngleDuotoneRounded,
  IconAngleTwotoneRounded,
  IconAngleSolidRounded,
  IconAngleBulkRounded,
  IconAngleStrokeSharp,
  IconAngleSolidSharp,
];