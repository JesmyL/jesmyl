...
export const IconAlignBoxMiddleLeftStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignBoxMiddleLeft StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAlignBoxMiddleLeftDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignBoxMiddleLeft DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconAlignBoxMiddleLeftTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignBoxMiddleLeft TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAlignBoxMiddleLeftSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignBoxMiddleLeft SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconAlignBoxMiddleLeftBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignBoxMiddleLeft BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconAlignBoxMiddleLeftStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignBoxMiddleLeft StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sr sw"
...
export const IconAlignBoxMiddleLeftSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignBoxMiddleLeft SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfAlignBoxMiddleLeft: TheIconSelfPack = [
  'AlignBoxMiddleLeft',
  IconAlignBoxMiddleLeftStrokeRounded,
  IconAlignBoxMiddleLeftDuotoneRounded,
  IconAlignBoxMiddleLeftTwotoneRounded,
  IconAlignBoxMiddleLeftSolidRounded,
  IconAlignBoxMiddleLeftBulkRounded,
  IconAlignBoxMiddleLeftStrokeSharp,
  IconAlignBoxMiddleLeftSolidSharp,
];