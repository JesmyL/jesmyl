...
export const IconSchoolDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="School DuotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconSchoolTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="School TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfSchool: TheIconSelfPack = [
  'School',
  IconSchoolStrokeRounded,
  IconSchoolDuotoneRounded,
  IconSchoolTwotoneRounded,
  IconSchoolSolidRounded,
  IconSchoolBulkRounded,
  IconSchoolStrokeSharp,
  IconSchoolSolidSharp,
];