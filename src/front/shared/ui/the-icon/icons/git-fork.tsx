...
export const IconGitForkStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitFork StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconGitForkDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitFork DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="s sj sr sw"
...
export const IconGitForkTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GitFork TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfGitFork: TheIconSelfPack = [
  'GitFork',
  IconGitForkStrokeRounded,
  IconGitForkDuotoneRounded,
  IconGitForkTwotoneRounded,
  IconGitForkSolidRounded,
  IconGitForkBulkRounded,
  IconGitForkStrokeSharp,
  IconGitForkSolidSharp,
];