...
export const IconAlignBoxBottomCenterStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignBoxBottomCenter StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAlignBoxBottomCenterDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignBoxBottomCenter DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconAlignBoxBottomCenterTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignBoxBottomCenter TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAlignBoxBottomCenterSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignBoxBottomCenter SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconAlignBoxBottomCenterBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignBoxBottomCenter BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconAlignBoxBottomCenterStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignBoxBottomCenter StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sr sw"
...
export const IconAlignBoxBottomCenterSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlignBoxBottomCenter SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfAlignBoxBottomCenter: TheIconSelfPack = [
  ...
  IconAlignBoxBottomCenterStrokeRounded,
  IconAlignBoxBottomCenterDuotoneRounded,
  IconAlignBoxBottomCenterTwotoneRounded,
  IconAlignBoxBottomCenterSolidRounded,
  IconAlignBoxBottomCenterBulkRounded,
  IconAlignBoxBottomCenterStrokeSharp,
  IconAlignBoxBottomCenterSolidSharp,
];