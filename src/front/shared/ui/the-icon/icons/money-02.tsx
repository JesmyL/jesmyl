...
export const IconMoney02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Money02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMoney02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Money02 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconMoney02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Money02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const iconPackOfMoney02: TheIconSelfPack = [
  'Money02',
  IconMoney02StrokeRounded,
  IconMoney02DuotoneRounded,
  IconMoney02TwotoneRounded,
  IconMoney02SolidRounded,
  IconMoney02BulkRounded,
  IconMoney02StrokeSharp,
  IconMoney02SolidSharp,
];