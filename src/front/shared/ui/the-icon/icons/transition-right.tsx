...
export const IconTransitionRightStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TransitionRight StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconTransitionRightDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TransitionRight DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconTransitionRightTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TransitionRight TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconTransitionRightSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TransitionRight SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconTransitionRightBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TransitionRight BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconTransitionRightStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TransitionRight StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconTransitionRightSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TransitionRight SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfTransitionRight: TheIconSelfPack = [
  'TransitionRight',
  IconTransitionRightStrokeRounded,
  IconTransitionRightDuotoneRounded,
  IconTransitionRightTwotoneRounded,
  IconTransitionRightSolidRounded,
  IconTransitionRightBulkRounded,
  IconTransitionRightStrokeSharp,
  IconTransitionRightSolidSharp,
];