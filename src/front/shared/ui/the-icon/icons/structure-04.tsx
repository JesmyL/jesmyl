...
export const IconStructure04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Structure04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconStructure04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Structure04 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconStructure04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Structure04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconStructure04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Structure04 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconStructure04BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Structure04 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconStructure04StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Structure04 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconStructure04SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Structure04 SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const iconPackOfStructure04: TheIconSelfPack = [
  'Structure04',
  IconStructure04StrokeRounded,
  IconStructure04DuotoneRounded,
  IconStructure04TwotoneRounded,
  IconStructure04SolidRounded,
  IconStructure04BulkRounded,
  IconStructure04StrokeSharp,
  IconStructure04SolidSharp,
];