...
export const IconRhombus01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Rhombus01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconRhombus01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Rhombus01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconRhombus01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Rhombus01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sw"
...
export const IconRhombus01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Rhombus01 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconRhombus01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Rhombus01 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconRhombus01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Rhombus01 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const iconPackOfRhombus01: TheIconSelfPack = [
  'Rhombus01',
  IconRhombus01StrokeRounded,
  IconRhombus01DuotoneRounded,
  IconRhombus01TwotoneRounded,
  IconRhombus01SolidRounded,
  IconRhombus01BulkRounded,
  IconRhombus01StrokeSharp,
  IconRhombus01SolidSharp,
];