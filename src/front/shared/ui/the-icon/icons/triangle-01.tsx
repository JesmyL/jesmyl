...
export const IconTriangle01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Triangle01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconTriangle01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Triangle01 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconTriangle01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Triangle01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconTriangle01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Triangle01 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconTriangle01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Triangle01 BulkRounded"
    >
      <path 
        d={d.d11}
        i-c="c f fr o7"
...
export const IconTriangle01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Triangle01 StrokeSharp"
    >
      <path 
        d={d.d15}
        i-c="s sj sw"
...
export const IconTriangle01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Triangle01 SolidSharp"
    >
      <path 
        d={d.d21}
        i-c="c f fr"
...
export const iconPackOfTriangle01: TheIconSelfPack = [
  'Triangle01',
  IconTriangle01StrokeRounded,
  IconTriangle01DuotoneRounded,
  IconTriangle01TwotoneRounded,
  IconTriangle01SolidRounded,
  IconTriangle01BulkRounded,
  IconTriangle01StrokeSharp,
  IconTriangle01SolidSharp,
];