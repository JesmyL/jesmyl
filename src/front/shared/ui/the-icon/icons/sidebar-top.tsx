...
export const IconSidebarTopStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarTop StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSidebarTopDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarTop DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconSidebarTopTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarTop TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSidebarTopSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarTop SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconSidebarTopBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarTop BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconSidebarTopStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarTop StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconSidebarTopSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SidebarTop SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfSidebarTop: TheIconSelfPack = [
  'SidebarTop',
  IconSidebarTopStrokeRounded,
  IconSidebarTopDuotoneRounded,
  IconSidebarTopTwotoneRounded,
  IconSidebarTopSolidRounded,
  IconSidebarTopBulkRounded,
  IconSidebarTopStrokeSharp,
  IconSidebarTopSolidSharp,
];