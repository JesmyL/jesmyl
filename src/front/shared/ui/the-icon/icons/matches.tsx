...
export const IconMatchesStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Matches StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMatchesDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Matches DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr o7"
...
export const IconMatchesTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Matches TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfMatches: TheIconSelfPack = [
  'Matches',
  IconMatchesStrokeRounded,
  IconMatchesDuotoneRounded,
  IconMatchesTwotoneRounded,
  IconMatchesSolidRounded,
  IconMatchesBulkRounded,
  IconMatchesStrokeSharp,
  IconMatchesSolidSharp,
];