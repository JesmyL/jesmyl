...
export const IconHierarchyStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Hierarchy StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHierarchyDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Hierarchy DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconHierarchyTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Hierarchy TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHierarchySolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Hierarchy SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconHierarchyBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Hierarchy BulkRounded"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const IconHierarchyStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Hierarchy StrokeSharp"
    >
      <path 
        d={d.d15}
        i-c="s sj sw"
...
export const iconPackOfHierarchy: TheIconSelfPack = [
  'Hierarchy',
  IconHierarchyStrokeRounded,
  IconHierarchyDuotoneRounded,
  IconHierarchyTwotoneRounded,
  IconHierarchySolidRounded,
  IconHierarchyBulkRounded,
  IconHierarchyStrokeSharp,
  IconHierarchySolidSharp,
];