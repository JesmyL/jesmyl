...
export const iconPackOfStars: TheIconSelfPack = [
  'Stars',
  IconStarsStrokeRounded,
  IconStarsDuotoneRounded,
  IconStarsTwotoneRounded,
  IconStarsSolidRounded,
  IconStarsBulkRounded,
  IconStarsStrokeSharp,
  IconStarsSolidSharp,
];