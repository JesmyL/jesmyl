...
export const IconAlertSquareStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlertSquare StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconAlertSquareDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlertSquare DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconAlertSquareTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlertSquare TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconAlertSquareSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlertSquare SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconAlertSquareBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlertSquare BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconAlertSquareStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlertSquare StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconAlertSquareSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlertSquare SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfAlertSquare: TheIconSelfPack = [
  'AlertSquare',
  IconAlertSquareStrokeRounded,
  IconAlertSquareDuotoneRounded,
  IconAlertSquareTwotoneRounded,
  IconAlertSquareSolidRounded,
  IconAlertSquareBulkRounded,
  IconAlertSquareStrokeSharp,
  IconAlertSquareSolidSharp,
];