...
export const IconTrolley01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Trolley01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconTrolley01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Trolley01 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconTrolley01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Trolley01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconTrolley01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Trolley01 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconTrolley01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Trolley01 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconTrolley01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Trolley01 StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const iconPackOfTrolley01: TheIconSelfPack = [
  'Trolley01',
  IconTrolley01StrokeRounded,
  IconTrolley01DuotoneRounded,
  IconTrolley01TwotoneRounded,
  IconTrolley01SolidRounded,
  IconTrolley01BulkRounded,
  IconTrolley01StrokeSharp,
  IconTrolley01SolidSharp,
];