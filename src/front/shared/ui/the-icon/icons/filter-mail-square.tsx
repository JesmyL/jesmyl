...
export const IconFilterMailSquareStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterMailSquare StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconFilterMailSquareDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterMailSquare DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconFilterMailSquareTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterMailSquare TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconFilterMailSquareSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterMailSquare SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconFilterMailSquareBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterMailSquare BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconFilterMailSquareStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterMailSquare StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconFilterMailSquareSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterMailSquare SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfFilterMailSquare: TheIconSelfPack = [
  'FilterMailSquare',
  IconFilterMailSquareStrokeRounded,
  IconFilterMailSquareDuotoneRounded,
  IconFilterMailSquareTwotoneRounded,
  IconFilterMailSquareSolidRounded,
  IconFilterMailSquareBulkRounded,
  IconFilterMailSquareStrokeSharp,
  IconFilterMailSquareSolidSharp,
];