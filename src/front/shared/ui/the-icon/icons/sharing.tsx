...
export const IconSharingStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sharing StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSharingDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sharing DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconSharingTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sharing TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfSharing: TheIconSelfPack = [
  'Sharing',
  IconSharingStrokeRounded,
  IconSharingDuotoneRounded,
  IconSharingTwotoneRounded,
  IconSharingSolidRounded,
  IconSharingBulkRounded,
  IconSharingStrokeSharp,
  IconSharingSolidSharp,
];