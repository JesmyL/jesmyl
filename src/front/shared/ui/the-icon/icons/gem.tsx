...
export const iconPackOfGem: TheIconSelfPack = [
  'Gem',
  IconGemStrokeRounded,
  IconGemDuotoneRounded,
  IconGemTwotoneRounded,
  IconGemSolidRounded,
  IconGemBulkRounded,
  IconGemStrokeSharp,
  IconGemSolidSharp,
