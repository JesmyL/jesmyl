...
export const IconUngroupLayersStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UngroupLayers StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconUngroupLayersDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UngroupLayers DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconUngroupLayersTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UngroupLayers TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconUngroupLayersSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UngroupLayers SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconUngroupLayersBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UngroupLayers BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconUngroupLayersStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UngroupLayers StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconUngroupLayersSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UngroupLayers SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const iconPackOfUngroupLayers: TheIconSelfPack = [
  'UngroupLayers',
  IconUngroupLayersStrokeRounded,
  IconUngroupLayersDuotoneRounded,
  IconUngroupLayersTwotoneRounded,
  IconUngroupLayersSolidRounded,
  IconUngroupLayersBulkRounded,
  IconUngroupLayersStrokeSharp,
  IconUngroupLayersSolidSharp,
];