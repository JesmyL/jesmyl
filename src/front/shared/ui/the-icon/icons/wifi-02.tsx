...
export const IconWifi02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wifi02 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="o7 s sj sr sw"
...
export const IconWifi02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wifi02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfWifi02: TheIconSelfPack = [
  'Wifi02',
  IconWifi02StrokeRounded,
  IconWifi02DuotoneRounded,
  IconWifi02TwotoneRounded,
  IconWifi02SolidRounded,
  IconWifi02BulkRounded,
  IconWifi02StrokeSharp,
  IconWifi02SolidSharp,
];