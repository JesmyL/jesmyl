...
export const IconHangerDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Hanger DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconHangerTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Hanger TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfHanger: TheIconSelfPack = [
  'Hanger',
  IconHangerStrokeRounded,
  IconHangerDuotoneRounded,
  IconHangerTwotoneRounded,
  IconHangerSolidRounded,
  IconHangerBulkRounded,
  IconHangerStrokeSharp,
  IconHangerSolidSharp,
];