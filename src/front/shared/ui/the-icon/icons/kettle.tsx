...
export const IconKettleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Kettle DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconKettleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Kettle TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfKettle: TheIconSelfPack = [
  'Kettle',
  IconKettleStrokeRounded,
  IconKettleDuotoneRounded,
  IconKettleTwotoneRounded,
  IconKettleSolidRounded,
  IconKettleBulkRounded,
  IconKettleStrokeSharp,
  IconKettleSolidSharp,
];