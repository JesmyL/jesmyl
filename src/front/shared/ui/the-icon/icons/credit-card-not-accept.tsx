...
export const IconCreditCardNotAcceptStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CreditCardNotAccept StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCreditCardNotAcceptDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CreditCardNotAccept DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconCreditCardNotAcceptTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CreditCardNotAccept TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCreditCardNotAcceptSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CreditCardNotAccept SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconCreditCardNotAcceptBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CreditCardNotAccept BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconCreditCardNotAcceptStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CreditCardNotAccept StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const IconCreditCardNotAcceptSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CreditCardNotAccept SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfCreditCardNotAccept: TheIconSelfPack = [
  'CreditCardNotAccept',
  IconCreditCardNotAcceptStrokeRounded,
  IconCreditCardNotAcceptDuotoneRounded,
  IconCreditCardNotAcceptTwotoneRounded,
  IconCreditCardNotAcceptSolidRounded,
  IconCreditCardNotAcceptBulkRounded,
  IconCreditCardNotAcceptStrokeSharp,
  IconCreditCardNotAcceptSolidSharp,
];