...
export const IconTextKerningStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextKerning StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTextKerningDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextKerning DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconTextKerningTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextKerning TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTextKerningSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextKerning SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconTextKerningBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextKerning BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconTextKerningStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextKerning StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sw"
...
export const IconTextKerningSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextKerning SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfTextKerning: TheIconSelfPack = [
  'TextKerning',
  IconTextKerningStrokeRounded,
  IconTextKerningDuotoneRounded,
  IconTextKerningTwotoneRounded,
  IconTextKerningSolidRounded,
  IconTextKerningBulkRounded,
  IconTextKerningStrokeSharp,
  IconTextKerningSolidSharp,
];