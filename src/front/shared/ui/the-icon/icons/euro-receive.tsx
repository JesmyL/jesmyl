...
export const IconEuroReceiveStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EuroReceive StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconEuroReceiveDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EuroReceive DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconEuroReceiveTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EuroReceive TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconEuroReceiveSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EuroReceive SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconEuroReceiveBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EuroReceive BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr o7"
...
export const IconEuroReceiveStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EuroReceive StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconEuroReceiveSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EuroReceive SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfEuroReceive: TheIconSelfPack = [
  'EuroReceive',
  IconEuroReceiveStrokeRounded,
  IconEuroReceiveDuotoneRounded,
  IconEuroReceiveTwotoneRounded,
  IconEuroReceiveSolidRounded,
  IconEuroReceiveBulkRounded,
  IconEuroReceiveStrokeSharp,
  IconEuroReceiveSolidSharp,
];