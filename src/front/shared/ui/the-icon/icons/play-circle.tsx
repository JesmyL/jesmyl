...
export const IconPlayCircleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayCircle StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconPlayCircleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayCircle DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="c f fr o7"
...
export const IconPlayCircleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayCircle TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconPlayCircleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayCircle SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconPlayCircleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayCircle BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconPlayCircleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayCircle StrokeSharp"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconPlayCircleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlayCircle SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfPlayCircle: TheIconSelfPack = [
  'PlayCircle',
  IconPlayCircleStrokeRounded,
  IconPlayCircleDuotoneRounded,
  IconPlayCircleTwotoneRounded,
  IconPlayCircleSolidRounded,
  IconPlayCircleBulkRounded,
  IconPlayCircleStrokeSharp,
  IconPlayCircleSolidSharp,
];