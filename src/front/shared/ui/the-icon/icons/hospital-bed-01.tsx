...
export const IconHospitalBed01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HospitalBed01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconHospitalBed01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HospitalBed01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconHospitalBed01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HospitalBed01 TwotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="s sr sw"
...
export const IconHospitalBed01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HospitalBed01 SolidRounded"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const IconHospitalBed01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HospitalBed01 BulkRounded"
    >
      <path 
        d={d.d10}
        i-c="f o7"
...
export const IconHospitalBed01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HospitalBed01 StrokeSharp"
    >
      <path 
        d={d.d20}
        i-c="s sj sw"
...
export const IconHospitalBed01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HospitalBed01 SolidSharp"
    >
      <path 
        d={d.d27}
        i-c="c f fr"
...
export const iconPackOfHospitalBed01: TheIconSelfPack = [
  'HospitalBed01',
  IconHospitalBed01StrokeRounded,
  IconHospitalBed01DuotoneRounded,
  IconHospitalBed01TwotoneRounded,
  IconHospitalBed01SolidRounded,
  IconHospitalBed01BulkRounded,
  IconHospitalBed01StrokeSharp,
  IconHospitalBed01SolidSharp,
];