...
export const IconBorderAll01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BorderAll01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBorderAll01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BorderAll01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconBorderAll01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BorderAll01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBorderAll01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BorderAll01 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconBorderAll01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BorderAll01 BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconBorderAll01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BorderAll01 StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sj sw"
...
export const IconBorderAll01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BorderAll01 SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfBorderAll01: TheIconSelfPack = [
  'BorderAll01',
  IconBorderAll01StrokeRounded,
  IconBorderAll01DuotoneRounded,
  IconBorderAll01TwotoneRounded,
  IconBorderAll01SolidRounded,
  IconBorderAll01BulkRounded,
  IconBorderAll01StrokeSharp,
  IconBorderAll01SolidSharp,
];