...
export const IconBookshelf02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookshelf02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBookshelf02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookshelf02 DuotoneRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconBookshelf02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookshelf02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBookshelf02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookshelf02 SolidRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const IconBookshelf02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookshelf02 BulkRounded"
    >
      <path 
        d={d.d16}
        i-c="c f fr o7"
...
export const IconBookshelf02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookshelf02 StrokeSharp"
    >
      <path 
        d={d.d24}
        i-c="s sj sw"
...
export const IconBookshelf02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookshelf02 SolidSharp"
    >
      <path 
        d={d.d29}
        i-c="c f fr"
...
export const iconPackOfBookshelf02: TheIconSelfPack = [
  'Bookshelf02',
  IconBookshelf02StrokeRounded,
  IconBookshelf02DuotoneRounded,
  IconBookshelf02TwotoneRounded,
  IconBookshelf02SolidRounded,
  IconBookshelf02BulkRounded,
  IconBookshelf02StrokeSharp,
  IconBookshelf02SolidSharp,
];