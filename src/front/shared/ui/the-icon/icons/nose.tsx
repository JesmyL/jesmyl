...
export const iconPackOfNose: TheIconSelfPack = [
  'Nose',
  IconNoseStrokeRounded,
  IconNoseDuotoneRounded,
  IconNoseTwotoneRounded,
  IconNoseSolidRounded,
  IconNoseBulkRounded,
  IconNoseStrokeSharp,
  IconNoseSolidSharp,
];