...
export const IconBloggerStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Blogger StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconBloggerDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Blogger DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconBloggerTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Blogger TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfBlogger: TheIconSelfPack = [
  'Blogger',
  IconBloggerStrokeRounded,
  IconBloggerDuotoneRounded,
  IconBloggerTwotoneRounded,
  IconBloggerSolidRounded,
  IconBloggerBulkRounded,
  IconBloggerStrokeSharp,
  IconBloggerSolidSharp,
];