...
export const IconRockingChairStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RockingChair StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRockingChairDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RockingChair DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconRockingChairTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RockingChair TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconRockingChairSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RockingChair SolidRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const IconRockingChairBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RockingChair BulkRounded"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const IconRockingChairStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RockingChair StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconRockingChairSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RockingChair SolidSharp"
    >
      <path 
        d={d.d16}
        i-c="c f fr"
...
export const iconPackOfRockingChair: TheIconSelfPack = [
  'RockingChair',
  IconRockingChairStrokeRounded,
  IconRockingChairDuotoneRounded,
  IconRockingChairTwotoneRounded,
  IconRockingChairSolidRounded,
  IconRockingChairBulkRounded,
  IconRockingChairStrokeSharp,
  IconRockingChairSolidSharp,
];