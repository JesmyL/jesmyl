...
export const IconLink04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Link04 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconLink04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Link04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const iconPackOfLink04: TheIconSelfPack = [
  'Link04',
  IconLink04StrokeRounded,
  IconLink04DuotoneRounded,
  IconLink04TwotoneRounded,
  IconLink04SolidRounded,
  IconLink04BulkRounded,
  IconLink04StrokeSharp,
  IconLink04SolidSharp,
];