...
export const IconTextFootnoteStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextFootnote StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconTextFootnoteDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextFootnote DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="o7 s sr sw"
...
export const IconTextFootnoteTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextFootnote TwotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="s sj sr sw"
...
export const IconTextFootnoteSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextFootnote SolidRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const IconTextFootnoteBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextFootnote BulkRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr o7"
...
export const IconTextFootnoteStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextFootnote StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const IconTextFootnoteSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextFootnote SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfTextFootnote: TheIconSelfPack = [
  'TextFootnote',
  IconTextFootnoteStrokeRounded,
  IconTextFootnoteDuotoneRounded,
  IconTextFootnoteTwotoneRounded,
  IconTextFootnoteSolidRounded,
  IconTextFootnoteBulkRounded,
  IconTextFootnoteStrokeSharp,
  IconTextFootnoteSolidSharp,
];