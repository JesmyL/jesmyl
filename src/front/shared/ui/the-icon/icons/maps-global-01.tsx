...
export const IconMapsGlobal01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapsGlobal01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconMapsGlobal01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapsGlobal01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconMapsGlobal01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapsGlobal01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconMapsGlobal01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapsGlobal01 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconMapsGlobal01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapsGlobal01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconMapsGlobal01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapsGlobal01 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconMapsGlobal01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapsGlobal01 SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfMapsGlobal01: TheIconSelfPack = [
  'MapsGlobal01',
  IconMapsGlobal01StrokeRounded,
  IconMapsGlobal01DuotoneRounded,
  IconMapsGlobal01TwotoneRounded,
  IconMapsGlobal01SolidRounded,
  IconMapsGlobal01BulkRounded,
  IconMapsGlobal01StrokeSharp,
  IconMapsGlobal01SolidSharp,
];