...
export const IconComputerRemoveStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerRemove StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconComputerRemoveDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerRemove DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconComputerRemoveTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerRemove TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconComputerRemoveSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerRemove SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconComputerRemoveBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerRemove BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconComputerRemoveStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerRemove StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconComputerRemoveSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerRemove SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfComputerRemove: TheIconSelfPack = [
  'ComputerRemove',
  IconComputerRemoveStrokeRounded,
  IconComputerRemoveDuotoneRounded,
  IconComputerRemoveTwotoneRounded,
  IconComputerRemoveSolidRounded,
  IconComputerRemoveBulkRounded,
  IconComputerRemoveStrokeSharp,
  IconComputerRemoveSolidSharp,
];