...
export const IconSourceCodeCircleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SourceCodeCircle StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconSourceCodeCircleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SourceCodeCircle DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconSourceCodeCircleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SourceCodeCircle TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconSourceCodeCircleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SourceCodeCircle SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconSourceCodeCircleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SourceCodeCircle BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconSourceCodeCircleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SourceCodeCircle StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const IconSourceCodeCircleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SourceCodeCircle SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfSourceCodeCircle: TheIconSelfPack = [
  'SourceCodeCircle',
  IconSourceCodeCircleStrokeRounded,
  IconSourceCodeCircleDuotoneRounded,
  IconSourceCodeCircleTwotoneRounded,
  IconSourceCodeCircleSolidRounded,
  IconSourceCodeCircleBulkRounded,
  IconSourceCodeCircleStrokeSharp,
  IconSourceCodeCircleSolidSharp,
];