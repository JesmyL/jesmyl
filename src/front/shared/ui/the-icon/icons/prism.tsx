...
export const iconPackOfPrism: TheIconSelfPack = [
  'Prism',
  IconPrismStrokeRounded,
  IconPrismDuotoneRounded,
  IconPrismTwotoneRounded,
  IconPrismSolidRounded,
  IconPrismBulkRounded,
  IconPrismStrokeSharp,
  IconPrismSolidSharp,
];