...
export const IconAbacusDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Abacus DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconAbacusTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Abacus TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfAbacus: TheIconSelfPack = [
  'Abacus',
  IconAbacusStrokeRounded,
  IconAbacusDuotoneRounded,
  IconAbacusTwotoneRounded,
  IconAbacusSolidRounded,
  IconAbacusBulkRounded,
  IconAbacusStrokeSharp,
  IconAbacusSolidSharp,
];