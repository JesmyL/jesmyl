...
export const IconCenterFocusStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CenterFocus StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCenterFocusDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CenterFocus DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr o7"
...
export const IconCenterFocusTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CenterFocus TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCenterFocusSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CenterFocus SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconCenterFocusBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CenterFocus BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconCenterFocusStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CenterFocus StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const IconCenterFocusSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CenterFocus SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfCenterFocus: TheIconSelfPack = [
  'CenterFocus',
  IconCenterFocusStrokeRounded,
  IconCenterFocusDuotoneRounded,
  IconCenterFocusTwotoneRounded,
  IconCenterFocusSolidRounded,
  IconCenterFocusBulkRounded,
  IconCenterFocusStrokeSharp,
  IconCenterFocusSolidSharp,
];