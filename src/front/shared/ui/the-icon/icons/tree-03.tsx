...
export const IconTree03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Tree03 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconTree03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Tree03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfTree03: TheIconSelfPack = [
  'Tree03',
  IconTree03StrokeRounded,
  IconTree03DuotoneRounded,
  IconTree03TwotoneRounded,
  IconTree03SolidRounded,
  IconTree03BulkRounded,
  IconTree03StrokeSharp,
  IconTree03SolidSharp,
];