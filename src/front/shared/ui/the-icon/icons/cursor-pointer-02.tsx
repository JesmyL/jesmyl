...
export const IconCursorPointer02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorPointer02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconCursorPointer02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorPointer02 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconCursorPointer02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorPointer02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconCursorPointer02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorPointer02 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconCursorPointer02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorPointer02 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconCursorPointer02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorPointer02 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconCursorPointer02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorPointer02 SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfCursorPointer02: TheIconSelfPack = [
  'CursorPointer02',
  IconCursorPointer02StrokeRounded,
  IconCursorPointer02DuotoneRounded,
  IconCursorPointer02TwotoneRounded,
  IconCursorPointer02SolidRounded,
  IconCursorPointer02BulkRounded,
  IconCursorPointer02StrokeSharp,
  IconCursorPointer02SolidSharp,
];