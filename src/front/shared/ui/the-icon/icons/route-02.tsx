...
export const IconRoute02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Route02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconRoute02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Route02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconRoute02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Route02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const iconPackOfRoute02: TheIconSelfPack = [
  'Route02',
  IconRoute02StrokeRounded,
  IconRoute02DuotoneRounded,
  IconRoute02TwotoneRounded,
  IconRoute02SolidRounded,
  IconRoute02BulkRounded,
  IconRoute02StrokeSharp,
  IconRoute02SolidSharp,
];