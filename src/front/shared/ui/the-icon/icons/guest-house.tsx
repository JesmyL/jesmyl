...
export const IconGuestHouseStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GuestHouse StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGuestHouseDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GuestHouse DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconGuestHouseTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GuestHouse TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGuestHouseSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GuestHouse SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconGuestHouseBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GuestHouse BulkRounded"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const IconGuestHouseStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GuestHouse StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconGuestHouseSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GuestHouse SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const iconPackOfGuestHouse: TheIconSelfPack = [
  'GuestHouse',
  IconGuestHouseStrokeRounded,
  IconGuestHouseDuotoneRounded,
  IconGuestHouseTwotoneRounded,
  IconGuestHouseSolidRounded,
  IconGuestHouseBulkRounded,
  IconGuestHouseStrokeSharp,
  IconGuestHouseSolidSharp,
];