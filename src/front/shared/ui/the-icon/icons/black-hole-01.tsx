...
export const IconBlackHole01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BlackHole01 StrokeRounded"
    >
      <ellipse 
        cx="12"
        cy="13"
...
export const IconBlackHole01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BlackHole01 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconBlackHole01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BlackHole01 TwotoneRounded"
    >
      <ellipse 
        cx="12"
        cy="13"
...
export const IconBlackHole01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BlackHole01 SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconBlackHole01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BlackHole01 BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconBlackHole01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BlackHole01 StrokeSharp"
    >
      <ellipse 
        cx="12"
        cy="13"
...
export const IconBlackHole01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BlackHole01 SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfBlackHole01: TheIconSelfPack = [
  'BlackHole01',
  IconBlackHole01StrokeRounded,
  IconBlackHole01DuotoneRounded,
  IconBlackHole01TwotoneRounded,
  IconBlackHole01SolidRounded,
  IconBlackHole01BulkRounded,
  IconBlackHole01StrokeSharp,
  IconBlackHole01SolidSharp,
];