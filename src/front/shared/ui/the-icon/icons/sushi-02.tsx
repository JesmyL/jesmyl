...
export const IconSushi02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sushi02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSushi02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sushi02 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconSushi02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sushi02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const iconPackOfSushi02: TheIconSelfPack = [
  'Sushi02',
  IconSushi02StrokeRounded,
  IconSushi02DuotoneRounded,
  IconSushi02TwotoneRounded,
  IconSushi02SolidRounded,
  IconSushi02BulkRounded,
  IconSushi02StrokeSharp,
  IconSushi02SolidSharp,
];