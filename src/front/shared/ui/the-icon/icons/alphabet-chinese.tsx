...
export const IconAlphabetChineseStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlphabetChinese StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAlphabetChineseDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlphabetChinese DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconAlphabetChineseTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlphabetChinese TwotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="o7 s sj sr sw"
...
export const IconAlphabetChineseSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlphabetChinese SolidRounded"
    >
      <path 
        d={d.d12}
        i-c="f"
...
export const IconAlphabetChineseBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlphabetChinese BulkRounded"
    >
      <path 
        d={d.d12}
        i-c="f o7"
...
export const IconAlphabetChineseStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlphabetChinese StrokeSharp"
    >
      <path 
        d={d.d14}
        i-c="s sj sw"
...
export const IconAlphabetChineseSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AlphabetChinese SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const iconPackOfAlphabetChinese: TheIconSelfPack = [
  'AlphabetChinese',
  IconAlphabetChineseStrokeRounded,
  IconAlphabetChineseDuotoneRounded,
  IconAlphabetChineseTwotoneRounded,
  IconAlphabetChineseSolidRounded,
  IconAlphabetChineseBulkRounded,
  IconAlphabetChineseStrokeSharp,
  IconAlphabetChineseSolidSharp,
];