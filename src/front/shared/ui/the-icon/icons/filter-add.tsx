...
export const IconFilterAddStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterAdd StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFilterAddDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterAdd DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconFilterAddTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterAdd TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFilterAddSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterAdd SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconFilterAddBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterAdd BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconFilterAddStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterAdd StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const iconPackOfFilterAdd: TheIconSelfPack = [
  'FilterAdd',
  IconFilterAddStrokeRounded,
  IconFilterAddDuotoneRounded,
  IconFilterAddTwotoneRounded,
  IconFilterAddSolidRounded,
  IconFilterAddBulkRounded,
  IconFilterAddStrokeSharp,
  IconFilterAddSolidSharp,
];