...
export const IconVynil01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Vynil01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconVynil01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Vynil01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconVynil01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Vynil01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfVynil01: TheIconSelfPack = [
  'Vynil01',
  IconVynil01StrokeRounded,
  IconVynil01DuotoneRounded,
  IconVynil01TwotoneRounded,
  IconVynil01SolidRounded,
  IconVynil01BulkRounded,
  IconVynil01StrokeSharp,
  IconVynil01SolidSharp,
];