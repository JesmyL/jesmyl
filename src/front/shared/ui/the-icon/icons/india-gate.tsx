...
export const IconIndiaGateStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IndiaGate StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconIndiaGateDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IndiaGate DuotoneRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconIndiaGateTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IndiaGate TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconIndiaGateSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IndiaGate SolidRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const IconIndiaGateBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IndiaGate BulkRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const IconIndiaGateStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="IndiaGate StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfIndiaGate: TheIconSelfPack = [
  'IndiaGate',
  IconIndiaGateStrokeRounded,
  IconIndiaGateDuotoneRounded,
  IconIndiaGateTwotoneRounded,
  IconIndiaGateSolidRounded,
  IconIndiaGateBulkRounded,
  IconIndiaGateStrokeSharp,
  IconIndiaGateSolidSharp,
];