...
export const IconHorizonalScrollPointStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HorizonalScrollPoint StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHorizonalScrollPointDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HorizonalScrollPoint DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconHorizonalScrollPointTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HorizonalScrollPoint TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconHorizonalScrollPointSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HorizonalScrollPoint SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconHorizonalScrollPointBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HorizonalScrollPoint BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconHorizonalScrollPointStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HorizonalScrollPoint StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const IconHorizonalScrollPointSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HorizonalScrollPoint SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfHorizonalScrollPoint: TheIconSelfPack = [
  ...
  IconHorizonalScrollPointStrokeRounded,
  IconHorizonalScrollPointDuotoneRounded,
  IconHorizonalScrollPointTwotoneRounded,
  IconHorizonalScrollPointSolidRounded,
  IconHorizonalScrollPointBulkRounded,
  IconHorizonalScrollPointStrokeSharp,
  IconHorizonalScrollPointSolidSharp,
];