...
export const IconBloodBottleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BloodBottle StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBloodBottleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BloodBottle DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBloodBottleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BloodBottle TwotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="s sj sw"
...
export const IconBloodBottleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BloodBottle SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconBloodBottleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BloodBottle BulkRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const IconBloodBottleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BloodBottle StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconBloodBottleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BloodBottle SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const iconPackOfBloodBottle: TheIconSelfPack = [
  'BloodBottle',
  IconBloodBottleStrokeRounded,
  IconBloodBottleDuotoneRounded,
  IconBloodBottleTwotoneRounded,
  IconBloodBottleSolidRounded,
  IconBloodBottleBulkRounded,
  IconBloodBottleStrokeSharp,
  IconBloodBottleSolidSharp,
];