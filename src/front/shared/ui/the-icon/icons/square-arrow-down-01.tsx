...
export const IconSquareArrowDown01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowDown01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSquareArrowDown01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowDown01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconSquareArrowDown01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowDown01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSquareArrowDown01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowDown01 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconSquareArrowDown01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowDown01 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconSquareArrowDown01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowDown01 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const IconSquareArrowDown01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowDown01 SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfSquareArrowDown01: TheIconSelfPack = [
  'SquareArrowDown01',
  IconSquareArrowDown01StrokeRounded,
  IconSquareArrowDown01DuotoneRounded,
  IconSquareArrowDown01TwotoneRounded,
  IconSquareArrowDown01SolidRounded,
  IconSquareArrowDown01BulkRounded,
  IconSquareArrowDown01StrokeSharp,
  IconSquareArrowDown01SolidSharp,
];