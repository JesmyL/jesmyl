...
export const iconPackOfBeach: TheIconSelfPack = [
  'Beach',
  IconBeachStrokeRounded,
  IconBeachDuotoneRounded,
  IconBeachTwotoneRounded,
  IconBeachSolidRounded,
  IconBeachBulkRounded,
  IconBeachStrokeSharp,
  IconBeachSolidSharp,
];