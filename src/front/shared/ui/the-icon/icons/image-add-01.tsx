...
export const IconImageAdd01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageAdd01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconImageAdd01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageAdd01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconImageAdd01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageAdd01 TwotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="s sr sw"
...
export const IconImageAdd01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageAdd01 SolidRounded"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const IconImageAdd01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageAdd01 BulkRounded"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const IconImageAdd01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageAdd01 StrokeSharp"
    >
      <path 
        d={d.d14}
        i-c="s sj sw"
...
export const IconImageAdd01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ImageAdd01 SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const iconPackOfImageAdd01: TheIconSelfPack = [
  'ImageAdd01',
  IconImageAdd01StrokeRounded,
  IconImageAdd01DuotoneRounded,
  IconImageAdd01TwotoneRounded,
  IconImageAdd01SolidRounded,
  IconImageAdd01BulkRounded,
  IconImageAdd01StrokeSharp,
  IconImageAdd01SolidSharp,
];