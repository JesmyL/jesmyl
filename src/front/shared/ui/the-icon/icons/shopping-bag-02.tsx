...
export const IconShoppingBag02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBag02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconShoppingBag02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBag02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconShoppingBag02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBag02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconShoppingBag02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBag02 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconShoppingBag02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBag02 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconShoppingBag02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBag02 StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const IconShoppingBag02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBag02 SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfShoppingBag02: TheIconSelfPack = [
  'ShoppingBag02',
  IconShoppingBag02StrokeRounded,
  IconShoppingBag02DuotoneRounded,
  IconShoppingBag02TwotoneRounded,
  IconShoppingBag02SolidRounded,
  IconShoppingBag02BulkRounded,
  IconShoppingBag02StrokeSharp,
  IconShoppingBag02SolidSharp,
];