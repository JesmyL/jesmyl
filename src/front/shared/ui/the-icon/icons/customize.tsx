...
export const IconCustomizeStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Customize StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconCustomizeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Customize DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconCustomizeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Customize TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconCustomizeSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Customize SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconCustomizeBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Customize BulkRounded"
    >
      <rect 
        x="2.25"
        y="2.25"
...
export const IconCustomizeStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Customize StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const iconPackOfCustomize: TheIconSelfPack = [
  'Customize',
  IconCustomizeStrokeRounded,
  IconCustomizeDuotoneRounded,
  IconCustomizeTwotoneRounded,
  IconCustomizeSolidRounded,
  IconCustomizeBulkRounded,
  IconCustomizeStrokeSharp,
  IconCustomizeSolidSharp,
];