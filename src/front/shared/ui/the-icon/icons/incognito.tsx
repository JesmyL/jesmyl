...
export const IconIncognitoStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Incognito StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconIncognitoDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Incognito DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconIncognitoTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Incognito TwotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="s sr sw"
...
export const IconIncognitoSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Incognito SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconIncognitoBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Incognito BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconIncognitoStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Incognito StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfIncognito: TheIconSelfPack = [
  'Incognito',
  IconIncognitoStrokeRounded,
  IconIncognitoDuotoneRounded,
  IconIncognitoTwotoneRounded,
  IconIncognitoSolidRounded,
  IconIncognitoBulkRounded,
  IconIncognitoStrokeSharp,
  IconIncognitoSolidSharp,
];