...
export const IconSwimmingStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Swimming StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSwimmingDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Swimming DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconSwimmingTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Swimming TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSwimmingSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Swimming SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const iconPackOfSwimming: TheIconSelfPack = [
  'Swimming',
  IconSwimmingStrokeRounded,
  IconSwimmingDuotoneRounded,
  IconSwimmingTwotoneRounded,
  IconSwimmingSolidRounded,
  IconSwimmingBulkRounded,
  IconSwimmingStrokeSharp,
  IconSwimmingSolidSharp,
];