...
export const IconPyramidStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pyramid StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPyramidDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pyramid DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconPyramidTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pyramid TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfPyramid: TheIconSelfPack = [
  'Pyramid',
  IconPyramidStrokeRounded,
  IconPyramidDuotoneRounded,
  IconPyramidTwotoneRounded,
  IconPyramidSolidRounded,
  IconPyramidBulkRounded,
  IconPyramidStrokeSharp,
  IconPyramidSolidSharp,
];