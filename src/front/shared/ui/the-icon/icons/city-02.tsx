...
export const IconCity02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="City02 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconCity02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="City02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfCity02: TheIconSelfPack = [
  'City02',
  IconCity02StrokeRounded,
  IconCity02DuotoneRounded,
  IconCity02TwotoneRounded,
  IconCity02SolidRounded,
  IconCity02BulkRounded,
  IconCity02StrokeSharp,
  IconCity02SolidSharp,
];