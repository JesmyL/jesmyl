...
export const IconTestTube02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TestTube02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconTestTube02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TestTube02 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconTestTube02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TestTube02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconTestTube02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TestTube02 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconTestTube02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TestTube02 BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr o7"
...
export const IconTestTube02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TestTube02 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconTestTube02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TestTube02 SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfTestTube02: TheIconSelfPack = [
  'TestTube02',
  IconTestTube02StrokeRounded,
  IconTestTube02DuotoneRounded,
  IconTestTube02TwotoneRounded,
  IconTestTube02SolidRounded,
  IconTestTube02BulkRounded,
  IconTestTube02StrokeSharp,
  IconTestTube02SolidSharp,
];