...
export const IconShaka01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Shaka01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconShaka01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Shaka01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconShaka01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Shaka01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfShaka01: TheIconSelfPack = [
  'Shaka01',
  IconShaka01StrokeRounded,
  IconShaka01DuotoneRounded,
  IconShaka01TwotoneRounded,
  IconShaka01SolidRounded,
  IconShaka01BulkRounded,
  IconShaka01StrokeSharp,
  IconShaka01SolidSharp,
];