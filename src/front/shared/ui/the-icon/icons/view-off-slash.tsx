...
export const IconViewOffSlashStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ViewOffSlash StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconViewOffSlashDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ViewOffSlash DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconViewOffSlashTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ViewOffSlash TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconViewOffSlashSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ViewOffSlash SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconViewOffSlashBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ViewOffSlash BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconViewOffSlashStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ViewOffSlash StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s ss sw"
...
export const IconViewOffSlashSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ViewOffSlash SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfViewOffSlash: TheIconSelfPack = [
  'ViewOffSlash',
  IconViewOffSlashStrokeRounded,
  IconViewOffSlashDuotoneRounded,
  IconViewOffSlashTwotoneRounded,
  IconViewOffSlashSolidRounded,
  IconViewOffSlashBulkRounded,
  IconViewOffSlashStrokeSharp,
  IconViewOffSlashSolidSharp,
];