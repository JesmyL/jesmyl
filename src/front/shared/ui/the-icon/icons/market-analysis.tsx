...
export const IconMarketAnalysisStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MarketAnalysis StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMarketAnalysisDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MarketAnalysis DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconMarketAnalysisTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MarketAnalysis TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMarketAnalysisSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MarketAnalysis SolidRounded"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const IconMarketAnalysisBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MarketAnalysis BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d14}
...
export const IconMarketAnalysisStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MarketAnalysis StrokeSharp"
    >
      <path 
        d={d.d23}
        i-c="s ss sw"
...
export const IconMarketAnalysisSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MarketAnalysis SolidSharp"
    >
      <path 
        d={d.d26}
        i-c="f"
...
export const iconPackOfMarketAnalysis: TheIconSelfPack = [
  'MarketAnalysis',
  IconMarketAnalysisStrokeRounded,
  IconMarketAnalysisDuotoneRounded,
  IconMarketAnalysisTwotoneRounded,
  IconMarketAnalysisSolidRounded,
  IconMarketAnalysisBulkRounded,
  IconMarketAnalysisStrokeSharp,
  IconMarketAnalysisSolidSharp,
];