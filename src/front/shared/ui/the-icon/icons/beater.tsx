...
export const IconBeaterDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Beater DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconBeaterTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Beater TwotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="o7 s sj sr sw"
...
export const iconPackOfBeater: TheIconSelfPack = [
  'Beater',
  IconBeaterStrokeRounded,
  IconBeaterDuotoneRounded,
  IconBeaterTwotoneRounded,
  IconBeaterSolidRounded,
  IconBeaterBulkRounded,
  IconBeaterStrokeSharp,
  IconBeaterSolidSharp,
];