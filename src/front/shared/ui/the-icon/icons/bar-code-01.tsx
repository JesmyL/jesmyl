...
export const IconBarCode01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BarCode01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBarCode01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BarCode01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBarCode01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BarCode01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBarCode01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BarCode01 SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconBarCode01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BarCode01 BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconBarCode01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BarCode01 StrokeSharp"
    >
      <path 
        d={d.d17}
        i-c="s sj sw"
...
export const iconPackOfBarCode01: TheIconSelfPack = [
  'BarCode01',
  IconBarCode01StrokeRounded,
  IconBarCode01DuotoneRounded,
  IconBarCode01TwotoneRounded,
  IconBarCode01SolidRounded,
  IconBarCode01BulkRounded,
  IconBarCode01StrokeSharp,
  IconBarCode01SolidSharp,
];