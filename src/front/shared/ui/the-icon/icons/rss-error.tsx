...
export const IconRssErrorStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RssError StrokeRounded"
    >
      <circle 
        cx="17"
        cy="7"
...
export const IconRssErrorDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RssError DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconRssErrorTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RssError TwotoneRounded"
    >
      <circle 
        cx="17"
        cy="7"
...
export const IconRssErrorSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RssError SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const iconPackOfRssError: TheIconSelfPack = [
  'RssError',
  IconRssErrorStrokeRounded,
  IconRssErrorDuotoneRounded,
  IconRssErrorTwotoneRounded,
  IconRssErrorSolidRounded,
  IconRssErrorBulkRounded,
  IconRssErrorStrokeSharp,
  IconRssErrorSolidSharp,
];