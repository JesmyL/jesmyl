...
export const IconSingLeftStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SingLeft StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconSingLeftDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SingLeft DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="c f fr o7"
...
export const IconSingLeftTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SingLeft TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconSingLeftSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SingLeft SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const iconPackOfSingLeft: TheIconSelfPack = [
  'SingLeft',
  IconSingLeftStrokeRounded,
  IconSingLeftDuotoneRounded,
  IconSingLeftTwotoneRounded,
  IconSingLeftSolidRounded,
  IconSingLeftBulkRounded,
  IconSingLeftStrokeSharp,
  IconSingLeftSolidSharp,
];