...
export const IconPercentSquareStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PercentSquare StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconPercentSquareDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PercentSquare DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconPercentSquareTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PercentSquare TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconPercentSquareSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PercentSquare SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconPercentSquareBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PercentSquare BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconPercentSquareStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PercentSquare StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconPercentSquareSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PercentSquare SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfPercentSquare: TheIconSelfPack = [
  'PercentSquare',
  IconPercentSquareStrokeRounded,
  IconPercentSquareDuotoneRounded,
  IconPercentSquareTwotoneRounded,
  IconPercentSquareSolidRounded,
  IconPercentSquareBulkRounded,
  IconPercentSquareStrokeSharp,
  IconPercentSquareSolidSharp,
];