...
export const IconStrokeRightStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeRight StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconStrokeRightDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeRight DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconStrokeRightTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeRight TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconStrokeRightSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeRight SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconStrokeRightBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeRight BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconStrokeRightStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeRight StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s ss sw"
...
export const IconStrokeRightSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StrokeRight SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfStrokeRight: TheIconSelfPack = [
  'StrokeRight',
  IconStrokeRightStrokeRounded,
  IconStrokeRightDuotoneRounded,
  IconStrokeRightTwotoneRounded,
  IconStrokeRightSolidRounded,
  IconStrokeRightBulkRounded,
  IconStrokeRightStrokeSharp,
  IconStrokeRightSolidSharp,
];