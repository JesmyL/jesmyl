...
export const IconBookmark02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookmark02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBookmark02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookmark02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconBookmark02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookmark02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconBookmark02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookmark02 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconBookmark02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookmark02 BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconBookmark02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookmark02 StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sj sw"
...
export const IconBookmark02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bookmark02 SolidSharp"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const iconPackOfBookmark02: TheIconSelfPack = [
  'Bookmark02',
  IconBookmark02StrokeRounded,
  IconBookmark02DuotoneRounded,
  IconBookmark02TwotoneRounded,
  IconBookmark02SolidRounded,
  IconBookmark02BulkRounded,
  IconBookmark02StrokeSharp,
  IconBookmark02SolidSharp,
];