...
export const IconFolderDetailsReferenceStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderDetailsReference StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFolderDetailsReferenceDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderDetailsReference DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconFolderDetailsReferenceTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderDetailsReference TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFolderDetailsReferenceSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderDetailsReference SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconFolderDetailsReferenceBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderDetailsReference BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconFolderDetailsReferenceStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderDetailsReference StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sw"
...
export const IconFolderDetailsReferenceSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderDetailsReference SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const iconPackOfFolderDetailsReference: TheIconSelfPack = [
  ...
  IconFolderDetailsReferenceStrokeRounded,
  IconFolderDetailsReferenceDuotoneRounded,
  IconFolderDetailsReferenceTwotoneRounded,
  IconFolderDetailsReferenceSolidRounded,
  IconFolderDetailsReferenceBulkRounded,
  IconFolderDetailsReferenceStrokeSharp,
  IconFolderDetailsReferenceSolidSharp,
];