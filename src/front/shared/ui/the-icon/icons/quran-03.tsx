...
export const IconQuran03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Quran03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconQuran03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Quran03 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconQuran03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Quran03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfQuran03: TheIconSelfPack = [
  'Quran03',
  IconQuran03StrokeRounded,
  IconQuran03DuotoneRounded,
  IconQuran03TwotoneRounded,
  IconQuran03SolidRounded,
  IconQuran03BulkRounded,
  IconQuran03StrokeSharp,
  IconQuran03SolidSharp,
];