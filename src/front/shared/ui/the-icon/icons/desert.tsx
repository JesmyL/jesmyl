...
export const IconDesertDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Desert DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDesertTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Desert TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfDesert: TheIconSelfPack = [
  'Desert',
  IconDesertStrokeRounded,
  IconDesertDuotoneRounded,
  IconDesertTwotoneRounded,
  IconDesertSolidRounded,
  IconDesertBulkRounded,
  IconDesertStrokeSharp,
  IconDesertSolidSharp,
];