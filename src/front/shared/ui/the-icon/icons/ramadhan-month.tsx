...
export const IconRamadhanMonthStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RamadhanMonth StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRamadhanMonthDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RamadhanMonth DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconRamadhanMonthTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RamadhanMonth TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRamadhanMonthSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RamadhanMonth SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconRamadhanMonthBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RamadhanMonth BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr o7"
...
export const IconRamadhanMonthStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RamadhanMonth StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const IconRamadhanMonthSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RamadhanMonth SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const iconPackOfRamadhanMonth: TheIconSelfPack = [
  'RamadhanMonth',
  IconRamadhanMonthStrokeRounded,
  IconRamadhanMonthDuotoneRounded,
  IconRamadhanMonthTwotoneRounded,
  IconRamadhanMonthSolidRounded,
  IconRamadhanMonthBulkRounded,
  IconRamadhanMonthStrokeSharp,
  IconRamadhanMonthSolidSharp,
];