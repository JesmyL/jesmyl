...
export const IconFileDownloadStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileDownload StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFileDownloadDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileDownload DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFileDownloadTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileDownload TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFileDownloadSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileDownload SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconFileDownloadBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileDownload BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconFileDownloadStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileDownload StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const IconFileDownloadSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileDownload SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfFileDownload: TheIconSelfPack = [
  'FileDownload',
  IconFileDownloadStrokeRounded,
  IconFileDownloadDuotoneRounded,
  IconFileDownloadTwotoneRounded,
  IconFileDownloadSolidRounded,
  IconFileDownloadBulkRounded,
  IconFileDownloadStrokeSharp,
  IconFileDownloadSolidSharp,
];