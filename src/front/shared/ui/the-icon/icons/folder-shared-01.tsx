...
export const IconFolderShared01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderShared01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFolderShared01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderShared01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconFolderShared01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderShared01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFolderShared01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderShared01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconFolderShared01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderShared01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconFolderShared01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderShared01 StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sw"
...
export const IconFolderShared01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderShared01 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const iconPackOfFolderShared01: TheIconSelfPack = [
  'FolderShared01',
  IconFolderShared01StrokeRounded,
  IconFolderShared01DuotoneRounded,
  IconFolderShared01TwotoneRounded,
  IconFolderShared01SolidRounded,
  IconFolderShared01BulkRounded,
  IconFolderShared01StrokeSharp,
  IconFolderShared01SolidSharp,
];