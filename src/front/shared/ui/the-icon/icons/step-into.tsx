...
export const IconStepIntoStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StepInto StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconStepIntoDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StepInto DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="o7 s sj sr sw"
...
export const IconStepIntoTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StepInto TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconStepIntoSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StepInto SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const iconPackOfStepInto: TheIconSelfPack = [
  'StepInto',
  IconStepIntoStrokeRounded,
  IconStepIntoDuotoneRounded,
  IconStepIntoTwotoneRounded,
  IconStepIntoSolidRounded,
  IconStepIntoBulkRounded,
  IconStepIntoStrokeSharp,
  IconStepIntoSolidSharp,
];