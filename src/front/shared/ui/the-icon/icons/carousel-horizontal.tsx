...
export const IconCarouselHorizontalStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CarouselHorizontal StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCarouselHorizontalDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CarouselHorizontal DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconCarouselHorizontalTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CarouselHorizontal TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCarouselHorizontalSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CarouselHorizontal SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconCarouselHorizontalBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CarouselHorizontal BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconCarouselHorizontalStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CarouselHorizontal StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sr sw"
...
export const IconCarouselHorizontalSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CarouselHorizontal SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfCarouselHorizontal: TheIconSelfPack = [
  'CarouselHorizontal',
  IconCarouselHorizontalStrokeRounded,
  IconCarouselHorizontalDuotoneRounded,
  IconCarouselHorizontalTwotoneRounded,
  IconCarouselHorizontalSolidRounded,
  IconCarouselHorizontalBulkRounded,
  IconCarouselHorizontalStrokeSharp,
  IconCarouselHorizontalSolidSharp,
];