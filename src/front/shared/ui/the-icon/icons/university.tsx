...
export const IconUniversityStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="University StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUniversityDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="University DuotoneRounded"
    >
      <path 
        d={d.d10}
        i-c="f o7"
...
export const IconUniversityTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="University TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUniversitySolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="University SolidRounded"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const IconUniversityBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="University BulkRounded"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const IconUniversityStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="University StrokeSharp"
    >
      <path 
        d={d.d23}
        i-c="s sj sw"
...
export const IconUniversitySolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="University SolidSharp"
    >
      <path 
        d={d.d32}
        i-c="c f fr"
...
export const iconPackOfUniversity: TheIconSelfPack = [
  'University',
  IconUniversityStrokeRounded,
  IconUniversityDuotoneRounded,
  IconUniversityTwotoneRounded,
  IconUniversitySolidRounded,
  IconUniversityBulkRounded,
  IconUniversityStrokeSharp,
  IconUniversitySolidSharp,
];