...
export const IconDiscoverCircleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiscoverCircle StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconDiscoverCircleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiscoverCircle DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconDiscoverCircleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiscoverCircle TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconDiscoverCircleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiscoverCircle SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconDiscoverCircleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiscoverCircle BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconDiscoverCircleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiscoverCircle StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconDiscoverCircleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DiscoverCircle SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfDiscoverCircle: TheIconSelfPack = [
  'DiscoverCircle',
  IconDiscoverCircleStrokeRounded,
  IconDiscoverCircleDuotoneRounded,
  IconDiscoverCircleTwotoneRounded,
  IconDiscoverCircleSolidRounded,
  IconDiscoverCircleBulkRounded,
  IconDiscoverCircleStrokeSharp,
  IconDiscoverCircleSolidSharp,
];