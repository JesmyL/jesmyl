...
export const IconDocumentCodeStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DocumentCode StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDocumentCodeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DocumentCode DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconDocumentCodeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DocumentCode TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconDocumentCodeSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DocumentCode SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconDocumentCodeBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DocumentCode BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconDocumentCodeStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DocumentCode StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const IconDocumentCodeSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DocumentCode SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="f"
...
export const iconPackOfDocumentCode: TheIconSelfPack = [
  'DocumentCode',
  IconDocumentCodeStrokeRounded,
  IconDocumentCodeDuotoneRounded,
  IconDocumentCodeTwotoneRounded,
  IconDocumentCodeSolidRounded,
  IconDocumentCodeBulkRounded,
  IconDocumentCodeStrokeSharp,
  IconDocumentCodeSolidSharp,
];