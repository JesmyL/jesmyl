...
export const IconDrawingModeStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DrawingMode StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconDrawingModeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DrawingMode DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconDrawingModeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DrawingMode TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconDrawingModeSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DrawingMode SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconDrawingModeBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DrawingMode BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconDrawingModeStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DrawingMode StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconDrawingModeSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DrawingMode SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfDrawingMode: TheIconSelfPack = [
  'DrawingMode',
  IconDrawingModeStrokeRounded,
  IconDrawingModeDuotoneRounded,
  IconDrawingModeTwotoneRounded,
  IconDrawingModeSolidRounded,
  IconDrawingModeBulkRounded,
  IconDrawingModeStrokeSharp,
  IconDrawingModeSolidSharp,
];