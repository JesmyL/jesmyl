...
export const IconArtboardStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Artboard StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconArtboardDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Artboard DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7 s sw"
...
export const IconArtboardTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Artboard TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconArtboardSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Artboard SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const iconPackOfArtboard: TheIconSelfPack = [
  'Artboard',
  IconArtboardStrokeRounded,
  IconArtboardDuotoneRounded,
  IconArtboardTwotoneRounded,
  IconArtboardSolidRounded,
  IconArtboardBulkRounded,
  IconArtboardStrokeSharp,
  IconArtboardSolidSharp,
];