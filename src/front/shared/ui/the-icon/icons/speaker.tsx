...
export const IconSpeakerStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Speaker StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSpeakerDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Speaker DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconSpeakerTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Speaker TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfSpeaker: TheIconSelfPack = [
  'Speaker',
  IconSpeakerStrokeRounded,
  IconSpeakerDuotoneRounded,
  IconSpeakerTwotoneRounded,
  IconSpeakerSolidRounded,
  IconSpeakerBulkRounded,
  IconSpeakerStrokeSharp,
  IconSpeakerSolidSharp,
];