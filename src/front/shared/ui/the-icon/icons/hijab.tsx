...
export const iconPackOfHijab: TheIconSelfPack = [
  'Hijab',
  IconHijabStrokeRounded,
  IconHijabDuotoneRounded,
  IconHijabTwotoneRounded,
  IconHijabSolidRounded,
  IconHijabBulkRounded,
  IconHijabStrokeSharp,
  IconHijabSolidSharp,
];