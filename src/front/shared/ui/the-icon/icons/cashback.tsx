...
export const IconCashbackStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cashback StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCashbackDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cashback DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconCashbackTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cashback TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCashbackSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cashback SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const iconPackOfCashback: TheIconSelfPack = [
  'Cashback',
  IconCashbackStrokeRounded,
  IconCashbackDuotoneRounded,
  IconCashbackTwotoneRounded,
  IconCashbackSolidRounded,
  IconCashbackBulkRounded,
  IconCashbackStrokeSharp,
  IconCashbackSolidSharp,
];