...
export const IconNotificationBlock03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationBlock03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconNotificationBlock03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationBlock03 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconNotificationBlock03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationBlock03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconNotificationBlock03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationBlock03 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconNotificationBlock03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationBlock03 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconNotificationBlock03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationBlock03 StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sr sw"
...
export const IconNotificationBlock03SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationBlock03 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfNotificationBlock03: TheIconSelfPack = [
  'NotificationBlock03',
  IconNotificationBlock03StrokeRounded,
  IconNotificationBlock03DuotoneRounded,
  IconNotificationBlock03TwotoneRounded,
  IconNotificationBlock03SolidRounded,
  IconNotificationBlock03BulkRounded,
  IconNotificationBlock03StrokeSharp,
  IconNotificationBlock03SolidSharp,
];