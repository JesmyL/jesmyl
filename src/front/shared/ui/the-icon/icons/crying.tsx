...
export const IconCryingDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Crying DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconCryingTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Crying TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfCrying: TheIconSelfPack = [
  'Crying',
  IconCryingStrokeRounded,
  IconCryingDuotoneRounded,
  IconCryingTwotoneRounded,
  IconCryingSolidRounded,
  IconCryingBulkRounded,
  IconCryingStrokeSharp,
  IconCryingSolidSharp,
];