...
export const IconShare04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Share04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShare04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Share04 DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="11.9999"
...
export const IconShare04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Share04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfShare04: TheIconSelfPack = [
  'Share04',
  IconShare04StrokeRounded,
  IconShare04DuotoneRounded,
  IconShare04TwotoneRounded,
  IconShare04SolidRounded,
  IconShare04BulkRounded,
  IconShare04StrokeSharp,
  IconShare04SolidSharp,
];