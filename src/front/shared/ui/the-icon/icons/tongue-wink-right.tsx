...
export const IconTongueWinkRightStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TongueWinkRight StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconTongueWinkRightDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TongueWinkRight DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconTongueWinkRightTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TongueWinkRight TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconTongueWinkRightSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TongueWinkRight SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconTongueWinkRightBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TongueWinkRight BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconTongueWinkRightStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TongueWinkRight StrokeSharp"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconTongueWinkRightSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TongueWinkRight SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfTongueWinkRight: TheIconSelfPack = [
  'TongueWinkRight',
  IconTongueWinkRightStrokeRounded,
  IconTongueWinkRightDuotoneRounded,
  IconTongueWinkRightTwotoneRounded,
  IconTongueWinkRightSolidRounded,
  IconTongueWinkRightBulkRounded,
  IconTongueWinkRightStrokeSharp,
  IconTongueWinkRightSolidSharp,
];