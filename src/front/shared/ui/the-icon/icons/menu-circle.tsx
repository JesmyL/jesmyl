...
export const IconMenuCircleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MenuCircle StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMenuCircleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MenuCircle DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconMenuCircleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MenuCircle TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMenuCircleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MenuCircle SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconMenuCircleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MenuCircle BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconMenuCircleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MenuCircle StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMenuCircleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MenuCircle SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfMenuCircle: TheIconSelfPack = [
  'MenuCircle',
  IconMenuCircleStrokeRounded,
  IconMenuCircleDuotoneRounded,
  IconMenuCircleTwotoneRounded,
  IconMenuCircleSolidRounded,
  IconMenuCircleBulkRounded,
  IconMenuCircleStrokeSharp,
  IconMenuCircleSolidSharp,
];