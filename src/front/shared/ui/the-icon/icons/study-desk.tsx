...
export const IconStudyDeskStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StudyDesk StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconStudyDeskDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StudyDesk DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconStudyDeskTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StudyDesk TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconStudyDeskSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StudyDesk SolidRounded"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const IconStudyDeskBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StudyDesk BulkRounded"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const IconStudyDeskStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StudyDesk StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfStudyDesk: TheIconSelfPack = [
  'StudyDesk',
  IconStudyDeskStrokeRounded,
  IconStudyDeskDuotoneRounded,
  IconStudyDeskTwotoneRounded,
  IconStudyDeskSolidRounded,
  IconStudyDeskBulkRounded,
  IconStudyDeskStrokeSharp,
  IconStudyDeskSolidSharp,
];