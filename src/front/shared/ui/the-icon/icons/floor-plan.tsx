...
export const IconFloorPlanStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FloorPlan StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFloorPlanDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FloorPlan DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconFloorPlanTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FloorPlan TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFloorPlanSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FloorPlan SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconFloorPlanBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FloorPlan BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconFloorPlanStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FloorPlan StrokeSharp"
    >
      <path 
        d={d.d14}
        i-c="s sw"
...
export const iconPackOfFloorPlan: TheIconSelfPack = [
  'FloorPlan',
  IconFloorPlanStrokeRounded,
  IconFloorPlanDuotoneRounded,
  IconFloorPlanTwotoneRounded,
  IconFloorPlanSolidRounded,
  IconFloorPlanBulkRounded,
  IconFloorPlanStrokeSharp,
  IconFloorPlanSolidSharp,
];