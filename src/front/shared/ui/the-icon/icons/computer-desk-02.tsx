...
export const IconComputerDesk02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerDesk02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconComputerDesk02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerDesk02 DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconComputerDesk02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerDesk02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconComputerDesk02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerDesk02 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconComputerDesk02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerDesk02 BulkRounded"
    >
      <path 
        d={d.d12}
        i-c="f o7"
...
export const IconComputerDesk02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerDesk02 StrokeSharp"
    >
      <path 
        d={d.d15}
        i-c="s sr sw"
...
export const IconComputerDesk02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerDesk02 SolidSharp"
    >
      <path 
        d={d.d19}
        i-c="c f fr"
...
export const iconPackOfComputerDesk02: TheIconSelfPack = [
  'ComputerDesk02',
  IconComputerDesk02StrokeRounded,
  IconComputerDesk02DuotoneRounded,
  IconComputerDesk02TwotoneRounded,
  IconComputerDesk02SolidRounded,
  IconComputerDesk02BulkRounded,
  IconComputerDesk02StrokeSharp,
  IconComputerDesk02SolidSharp,
];