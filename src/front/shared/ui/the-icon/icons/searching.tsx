...
export const IconSearchingStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Searching StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSearchingDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Searching DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSearchingTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Searching TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconSearchingSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Searching SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconSearchingBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Searching BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconSearchingStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Searching StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const iconPackOfSearching: TheIconSelfPack = [
  'Searching',
  IconSearchingStrokeRounded,
  IconSearchingDuotoneRounded,
  IconSearchingTwotoneRounded,
  IconSearchingSolidRounded,
  IconSearchingBulkRounded,
  IconSearchingStrokeSharp,
  IconSearchingSolidSharp,
];