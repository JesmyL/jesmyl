...
export const IconLinkForwardStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LinkForward StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLinkForwardDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LinkForward DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconLinkForwardTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LinkForward TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconLinkForwardSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LinkForward SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconLinkForwardBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LinkForward BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconLinkForwardStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LinkForward StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const IconLinkForwardSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LinkForward SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const iconPackOfLinkForward: TheIconSelfPack = [
  ...
  IconLinkForwardDuotoneRounded,
  IconLinkForwardTwotoneRounded,
  IconLinkForwardSolidRounded,
  IconLinkForwardBulkRounded,
  IconLinkForwardStrokeSharp,
  IconLinkForwardSolidSharp,
];