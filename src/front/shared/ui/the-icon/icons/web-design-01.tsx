...
export const IconWebDesign01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WebDesign01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWebDesign01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WebDesign01 DuotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconWebDesign01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WebDesign01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWebDesign01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WebDesign01 SolidRounded"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const IconWebDesign01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WebDesign01 BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d13}
...
export const IconWebDesign01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WebDesign01 StrokeSharp"
    >
      <path 
        d={d.d18}
        i-c="s sj sw"
...
export const IconWebDesign01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WebDesign01 SolidSharp"
    >
      <path 
        d={d.d23}
        i-c="c f fr"
...
export const iconPackOfWebDesign01: TheIconSelfPack = [
  'WebDesign01',
  IconWebDesign01StrokeRounded,
  IconWebDesign01DuotoneRounded,
  IconWebDesign01TwotoneRounded,
  IconWebDesign01SolidRounded,
  IconWebDesign01BulkRounded,
  IconWebDesign01StrokeSharp,
  IconWebDesign01SolidSharp,
];