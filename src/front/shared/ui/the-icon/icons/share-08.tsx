...
export const IconShare08StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Share08 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconShare08DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Share08 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconShare08TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Share08 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfShare08: TheIconSelfPack = [
  'Share08',
  IconShare08StrokeRounded,
  IconShare08DuotoneRounded,
  IconShare08TwotoneRounded,
  IconShare08SolidRounded,
  IconShare08BulkRounded,
  IconShare08StrokeSharp,
  IconShare08SolidSharp,
];