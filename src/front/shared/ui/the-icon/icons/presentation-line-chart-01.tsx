...
export const IconPresentationLineChart01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PresentationLineChart01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPresentationLineChart01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PresentationLineChart01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconPresentationLineChart01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PresentationLineChart01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPresentationLineChart01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PresentationLineChart01 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconPresentationLineChart01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PresentationLineChart01 BulkRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr o7"
...
export const IconPresentationLineChart01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PresentationLineChart01 StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sj sw"
...
export const IconPresentationLineChart01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PresentationLineChart01 SolidSharp"
    >
      <path 
        d={d.d16}
        i-c="f"
...
export const iconPackOfPresentationLineChart01: TheIconSelfPack = [
  ...
  IconPresentationLineChart01StrokeRounded,
  IconPresentationLineChart01DuotoneRounded,
  IconPresentationLineChart01TwotoneRounded,
  IconPresentationLineChart01SolidRounded,
  IconPresentationLineChart01BulkRounded,
  IconPresentationLineChart01StrokeSharp,
  IconPresentationLineChart01SolidSharp,
];