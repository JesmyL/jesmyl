...
export const iconPackOfNews: TheIconSelfPack = [
  'News',
  IconNewsStrokeRounded,
  IconNewsDuotoneRounded,
  IconNewsTwotoneRounded,
  IconNewsSolidRounded,
  IconNewsBulkRounded,
  IconNewsStrokeSharp,
  IconNewsSolidSharp,
];