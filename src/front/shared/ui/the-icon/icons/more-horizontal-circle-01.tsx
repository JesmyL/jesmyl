...
export const IconMoreHorizontalCircle01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreHorizontalCircle01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMoreHorizontalCircle01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreHorizontalCircle01 DuotoneRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d1}
...
export const IconMoreHorizontalCircle01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreHorizontalCircle01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMoreHorizontalCircle01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreHorizontalCircle01 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconMoreHorizontalCircle01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreHorizontalCircle01 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconMoreHorizontalCircle01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreHorizontalCircle01 StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const IconMoreHorizontalCircle01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoreHorizontalCircle01 SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfMoreHorizontalCircle01: TheIconSelfPack = [
  ...
  IconMoreHorizontalCircle01StrokeRounded,
  IconMoreHorizontalCircle01DuotoneRounded,
  IconMoreHorizontalCircle01TwotoneRounded,
  IconMoreHorizontalCircle01SolidRounded,
  IconMoreHorizontalCircle01BulkRounded,
  IconMoreHorizontalCircle01StrokeSharp,
  IconMoreHorizontalCircle01SolidSharp,
];