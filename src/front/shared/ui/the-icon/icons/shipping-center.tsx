...
export const IconShippingCenterStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShippingCenter StrokeRounded"
    >
      <rect 
        x="2"
        y="15"
...
export const IconShippingCenterDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShippingCenter DuotoneRounded"
    >
      <rect 
        x="2"
        y="15"
...
export const IconShippingCenterTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShippingCenter TwotoneRounded"
    >
      <rect 
        x="2"
        y="15"
...
export const IconShippingCenterSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShippingCenter SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconShippingCenterBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShippingCenter BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconShippingCenterStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShippingCenter StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const IconShippingCenterSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShippingCenter SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfShippingCenter: TheIconSelfPack = [
  'ShippingCenter',
  IconShippingCenterStrokeRounded,
  IconShippingCenterDuotoneRounded,
  IconShippingCenterTwotoneRounded,
  IconShippingCenterSolidRounded,
  IconShippingCenterBulkRounded,
  IconShippingCenterStrokeSharp,
  IconShippingCenterSolidSharp,
];