...
export const iconPackOfQuora: TheIconSelfPack = [
  'Quora',
  IconQuoraStrokeRounded,
  IconQuoraDuotoneRounded,
  IconQuoraTwotoneRounded,
  IconQuoraSolidRounded,
  IconQuoraBulkRounded,
  IconQuoraStrokeSharp,
  IconQuoraSolidSharp,
];