...
export const IconRoadWaysideStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RoadWayside StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconRoadWaysideDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RoadWayside DuotoneRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr o7"
...
export const IconRoadWaysideTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RoadWayside TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconRoadWaysideSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RoadWayside SolidRounded"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const IconRoadWaysideBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RoadWayside BulkRounded"
    >
      <path 
        d={d.d12}
        i-c="f o7"
...
export const IconRoadWaysideStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RoadWayside StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconRoadWaysideSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RoadWayside SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="f"
...
export const iconPackOfRoadWayside: TheIconSelfPack = [
  'RoadWayside',
  IconRoadWaysideStrokeRounded,
  IconRoadWaysideDuotoneRounded,
  IconRoadWaysideTwotoneRounded,
  IconRoadWaysideSolidRounded,
  IconRoadWaysideBulkRounded,
  IconRoadWaysideStrokeSharp,
  IconRoadWaysideSolidSharp,
];