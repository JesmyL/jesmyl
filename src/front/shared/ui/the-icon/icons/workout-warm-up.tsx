...
export const IconWorkoutWarmUpStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkoutWarmUp StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWorkoutWarmUpDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkoutWarmUp DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWorkoutWarmUpTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkoutWarmUp TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconWorkoutWarmUpSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkoutWarmUp SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconWorkoutWarmUpBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkoutWarmUp BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconWorkoutWarmUpStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkoutWarmUp StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconWorkoutWarmUpSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkoutWarmUp SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfWorkoutWarmUp: TheIconSelfPack = [
  'WorkoutWarmUp',
  IconWorkoutWarmUpStrokeRounded,
  IconWorkoutWarmUpDuotoneRounded,
  IconWorkoutWarmUpTwotoneRounded,
  IconWorkoutWarmUpSolidRounded,
  IconWorkoutWarmUpBulkRounded,
  IconWorkoutWarmUpStrokeSharp,
  IconWorkoutWarmUpSolidSharp,
];