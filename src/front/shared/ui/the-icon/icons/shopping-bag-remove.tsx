...
export const IconShoppingBagRemoveStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBagRemove StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconShoppingBagRemoveDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBagRemove DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconShoppingBagRemoveTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBagRemove TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconShoppingBagRemoveSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBagRemove SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconShoppingBagRemoveBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBagRemove BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconShoppingBagRemoveStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBagRemove StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sw"
...
export const IconShoppingBagRemoveSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBagRemove SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfShoppingBagRemove: TheIconSelfPack = [
  'ShoppingBagRemove',
  IconShoppingBagRemoveStrokeRounded,
  IconShoppingBagRemoveDuotoneRounded,
  IconShoppingBagRemoveTwotoneRounded,
  IconShoppingBagRemoveSolidRounded,
  IconShoppingBagRemoveBulkRounded,
  IconShoppingBagRemoveStrokeSharp,
  IconShoppingBagRemoveSolidSharp,
];