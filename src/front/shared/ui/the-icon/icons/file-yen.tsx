...
export const IconFileYenStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileYen StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFileYenDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileYen DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconFileYenTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileYen TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfFileYen: TheIconSelfPack = [
  'FileYen',
  IconFileYenStrokeRounded,
  IconFileYenDuotoneRounded,
  IconFileYenTwotoneRounded,
  IconFileYenSolidRounded,
  IconFileYenBulkRounded,
  IconFileYenStrokeSharp,
  IconFileYenSolidSharp,
];