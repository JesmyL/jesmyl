...
export const iconPackOfWhisk: TheIconSelfPack = [
  'Whisk',
  IconWhiskStrokeRounded,
  IconWhiskDuotoneRounded,
  IconWhiskTwotoneRounded,
  IconWhiskSolidRounded,
  IconWhiskBulkRounded,
  IconWhiskStrokeSharp,
  IconWhiskSolidSharp,
];