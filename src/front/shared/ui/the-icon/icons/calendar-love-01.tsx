...
export const IconCalendarLove01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarLove01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconCalendarLove01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarLove01 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconCalendarLove01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarLove01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconCalendarLove01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarLove01 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconCalendarLove01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarLove01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconCalendarLove01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarLove01 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sr sw"
...
export const IconCalendarLove01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarLove01 SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="f"
...
export const iconPackOfCalendarLove01: TheIconSelfPack = [
  'CalendarLove01',
  IconCalendarLove01StrokeRounded,
  IconCalendarLove01DuotoneRounded,
  IconCalendarLove01TwotoneRounded,
  IconCalendarLove01SolidRounded,
  IconCalendarLove01BulkRounded,
  IconCalendarLove01StrokeSharp,
  IconCalendarLove01SolidSharp,
];