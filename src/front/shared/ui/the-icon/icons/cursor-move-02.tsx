...
export const IconCursorMove02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorMove02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconCursorMove02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorMove02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconCursorMove02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorMove02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconCursorMove02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorMove02 SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const IconCursorMove02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorMove02 BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconCursorMove02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorMove02 StrokeSharp"
    >
      <path 
        d={d.d14}
        i-c="s sj sw"
...
export const IconCursorMove02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorMove02 SolidSharp"
    >
      <path 
        d={d.d16}
        i-c="f"
...
export const iconPackOfCursorMove02: TheIconSelfPack = [
  'CursorMove02',
  IconCursorMove02StrokeRounded,
  IconCursorMove02DuotoneRounded,
  IconCursorMove02TwotoneRounded,
  IconCursorMove02SolidRounded,
  IconCursorMove02BulkRounded,
  IconCursorMove02StrokeSharp,
  IconCursorMove02SolidSharp,
];