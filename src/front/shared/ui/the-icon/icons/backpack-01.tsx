...
export const IconBackpack01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Backpack01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconBackpack01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Backpack01 DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconBackpack01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Backpack01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconBackpack01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Backpack01 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconBackpack01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Backpack01 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconBackpack01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Backpack01 StrokeSharp"
    >
      <path 
        d={d.d15}
        i-c="s sw"
...
export const IconBackpack01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Backpack01 SolidSharp"
    >
      <path 
        d={d.d20}
        i-c="c f fr"
...
export const iconPackOfBackpack01: TheIconSelfPack = [
  'Backpack01',
  IconBackpack01StrokeRounded,
  IconBackpack01DuotoneRounded,
  IconBackpack01TwotoneRounded,
  IconBackpack01SolidRounded,
  IconBackpack01BulkRounded,
  IconBackpack01StrokeSharp,
  IconBackpack01SolidSharp,
];