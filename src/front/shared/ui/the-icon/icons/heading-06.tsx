...
export const IconHeading06StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Heading06 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHeading06DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Heading06 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHeading06TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Heading06 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHeading06SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Heading06 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconHeading06BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Heading06 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconHeading06StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Heading06 StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const iconPackOfHeading06: TheIconSelfPack = [
  'Heading06',
  IconHeading06StrokeRounded,
  IconHeading06DuotoneRounded,
  IconHeading06TwotoneRounded,
  IconHeading06SolidRounded,
  IconHeading06BulkRounded,
  IconHeading06StrokeSharp,
  IconHeading06SolidSharp,
];