...
export const IconComputerVideoStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerVideo StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconComputerVideoDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerVideo DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconComputerVideoTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerVideo TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconComputerVideoSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerVideo SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconComputerVideoBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerVideo BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr o7"
...
export const IconComputerVideoStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerVideo StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sw"
...
export const IconComputerVideoSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ComputerVideo SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="f"
...
export const iconPackOfComputerVideo: TheIconSelfPack = [
  'ComputerVideo',
  IconComputerVideoStrokeRounded,
  IconComputerVideoDuotoneRounded,
  IconComputerVideoTwotoneRounded,
  IconComputerVideoSolidRounded,
  IconComputerVideoBulkRounded,
  IconComputerVideoStrokeSharp,
  IconComputerVideoSolidSharp,
];