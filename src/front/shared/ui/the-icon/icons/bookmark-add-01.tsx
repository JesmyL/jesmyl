...
export const IconBookmarkAdd01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkAdd01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBookmarkAdd01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkAdd01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconBookmarkAdd01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkAdd01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBookmarkAdd01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkAdd01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconBookmarkAdd01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkAdd01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconBookmarkAdd01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkAdd01 StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconBookmarkAdd01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkAdd01 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfBookmarkAdd01: TheIconSelfPack = [
  'BookmarkAdd01',
  IconBookmarkAdd01StrokeRounded,
  IconBookmarkAdd01DuotoneRounded,
  IconBookmarkAdd01TwotoneRounded,
  IconBookmarkAdd01SolidRounded,
  IconBookmarkAdd01BulkRounded,
  IconBookmarkAdd01StrokeSharp,
  IconBookmarkAdd01SolidSharp,
];