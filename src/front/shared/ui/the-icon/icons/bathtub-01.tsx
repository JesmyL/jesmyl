...
export const IconBathtub01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bathtub01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconBathtub01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bathtub01 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconBathtub01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bathtub01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconBathtub01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bathtub01 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconBathtub01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bathtub01 BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconBathtub01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Bathtub01 StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sw"
...
export const iconPackOfBathtub01: TheIconSelfPack = [
  'Bathtub01',
  IconBathtub01StrokeRounded,
  IconBathtub01DuotoneRounded,
  IconBathtub01TwotoneRounded,
  IconBathtub01SolidRounded,
  IconBathtub01BulkRounded,
  IconBathtub01StrokeSharp,
  IconBathtub01SolidSharp,
];