...
export const IconArrowLeftRightStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowLeftRight StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconArrowLeftRightDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowLeftRight DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="o7 s sj sr sw"
...
export const IconArrowLeftRightTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowLeftRight TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconArrowLeftRightSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowLeftRight SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconArrowLeftRightBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowLeftRight BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconArrowLeftRightStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowLeftRight StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sw"
...
export const IconArrowLeftRightSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowLeftRight SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfArrowLeftRight: TheIconSelfPack = [
  'ArrowLeftRight',
  IconArrowLeftRightStrokeRounded,
  IconArrowLeftRightDuotoneRounded,
  IconArrowLeftRightTwotoneRounded,
  IconArrowLeftRightSolidRounded,
  IconArrowLeftRightBulkRounded,
  IconArrowLeftRightStrokeSharp,
  IconArrowLeftRightSolidSharp,
];