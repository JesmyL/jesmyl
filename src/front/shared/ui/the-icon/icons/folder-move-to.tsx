...
export const IconFolderMoveToStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderMoveTo StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFolderMoveToDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderMoveTo DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconFolderMoveToTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderMoveTo TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFolderMoveToSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderMoveTo SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconFolderMoveToBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderMoveTo BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconFolderMoveToStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderMoveTo StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const IconFolderMoveToSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderMoveTo SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const iconPackOfFolderMoveTo: TheIconSelfPack = [
  'FolderMoveTo',
  IconFolderMoveToStrokeRounded,
  IconFolderMoveToDuotoneRounded,
  IconFolderMoveToTwotoneRounded,
  IconFolderMoveToSolidRounded,
  IconFolderMoveToBulkRounded,
  IconFolderMoveToStrokeSharp,
  IconFolderMoveToSolidSharp,
];