...
export const IconFirstAidKitStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FirstAidKit StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFirstAidKitDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FirstAidKit DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconFirstAidKitTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FirstAidKit TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFirstAidKitSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FirstAidKit SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconFirstAidKitBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FirstAidKit BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconFirstAidKitStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FirstAidKit StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconFirstAidKitSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FirstAidKit SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfFirstAidKit: TheIconSelfPack = [
  'FirstAidKit',
  IconFirstAidKitStrokeRounded,
  IconFirstAidKitDuotoneRounded,
  IconFirstAidKitTwotoneRounded,
  IconFirstAidKitSolidRounded,
  IconFirstAidKitBulkRounded,
  IconFirstAidKitStrokeSharp,
  IconFirstAidKitSolidSharp,
];