...
export const IconSpaceshipStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Spaceship StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSpaceshipDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Spaceship DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconSpaceshipTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Spaceship TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSpaceshipSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Spaceship SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconSpaceshipBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Spaceship BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconSpaceshipStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Spaceship StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sw"
...
export const iconPackOfSpaceship: TheIconSelfPack = [
  'Spaceship',
  IconSpaceshipStrokeRounded,
  IconSpaceshipDuotoneRounded,
  IconSpaceshipTwotoneRounded,
  IconSpaceshipSolidRounded,
  IconSpaceshipBulkRounded,
  IconSpaceshipStrokeSharp,
  IconSpaceshipSolidSharp,
];