...
export const IconConversationStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Conversation StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconConversationDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Conversation DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconConversationTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Conversation TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sw"
...
export const IconConversationSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Conversation SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconConversationBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Conversation BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconConversationStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Conversation StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sw"
...
export const IconConversationSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Conversation SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="f"
...
export const iconPackOfConversation: TheIconSelfPack = [
  'Conversation',
  IconConversationStrokeRounded,
  IconConversationDuotoneRounded,
  IconConversationTwotoneRounded,
  IconConversationSolidRounded,
  IconConversationBulkRounded,
  IconConversationStrokeSharp,
  IconConversationSolidSharp,
];