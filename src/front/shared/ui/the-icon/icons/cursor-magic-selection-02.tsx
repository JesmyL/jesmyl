...
export const IconCursorMagicSelection02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorMagicSelection02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCursorMagicSelection02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorMagicSelection02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCursorMagicSelection02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorMagicSelection02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconCursorMagicSelection02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorMagicSelection02 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconCursorMagicSelection02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorMagicSelection02 BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconCursorMagicSelection02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorMagicSelection02 StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sj sw"
...
export const IconCursorMagicSelection02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorMagicSelection02 SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfCursorMagicSelection02: TheIconSelfPack = [
  ...
  IconCursorMagicSelection02StrokeRounded,
  IconCursorMagicSelection02DuotoneRounded,
  IconCursorMagicSelection02TwotoneRounded,
  IconCursorMagicSelection02SolidRounded,
  IconCursorMagicSelection02BulkRounded,
  IconCursorMagicSelection02StrokeSharp,
  IconCursorMagicSelection02SolidSharp,
];