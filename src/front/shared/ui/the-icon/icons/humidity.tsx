...
export const IconHumidityStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Humidity StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconHumidityDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Humidity DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconHumidityTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Humidity TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconHumiditySolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Humidity SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const iconPackOfHumidity: TheIconSelfPack = [
  'Humidity',
  IconHumidityStrokeRounded,
  IconHumidityDuotoneRounded,
  IconHumidityTwotoneRounded,
  IconHumiditySolidRounded,
  IconHumidityBulkRounded,
  IconHumidityStrokeSharp,
  IconHumiditySolidSharp,
];