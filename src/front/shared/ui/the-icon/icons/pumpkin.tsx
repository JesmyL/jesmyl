...
export const IconPumpkinStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pumpkin StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconPumpkinDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pumpkin DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconPumpkinTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pumpkin TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfPumpkin: TheIconSelfPack = [
  'Pumpkin',
  IconPumpkinStrokeRounded,
  IconPumpkinDuotoneRounded,
  IconPumpkinTwotoneRounded,
  IconPumpkinSolidRounded,
  IconPumpkinBulkRounded,
  IconPumpkinStrokeSharp,
  IconPumpkinSolidSharp,
];