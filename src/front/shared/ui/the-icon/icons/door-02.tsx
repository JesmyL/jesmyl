...
export const IconDoor02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Door02 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconDoor02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Door02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfDoor02: TheIconSelfPack = [
  'Door02',
  IconDoor02StrokeRounded,
  IconDoor02DuotoneRounded,
  IconDoor02TwotoneRounded,
  IconDoor02SolidRounded,
  IconDoor02BulkRounded,
  IconDoor02StrokeSharp,
  IconDoor02SolidSharp,
];