...
export const IconAnalyticsUpStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AnalyticsUp StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAnalyticsUpDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AnalyticsUp DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconAnalyticsUpTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AnalyticsUp TwotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="s sr sw"
...
export const IconAnalyticsUpSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AnalyticsUp SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconAnalyticsUpBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AnalyticsUp BulkRounded"
    >
      <path 
        d={d.d10}
        i-c="f o7"
...
export const IconAnalyticsUpStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AnalyticsUp StrokeSharp"
    >
      <path 
        d={d.d4}
        i-c="s sj sw"
...
export const IconAnalyticsUpSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AnalyticsUp SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const iconPackOfAnalyticsUp: TheIconSelfPack = [
  'AnalyticsUp',
  IconAnalyticsUpStrokeRounded,
  IconAnalyticsUpDuotoneRounded,
  IconAnalyticsUpTwotoneRounded,
  IconAnalyticsUpSolidRounded,
  IconAnalyticsUpBulkRounded,
  IconAnalyticsUpStrokeSharp,
  IconAnalyticsUpSolidSharp,
];