...
export const IconFolderMinusStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderMinus StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFolderMinusDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderMinus DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconFolderMinusTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderMinus TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconFolderMinusSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderMinus SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconFolderMinusBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderMinus BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconFolderMinusStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderMinus StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const IconFolderMinusSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FolderMinus SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfFolderMinus: TheIconSelfPack = [
  'FolderMinus',
  IconFolderMinusStrokeRounded,
  IconFolderMinusDuotoneRounded,
  IconFolderMinusTwotoneRounded,
  IconFolderMinusSolidRounded,
  IconFolderMinusBulkRounded,
  IconFolderMinusStrokeSharp,
  IconFolderMinusSolidSharp,
];