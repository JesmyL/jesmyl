...
export const iconPackOfGame: TheIconSelfPack = [
  'Game',
  IconGameStrokeRounded,
  IconGameDuotoneRounded,
  IconGameTwotoneRounded,
  IconGameSolidRounded,
  IconGameBulkRounded,
  IconGameStrokeSharp,
  IconGameSolidSharp,
];