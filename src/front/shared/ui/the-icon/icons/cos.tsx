...
export const iconPackOfCos: TheIconSelfPack = [
  'Cos',
  IconCosStrokeRounded,
  IconCosDuotoneRounded,
  IconCosTwotoneRounded,
  IconCosSolidRounded,
  IconCosBulkRounded,
  IconCosStrokeSharp,
  IconCosSolidSharp,
