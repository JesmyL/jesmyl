...
export const iconPackOfHdd: TheIconSelfPack = [
  'Hdd',
  IconHddStrokeRounded,
  IconHddDuotoneRounded,
  IconHddTwotoneRounded,
  IconHddSolidRounded,
  IconHddBulkRounded,
  IconHddStrokeSharp,
  IconHddSolidSharp,
