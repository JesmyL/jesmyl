...
export const IconEdit02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Edit02 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconEdit02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Edit02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfEdit02: TheIconSelfPack = [
  ...
  IconEdit02DuotoneRounded,
  IconEdit02TwotoneRounded,
  IconEdit02SolidRounded,
  IconEdit02BulkRounded,
  IconEdit02StrokeSharp,
  IconEdit02SolidSharp,
];