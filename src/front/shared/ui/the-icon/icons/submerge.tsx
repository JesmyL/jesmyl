...
export const IconSubmergeStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Submerge StrokeRounded"
    >
      <circle 
        cx="12"
        cy="14"
...
export const IconSubmergeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Submerge DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconSubmergeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Submerge TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="14"
...
export const IconSubmergeSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Submerge SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfSubmerge: TheIconSelfPack = [
  'Submerge',
  IconSubmergeStrokeRounded,
  IconSubmergeDuotoneRounded,
  IconSubmergeTwotoneRounded,
  IconSubmergeSolidRounded,
  IconSubmergeBulkRounded,
  IconSubmergeStrokeSharp,
  IconSubmergeSolidSharp,
];