...
export const IconCreditCardChangeStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CreditCardChange StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCreditCardChangeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CreditCardChange DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconCreditCardChangeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CreditCardChange TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCreditCardChangeSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CreditCardChange SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconCreditCardChangeBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CreditCardChange BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconCreditCardChangeStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CreditCardChange StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconCreditCardChangeSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CreditCardChange SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfCreditCardChange: TheIconSelfPack = [
  'CreditCardChange',
  IconCreditCardChangeStrokeRounded,
  IconCreditCardChangeDuotoneRounded,
  IconCreditCardChangeTwotoneRounded,
  IconCreditCardChangeSolidRounded,
  IconCreditCardChangeBulkRounded,
  IconCreditCardChangeStrokeSharp,
  IconCreditCardChangeSolidSharp,
];