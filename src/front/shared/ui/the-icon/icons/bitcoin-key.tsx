...
export const IconBitcoinKeyStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinKey StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconBitcoinKeyDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinKey DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconBitcoinKeyTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinKey TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconBitcoinKeySolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinKey SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconBitcoinKeyBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinKey BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconBitcoinKeyStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinKey StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sr sw"
...
export const IconBitcoinKeySolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinKey SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfBitcoinKey: TheIconSelfPack = [
  'BitcoinKey',
  IconBitcoinKeyStrokeRounded,
  IconBitcoinKeyDuotoneRounded,
  IconBitcoinKeyTwotoneRounded,
  IconBitcoinKeySolidRounded,
  IconBitcoinKeyBulkRounded,
  IconBitcoinKeyStrokeSharp,
  IconBitcoinKeySolidSharp,
];