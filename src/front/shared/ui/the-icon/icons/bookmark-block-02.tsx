...
export const IconBookmarkBlock02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkBlock02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBookmarkBlock02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkBlock02 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconBookmarkBlock02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkBlock02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBookmarkBlock02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkBlock02 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconBookmarkBlock02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkBlock02 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconBookmarkBlock02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkBlock02 StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconBookmarkBlock02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkBlock02 SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfBookmarkBlock02: TheIconSelfPack = [
  'BookmarkBlock02',
  IconBookmarkBlock02StrokeRounded,
  IconBookmarkBlock02DuotoneRounded,
  IconBookmarkBlock02TwotoneRounded,
  IconBookmarkBlock02SolidRounded,
  IconBookmarkBlock02BulkRounded,
  IconBookmarkBlock02StrokeSharp,
  IconBookmarkBlock02SolidSharp,
];