...
export const IconSwipeDown04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeDown04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSwipeDown04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeDown04 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconSwipeDown04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeDown04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSwipeDown04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeDown04 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconSwipeDown04BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeDown04 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconSwipeDown04StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeDown04 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const IconSwipeDown04SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SwipeDown04 SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfSwipeDown04: TheIconSelfPack = [
  'SwipeDown04',
  IconSwipeDown04StrokeRounded,
  IconSwipeDown04DuotoneRounded,
  IconSwipeDown04TwotoneRounded,
  IconSwipeDown04SolidRounded,
  IconSwipeDown04BulkRounded,
  IconSwipeDown04StrokeSharp,
  IconSwipeDown04SolidSharp,
];