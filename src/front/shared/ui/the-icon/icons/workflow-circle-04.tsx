...
export const IconWorkflowCircle04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowCircle04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWorkflowCircle04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowCircle04 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconWorkflowCircle04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowCircle04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconWorkflowCircle04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowCircle04 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconWorkflowCircle04BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowCircle04 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconWorkflowCircle04StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowCircle04 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconWorkflowCircle04SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="WorkflowCircle04 SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const iconPackOfWorkflowCircle04: TheIconSelfPack = [
  'WorkflowCircle04',
  IconWorkflowCircle04StrokeRounded,
  IconWorkflowCircle04DuotoneRounded,
  IconWorkflowCircle04TwotoneRounded,
  IconWorkflowCircle04SolidRounded,
  IconWorkflowCircle04BulkRounded,
  IconWorkflowCircle04StrokeSharp,
  IconWorkflowCircle04SolidSharp,
];