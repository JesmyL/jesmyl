...
export const IconSword02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sword02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSword02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sword02 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="s sw"
...
export const IconSword02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sword02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfSword02: TheIconSelfPack = [
  'Sword02',
  IconSword02StrokeRounded,
  IconSword02DuotoneRounded,
  IconSword02TwotoneRounded,
  IconSword02SolidRounded,
  IconSword02BulkRounded,
  IconSword02StrokeSharp,
  IconSword02SolidSharp,
];