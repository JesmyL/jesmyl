...
export const IconCpuChargeStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CpuCharge StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCpuChargeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CpuCharge DuotoneRounded"
    >
      <path 
        d={d.d10}
        i-c="f o7"
...
export const IconCpuChargeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CpuCharge TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconCpuChargeSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CpuCharge SolidRounded"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const IconCpuChargeBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CpuCharge BulkRounded"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const IconCpuChargeStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CpuCharge StrokeSharp"
    >
      <path 
        d={d.d16}
        i-c="s sw"
...
export const iconPackOfCpuCharge: TheIconSelfPack = [
  'CpuCharge',
  IconCpuChargeStrokeRounded,
  IconCpuChargeDuotoneRounded,
  IconCpuChargeTwotoneRounded,
  IconCpuChargeSolidRounded,
  IconCpuChargeBulkRounded,
  IconCpuChargeStrokeSharp,
  IconCpuChargeSolidSharp,
];