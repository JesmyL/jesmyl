...
export const iconPackOfAngel: TheIconSelfPack = [
  'Angel',
  IconAngelStrokeRounded,
  IconAngelDuotoneRounded,
  IconAngelTwotoneRounded,
  IconAngelSolidRounded,
  IconAngelBulkRounded,
  IconAngelStrokeSharp,
  IconAngelSolidSharp,
];