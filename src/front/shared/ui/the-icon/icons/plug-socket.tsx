...
export const IconPlugSocketStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlugSocket StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPlugSocketDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlugSocket DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconPlugSocketTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlugSocket TwotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="o7 s sj sr sw"
...
export const IconPlugSocketSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlugSocket SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const IconPlugSocketBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlugSocket BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconPlugSocketStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlugSocket StrokeSharp"
    >
      <path 
        d={d.d2}
        i-c="s sj ss sw"
...
export const IconPlugSocketSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PlugSocket SolidSharp"
    >
      <path 
        d={d.d20}
        i-c="c f fr"
...
export const iconPackOfPlugSocket: TheIconSelfPack = [
  'PlugSocket',
  IconPlugSocketStrokeRounded,
  IconPlugSocketDuotoneRounded,
  IconPlugSocketTwotoneRounded,
  IconPlugSocketSolidRounded,
  IconPlugSocketBulkRounded,
  IconPlugSocketStrokeSharp,
  IconPlugSocketSolidSharp,
];