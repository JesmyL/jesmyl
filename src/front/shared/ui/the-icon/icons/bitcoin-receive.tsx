...
export const IconBitcoinReceiveStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinReceive StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconBitcoinReceiveDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinReceive DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconBitcoinReceiveTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinReceive TwotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="s sr sw"
...
export const IconBitcoinReceiveSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinReceive SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconBitcoinReceiveBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinReceive BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconBitcoinReceiveStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinReceive StrokeSharp"
    >
      <path 
        d={d.d16}
        i-c="s sj sw"
...
export const IconBitcoinReceiveSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinReceive SolidSharp"
    >
      <path 
        d={d.d18}
        i-c="c f fr"
...
export const iconPackOfBitcoinReceive: TheIconSelfPack = [
  'BitcoinReceive',
  IconBitcoinReceiveStrokeRounded,
  IconBitcoinReceiveDuotoneRounded,
  IconBitcoinReceiveTwotoneRounded,
  IconBitcoinReceiveSolidRounded,
  IconBitcoinReceiveBulkRounded,
  IconBitcoinReceiveStrokeSharp,
  IconBitcoinReceiveSolidSharp,
];