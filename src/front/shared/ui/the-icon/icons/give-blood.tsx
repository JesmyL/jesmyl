...
export const IconGiveBloodStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GiveBlood StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconGiveBloodDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GiveBlood DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconGiveBloodTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GiveBlood TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconGiveBloodSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GiveBlood SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconGiveBloodBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GiveBlood BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconGiveBloodStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GiveBlood StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const iconPackOfGiveBlood: TheIconSelfPack = [
  'GiveBlood',
  IconGiveBloodStrokeRounded,
  IconGiveBloodDuotoneRounded,
  IconGiveBloodTwotoneRounded,
  IconGiveBloodSolidRounded,
  IconGiveBloodBulkRounded,
  IconGiveBloodStrokeSharp,
  IconGiveBloodSolidSharp,
];