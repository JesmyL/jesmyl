...
export const IconPieChartStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PieChart StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconPieChartDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PieChart DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconPieChartTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PieChart TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconPieChartSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PieChart SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const iconPackOfPieChart: TheIconSelfPack = [
  'PieChart',
  IconPieChartStrokeRounded,
  IconPieChartDuotoneRounded,
  IconPieChartTwotoneRounded,
  IconPieChartSolidRounded,
  IconPieChartBulkRounded,
  IconPieChartStrokeSharp,
  IconPieChartSolidSharp,
];