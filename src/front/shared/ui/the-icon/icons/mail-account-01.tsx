...
export const IconMailAccount01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailAccount01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconMailAccount01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailAccount01 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconMailAccount01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailAccount01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconMailAccount01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailAccount01 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconMailAccount01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailAccount01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconMailAccount01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailAccount01 StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const IconMailAccount01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MailAccount01 SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const iconPackOfMailAccount01: TheIconSelfPack = [
  'MailAccount01',
  IconMailAccount01StrokeRounded,
  IconMailAccount01DuotoneRounded,
  IconMailAccount01TwotoneRounded,
  IconMailAccount01SolidRounded,
  IconMailAccount01BulkRounded,
  IconMailAccount01StrokeSharp,
  IconMailAccount01SolidSharp,
];