...
export const IconSegmentStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Segment StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSegmentDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Segment DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSegmentTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Segment TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfSegment: TheIconSelfPack = [
  'Segment',
  IconSegmentStrokeRounded,
  IconSegmentDuotoneRounded,
  IconSegmentTwotoneRounded,
  IconSegmentSolidRounded,
  IconSegmentBulkRounded,
  IconSegmentStrokeSharp,
  IconSegmentSolidSharp,
];