...
export const IconFerrisWheelStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FerrisWheel StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconFerrisWheelDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FerrisWheel DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconFerrisWheelTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FerrisWheel TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconFerrisWheelSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FerrisWheel SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconFerrisWheelBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FerrisWheel BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconFerrisWheelStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FerrisWheel StrokeSharp"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconFerrisWheelSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FerrisWheel SolidSharp"
    >
      <path 
        d={d.d16}
        i-c="c f fr"
...
export const iconPackOfFerrisWheel: TheIconSelfPack = [
  'FerrisWheel',
  IconFerrisWheelStrokeRounded,
  IconFerrisWheelDuotoneRounded,
  IconFerrisWheelTwotoneRounded,
  IconFerrisWheelSolidRounded,
  IconFerrisWheelBulkRounded,
  IconFerrisWheelStrokeSharp,
  IconFerrisWheelSolidSharp,
];