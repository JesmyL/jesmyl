...
export const IconRestaurantStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Restaurant StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRestaurantDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Restaurant DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconRestaurantTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Restaurant TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconRestaurantSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Restaurant SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconRestaurantBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Restaurant BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr o7"
...
export const IconRestaurantStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Restaurant StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s ss sw"
...
export const IconRestaurantSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Restaurant SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfRestaurant: TheIconSelfPack = [
  'Restaurant',
  IconRestaurantStrokeRounded,
  IconRestaurantDuotoneRounded,
  IconRestaurantTwotoneRounded,
  IconRestaurantSolidRounded,
  IconRestaurantBulkRounded,
  IconRestaurantStrokeSharp,
  IconRestaurantSolidSharp,
];