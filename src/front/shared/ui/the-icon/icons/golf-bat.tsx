...
export const IconGolfBatStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GolfBat StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGolfBatDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GolfBat DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconGolfBatTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GolfBat TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfGolfBat: TheIconSelfPack = [
  'GolfBat',
  IconGolfBatStrokeRounded,
  IconGolfBatDuotoneRounded,
  IconGolfBatTwotoneRounded,
  IconGolfBatSolidRounded,
  IconGolfBatBulkRounded,
  IconGolfBatStrokeSharp,
  IconGolfBatSolidSharp,
];