...
export const IconCursorAddSelection02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorAddSelection02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconCursorAddSelection02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorAddSelection02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconCursorAddSelection02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorAddSelection02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconCursorAddSelection02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorAddSelection02 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconCursorAddSelection02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorAddSelection02 BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconCursorAddSelection02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorAddSelection02 StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sj sw"
...
export const IconCursorAddSelection02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorAddSelection02 SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const iconPackOfCursorAddSelection02: TheIconSelfPack = [
  ...
  IconCursorAddSelection02StrokeRounded,
  IconCursorAddSelection02DuotoneRounded,
  IconCursorAddSelection02TwotoneRounded,
  IconCursorAddSelection02SolidRounded,
  IconCursorAddSelection02BulkRounded,
  IconCursorAddSelection02StrokeSharp,
  IconCursorAddSelection02SolidSharp,
];