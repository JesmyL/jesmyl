...
export const IconWardrobe02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wardrobe02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconWardrobe02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wardrobe02 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconWardrobe02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wardrobe02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconWardrobe02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wardrobe02 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconWardrobe02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wardrobe02 BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d9}
...
export const IconWardrobe02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wardrobe02 StrokeSharp"
    >
      <path 
        d={d.d15}
        i-c="s sj sw"
...
export const IconWardrobe02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Wardrobe02 SolidSharp"
    >
      <path 
        d={d.d20}
        i-c="c f fr"
...
export const iconPackOfWardrobe02: TheIconSelfPack = [
  'Wardrobe02',
  IconWardrobe02StrokeRounded,
  IconWardrobe02DuotoneRounded,
  IconWardrobe02TwotoneRounded,
  IconWardrobe02SolidRounded,
  IconWardrobe02BulkRounded,
  IconWardrobe02StrokeSharp,
  IconWardrobe02SolidSharp,
];