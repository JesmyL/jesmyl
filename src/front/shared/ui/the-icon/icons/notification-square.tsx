...
export const IconNotificationSquareStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationSquare StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconNotificationSquareDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationSquare DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconNotificationSquareTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationSquare TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconNotificationSquareSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationSquare SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconNotificationSquareBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationSquare BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconNotificationSquareStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationSquare StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sw"
...
export const IconNotificationSquareSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="NotificationSquare SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfNotificationSquare: TheIconSelfPack = [
  'NotificationSquare',
  IconNotificationSquareStrokeRounded,
  IconNotificationSquareDuotoneRounded,
  IconNotificationSquareTwotoneRounded,
  IconNotificationSquareSolidRounded,
  IconNotificationSquareBulkRounded,
  IconNotificationSquareStrokeSharp,
  IconNotificationSquareSolidSharp,
];