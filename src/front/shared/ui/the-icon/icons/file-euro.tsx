...
export const IconFileEuroStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileEuro StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFileEuroDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileEuro DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconFileEuroTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileEuro TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFileEuroSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileEuro SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const iconPackOfFileEuro: TheIconSelfPack = [
  'FileEuro',
  IconFileEuroStrokeRounded,
  IconFileEuroDuotoneRounded,
  IconFileEuroTwotoneRounded,
  IconFileEuroSolidRounded,
  IconFileEuroBulkRounded,
  IconFileEuroStrokeSharp,
  IconFileEuroSolidSharp,
];