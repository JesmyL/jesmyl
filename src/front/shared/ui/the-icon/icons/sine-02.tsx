...
export const IconSine02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sine02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconSine02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Sine02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfSine02: TheIconSelfPack = [
  'Sine02',
  IconSine02StrokeRounded,
  IconSine02DuotoneRounded,
  IconSine02TwotoneRounded,
  IconSine02SolidRounded,
  IconSine02BulkRounded,
  IconSine02StrokeSharp,
  IconSine02SolidSharp,
];