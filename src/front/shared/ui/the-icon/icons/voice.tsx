...
export const iconPackOfVoice: TheIconSelfPack = [
  'Voice',
  IconVoiceStrokeRounded,
  IconVoiceDuotoneRounded,
  IconVoiceTwotoneRounded,
  IconVoiceSolidRounded,
  IconVoiceBulkRounded,
  IconVoiceStrokeSharp,
  IconVoiceSolidSharp,
];