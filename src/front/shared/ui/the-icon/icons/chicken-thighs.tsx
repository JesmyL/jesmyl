...
export const IconChickenThighsStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChickenThighs StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconChickenThighsDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChickenThighs DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconChickenThighsTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChickenThighs TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sw"
...
export const IconChickenThighsSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChickenThighs SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconChickenThighsBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChickenThighs BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconChickenThighsStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChickenThighs StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconChickenThighsSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChickenThighs SolidSharp"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const iconPackOfChickenThighs: TheIconSelfPack = [
  'ChickenThighs',
  IconChickenThighsStrokeRounded,
  IconChickenThighsDuotoneRounded,
  IconChickenThighsTwotoneRounded,
  IconChickenThighsSolidRounded,
  IconChickenThighsBulkRounded,
  IconChickenThighsStrokeSharp,
  IconChickenThighsSolidSharp,
];