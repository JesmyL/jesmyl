...
export const IconFactoryStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Factory StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFactoryDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Factory DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconFactoryTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Factory TwotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="s sj sr sw"
...
export const iconPackOfFactory: TheIconSelfPack = [
  'Factory',
  IconFactoryStrokeRounded,
  IconFactoryDuotoneRounded,
  IconFactoryTwotoneRounded,
  IconFactorySolidRounded,
  IconFactoryBulkRounded,
  IconFactoryStrokeSharp,
  IconFactorySolidSharp,
];