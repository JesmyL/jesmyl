...
export const IconQuoteUpStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="QuoteUp StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconQuoteUpDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="QuoteUp DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconQuoteUpTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="QuoteUp TwotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="o7 s sr sw"
...
export const iconPackOfQuoteUp: TheIconSelfPack = [
  'QuoteUp',
  IconQuoteUpStrokeRounded,
  IconQuoteUpDuotoneRounded,
  IconQuoteUpTwotoneRounded,
  IconQuoteUpSolidRounded,
  IconQuoteUpBulkRounded,
  IconQuoteUpStrokeSharp,
  IconQuoteUpSolidSharp,
];