...
export const IconDownload05StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download05 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDownload05DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download05 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDownload05TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download05 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDownload05SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download05 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconDownload05BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download05 BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconDownload05StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download05 StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sw"
...
export const IconDownload05SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download05 SolidSharp"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const iconPackOfDownload05: TheIconSelfPack = [
  'Download05',
  IconDownload05StrokeRounded,
  IconDownload05DuotoneRounded,
  IconDownload05TwotoneRounded,
  IconDownload05SolidRounded,
  IconDownload05BulkRounded,
  IconDownload05StrokeSharp,
  IconDownload05SolidSharp,
];