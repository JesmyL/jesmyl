...
export const IconAiFolder01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiFolder01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconAiFolder01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiFolder01 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconAiFolder01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiFolder01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconAiFolder01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiFolder01 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconAiFolder01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiFolder01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconAiFolder01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiFolder01 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconAiFolder01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiFolder01 SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfAiFolder01: TheIconSelfPack = [
  'AiFolder01',
  IconAiFolder01StrokeRounded,
  IconAiFolder01DuotoneRounded,
  IconAiFolder01TwotoneRounded,
  IconAiFolder01SolidRounded,
  IconAiFolder01BulkRounded,
  IconAiFolder01StrokeSharp,
  IconAiFolder01SolidSharp,
];