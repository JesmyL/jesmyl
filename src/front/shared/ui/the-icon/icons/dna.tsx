...
export const iconPackOfDna: TheIconSelfPack = [
  'Dna',
  IconDnaStrokeRounded,
  IconDnaDuotoneRounded,
  IconDnaTwotoneRounded,
  IconDnaSolidRounded,
  IconDnaBulkRounded,
  IconDnaStrokeSharp,
  IconDnaSolidSharp,
