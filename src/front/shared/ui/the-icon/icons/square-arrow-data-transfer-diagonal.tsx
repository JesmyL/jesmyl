...
export const IconSquareArrowDataTransferDiagonalStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowDataTransferDiagonal StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSquareArrowDataTransferDiagonalDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowDataTransferDiagonal DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconSquareArrowDataTransferDiagonalTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowDataTransferDiagonal TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconSquareArrowDataTransferDiagonalSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowDataTransferDiagonal SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconSquareArrowDataTransferDiagonalBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowDataTransferDiagonal BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconSquareArrowDataTransferDiagonalStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowDataTransferDiagonal StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconSquareArrowDataTransferDiagonalSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowDataTransferDiagonal SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfSquareArrowDataTransferDiagonal: TheIconSelfPack = [
  ...
  IconSquareArrowDataTransferDiagonalStrokeRounded,
  IconSquareArrowDataTransferDiagonalDuotoneRounded,
  IconSquareArrowDataTransferDiagonalTwotoneRounded,
  IconSquareArrowDataTransferDiagonalSolidRounded,
  IconSquareArrowDataTransferDiagonalBulkRounded,
  IconSquareArrowDataTransferDiagonalStrokeSharp,
  IconSquareArrowDataTransferDiagonalSolidSharp,
];