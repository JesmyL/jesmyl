...
export const IconNote01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Note01 DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconNote01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Note01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfNote01: TheIconSelfPack = [
  'Note01',
  IconNote01StrokeRounded,
  IconNote01DuotoneRounded,
  IconNote01TwotoneRounded,
  IconNote01SolidRounded,
  IconNote01BulkRounded,
  IconNote01StrokeSharp,
  IconNote01SolidSharp,
];