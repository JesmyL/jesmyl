...
export const IconBitcoinSendStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinSend StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconBitcoinSendDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinSend DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconBitcoinSendTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinSend TwotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="s sr sw"
...
export const IconBitcoinSendSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinSend SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconBitcoinSendBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinSend BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconBitcoinSendStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinSend StrokeSharp"
    >
      <path 
        d={d.d15}
        i-c="s sj sw"
...
export const IconBitcoinSendSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinSend SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const iconPackOfBitcoinSend: TheIconSelfPack = [
  'BitcoinSend',
  IconBitcoinSendStrokeRounded,
  IconBitcoinSendDuotoneRounded,
  IconBitcoinSendTwotoneRounded,
  IconBitcoinSendSolidRounded,
  IconBitcoinSendBulkRounded,
  IconBitcoinSendStrokeSharp,
  IconBitcoinSendSolidSharp,
];