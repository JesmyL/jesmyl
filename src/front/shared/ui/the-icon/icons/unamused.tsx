...
export const IconUnamusedStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Unamused StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconUnamusedDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Unamused DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconUnamusedTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Unamused TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconUnamusedSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Unamused SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const iconPackOfUnamused: TheIconSelfPack = [
  'Unamused',
  IconUnamusedStrokeRounded,
  IconUnamusedDuotoneRounded,
  IconUnamusedTwotoneRounded,
  IconUnamusedSolidRounded,
  IconUnamusedBulkRounded,
  IconUnamusedStrokeSharp,
  IconUnamusedSolidSharp,
];