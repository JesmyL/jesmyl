...
export const IconFilterHorizontalStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterHorizontal StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFilterHorizontalDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterHorizontal DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconFilterHorizontalTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterHorizontal TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFilterHorizontalSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterHorizontal SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconFilterHorizontalBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterHorizontal BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconFilterHorizontalStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterHorizontal StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconFilterHorizontalSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FilterHorizontal SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfFilterHorizontal: TheIconSelfPack = [
  'FilterHorizontal',
  IconFilterHorizontalStrokeRounded,
  IconFilterHorizontalDuotoneRounded,
  IconFilterHorizontalTwotoneRounded,
  IconFilterHorizontalSolidRounded,
  IconFilterHorizontalBulkRounded,
  IconFilterHorizontalStrokeSharp,
  IconFilterHorizontalSolidSharp,
];