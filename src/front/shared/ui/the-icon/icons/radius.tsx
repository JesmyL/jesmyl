...
export const IconRadiusDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Radius DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconRadiusTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Radius TwotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="s sw"
...
export const iconPackOfRadius: TheIconSelfPack = [
  'Radius',
  IconRadiusStrokeRounded,
  IconRadiusDuotoneRounded,
  IconRadiusTwotoneRounded,
  IconRadiusSolidRounded,
  IconRadiusBulkRounded,
  IconRadiusStrokeSharp,
  IconRadiusSolidSharp,
];