...
export const IconUserEdit01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserEdit01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserEdit01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserEdit01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserEdit01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserEdit01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUserEdit01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserEdit01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconUserEdit01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserEdit01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconUserEdit01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserEdit01 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sw"
...
export const IconUserEdit01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserEdit01 SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="f"
...
export const iconPackOfUserEdit01: TheIconSelfPack = [
  'UserEdit01',
  IconUserEdit01StrokeRounded,
  IconUserEdit01DuotoneRounded,
  IconUserEdit01TwotoneRounded,
  IconUserEdit01SolidRounded,
  IconUserEdit01BulkRounded,
  IconUserEdit01StrokeSharp,
  IconUserEdit01SolidSharp,
];