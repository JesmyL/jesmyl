...
export const IconInsertPiStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InsertPi StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconInsertPiDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InsertPi DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconInsertPiTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InsertPi TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconInsertPiSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InsertPi SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const iconPackOfInsertPi: TheIconSelfPack = [
  'InsertPi',
  IconInsertPiStrokeRounded,
  IconInsertPiDuotoneRounded,
  IconInsertPiTwotoneRounded,
  IconInsertPiSolidRounded,
  IconInsertPiBulkRounded,
  IconInsertPiStrokeSharp,
  IconInsertPiSolidSharp,
];