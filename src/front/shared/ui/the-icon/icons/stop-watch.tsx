...
export const IconStopWatchStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StopWatch StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconStopWatchDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StopWatch DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="13"
...
export const IconStopWatchTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StopWatch TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconStopWatchSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StopWatch SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconStopWatchBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StopWatch BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconStopWatchStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="StopWatch StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sw"
...
export const iconPackOfStopWatch: TheIconSelfPack = [
  'StopWatch',
  IconStopWatchStrokeRounded,
  IconStopWatchDuotoneRounded,
  IconStopWatchTwotoneRounded,
  IconStopWatchSolidRounded,
  IconStopWatchBulkRounded,
  IconStopWatchStrokeSharp,
  IconStopWatchSolidSharp,
];