...
export const IconAddSquareStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AddSquare StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAddSquareDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AddSquare DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconAddSquareTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AddSquare TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconAddSquareSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AddSquare SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconAddSquareBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AddSquare BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o1"
...
export const IconAddSquareStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AddSquare StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const iconPackOfAddSquare: TheIconSelfPack = [
  'AddSquare',
  IconAddSquareStrokeRounded,
  IconAddSquareDuotoneRounded,
  IconAddSquareTwotoneRounded,
  IconAddSquareSolidRounded,
  IconAddSquareBulkRounded,
  IconAddSquareStrokeSharp,
  IconAddSquareSolidSharp,
];