...
export const IconBubbleChatDelayStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BubbleChatDelay StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBubbleChatDelayDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BubbleChatDelay DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconBubbleChatDelayTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BubbleChatDelay TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBubbleChatDelaySolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BubbleChatDelay SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconBubbleChatDelayBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BubbleChatDelay BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconBubbleChatDelayStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BubbleChatDelay StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const IconBubbleChatDelaySolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BubbleChatDelay SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfBubbleChatDelay: TheIconSelfPack = [
  'BubbleChatDelay',
  IconBubbleChatDelayStrokeRounded,
  IconBubbleChatDelayDuotoneRounded,
  IconBubbleChatDelayTwotoneRounded,
  IconBubbleChatDelaySolidRounded,
  IconBubbleChatDelayBulkRounded,
  IconBubbleChatDelayStrokeSharp,
  IconBubbleChatDelaySolidSharp,
];