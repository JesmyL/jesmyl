...
export const IconCalculateStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Calculate StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconCalculateDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Calculate DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconCalculateTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Calculate TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconCalculateSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Calculate SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconCalculateBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Calculate BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconCalculateStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Calculate StrokeSharp"
    >
      <path 
        d={d.d14}
        i-c="s sj sw"
...
export const iconPackOfCalculate: TheIconSelfPack = [
  'Calculate',
  IconCalculateStrokeRounded,
  IconCalculateDuotoneRounded,
  IconCalculateTwotoneRounded,
  IconCalculateSolidRounded,
  IconCalculateBulkRounded,
  IconCalculateStrokeSharp,
  IconCalculateSolidSharp,
];