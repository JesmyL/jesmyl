...
export const IconTrain01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Train01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconTrain01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Train01 DuotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconTrain01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Train01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfTrain01: TheIconSelfPack = [
  'Train01',
  IconTrain01StrokeRounded,
  IconTrain01DuotoneRounded,
  IconTrain01TwotoneRounded,
  IconTrain01SolidRounded,
  IconTrain01BulkRounded,
  IconTrain01StrokeSharp,
  IconTrain01SolidSharp,
];