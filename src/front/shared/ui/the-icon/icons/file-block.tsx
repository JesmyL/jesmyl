...
export const IconFileBlockStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileBlock StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconFileBlockDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileBlock DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconFileBlockTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileBlock TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconFileBlockSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileBlock SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconFileBlockBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileBlock BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconFileBlockStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileBlock StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfFileBlock: TheIconSelfPack = [
  'FileBlock',
  IconFileBlockStrokeRounded,
  IconFileBlockDuotoneRounded,
  IconFileBlockTwotoneRounded,
  IconFileBlockSolidRounded,
  IconFileBlockBulkRounded,
  IconFileBlockStrokeSharp,
  IconFileBlockSolidSharp,
];