...
export const IconShoppingBasketFavorite01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketFavorite01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShoppingBasketFavorite01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketFavorite01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconShoppingBasketFavorite01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketFavorite01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShoppingBasketFavorite01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketFavorite01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconShoppingBasketFavorite01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketFavorite01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconShoppingBasketFavorite01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketFavorite01 StrokeSharp"
    >
      <path 
        d={d.d3}
        i-c="s sw"
...
export const IconShoppingBasketFavorite01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketFavorite01 SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfShoppingBasketFavorite01: TheIconSelfPack = [
  ...
  IconShoppingBasketFavorite01StrokeRounded,
  IconShoppingBasketFavorite01DuotoneRounded,
  IconShoppingBasketFavorite01TwotoneRounded,
  IconShoppingBasketFavorite01SolidRounded,
  IconShoppingBasketFavorite01BulkRounded,
  IconShoppingBasketFavorite01StrokeSharp,
  IconShoppingBasketFavorite01SolidSharp,
];