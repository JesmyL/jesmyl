...
export const IconNintendoStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Nintendo StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconNintendoDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Nintendo DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconNintendoTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Nintendo TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconNintendoSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Nintendo SolidRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfNintendo: TheIconSelfPack = [
  'Nintendo',
  IconNintendoStrokeRounded,
  IconNintendoDuotoneRounded,
  IconNintendoTwotoneRounded,
  IconNintendoSolidRounded,
  IconNintendoBulkRounded,
  IconNintendoStrokeSharp,
  IconNintendoSolidSharp,
];