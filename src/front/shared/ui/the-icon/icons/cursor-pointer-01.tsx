...
export const IconCursorPointer01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorPointer01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconCursorPointer01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorPointer01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconCursorPointer01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorPointer01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconCursorPointer01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorPointer01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconCursorPointer01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorPointer01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconCursorPointer01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorPointer01 StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sr sw"
...
export const IconCursorPointer01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorPointer01 SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfCursorPointer01: TheIconSelfPack = [
  'CursorPointer01',
  IconCursorPointer01StrokeRounded,
  IconCursorPointer01DuotoneRounded,
  IconCursorPointer01TwotoneRounded,
  IconCursorPointer01SolidRounded,
  IconCursorPointer01BulkRounded,
  IconCursorPointer01StrokeSharp,
  IconCursorPointer01SolidSharp,
];