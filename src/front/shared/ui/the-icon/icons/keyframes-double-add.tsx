...
export const IconKeyframesDoubleAddStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframesDoubleAdd StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconKeyframesDoubleAddDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframesDoubleAdd DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconKeyframesDoubleAddTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframesDoubleAdd TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconKeyframesDoubleAddSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframesDoubleAdd SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconKeyframesDoubleAddBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframesDoubleAdd BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconKeyframesDoubleAddStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframesDoubleAdd StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sw"
...
export const IconKeyframesDoubleAddSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="KeyframesDoubleAdd SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfKeyframesDoubleAdd: TheIconSelfPack = [
  'KeyframesDoubleAdd',
  IconKeyframesDoubleAddStrokeRounded,
  IconKeyframesDoubleAddDuotoneRounded,
  IconKeyframesDoubleAddTwotoneRounded,
  IconKeyframesDoubleAddSolidRounded,
  IconKeyframesDoubleAddBulkRounded,
  IconKeyframesDoubleAddStrokeSharp,
  IconKeyframesDoubleAddSolidSharp,
];