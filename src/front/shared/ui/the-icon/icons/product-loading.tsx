...
export const IconProductLoadingStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ProductLoading StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconProductLoadingDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ProductLoading DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconProductLoadingTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ProductLoading TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconProductLoadingSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ProductLoading SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconProductLoadingBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ProductLoading BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconProductLoadingStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ProductLoading StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sr sw"
...
export const IconProductLoadingSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ProductLoading SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfProductLoading: TheIconSelfPack = [
  'ProductLoading',
  IconProductLoadingStrokeRounded,
  IconProductLoadingDuotoneRounded,
  IconProductLoadingTwotoneRounded,
  IconProductLoadingSolidRounded,
  IconProductLoadingBulkRounded,
  IconProductLoadingStrokeSharp,
  IconProductLoadingSolidSharp,
];