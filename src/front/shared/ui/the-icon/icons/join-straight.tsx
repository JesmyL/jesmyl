...
export const IconJoinStraightStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="JoinStraight StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconJoinStraightDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="JoinStraight DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconJoinStraightTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="JoinStraight TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconJoinStraightSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="JoinStraight SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconJoinStraightBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="JoinStraight BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconJoinStraightStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="JoinStraight StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sw"
...
export const IconJoinStraightSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="JoinStraight SolidSharp"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const iconPackOfJoinStraight: TheIconSelfPack = [
  'JoinStraight',
  IconJoinStraightStrokeRounded,
  IconJoinStraightDuotoneRounded,
  IconJoinStraightTwotoneRounded,
  IconJoinStraightSolidRounded,
  IconJoinStraightBulkRounded,
  IconJoinStraightStrokeSharp,
  IconJoinStraightSolidSharp,
];