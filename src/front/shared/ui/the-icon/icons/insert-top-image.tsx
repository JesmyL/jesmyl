...
export const IconInsertTopImageStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InsertTopImage StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconInsertTopImageDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InsertTopImage DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconInsertTopImageTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InsertTopImage TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconInsertTopImageSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InsertTopImage SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconInsertTopImageBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InsertTopImage BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconInsertTopImageStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InsertTopImage StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj ss sw"
...
export const IconInsertTopImageSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="InsertTopImage SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfInsertTopImage: TheIconSelfPack = [
  'InsertTopImage',
  IconInsertTopImageStrokeRounded,
  IconInsertTopImageDuotoneRounded,
  IconInsertTopImageTwotoneRounded,
  IconInsertTopImageSolidRounded,
  IconInsertTopImageBulkRounded,
  IconInsertTopImageStrokeSharp,
  IconInsertTopImageSolidSharp,
];