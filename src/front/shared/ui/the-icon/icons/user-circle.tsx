...
export const IconUserCircleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserCircle StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconUserCircleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserCircle DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="c f fr o7"
...
export const IconUserCircleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserCircle TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconUserCircleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserCircle SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconUserCircleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserCircle BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconUserCircleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserCircle StrokeSharp"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconUserCircleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UserCircle SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfUserCircle: TheIconSelfPack = [
  'UserCircle',
  IconUserCircleStrokeRounded,
  IconUserCircleDuotoneRounded,
  IconUserCircleTwotoneRounded,
  IconUserCircleSolidRounded,
  IconUserCircleBulkRounded,
  IconUserCircleStrokeSharp,
  IconUserCircleSolidSharp,
];