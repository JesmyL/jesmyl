...
export const IconHeadsetConnectedStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HeadsetConnected StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconHeadsetConnectedDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HeadsetConnected DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconHeadsetConnectedTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HeadsetConnected TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconHeadsetConnectedSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HeadsetConnected SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconHeadsetConnectedBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HeadsetConnected BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr o7"
...
export const IconHeadsetConnectedStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HeadsetConnected StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sw"
...
export const IconHeadsetConnectedSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HeadsetConnected SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="f"
...
export const iconPackOfHeadsetConnected: TheIconSelfPack = [
  'HeadsetConnected',
  IconHeadsetConnectedStrokeRounded,
  IconHeadsetConnectedDuotoneRounded,
  IconHeadsetConnectedTwotoneRounded,
  IconHeadsetConnectedSolidRounded,
  IconHeadsetConnectedBulkRounded,
  IconHeadsetConnectedStrokeSharp,
  IconHeadsetConnectedSolidSharp,
];