...
export const IconSettings04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Settings04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconSettings04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Settings04 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconSettings04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Settings04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconSettings04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Settings04 SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconSettings04BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Settings04 BulkRounded"
    >
      <path 
        d={d.d10}
        i-c="f o7"
...
export const IconSettings04StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Settings04 StrokeSharp"
    >
      <path 
        d={d.d13}
        i-c="s sj sw"
...
export const IconSettings04SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Settings04 SolidSharp"
    >
      <path 
        d={d.d16}
        i-c="c f fr"
...
export const iconPackOfSettings04: TheIconSelfPack = [
  'Settings04',
  IconSettings04StrokeRounded,
  IconSettings04DuotoneRounded,
  IconSettings04TwotoneRounded,
  IconSettings04SolidRounded,
  IconSettings04BulkRounded,
  IconSettings04StrokeSharp,
  IconSettings04SolidSharp,
];