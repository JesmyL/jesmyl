...
export const IconTrain02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Train02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTrain02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Train02 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconTrain02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Train02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfTrain02: TheIconSelfPack = [
  'Train02',
  IconTrain02StrokeRounded,
  IconTrain02DuotoneRounded,
  IconTrain02TwotoneRounded,
  IconTrain02SolidRounded,
  IconTrain02BulkRounded,
  IconTrain02StrokeSharp,
  IconTrain02SolidSharp,
];