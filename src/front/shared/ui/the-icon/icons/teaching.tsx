...
export const IconTeachingStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Teaching StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTeachingDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Teaching DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconTeachingTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Teaching TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTeachingSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Teaching SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const iconPackOfTeaching: TheIconSelfPack = [
  'Teaching',
  IconTeachingStrokeRounded,
  IconTeachingDuotoneRounded,
  IconTeachingTwotoneRounded,
  IconTeachingSolidRounded,
  IconTeachingBulkRounded,
  IconTeachingStrokeSharp,
  IconTeachingSolidSharp,
];