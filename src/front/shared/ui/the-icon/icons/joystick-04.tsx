...
export const IconJoystick04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconJoystick04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick04 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconJoystick04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconJoystick04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick04 SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconJoystick04BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick04 BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconJoystick04StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick04 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconJoystick04SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Joystick04 SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="f"
...
export const iconPackOfJoystick04: TheIconSelfPack = [
  'Joystick04',
  IconJoystick04StrokeRounded,
  IconJoystick04DuotoneRounded,
  IconJoystick04TwotoneRounded,
  IconJoystick04SolidRounded,
  IconJoystick04BulkRounded,
  IconJoystick04StrokeSharp,
  IconJoystick04SolidSharp,
];