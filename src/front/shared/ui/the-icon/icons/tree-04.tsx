...
export const IconTree04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Tree04 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconTree04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Tree04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfTree04: TheIconSelfPack = [
  'Tree04',
  IconTree04StrokeRounded,
  IconTree04DuotoneRounded,
  IconTree04TwotoneRounded,
  IconTree04SolidRounded,
  IconTree04BulkRounded,
  IconTree04StrokeSharp,
  IconTree04SolidSharp,
];