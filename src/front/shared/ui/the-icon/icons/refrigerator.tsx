...
export const IconRefrigeratorStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Refrigerator StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRefrigeratorDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Refrigerator DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconRefrigeratorTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Refrigerator TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRefrigeratorSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Refrigerator SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconRefrigeratorBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Refrigerator BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d7}
...
export const IconRefrigeratorStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Refrigerator StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sw"
...
export const IconRefrigeratorSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Refrigerator SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfRefrigerator: TheIconSelfPack = [
  'Refrigerator',
  IconRefrigeratorStrokeRounded,
  IconRefrigeratorDuotoneRounded,
  IconRefrigeratorTwotoneRounded,
  IconRefrigeratorSolidRounded,
  IconRefrigeratorBulkRounded,
  IconRefrigeratorStrokeSharp,
  IconRefrigeratorSolidSharp,
];