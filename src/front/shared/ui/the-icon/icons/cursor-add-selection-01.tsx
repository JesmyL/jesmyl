...
export const IconCursorAddSelection01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorAddSelection01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCursorAddSelection01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorAddSelection01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconCursorAddSelection01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorAddSelection01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCursorAddSelection01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorAddSelection01 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconCursorAddSelection01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorAddSelection01 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconCursorAddSelection01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorAddSelection01 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const IconCursorAddSelection01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorAddSelection01 SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const iconPackOfCursorAddSelection01: TheIconSelfPack = [
  ...
  IconCursorAddSelection01StrokeRounded,
  IconCursorAddSelection01DuotoneRounded,
  IconCursorAddSelection01TwotoneRounded,
  IconCursorAddSelection01SolidRounded,
  IconCursorAddSelection01BulkRounded,
  IconCursorAddSelection01StrokeSharp,
  IconCursorAddSelection01SolidSharp,
];