...
export const IconEuroSendStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EuroSend StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconEuroSendDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EuroSend DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconEuroSendTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EuroSend TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconEuroSendSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="EuroSend SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const iconPackOfEuroSend: TheIconSelfPack = [
  'EuroSend',
  IconEuroSendStrokeRounded,
  IconEuroSendDuotoneRounded,
  IconEuroSendTwotoneRounded,
  IconEuroSendSolidRounded,
  IconEuroSendBulkRounded,
  IconEuroSendStrokeSharp,
  IconEuroSendSolidSharp,
];