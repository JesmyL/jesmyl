...
export const IconDownload04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDownload04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download04 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconDownload04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconDownload04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download04 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconDownload04BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download04 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconDownload04StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download04 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const IconDownload04SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Download04 SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfDownload04: TheIconSelfPack = [
  'Download04',
  IconDownload04StrokeRounded,
  IconDownload04DuotoneRounded,
  IconDownload04TwotoneRounded,
  IconDownload04SolidRounded,
  IconDownload04BulkRounded,
  IconDownload04StrokeSharp,
  IconDownload04SolidSharp,
];