...
export const IconTick01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Tick01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconTick01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Tick01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfTick01: TheIconSelfPack = [
  'Tick01',
  IconTick01StrokeRounded,
  IconTick01DuotoneRounded,
  IconTick01TwotoneRounded,
  IconTick01SolidRounded,
  IconTick01BulkRounded,
  IconTick01StrokeSharp,
  IconTick01SolidSharp,
];