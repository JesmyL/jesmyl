...
export const IconLaptopPerformanceStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopPerformance StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLaptopPerformanceDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopPerformance DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconLaptopPerformanceTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopPerformance TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLaptopPerformanceSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopPerformance SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconLaptopPerformanceBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopPerformance BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconLaptopPerformanceStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopPerformance StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const IconLaptopPerformanceSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LaptopPerformance SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfLaptopPerformance: TheIconSelfPack = [
  'LaptopPerformance',
  IconLaptopPerformanceStrokeRounded,
  IconLaptopPerformanceDuotoneRounded,
  IconLaptopPerformanceTwotoneRounded,
  IconLaptopPerformanceSolidRounded,
  IconLaptopPerformanceBulkRounded,
  IconLaptopPerformanceStrokeSharp,
  IconLaptopPerformanceSolidSharp,
];