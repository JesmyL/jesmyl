...
export const IconPresentationOnlineStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PresentationOnline StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPresentationOnlineDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PresentationOnline DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconPresentationOnlineTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PresentationOnline TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPresentationOnlineSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PresentationOnline SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconPresentationOnlineBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PresentationOnline BulkRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const IconPresentationOnlineStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PresentationOnline StrokeSharp"
    >
      <path 
        d={d.d14}
        i-c="s sj sw"
...
export const IconPresentationOnlineSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PresentationOnline SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const iconPackOfPresentationOnline: TheIconSelfPack = [
  'PresentationOnline',
  IconPresentationOnlineStrokeRounded,
  IconPresentationOnlineDuotoneRounded,
  IconPresentationOnlineTwotoneRounded,
  IconPresentationOnlineSolidRounded,
  IconPresentationOnlineBulkRounded,
  IconPresentationOnlineStrokeSharp,
  IconPresentationOnlineSolidSharp,
];