...
export const IconInvoice01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Invoice01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconInvoice01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Invoice01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconInvoice01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Invoice01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconInvoice01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Invoice01 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconInvoice01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Invoice01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconInvoice01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Invoice01 StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const iconPackOfInvoice01: TheIconSelfPack = [
  'Invoice01',
  IconInvoice01StrokeRounded,
  IconInvoice01DuotoneRounded,
  IconInvoice01TwotoneRounded,
  IconInvoice01SolidRounded,
  IconInvoice01BulkRounded,
  IconInvoice01StrokeSharp,
  IconInvoice01SolidSharp,
];