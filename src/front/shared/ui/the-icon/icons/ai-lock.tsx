...
export const IconAiLockDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiLock DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconAiLockTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="AiLock TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfAiLock: TheIconSelfPack = [
  'AiLock',
  IconAiLockStrokeRounded,
  IconAiLockDuotoneRounded,
  IconAiLockTwotoneRounded,
  IconAiLockSolidRounded,
  IconAiLockBulkRounded,
  IconAiLockStrokeSharp,
  IconAiLockSolidSharp,
];