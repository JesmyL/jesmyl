...
export const IconChartHistogramStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartHistogram StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconChartHistogramDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartHistogram DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconChartHistogramTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartHistogram TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconChartHistogramSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartHistogram SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconChartHistogramBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartHistogram BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconChartHistogramStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartHistogram StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const IconChartHistogramSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ChartHistogram SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfChartHistogram: TheIconSelfPack = [
  'ChartHistogram',
  IconChartHistogramStrokeRounded,
  IconChartHistogramDuotoneRounded,
  IconChartHistogramTwotoneRounded,
  IconChartHistogramSolidRounded,
  IconChartHistogramBulkRounded,
  IconChartHistogramStrokeSharp,
  IconChartHistogramSolidSharp,
];