...
export const iconPackOfPound: TheIconSelfPack = [
  'Pound',
  IconPoundStrokeRounded,
  IconPoundDuotoneRounded,
  IconPoundTwotoneRounded,
  IconPoundSolidRounded,
  IconPoundBulkRounded,
  IconPoundStrokeSharp,
  IconPoundSolidSharp,
];