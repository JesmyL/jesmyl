...
export const IconLocationFavourite02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationFavourite02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLocationFavourite02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationFavourite02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLocationFavourite02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationFavourite02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLocationFavourite02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationFavourite02 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconLocationFavourite02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationFavourite02 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconLocationFavourite02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationFavourite02 StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconLocationFavourite02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="LocationFavourite02 SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfLocationFavourite02: TheIconSelfPack = [
  'LocationFavourite02',
  IconLocationFavourite02StrokeRounded,
  IconLocationFavourite02DuotoneRounded,
  IconLocationFavourite02TwotoneRounded,
  IconLocationFavourite02SolidRounded,
  IconLocationFavourite02BulkRounded,
  IconLocationFavourite02StrokeSharp,
  IconLocationFavourite02SolidSharp,
];