...
export const IconPenToolAddStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PenToolAdd StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconPenToolAddDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PenToolAdd DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconPenToolAddTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PenToolAdd TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconPenToolAddSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PenToolAdd SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconPenToolAddBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PenToolAdd BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconPenToolAddStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PenToolAdd StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sr sw"
...
export const IconPenToolAddSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PenToolAdd SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="f"
...
export const iconPackOfPenToolAdd: TheIconSelfPack = [
  'PenToolAdd',
  IconPenToolAddStrokeRounded,
  IconPenToolAddDuotoneRounded,
  IconPenToolAddTwotoneRounded,
  IconPenToolAddSolidRounded,
  IconPenToolAddBulkRounded,
  IconPenToolAddStrokeSharp,
  IconPenToolAddSolidSharp,
];