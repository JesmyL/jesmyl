...
export const IconMosque03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mosque03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMosque03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mosque03 DuotoneRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconMosque03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mosque03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMosque03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mosque03 SolidRounded"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfMosque03: TheIconSelfPack = [
  'Mosque03',
  IconMosque03StrokeRounded,
  IconMosque03DuotoneRounded,
  IconMosque03TwotoneRounded,
  IconMosque03SolidRounded,
  IconMosque03BulkRounded,
  IconMosque03StrokeSharp,
  IconMosque03SolidSharp,
];