...
export const IconAstronaut01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Astronaut01 StrokeRounded"
    >
      <circle 
        cx="12"
        cy="11"
...
export const IconAstronaut01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Astronaut01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconAstronaut01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Astronaut01 TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="11"
...
export const IconAstronaut01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Astronaut01 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconAstronaut01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Astronaut01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconAstronaut01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Astronaut01 StrokeSharp"
    >
      <circle 
        cx="12"
        cy="11"
...
export const IconAstronaut01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Astronaut01 SolidSharp"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const iconPackOfAstronaut01: TheIconSelfPack = [
  'Astronaut01',
  IconAstronaut01StrokeRounded,
  IconAstronaut01DuotoneRounded,
  IconAstronaut01TwotoneRounded,
  IconAstronaut01SolidRounded,
  IconAstronaut01BulkRounded,
  IconAstronaut01StrokeSharp,
  IconAstronaut01SolidSharp,
];