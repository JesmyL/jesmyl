...
export const IconTropicalStormStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TropicalStorm StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconTropicalStormDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TropicalStorm DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="c f fr o7"
...
export const IconTropicalStormTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TropicalStorm TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconTropicalStormSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TropicalStorm SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconTropicalStormBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TropicalStorm BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconTropicalStormStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TropicalStorm StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const IconTropicalStormSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TropicalStorm SolidSharp"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const iconPackOfTropicalStorm: TheIconSelfPack = [
  'TropicalStorm',
  IconTropicalStormStrokeRounded,
  IconTropicalStormDuotoneRounded,
  IconTropicalStormTwotoneRounded,
  IconTropicalStormSolidRounded,
  IconTropicalStormBulkRounded,
  IconTropicalStormStrokeSharp,
  IconTropicalStormSolidSharp,
];