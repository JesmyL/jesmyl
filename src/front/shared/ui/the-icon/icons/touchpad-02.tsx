...
export const IconTouchpad02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Touchpad02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTouchpad02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Touchpad02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconTouchpad02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Touchpad02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTouchpad02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Touchpad02 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconTouchpad02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Touchpad02 BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconTouchpad02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Touchpad02 StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sw"
...
export const IconTouchpad02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Touchpad02 SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfTouchpad02: TheIconSelfPack = [
  'Touchpad02',
  IconTouchpad02StrokeRounded,
  IconTouchpad02DuotoneRounded,
  IconTouchpad02TwotoneRounded,
  IconTouchpad02SolidRounded,
  IconTouchpad02BulkRounded,
  IconTouchpad02StrokeSharp,
  IconTouchpad02SolidSharp,
];