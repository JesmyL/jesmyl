...
export const IconSquareLockAdd01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareLockAdd01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSquareLockAdd01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareLockAdd01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconSquareLockAdd01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareLockAdd01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSquareLockAdd01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareLockAdd01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconSquareLockAdd01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareLockAdd01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconSquareLockAdd01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareLockAdd01 StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const IconSquareLockAdd01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareLockAdd01 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfSquareLockAdd01: TheIconSelfPack = [
  'SquareLockAdd01',
  IconSquareLockAdd01StrokeRounded,
  IconSquareLockAdd01DuotoneRounded,
  IconSquareLockAdd01TwotoneRounded,
  IconSquareLockAdd01SolidRounded,
  IconSquareLockAdd01BulkRounded,
  IconSquareLockAdd01StrokeSharp,
  IconSquareLockAdd01SolidSharp,
];