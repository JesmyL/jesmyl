...
export const IconCalendarBlock01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarBlock01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCalendarBlock01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarBlock01 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconCalendarBlock01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarBlock01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCalendarBlock01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarBlock01 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconCalendarBlock01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarBlock01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconCalendarBlock01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarBlock01 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconCalendarBlock01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarBlock01 SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="f"
...
export const iconPackOfCalendarBlock01: TheIconSelfPack = [
  'CalendarBlock01',
  IconCalendarBlock01StrokeRounded,
  IconCalendarBlock01DuotoneRounded,
  IconCalendarBlock01TwotoneRounded,
  IconCalendarBlock01SolidRounded,
  IconCalendarBlock01BulkRounded,
  IconCalendarBlock01StrokeSharp,
  IconCalendarBlock01SolidSharp,
];