...
export const IconLogout04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Logout04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLogout04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Logout04 DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="13"
...
export const IconLogout04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Logout04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLogout04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Logout04 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const iconPackOfLogout04: TheIconSelfPack = [
  'Logout04',
  IconLogout04StrokeRounded,
  IconLogout04DuotoneRounded,
  IconLogout04TwotoneRounded,
  IconLogout04SolidRounded,
  IconLogout04BulkRounded,
  IconLogout04StrokeSharp,
  IconLogout04SolidSharp,
];