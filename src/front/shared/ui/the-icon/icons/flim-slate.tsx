...
export const IconFlimSlateStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlimSlate StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconFlimSlateDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlimSlate DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconFlimSlateTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlimSlate TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconFlimSlateSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlimSlate SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconFlimSlateBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlimSlate BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o4"
...
export const IconFlimSlateStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlimSlate StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sw"
...
export const iconPackOfFlimSlate: TheIconSelfPack = [
  'FlimSlate',
  IconFlimSlateStrokeRounded,
  IconFlimSlateDuotoneRounded,
  IconFlimSlateTwotoneRounded,
  IconFlimSlateSolidRounded,
  IconFlimSlateBulkRounded,
  IconFlimSlateStrokeSharp,
  IconFlimSlateSolidSharp,
];