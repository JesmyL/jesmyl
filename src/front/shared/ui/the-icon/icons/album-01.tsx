...
export const IconAlbum01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Album01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconAlbum01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Album01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconAlbum01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Album01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const iconPackOfAlbum01: TheIconSelfPack = [
  'Album01',
  IconAlbum01StrokeRounded,
  IconAlbum01DuotoneRounded,
  IconAlbum01TwotoneRounded,
  IconAlbum01SolidRounded,
  IconAlbum01BulkRounded,
  IconAlbum01StrokeSharp,
  IconAlbum01SolidSharp,
];