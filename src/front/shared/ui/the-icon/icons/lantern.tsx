...
export const IconLanternStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Lantern StrokeRounded"
    >
      <rect 
        x="6"
        y="7.5"
        i-c="h2 s sj sr sw w3"
      />
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLanternDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Lantern DuotoneRounded"
    >
      <rect 
        x="6"
        y="7.5"
...
export const IconLanternTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Lantern TwotoneRounded"
    >
      <rect 
        x="6"
        y="7.5"
...
export const iconPackOfLantern: TheIconSelfPack = [
  'Lantern',
  IconLanternStrokeRounded,
  IconLanternDuotoneRounded,
  IconLanternTwotoneRounded,
  IconLanternSolidRounded,
  IconLanternBulkRounded,
  IconLanternStrokeSharp,
  IconLanternSolidSharp,
];