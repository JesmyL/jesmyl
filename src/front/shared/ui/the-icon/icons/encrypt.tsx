...
export const IconEncryptStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Encrypt StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconEncryptDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Encrypt DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconEncryptTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Encrypt TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfEncrypt: TheIconSelfPack = [
  'Encrypt',
  IconEncryptStrokeRounded,
  IconEncryptDuotoneRounded,
  IconEncryptTwotoneRounded,
  IconEncryptSolidRounded,
  IconEncryptBulkRounded,
  IconEncryptStrokeSharp,
  IconEncryptSolidSharp,
];