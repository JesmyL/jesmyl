...
export const IconAvocadoStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Avocado StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconAvocadoDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Avocado DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconAvocadoTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Avocado TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfAvocado: TheIconSelfPack = [
  'Avocado',
  IconAvocadoStrokeRounded,
  IconAvocadoDuotoneRounded,
  IconAvocadoTwotoneRounded,
  IconAvocadoSolidRounded,
  IconAvocadoBulkRounded,
  IconAvocadoStrokeSharp,
  IconAvocadoSolidSharp,
];