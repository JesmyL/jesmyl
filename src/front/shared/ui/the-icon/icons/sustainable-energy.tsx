...
export const IconSustainableEnergyStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SustainableEnergy StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSustainableEnergyDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SustainableEnergy DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconSustainableEnergyTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SustainableEnergy TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSustainableEnergySolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SustainableEnergy SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconSustainableEnergyBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SustainableEnergy BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconSustainableEnergyStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SustainableEnergy StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s ss sw"
...
export const IconSustainableEnergySolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SustainableEnergy SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const iconPackOfSustainableEnergy: TheIconSelfPack = [
  'SustainableEnergy',
  IconSustainableEnergyStrokeRounded,
  IconSustainableEnergyDuotoneRounded,
  IconSustainableEnergyTwotoneRounded,
  IconSustainableEnergySolidRounded,
  IconSustainableEnergyBulkRounded,
  IconSustainableEnergyStrokeSharp,
  IconSustainableEnergySolidSharp,
];