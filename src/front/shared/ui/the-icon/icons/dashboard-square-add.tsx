...
export const IconDashboardSquareAddStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DashboardSquareAdd StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDashboardSquareAddDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DashboardSquareAdd DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconDashboardSquareAddTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DashboardSquareAdd TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconDashboardSquareAddSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DashboardSquareAdd SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconDashboardSquareAddBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DashboardSquareAdd BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconDashboardSquareAddStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DashboardSquareAdd StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sj sw"
...
export const IconDashboardSquareAddSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DashboardSquareAdd SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfDashboardSquareAdd: TheIconSelfPack = [
  'DashboardSquareAdd',
  IconDashboardSquareAddStrokeRounded,
  IconDashboardSquareAddDuotoneRounded,
  IconDashboardSquareAddTwotoneRounded,
  IconDashboardSquareAddSolidRounded,
  IconDashboardSquareAddBulkRounded,
  IconDashboardSquareAddStrokeSharp,
  IconDashboardSquareAddSolidSharp,
];