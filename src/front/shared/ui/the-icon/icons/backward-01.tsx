...
export const IconBackward01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Backward01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconBackward01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Backward01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconBackward01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Backward01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconBackward01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Backward01 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconBackward01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Backward01 BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr o7"
...
export const IconBackward01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Backward01 StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sj sw"
...
export const IconBackward01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Backward01 SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const iconPackOfBackward01: TheIconSelfPack = [
  'Backward01',
  IconBackward01StrokeRounded,
  IconBackward01DuotoneRounded,
  IconBackward01TwotoneRounded,
  IconBackward01SolidRounded,
  IconBackward01BulkRounded,
  IconBackward01StrokeSharp,
  IconBackward01SolidSharp,
];