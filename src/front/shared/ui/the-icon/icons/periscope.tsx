...
export const IconPeriscopeStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Periscope StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconPeriscopeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Periscope DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr o7"
...
export const IconPeriscopeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Periscope TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconPeriscopeSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Periscope SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconPeriscopeBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Periscope BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconPeriscopeStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Periscope StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const iconPackOfPeriscope: TheIconSelfPack = [
  'Periscope',
  IconPeriscopeStrokeRounded,
  IconPeriscopeDuotoneRounded,
  IconPeriscopeTwotoneRounded,
  IconPeriscopeSolidRounded,
  IconPeriscopeBulkRounded,
  IconPeriscopeStrokeSharp,
  IconPeriscopeSolidSharp,
];