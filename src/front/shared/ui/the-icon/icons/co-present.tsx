...
export const IconCoPresentStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoPresent StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconCoPresentDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoPresent DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconCoPresentTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoPresent TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconCoPresentSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoPresent SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconCoPresentBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoPresent BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconCoPresentStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoPresent StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const iconPackOfCoPresent: TheIconSelfPack = [
  'CoPresent',
  IconCoPresentStrokeRounded,
  IconCoPresentDuotoneRounded,
  IconCoPresentTwotoneRounded,
  IconCoPresentSolidRounded,
  IconCoPresentBulkRounded,
  IconCoPresentStrokeSharp,
  IconCoPresentSolidSharp,
];