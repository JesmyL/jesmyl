...
export const IconRoboticStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Robotic StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconRoboticDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Robotic DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconRoboticTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Robotic TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfRobotic: TheIconSelfPack = [
  'Robotic',
  IconRoboticStrokeRounded,
  IconRoboticDuotoneRounded,
  IconRoboticTwotoneRounded,
  IconRoboticSolidRounded,
  IconRoboticBulkRounded,
  IconRoboticStrokeSharp,
  IconRoboticSolidSharp,
];