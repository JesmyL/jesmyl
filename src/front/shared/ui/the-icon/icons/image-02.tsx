...
export const IconImage02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Image02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconImage02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Image02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconImage02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Image02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfImage02: TheIconSelfPack = [
  'Image02',
  IconImage02StrokeRounded,
  IconImage02DuotoneRounded,
  IconImage02TwotoneRounded,
  IconImage02SolidRounded,
  IconImage02BulkRounded,
  IconImage02StrokeSharp,
  IconImage02SolidSharp,
];