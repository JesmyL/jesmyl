...
export const IconFlipVerticalStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlipVertical StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFlipVerticalDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlipVertical DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconFlipVerticalTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlipVertical TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFlipVerticalSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlipVertical SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconFlipVerticalBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlipVertical BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconFlipVerticalStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlipVertical StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sr sw"
...
export const IconFlipVerticalSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FlipVertical SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfFlipVertical: TheIconSelfPack = [
  'FlipVertical',
  IconFlipVerticalStrokeRounded,
  IconFlipVerticalDuotoneRounded,
  IconFlipVerticalTwotoneRounded,
  IconFlipVerticalSolidRounded,
  IconFlipVerticalBulkRounded,
  IconFlipVerticalStrokeSharp,
  IconFlipVerticalSolidSharp,
];