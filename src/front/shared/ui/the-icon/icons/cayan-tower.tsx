...
export const IconCayanTowerStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CayanTower StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCayanTowerDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CayanTower DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconCayanTowerTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CayanTower TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCayanTowerSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CayanTower SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconCayanTowerBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CayanTower BulkRounded"
    >
      <path 
        d={d.d11}
        i-c="f o7"
...
export const IconCayanTowerStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CayanTower StrokeSharp"
    >
      <path 
        d={d.d14}
        i-c="s sj sw"
...
export const IconCayanTowerSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CayanTower SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="f"
...
export const iconPackOfCayanTower: TheIconSelfPack = [
  'CayanTower',
  IconCayanTowerStrokeRounded,
  IconCayanTowerDuotoneRounded,
  IconCayanTowerTwotoneRounded,
  IconCayanTowerSolidRounded,
  IconCayanTowerBulkRounded,
  IconCayanTowerStrokeSharp,
  IconCayanTowerSolidSharp,
];