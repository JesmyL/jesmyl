...
export const iconPackOfWaze: TheIconSelfPack = [
  'Waze',
  IconWazeStrokeRounded,
  IconWazeDuotoneRounded,
  IconWazeTwotoneRounded,
  IconWazeSolidRounded,
  IconWazeBulkRounded,
  IconWazeStrokeSharp,
  IconWazeSolidSharp,
];