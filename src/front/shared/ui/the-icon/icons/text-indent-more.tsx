...
export const IconTextIndentMoreStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextIndentMore StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTextIndentMoreDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextIndentMore DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconTextIndentMoreTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextIndentMore TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTextIndentMoreSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextIndentMore SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconTextIndentMoreBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextIndentMore BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr o7"
...
export const IconTextIndentMoreStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextIndentMore StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconTextIndentMoreSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextIndentMore SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="c f fr"
...
export const iconPackOfTextIndentMore: TheIconSelfPack = [
  'TextIndentMore',
  IconTextIndentMoreStrokeRounded,
  IconTextIndentMoreDuotoneRounded,
  IconTextIndentMoreTwotoneRounded,
  IconTextIndentMoreSolidRounded,
  IconTextIndentMoreBulkRounded,
  IconTextIndentMoreStrokeSharp,
  IconTextIndentMoreSolidSharp,
];