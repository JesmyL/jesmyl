...
export const IconPyramidStructure01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PyramidStructure01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconPyramidStructure01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PyramidStructure01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconPyramidStructure01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PyramidStructure01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sw"
...
export const IconPyramidStructure01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PyramidStructure01 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconPyramidStructure01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PyramidStructure01 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconPyramidStructure01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PyramidStructure01 StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const IconPyramidStructure01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PyramidStructure01 SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfPyramidStructure01: TheIconSelfPack = [
  'PyramidStructure01',
  IconPyramidStructure01StrokeRounded,
  IconPyramidStructure01DuotoneRounded,
  IconPyramidStructure01TwotoneRounded,
  IconPyramidStructure01SolidRounded,
  IconPyramidStructure01BulkRounded,
  IconPyramidStructure01StrokeSharp,
  IconPyramidStructure01SolidSharp,
];