...
export const IconShoppingBasketCheckOut01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketCheckOut01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShoppingBasketCheckOut01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketCheckOut01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconShoppingBasketCheckOut01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketCheckOut01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShoppingBasketCheckOut01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketCheckOut01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconShoppingBasketCheckOut01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketCheckOut01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconShoppingBasketCheckOut01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketCheckOut01 StrokeSharp"
    >
      <path 
        d={d.d2}
        i-c="s sw"
...
export const IconShoppingBasketCheckOut01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasketCheckOut01 SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfShoppingBasketCheckOut01: TheIconSelfPack = [
  ...
  IconShoppingBasketCheckOut01StrokeRounded,
  IconShoppingBasketCheckOut01DuotoneRounded,
  IconShoppingBasketCheckOut01TwotoneRounded,
  IconShoppingBasketCheckOut01SolidRounded,
  IconShoppingBasketCheckOut01BulkRounded,
  IconShoppingBasketCheckOut01StrokeSharp,
  IconShoppingBasketCheckOut01SolidSharp,
];