...
export const IconGroupLayersStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GroupLayers StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconGroupLayersDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GroupLayers DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconGroupLayersTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GroupLayers TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconGroupLayersSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GroupLayers SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const IconGroupLayersBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GroupLayers BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d8}
...
export const IconGroupLayersStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GroupLayers StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconGroupLayersSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GroupLayers SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const iconPackOfGroupLayers: TheIconSelfPack = [
  'GroupLayers',
  IconGroupLayersStrokeRounded,
  IconGroupLayersDuotoneRounded,
  IconGroupLayersTwotoneRounded,
  IconGroupLayersSolidRounded,
  IconGroupLayersBulkRounded,
  IconGroupLayersStrokeSharp,
  IconGroupLayersSolidSharp,
];