...
export const iconPackOfIco: TheIconSelfPack = [
  'Ico',
  IconIcoStrokeRounded,
  IconIcoDuotoneRounded,
  IconIcoTwotoneRounded,
  IconIcoSolidRounded,
  IconIcoBulkRounded,
  IconIcoStrokeSharp,
  IconIcoSolidSharp,
