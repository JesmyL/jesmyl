...
export const IconGoldIngotsStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoldIngots StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconGoldIngotsDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoldIngots DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconGoldIngotsTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoldIngots TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconGoldIngotsSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoldIngots SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconGoldIngotsBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoldIngots BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconGoldIngotsStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoldIngots StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconGoldIngotsSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoldIngots SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const iconPackOfGoldIngots: TheIconSelfPack = [
  'GoldIngots',
  IconGoldIngotsStrokeRounded,
  IconGoldIngotsDuotoneRounded,
  IconGoldIngotsTwotoneRounded,
  IconGoldIngotsSolidRounded,
  IconGoldIngotsBulkRounded,
  IconGoldIngotsStrokeSharp,
  IconGoldIngotsSolidSharp,
];