...
export const IconFileImportStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileImport StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFileImportDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileImport DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconFileImportTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileImport TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconFileImportSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileImport SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconFileImportBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileImport BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconFileImportStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileImport StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const IconFileImportSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileImport SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfFileImport: TheIconSelfPack = [
  'FileImport',
  IconFileImportStrokeRounded,
  IconFileImportDuotoneRounded,
  IconFileImportTwotoneRounded,
  IconFileImportSolidRounded,
  IconFileImportBulkRounded,
  IconFileImportStrokeSharp,
  IconFileImportSolidSharp,
];