...
export const iconPackOfBank: TheIconSelfPack = [
  'Bank',
  IconBankStrokeRounded,
  IconBankDuotoneRounded,
  IconBankTwotoneRounded,
  IconBankSolidRounded,
  IconBankBulkRounded,
  IconBankStrokeSharp,
  IconBankSolidSharp,
];