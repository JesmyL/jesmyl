...
export const IconCursorRemoveSelection02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorRemoveSelection02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconCursorRemoveSelection02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorRemoveSelection02 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconCursorRemoveSelection02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorRemoveSelection02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconCursorRemoveSelection02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorRemoveSelection02 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconCursorRemoveSelection02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorRemoveSelection02 BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconCursorRemoveSelection02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorRemoveSelection02 StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sw"
...
export const IconCursorRemoveSelection02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorRemoveSelection02 SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfCursorRemoveSelection02: TheIconSelfPack = [
  ...
  IconCursorRemoveSelection02StrokeRounded,
  IconCursorRemoveSelection02DuotoneRounded,
  IconCursorRemoveSelection02TwotoneRounded,
  IconCursorRemoveSelection02SolidRounded,
  IconCursorRemoveSelection02BulkRounded,
  IconCursorRemoveSelection02StrokeSharp,
  IconCursorRemoveSelection02SolidSharp,
];