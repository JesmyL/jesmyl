...
export const IconTextFirstlineLeftStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextFirstlineLeft StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTextFirstlineLeftDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextFirstlineLeft DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconTextFirstlineLeftTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextFirstlineLeft TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconTextFirstlineLeftSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextFirstlineLeft SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconTextFirstlineLeftBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextFirstlineLeft BulkRounded"
    >
      <path 
        d={d.d11}
        i-c="c f fr o7"
...
export const IconTextFirstlineLeftStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextFirstlineLeft StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj ss sw"
...
export const IconTextFirstlineLeftSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextFirstlineLeft SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const iconPackOfTextFirstlineLeft: TheIconSelfPack = [
  'TextFirstlineLeft',
  IconTextFirstlineLeftStrokeRounded,
  IconTextFirstlineLeftDuotoneRounded,
  IconTextFirstlineLeftTwotoneRounded,
  IconTextFirstlineLeftSolidRounded,
  IconTextFirstlineLeftBulkRounded,
  IconTextFirstlineLeftStrokeSharp,
  IconTextFirstlineLeftSolidSharp,
];