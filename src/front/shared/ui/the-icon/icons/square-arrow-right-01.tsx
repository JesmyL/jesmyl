...
export const IconSquareArrowRight01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowRight01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSquareArrowRight01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowRight01 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconSquareArrowRight01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowRight01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSquareArrowRight01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowRight01 SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconSquareArrowRight01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowRight01 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconSquareArrowRight01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowRight01 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const IconSquareArrowRight01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SquareArrowRight01 SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfSquareArrowRight01: TheIconSelfPack = [
  'SquareArrowRight01',
  IconSquareArrowRight01StrokeRounded,
  IconSquareArrowRight01DuotoneRounded,
  IconSquareArrowRight01TwotoneRounded,
  IconSquareArrowRight01SolidRounded,
  IconSquareArrowRight01BulkRounded,
  IconSquareArrowRight01StrokeSharp,
  IconSquareArrowRight01SolidSharp,
];