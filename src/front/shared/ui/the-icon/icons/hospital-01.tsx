...
export const IconHospital01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Hospital01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconHospital01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Hospital01 DuotoneRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconHospital01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Hospital01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconHospital01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Hospital01 SolidRounded"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const IconHospital01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Hospital01 BulkRounded"
    >
      <path 
        d={d.d15}
        i-c="f o7"
...
export const IconHospital01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Hospital01 StrokeSharp"
    >
      <path 
        d={d.d18}
        i-c="s sj sw"
...
export const IconHospital01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Hospital01 SolidSharp"
    >
      <path 
        d={d.d25}
        i-c="c f fr"
...
export const iconPackOfHospital01: TheIconSelfPack = [
  'Hospital01',
  IconHospital01StrokeRounded,
  IconHospital01DuotoneRounded,
  IconHospital01TwotoneRounded,
  IconHospital01SolidRounded,
  IconHospital01BulkRounded,
  IconHospital01StrokeSharp,
  IconHospital01SolidSharp,
];