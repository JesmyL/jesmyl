...
export const iconPackOfCorn: TheIconSelfPack = [
  'Corn',
  IconCornStrokeRounded,
  IconCornDuotoneRounded,
  IconCornTwotoneRounded,
  IconCornSolidRounded,
  IconCornBulkRounded,
  IconCornStrokeSharp,
  IconCornSolidSharp,
];