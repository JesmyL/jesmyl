...
export const IconTradeDownStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TradeDown StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTradeDownDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TradeDown DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTradeDownTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TradeDown TwotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="o7 s sj sr sw"
...
export const IconTradeDownSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TradeDown SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconTradeDownBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TradeDown BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconTradeDownStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TradeDown StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s ss sw"
...
export const iconPackOfTradeDown: TheIconSelfPack = [
  'TradeDown',
  IconTradeDownStrokeRounded,
  IconTradeDownDuotoneRounded,
  IconTradeDownTwotoneRounded,
  IconTradeDownSolidRounded,
  IconTradeDownBulkRounded,
  IconTradeDownStrokeSharp,
  IconTradeDownSolidSharp,
];