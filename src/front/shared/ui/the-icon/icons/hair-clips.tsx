...
export const IconHairClipsStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HairClips StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconHairClipsDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HairClips DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconHairClipsTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HairClips TwotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="s sj sr sw"
...
export const IconHairClipsSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HairClips SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconHairClipsBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HairClips BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d8}
...
export const IconHairClipsStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="HairClips StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sw"
...
export const iconPackOfHairClips: TheIconSelfPack = [
  'HairClips',
  IconHairClipsStrokeRounded,
  IconHairClipsDuotoneRounded,
  IconHairClipsTwotoneRounded,
  IconHairClipsSolidRounded,
  IconHairClipsBulkRounded,
  IconHairClipsStrokeSharp,
  IconHairClipsSolidSharp,
];