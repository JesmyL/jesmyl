...
export const iconPackOfFry: TheIconSelfPack = [
  'Fry',
  IconFryStrokeRounded,
  IconFryDuotoneRounded,
  IconFryTwotoneRounded,
  IconFrySolidRounded,
  IconFryBulkRounded,
  IconFryStrokeSharp,
  IconFrySolidSharp,
