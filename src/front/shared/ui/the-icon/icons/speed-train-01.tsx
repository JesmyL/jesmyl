...
export const IconSpeedTrain01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpeedTrain01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSpeedTrain01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpeedTrain01 DuotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr o7"
...
export const IconSpeedTrain01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpeedTrain01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSpeedTrain01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpeedTrain01 SolidRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const IconSpeedTrain01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpeedTrain01 BulkRounded"
    >
      <path 
        d={d.d14}
        i-c="f o7"
...
export const IconSpeedTrain01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpeedTrain01 StrokeSharp"
    >
      <path 
        d={d.d17}
        i-c="s sj sw"
...
export const IconSpeedTrain01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SpeedTrain01 SolidSharp"
    >
      <path 
        d={d.d22}
        i-c="c f fr"
...
export const iconPackOfSpeedTrain01: TheIconSelfPack = [
  'SpeedTrain01',
  IconSpeedTrain01StrokeRounded,
  IconSpeedTrain01DuotoneRounded,
  IconSpeedTrain01TwotoneRounded,
  IconSpeedTrain01SolidRounded,
  IconSpeedTrain01BulkRounded,
  IconSpeedTrain01StrokeSharp,
  IconSpeedTrain01SolidSharp,
];