...
export const IconSdCardDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SdCard DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconSdCardTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SdCard TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfSdCard: TheIconSelfPack = [
  'SdCard',
  IconSdCardStrokeRounded,
  IconSdCardDuotoneRounded,
  IconSdCardTwotoneRounded,
  IconSdCardSolidRounded,
  IconSdCardBulkRounded,
  IconSdCardStrokeSharp,
  IconSdCardSolidSharp,
];