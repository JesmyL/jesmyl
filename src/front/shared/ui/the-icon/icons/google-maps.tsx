...
export const IconGoogleMapsStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoogleMaps StrokeRounded"
    >
      <circle 
        cx="12"
        cy="9"
...
export const IconGoogleMapsDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoogleMaps DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconGoogleMapsTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoogleMaps TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="9"
...
export const IconGoogleMapsSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoogleMaps SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconGoogleMapsBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoogleMaps BulkRounded"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const IconGoogleMapsStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoogleMaps StrokeSharp"
    >
      <circle 
        cx="12"
        cy="9"
...
export const IconGoogleMapsSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoogleMaps SolidSharp"
    >
      <path 
        d={d.d15}
        i-c="f"
...
export const iconPackOfGoogleMaps: TheIconSelfPack = [
  'GoogleMaps',
  IconGoogleMapsStrokeRounded,
  IconGoogleMapsDuotoneRounded,
  IconGoogleMapsTwotoneRounded,
  IconGoogleMapsSolidRounded,
  IconGoogleMapsBulkRounded,
  IconGoogleMapsStrokeSharp,
  IconGoogleMapsSolidSharp,
];