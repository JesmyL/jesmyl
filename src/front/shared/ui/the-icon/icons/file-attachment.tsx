...
export const IconFileAttachmentStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileAttachment StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconFileAttachmentDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileAttachment DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconFileAttachmentTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileAttachment TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const IconFileAttachmentSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileAttachment SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconFileAttachmentBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileAttachment BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconFileAttachmentStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileAttachment StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const IconFileAttachmentSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileAttachment SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfFileAttachment: TheIconSelfPack = [
  'FileAttachment',
  IconFileAttachmentStrokeRounded,
  IconFileAttachmentDuotoneRounded,
  IconFileAttachmentTwotoneRounded,
  IconFileAttachmentSolidRounded,
  IconFileAttachmentBulkRounded,
  IconFileAttachmentStrokeSharp,
  IconFileAttachmentSolidSharp,
];