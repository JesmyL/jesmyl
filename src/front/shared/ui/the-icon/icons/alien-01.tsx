...
export const IconAlien01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Alien01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconAlien01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Alien01 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconAlien01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Alien01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sw"
...
export const iconPackOfAlien01: TheIconSelfPack = [
  'Alien01',
  IconAlien01StrokeRounded,
  IconAlien01DuotoneRounded,
  IconAlien01TwotoneRounded,
  IconAlien01SolidRounded,
  IconAlien01BulkRounded,
  IconAlien01StrokeSharp,
  IconAlien01SolidSharp,
];