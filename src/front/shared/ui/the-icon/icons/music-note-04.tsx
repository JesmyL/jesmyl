...
export const IconMusicNote04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNote04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMusicNote04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNote04 DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMusicNote04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNote04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconMusicNote04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNote04 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconMusicNote04BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNote04 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconMusicNote04StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNote04 StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sr sw"
...
export const IconMusicNote04SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MusicNote04 SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfMusicNote04: TheIconSelfPack = [
  'MusicNote04',
  IconMusicNote04StrokeRounded,
  IconMusicNote04DuotoneRounded,
  IconMusicNote04TwotoneRounded,
  IconMusicNote04SolidRounded,
  IconMusicNote04BulkRounded,
  IconMusicNote04StrokeSharp,
  IconMusicNote04SolidSharp,
];