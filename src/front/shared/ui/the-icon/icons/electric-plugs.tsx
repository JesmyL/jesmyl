...
export const IconElectricPlugsStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ElectricPlugs StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconElectricPlugsDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ElectricPlugs DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconElectricPlugsTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ElectricPlugs TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconElectricPlugsSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ElectricPlugs SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconElectricPlugsBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ElectricPlugs BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconElectricPlugsStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ElectricPlugs StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconElectricPlugsSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ElectricPlugs SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfElectricPlugs: TheIconSelfPack = [
  'ElectricPlugs',
  IconElectricPlugsStrokeRounded,
  IconElectricPlugsDuotoneRounded,
  IconElectricPlugsTwotoneRounded,
  IconElectricPlugsSolidRounded,
  IconElectricPlugsBulkRounded,
  IconElectricPlugsStrokeSharp,
  IconElectricPlugsSolidSharp,
];