...
export const IconShoppingCartCheckIn01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingCartCheckIn01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShoppingCartCheckIn01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingCartCheckIn01 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconShoppingCartCheckIn01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingCartCheckIn01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconShoppingCartCheckIn01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingCartCheckIn01 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconShoppingCartCheckIn01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingCartCheckIn01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconShoppingCartCheckIn01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingCartCheckIn01 StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconShoppingCartCheckIn01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingCartCheckIn01 SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfShoppingCartCheckIn01: TheIconSelfPack = [
  ...
  IconShoppingCartCheckIn01StrokeRounded,
  IconShoppingCartCheckIn01DuotoneRounded,
  IconShoppingCartCheckIn01TwotoneRounded,
  IconShoppingCartCheckIn01SolidRounded,
  IconShoppingCartCheckIn01BulkRounded,
  IconShoppingCartCheckIn01StrokeSharp,
  IconShoppingCartCheckIn01SolidSharp,
];