...
export const IconBookmarkBlock01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkBlock01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconBookmarkBlock01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkBlock01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconBookmarkBlock01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkBlock01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sw"
...
export const IconBookmarkBlock01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkBlock01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconBookmarkBlock01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkBlock01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconBookmarkBlock01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkBlock01 StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconBookmarkBlock01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkBlock01 SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="c f fr"
...
export const iconPackOfBookmarkBlock01: TheIconSelfPack = [
  'BookmarkBlock01',
  IconBookmarkBlock01StrokeRounded,
  IconBookmarkBlock01DuotoneRounded,
  IconBookmarkBlock01TwotoneRounded,
  IconBookmarkBlock01SolidRounded,
  IconBookmarkBlock01BulkRounded,
  IconBookmarkBlock01StrokeSharp,
  IconBookmarkBlock01SolidSharp,
];