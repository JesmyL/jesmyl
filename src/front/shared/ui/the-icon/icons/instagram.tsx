...
export const IconInstagramStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Instagram StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconInstagramDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Instagram DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconInstagramTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Instagram TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconInstagramSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Instagram SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconInstagramBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Instagram BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconInstagramStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Instagram StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj ss sw"
...
export const iconPackOfInstagram: TheIconSelfPack = [
  'Instagram',
  IconInstagramStrokeRounded,
  IconInstagramDuotoneRounded,
  IconInstagramTwotoneRounded,
  IconInstagramSolidRounded,
  IconInstagramBulkRounded,
  IconInstagramStrokeSharp,
  IconInstagramSolidSharp,
];