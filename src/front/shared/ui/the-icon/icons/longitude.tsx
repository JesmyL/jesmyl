...
export const IconLongitudeStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Longitude StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconLongitudeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Longitude DuotoneRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d4}
...
export const IconLongitudeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Longitude TwotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="o7 s sw"
...
export const IconLongitudeSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Longitude SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconLongitudeBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Longitude BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d7}
...
export const IconLongitudeStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Longitude StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const iconPackOfLongitude: TheIconSelfPack = [
  'Longitude',
  IconLongitudeStrokeRounded,
  IconLongitudeDuotoneRounded,
  IconLongitudeTwotoneRounded,
  IconLongitudeSolidRounded,
  IconLongitudeBulkRounded,
  IconLongitudeStrokeSharp,
  IconLongitudeSolidSharp,
];