...
export const IconMouse03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mouse03 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMouse03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mouse03 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconMouse03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Mouse03 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfMouse03: TheIconSelfPack = [
  'Mouse03',
  IconMouse03StrokeRounded,
  IconMouse03DuotoneRounded,
  IconMouse03TwotoneRounded,
  IconMouse03SolidRounded,
  IconMouse03BulkRounded,
  IconMouse03StrokeSharp,
  IconMouse03SolidSharp,
];