...
export const IconBookmarkMinus01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkMinus01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBookmarkMinus01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkMinus01 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconBookmarkMinus01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkMinus01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBookmarkMinus01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkMinus01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconBookmarkMinus01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkMinus01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconBookmarkMinus01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkMinus01 StrokeSharp"
    >
      <path 
        d={d.d8}
        i-c="s sj sw"
...
export const IconBookmarkMinus01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BookmarkMinus01 SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const iconPackOfBookmarkMinus01: TheIconSelfPack = [
  'BookmarkMinus01',
  IconBookmarkMinus01StrokeRounded,
  IconBookmarkMinus01DuotoneRounded,
  IconBookmarkMinus01TwotoneRounded,
  IconBookmarkMinus01SolidRounded,
  IconBookmarkMinus01BulkRounded,
  IconBookmarkMinus01StrokeSharp,
  IconBookmarkMinus01SolidSharp,
];