...
export const IconTypeCursorStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TypeCursor StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconTypeCursorDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TypeCursor DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconTypeCursorTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TypeCursor TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconTypeCursorSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TypeCursor SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconTypeCursorBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TypeCursor BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconTypeCursorStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TypeCursor StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const IconTypeCursorSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TypeCursor SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfTypeCursor: TheIconSelfPack = [
  'TypeCursor',
  IconTypeCursorStrokeRounded,
  IconTypeCursorDuotoneRounded,
  IconTypeCursorTwotoneRounded,
  IconTypeCursorSolidRounded,
  IconTypeCursorBulkRounded,
  IconTypeCursorStrokeSharp,
  IconTypeCursorSolidSharp,
];