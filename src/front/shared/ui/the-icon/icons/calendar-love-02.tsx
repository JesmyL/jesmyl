...
export const IconCalendarLove02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarLove02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCalendarLove02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarLove02 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const IconCalendarLove02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarLove02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCalendarLove02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarLove02 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconCalendarLove02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarLove02 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconCalendarLove02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarLove02 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sr sw"
...
export const IconCalendarLove02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarLove02 SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfCalendarLove02: TheIconSelfPack = [
  'CalendarLove02',
  IconCalendarLove02StrokeRounded,
  IconCalendarLove02DuotoneRounded,
  IconCalendarLove02TwotoneRounded,
  IconCalendarLove02SolidRounded,
  IconCalendarLove02BulkRounded,
  IconCalendarLove02StrokeSharp,
  IconCalendarLove02SolidSharp,
];