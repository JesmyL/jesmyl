...
export const IconDatabaseAddStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DatabaseAdd StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDatabaseAddDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DatabaseAdd DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconDatabaseAddTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DatabaseAdd TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconDatabaseAddSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DatabaseAdd SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconDatabaseAddBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DatabaseAdd BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d9}
...
export const IconDatabaseAddStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DatabaseAdd StrokeSharp"
    >
      <path 
        d={d.d12}
        i-c="s sj sw"
...
export const IconDatabaseAddSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DatabaseAdd SolidSharp"
    >
      <path 
        d={d.d18}
        i-c="c f fr"
...
export const iconPackOfDatabaseAdd: TheIconSelfPack = [
  'DatabaseAdd',
  IconDatabaseAddStrokeRounded,
  IconDatabaseAddDuotoneRounded,
  IconDatabaseAddTwotoneRounded,
  IconDatabaseAddSolidRounded,
  IconDatabaseAddBulkRounded,
  IconDatabaseAddStrokeSharp,
  IconDatabaseAddSolidSharp,
];