...
export const iconPackOfGrok: TheIconSelfPack = [
  'Grok',
  IconGrokStrokeRounded,
  IconGrokDuotoneRounded,
  IconGrokTwotoneRounded,
  IconGrokSolidRounded,
  IconGrokBulkRounded,
  IconGrokStrokeSharp,
  IconGrokSolidSharp,
];