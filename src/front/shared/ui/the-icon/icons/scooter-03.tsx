...
export const IconScooter03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Scooter03 StrokeRounded"
    >
      <circle 
        cx="12"
        cy="4"
...
export const IconScooter03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Scooter03 DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="4"
...
export const IconScooter03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Scooter03 TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="4"
...
export const IconScooter03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Scooter03 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconScooter03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Scooter03 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconScooter03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Scooter03 StrokeSharp"
    >
      <circle 
        cx="12"
        cy="4"
...
export const iconPackOfScooter03: TheIconSelfPack = [
  'Scooter03',
  IconScooter03StrokeRounded,
  IconScooter03DuotoneRounded,
  IconScooter03TwotoneRounded,
  IconScooter03SolidRounded,
  IconScooter03BulkRounded,
  IconScooter03StrokeSharp,
  IconScooter03SolidSharp,
];