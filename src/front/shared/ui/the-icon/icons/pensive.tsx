...
export const IconPensiveStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pensive StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconPensiveDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pensive DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconPensiveTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Pensive TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const iconPackOfPensive: TheIconSelfPack = [
  'Pensive',
  IconPensiveStrokeRounded,
  IconPensiveDuotoneRounded,
  IconPensiveTwotoneRounded,
  IconPensiveSolidRounded,
  IconPensiveBulkRounded,
  IconPensiveStrokeSharp,
  IconPensiveSolidSharp,
];