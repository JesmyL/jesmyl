...
export const IconBabyBoyDressStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BabyBoyDress StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBabyBoyDressDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BabyBoyDress DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconBabyBoyDressTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BabyBoyDress TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBabyBoyDressSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BabyBoyDress SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconBabyBoyDressBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BabyBoyDress BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconBabyBoyDressStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BabyBoyDress StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const IconBabyBoyDressSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BabyBoyDress SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfBabyBoyDress: TheIconSelfPack = [
  'BabyBoyDress',
  IconBabyBoyDressStrokeRounded,
  IconBabyBoyDressDuotoneRounded,
  IconBabyBoyDressTwotoneRounded,
  IconBabyBoyDressSolidRounded,
  IconBabyBoyDressBulkRounded,
  IconBabyBoyDressStrokeSharp,
  IconBabyBoyDressSolidSharp,
];