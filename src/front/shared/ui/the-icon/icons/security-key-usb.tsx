...
export const IconSecurityKeyUsbStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SecurityKeyUsb StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSecurityKeyUsbDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SecurityKeyUsb DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconSecurityKeyUsbTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SecurityKeyUsb TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSecurityKeyUsbSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SecurityKeyUsb SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconSecurityKeyUsbBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SecurityKeyUsb BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconSecurityKeyUsbStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SecurityKeyUsb StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s ss sw"
...
export const IconSecurityKeyUsbSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SecurityKeyUsb SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfSecurityKeyUsb: TheIconSelfPack = [
  'SecurityKeyUsb',
  IconSecurityKeyUsbStrokeRounded,
  IconSecurityKeyUsbDuotoneRounded,
  IconSecurityKeyUsbTwotoneRounded,
  IconSecurityKeyUsbSolidRounded,
  IconSecurityKeyUsbBulkRounded,
  IconSecurityKeyUsbStrokeSharp,
  IconSecurityKeyUsbSolidSharp,
];