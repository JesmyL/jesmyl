...
export const IconCalendarAdd01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarAdd01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCalendarAdd01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarAdd01 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconCalendarAdd01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarAdd01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCalendarAdd01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarAdd01 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconCalendarAdd01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarAdd01 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconCalendarAdd01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarAdd01 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconCalendarAdd01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarAdd01 SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const iconPackOfCalendarAdd01: TheIconSelfPack = [
  'CalendarAdd01',
  IconCalendarAdd01StrokeRounded,
  IconCalendarAdd01DuotoneRounded,
  IconCalendarAdd01TwotoneRounded,
  IconCalendarAdd01SolidRounded,
  IconCalendarAdd01BulkRounded,
  IconCalendarAdd01StrokeSharp,
  IconCalendarAdd01SolidSharp,
];