...
export const IconPaintBrush01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PaintBrush01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPaintBrush01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PaintBrush01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconPaintBrush01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PaintBrush01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconPaintBrush01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PaintBrush01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconPaintBrush01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PaintBrush01 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconPaintBrush01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PaintBrush01 StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj sr sw"
...
export const IconPaintBrush01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PaintBrush01 SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const iconPackOfPaintBrush01: TheIconSelfPack = [
  'PaintBrush01',
  IconPaintBrush01StrokeRounded,
  IconPaintBrush01DuotoneRounded,
  IconPaintBrush01TwotoneRounded,
  IconPaintBrush01SolidRounded,
  IconPaintBrush01BulkRounded,
  IconPaintBrush01StrokeSharp,
  IconPaintBrush01SolidSharp,
];