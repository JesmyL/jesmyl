...
export const IconMapsSquare01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapsSquare01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconMapsSquare01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapsSquare01 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr o7"
...
export const IconMapsSquare01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapsSquare01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sw"
...
export const IconMapsSquare01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapsSquare01 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconMapsSquare01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapsSquare01 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconMapsSquare01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapsSquare01 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sw"
...
export const IconMapsSquare01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MapsSquare01 SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const iconPackOfMapsSquare01: TheIconSelfPack = [
  'MapsSquare01',
  IconMapsSquare01StrokeRounded,
  IconMapsSquare01DuotoneRounded,
  IconMapsSquare01TwotoneRounded,
  IconMapsSquare01SolidRounded,
  IconMapsSquare01BulkRounded,
  IconMapsSquare01StrokeSharp,
  IconMapsSquare01SolidSharp,
];