...
export const IconSoftwareLicenseStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoftwareLicense StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSoftwareLicenseDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoftwareLicense DuotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconSoftwareLicenseTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoftwareLicense TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconSoftwareLicenseSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoftwareLicense SolidRounded"
    >
      <path 
        d={d.d10}
        i-c="c f fr"
...
export const IconSoftwareLicenseBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoftwareLicense BulkRounded"
    >
      <path 
        d={d.d11}
        i-c="f o7"
...
export const IconSoftwareLicenseStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoftwareLicense StrokeSharp"
    >
      <path 
        d={d.d15}
        i-c="s sj sw"
...
export const IconSoftwareLicenseSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SoftwareLicense SolidSharp"
    >
      <path 
        d={d.d17}
        i-c="c f fr"
...
export const iconPackOfSoftwareLicense: TheIconSelfPack = [
  'SoftwareLicense',
  IconSoftwareLicenseStrokeRounded,
  IconSoftwareLicenseDuotoneRounded,
  IconSoftwareLicenseTwotoneRounded,
  IconSoftwareLicenseSolidRounded,
  IconSoftwareLicenseBulkRounded,
  IconSoftwareLicenseStrokeSharp,
  IconSoftwareLicenseSolidSharp,
];