...
export const IconCoffeeBeansStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoffeeBeans StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCoffeeBeansDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoffeeBeans DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconCoffeeBeansTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoffeeBeans TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconCoffeeBeansSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoffeeBeans SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconCoffeeBeansBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoffeeBeans BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d6}
...
export const IconCoffeeBeansStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoffeeBeans StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconCoffeeBeansSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CoffeeBeans SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const iconPackOfCoffeeBeans: TheIconSelfPack = [
  'CoffeeBeans',
  IconCoffeeBeansStrokeRounded,
  IconCoffeeBeansDuotoneRounded,
  IconCoffeeBeansTwotoneRounded,
  IconCoffeeBeansSolidRounded,
  IconCoffeeBeansBulkRounded,
  IconCoffeeBeansStrokeSharp,
  IconCoffeeBeansSolidSharp,
];