...
export const IconDragDropHorizontalStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DragDropHorizontal StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDragDropHorizontalDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DragDropHorizontal DuotoneRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d1}
...
export const IconDragDropHorizontalTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DragDropHorizontal TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconDragDropHorizontalSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DragDropHorizontal SolidRounded"
    >
      <path 
        d={d.d2}
        i-c="c f fr"
...
export const IconDragDropHorizontalBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DragDropHorizontal BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr o7"
...
export const IconDragDropHorizontalStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DragDropHorizontal StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj ss sw"
...
export const IconDragDropHorizontalSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DragDropHorizontal SolidSharp"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const iconPackOfDragDropHorizontal: TheIconSelfPack = [
  'DragDropHorizontal',
  IconDragDropHorizontalStrokeRounded,
  IconDragDropHorizontalDuotoneRounded,
  IconDragDropHorizontalTwotoneRounded,
  IconDragDropHorizontalSolidRounded,
  IconDragDropHorizontalBulkRounded,
  IconDragDropHorizontalStrokeSharp,
  IconDragDropHorizontalSolidSharp,
];