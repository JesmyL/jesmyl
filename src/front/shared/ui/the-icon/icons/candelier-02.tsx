...
export const IconCandelier02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Candelier02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCandelier02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Candelier02 DuotoneRounded"
    >
      <path 
        d={d.d8}
        i-c="f o7"
...
export const IconCandelier02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Candelier02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCandelier02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Candelier02 SolidRounded"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const IconCandelier02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Candelier02 BulkRounded"
    >
      <path 
        d={d.d10}
        i-c="f o7"
...
export const IconCandelier02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Candelier02 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconCandelier02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Candelier02 SolidSharp"
    >
      <path 
        d={d.d22}
        i-c="f"
...
export const iconPackOfCandelier02: TheIconSelfPack = [
  'Candelier02',
  IconCandelier02StrokeRounded,
  IconCandelier02DuotoneRounded,
  IconCandelier02TwotoneRounded,
  IconCandelier02SolidRounded,
  IconCandelier02BulkRounded,
  IconCandelier02StrokeSharp,
  IconCandelier02SolidSharp,
];