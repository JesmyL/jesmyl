...
export const IconCastleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Castle DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconCastleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Castle TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfCastle: TheIconSelfPack = [
  'Castle',
  IconCastleStrokeRounded,
  IconCastleDuotoneRounded,
  IconCastleTwotoneRounded,
  IconCastleSolidRounded,
  IconCastleBulkRounded,
  IconCastleStrokeSharp,
  IconCastleSolidSharp,
];