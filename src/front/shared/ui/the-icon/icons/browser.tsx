...
export const IconBrowserStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Browser StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconBrowserDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Browser DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconBrowserTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Browser TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const iconPackOfBrowser: TheIconSelfPack = [
  'Browser',
  IconBrowserStrokeRounded,
  IconBrowserDuotoneRounded,
  IconBrowserTwotoneRounded,
  IconBrowserSolidRounded,
  IconBrowserBulkRounded,
  IconBrowserStrokeSharp,
  IconBrowserSolidSharp,
];