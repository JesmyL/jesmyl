...
export const iconPackOfLock: TheIconSelfPack = [
  'Lock',
  IconLockStrokeRounded,
  IconLockDuotoneRounded,
  IconLockTwotoneRounded,
  IconLockSolidRounded,
  IconLockBulkRounded,
  IconLockStrokeSharp,
  IconLockSolidSharp,
];