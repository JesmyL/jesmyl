...
export const IconCursorDisabled01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorDisabled01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCursorDisabled01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorDisabled01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconCursorDisabled01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorDisabled01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCursorDisabled01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorDisabled01 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="f"
...
export const IconCursorDisabled01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorDisabled01 BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconCursorDisabled01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorDisabled01 StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconCursorDisabled01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CursorDisabled01 SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfCursorDisabled01: TheIconSelfPack = [
  'CursorDisabled01',
  IconCursorDisabled01StrokeRounded,
  IconCursorDisabled01DuotoneRounded,
  IconCursorDisabled01TwotoneRounded,
  IconCursorDisabled01SolidRounded,
  IconCursorDisabled01BulkRounded,
  IconCursorDisabled01StrokeSharp,
  IconCursorDisabled01SolidSharp,
];