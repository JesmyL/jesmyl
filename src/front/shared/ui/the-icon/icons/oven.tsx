...
export const iconPackOfOven: TheIconSelfPack = [
  'Oven',
  IconOvenStrokeRounded,
  IconOvenDuotoneRounded,
  IconOvenTwotoneRounded,
  IconOvenSolidRounded,
  IconOvenBulkRounded,
  IconOvenStrokeSharp,
  IconOvenSolidSharp,
];