...
export const IconBitcoinPieChartStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinPieChart StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconBitcoinPieChartDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinPieChart DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconBitcoinPieChartTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinPieChart TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconBitcoinPieChartSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinPieChart SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconBitcoinPieChartBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinPieChart BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconBitcoinPieChartStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinPieChart StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconBitcoinPieChartSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BitcoinPieChart SolidSharp"
    >
      <path 
        d={d.d10}
        i-c="f"
...
export const iconPackOfBitcoinPieChart: TheIconSelfPack = [
  'BitcoinPieChart',
  IconBitcoinPieChartStrokeRounded,
  IconBitcoinPieChartDuotoneRounded,
  IconBitcoinPieChartTwotoneRounded,
  IconBitcoinPieChartSolidRounded,
  IconBitcoinPieChartBulkRounded,
  IconBitcoinPieChartStrokeSharp,
  IconBitcoinPieChartSolidSharp,
];