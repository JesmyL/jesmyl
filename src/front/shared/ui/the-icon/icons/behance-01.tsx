...
export const IconBehance01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Behance01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBehance01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Behance01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr o7"
...
export const IconBehance01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Behance01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBehance01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Behance01 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconBehance01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Behance01 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr"
...
export const IconBehance01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Behance01 StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const iconPackOfBehance01: TheIconSelfPack = [
  'Behance01',
  IconBehance01StrokeRounded,
  IconBehance01DuotoneRounded,
  IconBehance01TwotoneRounded,
  IconBehance01SolidRounded,
  IconBehance01BulkRounded,
  IconBehance01StrokeSharp,
  IconBehance01SolidSharp,
];