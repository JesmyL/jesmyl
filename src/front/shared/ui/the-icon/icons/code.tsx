...
export const iconPackOfCode: TheIconSelfPack = [
  'Code',
  IconCodeStrokeRounded,
  IconCodeDuotoneRounded,
  IconCodeTwotoneRounded,
  IconCodeSolidRounded,
  IconCodeBulkRounded,
  IconCodeStrokeSharp,
  IconCodeSolidSharp,
];