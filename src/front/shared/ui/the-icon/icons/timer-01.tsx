...
export const IconTimer01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Timer01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTimer01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Timer01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr o7"
...
export const IconTimer01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Timer01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfTimer01: TheIconSelfPack = [
  'Timer01',
  IconTimer01StrokeRounded,
  IconTimer01DuotoneRounded,
  IconTimer01TwotoneRounded,
  IconTimer01SolidRounded,
  IconTimer01BulkRounded,
  IconTimer01StrokeSharp,
  IconTimer01SolidSharp,
];