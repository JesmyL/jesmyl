...
export const IconTextCenterlineLeftStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextCenterlineLeft StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTextCenterlineLeftDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextCenterlineLeft DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconTextCenterlineLeftTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextCenterlineLeft TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconTextCenterlineLeftSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextCenterlineLeft SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconTextCenterlineLeftBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextCenterlineLeft BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconTextCenterlineLeftStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextCenterlineLeft StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj ss sw"
...
export const IconTextCenterlineLeftSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TextCenterlineLeft SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfTextCenterlineLeft: TheIconSelfPack = [
  'TextCenterlineLeft',
  IconTextCenterlineLeftStrokeRounded,
  IconTextCenterlineLeftDuotoneRounded,
  IconTextCenterlineLeftTwotoneRounded,
  IconTextCenterlineLeftSolidRounded,
  IconTextCenterlineLeftBulkRounded,
  IconTextCenterlineLeftStrokeSharp,
  IconTextCenterlineLeftSolidSharp,
];