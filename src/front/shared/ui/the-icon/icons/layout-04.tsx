...
export const IconLayout04StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout04 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLayout04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout04 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconLayout04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout04 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconLayout04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Layout04 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const iconPackOfLayout04: TheIconSelfPack = [
  'Layout04',
  IconLayout04StrokeRounded,
  IconLayout04DuotoneRounded,
  IconLayout04TwotoneRounded,
  IconLayout04SolidRounded,
  IconLayout04BulkRounded,
  IconLayout04StrokeSharp,
  IconLayout04SolidSharp,
];