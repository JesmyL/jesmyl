...
export const IconRepeatDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Repeat DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconRepeatTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Repeat TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfRepeat: TheIconSelfPack = [
  'Repeat',
  IconRepeatStrokeRounded,
  IconRepeatDuotoneRounded,
  IconRepeatTwotoneRounded,
  IconRepeatSolidRounded,
  IconRepeatBulkRounded,
  IconRepeatStrokeSharp,
  IconRepeatSolidSharp,
];