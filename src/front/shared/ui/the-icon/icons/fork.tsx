...
export const iconPackOfFork: TheIconSelfPack = [
  'Fork',
  IconForkStrokeRounded,
  IconForkDuotoneRounded,
  IconForkTwotoneRounded,
  IconForkSolidRounded,
  IconForkBulkRounded,
  IconForkStrokeSharp,
  IconForkSolidSharp,
];