...
export const IconBloodPressureStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BloodPressure StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconBloodPressureDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BloodPressure DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconBloodPressureTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BloodPressure TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconBloodPressureSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BloodPressure SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconBloodPressureBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BloodPressure BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconBloodPressureStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BloodPressure StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sj sw"
...
export const IconBloodPressureSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="BloodPressure SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOfBloodPressure: TheIconSelfPack = [
  'BloodPressure',
  IconBloodPressureStrokeRounded,
  IconBloodPressureDuotoneRounded,
  IconBloodPressureTwotoneRounded,
  IconBloodPressureSolidRounded,
  IconBloodPressureBulkRounded,
  IconBloodPressureStrokeSharp,
  IconBloodPressureSolidSharp,
];