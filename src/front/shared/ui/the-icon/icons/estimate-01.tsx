...
export const IconEstimate01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Estimate01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconEstimate01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Estimate01 DuotoneRounded"
    >
      <path 
        d={d.d9}
        i-c="f o7"
...
export const IconEstimate01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Estimate01 TwotoneRounded"
    >
      <path 
        d={d.d10}
        i-c="s sr sw"
...
export const IconEstimate01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Estimate01 SolidRounded"
    >
      <path 
        d={d.d18}
        i-c="c f fr"
...
export const IconEstimate01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Estimate01 BulkRounded"
    >
      <path 
        d={d.d20}
        i-c="f o7"
...
export const IconEstimate01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Estimate01 StrokeSharp"
    >
      <path 
        d={d.d27}
        i-c="s sw"
...
export const IconEstimate01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Estimate01 SolidSharp"
    >
      <path 
        d={d.d30}
        i-c="c f fr"
...
export const iconPackOfEstimate01: TheIconSelfPack = [
  'Estimate01',
  IconEstimate01StrokeRounded,
  IconEstimate01DuotoneRounded,
  IconEstimate01TwotoneRounded,
  IconEstimate01SolidRounded,
  IconEstimate01BulkRounded,
  IconEstimate01StrokeSharp,
  IconEstimate01SolidSharp,
];