...
export const IconNoodlesStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Noodles StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconNoodlesDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Noodles DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconNoodlesTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Noodles TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfNoodles: TheIconSelfPack = [
  'Noodles',
  IconNoodlesStrokeRounded,
  IconNoodlesDuotoneRounded,
  IconNoodlesTwotoneRounded,
  IconNoodlesSolidRounded,
  IconNoodlesBulkRounded,
  IconNoodlesStrokeSharp,
  IconNoodlesSolidSharp,
];