...
export const IconIconjarStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Iconjar StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconIconjarDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Iconjar DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconIconjarTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Iconjar TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfIconjar: TheIconSelfPack = [
  'Iconjar',
  IconIconjarStrokeRounded,
  IconIconjarDuotoneRounded,
  IconIconjarTwotoneRounded,
  IconIconjarSolidRounded,
  IconIconjarBulkRounded,
  IconIconjarStrokeSharp,
  IconIconjarSolidSharp,
];