...
export const IconTennisBallStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TennisBall StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconTennisBallDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TennisBall DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconTennisBallTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TennisBall TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconTennisBallSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TennisBall SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconTennisBallBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TennisBall BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr o7"
...
export const IconTennisBallStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TennisBall StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconTennisBallSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="TennisBall SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const iconPackOfTennisBall: TheIconSelfPack = [
  'TennisBall',
  IconTennisBallStrokeRounded,
  IconTennisBallDuotoneRounded,
  IconTennisBallTwotoneRounded,
  IconTennisBallSolidRounded,
  IconTennisBallBulkRounded,
  IconTennisBallStrokeSharp,
  IconTennisBallSolidSharp,
];