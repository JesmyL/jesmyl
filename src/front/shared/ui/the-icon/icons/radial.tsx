...
export const IconRadialDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Radial DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconRadialTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Radial TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const iconPackOfRadial: TheIconSelfPack = [
  'Radial',
  IconRadialStrokeRounded,
  IconRadialDuotoneRounded,
  IconRadialTwotoneRounded,
  IconRadialSolidRounded,
  IconRadialBulkRounded,
  IconRadialStrokeSharp,
  IconRadialSolidSharp,
];