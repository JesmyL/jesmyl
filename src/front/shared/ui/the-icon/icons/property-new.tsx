...
export const IconPropertyNewStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PropertyNew StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPropertyNewDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PropertyNew DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconPropertyNewTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PropertyNew TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconPropertyNewSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PropertyNew SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const IconPropertyNewBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PropertyNew BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f o7"
...
export const IconPropertyNewStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PropertyNew StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconPropertyNewSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="PropertyNew SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="f"
...
export const iconPackOfPropertyNew: TheIconSelfPack = [
  'PropertyNew',
  IconPropertyNewStrokeRounded,
  IconPropertyNewDuotoneRounded,
  IconPropertyNewTwotoneRounded,
  IconPropertyNewSolidRounded,
  IconPropertyNewBulkRounded,
  IconPropertyNewStrokeSharp,
  IconPropertyNewSolidSharp,
];