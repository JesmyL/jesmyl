...
export const IconSunCloud01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SunCloud01 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSunCloud01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SunCloud01 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconSunCloud01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SunCloud01 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconSunCloud01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SunCloud01 SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconSunCloud01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SunCloud01 BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconSunCloud01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SunCloud01 StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconSunCloud01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SunCloud01 SolidSharp"
    >
      <path 
        d={d.d6}
        i-c="c f fr"
...
export const iconPackOfSunCloud01: TheIconSelfPack = [
  'SunCloud01',
  IconSunCloud01StrokeRounded,
  IconSunCloud01DuotoneRounded,
  IconSunCloud01TwotoneRounded,
  IconSunCloud01SolidRounded,
  IconSunCloud01BulkRounded,
  IconSunCloud01StrokeSharp,
  IconSunCloud01SolidSharp,
];