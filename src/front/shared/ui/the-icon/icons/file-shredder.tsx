...
export const IconFileShredderStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileShredder StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFileShredderDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileShredder DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconFileShredderTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileShredder TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFileShredderSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileShredder SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconFileShredderBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileShredder BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const IconFileShredderStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileShredder StrokeSharp"
    >
      <path 
        d={d.d11}
        i-c="s sj ss sw"
...
export const IconFileShredderSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FileShredder SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfFileShredder: TheIconSelfPack = [
  'FileShredder',
  IconFileShredderStrokeRounded,
  IconFileShredderDuotoneRounded,
  IconFileShredderTwotoneRounded,
  IconFileShredderSolidRounded,
  IconFileShredderBulkRounded,
  IconFileShredderStrokeSharp,
  IconFileShredderSolidSharp,
];