...
export const IconSailboatCoastalStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SailboatCoastal StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconSailboatCoastalDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SailboatCoastal DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconSailboatCoastalTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SailboatCoastal TwotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="s sr sw"
...
export const IconSailboatCoastalSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SailboatCoastal SolidRounded"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const IconSailboatCoastalBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SailboatCoastal BulkRounded"
    >
      <path 
        d={d.d9}
        i-c="f"
...
export const IconSailboatCoastalStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SailboatCoastal StrokeSharp"
    >
      <path 
        d={d.d14}
        i-c="s sw"
...
export const IconSailboatCoastalSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="SailboatCoastal SolidSharp"
    >
      <path 
        d={d.d18}
        i-c="f"
...
export const iconPackOfSailboatCoastal: TheIconSelfPack = [
  'SailboatCoastal',
  IconSailboatCoastalStrokeRounded,
  IconSailboatCoastalDuotoneRounded,
  IconSailboatCoastalTwotoneRounded,
  IconSailboatCoastalSolidRounded,
  IconSailboatCoastalBulkRounded,
  IconSailboatCoastalStrokeSharp,
  IconSailboatCoastalSolidSharp,
];