...
export const IconGoForward5SecStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoForward5Sec StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGoForward5SecDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoForward5Sec DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGoForward5SecTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoForward5Sec TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconGoForward5SecSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoForward5Sec SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconGoForward5SecBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoForward5Sec BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconGoForward5SecStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoForward5Sec StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sj sw"
...
export const IconGoForward5SecSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="GoForward5Sec SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfGoForward5Sec: TheIconSelfPack = [
  'GoForward5Sec',
  IconGoForward5SecStrokeRounded,
  IconGoForward5SecDuotoneRounded,
  IconGoForward5SecTwotoneRounded,
  IconGoForward5SecSolidRounded,
  IconGoForward5SecBulkRounded,
  IconGoForward5SecStrokeSharp,
  IconGoForward5SecSolidSharp,
];