...
export const IconDispleasedStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Displeased StrokeRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconDispleasedDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Displeased DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconDispleasedTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Displeased TwotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconDispleasedSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Displeased SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="c f fr"
...
export const IconDispleasedBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Displeased BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconDispleasedStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Displeased StrokeSharp"
    >
      <circle 
        cx="12"
        cy="12"
...
export const IconDispleasedSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Displeased SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfDispleased: TheIconSelfPack = [
  'Displeased',
  IconDispleasedStrokeRounded,
  IconDispleasedDuotoneRounded,
  IconDispleasedTwotoneRounded,
  IconDispleasedSolidRounded,
  IconDispleasedBulkRounded,
  IconDispleasedStrokeSharp,
  IconDispleasedSolidSharp,
];