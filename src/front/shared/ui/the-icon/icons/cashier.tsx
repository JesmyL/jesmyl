...
export const IconCashierStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cashier StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const IconCashierDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cashier DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconCashierTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Cashier TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sr sw"
...
export const iconPackOfCashier: TheIconSelfPack = [
  'Cashier',
  IconCashierStrokeRounded,
  IconCashierDuotoneRounded,
  IconCashierTwotoneRounded,
  IconCashierSolidRounded,
  IconCashierBulkRounded,
  IconCashierStrokeSharp,
  IconCashierSolidSharp,
];