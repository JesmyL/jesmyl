...
export const IconGalaxyDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Galaxy DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="c f fr o7"
...
export const IconGalaxyTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Galaxy TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sr sw"
...
export const iconPackOfGalaxy: TheIconSelfPack = [
  'Galaxy',
  IconGalaxyStrokeRounded,
  IconGalaxyDuotoneRounded,
  IconGalaxyTwotoneRounded,
  IconGalaxySolidRounded,
  IconGalaxyBulkRounded,
  IconGalaxyStrokeSharp,
  IconGalaxySolidSharp,
];