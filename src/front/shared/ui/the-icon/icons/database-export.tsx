...
export const IconDatabaseExportStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DatabaseExport StrokeRounded"
    >
      <ellipse 
        cx="11"
        cy="5"
...
export const IconDatabaseExportDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DatabaseExport DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconDatabaseExportTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DatabaseExport TwotoneRounded"
    >
      <ellipse 
        cx="11"
        cy="5"
...
export const IconDatabaseExportSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DatabaseExport SolidRounded"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const IconDatabaseExportBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DatabaseExport BulkRounded"
    >
      <g    i-c="o7">
      <path 
        d={d.d7}
...
export const IconDatabaseExportStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DatabaseExport StrokeSharp"
    >
      <ellipse 
        cx="11"
        cy="5"
...
export const IconDatabaseExportSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="DatabaseExport SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfDatabaseExport: TheIconSelfPack = [
  'DatabaseExport',
  IconDatabaseExportStrokeRounded,
  IconDatabaseExportDuotoneRounded,
  IconDatabaseExportTwotoneRounded,
  IconDatabaseExportSolidRounded,
  IconDatabaseExportBulkRounded,
  IconDatabaseExportStrokeSharp,
  IconDatabaseExportSolidSharp,
];