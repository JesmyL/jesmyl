...
export const IconYoga01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Yoga01 DuotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconYoga01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="Yoga01 TwotoneRounded"
    >
      <path 
        d={d.d7}
        i-c="s sj sr sw"
...
export const iconPackOfYoga01: TheIconSelfPack = [
  'Yoga01',
  IconYoga01StrokeRounded,
  IconYoga01DuotoneRounded,
  IconYoga01TwotoneRounded,
  IconYoga01SolidRounded,
  IconYoga01BulkRounded,
  IconYoga01StrokeSharp,
  IconYoga01SolidSharp,
];