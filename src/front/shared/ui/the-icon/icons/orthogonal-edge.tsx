...
export const IconOrthogonalEdgeStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OrthogonalEdge StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconOrthogonalEdgeDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OrthogonalEdge DuotoneRounded"
    >
      <path 
        d={d.d2}
        i-c="f o7"
...
export const IconOrthogonalEdgeTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OrthogonalEdge TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sw"
...
export const IconOrthogonalEdgeSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OrthogonalEdge SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconOrthogonalEdgeBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OrthogonalEdge BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconOrthogonalEdgeStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OrthogonalEdge StrokeSharp"
    >
      <path 
        d={d.d1}
        i-c="s sj sw"
...
export const IconOrthogonalEdgeSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="OrthogonalEdge SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="f"
...
export const iconPackOfOrthogonalEdge: TheIconSelfPack = [
  'OrthogonalEdge',
  IconOrthogonalEdgeStrokeRounded,
  IconOrthogonalEdgeDuotoneRounded,
  IconOrthogonalEdgeTwotoneRounded,
  IconOrthogonalEdgeSolidRounded,
  IconOrthogonalEdgeBulkRounded,
  IconOrthogonalEdgeStrokeSharp,
  IconOrthogonalEdgeSolidSharp,
];