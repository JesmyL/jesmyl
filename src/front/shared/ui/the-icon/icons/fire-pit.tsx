...
export const IconFirePitStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FirePit StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconFirePitDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FirePit DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconFirePitTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="FirePit TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const iconPackOfFirePit: TheIconSelfPack = [
  'FirePit',
  IconFirePitStrokeRounded,
  IconFirePitDuotoneRounded,
  IconFirePitTwotoneRounded,
  IconFirePitSolidRounded,
  IconFirePitBulkRounded,
  IconFirePitStrokeSharp,
  IconFirePitSolidSharp,
];