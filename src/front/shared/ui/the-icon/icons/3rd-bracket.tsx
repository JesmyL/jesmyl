...
export const Icon3rdBracketStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="3rdBracket StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const Icon3rdBracketDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="3rdBracket DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const Icon3rdBracketTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="3rdBracket TwotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="o7 s sj sr sw"
...
export const Icon3rdBracketSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="3rdBracket SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const Icon3rdBracketBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="3rdBracket BulkRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr o7"
...
export const Icon3rdBracketStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="3rdBracket StrokeSharp"
    >
      <path 
        d={d.d7}
        i-c="s sw"
...
export const Icon3rdBracketSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="3rdBracket SolidSharp"
    >
      <path 
        d={d.d9}
        i-c="c f fr"
...
export const iconPackOf3rdBracket: TheIconSelfPack = [
  '3rdBracket',
  Icon3rdBracketStrokeRounded,
  Icon3rdBracketDuotoneRounded,
  Icon3rdBracketTwotoneRounded,
  Icon3rdBracketSolidRounded,
  Icon3rdBracketBulkRounded,
  Icon3rdBracketStrokeSharp,
  Icon3rdBracketSolidSharp,
];