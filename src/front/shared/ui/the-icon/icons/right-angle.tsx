...
export const IconRightAngleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RightAngle StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRightAngleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RightAngle DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o4"
...
export const IconRightAngleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RightAngle TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconRightAngleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RightAngle SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconRightAngleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RightAngle BulkRounded"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const IconRightAngleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RightAngle StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const IconRightAngleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="RightAngle SolidSharp"
    >
      <path 
        d={d.d11}
        i-c="f"
...
export const iconPackOfRightAngle: TheIconSelfPack = [
  'RightAngle',
  IconRightAngleStrokeRounded,
  IconRightAngleDuotoneRounded,
  IconRightAngleTwotoneRounded,
  IconRightAngleSolidRounded,
  IconRightAngleBulkRounded,
  IconRightAngleStrokeSharp,
  IconRightAngleSolidSharp,
];