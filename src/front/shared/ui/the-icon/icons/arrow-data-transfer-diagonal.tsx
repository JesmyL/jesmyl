...
export const IconArrowDataTransferDiagonalStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowDataTransferDiagonal StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconArrowDataTransferDiagonalDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowDataTransferDiagonal DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconArrowDataTransferDiagonalTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowDataTransferDiagonal TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const IconArrowDataTransferDiagonalSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowDataTransferDiagonal SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconArrowDataTransferDiagonalBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowDataTransferDiagonal BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconArrowDataTransferDiagonalStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowDataTransferDiagonal StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sj sw"
...
export const IconArrowDataTransferDiagonalSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowDataTransferDiagonal SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="c f fr"
...
export const iconPackOfArrowDataTransferDiagonal: TheIconSelfPack = [
  ...
  IconArrowDataTransferDiagonalStrokeRounded,
  IconArrowDataTransferDiagonalDuotoneRounded,
  IconArrowDataTransferDiagonalTwotoneRounded,
  IconArrowDataTransferDiagonalSolidRounded,
  IconArrowDataTransferDiagonalBulkRounded,
  IconArrowDataTransferDiagonalStrokeSharp,
  IconArrowDataTransferDiagonalSolidSharp,
];