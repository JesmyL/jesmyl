...
export const IconArrowRight05StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowRight05 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconArrowRight05DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowRight05 DuotoneRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconArrowRight05TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowRight05 TwotoneRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconArrowRight05SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowRight05 SolidRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconArrowRight05BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowRight05 BulkRounded"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const IconArrowRight05StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowRight05 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sj sw"
...
export const IconArrowRight05SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ArrowRight05 SolidSharp"
    >
      <path 
        d={d.d13}
        i-c="c f fr"
...
export const iconPackOfArrowRight05: TheIconSelfPack = [
  'ArrowRight05',
  IconArrowRight05StrokeRounded,
  IconArrowRight05DuotoneRounded,
  IconArrowRight05TwotoneRounded,
  IconArrowRight05SolidRounded,
  IconArrowRight05BulkRounded,
  IconArrowRight05StrokeSharp,
  IconArrowRight05SolidSharp,
];