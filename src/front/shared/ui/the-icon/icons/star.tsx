...
export const iconPackOfStar: TheIconSelfPack = [
  'Star',
  IconStarStrokeRounded,
  IconStarDuotoneRounded,
  IconStarTwotoneRounded,
  IconStarSolidRounded,
  IconStarBulkRounded,
  IconStarStrokeSharp,
  IconStarSolidSharp,
];