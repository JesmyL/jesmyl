...
export const IconCalendarUpload02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarUpload02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCalendarUpload02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarUpload02 DuotoneRounded"
    >
      <path 
        d={d.d5}
        i-c="f o7"
...
export const IconCalendarUpload02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarUpload02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconCalendarUpload02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarUpload02 SolidRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconCalendarUpload02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarUpload02 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f"
...
export const IconCalendarUpload02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarUpload02 StrokeSharp"
    >
      <path 
        d={d.d10}
        i-c="s sw"
...
export const IconCalendarUpload02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="CalendarUpload02 SolidSharp"
    >
      <path 
        d={d.d14}
        i-c="c f fr"
...
export const iconPackOfCalendarUpload02: TheIconSelfPack = [
  'CalendarUpload02',
  IconCalendarUpload02StrokeRounded,
  IconCalendarUpload02DuotoneRounded,
  IconCalendarUpload02TwotoneRounded,
  IconCalendarUpload02SolidRounded,
  IconCalendarUpload02BulkRounded,
  IconCalendarUpload02StrokeSharp,
  IconCalendarUpload02SolidSharp,
];