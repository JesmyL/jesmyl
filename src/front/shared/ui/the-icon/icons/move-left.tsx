...
export const IconMoveLeftStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoveLeft StrokeRounded"
    >
      <circle 
        cx="3"
        cy="3"
...
export const IconMoveLeftDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoveLeft DuotoneRounded"
    >
      <circle 
        cx="3"
        cy="3"
...
export const IconMoveLeftTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoveLeft TwotoneRounded"
    >
      <circle 
        cx="3"
        cy="3"
...
export const IconMoveLeftSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="MoveLeft SolidRounded"
    >
      <path 
        d={d.d2}
        i-c="f"
...
export const iconPackOfMoveLeft: TheIconSelfPack = [
  'MoveLeft',
  IconMoveLeftStrokeRounded,
  IconMoveLeftDuotoneRounded,
  IconMoveLeftTwotoneRounded,
  IconMoveLeftSolidRounded,
  IconMoveLeftBulkRounded,
  IconMoveLeftStrokeSharp,
  IconMoveLeftSolidSharp,
];