...
export const Icon3rdBracketCircleStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="3rdBracketCircle StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const Icon3rdBracketCircleDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="3rdBracketCircle DuotoneRounded"
    >
      <circle 
        cx="12"
        cy="12"
...
export const Icon3rdBracketCircleTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="3rdBracketCircle TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="o7 s sj sr sw"
...
export const Icon3rdBracketCircleSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="3rdBracketCircle SolidRounded"
    >
      <path 
        d={d.d2}
        i-c="c f fr"
...
export const Icon3rdBracketCircleBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="3rdBracketCircle BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const Icon3rdBracketCircleStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="3rdBracketCircle StrokeSharp"
    >
      <path 
        d={d.d6}
        i-c="s sw"
...
export const Icon3rdBracketCircleSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="3rdBracketCircle SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOf3rdBracketCircle: TheIconSelfPack = [
  '3rdBracketCircle',
  Icon3rdBracketCircleStrokeRounded,
  Icon3rdBracketCircleDuotoneRounded,
  Icon3rdBracketCircleTwotoneRounded,
  Icon3rdBracketCircleSolidRounded,
  Icon3rdBracketCircleBulkRounded,
  Icon3rdBracketCircleStrokeSharp,
  Icon3rdBracketCircleSolidSharp,
];