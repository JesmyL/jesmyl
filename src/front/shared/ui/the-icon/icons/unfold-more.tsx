...
export const IconUnfoldMoreStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UnfoldMore StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUnfoldMoreDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UnfoldMore DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUnfoldMoreTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UnfoldMore TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconUnfoldMoreSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UnfoldMore SolidRounded"
    >
      <path 
        d={d.d3}
        i-c="f"
...
export const IconUnfoldMoreBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UnfoldMore BulkRounded"
    >
      <path 
        d={d.d3}
        i-c="f o7"
...
export const IconUnfoldMoreStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UnfoldMore StrokeSharp"
    >
      <path 
        d={d.d5}
        i-c="s sw"
...
export const IconUnfoldMoreSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="UnfoldMore SolidSharp"
    >
      <path 
        d={d.d7}
        i-c="f"
...
export const iconPackOfUnfoldMore: TheIconSelfPack = [
  'UnfoldMore',
  IconUnfoldMoreStrokeRounded,
  IconUnfoldMoreDuotoneRounded,
  IconUnfoldMoreTwotoneRounded,
  IconUnfoldMoreSolidRounded,
  IconUnfoldMoreBulkRounded,
  IconUnfoldMoreStrokeSharp,
  IconUnfoldMoreSolidSharp,
];