...
export const IconVolumeHighStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VolumeHigh StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconVolumeHighDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VolumeHigh DuotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="f o7"
...
export const IconVolumeHighTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VolumeHigh TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sj sr sw"
...
export const IconVolumeHighSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VolumeHigh SolidRounded"
    >
      <path 
        d={d.d4}
        i-c="f"
...
export const IconVolumeHighBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VolumeHigh BulkRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconVolumeHighStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VolumeHigh StrokeSharp"
    >
      <path 
        d={d.d2}
        i-c="s sj sw"
...
export const IconVolumeHighSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="VolumeHigh SolidSharp"
    >
      <path 
        d={d.d8}
        i-c="c f fr"
...
export const iconPackOfVolumeHigh: TheIconSelfPack = [
  'VolumeHigh',
  IconVolumeHighStrokeRounded,
  IconVolumeHighDuotoneRounded,
  IconVolumeHighTwotoneRounded,
  IconVolumeHighSolidRounded,
  IconVolumeHighBulkRounded,
  IconVolumeHighStrokeSharp,
  IconVolumeHighSolidSharp,
];