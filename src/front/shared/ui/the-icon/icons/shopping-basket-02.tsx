...
export const IconShoppingBasket02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasket02 StrokeRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconShoppingBasket02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasket02 DuotoneRounded"
    >
      <path 
        d={d.d4}
        i-c="f o7"
...
export const IconShoppingBasket02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasket02 TwotoneRounded"
    >
      <path 
        d={d.d1}
        i-c="s sw"
...
export const IconShoppingBasket02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasket02 SolidRounded"
    >
      <path 
        d={d.d5}
        i-c="c f fr"
...
export const IconShoppingBasket02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasket02 BulkRounded"
    >
      <path 
        d={d.d6}
        i-c="f o7"
...
export const IconShoppingBasket02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasket02 StrokeSharp"
    >
      <path 
        d={d.d9}
        i-c="s sw"
...
export const IconShoppingBasket02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      the-icon="ShoppingBasket02 SolidSharp"
    >
      <path 
        d={d.d12}
        i-c="c f fr"
...
export const iconPackOfShoppingBasket02: TheIconSelfPack = [
  'ShoppingBasket02',
  IconShoppingBasket02StrokeRounded,
  IconShoppingBasket02DuotoneRounded,
  IconShoppingBasket02TwotoneRounded,
  IconShoppingBasket02SolidRounded,
  IconShoppingBasket02BulkRounded,
  IconShoppingBasket02StrokeSharp,
  IconShoppingBasket02SolidSharp,
];