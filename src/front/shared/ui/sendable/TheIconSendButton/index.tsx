...
import { SendButtonContentMaker } from '../lib/send-button-content-maker/maker';
import { SendButtonContentMakerProps } from '../lib/send-button-content-maker/maker.model';
...
export const TheIconSendButton = <Value,>(props: Props<Value>) => {
