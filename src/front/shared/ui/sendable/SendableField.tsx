...
import { useIsRedactArea } from '../../lib/+hooks/useIsRedactArea';
import { SendableMultilineField } from './StrongEditableFieldMultiline';
...
export const SendableField = <Key extends string, Value extends string | Partial<Record<Key, string>>>(
    ...
    >
      ...
      {isRedact ? (
        ...
        >
          ...
          {value ? (
            props.multiline ? (
              <SendableMultilineField value={value} />
            ) : (
