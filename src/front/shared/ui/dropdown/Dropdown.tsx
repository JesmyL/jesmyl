...
import { useOnSendPromiseCallback } from '../sendable/lib/useOnSendPromiseCallback';
import { DropdownItem, DropdownProps } from './Dropdown.model';

let lastDroppedCloser: () => void = () => {};

export const Dropdown = <Id, Item extends DropdownItem<Id> = DropdownItem<Id>>(props: DropdownProps<Id, Item>) => {
