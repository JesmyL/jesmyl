...
import { AppUserMorePopupInner } from './AppUserMorePopupInner';

export const AppProfileInfo = ({ auth }: { auth: LocalSokiAuth }) => {
    ...
    <>
      ...
      {isUserMoreOpen && (
        <BottomPopup onClose={setIsUserMoreOpen}>
          <AppUserMorePopupInner onClose={setIsUserMoreOpen} />
        </BottomPopup>
      )}
    </>
  );
